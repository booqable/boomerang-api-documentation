...
```json
  ...
  "data": [
    {
      "id": "8e4760fd-b1bd-4514-9544-0521137a6d7b",
      "type": "themes",
      "attributes": {
        "created_at": "2023-02-07T15:03:20+00:00",
        "updated_at": "2023-02-07T15:03:20+00:00",
        "name": "Theme 1",
        "identifier": "ab9ec1bd-0be7-4353-9583-a1ef095c8938",
        "version": "1.0",
        "theme_type": "official",
        "description": "A simple theme for setting up your shop",
        "preview_image": "",
        "theme_id": "6a723643-3925-4860-b601-5b10c5d1639b",
        "installed": true
      },
      "relationships": {
        "assets": {
          "links": {
            "related": "api/boomerang/assets?filter[theme_id]=8e4760fd-b1bd-4514-9544-0521137a6d7b"
          }
        },
        "original_theme": {
          "links": {
            "related": "api/boomerang/themes/6a723643-3925-4860-b601-5b10c5d1639b"
          }
        }
      }
    }
...
```json
  ...
  "data": [
    {
      "id": "22d7ce99-58d6-41c5-9871-db68d51be1ee",
      "type": "themes",
      "attributes": {
        "created_at": "2023-02-07T15:03:21+00:00",
        "updated_at": "2023-02-07T15:03:21+00:00",
        "name": "Official theme",
        "identifier": "b44095b7-98ed-4a3d-bdac-ecfb2adb5465",
        "version": "1.0",
        "theme_type": "official",
        "description": null,
        "preview_image": "",
      ...
      "relationships": {
        "assets": {
          "links": {
            "related": "api/boomerang/assets?filter[theme_id]=22d7ce99-58d6-41c5-9871-db68d51be1ee"
          }
        },
        "original_theme": {
          "links": {
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "name": "New theme",
          "theme_id": "aa56062f-80c7-4967-9438-68d9a150bc6f"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "c64ef25c-d00f-48da-a6e0-088ea89725f1",
    "type": "themes",
    "attributes": {
      "created_at": "2023-02-07T15:03:22+00:00",
      "updated_at": "2023-02-07T15:03:22+00:00",
      "name": "Official theme",
      "identifier": "36ac6ae0-831b-4612-ad1b-de91ae2cf94d",
      "version": null,
      "theme_type": "official",
      "description": null,
      "preview_image": "",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/themes/b943e9d5-2290-4442-b08d-a57f13a8a9ea' \
    --header 'content-type: application/json' \
```
