...
```json
  ...
  "data": [
    {
      "id": "48f0a728-2482-4864-a79d-b8a37e614d17",
      "type": "themes",
      "attributes": {
        "created_at": "2023-02-24T08:47:17+00:00",
        "updated_at": "2023-02-24T08:47:17+00:00",
        "name": "Theme 1",
        "identifier": "31ca14ab-e857-4be9-9f9c-b064f2931cc0",
        "version": "1.0",
        "theme_type": "official",
        "description": "A simple theme for setting up your shop",
        "preview_image": "",
        "theme_id": "672ae33a-e291-463e-9744-bf651a891aa3",
        "installed": true
      },
      "relationships": {
        "assets": {
          "links": {
            "related": "api/boomerang/assets?filter[theme_id]=48f0a728-2482-4864-a79d-b8a37e614d17"
          }
        },
        "original_theme": {
          "links": {
            "related": "api/boomerang/themes/672ae33a-e291-463e-9744-bf651a891aa3"
          }
        }
      }
    }
...
```json
  ...
  "data": [
    {
      "id": "97373312-22e5-4c27-a3e0-8aba8665135e",
      "type": "themes",
      "attributes": {
        "created_at": "2023-02-24T08:47:17+00:00",
        "updated_at": "2023-02-24T08:47:17+00:00",
        "name": "Official theme",
        "identifier": "9f47aab9-9382-4073-8ee7-8e0e611a3555",
        "version": "1.0",
        "theme_type": "official",
        "description": null,
        "preview_image": "",
      ...
      "relationships": {
        "assets": {
          "links": {
            "related": "api/boomerang/assets?filter[theme_id]=97373312-22e5-4c27-a3e0-8aba8665135e"
          }
        },
        "original_theme": {
          "links": {
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "name": "New theme",
          "theme_id": "522f7990-8508-4013-936f-b3d90725c552"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "7ac50bf4-6e87-46b7-b46d-da38589f18ed",
    "type": "themes",
    "attributes": {
      "created_at": "2023-02-24T08:47:18+00:00",
      "updated_at": "2023-02-24T08:47:18+00:00",
      "name": "Official theme",
      "identifier": "628577e6-1263-492d-81a0-1d4c622087a3",
      "version": null,
      "theme_type": "official",
      "description": null,
      "preview_image": "",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/themes/563897bd-9286-44c6-b93a-0708778f4135' \
    --header 'content-type: application/json' \
```
