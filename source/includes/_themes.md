...
```json
  ...
  "data": [
    {
      "id": "fa70b321-0dab-420e-92db-4e2b23355d65",
      "type": "themes",
      "attributes": {
        "created_at": "2023-02-13T09:12:42+00:00",
        "updated_at": "2023-02-13T09:12:42+00:00",
        "name": "Theme 1",
        "identifier": "9995ebc2-a061-4275-a0e1-5657b9d483bd",
        "version": "1.0",
        "theme_type": "official",
        "description": "A simple theme for setting up your shop",
        "preview_image": "",
        "theme_id": "d8bf94d6-8fae-4ccc-810c-8a17a7e8834a",
        "installed": true
      },
      "relationships": {
        "assets": {
          "links": {
            "related": "api/boomerang/assets?filter[theme_id]=fa70b321-0dab-420e-92db-4e2b23355d65"
          }
        },
        "original_theme": {
          "links": {
            "related": "api/boomerang/themes/d8bf94d6-8fae-4ccc-810c-8a17a7e8834a"
          }
        }
      }
    }
...
```json
  ...
  "data": [
    {
      "id": "ca202504-4ed9-4dc9-a678-de4c4e1af67d",
      "type": "themes",
      "attributes": {
        "created_at": "2023-02-13T09:12:42+00:00",
        "updated_at": "2023-02-13T09:12:42+00:00",
        "name": "Official theme",
        "identifier": "e2daa958-94fa-4544-ace2-48b990316b6d",
        "version": "1.0",
        "theme_type": "official",
        "description": null,
        "preview_image": "",
      ...
      "relationships": {
        "assets": {
          "links": {
            "related": "api/boomerang/assets?filter[theme_id]=ca202504-4ed9-4dc9-a678-de4c4e1af67d"
          }
        },
        "original_theme": {
          "links": {
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "name": "New theme",
          "theme_id": "3de9d199-887a-4f95-adfc-095b3103330d"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "0126b014-3314-4220-889e-6edf6921ebda",
    "type": "themes",
    "attributes": {
      "created_at": "2023-02-13T09:12:43+00:00",
      "updated_at": "2023-02-13T09:12:43+00:00",
      "name": "Official theme",
      "identifier": "f25a2a99-0c0c-4eb4-90ec-69d0d8bd00a5",
      "version": null,
      "theme_type": "official",
      "description": null,
      "preview_image": "",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/themes/e2164cf6-47bf-4325-8d48-536d8bd5f07f' \
    --header 'content-type: application/json' \
```
