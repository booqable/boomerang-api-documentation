...
```json
  ...
  "data": [
    {
      "id": "16226f6c-c0b5-4ef6-932c-72004df0f327",
      "type": "themes",
      "attributes": {
        "created_at": "2022-12-19T08:49:53+00:00",
        "updated_at": "2022-12-19T08:49:53+00:00",
        "name": "Theme 1",
        "identifier": "d019aaf7-77fc-4992-a7d0-0c61d2cd3d20",
        "version": "1.0",
        "theme_type": "official",
        "description": "A simple theme for setting up your shop",
        "preview_image": "",
        "theme_id": "c0c949ba-6122-4f57-bd4b-685f9fe1800d",
        "installed": true
      },
      "relationships": {
        "assets": {
          "links": {
            "related": "api/boomerang/assets?filter[theme_id]=16226f6c-c0b5-4ef6-932c-72004df0f327"
          }
        },
        "original_theme": {
          "links": {
            "related": "api/boomerang/themes/c0c949ba-6122-4f57-bd4b-685f9fe1800d"
          }
        }
      }
    }
...
```json
  ...
  "data": [
    {
      "id": "ebf50bfe-a114-4e13-a5d9-5ef0e71ee4e8",
      "type": "themes",
      "attributes": {
        "created_at": "2022-12-19T08:49:53+00:00",
        "updated_at": "2022-12-19T08:49:53+00:00",
        "name": "Official theme",
        "identifier": "2f32b239-f5fe-4952-87d9-28cc04da4eea",
        "version": "1.0",
        "theme_type": "official",
        "description": null,
        "preview_image": "",
      ...
      "relationships": {
        "assets": {
          "links": {
            "related": "api/boomerang/assets?filter[theme_id]=ebf50bfe-a114-4e13-a5d9-5ef0e71ee4e8"
          }
        },
        "original_theme": {
          "links": {
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "name": "New theme",
          "theme_id": "0fd1f078-73ce-47e2-856f-0a180a4e2811"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "545501c4-2220-49fc-abcf-d6556019847a",
    "type": "themes",
    "attributes": {
      "created_at": "2022-12-19T08:49:53+00:00",
      "updated_at": "2022-12-19T08:49:53+00:00",
      "name": "Official theme",
      "identifier": "f01bf888-5614-4ada-b9a2-7881cbdda855",
      "version": null,
      "theme_type": "official",
      "description": null,
      "preview_image": "",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/themes/c0a0df83-24f7-436e-add2-f2d456e5aadd' \
    --header 'content-type: application/json' \
```
