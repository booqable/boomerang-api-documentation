...
```json
  ...
  "data": [
    {
      "id": "37544461-808a-47c0-becc-98e44aadc43c",
      "type": "themes",
      "attributes": {
        "created_at": "2023-02-02T07:59:04+00:00",
        "updated_at": "2023-02-02T07:59:04+00:00",
        "name": "Theme 1",
        "identifier": "16388b24-fb05-45be-9baa-8c8d489d1c92",
        "version": "1.0",
        "theme_type": "official",
        "description": "A simple theme for setting up your shop",
        "preview_image": "",
        "theme_id": "e8948e7e-b8ba-450e-b1d7-c19ea54c3894",
        "installed": true
      },
      "relationships": {
        "assets": {
          "links": {
            "related": "api/boomerang/assets?filter[theme_id]=37544461-808a-47c0-becc-98e44aadc43c"
          }
        },
        "original_theme": {
          "links": {
            "related": "api/boomerang/themes/e8948e7e-b8ba-450e-b1d7-c19ea54c3894"
          }
        }
      }
    }
...
```json
  ...
  "data": [
    {
      "id": "f1b29a74-c77e-42c9-8404-60409f63109f",
      "type": "themes",
      "attributes": {
        "created_at": "2023-02-02T07:59:04+00:00",
        "updated_at": "2023-02-02T07:59:04+00:00",
        "name": "Official theme",
        "identifier": "27de0759-6640-41b6-8bda-d2560291ff07",
        "version": "1.0",
        "theme_type": "official",
        "description": null,
        "preview_image": "",
      ...
      "relationships": {
        "assets": {
          "links": {
            "related": "api/boomerang/assets?filter[theme_id]=f1b29a74-c77e-42c9-8404-60409f63109f"
          }
        },
        "original_theme": {
          "links": {
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "name": "New theme",
          "theme_id": "af8e7d2f-67a7-4475-9110-15b2abc8678f"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "aa1d921c-f839-4534-b003-bcb5fd8a5573",
    "type": "themes",
    "attributes": {
      "created_at": "2023-02-02T07:59:05+00:00",
      "updated_at": "2023-02-02T07:59:05+00:00",
      "name": "Official theme",
      "identifier": "8c9668a5-3817-4523-97b4-98d2e4166db5",
      "version": null,
      "theme_type": "official",
      "description": null,
      "preview_image": "",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/themes/9cac68de-ddc4-4063-8c48-f7b9d77fabd8' \
    --header 'content-type: application/json' \
```
