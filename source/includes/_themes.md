...
```json
  ...
  "data": [
    {
      "id": "8ae39dd4-da72-4b44-abab-28b07c501601",
      "type": "themes",
      "attributes": {
        "created_at": "2023-02-02T17:01:42+00:00",
        "updated_at": "2023-02-02T17:01:42+00:00",
        "name": "Theme 1",
        "identifier": "7837a1c5-2f8f-4ae4-a3f0-6974e110389d",
        "version": "1.0",
        "theme_type": "official",
        "description": "A simple theme for setting up your shop",
        "preview_image": "",
        "theme_id": "53d3efdb-6304-4274-88c3-a890c05f9096",
        "installed": true
      },
      "relationships": {
        "assets": {
          "links": {
            "related": "api/boomerang/assets?filter[theme_id]=8ae39dd4-da72-4b44-abab-28b07c501601"
          }
        },
        "original_theme": {
          "links": {
            "related": "api/boomerang/themes/53d3efdb-6304-4274-88c3-a890c05f9096"
          }
        }
      }
    }
...
```json
  ...
  "data": [
    {
      "id": "a3c5b283-225e-4559-9c58-7e4c51de5e56",
      "type": "themes",
      "attributes": {
        "created_at": "2023-02-02T17:01:42+00:00",
        "updated_at": "2023-02-02T17:01:42+00:00",
        "name": "Official theme",
        "identifier": "64d9ff35-b85d-44d0-a1ea-1b4b8444495f",
        "version": "1.0",
        "theme_type": "official",
        "description": null,
        "preview_image": "",
      ...
      "relationships": {
        "assets": {
          "links": {
            "related": "api/boomerang/assets?filter[theme_id]=a3c5b283-225e-4559-9c58-7e4c51de5e56"
          }
        },
        "original_theme": {
          "links": {
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "name": "New theme",
          "theme_id": "b328506e-7e64-4135-99e8-69c108c52ba9"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "7e6f1402-c3f9-4706-b107-478f9636d68f",
    "type": "themes",
    "attributes": {
      "created_at": "2023-02-02T17:01:43+00:00",
      "updated_at": "2023-02-02T17:01:43+00:00",
      "name": "Official theme",
      "identifier": "32d341c9-b5b3-41fc-bde2-18e89285c648",
      "version": null,
      "theme_type": "official",
      "description": null,
      "preview_image": "",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/themes/fc2b083b-8ec3-4cc1-8a1d-433be2aa5e20' \
    --header 'content-type: application/json' \
```
