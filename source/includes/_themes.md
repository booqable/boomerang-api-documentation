...
```json
  ...
  "data": [
    {
      "id": "216cc195-af07-44f4-8393-235fab4661ce",
      "type": "themes",
      "attributes": {
        "created_at": "2023-01-25T12:38:11+00:00",
        "updated_at": "2023-01-25T12:38:11+00:00",
        "name": "Theme 1",
        "identifier": "aeeb2d3c-2998-411b-89dc-ab21ac364952",
        "version": "1.0",
        "theme_type": "official",
        "description": "A simple theme for setting up your shop",
        "preview_image": "",
        "theme_id": "ac8a8590-7c4e-4ac1-bdda-81dbe791ddec",
        "installed": true
      },
      "relationships": {
        "assets": {
          "links": {
            "related": "api/boomerang/assets?filter[theme_id]=216cc195-af07-44f4-8393-235fab4661ce"
          }
        },
        "original_theme": {
          "links": {
            "related": "api/boomerang/themes/ac8a8590-7c4e-4ac1-bdda-81dbe791ddec"
          }
        }
      }
    }
...
```json
  ...
  "data": [
    {
      "id": "2eb27fc9-16a9-4b93-95a0-ad2f1da4e2e7",
      "type": "themes",
      "attributes": {
        "created_at": "2023-01-25T12:38:11+00:00",
        "updated_at": "2023-01-25T12:38:11+00:00",
        "name": "Official theme",
        "identifier": "7bba758c-e2f8-42a6-8cf9-563a1105a98b",
        "version": "1.0",
        "theme_type": "official",
        "description": null,
        "preview_image": "",
      ...
      "relationships": {
        "assets": {
          "links": {
            "related": "api/boomerang/assets?filter[theme_id]=2eb27fc9-16a9-4b93-95a0-ad2f1da4e2e7"
          }
        },
        "original_theme": {
          "links": {
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "name": "New theme",
          "theme_id": "146baaa7-f338-4f24-b19a-ed580c67a922"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "69228801-fd78-45de-9a77-c80f8e379bc9",
    "type": "themes",
    "attributes": {
      "created_at": "2023-01-25T12:38:11+00:00",
      "updated_at": "2023-01-25T12:38:11+00:00",
      "name": "Official theme",
      "identifier": "d7c23461-8b9f-43ef-977a-01d4f05c582d",
      "version": null,
      "theme_type": "official",
      "description": null,
      "preview_image": "",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/themes/30898845-efb1-4346-be52-2bd5c192b431' \
    --header 'content-type: application/json' \
```
