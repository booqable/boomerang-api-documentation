...
```json
  ...
  "data": [
    {
      "id": "2bcde59a-0761-49f5-8755-5778440ddffc",
      "type": "themes",
      "attributes": {
        "created_at": "2023-02-16T10:03:51+00:00",
        "updated_at": "2023-02-16T10:03:51+00:00",
        "name": "Theme 1",
        "identifier": "8673da8b-5bcd-44ce-b210-b9a2933cffe2",
        "version": "1.0",
        "theme_type": "official",
        "description": "A simple theme for setting up your shop",
        "preview_image": "",
        "theme_id": "2bdebf96-8d8d-46bc-a342-3fdeb031789c",
        "installed": true
      },
      "relationships": {
        "assets": {
          "links": {
            "related": "api/boomerang/assets?filter[theme_id]=2bcde59a-0761-49f5-8755-5778440ddffc"
          }
        },
        "original_theme": {
          "links": {
            "related": "api/boomerang/themes/2bdebf96-8d8d-46bc-a342-3fdeb031789c"
          }
        }
      }
    }
...
```json
  ...
  "data": [
    {
      "id": "b4c7e699-d6db-4f49-b432-173a48a3ef8f",
      "type": "themes",
      "attributes": {
        "created_at": "2023-02-16T10:03:52+00:00",
        "updated_at": "2023-02-16T10:03:52+00:00",
        "name": "Official theme",
        "identifier": "e599456a-9d8a-4723-8173-01105f50ee7a",
        "version": "1.0",
        "theme_type": "official",
        "description": null,
        "preview_image": "",
      ...
      "relationships": {
        "assets": {
          "links": {
            "related": "api/boomerang/assets?filter[theme_id]=b4c7e699-d6db-4f49-b432-173a48a3ef8f"
          }
        },
        "original_theme": {
          "links": {
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "name": "New theme",
          "theme_id": "442d0f66-4884-4448-8885-a58a07f94e9a"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "51db8668-6336-4e1d-ad57-41ba4050927a",
    "type": "themes",
    "attributes": {
      "created_at": "2023-02-16T10:03:52+00:00",
      "updated_at": "2023-02-16T10:03:52+00:00",
      "name": "Official theme",
      "identifier": "9d0611e3-eb09-4295-8578-210b901c31ac",
      "version": null,
      "theme_type": "official",
      "description": null,
      "preview_image": "",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/themes/e0af7223-d8d0-45ad-a212-b0360b6058ad' \
    --header 'content-type: application/json' \
```
