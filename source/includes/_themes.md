...
```json
  ...
  "data": [
    {
      "id": "0cb2dfbd-7c19-4c43-b15f-28ecb7bfc6b4",
      "type": "themes",
      "attributes": {
        "created_at": "2023-02-07T11:02:12+00:00",
        "updated_at": "2023-02-07T11:02:12+00:00",
        "name": "Theme 1",
        "identifier": "5d79c0c9-374e-4fb0-9d90-62d031757c1c",
        "version": "1.0",
        "theme_type": "official",
        "description": "A simple theme for setting up your shop",
        "preview_image": "",
        "theme_id": "f5d5c711-f323-4f8f-8dd4-99eb01583d82",
        "installed": true
      },
      "relationships": {
        "assets": {
          "links": {
            "related": "api/boomerang/assets?filter[theme_id]=0cb2dfbd-7c19-4c43-b15f-28ecb7bfc6b4"
          }
        },
        "original_theme": {
          "links": {
            "related": "api/boomerang/themes/f5d5c711-f323-4f8f-8dd4-99eb01583d82"
          }
        }
      }
    }
...
```json
  ...
  "data": [
    {
      "id": "c6bf6a0f-66b7-40e0-8f6d-0a6711100313",
      "type": "themes",
      "attributes": {
        "created_at": "2023-02-07T11:02:13+00:00",
        "updated_at": "2023-02-07T11:02:13+00:00",
        "name": "Official theme",
        "identifier": "eda250cb-f4fe-4884-8df6-d3bb78478275",
        "version": "1.0",
        "theme_type": "official",
        "description": null,
        "preview_image": "",
      ...
      "relationships": {
        "assets": {
          "links": {
            "related": "api/boomerang/assets?filter[theme_id]=c6bf6a0f-66b7-40e0-8f6d-0a6711100313"
          }
        },
        "original_theme": {
          "links": {
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "name": "New theme",
          "theme_id": "e47317fd-4042-45f4-b8e6-eabdac6b0dea"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "7d37ca7d-7b62-42c4-8e15-ad3967bb1b06",
    "type": "themes",
    "attributes": {
      "created_at": "2023-02-07T11:02:13+00:00",
      "updated_at": "2023-02-07T11:02:13+00:00",
      "name": "Official theme",
      "identifier": "f8acb0ec-4a91-48d9-8915-2801dff0328f",
      "version": null,
      "theme_type": "official",
      "description": null,
      "preview_image": "",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/themes/5cfec10d-cfa1-440d-874b-3c65368ca0fb' \
    --header 'content-type: application/json' \
```
