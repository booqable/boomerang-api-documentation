...
```json
  ...
  "data": [
    {
      "id": "cf70be6e-67cf-4f0d-b4b7-883edb61a1ca",
      "type": "themes",
      "attributes": {
        "created_at": "2023-02-02T14:31:39+00:00",
        "updated_at": "2023-02-02T14:31:39+00:00",
        "name": "Theme 1",
        "identifier": "69326b77-5707-4da4-9599-bab112907461",
        "version": "1.0",
        "theme_type": "official",
        "description": "A simple theme for setting up your shop",
        "preview_image": "",
        "theme_id": "42139447-4821-4886-9f07-588ab73804be",
        "installed": true
      },
      "relationships": {
        "assets": {
          "links": {
            "related": "api/boomerang/assets?filter[theme_id]=cf70be6e-67cf-4f0d-b4b7-883edb61a1ca"
          }
        },
        "original_theme": {
          "links": {
            "related": "api/boomerang/themes/42139447-4821-4886-9f07-588ab73804be"
          }
        }
      }
    }
...
```json
  ...
  "data": [
    {
      "id": "eb3a6430-2fbf-4444-a7d2-f7beb0125645",
      "type": "themes",
      "attributes": {
        "created_at": "2023-02-02T14:31:39+00:00",
        "updated_at": "2023-02-02T14:31:39+00:00",
        "name": "Official theme",
        "identifier": "1a067a48-6641-4db3-9519-75bebaaf0af6",
        "version": "1.0",
        "theme_type": "official",
        "description": null,
        "preview_image": "",
      ...
      "relationships": {
        "assets": {
          "links": {
            "related": "api/boomerang/assets?filter[theme_id]=eb3a6430-2fbf-4444-a7d2-f7beb0125645"
          }
        },
        "original_theme": {
          "links": {
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "name": "New theme",
          "theme_id": "2c8fa6cf-67a3-49ae-b12c-9f79ce5f99f9"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "ed552090-3e90-4e41-89cd-a7f679694c88",
    "type": "themes",
    "attributes": {
      "created_at": "2023-02-02T14:31:40+00:00",
      "updated_at": "2023-02-02T14:31:40+00:00",
      "name": "Official theme",
      "identifier": "0b8ab800-03ae-4911-aeb0-8a1e73f89626",
      "version": null,
      "theme_type": "official",
      "description": null,
      "preview_image": "",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/themes/3039afe9-de47-4471-9ebc-3389a428edba' \
    --header 'content-type: application/json' \
```
