...
```json
  ...
  "data": [
    {
      "id": "d664aba1-e1cd-4307-90b2-ddbce4b9e9a5",
      "type": "themes",
      "attributes": {
        "created_at": "2023-02-02T19:30:28+00:00",
        "updated_at": "2023-02-02T19:30:28+00:00",
        "name": "Theme 1",
        "identifier": "c452b2f4-3f97-4a14-a46f-8672d4cfc3f6",
        "version": "1.0",
        "theme_type": "official",
        "description": "A simple theme for setting up your shop",
        "preview_image": "",
        "theme_id": "db436d2e-e6bf-4510-af7f-7de9b12c2151",
        "installed": true
      },
      "relationships": {
        "assets": {
          "links": {
            "related": "api/boomerang/assets?filter[theme_id]=d664aba1-e1cd-4307-90b2-ddbce4b9e9a5"
          }
        },
        "original_theme": {
          "links": {
            "related": "api/boomerang/themes/db436d2e-e6bf-4510-af7f-7de9b12c2151"
          }
        }
      }
    }
...
```json
  ...
  "data": [
    {
      "id": "be24e630-29af-47d6-ac8f-0a5b14035fd4",
      "type": "themes",
      "attributes": {
        "created_at": "2023-02-02T19:30:28+00:00",
        "updated_at": "2023-02-02T19:30:28+00:00",
        "name": "Official theme",
        "identifier": "8e32564a-51c4-40cd-89a6-667215574b4a",
        "version": "1.0",
        "theme_type": "official",
        "description": null,
        "preview_image": "",
      ...
      "relationships": {
        "assets": {
          "links": {
            "related": "api/boomerang/assets?filter[theme_id]=be24e630-29af-47d6-ac8f-0a5b14035fd4"
          }
        },
        "original_theme": {
          "links": {
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "name": "New theme",
          "theme_id": "3afd4445-6869-4395-8c83-7dd57ca2a074"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "2c1b42e0-9fc9-4616-80b0-94c8b518a384",
    "type": "themes",
    "attributes": {
      "created_at": "2023-02-02T19:30:29+00:00",
      "updated_at": "2023-02-02T19:30:29+00:00",
      "name": "Official theme",
      "identifier": "abce32df-589f-4684-9a15-36a7ebea041b",
      "version": null,
      "theme_type": "official",
      "description": null,
      "preview_image": "",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/themes/38c84bbf-5398-4e86-a23e-b894d1ce21ed' \
    --header 'content-type: application/json' \
```
