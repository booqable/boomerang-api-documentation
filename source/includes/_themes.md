...
```json
  ...
  "data": [
    {
      "id": "02276529-8657-4083-9157-1af5b1371dca",
      "type": "themes",
      "attributes": {
        "created_at": "2023-02-08T09:22:10+00:00",
        "updated_at": "2023-02-08T09:22:10+00:00",
        "name": "Theme 1",
        "identifier": "0ccbda4c-3b90-415b-baeb-d1364e47bb82",
        "version": "1.0",
        "theme_type": "official",
        "description": "A simple theme for setting up your shop",
        "preview_image": "",
        "theme_id": "930f5755-06f1-4c80-bb1e-1e8d7b054e37",
        "installed": true
      },
      "relationships": {
        "assets": {
          "links": {
            "related": "api/boomerang/assets?filter[theme_id]=02276529-8657-4083-9157-1af5b1371dca"
          }
        },
        "original_theme": {
          "links": {
            "related": "api/boomerang/themes/930f5755-06f1-4c80-bb1e-1e8d7b054e37"
          }
        }
      }
    }
...
```json
  ...
  "data": [
    {
      "id": "0c710298-1a80-4abd-a7ea-19221bc63116",
      "type": "themes",
      "attributes": {
        "created_at": "2023-02-08T09:22:11+00:00",
        "updated_at": "2023-02-08T09:22:11+00:00",
        "name": "Official theme",
        "identifier": "556e1909-7778-4623-850a-b5ea3c88946a",
        "version": "1.0",
        "theme_type": "official",
        "description": null,
        "preview_image": "",
      ...
      "relationships": {
        "assets": {
          "links": {
            "related": "api/boomerang/assets?filter[theme_id]=0c710298-1a80-4abd-a7ea-19221bc63116"
          }
        },
        "original_theme": {
          "links": {
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "name": "New theme",
          "theme_id": "cd9f8084-eabd-435e-91b4-1191dbb20ca5"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "8549c36c-7999-4480-bc1a-e4ffc6aaa3f2",
    "type": "themes",
    "attributes": {
      "created_at": "2023-02-08T09:22:11+00:00",
      "updated_at": "2023-02-08T09:22:11+00:00",
      "name": "Official theme",
      "identifier": "b694b137-34ea-4014-a36a-1347cd32f496",
      "version": null,
      "theme_type": "official",
      "description": null,
      "preview_image": "",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/themes/4b236d2a-0759-4b80-babd-be41b53bac62' \
    --header 'content-type: application/json' \
```
