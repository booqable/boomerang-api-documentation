...
```json
  ...
  "data": [
    {
      "id": "ff124b3c-ee96-41e2-b2b1-f7ce1137fabf",
      "type": "themes",
      "attributes": {
        "created_at": "2022-11-22T14:45:30+00:00",
        "updated_at": "2022-11-22T14:45:30+00:00",
        "name": "Theme 1",
        "identifier": "ce0ed499-2ad6-4c1b-82a8-204c6bcebe3f",
        "version": "1.0",
        "theme_type": "official",
        "description": "A simple theme for setting up your shop",
        "preview_image": "",
        "theme_id": "cf888eb7-83c5-47cc-8cce-036f12926368",
        "installed": true
      },
      "relationships": {
        "assets": {
          "links": {
            "related": "api/boomerang/assets?filter[theme_id]=ff124b3c-ee96-41e2-b2b1-f7ce1137fabf"
          }
        },
        "original_theme": {
          "links": {
            "related": "api/boomerang/themes/cf888eb7-83c5-47cc-8cce-036f12926368"
          }
        }
      }
    }
...
```json
  ...
  "data": [
    {
      "id": "8af1306e-2644-404d-8281-bd66170fa58f",
      "type": "themes",
      "attributes": {
        "created_at": "2022-11-22T14:45:30+00:00",
        "updated_at": "2022-11-22T14:45:30+00:00",
        "name": "Official theme",
        "identifier": "ac91bc50-8584-47c6-b266-a26fd9024d94",
        "version": "1.0",
        "theme_type": "official",
        "description": null,
        "preview_image": "",
      ...
      "relationships": {
        "assets": {
          "links": {
            "related": "api/boomerang/assets?filter[theme_id]=8af1306e-2644-404d-8281-bd66170fa58f"
          }
        },
        "original_theme": {
          "links": {
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "name": "New theme",
          "theme_id": "a4c8ada5-0556-43d5-8849-62b381bded07"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "83dedecf-d183-494b-a3ce-627c109fd169",
    "type": "themes",
    "attributes": {
      "created_at": "2022-11-22T14:45:30+00:00",
      "updated_at": "2022-11-22T14:45:30+00:00",
      "name": "Official theme",
      "identifier": "737b3fd0-8b9f-4e84-9145-5e57fbf12b23",
      "version": null,
      "theme_type": "official",
      "description": null,
      "preview_image": "",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/themes/abd4967f-c962-48ba-8481-afcf64e2f94e' \
    --header 'content-type: application/json' \
```
