...
```json
  ...
  "data": [
    {
      "id": "8ccbd436-4ab7-4af8-bc52-6ece0f088f89",
      "type": "themes",
      "attributes": {
        "created_at": "2022-07-12T08:50:39+00:00",
        "updated_at": "2022-07-12T08:50:39+00:00",
        "name": "Theme 1",
        "identifier": "a94cd081-a559-49dc-875c-fae7bbd0f0bf",
        "version": "1.0",
        "theme_type": "official",
        "description": "A simple theme for setting up your shop",
        "preview_image": "",
        "theme_id": "33a6ea13-f9b5-44f4-b1ed-35399d7f66e4",
        "installed": true
      },
      "relationships": {
        "assets": {
          "links": {
            "related": "api/boomerang/assets?filter[theme_id]=8ccbd436-4ab7-4af8-bc52-6ece0f088f89"
          }
        },
        "original_theme": {
          "links": {
            "related": "api/boomerang/themes/33a6ea13-f9b5-44f4-b1ed-35399d7f66e4"
          }
        }
      }
    }
...
```json
  ...
  "data": [
    {
      "id": "da126682-9750-4de3-9fb4-4526e3bec678",
      "type": "themes",
      "attributes": {
        "created_at": "2022-07-12T08:50:40+00:00",
        "updated_at": "2022-07-12T08:50:40+00:00",
        "name": "Official theme",
        "identifier": "40535826-9c7c-4b3a-b4c1-a373eab01124",
        "version": "1.0",
        "theme_type": "official",
        "description": null,
        "preview_image": "",
      ...
      "relationships": {
        "assets": {
          "links": {
            "related": "api/boomerang/assets?filter[theme_id]=da126682-9750-4de3-9fb4-4526e3bec678"
          }
        },
        "original_theme": {
          "links": {
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "name": "New theme",
          "theme_id": "f88d2f46-f8e2-40c6-9894-abe1c78a2012"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "b5ec128f-3a8d-4a42-a0c1-74c62484b0a4",
    "type": "themes",
    "attributes": {
      "created_at": "2022-07-12T08:50:41+00:00",
      "updated_at": "2022-07-12T08:50:41+00:00",
      "name": "Official theme",
      "identifier": "4342310d-8b9d-4818-baf9-e417dbbef0c1",
      "version": null,
      "theme_type": "official",
      "description": null,
      "preview_image": "",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/themes/47de6925-ed9d-497a-933c-aa4757e89b7c' \
    --header 'content-type: application/json' \
```
