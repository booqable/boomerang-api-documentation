...
```json
  ...
  "data": [
    {
      "id": "49f7e6e1-bdf6-4701-a30b-0b2a97c55681",
      "type": "themes",
      "attributes": {
        "created_at": "2023-02-24T09:51:25+00:00",
        "updated_at": "2023-02-24T09:51:25+00:00",
        "name": "Theme 1",
        "identifier": "02c74dcc-92c1-417a-9143-c45f09d35687",
        "version": "1.0",
        "theme_type": "official",
        "description": "A simple theme for setting up your shop",
        "preview_image": "",
        "theme_id": "a9858619-0b6c-4dcb-9565-af56b9523c79",
        "installed": true
      },
      "relationships": {
        "assets": {
          "links": {
            "related": "api/boomerang/assets?filter[theme_id]=49f7e6e1-bdf6-4701-a30b-0b2a97c55681"
          }
        },
        "original_theme": {
          "links": {
            "related": "api/boomerang/themes/a9858619-0b6c-4dcb-9565-af56b9523c79"
          }
        }
      }
    }
...
```json
  ...
  "data": [
    {
      "id": "adf16559-31ee-454a-84e6-3399fa6581d9",
      "type": "themes",
      "attributes": {
        "created_at": "2023-02-24T09:51:25+00:00",
        "updated_at": "2023-02-24T09:51:25+00:00",
        "name": "Official theme",
        "identifier": "7d76affc-5804-461d-8804-d9e9be7cabd4",
        "version": "1.0",
        "theme_type": "official",
        "description": null,
        "preview_image": "",
      ...
      "relationships": {
        "assets": {
          "links": {
            "related": "api/boomerang/assets?filter[theme_id]=adf16559-31ee-454a-84e6-3399fa6581d9"
          }
        },
        "original_theme": {
          "links": {
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "name": "New theme",
          "theme_id": "7d7414ed-787b-4639-b1a1-bba62e2f9486"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "530307af-4995-42aa-a5b1-4e788d8e4f61",
    "type": "themes",
    "attributes": {
      "created_at": "2023-02-24T09:51:25+00:00",
      "updated_at": "2023-02-24T09:51:25+00:00",
      "name": "Official theme",
      "identifier": "a717e47c-a0b4-4967-a11d-d842eaff49a1",
      "version": null,
      "theme_type": "official",
      "description": null,
      "preview_image": "",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/themes/b742c37f-6058-4e13-9ebe-60e35a1daa5c' \
    --header 'content-type: application/json' \
```
