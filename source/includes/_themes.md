...
```json
  ...
  "data": [
    {
      "id": "3c38c24d-d503-4294-8d13-de1e1ea04090",
      "type": "themes",
      "attributes": {
        "created_at": "2023-02-02T08:05:41+00:00",
        "updated_at": "2023-02-02T08:05:41+00:00",
        "name": "Theme 1",
        "identifier": "6af45398-75f3-4441-b38f-62e1362cb94a",
        "version": "1.0",
        "theme_type": "official",
        "description": "A simple theme for setting up your shop",
        "preview_image": "",
        "theme_id": "b56255ef-58b5-4897-905f-7c69c7f06895",
        "installed": true
      },
      "relationships": {
        "assets": {
          "links": {
            "related": "api/boomerang/assets?filter[theme_id]=3c38c24d-d503-4294-8d13-de1e1ea04090"
          }
        },
        "original_theme": {
          "links": {
            "related": "api/boomerang/themes/b56255ef-58b5-4897-905f-7c69c7f06895"
          }
        }
      }
    }
...
```json
  ...
  "data": [
    {
      "id": "3cd43988-b9c4-4860-ac96-bb900cf5e9a8",
      "type": "themes",
      "attributes": {
        "created_at": "2023-02-02T08:05:41+00:00",
        "updated_at": "2023-02-02T08:05:41+00:00",
        "name": "Official theme",
        "identifier": "7311f26a-96ca-4135-89f6-32e5c68a13b4",
        "version": "1.0",
        "theme_type": "official",
        "description": null,
        "preview_image": "",
      ...
      "relationships": {
        "assets": {
          "links": {
            "related": "api/boomerang/assets?filter[theme_id]=3cd43988-b9c4-4860-ac96-bb900cf5e9a8"
          }
        },
        "original_theme": {
          "links": {
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "name": "New theme",
          "theme_id": "c1c487c2-aefc-47c9-a71f-494206b58aa2"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "d0950796-0b94-44e1-b29e-f8ad89585c45",
    "type": "themes",
    "attributes": {
      "created_at": "2023-02-02T08:05:42+00:00",
      "updated_at": "2023-02-02T08:05:42+00:00",
      "name": "Official theme",
      "identifier": "90246391-3bb1-4544-b3d4-1ff32e5364c2",
      "version": null,
      "theme_type": "official",
      "description": null,
      "preview_image": "",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/themes/1396f6fc-f536-4754-bbe0-21d94147b5fe' \
    --header 'content-type: application/json' \
```
