...
```json
  ...
  "data": [
    {
      "id": "e1efad9a-729b-4a85-8676-10d96ae90a36",
      "type": "themes",
      "attributes": {
        "created_at": "2023-02-23T13:53:58+00:00",
        "updated_at": "2023-02-23T13:53:58+00:00",
        "name": "Theme 1",
        "identifier": "64cc0598-bdfe-460f-aed3-4ec399147cbc",
        "version": "1.0",
        "theme_type": "official",
        "description": "A simple theme for setting up your shop",
        "preview_image": "",
        "theme_id": "86deff71-1e4b-475b-953a-ccefdc585816",
        "installed": true
      },
      "relationships": {
        "assets": {
          "links": {
            "related": "api/boomerang/assets?filter[theme_id]=e1efad9a-729b-4a85-8676-10d96ae90a36"
          }
        },
        "original_theme": {
          "links": {
            "related": "api/boomerang/themes/86deff71-1e4b-475b-953a-ccefdc585816"
          }
        }
      }
    }
...
```json
  ...
  "data": [
    {
      "id": "c263032c-d721-4607-8091-ef748b9dc599",
      "type": "themes",
      "attributes": {
        "created_at": "2023-02-23T13:53:59+00:00",
        "updated_at": "2023-02-23T13:53:59+00:00",
        "name": "Official theme",
        "identifier": "91dd6d90-ec4e-4750-a9d6-e69d78665705",
        "version": "1.0",
        "theme_type": "official",
        "description": null,
        "preview_image": "",
      ...
      "relationships": {
        "assets": {
          "links": {
            "related": "api/boomerang/assets?filter[theme_id]=c263032c-d721-4607-8091-ef748b9dc599"
          }
        },
        "original_theme": {
          "links": {
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "name": "New theme",
          "theme_id": "28ab4f8e-1f22-47a4-8701-fe22d9c052ce"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "98796af9-9b5b-454b-9e1a-59ec04a19be4",
    "type": "themes",
    "attributes": {
      "created_at": "2023-02-23T13:53:59+00:00",
      "updated_at": "2023-02-23T13:53:59+00:00",
      "name": "Official theme",
      "identifier": "9540a09b-db7c-40ca-b198-3e9991c27102",
      "version": null,
      "theme_type": "official",
      "description": null,
      "preview_image": "",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/themes/c565b7f6-434e-45cd-ad46-3c8543ac7a0a' \
    --header 'content-type: application/json' \
```
