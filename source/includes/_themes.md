...
```json
  ...
  "data": [
    {
      "id": "27ea9663-1a51-4c43-a2d4-4ac3927cb928",
      "type": "themes",
      "attributes": {
        "created_at": "2023-02-02T11:19:16+00:00",
        "updated_at": "2023-02-02T11:19:16+00:00",
        "name": "Theme 1",
        "identifier": "947233cd-6508-4eb4-926e-5a32e5de90ee",
        "version": "1.0",
        "theme_type": "official",
        "description": "A simple theme for setting up your shop",
        "preview_image": "",
        "theme_id": "015cda05-b5f1-4971-ae6f-347280f64931",
        "installed": true
      },
      "relationships": {
        "assets": {
          "links": {
            "related": "api/boomerang/assets?filter[theme_id]=27ea9663-1a51-4c43-a2d4-4ac3927cb928"
          }
        },
        "original_theme": {
          "links": {
            "related": "api/boomerang/themes/015cda05-b5f1-4971-ae6f-347280f64931"
          }
        }
      }
    }
...
```json
  ...
  "data": [
    {
      "id": "1e8c21ea-f6ca-4771-8c3d-988ad6dc2f72",
      "type": "themes",
      "attributes": {
        "created_at": "2023-02-02T11:19:17+00:00",
        "updated_at": "2023-02-02T11:19:17+00:00",
        "name": "Official theme",
        "identifier": "0cfb936b-776a-43f2-91d8-ab85d2244aaf",
        "version": "1.0",
        "theme_type": "official",
        "description": null,
        "preview_image": "",
      ...
      "relationships": {
        "assets": {
          "links": {
            "related": "api/boomerang/assets?filter[theme_id]=1e8c21ea-f6ca-4771-8c3d-988ad6dc2f72"
          }
        },
        "original_theme": {
          "links": {
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "name": "New theme",
          "theme_id": "1dce79ca-84d5-4073-9cee-7fe1fc473a1c"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "06b62343-ac2f-4d6a-8def-ac941c01b4ce",
    "type": "themes",
    "attributes": {
      "created_at": "2023-02-02T11:19:17+00:00",
      "updated_at": "2023-02-02T11:19:17+00:00",
      "name": "Official theme",
      "identifier": "418cc1f5-e6de-4e39-9a22-05fe6e6e57f1",
      "version": null,
      "theme_type": "official",
      "description": null,
      "preview_image": "",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/themes/20b33fac-686b-4333-9fdd-84372588b772' \
    --header 'content-type: application/json' \
```
