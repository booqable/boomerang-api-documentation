...
```json
  ...
  "data": [
    {
      "id": "06e8f714-c527-4aad-9924-7535a9a4a462",
      "type": "themes",
      "attributes": {
        "created_at": "2023-03-10T08:40:54+00:00",
        "updated_at": "2023-03-10T08:40:54+00:00",
        "name": "Theme 9",
        "identifier": "5e951776-0fa7-4565-8556-7b2c217b5809",
        "version": "1.0",
        "theme_type": "official",
        "description": "A simple theme for setting up your shop",
        "preview_image": "",
        "theme_id": "8a23a7e6-e1c2-4195-8ff1-bfd7052e9cff",
        "installed": true
      },
      "relationships": {
        "assets": {
          "links": {
            "related": "api/boomerang/assets?filter[theme_id]=06e8f714-c527-4aad-9924-7535a9a4a462"
          }
        },
        "original_theme": {
          "links": {
            "related": "api/boomerang/themes/8a23a7e6-e1c2-4195-8ff1-bfd7052e9cff"
          }
        }
      }
    }
...
```json
  ...
  "data": [
    {
      "id": "24300de8-1cba-4917-a5d6-c1d4d44d909d",
      "type": "themes",
      "attributes": {
        "created_at": "2023-03-10T08:40:54+00:00",
        "updated_at": "2023-03-10T08:40:54+00:00",
        "name": "Official theme",
        "identifier": "9501a5cf-a2e1-44a7-8ae4-0364b1726fea",
        "version": "1.0",
        "theme_type": "official",
        "description": null,
        "preview_image": "",
      ...
      "relationships": {
        "assets": {
          "links": {
            "related": "api/boomerang/assets?filter[theme_id]=24300de8-1cba-4917-a5d6-c1d4d44d909d"
          }
        },
        "original_theme": {
          "links": {
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "name": "New theme",
          "theme_id": "65d7815f-680a-4179-90be-4cf10cc18200"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "5ba7b5c3-5659-421b-b8b9-f289bbc57a3c",
    "type": "themes",
    "attributes": {
      "created_at": "2023-03-10T08:40:55+00:00",
      "updated_at": "2023-03-10T08:40:55+00:00",
      "name": "Official theme",
      "identifier": "38f4894d-3375-46fe-aa4b-d3104d291db9",
      "version": null,
      "theme_type": "official",
      "description": null,
      "preview_image": "",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/themes/86bc1e5a-bbbf-4744-9abb-abe3f88f6872' \
    --header 'content-type: application/json' \
```
