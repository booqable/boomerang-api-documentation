...
Name | Description
-- | --
`new_product_group` | **[Product group](#product-groups)** `required`<br>The newly created ProductGroup.
`original_product_group` | **[Product group](#product-groups)** `required`<br>The ProductGroup to be duplicated.
...
`name` | **string** <br>Name of the newly created ProductGroup.
`new_product_group_id` | **uuid** `readonly`<br>The newly created ProductGroup.
`original_product_group_id` | **uuid** <br>The ProductGroup to be duplicated.
...
`data[attributes][name]` | **string** <br>Name of the newly created ProductGroup.
`data[attributes][original_product_group_id]` | **uuid** <br>The ProductGroup to be duplicated.
