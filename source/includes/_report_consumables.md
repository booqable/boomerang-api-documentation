...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/report_consumables?filter%5Bfrom%5D=2023-02-03+00%3A00%3A00+UTC&filter%5Btill%5D=2023-02-08+23%3A59%3A59+UTC' \
...
```json
  ...
  "data": [
    {
      "id": "6a97db78-a03e-4b96-bbbe-dcab04ce954b",
      "type": "report_consumables",
      "attributes": {
        "created_at": "2023-02-08T15:21:44+00:00",
        "name": "Product 52",
        "sold": 2,
        "returned": 0,
        "turnover_in_cents": 0,
        "returned_in_cents": 0,
        "product_id": "6a97db78-a03e-4b96-bbbe-dcab04ce954b"
      },
      "relationships": {
        "product": {
          "links": {
            "related": "api/boomerang/products/6a97db78-a03e-4b96-bbbe-dcab04ce954b"
          }
        }
      }
    }
