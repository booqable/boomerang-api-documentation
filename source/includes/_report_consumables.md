...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/report_consumables?filter%5Bfrom%5D=2023-01-14+00%3A00%3A00+UTC&filter%5Btill%5D=2023-01-19+23%3A59%3A59+UTC' \
...
```json
  ...
  "data": [
    {
      "id": "540b20cc-0297-466d-a84a-c3e9a6bd165e",
      "type": "report_consumables",
      "attributes": {
        "created_at": "2023-01-19T10:30:55+00:00",
        "name": "Product 51",
        "sold": 2,
        "returned": 0,
        "turnover_in_cents": 0,
        "returned_in_cents": 0,
        "product_id": "540b20cc-0297-466d-a84a-c3e9a6bd165e"
      },
      "relationships": {
        "product": {
          "links": {
            "related": "api/boomerang/products/540b20cc-0297-466d-a84a-c3e9a6bd165e"
          }
        }
      }
    }
