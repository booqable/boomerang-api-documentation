...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/report_consumables?filter%5Bfrom%5D=2022-09-30+00%3A00%3A00+UTC&filter%5Btill%5D=2022-10-05+23%3A59%3A59+UTC' \
...
```json
  ...
  "data": [
    {
      "id": "1eb8bae6-fdeb-4894-be7c-cb1bf481d7f6",
      "type": "report_consumables",
      "attributes": {
        "created_at": "2022-10-05T11:37:56+00:00",
        "name": "Product 38",
        "sold": 2,
        "returned": 0,
        "turnover_in_cents": 10000,
        "returned_in_cents": 0,
        "product_id": "1eb8bae6-fdeb-4894-be7c-cb1bf481d7f6"
      },
      "relationships": {
        "product": {
          "links": {
            "related": "api/boomerang/products/1eb8bae6-fdeb-4894-be7c-cb1bf481d7f6"
          }
        }
      }
    }
