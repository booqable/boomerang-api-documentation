...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/report_consumables?filter%5Bfrom%5D=2023-02-22+00%3A00%3A00+UTC&filter%5Btill%5D=2023-02-27+23%3A59%3A59+UTC' \
...
```json
  ...
  "data": [
    {
      "id": "c7602434-c75e-4b7b-86c1-8d410e8fb5f4",
      "type": "report_consumables",
      "attributes": {
        "created_at": "2023-02-27T10:17:58+00:00",
        "name": "Product 58",
        "sold": 2,
        "returned": 0,
        "turnover_in_cents": 0,
        "returned_in_cents": 0,
        "product_id": "c7602434-c75e-4b7b-86c1-8d410e8fb5f4"
      },
      "relationships": {
        "product": {
          "links": {
            "related": "api/boomerang/products/c7602434-c75e-4b7b-86c1-8d410e8fb5f4"
          }
        }
      }
    }
