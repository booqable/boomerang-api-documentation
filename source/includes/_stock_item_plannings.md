...
```json
  ...
  "data": [
    {
      "id": "62fdd810-8785-4f7d-ac44-0d0460cc01bc",
      "type": "stock_item_plannings",
      "attributes": {
        "created_at": "2022-05-04T10:06:49+00:00",
        "updated_at": "2022-05-04T10:06:49+00:00",
        "archived": false,
        "archived_at": null,
        "reserved": false,
        "started": false,
        "stopped": false,
        "stock_item_id": "587b0033-7c33-4fd5-9798-2780fcec03e5",
        "planning_id": "c94882a2-3b7e-4ac8-8adf-a6bc5999549f",
        "order_id": "807ca628-8285-4e5b-be9d-f36e331f48cf"
      },
      "relationships": {
        "stock_item": {
          "links": {
            "related": "api/boomerang/stock_items/587b0033-7c33-4fd5-9798-2780fcec03e5"
          }
        },
        "planning": {
          "links": {
            "related": "api/boomerang/plannings/c94882a2-3b7e-4ac8-8adf-a6bc5999549f"
          }
        },
        "order": {
          "links": {
            "related": "api/boomerang/orders/807ca628-8285-4e5b-be9d-f36e331f48cf"
          }
        }
      }
    }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/stock_item_plannings/0fcbe6e6-b963-485f-9037-fb4f7d0a1a25' \
    --header 'content-type: application/json' \
```
