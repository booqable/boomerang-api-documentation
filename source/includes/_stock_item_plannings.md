...
```json
  ...
  "data": [
    {
      "id": "ffd543b5-f588-4455-957d-8cb5f4893d7c",
      "type": "stock_item_plannings",
      "attributes": {
        "created_at": "2023-02-03T11:13:27+00:00",
        "updated_at": "2023-02-03T11:13:27+00:00",
        "archived": false,
        "archived_at": null,
        "reserved": false,
        "started": false,
        "stopped": false,
        "stock_item_id": "60dcaa73-e161-442a-b1aa-390b8f9694db",
        "planning_id": "7b3b1efa-8862-40d5-b868-e6411c98abc7",
        "order_id": "09e0bcf7-52df-4d58-b1cf-31aedd580b40"
      },
      "relationships": {
        "stock_item": {
          "links": {
            "related": "api/boomerang/stock_items/60dcaa73-e161-442a-b1aa-390b8f9694db"
          }
        },
        "planning": {
          "links": {
            "related": "api/boomerang/plannings/7b3b1efa-8862-40d5-b868-e6411c98abc7"
          }
        },
        "order": {
          "links": {
            "related": "api/boomerang/orders/09e0bcf7-52df-4d58-b1cf-31aedd580b40"
          }
        }
      }
    }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/stock_item_plannings/cbfebc8f-197d-43c8-8fab-26696107fe2e' \
    --header 'content-type: application/json' \
```
