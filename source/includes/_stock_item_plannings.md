...
```json
  ...
  "data": [
    {
      "id": "743d973a-46b1-4c69-8a5a-fe0426f7f0ba",
      ...
      "attributes": {
        ...
        "started": false,
        "stopped": false,
        "stock_item_id": "082e25df-866b-4ba6-9e38-d59c3be2feb0",
        "planning_id": "2e6391f5-4217-4816-b89d-336aee8db20c",
        "order_id": "54fd86af-c920-4282-90dd-fde7749fe4b8"
      },
      "relationships": {
        "stock_item": {
          "links": {
            "related": "api/boomerang/stock_items/082e25df-866b-4ba6-9e38-d59c3be2feb0"
          }
        },
        "planning": {
          "links": {
            "related": "api/boomerang/plannings/2e6391f5-4217-4816-b89d-336aee8db20c"
          }
        },
        "order": {
          "links": {
            "related": "api/boomerang/orders/54fd86af-c920-4282-90dd-fde7749fe4b8"
          }
        }
      }
    }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/stock_item_plannings/6670d370-9469-4df0-a30d-7a46ebd77696' \
    --header 'content-type: application/json' \
```
