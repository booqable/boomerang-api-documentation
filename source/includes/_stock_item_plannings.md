...
```json
  ...
  "data": [
    {
      "id": "84d61477-ba3b-4fae-8206-e136679b1fdf",
      "type": "stock_item_plannings",
      "attributes": {
        "created_at": "2023-02-21T16:25:16+00:00",
        "updated_at": "2023-02-21T16:25:16+00:00",
        "archived": false,
        "archived_at": null,
        "reserved": false,
        "started": false,
        "stopped": false,
        "stock_item_id": "2b937447-5ae3-45de-a7ac-33cade9a0d00",
        "planning_id": "9232f548-03a5-42e2-af00-1430ce9802fa",
        "order_id": "420888d6-1266-408e-a5ed-801d7fe3b9bd"
      },
      "relationships": {
        "stock_item": {
          "links": {
            "related": "api/boomerang/stock_items/2b937447-5ae3-45de-a7ac-33cade9a0d00"
          }
        },
        "planning": {
          "links": {
            "related": "api/boomerang/plannings/9232f548-03a5-42e2-af00-1430ce9802fa"
          }
        },
        "order": {
          "links": {
            "related": "api/boomerang/orders/420888d6-1266-408e-a5ed-801d7fe3b9bd"
          }
        }
      }
    }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/stock_item_plannings/e816c8b3-d6fb-4715-bde0-d4dbfa3ea8db' \
    --header 'content-type: application/json' \
```
