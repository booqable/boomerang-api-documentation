...
```json
  ...
  "data": [
    {
      "id": "964a1f99-9a47-4ca8-b3bd-98c2a7fdcca6",
      ...
      "attributes": {
        ...
        "started": false,
        "stopped": false,
        "stock_item_id": "9f0f07b9-4e0e-414a-a5fb-4e4e6ea7f437",
        "planning_id": "617b62a1-0026-4aa4-8d62-0a7b248c404a",
        "order_id": "5f4257f8-98f2-4b96-a360-b3aa0038bed6"
      },
      "relationships": {
        "stock_item": {
          "links": {
            "related": "api/boomerang/stock_items/9f0f07b9-4e0e-414a-a5fb-4e4e6ea7f437"
          }
        },
        "planning": {
          "links": {
            "related": "api/boomerang/plannings/617b62a1-0026-4aa4-8d62-0a7b248c404a"
          }
        },
        "order": {
          "links": {
            "related": "api/boomerang/orders/5f4257f8-98f2-4b96-a360-b3aa0038bed6"
          }
        }
      }
    }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/stock_item_plannings/966a0fe2-3158-471f-8833-85bf60ebaceb' \
    --header 'content-type: application/json' \
```
