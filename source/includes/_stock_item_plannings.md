...
```json
  ...
  "data": [
    {
      "id": "e0521418-3cf3-4eb6-8f96-6040f68a9d44",
      "type": "stock_item_plannings",
      "attributes": {
        "created_at": "2023-02-02T08:05:23+00:00",
        "updated_at": "2023-02-02T08:05:23+00:00",
        "archived": false,
        "archived_at": null,
        "reserved": false,
        "started": false,
        "stopped": false,
        "stock_item_id": "e015f317-5eaa-4265-b1e3-33a2b582418f",
        "planning_id": "3dbbf9cf-df02-4734-892a-427a6e0632cb",
        "order_id": "9b30b573-50bc-4fe6-bc30-339370022477"
      },
      "relationships": {
        "stock_item": {
          "links": {
            "related": "api/boomerang/stock_items/e015f317-5eaa-4265-b1e3-33a2b582418f"
          }
        },
        "planning": {
          "links": {
            "related": "api/boomerang/plannings/3dbbf9cf-df02-4734-892a-427a6e0632cb"
          }
        },
        "order": {
          "links": {
            "related": "api/boomerang/orders/9b30b573-50bc-4fe6-bc30-339370022477"
          }
        }
      }
    }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/stock_item_plannings/24eedf3b-ea2d-414a-adef-7acd09b4d9b1' \
    --header 'content-type: application/json' \
```
