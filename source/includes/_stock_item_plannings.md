...
```json
  ...
  "data": [
    {
      "id": "06b6480c-1b25-442f-9d30-ce6eac6295a7",
      "type": "stock_item_plannings",
      "attributes": {
        "created_at": "2023-02-06T19:00:55+00:00",
        "updated_at": "2023-02-06T19:00:55+00:00",
        "archived": false,
        "archived_at": null,
        "reserved": false,
        "started": false,
        "stopped": false,
        "stock_item_id": "8f94af2e-9596-4b1b-98c5-296873fc285c",
        "planning_id": "2e4e4753-a4ea-4085-a6b4-6fa6047683de",
        "order_id": "b1815685-ab0a-45ef-a035-035a7a9353ed"
      },
      "relationships": {
        "stock_item": {
          "links": {
            "related": "api/boomerang/stock_items/8f94af2e-9596-4b1b-98c5-296873fc285c"
          }
        },
        "planning": {
          "links": {
            "related": "api/boomerang/plannings/2e4e4753-a4ea-4085-a6b4-6fa6047683de"
          }
        },
        "order": {
          "links": {
            "related": "api/boomerang/orders/b1815685-ab0a-45ef-a035-035a7a9353ed"
          }
        }
      }
    }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/stock_item_plannings/0929633f-de3a-4d97-a4c8-53d9a2f7696c' \
    --header 'content-type: application/json' \
```
