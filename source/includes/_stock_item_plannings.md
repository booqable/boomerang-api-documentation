...
```json
  ...
  "data": [
    {
      "id": "25edf526-e634-4217-9760-624829263a60",
      "type": "stock_item_plannings",
      "attributes": {
        "created_at": "2023-02-02T19:30:07+00:00",
        "updated_at": "2023-02-02T19:30:07+00:00",
        "archived": false,
        "archived_at": null,
        "reserved": false,
        "started": false,
        "stopped": false,
        "stock_item_id": "62fe5f8f-2b2a-43ac-bf20-2ae1f02a4285",
        "planning_id": "2e0e26a5-4363-4400-bdef-982662c70359",
        "order_id": "09b33f03-d923-43d8-bdb1-b1ccbdd2a0b2"
      },
      "relationships": {
        "stock_item": {
          "links": {
            "related": "api/boomerang/stock_items/62fe5f8f-2b2a-43ac-bf20-2ae1f02a4285"
          }
        },
        "planning": {
          "links": {
            "related": "api/boomerang/plannings/2e0e26a5-4363-4400-bdef-982662c70359"
          }
        },
        "order": {
          "links": {
            "related": "api/boomerang/orders/09b33f03-d923-43d8-bdb1-b1ccbdd2a0b2"
          }
        }
      }
    }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/stock_item_plannings/e7e207cc-5d40-431e-b437-252e13f302c1' \
    --header 'content-type: application/json' \
```
