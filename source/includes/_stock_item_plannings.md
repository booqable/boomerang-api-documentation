...
```json
  ...
  "data": [
    {
      "id": "89080519-3186-4034-8611-71b7d503077b",
      ...
      "attributes": {
        ...
        "started": false,
        "stopped": false,
        "stock_item_id": "bfebc5c5-8949-4a50-9cbd-5e08961d52e5",
        "planning_id": "90b2e000-0363-4728-b531-09fc1b9eda3e",
        "order_id": "4cf2d695-e3f7-41a6-83a0-75f942a084b7"
      },
      "relationships": {
        "stock_item": {
          "links": {
            "related": "api/boomerang/stock_items/bfebc5c5-8949-4a50-9cbd-5e08961d52e5"
          }
        },
        "planning": {
          "links": {
            "related": "api/boomerang/plannings/90b2e000-0363-4728-b531-09fc1b9eda3e"
          }
        },
        "order": {
          "links": {
            "related": "api/boomerang/orders/4cf2d695-e3f7-41a6-83a0-75f942a084b7"
          }
        }
      }
    }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/stock_item_plannings/e6533588-6f7c-48b4-b7a6-d92f69e301d8' \
    --header 'content-type: application/json' \
```
