...
```json
  ...
  "data": [
    {
      "id": "df929a98-7762-4797-a175-324bc761f3d7",
      ...
      "attributes": {
        ...
        "started": false,
        "stopped": false,
        "stock_item_id": "edb14dc8-e23a-46ef-a279-5b2e7078c791",
        "planning_id": "c1060b59-5ec8-4180-a775-46dcf391fe15",
        "order_id": "86e551c6-88c2-45c6-9db5-34ea79b204bd"
      },
      "relationships": {
        "stock_item": {
          "links": {
            "related": "api/boomerang/stock_items/edb14dc8-e23a-46ef-a279-5b2e7078c791"
          }
        },
        "planning": {
          "links": {
            "related": "api/boomerang/plannings/c1060b59-5ec8-4180-a775-46dcf391fe15"
          }
        },
        "order": {
          "links": {
            "related": "api/boomerang/orders/86e551c6-88c2-45c6-9db5-34ea79b204bd"
          }
        }
      }
    }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/stock_item_plannings/076e5bf0-6a09-4a5d-b885-eaa6334543fb' \
    --header 'content-type: application/json' \
```
