...
```json
  ...
  "data": [
    {
      "id": "4db4d5de-145e-4b16-b6bb-9eea54e391d1",
      "type": "stock_item_plannings",
      "attributes": {
        "created_at": "2022-01-12T10:15:08+00:00",
        "updated_at": "2022-01-12T10:15:08+00:00",
        "reserved": false,
        "started": false,
        "stopped": false,
        "stock_item_id": "db9732e3-72d7-4272-b20f-cbec0544b8b6",
        "planning_id": "7c5b557d-5e18-429b-ba99-98f8cf31396c",
        "order_id": "c152cefa-430e-44e4-8657-6a5fdbaf8950"
      },
      "relationships": {
        "stock_item": {
          "links": {
            "related": "api/boomerang/stock_items/db9732e3-72d7-4272-b20f-cbec0544b8b6"
          }
        },
        "planning": {
          "links": {
            "related": "api/boomerang/plannings/7c5b557d-5e18-429b-ba99-98f8cf31396c"
          }
        },
        "order": {
          "links": {
            "related": "api/boomerang/orders/c152cefa-430e-44e4-8657-6a5fdbaf8950"
          }
        }
      }
    }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/stock_item_plannings/bd0cae48-aaed-48b4-a391-205a13a0dd61' \
    --header 'content-type: application/json' \
```
