...
```json
  {
  "data": {
    "id": "b065335b-0a78-4b5c-9b40-71033478a68f",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-02-01T15:17:55+00:00",
      "updated_at": "2023-02-01T15:17:55+00:00",
      "kind": "apn",
      "environment": "production"
    }
  },
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/ea58f2ad-1275-40ae-bc0f-2362ef424b86' \
    --header 'content-type: application/json' \
```
