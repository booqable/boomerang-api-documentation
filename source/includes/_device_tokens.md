...
```json
  {
  "data": {
    "id": "db36ee57-ddfe-40c4-a261-01ca171dce61",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-02-22T14:13:14+00:00",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/e54f64a0-e80e-40a3-a0f5-e83814332664' \
    --header 'content-type: application/json' \
```
