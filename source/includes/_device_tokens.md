...
```json
  {
  "data": {
    "id": "25cd1871-5959-4616-8a92-077711ed31f0",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-02-02T14:26:10+00:00",
      "updated_at": "2023-02-02T14:26:10+00:00",
      "kind": "apn",
      "environment": "production"
    }
  },
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/6dcd9b61-6d67-4587-a09a-02fd2c906d1c' \
    --header 'content-type: application/json' \
```
