...
```json
  {
  "data": {
    "id": "7249282a-05b0-467f-856b-d33769d4f3ae",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2022-05-03T10:18:26+00:00",
      "updated_at": "2022-05-03T10:18:26+00:00",
      "kind": "apn",
      "environment": "production"
    }
  },
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/8b984aac-97bc-4a50-a7fe-38a7c65b3691' \
    --header 'content-type: application/json' \
```
