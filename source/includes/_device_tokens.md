...
```json
  {
  "data": {
    "id": "33a00a24-a229-45ce-aae6-5d8d95fbafea",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2022-07-21T10:56:32+00:00",
      "updated_at": "2022-07-21T10:56:32+00:00",
      "kind": "apn",
      "environment": "production"
    }
  },
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/e6767e69-71ed-43a8-81d4-d30fd395a742' \
    --header 'content-type: application/json' \
```
