...
```json
  {
  "data": {
    "id": "502de47e-8015-4905-9efd-a510018558e4",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-02-06T19:28:58+00:00",
      "updated_at": "2023-02-06T19:28:58+00:00",
      "kind": "apn",
      "environment": "production"
    }
  },
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/952ff294-02b4-45f2-a42d-5dc0d000b1a2' \
    --header 'content-type: application/json' \
```
