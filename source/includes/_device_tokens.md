...
```json
  {
  "data": {
    "id": "df7d01ad-edad-43bc-8954-324e3021fd39",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-02-08T09:44:47+00:00",
      "updated_at": "2023-02-08T09:44:47+00:00",
      "kind": "apn",
      "environment": "production"
    }
  },
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/d1ae1bf2-cfad-43c8-b5d6-2399407cbebd' \
    --header 'content-type: application/json' \
```
