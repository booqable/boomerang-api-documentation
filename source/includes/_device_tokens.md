...
```json
  {
  "data": {
    "id": "e6d8ae6d-5a09-43a1-b706-d7cb02cca801",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-03-07T07:56:17+00:00",
      "updated_at": "2023-03-07T07:56:17+00:00",
      "kind": "apn",
      "environment": "production",
      "version": 3
    }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/9fb1d4c5-1e42-43db-a81f-a1cfccedf44e' \
    --header 'content-type: application/json' \
```
