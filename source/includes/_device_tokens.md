...
```json
  {
  "data": {
    "id": "24b93dda-d248-4578-bd7f-005c6f214abd",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-02-02T16:28:53+00:00",
      "updated_at": "2023-02-02T16:28:53+00:00",
      "kind": "apn",
      "environment": "production"
    }
  },
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/9a00ad0a-5fa3-499e-8362-5c49d0efba99' \
    --header 'content-type: application/json' \
```
