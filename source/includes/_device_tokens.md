...
```json
  {
  "data": {
    "id": "17b0ab86-7c30-4bd1-92ca-45a9ef07bbd0",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-02-21T16:14:03+00:00",
      "updated_at": "2023-02-21T16:14:03+00:00",
      "kind": "apn",
      "environment": "production",
      "version": 3
    }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/fd44cf9e-f2a5-4346-8d4f-97518d13dad8' \
    --header 'content-type: application/json' \
```
