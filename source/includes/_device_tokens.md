...
```json
  {
  "data": {
    "id": "ed116f04-0272-4e0b-9eea-b5572f5fa1a0",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-02-14T13:01:26+00:00",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/45c9113f-de01-46c5-88a6-055206330f10' \
    --header 'content-type: application/json' \
```
