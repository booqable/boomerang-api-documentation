...
```json
  {
  "data": {
    "id": "50685a85-0d95-47ad-ab9b-5b76d7715963",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2022-11-16T14:31:00+00:00",
      "updated_at": "2022-11-16T14:31:00+00:00",
      "kind": "apn",
      "environment": "production"
    }
  },
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/04cd74d3-4aa5-446b-9eec-dd93a203e834' \
    --header 'content-type: application/json' \
```
