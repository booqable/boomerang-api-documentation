...
```json
  {
  "data": {
    "id": "ce77885b-d228-4f81-b29a-0367072bf625",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-02-09T13:05:57+00:00",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/bda6817c-af02-486e-9544-835c5572f7b4' \
    --header 'content-type: application/json' \
```
