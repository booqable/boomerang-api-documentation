...
```json
  {
  "data": {
    "id": "1311cdc1-22f7-4501-af2d-64797b66b30d",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-02-09T13:00:00+00:00",
      "updated_at": "2023-02-09T13:00:00+00:00",
      "kind": "apn",
      "environment": "production",
      "version": 3
    }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/718ae0e2-9fdc-4f2c-aa37-d9c47aa562e1' \
    --header 'content-type: application/json' \
```
