...
```json
  {
  "data": {
    "id": "357957c0-b659-4194-9d02-b2c3fe111e20",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-02-23T13:50:31+00:00",
      "updated_at": "2023-02-23T13:50:31+00:00",
      "kind": "apn",
      "environment": "production",
      "version": 3
    }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/4e872757-aeed-4349-a467-5f7cbe7df7fb' \
    --header 'content-type: application/json' \
```
