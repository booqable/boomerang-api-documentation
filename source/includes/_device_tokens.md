...
```json
  {
  "data": {
    "id": "f14d04cb-2599-4017-adf3-39ea200176ae",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-02-16T22:55:49+00:00",
      "updated_at": "2023-02-16T22:55:49+00:00",
      "kind": "apn",
      "environment": "production",
      "version": 3
    }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/ff0f6bc4-1db5-477e-84f6-bb06c401331b' \
    --header 'content-type: application/json' \
```
