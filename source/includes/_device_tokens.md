...
```json
  {
  "data": {
    "id": "5f69642c-4453-4d26-a003-78d2c7ffdfde",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-02-27T10:46:13+00:00",
      "updated_at": "2023-02-27T10:46:13+00:00",
      "kind": "apn",
      "environment": "production",
      "version": 3
    }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/7e052cb3-be6d-4d50-8b90-effedb5e6256' \
    --header 'content-type: application/json' \
```
