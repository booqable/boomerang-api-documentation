...
```json
  {
  "data": {
    "id": "18b828b7-87e6-4cda-91ba-51f409c88068",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-03-02T09:23:55+00:00",
      "updated_at": "2023-03-02T09:23:55+00:00",
      "kind": "apn",
      "environment": "production",
      "version": 3
    }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/645c5299-17ce-4dde-a3a8-c709e6e947f2' \
    --header 'content-type: application/json' \
```
