...
```json
  {
  "data": {
    "id": "ccf86592-a0d9-46a0-96be-dd40821a5c06",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-02-16T09:14:46+00:00",
      "updated_at": "2023-02-16T09:14:46+00:00",
      "kind": "apn",
      "environment": "production",
      "version": 3
    }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/2c2bf406-fe27-4990-91e5-63f5d667849e' \
    --header 'content-type: application/json' \
```
