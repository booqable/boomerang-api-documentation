...
```json
  {
  "data": {
    "id": "20f30652-e2c1-4731-9fe3-247042ed3bf6",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-01-25T12:34:38+00:00",
      "updated_at": "2023-01-25T12:34:38+00:00",
      "kind": "apn",
      "environment": "production"
    }
  },
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/f3cbae45-dcdc-4691-8f31-cf9eddc1df47' \
    --header 'content-type: application/json' \
```
