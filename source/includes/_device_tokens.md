...
```json
  {
  "data": {
    "id": "449ea269-1b1e-47a7-914a-b6cb70045520",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-02-10T11:15:35+00:00",
      "updated_at": "2023-02-10T11:15:35+00:00",
      "kind": "apn",
      "environment": "production",
      "version": 3
    }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/a378e7bd-a7e0-4310-a350-2ce6952d7dad' \
    --header 'content-type: application/json' \
```
