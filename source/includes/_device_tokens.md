...
```json
  {
  "data": {
    "id": "2cb70cbe-e7f9-4afa-9e6a-18fcbf05b418",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-02-23T13:36:37+00:00",
      "updated_at": "2023-02-23T13:36:37+00:00",
      "kind": "apn",
      "environment": "production",
      "version": 3
    }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/cfec8d17-7ee4-4ab6-a881-0dcd9a1cd1c4' \
    --header 'content-type: application/json' \
```
