...
```json
  {
  "data": {
    "id": "f37a8cc9-f39f-4e22-8d7e-19b669443258",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-02-15T13:21:58+00:00",
      "updated_at": "2023-02-15T13:21:58+00:00",
      "kind": "apn",
      "environment": "production",
      "version": 3
    }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/253abb86-1efd-42dd-893f-bd34afa4305e' \
    --header 'content-type: application/json' \
```
