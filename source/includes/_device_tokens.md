...
```json
  {
  "data": {
    "id": "bb16521f-c47a-4572-a9c5-5694bdb81f72",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-02-16T08:12:24+00:00",
      "updated_at": "2023-02-16T08:12:24+00:00",
      "kind": "apn",
      "environment": "production",
      "version": 3
    }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/53b494b4-526e-455e-b1bd-76d31db84f28' \
    --header 'content-type: application/json' \
```
