...
```json
  {
  "data": {
    "id": "c10f9b36-9c13-4d48-89d3-90e3e0488ccc",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2022-07-13T11:18:19+00:00",
      "updated_at": "2022-07-13T11:18:19+00:00",
      "kind": "apn",
      "environment": "production"
    }
  },
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/528c7742-b637-4723-9a1d-8976e4eb6b65' \
    --header 'content-type: application/json' \
```
