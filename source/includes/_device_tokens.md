...
```json
  {
  "data": {
    "id": "d4596cf5-361f-4c38-97d9-40d1091e11d2",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-02-01T12:59:44+00:00",
      "updated_at": "2023-02-01T12:59:44+00:00",
      "kind": "apn",
      "environment": "production"
    }
  },
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/dda104e9-602b-4fa9-b87a-38816156c906' \
    --header 'content-type: application/json' \
```
