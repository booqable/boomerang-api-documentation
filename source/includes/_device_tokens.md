...
```json
  {
  "data": {
    "id": "2acce0b8-bf35-4d56-b644-8e1fbdd688af",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2022-06-30T12:41:13+00:00",
      "updated_at": "2022-06-30T12:41:13+00:00",
      "kind": "apn",
      "environment": "production"
    }
  },
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/4b3258e8-756d-40fb-b54a-9a6545a29797' \
    --header 'content-type: application/json' \
```
