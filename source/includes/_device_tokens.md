...
```json
  {
  "data": {
    "id": "bb5e0f4d-9927-43ac-8d46-50bb1875236b",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-02-07T15:18:04+00:00",
      "updated_at": "2023-02-07T15:18:04+00:00",
      "kind": "apn",
      "environment": "production"
    }
  },
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/1452a788-ccf3-41b0-a162-2248fdfdc019' \
    --header 'content-type: application/json' \
```
