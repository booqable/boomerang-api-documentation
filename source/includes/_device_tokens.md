...
```json
  {
  "data": {
    "id": "38d0621c-5c8e-4e5e-9588-edfb24f63c4d",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-02-03T11:09:53+00:00",
      "updated_at": "2023-02-03T11:09:53+00:00",
      "kind": "apn",
      "environment": "production"
    }
  },
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/738226fd-e865-4da3-846e-11fdcbc53d65' \
    --header 'content-type: application/json' \
```
