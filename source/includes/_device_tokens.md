...
```json
  {
  "data": {
    "id": "a9d524b4-cc8e-4ea7-8e2f-cbba0e9512a5",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-03-07T11:35:29+00:00",
      "updated_at": "2023-03-07T11:35:29+00:00",
      "kind": "apn",
      "environment": "production",
      "version": 3
    }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/b38bc53f-ca46-4876-9483-1f0a271342f2' \
    --header 'content-type: application/json' \
```
