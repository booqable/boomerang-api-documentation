...
```json
  {
  "data": {
    "id": "0326f5b2-48f2-426b-8f62-9f4c34652ddc",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-02-08T13:00:40+00:00",
      "updated_at": "2023-02-08T13:00:40+00:00",
      "kind": "apn",
      "environment": "production"
    }
  },
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/d6132874-8969-4cc4-9550-bf59b24540aa' \
    --header 'content-type: application/json' \
```
