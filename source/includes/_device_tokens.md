...
```json
  {
  "data": {
    "id": "833b3450-98cc-4b10-921a-7cf3ed071450",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-03-10T08:37:27+00:00",
      "updated_at": "2023-03-10T08:37:27+00:00",
      "kind": "apn",
      "environment": "production",
      "version": 3
    }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/7eb15c36-6fb8-4f9b-8067-b24308dabbb6' \
    --header 'content-type: application/json' \
```
