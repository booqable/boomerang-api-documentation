...
```json
  {
  "data": {
    "id": "e2f70364-c1cf-4596-a175-c5c50eda9192",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-02-14T11:04:13+00:00",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/7264e138-f9ae-4279-aae3-388581de0ac5' \
    --header 'content-type: application/json' \
```
