...
```json
  {
  "data": {
    "id": "53c00ce9-ce32-4ffa-b0f4-bc5e3e7858e4",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-03-01T10:30:59+00:00",
      "updated_at": "2023-03-01T10:30:59+00:00",
      "kind": "apn",
      "environment": "production",
      "version": 3
    }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/6c9ee46e-603e-4e8c-9a1d-9447766cfdc9' \
    --header 'content-type: application/json' \
```
