...
```json
  {
  "data": {
    "id": "47d23eab-13b9-4d01-b16e-52da7af5929a",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2022-07-14T14:26:58+00:00",
      "updated_at": "2022-07-14T14:26:58+00:00",
      "kind": "apn",
      "environment": "production"
    }
  },
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/561b9d0b-d571-4c59-875d-94e616b39f69' \
    --header 'content-type: application/json' \
```
