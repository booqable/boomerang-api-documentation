...
```json
  {
  "data": {
    "id": "30126dfb-f25a-49e8-a359-9bf7f8d03cbf",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2022-07-19T12:35:41+00:00",
      "updated_at": "2022-07-19T12:35:41+00:00",
      "kind": "apn",
      "environment": "production"
    }
  },
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/160189ab-0075-465a-a3bc-2c2b9922a506' \
    --header 'content-type: application/json' \
```
