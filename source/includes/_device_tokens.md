...
```json
  {
  "data": {
    "id": "db0ef27d-3706-4a53-a87f-90c8eafc5a14",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2022-12-09T08:12:43+00:00",
      "updated_at": "2022-12-09T08:12:43+00:00",
      "kind": "apn",
      "environment": "production"
    }
  },
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/8f224296-6c55-4235-90b7-76cd27961ec1' \
    --header 'content-type: application/json' \
```
