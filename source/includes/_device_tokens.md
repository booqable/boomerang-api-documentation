...
```json
  {
  "data": {
    "id": "18b00ace-aefd-4843-b67f-6418d7cc8bfd",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-03-09T10:27:12+00:00",
      "updated_at": "2023-03-09T10:27:12+00:00",
      "kind": "apn",
      "environment": "production",
      "version": 3
    }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/031eb6a4-af50-4532-a52a-0f41fd207db0' \
    --header 'content-type: application/json' \
```
