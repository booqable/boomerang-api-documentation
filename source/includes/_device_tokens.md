...
```json
  {
  "data": {
    "id": "d2a622b3-5adb-4188-83f5-2a6349dc3bb2",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-01-26T10:19:49+00:00",
      "updated_at": "2023-01-26T10:19:49+00:00",
      "kind": "apn",
      "environment": "production"
    }
  },
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/7eded5be-8032-47e4-aa1e-9baf2c5629e4' \
    --header 'content-type: application/json' \
```
