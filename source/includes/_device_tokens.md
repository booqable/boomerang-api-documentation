...
```json
  {
  "data": {
    "id": "f61699c7-7d36-4f87-abf6-d4baad1e65bd",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-02-24T14:56:47+00:00",
      "updated_at": "2023-02-24T14:56:47+00:00",
      "kind": "apn",
      "environment": "production",
      "version": 3
    }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/537082cb-2f1d-4cd5-854a-0c08250f3580' \
    --header 'content-type: application/json' \
```
