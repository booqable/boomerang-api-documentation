...
```json
  {
  "data": {
    "id": "f8067d2b-980a-4c0e-917e-ba3ea34fffc9",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-02-02T15:25:19+00:00",
      "updated_at": "2023-02-02T15:25:19+00:00",
      "kind": "apn",
      "environment": "production"
    }
  },
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/c9a17ea8-a778-45d4-aba0-b681b6b6e0bb' \
    --header 'content-type: application/json' \
```
