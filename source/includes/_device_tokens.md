...
```json
  {
  "data": {
    "id": "3346ce09-522c-474f-baea-f2a81bc63565",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-02-09T11:06:46+00:00",
      "updated_at": "2023-02-09T11:06:46+00:00",
      "kind": "apn",
      "environment": "production",
      "version": 3
    }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/6fe99fce-2896-46ca-a696-dc0ceaff0b37' \
    --header 'content-type: application/json' \
```
