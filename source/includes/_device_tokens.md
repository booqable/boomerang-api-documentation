...
```json
  {
  "data": {
    "id": "cd8c9e12-71a8-44b5-8409-855196e17625",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2022-10-12T12:57:06+00:00",
      "updated_at": "2022-10-12T12:57:06+00:00",
      "kind": "apn",
      "environment": "production"
    }
  },
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/76e7721f-3d48-4a0d-94bd-edad9b41d21f' \
    --header 'content-type: application/json' \
```
