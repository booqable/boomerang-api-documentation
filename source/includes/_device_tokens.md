...
```json
  {
  "data": {
    "id": "72bfde46-a3dd-4dfe-8bb9-5f74fbd6d063",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-03-07T08:08:24+00:00",
      "updated_at": "2023-03-07T08:08:24+00:00",
      "kind": "apn",
      "environment": "production",
      "version": 3
    }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/74b557a5-62c5-4f16-847e-53d08b8e2350' \
    --header 'content-type: application/json' \
```
