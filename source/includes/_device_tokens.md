...
```json
  {
  "data": {
    "id": "8456be20-4478-4bd3-a309-21dda0908789",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-02-24T08:42:23+00:00",
      "updated_at": "2023-02-24T08:42:23+00:00",
      "kind": "apn",
      "environment": "production",
      "version": 3
    }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/8c45c314-f0ff-471f-b341-49e9c5a5625a' \
    --header 'content-type: application/json' \
```
