...
```json
  {
  "data": {
    "id": "f8c0de6a-a861-4c2f-9197-a8f721072fb1",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-02-09T14:21:47+00:00",
      "updated_at": "2023-02-09T14:21:47+00:00",
      "kind": "apn",
      "environment": "production",
      "version": 3
    }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/773b18e9-679c-4cec-8921-ead05a2252a6' \
    --header 'content-type: application/json' \
```
