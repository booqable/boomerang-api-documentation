...
```json
  {
  "data": {
    "id": "808d4b31-576e-4b67-b0cb-48b90cb088e1",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-02-09T09:27:09+00:00",
      "updated_at": "2023-02-09T09:27:09+00:00",
      "kind": "apn",
      "environment": "production",
      "version": 3
    }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/43f0b4b8-e2f1-49c3-88ec-2207b5666ad9' \
    --header 'content-type: application/json' \
```
