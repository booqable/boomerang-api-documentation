...
```json
  {
  "data": {
    "id": "9c25c034-33ba-4780-9f00-28716a91ca57",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-02-22T11:52:04+00:00",
      "updated_at": "2023-02-22T11:52:04+00:00",
      "kind": "apn",
      "environment": "production",
      "version": 3
    }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/4b94947c-e331-4504-94f7-9a2aa37c5603' \
    --header 'content-type: application/json' \
```
