...
```json
  {
  "data": {
    "id": "8286c84f-370c-4052-ae79-23971646783c",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-02-01T15:14:28+00:00",
      "updated_at": "2023-02-01T15:14:28+00:00",
      "kind": "apn",
      "environment": "production"
    }
  },
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/ffdedc26-a349-489b-a40a-25882d47b10f' \
    --header 'content-type: application/json' \
```
