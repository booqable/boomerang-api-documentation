...
```json
  {
  "data": {
    "id": "0837a607-3450-4127-b467-12b57d8d133d",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-02-08T08:35:29+00:00",
      "updated_at": "2023-02-08T08:35:29+00:00",
      "kind": "apn",
      "environment": "production"
    }
  },
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/c8b00a27-2350-44fd-98a4-7f62af7b2fef' \
    --header 'content-type: application/json' \
```
