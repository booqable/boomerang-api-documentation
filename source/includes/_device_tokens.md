...
```json
  {
  "data": {
    "id": "e5b3f4b8-fd9e-4e81-bf19-b188748b9a27",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-02-14T15:26:51+00:00",
      "updated_at": "2023-02-14T15:26:51+00:00",
      "kind": "apn",
      "environment": "production",
      "version": 3
    }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/e96f15e3-5548-4f14-a5b8-a7bbf6474123' \
    --header 'content-type: application/json' \
```
