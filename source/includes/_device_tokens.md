...
```json
  {
  "data": {
    "id": "f02a7553-013a-4a13-a7ba-4d5a99de7b5c",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-02-08T14:59:45+00:00",
      "updated_at": "2023-02-08T14:59:45+00:00",
      "kind": "apn",
      "environment": "production",
      "version": 3
    }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/58d5dd06-9524-4f62-86c2-860af7566077' \
    --header 'content-type: application/json' \
```
