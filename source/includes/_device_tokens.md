...
```json
  {
  "data": {
    "id": "bc612891-d817-4f17-9c88-8d229cbbfd56",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-02-16T15:35:12+00:00",
      "updated_at": "2023-02-16T15:35:12+00:00",
      "kind": "apn",
      "environment": "production",
      "version": 3
    }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/a9f05b5c-8505-4ec3-ba99-61290d126789' \
    --header 'content-type: application/json' \
```
