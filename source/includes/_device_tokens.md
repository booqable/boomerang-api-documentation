...
```json
  {
  "data": {
    "id": "3d3cf586-592e-4357-8eb2-c1a9a7b9fdb3",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-03-07T12:10:04+00:00",
      "updated_at": "2023-03-07T12:10:04+00:00",
      "kind": "apn",
      "environment": "production",
      "version": 3
    }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/629402ba-4010-485f-ba2e-0e057b919b7e' \
    --header 'content-type: application/json' \
```
