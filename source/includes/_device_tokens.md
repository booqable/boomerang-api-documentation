...
```json
  {
  "data": {
    "id": "0fd61f72-689a-4346-9566-897cb90a8a19",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2022-05-19T13:58:03+00:00",
      "updated_at": "2022-05-19T13:58:03+00:00",
      "kind": "apn",
      "environment": "production"
    }
  },
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/59ed697c-ee81-414b-93a7-db1d59367ae2' \
    --header 'content-type: application/json' \
```
