...
```json
  {
  "data": {
    "id": "ca478ce2-3c35-42fa-828e-a4342e3869af",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-02-08T16:17:46+00:00",
      "updated_at": "2023-02-08T16:17:46+00:00",
      "kind": "apn",
      "environment": "production",
      "version": 3
    }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/b6061afd-831e-421e-9a1a-643ba8ffd89d' \
    --header 'content-type: application/json' \
```
