...
```json
  {
  "data": {
    "id": "7aa64d25-055f-4612-a4c8-ca6d30d29394",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-02-23T00:24:01+00:00",
      "updated_at": "2023-02-23T00:24:01+00:00",
      "kind": "apn",
      "environment": "production",
      "version": 3
    }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/d0ab05fe-552e-4188-b9b9-e61dc21ea382' \
    --header 'content-type: application/json' \
```
