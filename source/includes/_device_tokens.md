...
```json
  {
  "data": {
    "id": "b739ecc3-ad2b-4c80-ac8f-1eb88780afb1",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-03-08T09:40:35+00:00",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/20093660-9241-49a8-80b3-da90d22c628f' \
    --header 'content-type: application/json' \
```
