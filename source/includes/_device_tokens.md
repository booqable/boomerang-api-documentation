...
```json
  {
  "data": {
    "id": "f8d97dd6-67a9-466d-8c9f-38165ed5f34d",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2022-07-14T12:00:33+00:00",
      "updated_at": "2022-07-14T12:00:33+00:00",
      "kind": "apn",
      "environment": "production"
    }
  },
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/0b7a200f-5335-452d-8a7f-e214dba46a15' \
    --header 'content-type: application/json' \
```
