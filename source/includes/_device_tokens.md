...
```json
  {
  "data": {
    "id": "71f080e5-9fa9-4613-b8ac-0bcef4c939d2",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-02-28T08:11:09+00:00",
      "updated_at": "2023-02-28T08:11:09+00:00",
      "kind": "apn",
      "environment": "production",
      "version": 3
    }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/bd99f38f-f93a-4cd8-b614-d924596d96ea' \
    --header 'content-type: application/json' \
```
