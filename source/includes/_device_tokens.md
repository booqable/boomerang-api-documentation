...
```json
  {
  "data": {
    "id": "70108e7b-70a8-479a-8b47-90d286161b9a",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-03-02T13:54:56+00:00",
      "updated_at": "2023-03-02T13:54:56+00:00",
      "kind": "apn",
      "environment": "production",
      "version": 3
    }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/83c7a556-1a2c-4a7c-b0d3-ffde5ac410b9' \
    --header 'content-type: application/json' \
```
