...
```json
  {
  "data": {
    "id": "4500e055-f260-4c4e-b994-28fe74a317e3",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2022-08-19T07:56:08+00:00",
      "updated_at": "2022-08-19T07:56:08+00:00",
      "kind": "apn",
      "environment": "production"
    }
  },
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/0b45a4e7-269b-4a82-8195-1004956e5501' \
    --header 'content-type: application/json' \
```
