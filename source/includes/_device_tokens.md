...
```json
  {
  "data": {
    "id": "ea3d2038-b987-4e5c-a104-6b453a5e6450",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2022-07-14T10:49:10+00:00",
      "updated_at": "2022-07-14T10:49:10+00:00",
      "kind": "apn",
      "environment": "production"
    }
  },
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/e3d66003-a1dd-4142-89e9-14254f45344a' \
    --header 'content-type: application/json' \
```
