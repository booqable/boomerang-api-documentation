...
```json
  {
  "data": {
    "id": "4db034bc-c6ff-465e-a6a9-80113b1a6d6c",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-02-14T12:46:13+00:00",
      "updated_at": "2023-02-14T12:46:13+00:00",
      "kind": "apn",
      "environment": "production",
      "version": 3
    }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/4ec64b57-3a7b-492f-99d2-edc7c56b7a4c' \
    --header 'content-type: application/json' \
```
