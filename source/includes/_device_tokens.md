...
```json
  {
  "data": {
    "id": "251680e9-81a5-4cd2-8944-4dee00d67a8e",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-02-07T14:32:41+00:00",
      "updated_at": "2023-02-07T14:32:41+00:00",
      "kind": "apn",
      "environment": "production"
    }
  },
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/daed88d6-b31e-4385-b122-2342798034c4' \
    --header 'content-type: application/json' \
```
