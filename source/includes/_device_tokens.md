...
```json
  {
  "data": {
    "id": "2538a097-644a-4f0f-ae4f-3b8b6cf6eca7",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2022-11-03T11:06:14+00:00",
      "updated_at": "2022-11-03T11:06:14+00:00",
      "kind": "apn",
      "environment": "production"
    }
  },
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/ffc01a94-db93-4b9f-a128-75ea688d26b7' \
    --header 'content-type: application/json' \
```
