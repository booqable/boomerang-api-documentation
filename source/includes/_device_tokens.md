...
```json
  {
  "data": {
    "id": "5351d197-ad01-4a04-b433-6c333faa5e07",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-02-13T12:52:52+00:00",
      "updated_at": "2023-02-13T12:52:52+00:00",
      "kind": "apn",
      "environment": "production",
      "version": 3
    }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/c39ab803-fd8c-4537-bd75-35e53bdbb1e6' \
    --header 'content-type: application/json' \
```
