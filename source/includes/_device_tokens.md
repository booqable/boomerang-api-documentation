...
```json
  {
  "data": {
    "id": "e003b651-bf90-4d4e-9ab2-dabcf4d342c0",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-02-03T08:14:24+00:00",
      "updated_at": "2023-02-03T08:14:24+00:00",
      "kind": "apn",
      "environment": "production"
    }
  },
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/aa2ae83d-895c-4992-a855-c92116392267' \
    --header 'content-type: application/json' \
```
