...
```json
  {
  "data": {
    "id": "603a58ee-efdb-4993-bcf1-75e52d45cddb",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2022-11-22T15:32:25+00:00",
      "updated_at": "2022-11-22T15:32:25+00:00",
      "kind": "apn",
      "environment": "production"
    }
  },
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/f3afcf34-1b6f-4494-9ebd-1c972f99edf1' \
    --header 'content-type: application/json' \
```
