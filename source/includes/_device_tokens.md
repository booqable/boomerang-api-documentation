...
```json
  {
  "data": {
    "id": "9562f434-d6d9-413b-9b84-bedee612d70b",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2022-06-30T09:44:43+00:00",
      "updated_at": "2022-06-30T09:44:43+00:00",
      "kind": "apn",
      "environment": "production"
    }
  },
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/94c7dd71-1a7c-4382-a882-08486b442b6b' \
    --header 'content-type: application/json' \
```
