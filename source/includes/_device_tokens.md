...
```json
  {
  "data": {
    "id": "516cd70e-445a-40c3-8702-5177e4a81335",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-02-17T13:25:59+00:00",
      "updated_at": "2023-02-17T13:25:59+00:00",
      "kind": "apn",
      "environment": "production",
      "version": 3
    }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/9e394bd0-de06-4dd2-a0bf-d19029a81b22' \
    --header 'content-type: application/json' \
```
