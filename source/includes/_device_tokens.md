...
```json
  {
  "data": {
    "id": "1403ea05-d0a1-4421-a601-020f4674fcd8",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-03-08T09:18:30+00:00",
      "updated_at": "2023-03-08T09:18:30+00:00",
      "kind": "apn",
      "environment": "production",
      "version": 3
    }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/eed04a15-e3bf-4450-a5a8-1cea858beffb' \
    --header 'content-type: application/json' \
```
