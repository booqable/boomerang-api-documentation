...
```json
  {
  "data": {
    "id": "911593e6-cab0-4a24-80ef-c0d26f4cc7d0",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2022-06-07T06:51:13+00:00",
      "updated_at": "2022-06-07T06:51:13+00:00",
      "kind": "apn",
      "environment": "production"
    }
  },
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/c0cd85e7-a3db-44ef-b940-31f241ab3fd5' \
    --header 'content-type: application/json' \
```
