...
```json
  {
  "data": {
    "id": "af721a14-af17-46ac-9795-91f62b62e37a",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-02-09T12:18:07+00:00",
      "updated_at": "2023-02-09T12:18:07+00:00",
      "kind": "apn",
      "environment": "production",
      "version": 3
    }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/2e588b35-2269-48e0-9a72-a73ee38fa076' \
    --header 'content-type: application/json' \
```
