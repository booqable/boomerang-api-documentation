...
```json
  {
  "data": {
    "id": "9f754993-9b8f-4409-ba39-78eb0eb2909b",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-02-06T08:39:47+00:00",
      "updated_at": "2023-02-06T08:39:47+00:00",
      "kind": "apn",
      "environment": "production"
    }
  },
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/d5e766bf-1fc8-484c-b359-7d3628af604d' \
    --header 'content-type: application/json' \
```
