...
```json
  {
  "data": {
    "id": "4af43aa7-7e12-4207-8567-591b6105a754",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-03-02T11:08:02+00:00",
      "updated_at": "2023-03-02T11:08:02+00:00",
      "kind": "apn",
      "environment": "production",
      "version": 3
    }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/8fc754a5-3b8f-4fbf-9dc6-84720a946fcf' \
    --header 'content-type: application/json' \
```
