...
```json
  {
  "data": {
    "id": "eb851efe-3a1f-4feb-98b4-dc72d148a514",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2022-07-13T11:49:56+00:00",
      "updated_at": "2022-07-13T11:49:56+00:00",
      "kind": "apn",
      "environment": "production"
    }
  },
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/1c531cb7-eb39-4e83-9d2d-8d3a6f30c89e' \
    --header 'content-type: application/json' \
```
