...
```json
  {
  "data": {
    "id": "06f890d8-f4ca-4aa3-a4aa-911becfad1dc",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-01-05T11:26:30+00:00",
      "updated_at": "2023-01-05T11:26:30+00:00",
      "kind": "apn",
      "environment": "production"
    }
  },
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/546aa3a8-2ca4-4639-8731-b9c1d420441f' \
    --header 'content-type: application/json' \
```
