...
```json
  {
  "data": {
    "id": "a3869d8a-1d9f-4a5a-803b-80df731d5525",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-02-14T11:06:15+00:00",
      "updated_at": "2023-02-14T11:06:15+00:00",
      "kind": "apn",
      "environment": "production",
      "version": 3
    }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/67892df6-55e7-4b0a-911c-52bea4558edf' \
    --header 'content-type: application/json' \
```
