...
```json
  {
  "data": {
    "id": "4466318e-6e9c-49ca-9ccd-f5f0f6cf7225",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-02-14T11:04:26+00:00",
      "updated_at": "2023-02-14T11:04:26+00:00",
      "kind": "apn",
      "environment": "production",
      "version": 3
    }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/943ab111-97c7-48da-9134-47f61fbdfe9c' \
    --header 'content-type: application/json' \
```
