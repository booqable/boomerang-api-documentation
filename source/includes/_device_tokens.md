...
```json
  {
  "data": {
    "id": "d4e958d1-d21c-43fa-8f27-e29900783d46",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-02-02T16:58:35+00:00",
      "updated_at": "2023-02-02T16:58:35+00:00",
      "kind": "apn",
      "environment": "production"
    }
  },
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/10140c9d-efc6-4669-aa2e-ffecb0b0dd0f' \
    --header 'content-type: application/json' \
```
