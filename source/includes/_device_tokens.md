...
```json
  {
  "data": {
    "id": "0edf4456-f4da-4042-aa8d-1db8a186ab30",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2022-12-20T14:48:39+00:00",
      "updated_at": "2022-12-20T14:48:39+00:00",
      "kind": "apn",
      "environment": "production"
    }
  },
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/01b5e63c-439e-4da2-9ed3-14532d91ae86' \
    --header 'content-type: application/json' \
```
