...
```json
  {
  "data": {
    "id": "eba9c067-b17f-4330-a509-7464623edd47",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-02-07T16:05:04+00:00",
      "updated_at": "2023-02-07T16:05:04+00:00",
      "kind": "apn",
      "environment": "production"
    }
  },
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/ad7732a0-91b8-42cd-a3e4-921b0f41a35f' \
    --header 'content-type: application/json' \
```
