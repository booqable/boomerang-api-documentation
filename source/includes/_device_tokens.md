...
```json
  {
  "data": {
    "id": "507ad9de-5909-414d-96d5-bb02e79212b8",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-02-16T23:12:17+00:00",
      "updated_at": "2023-02-16T23:12:17+00:00",
      "kind": "apn",
      "environment": "production",
      "version": 3
    }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/c2e39806-58b4-4858-b5a7-4a1c0fdd2bf8' \
    --header 'content-type: application/json' \
```
