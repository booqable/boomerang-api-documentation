...
```json
  {
  "data": {
    "id": "922332aa-7b82-4f28-b3da-c6465875967b",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-01-26T08:08:56+00:00",
      "updated_at": "2023-01-26T08:08:56+00:00",
      "kind": "apn",
      "environment": "production"
    }
  },
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/b29dd74d-5d41-4bcb-a8dc-3369c67cc667' \
    --header 'content-type: application/json' \
```
