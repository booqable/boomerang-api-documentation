...
```json
  {
  "data": {
    "id": "9a9f60d2-5135-4dbb-8b7b-e72180b36b8f",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-02-06T08:47:50+00:00",
      "updated_at": "2023-02-06T08:47:50+00:00",
      "kind": "apn",
      "environment": "production"
    }
  },
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/ab08db84-fe51-4062-8d08-2b2693b9723d' \
    --header 'content-type: application/json' \
```
