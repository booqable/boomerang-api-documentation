...
```json
  {
  "data": {
    "id": "0fd056c0-3eb6-468e-a18f-e4d68878f2e4",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-03-01T14:16:25+00:00",
      "updated_at": "2023-03-01T14:16:25+00:00",
      "kind": "apn",
      "environment": "production",
      "version": 3
    }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/81a6dc81-bee7-4a55-b837-16c156e2bf89' \
    --header 'content-type: application/json' \
```
