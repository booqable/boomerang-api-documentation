...
```json
  {
  "data": {
    "id": "e4cf6a38-ec1d-4819-bd73-e2f970e28b41",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-03-06T08:23:04+00:00",
      "updated_at": "2023-03-06T08:23:04+00:00",
      "kind": "apn",
      "environment": "production",
      "version": 3
    }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/adfef895-8cb1-455f-8816-70f31c25ddf0' \
    --header 'content-type: application/json' \
```
