...
```json
  {
  "data": {
    "id": "32c342f2-55fb-4574-9c66-59b767dc76fe",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-03-08T07:52:36+00:00",
      "updated_at": "2023-03-08T07:52:36+00:00",
      "kind": "apn",
      "environment": "production",
      "version": 3
    }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/77522152-8667-4b94-8c1e-143b34c7233c' \
    --header 'content-type: application/json' \
```
