...
```json
  {
  "data": {
    "id": "49d1f707-8826-4caf-b6f5-68294f44c5d7",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-02-09T09:39:44+00:00",
      "updated_at": "2023-02-09T09:39:44+00:00",
      "kind": "apn",
      "environment": "production",
      "version": 3
    }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/db979737-5c45-4c21-b02b-09c86fdc2326' \
    --header 'content-type: application/json' \
```
