...
```json
  {
  "data": {
    "id": "c6c425c3-357a-4530-b94c-66ffe79b87bd",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-01-18T13:35:15+00:00",
      "updated_at": "2023-01-18T13:35:15+00:00",
      "kind": "apn",
      "environment": "production"
    }
  },
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/4d29dfcb-d661-4b95-bedb-63a67fbf5fe4' \
    --header 'content-type: application/json' \
```
