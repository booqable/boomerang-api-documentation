...
```json
  {
  "data": {
    "id": "6f79eb95-775f-47d2-9d65-8aff5c92fd27",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2022-07-12T08:47:27+00:00",
      "updated_at": "2022-07-12T08:47:27+00:00",
      "kind": "apn",
      "environment": "production"
    }
  },
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/abd89b59-de66-487d-bc25-93312e0ac308' \
    --header 'content-type: application/json' \
```
