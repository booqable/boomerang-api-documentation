...
```json
  {
  "data": {
    "id": "b57b82eb-f62c-48fb-baa1-153ca4a48438",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-02-16T15:48:30+00:00",
      "updated_at": "2023-02-16T15:48:30+00:00",
      "kind": "apn",
      "environment": "production",
      "version": 3
    }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/5dd1871a-9676-4af5-bd95-2bed0f26bd64' \
    --header 'content-type: application/json' \
```
