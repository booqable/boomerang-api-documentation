...
```json
  {
  "data": {
    "id": "f64a7b3d-0993-4295-ac0a-fc8395702fb2",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2022-06-23T19:01:21+00:00",
      "updated_at": "2022-06-23T19:01:21+00:00",
      "kind": "apn",
      "environment": "production"
    }
  },
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/bbb2b00c-2e82-409a-897c-dabef5efe109' \
    --header 'content-type: application/json' \
```
