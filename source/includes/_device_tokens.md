...
```json
  {
  "data": {
    "id": "dd0fcfb9-a8e8-4aee-88dc-405608d895b4",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-02-20T11:46:16+00:00",
      "updated_at": "2023-02-20T11:46:16+00:00",
      "kind": "apn",
      "environment": "production",
      "version": 3
    }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/d1a99af4-ca98-412c-920e-f4a2119b3a2c' \
    --header 'content-type: application/json' \
```
