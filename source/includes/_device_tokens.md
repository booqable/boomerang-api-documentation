...
```json
  {
  "data": {
    "id": "1a949f4d-24fc-4bf0-b554-0376813d4546",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-02-02T11:15:44+00:00",
      "updated_at": "2023-02-02T11:15:44+00:00",
      "kind": "apn",
      "environment": "production"
    }
  },
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/9c460626-d7fd-4a89-bb20-8a3808d67fb3' \
    --header 'content-type: application/json' \
```
