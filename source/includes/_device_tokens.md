...
```json
  {
  "data": {
    "id": "637ebac2-d92a-4bd1-a804-bcd793504748",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-02-24T09:47:12+00:00",
      "updated_at": "2023-02-24T09:47:12+00:00",
      "kind": "apn",
      "environment": "production",
      "version": 3
    }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/67c3b3e9-5ee6-44b7-807b-7d7a2ecf4602' \
    --header 'content-type: application/json' \
```
