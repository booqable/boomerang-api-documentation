...
```json
  {
  "data": {
    "id": "a129564a-fb41-4fb2-b890-b8eb2156b6ce",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-02-09T10:18:49+00:00",
      "updated_at": "2023-02-09T10:18:49+00:00",
      "kind": "apn",
      "environment": "production",
      "version": 3
    }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/1191b98a-2415-461c-96b3-c52a98dbf04d' \
    --header 'content-type: application/json' \
```
