...
```json
  {
  "data": {
    "id": "5c693004-a553-4b48-abb7-78db89b5d251",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-02-08T14:59:05+00:00",
      "updated_at": "2023-02-08T14:59:05+00:00",
      "kind": "apn",
      "environment": "production",
      "version": 3
    }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/938bc387-8220-4d3e-a877-50f1700c0a47' \
    --header 'content-type: application/json' \
```
