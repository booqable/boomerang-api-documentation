...
```json
  {
  "data": {
    "id": "6c233e97-6340-4c99-82ee-7bb045b0a197",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-02-28T08:44:45+00:00",
      "updated_at": "2023-02-28T08:44:45+00:00",
      "kind": "apn",
      "environment": "production",
      "version": 3
    }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/ede00adf-ccd5-48c9-bf33-52f619348e29' \
    --header 'content-type: application/json' \
```
