...
```json
  {
  "data": {
    "id": "21b6478e-26c3-4e6a-b612-1a0ee745f1a8",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-02-08T13:51:11+00:00",
      "updated_at": "2023-02-08T13:51:11+00:00",
      "kind": "apn",
      "environment": "production",
      "version": 3
    }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/4bf256c2-6509-44b2-992e-fedd80e76f79' \
    --header 'content-type: application/json' \
```
