...
```json
  {
  "data": {
    "id": "5ca7c79d-82f7-4000-9822-f1b7d35a67b0",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-01-12T14:26:54+00:00",
      "updated_at": "2023-01-12T14:26:54+00:00",
      "kind": "apn",
      "environment": "production"
    }
  },
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/e6fb590d-3fdf-4583-96f1-6c3c95c61171' \
    --header 'content-type: application/json' \
```
