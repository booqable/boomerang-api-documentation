...
```json
  {
  "data": {
    "id": "ef94b14c-f044-4383-bb82-94a6c9734b56",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2022-12-19T08:46:23+00:00",
      "updated_at": "2022-12-19T08:46:23+00:00",
      "kind": "apn",
      "environment": "production"
    }
  },
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/ceb23a8b-c7d4-4075-ad30-141b886ef8b1' \
    --header 'content-type: application/json' \
```
