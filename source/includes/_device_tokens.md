...
```json
  {
  "data": {
    "id": "11433486-b51f-4c08-8560-fead55eb5966",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2022-11-22T14:41:27+00:00",
      "updated_at": "2022-11-22T14:41:27+00:00",
      "kind": "apn",
      "environment": "production"
    }
  },
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/6f91305f-8e43-4d63-9281-2c60e4b9835c' \
    --header 'content-type: application/json' \
```
