...
```json
  {
  "data": {
    "id": "fa077bea-f5f8-43bc-9c6e-4e8c9f2254e5",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2022-12-06T11:17:47+00:00",
      "updated_at": "2022-12-06T11:17:47+00:00",
      "kind": "apn",
      "environment": "production"
    }
  },
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/360e76a6-4c85-4c95-98a8-316430a919b4' \
    --header 'content-type: application/json' \
```
