...
```json
  {
  "data": {
    "id": "b8944139-2e1e-483f-b44e-79d182183618",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-02-07T14:50:31+00:00",
      "updated_at": "2023-02-07T14:50:31+00:00",
      "kind": "apn",
      "environment": "production"
    }
  },
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/1336f0fd-8bed-4399-ba94-a7896d6bc180' \
    --header 'content-type: application/json' \
```
