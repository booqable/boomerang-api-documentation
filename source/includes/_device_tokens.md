...
```json
  {
  "data": {
    "id": "b4cc658b-0c53-4d34-bf23-c9b6db5cc3fc",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2022-06-30T08:46:04+00:00",
      "updated_at": "2022-06-30T08:46:04+00:00",
      "kind": "apn",
      "environment": "production"
    }
  },
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/323c6242-94db-480a-aee4-0c358e414def' \
    --header 'content-type: application/json' \
```
