...
```json
  {
  "data": {
    "id": "1e398b24-248e-44ac-8b90-4227417770e2",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2022-10-07T11:56:17+00:00",
      "updated_at": "2022-10-07T11:56:17+00:00",
      "kind": "apn",
      "environment": "production"
    }
  },
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/43667989-aaa6-4592-bc9b-197e47ed52db' \
    --header 'content-type: application/json' \
```
