...
```json
  {
  "data": {
    "id": "dd4b8cd3-209c-4cab-9991-7002ba63913b",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-02-13T08:14:40+00:00",
      "updated_at": "2023-02-13T08:14:40+00:00",
      "kind": "apn",
      "environment": "production",
      "version": 3
    }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/5eb9d192-f5fd-45d0-80c2-c7a02cbcb857' \
    --header 'content-type: application/json' \
```
