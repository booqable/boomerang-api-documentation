...
```json
  {
  "data": {
    "id": "a556527b-3a4c-4b2a-ab63-ca90c66ffc3a",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-02-20T10:23:13+00:00",
      "updated_at": "2023-02-20T10:23:13+00:00",
      "kind": "apn",
      "environment": "production",
      "version": 3
    }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/7d42f706-551f-4e35-b0ee-d8326e3821c4' \
    --header 'content-type: application/json' \
```
