...
```json
  {
  "data": {
    "id": "75d35638-cc8a-45b5-a6ef-680655968651",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-02-01T13:18:48+00:00",
      "updated_at": "2023-02-01T13:18:48+00:00",
      "kind": "apn",
      "environment": "production"
    }
  },
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/852922ce-6ef0-4717-aa69-17c6a536c6bf' \
    --header 'content-type: application/json' \
```
