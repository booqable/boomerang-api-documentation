...
```json
  {
  "data": {
    "id": "fe04ed3c-4c2a-44b9-ba28-426ffcf8a890",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-01-05T13:08:49+00:00",
      "updated_at": "2023-01-05T13:08:49+00:00",
      "kind": "apn",
      "environment": "production"
    }
  },
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/ff26c8f2-5a16-4a86-879e-c161246fc4f4' \
    --header 'content-type: application/json' \
```
