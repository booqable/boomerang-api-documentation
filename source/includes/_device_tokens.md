...
```json
  {
  "data": {
    "id": "8a5c4c52-6711-48e3-abde-c2d04f5d1de8",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-02-07T15:00:09+00:00",
      "updated_at": "2023-02-07T15:00:09+00:00",
      "kind": "apn",
      "environment": "production"
    }
  },
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/00f72882-750d-492f-8616-6403344b33ef' \
    --header 'content-type: application/json' \
```
