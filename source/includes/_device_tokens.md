...
```json
  {
  "data": {
    "id": "65e0b336-8314-4014-bf64-588abb3430ba",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-01-24T16:31:32+00:00",
      "updated_at": "2023-01-24T16:31:32+00:00",
      "kind": "apn",
      "environment": "production"
    }
  },
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/2aab1961-7148-4b2e-81d5-becdb2d98657' \
    --header 'content-type: application/json' \
```
