...
```json
  {
  "data": {
    "id": "f47be0d6-5bfd-461a-a445-986fed12de2e",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-03-01T10:00:27+00:00",
      "updated_at": "2023-03-01T10:00:27+00:00",
      "kind": "apn",
      "environment": "production",
      "version": 3
    }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/995be9e9-7581-4e1c-a309-374ddf44e5e6' \
    --header 'content-type: application/json' \
```
