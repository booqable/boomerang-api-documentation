...
```json
  {
  "data": {
    "id": "dfcd3960-4b73-44f0-a3f9-0f3ab79ab3c2",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-02-16T09:21:01+00:00",
      "updated_at": "2023-02-16T09:21:01+00:00",
      "kind": "apn",
      "environment": "production",
      "version": 3
    }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/76ff424a-a78d-4396-8a11-478f3c873a86' \
    --header 'content-type: application/json' \
```
