...
```json
  {
  "data": {
    "id": "a66af1ce-8da2-49a7-8ec8-a916af8a6d2c",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-02-13T09:08:31+00:00",
      "updated_at": "2023-02-13T09:08:31+00:00",
      "kind": "apn",
      "environment": "production",
      "version": 3
    }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/50732262-4c64-48aa-9e92-11ef55408a73' \
    --header 'content-type: application/json' \
```
