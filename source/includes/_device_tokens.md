...
```json
  {
  "data": {
    "id": "b27c67f1-553e-4c10-8849-943f80cdd697",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-02-02T07:56:01+00:00",
      "updated_at": "2023-02-02T07:56:01+00:00",
      "kind": "apn",
      "environment": "production"
    }
  },
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/38ec88c0-3ee3-46d3-a99d-936091af1636' \
    --header 'content-type: application/json' \
```
