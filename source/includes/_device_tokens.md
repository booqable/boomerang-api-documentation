...
```json
  {
  "data": {
    "id": "5e523281-a969-459d-aca7-e08daa1f70cb",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-02-23T08:19:41+00:00",
      "updated_at": "2023-02-23T08:19:41+00:00",
      "kind": "apn",
      "environment": "production",
      "version": 3
    }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/3fe5cb5f-2f24-4a15-98c7-e56686c7acb6' \
    --header 'content-type: application/json' \
```
