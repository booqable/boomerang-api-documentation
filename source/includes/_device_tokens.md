...
```json
  {
  "data": {
    "id": "e8921fcd-37cf-4b5d-98bc-da050344c1cf",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-02-13T12:46:25+00:00",
      "updated_at": "2023-02-13T12:46:25+00:00",
      "kind": "apn",
      "environment": "production",
      "version": 3
    }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/eb028507-3bc2-46e5-9681-4b9233f8e08d' \
    --header 'content-type: application/json' \
```
