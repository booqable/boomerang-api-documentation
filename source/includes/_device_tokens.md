...
```json
  {
  "data": {
    "id": "d4c1c276-943a-48ac-998a-24f72d717ebe",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-02-24T14:55:52+00:00",
      "updated_at": "2023-02-24T14:55:52+00:00",
      "kind": "apn",
      "environment": "production",
      "version": 3
    }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/77219d5f-6a86-4ffc-a382-020bcf94a76f' \
    --header 'content-type: application/json' \
```
