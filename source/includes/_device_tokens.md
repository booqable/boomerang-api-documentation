...
```json
  {
  "data": {
    "id": "b12c1bac-a511-47bb-a162-8a9c30f049f4",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-02-02T19:26:00+00:00",
      "updated_at": "2023-02-02T19:26:00+00:00",
      "kind": "apn",
      "environment": "production"
    }
  },
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/18f7ec94-c05a-424c-8bd4-6b2283b88be6' \
    --header 'content-type: application/json' \
```
