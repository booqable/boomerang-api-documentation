...
```json
  {
  "data": {
    "id": "8424a95d-5620-4755-9b7e-a555f087574e",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-02-27T10:15:21+00:00",
      "updated_at": "2023-02-27T10:15:21+00:00",
      "kind": "apn",
      "environment": "production",
      "version": 3
    }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/7173e48c-276e-4d33-80f7-c34539de2ae9' \
    --header 'content-type: application/json' \
```
