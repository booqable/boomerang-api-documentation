...
```json
  {
  "data": {
    "id": "b482db63-3346-426f-9d44-37ff5585e718",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-03-09T13:49:11+00:00",
      "updated_at": "2023-03-09T13:49:11+00:00",
      "kind": "apn",
      "environment": "production",
      "version": 3
    }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/fccc2060-a843-43a9-ae38-ee414e0aab37' \
    --header 'content-type: application/json' \
```
