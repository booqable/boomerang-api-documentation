...
```json
  {
  "data": {
    "id": "9bf2f3eb-aa6b-4607-a780-410c328b1e95",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-02-22T08:40:25+00:00",
      "updated_at": "2023-02-22T08:40:25+00:00",
      "kind": "apn",
      "environment": "production",
      "version": 3
    }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/0b725084-52a5-4668-baff-17c2f33658cb' \
    --header 'content-type: application/json' \
```
