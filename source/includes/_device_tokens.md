...
```json
  {
  "data": {
    "id": "d80bf6e8-86ae-4aeb-b04d-e6156808315b",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2022-06-23T12:51:07+00:00",
      "updated_at": "2022-06-23T12:51:07+00:00",
      "kind": "apn",
      "environment": "production"
    }
  },
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/47439ae4-7bf1-4701-b895-830a9f564800' \
    --header 'content-type: application/json' \
```
