...
```json
  {
  "data": {
    "id": "4eb56737-7238-48f8-8866-49df6a4dac1d",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-02-09T11:02:22+00:00",
      "updated_at": "2023-02-09T11:02:22+00:00",
      "kind": "apn",
      "environment": "production",
      "version": 3
    }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/a83be03a-0e48-4c0f-92df-8d52541dc7ae' \
    --header 'content-type: application/json' \
```
