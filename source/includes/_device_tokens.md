...
```json
  {
  "data": {
    "id": "027829aa-f37c-4055-ba0b-c0a063a8a2dc",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-02-09T15:55:26+00:00",
      "updated_at": "2023-02-09T15:55:26+00:00",
      "kind": "apn",
      "environment": "production",
      "version": 3
    }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/4f955d51-a543-4c68-93a6-94c00d59a765' \
    --header 'content-type: application/json' \
```
