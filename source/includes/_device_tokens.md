...
```json
  {
  "data": {
    "id": "ad4a9ee3-c258-4ec3-9d15-7f1e798392ea",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2022-05-30T12:18:07+00:00",
      "updated_at": "2022-05-30T12:18:07+00:00",
      "kind": "apn",
      "environment": "production"
    }
  },
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/7fc8df08-95bf-48bd-8988-ececd5c6056d' \
    --header 'content-type: application/json' \
```
