...
```json
  {
  "data": {
    "id": "b2a7a5d0-9f62-40fc-bb1d-a1c93312e3f8",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-02-09T12:16:46+00:00",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/2370bf55-771e-4fff-b123-039decb4c384' \
    --header 'content-type: application/json' \
```
