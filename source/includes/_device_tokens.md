...
```json
  {
  "data": {
    "id": "a3995edd-f402-4389-8b68-39c2842f6fbc",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-02-07T10:27:22+00:00",
      "updated_at": "2023-02-07T10:27:22+00:00",
      "kind": "apn",
      "environment": "production"
    }
  },
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/c78ca7a4-533c-4843-a9c0-79cbd2d72f5e' \
    --header 'content-type: application/json' \
```
