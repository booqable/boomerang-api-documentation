...
```json
  {
  "data": {
    "id": "a0ac5897-c06b-4945-9f4f-92678ad3d2ba",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2022-09-16T09:01:38+00:00",
      "updated_at": "2022-09-16T09:01:38+00:00",
      "kind": "apn",
      "environment": "production"
    }
  },
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/53645920-ce37-4593-abc5-6419aeeb8f45' \
    --header 'content-type: application/json' \
```
