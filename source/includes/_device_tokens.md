...
```json
  {
  "data": {
    "id": "e9bd2551-b1d2-44f4-924a-e3628e03ab43",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2022-05-05T12:26:25+00:00",
      "updated_at": "2022-05-05T12:26:25+00:00",
      "kind": "apn",
      "environment": "production"
    }
  },
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/1ffc98ef-9962-4366-a403-f5ef747a4a21' \
    --header 'content-type: application/json' \
```
