...
```json
  {
  "data": {
    "id": "59e6c138-6066-4085-8b7a-03cae016b225",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-03-02T12:19:58+00:00",
      "updated_at": "2023-03-02T12:19:58+00:00",
      "kind": "apn",
      "environment": "production",
      "version": 3
    }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/b3c204c0-8c41-42a9-b73b-3db7fa8df3e5' \
    --header 'content-type: application/json' \
```
