...
```json
  {
  "data": {
    "id": "4476670e-8ebe-49eb-a67e-0892613b5c4e",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2022-10-13T14:28:50+00:00",
      "updated_at": "2022-10-13T14:28:50+00:00",
      "kind": "apn",
      "environment": "production"
    }
  },
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/aaf9470d-c4b1-403c-b32a-b3cd4f1aad56' \
    --header 'content-type: application/json' \
```
