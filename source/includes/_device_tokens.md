...
```json
  {
  "data": {
    "id": "eb716acc-ee41-4d83-97c9-cef7783d63d0",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-01-05T11:03:09+00:00",
      "updated_at": "2023-01-05T11:03:09+00:00",
      "kind": "apn",
      "environment": "production"
    }
  },
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/cd123e6e-f5dc-47ae-aa88-de9ca0ac128c' \
    --header 'content-type: application/json' \
```
