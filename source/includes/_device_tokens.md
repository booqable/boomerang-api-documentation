...
```json
  {
  "data": {
    "id": "2f7aab38-e837-4b11-b8c6-36d593f9ae6e",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-02-21T12:16:14+00:00",
      "updated_at": "2023-02-21T12:16:14+00:00",
      "kind": "apn",
      "environment": "production",
      "version": 3
    }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/17d10581-2c70-430c-b199-1578294323a9' \
    --header 'content-type: application/json' \
```
