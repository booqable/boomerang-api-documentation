...
```json
  {
  "data": {
    "id": "abdb271f-4678-4058-b169-7638746592a5",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-02-24T08:53:04+00:00",
      "updated_at": "2023-02-24T08:53:04+00:00",
      "kind": "apn",
      "environment": "production",
      "version": 3
    }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/5ede0e16-5c25-4ce5-a6e1-1cc0f055e7d8' \
    --header 'content-type: application/json' \
```
