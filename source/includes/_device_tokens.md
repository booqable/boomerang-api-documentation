...
```json
  {
  "data": {
    "id": "2b111ef3-10ca-47b7-80e6-5fdf518aabb0",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-02-24T09:11:16+00:00",
      "updated_at": "2023-02-24T09:11:16+00:00",
      "kind": "apn",
      "environment": "production",
      "version": 3
    }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/3949bf0c-45b4-4e5e-bb49-a4050d4bcd7d' \
    --header 'content-type: application/json' \
```
