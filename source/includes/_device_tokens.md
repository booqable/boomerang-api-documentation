...
```json
  {
  "data": {
    "id": "2ff36c5e-f533-4987-8211-5caa17e33e2e",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-02-16T10:59:25+00:00",
      "updated_at": "2023-02-16T10:59:25+00:00",
      "kind": "apn",
      "environment": "production",
      "version": 3
    }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/6424ff31-9488-4834-8594-9f1ce9d2f4bf' \
    --header 'content-type: application/json' \
```
