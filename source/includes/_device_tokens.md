...
```json
  {
  "data": {
    "id": "97e04e12-2bd3-4e01-ab8f-6973c5528dac",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-02-28T11:26:19+00:00",
      "updated_at": "2023-02-28T11:26:19+00:00",
      "kind": "apn",
      "environment": "production",
      "version": 3
    }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/1ba4b7a5-669a-4a71-abc3-2de03223869d' \
    --header 'content-type: application/json' \
```
