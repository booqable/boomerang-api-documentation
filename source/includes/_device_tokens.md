...
```json
  {
  "data": {
    "id": "e3aa9edd-b1d2-46a3-9a99-cc7fac12d744",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2022-11-08T13:52:27+00:00",
      "updated_at": "2022-11-08T13:52:27+00:00",
      "kind": "apn",
      "environment": "production"
    }
  },
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/483cc7ab-ec26-4a35-bf2b-254bd8e1a5b4' \
    --header 'content-type: application/json' \
```
