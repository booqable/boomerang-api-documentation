...
```json
  {
  "data": {
    "id": "6292d329-e018-46de-9d22-b2f220049963",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-02-23T08:54:52+00:00",
      "updated_at": "2023-02-23T08:54:52+00:00",
      "kind": "apn",
      "environment": "production",
      "version": 3
    }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/a575471c-4e3b-4e94-8df0-eaa918e6e0e0' \
    --header 'content-type: application/json' \
```
