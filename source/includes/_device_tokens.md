...
```json
  {
  "data": {
    "id": "f19fd4a9-57d8-42d8-9643-cb6c4d9c3c1a",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2022-07-14T10:16:35+00:00",
      "updated_at": "2022-07-14T10:16:35+00:00",
      "kind": "apn",
      "environment": "production"
    }
  },
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/1fd56bf5-322e-4f1b-9c14-91a86faef1b9' \
    --header 'content-type: application/json' \
```
