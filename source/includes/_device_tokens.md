...
```json
  {
  "data": {
    "id": "ec1dc38f-89a2-44d4-a8e9-6923b9aa56b1",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-02-06T18:57:24+00:00",
      "updated_at": "2023-02-06T18:57:24+00:00",
      "kind": "apn",
      "environment": "production"
    }
  },
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/dd3fd9bd-0718-4e2d-aed8-29b72e2a33b9' \
    --header 'content-type: application/json' \
```
