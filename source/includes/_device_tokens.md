...
```json
  {
  "data": {
    "id": "ca2ef72b-d67a-4f8e-8a2e-34d4bc5a4b6e",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-03-06T10:40:25+00:00",
      "updated_at": "2023-03-06T10:40:25+00:00",
      "kind": "apn",
      "environment": "production",
      "version": 3
    }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/2b519495-c78f-41d4-ab17-645f7ac8d829' \
    --header 'content-type: application/json' \
```
