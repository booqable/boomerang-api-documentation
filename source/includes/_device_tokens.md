...
```json
  {
  "data": {
    "id": "6322c734-4767-4065-ad23-762aa37fedab",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-02-16T11:20:09+00:00",
      "updated_at": "2023-02-16T11:20:09+00:00",
      "kind": "apn",
      "environment": "production",
      "version": 3
    }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/f4df2cba-4608-4c78-b206-ba4c671f30ea' \
    --header 'content-type: application/json' \
```
