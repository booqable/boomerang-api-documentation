...
```json
  {
  "data": {
    "id": "4862706c-988f-483f-b424-9d054d6099a5",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-02-17T10:32:38+00:00",
      "updated_at": "2023-02-17T10:32:38+00:00",
      "kind": "apn",
      "environment": "production",
      "version": 3
    }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/b1602822-92b8-4ebe-bbf8-de3f7952905b' \
    --header 'content-type: application/json' \
```
