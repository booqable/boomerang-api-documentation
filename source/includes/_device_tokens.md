...
```json
  {
  "data": {
    "id": "029d9cbc-540c-4d43-b2ff-22c14d385f0d",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-02-02T14:14:47+00:00",
      "updated_at": "2023-02-02T14:14:47+00:00",
      "kind": "apn",
      "environment": "production"
    }
  },
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/2c6b12a2-7722-4d9a-ac23-88778015acaa' \
    --header 'content-type: application/json' \
```
