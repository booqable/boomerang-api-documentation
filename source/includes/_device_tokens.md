...
```json
  {
  "data": {
    "id": "ff2bf199-7f87-4e53-aa8b-7f7d2bdd6788",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-02-08T09:18:25+00:00",
      "updated_at": "2023-02-08T09:18:25+00:00",
      "kind": "apn",
      "environment": "production"
    }
  },
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/9bf5a5a8-1e8a-4504-9695-ed91f11fe809' \
    --header 'content-type: application/json' \
```
