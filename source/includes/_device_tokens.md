...
```json
  {
  "data": {
    "id": "3f9d299e-972e-4a38-90e6-f42f05045fd3",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-02-01T13:32:01+00:00",
      "updated_at": "2023-02-01T13:32:01+00:00",
      "kind": "apn",
      "environment": "production"
    }
  },
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/52200493-7b5d-4fe6-a855-19228871c288' \
    --header 'content-type: application/json' \
```
