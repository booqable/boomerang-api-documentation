...
```json
  {
  "data": {
    "id": "1cd3563a-a376-4307-87a2-b9477af90c7b",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-03-07T08:27:32+00:00",
      "updated_at": "2023-03-07T08:27:32+00:00",
      "kind": "apn",
      "environment": "production",
      "version": 3
    }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/cb97129e-3ff4-4035-a600-d200c15b20b3' \
    --header 'content-type: application/json' \
```
