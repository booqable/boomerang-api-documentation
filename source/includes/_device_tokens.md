...
```json
  {
  "data": {
    "id": "e568c231-aeb9-47c8-b95b-4a46a630d7ae",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-02-22T10:35:37+00:00",
      "updated_at": "2023-02-22T10:35:37+00:00",
      "kind": "apn",
      "environment": "production",
      "version": 3
    }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/a72cd201-4e2a-443e-bd10-ac2d5b9d97c3' \
    --header 'content-type: application/json' \
```
