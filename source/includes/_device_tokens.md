...
```json
  {
  "data": {
    "id": "d217207e-847a-4f87-ac91-acd8e1417512",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-03-09T09:33:57+00:00",
      "updated_at": "2023-03-09T09:33:57+00:00",
      "kind": "apn",
      "environment": "production",
      "version": 3
    }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/5cbf39b7-a0a7-4b7f-a1a1-3e23fecda692' \
    --header 'content-type: application/json' \
```
