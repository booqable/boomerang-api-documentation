...
```json
  {
  "data": {
    "id": "ec49cded-1f60-4a08-a804-e10669b45920",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2022-10-25T14:58:33+00:00",
      "updated_at": "2022-10-25T14:58:33+00:00",
      "kind": "apn",
      "environment": "production"
    }
  },
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/8f9929f7-e48b-4f7e-9e0d-2dcd70aa67e1' \
    --header 'content-type: application/json' \
```
