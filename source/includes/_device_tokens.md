...
```json
  {
  "data": {
    "id": "433774b9-0226-476a-8bd7-99141332b707",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2022-07-14T13:03:49+00:00",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/5bd315da-13fe-4ef6-ba72-4c40913a960a' \
    --header 'content-type: application/json' \
```
