...
```json
  {
  "data": {
    "id": "26005ec3-302c-486c-9ab4-86fff6993dc2",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-02-21T08:19:27+00:00",
      "updated_at": "2023-02-21T08:19:27+00:00",
      "kind": "apn",
      "environment": "production",
      "version": 3
    }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/52921dac-1b26-46b3-8a86-a872600783ef' \
    --header 'content-type: application/json' \
```
