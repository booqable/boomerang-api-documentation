...
```json
  {
  "data": {
    "id": "d00f2e33-f2cb-428a-aedd-3f1e799c6cc2",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-02-07T09:27:22+00:00",
      "updated_at": "2023-02-07T09:27:22+00:00",
      "kind": "apn",
      "environment": "production"
    }
  },
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/f08066e4-c733-4837-9b43-ab365556fee7' \
    --header 'content-type: application/json' \
```
