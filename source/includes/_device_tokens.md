...
```json
  {
  "data": {
    "id": "1c3f283f-dfed-496d-9253-404813a56996",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-01-26T12:16:33+00:00",
      "updated_at": "2023-01-26T12:16:33+00:00",
      "kind": "apn",
      "environment": "production"
    }
  },
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/a15a0d26-e993-44a1-9eb2-031a29aeb59f' \
    --header 'content-type: application/json' \
```
