...
```json
  {
  "data": {
    "id": "e781d81b-b905-4a47-ab9c-19333094ced7",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-02-03T08:27:07+00:00",
      "updated_at": "2023-02-03T08:27:07+00:00",
      "kind": "apn",
      "environment": "production"
    }
  },
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/4d2f27c6-53e6-4637-b069-104407cdc7e9' \
    --header 'content-type: application/json' \
```
