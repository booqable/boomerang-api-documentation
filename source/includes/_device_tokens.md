...
```json
  {
  "data": {
    "id": "d899c24c-d91a-432d-ad44-8f1d3b3049f0",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-01-24T13:21:10+00:00",
      "updated_at": "2023-01-24T13:21:10+00:00",
      "kind": "apn",
      "environment": "production"
    }
  },
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/4e052582-d153-403d-9ada-836038484d09' \
    --header 'content-type: application/json' \
```
