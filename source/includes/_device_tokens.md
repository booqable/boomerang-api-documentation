...
```json
  {
  "data": {
    "id": "29daf736-f499-4e15-bfb8-fe77487cb0f2",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-02-07T10:57:31+00:00",
      "updated_at": "2023-02-07T10:57:31+00:00",
      "kind": "apn",
      "environment": "production"
    }
  },
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/c8a00266-0189-4456-9fe5-1b046afca328' \
    --header 'content-type: application/json' \
```
