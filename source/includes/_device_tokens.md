...
```json
  {
  "data": {
    "id": "323916a9-8f87-4ba2-ab1d-b7e68b7b1d88",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2022-07-18T07:34:50+00:00",
      "updated_at": "2022-07-18T07:34:50+00:00",
      "kind": "apn",
      "environment": "production"
    }
  },
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/6d98a12e-520e-462a-b0ca-30c804807b78' \
    --header 'content-type: application/json' \
```
