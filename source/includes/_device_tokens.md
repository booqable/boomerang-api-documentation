...
```json
  {
  "data": {
    "id": "381414b3-cbf8-41ce-8e24-e5638f86d67d",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-02-09T13:19:31+00:00",
      "updated_at": "2023-02-09T13:19:31+00:00",
      "kind": "apn",
      "environment": "production",
      "version": 3
    }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/11842041-d80e-445f-a653-5c2d6476a614' \
    --header 'content-type: application/json' \
```
