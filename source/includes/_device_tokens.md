...
```json
  {
  "data": {
    "id": "3e196d9b-2b45-4a99-8a28-e713a4ef947f",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2022-06-09T12:37:47+00:00",
      "updated_at": "2022-06-09T12:37:47+00:00",
      "kind": "apn",
      "environment": "production"
    }
  },
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/9f4e30a3-70e4-4cc2-a6e1-63cfd9c8d52d' \
    --header 'content-type: application/json' \
```
