...
```json
  {
  "data": {
    "id": "4a790670-959f-4b7e-993b-408a5e1aa44d",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-02-03T09:51:53+00:00",
      "updated_at": "2023-02-03T09:51:53+00:00",
      "kind": "apn",
      "environment": "production"
    }
  },
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/0ad26f61-5079-444f-a099-3b986bc7deda' \
    --header 'content-type: application/json' \
```
