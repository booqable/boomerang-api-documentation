...
```json
  {
  "data": {
    "id": "14bff8d6-8dd6-4d84-98d3-2b06bedacf7b",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2023-02-02T08:01:31+00:00",
      "updated_at": "2023-02-02T08:01:31+00:00",
      "kind": "apn",
      "environment": "production"
    }
  },
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/9f19eb21-1469-486e-a5e6-2f3ce8251b88' \
    --header 'content-type: application/json' \
```
