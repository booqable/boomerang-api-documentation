...
```json
  {
  "data": {
    "id": "507e7e51-1aa3-4064-b973-69e0e09c5e9a",
    "type": "device_tokens",
    "attributes": {
      "created_at": "2022-07-14T10:34:03+00:00",
      "updated_at": "2022-07-14T10:34:03+00:00",
      "kind": "apn",
      "environment": "production"
    }
  },
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/device_tokens/303fc2d2-8f0c-49be-a9de-d222c8949168' \
    --header 'content-type: application/json' \
```
