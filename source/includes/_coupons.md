...
```json
  ...
  "data": [
    {
      "id": "73afdc76-2edf-4ad3-a591-c9eab51e3eab",
      "type": "coupons",
      "attributes": {
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/coupons/2e1d5aa3-6a75-474b-95fd-d16678f36d46' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "2e1d5aa3-6a75-474b-95fd-d16678f36d46",
    "type": "coupons",
    "attributes": {
...
```json
  {
  "data": {
    "id": "44414bd1-83c4-4b49-bbda-48b4ad7ee5a6",
    "type": "coupons",
    "attributes": {
      "created_at": "2023-03-10T08:37:13+00:00",
      "updated_at": "2023-03-10T08:37:13+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/coupons/50b5f1ba-4092-439f-9efd-20601aa065be' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "50b5f1ba-4092-439f-9efd-20601aa065be",
        "type": "coupons",
        "attributes": {
...
```json
  {
  "data": {
    "id": "ca37f330-b756-44b2-9009-3243229ed313",
    "type": "coupons",
    "attributes": {
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/coupons/d436a505-cae0-48d1-9e1f-6a6549533faa' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "d436a505-cae0-48d1-9e1f-6a6549533faa",
        "type": "coupons",
        "attributes": {
          "active": false
        }
...
```json
  {
  "data": {
    "id": "a54f5ee6-95e3-4813-a451-2bf3fd2f8409",
    "type": "coupons",
    "attributes": {
      "created_at": "2023-03-10T08:37:14+00:00",
      "updated_at": "2023-03-10T08:37:14+00:00",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/coupons/d3cba2c2-b0c4-441c-8586-4083c53d62ba' \
    --header 'content-type: application/json' \
```
