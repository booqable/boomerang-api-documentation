...
```json
  ...
  "data": [
    {
      "id": "315d4398-882e-440f-a422-cce522503ef1",
      "type": "coupons",
      "attributes": {
        "created_at": "2023-02-09T09:39:28+00:00",
        "updated_at": "2023-02-09T09:39:28+00:00",
        "archived": false,
        "archived_at": null,
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/coupons/69052d3b-422d-4706-b99c-9955445ac035' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "69052d3b-422d-4706-b99c-9955445ac035",
    "type": "coupons",
    "attributes": {
      "created_at": "2023-02-09T09:39:28+00:00",
      "updated_at": "2023-02-09T09:39:28+00:00",
...
```json
  {
  "data": {
    "id": "eb19de04-6878-4656-9f73-59fa038b74fa",
    "type": "coupons",
    "attributes": {
      "created_at": "2023-02-09T09:39:29+00:00",
      "updated_at": "2023-02-09T09:39:29+00:00",
      "archived": false,
      "archived_at": null,
      "identifier": "WINTERDISCOUNT",
      "coupon_type": "cents",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/coupons/a238c260-8859-40ec-a81d-d218af730901' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "a238c260-8859-40ec-a81d-d218af730901",
        "type": "coupons",
        "attributes": {
...
```json
  {
  "data": {
    "id": "ae115cab-1ff3-4be0-9838-b9d9f076eff4",
    "type": "coupons",
    "attributes": {
      "created_at": "2023-02-09T09:39:29+00:00",
      "updated_at": "2023-02-09T09:39:29+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/coupons/ff398e3e-1db9-4512-8a55-677b4864a605' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "ff398e3e-1db9-4512-8a55-677b4864a605",
        "type": "coupons",
        "attributes": {
          "active": false
        }
...
```json
  {
  "data": {
    "id": "250a8b88-0e03-4569-99e4-bcbf164c2320",
    "type": "coupons",
    "attributes": {
      "created_at": "2023-02-09T09:39:30+00:00",
      "updated_at": "2023-02-09T09:39:30+00:00",
      "archived": false,
      "archived_at": null,
      "identifier": "SUMMER20OFF",
      "coupon_type": "percentage",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/coupons/d20fb0cb-ee83-42eb-a06a-550d1a6b5b2f' \
    --header 'content-type: application/json' \
```
