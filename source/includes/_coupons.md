...
```json
  ...
  "data": [
    {
      "id": "a8824f27-a224-41a3-a3a0-c8268a5905b2",
      "type": "coupons",
      "attributes": {
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/coupons/2054083e-3dbd-4b5f-bdf3-eae858f1622c' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "2054083e-3dbd-4b5f-bdf3-eae858f1622c",
    "type": "coupons",
    "attributes": {
...
```json
  {
  "data": {
    "id": "4a8ded30-f30d-4026-a828-4ae5d3827d2e",
    "type": "coupons",
    "attributes": {
      "created_at": "2023-02-08T08:34:38+00:00",
      "updated_at": "2023-02-08T08:34:38+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/coupons/5bdb92b9-2d3f-4d1b-9261-7a31ccb1a4c6' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "5bdb92b9-2d3f-4d1b-9261-7a31ccb1a4c6",
        "type": "coupons",
        "attributes": {
...
```json
  {
  "data": {
    "id": "1cce4f94-5ec4-467d-9a06-a7b7b6a7b35a",
    "type": "coupons",
    "attributes": {
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/coupons/41a10c48-0d65-4b50-ae2f-34423e4fbe48' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "41a10c48-0d65-4b50-ae2f-34423e4fbe48",
        "type": "coupons",
        "attributes": {
          "active": false
        }
...
```json
  {
  "data": {
    "id": "00b4719d-8d4a-4026-b4f7-d003b9487f52",
    "type": "coupons",
    "attributes": {
      "created_at": "2023-02-08T08:34:39+00:00",
      "updated_at": "2023-02-08T08:34:39+00:00",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/coupons/9efc6f69-2317-4dac-b02e-e19fc299f11c' \
    --header 'content-type: application/json' \
```
