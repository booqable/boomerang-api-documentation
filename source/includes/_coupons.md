...
```json
  {
  "data": {
    "id": "6b241390-a41e-4a8d-8471-a30dc619e0d2",
    "type": "coupons",
    "attributes": {
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/coupons/dc3b584a-51d9-47ce-9ed6-9257612928e7' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "dc3b584a-51d9-47ce-9ed6-9257612928e7",
    "type": "coupons",
    "attributes": {
      "created_at": "2024-01-15T09:19:24+00:00",
      "updated_at": "2024-01-15T09:19:24+00:00",
      "archived": false,
      "archived_at": null,
...
```json
  ...
  "data": [
    {
      "id": "58c7af9d-1e11-478e-9c82-5f3220f0ddab",
      "type": "coupons",
      "attributes": {
        "created_at": "2024-01-15T09:19:25+00:00",
        "updated_at": "2024-01-15T09:19:25+00:00",
        "archived": false,
        "archived_at": null,
        "identifier": "SUMMER20OFF",
        "coupon_type": "percentage",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/coupons/4aa77af3-69e8-4cf3-b6ea-96cf82f0d06c' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "4aa77af3-69e8-4cf3-b6ea-96cf82f0d06c",
        "type": "coupons",
        "attributes": {
          "active": false
        }
...
```json
  {
  "data": {
    "id": "813c3ba4-366b-428f-868a-145c5ca5c582",
    "type": "coupons",
    "attributes": {
      "created_at": "2024-01-15T09:19:25+00:00",
      "updated_at": "2024-01-15T09:19:25+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/coupons/e216df38-3ce8-4bc7-a200-c2fa85031d1b' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "e216df38-3ce8-4bc7-a200-c2fa85031d1b",
        "type": "coupons",
        "attributes": {
...
```json
  {
  "data": {
    "id": "5761dde0-cfaa-4a13-8d20-e0cadaeb66e1",
    "type": "coupons",
    "attributes": {
      "created_at": "2024-01-15T09:19:26+00:00",
      "updated_at": "2024-01-15T09:19:26+00:00",
      "archived": false,
      "archived_at": null,
      "identifier": "SUMMER30OFF",
      "coupon_type": "percentage",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/coupons/ccb2456d-6184-42fc-b577-036e6d10d2be' \
    --header 'content-type: application/json' \
```
