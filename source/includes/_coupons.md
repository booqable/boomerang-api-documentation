...
```json
  ...
  "data": [
    {
      "id": "08f6cb14-84a8-4a1b-9dca-546e9fa5fe39",
      "type": "coupons",
      "attributes": {
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/coupons/f085ec0a-994d-4722-8183-2f5aac6a3a8d' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "f085ec0a-994d-4722-8183-2f5aac6a3a8d",
    "type": "coupons",
    "attributes": {
...
```json
  {
  "data": {
    "id": "8b75660b-6ef0-403e-b3e6-62e53e65d945",
    "type": "coupons",
    "attributes": {
      "created_at": "2022-11-22T16:34:52+00:00",
      "updated_at": "2022-11-22T16:34:52+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/coupons/71b3428a-1b75-4311-8d69-a4a84803af74' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "71b3428a-1b75-4311-8d69-a4a84803af74",
        "type": "coupons",
        "attributes": {
...
```json
  {
  "data": {
    "id": "44ebb2cd-7bba-4bf5-92ca-b6de0d7bb7f5",
    "type": "coupons",
    "attributes": {
      "created_at": "2022-11-22T16:34:52+00:00",
      "updated_at": "2022-11-22T16:34:52+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/coupons/dca45c01-f544-4cf3-81ee-691d10f13aae' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "dca45c01-f544-4cf3-81ee-691d10f13aae",
        "type": "coupons",
        "attributes": {
          "active": false
        }
...
```json
  {
  "data": {
    "id": "bbf0c27f-0f71-4b79-9ce7-e1f000452b53",
    "type": "coupons",
    "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/coupons/215fadff-0b89-4f9a-b415-cbfd7562a1a2' \
    --header 'content-type: application/json' \
```
