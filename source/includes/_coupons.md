...
```json
  ...
  "data": [
    {
      "id": "8dba34c7-14e3-4237-b9d5-6e0d56fe5859",
      "type": "coupons",
      "attributes": {
        "created_at": "2022-05-04T10:04:30+00:00",
        "updated_at": "2022-05-04T10:04:30+00:00",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/coupons/58fbea55-5d4c-4419-ada3-cbe1da00917c' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "58fbea55-5d4c-4419-ada3-cbe1da00917c",
    "type": "coupons",
    "attributes": {
      "created_at": "2022-05-04T10:04:30+00:00",
      "updated_at": "2022-05-04T10:04:30+00:00",
...
```json
  {
  "data": {
    "id": "d2da3d26-19f4-4fce-9e82-317f3e317aa5",
    "type": "coupons",
    "attributes": {
      "created_at": "2022-05-04T10:04:30+00:00",
      "updated_at": "2022-05-04T10:04:30+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/coupons/ff88fa0b-166c-43c0-81f4-b9d114592aa3' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "ff88fa0b-166c-43c0-81f4-b9d114592aa3",
        "type": "coupons",
        "attributes": {
...
```json
  {
  "data": {
    "id": "f7591c9f-16b3-4a87-924d-a3ee3e16ab96",
    "type": "coupons",
    "attributes": {
      "created_at": "2022-05-04T10:04:31+00:00",
      "updated_at": "2022-05-04T10:04:31+00:00",
      "identifier": "SUMMER30OFF",
      "coupon_type": "percentage",
      "value": 30,
      "active": false,
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/coupons/da69ebc2-c03c-437f-b4ef-a84e97925545' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "da69ebc2-c03c-437f-b4ef-a84e97925545",
        "type": "coupons",
        "attributes": {
          "active": false
        }
...
```json
  {
  "data": {
    "id": "4536ff1b-615e-4332-92f3-f5a17979446a",
    "type": "coupons",
    "attributes": {
      "created_at": "2022-05-04T10:04:31+00:00",
      "updated_at": "2022-05-04T10:04:31+00:00",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/coupons/d969c293-0e53-4db7-9355-7f3d4354276a' \
    --header 'content-type: application/json' \
```
