...
```json
  ...
  "data": [
    {
      "id": "fbf6dff4-a6a6-44bc-8587-ab4bb117e67a",
      "type": "coupons",
      "attributes": {
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/coupons/3fe410ca-596a-4bd0-a9f3-95ba180e261b' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "3fe410ca-596a-4bd0-a9f3-95ba180e261b",
    "type": "coupons",
    "attributes": {
      "created_at": "2023-02-08T08:35:10+00:00",
      "updated_at": "2023-02-08T08:35:10+00:00",
...
```json
  {
  "data": {
    "id": "738885f9-80d6-4f62-85ad-824b4139dd8a",
    "type": "coupons",
    "attributes": {
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/coupons/2d8f6488-a9c8-4171-b0d8-ed2887a7c134' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "2d8f6488-a9c8-4171-b0d8-ed2887a7c134",
        "type": "coupons",
        "attributes": {
...
```json
  {
  "data": {
    "id": "1baa54ce-7b5d-4ef2-98aa-eb2efcc63355",
    "type": "coupons",
    "attributes": {
      "created_at": "2023-02-08T08:35:11+00:00",
      "updated_at": "2023-02-08T08:35:11+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/coupons/abfb1775-8205-46fd-987b-411e00863534' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "abfb1775-8205-46fd-987b-411e00863534",
        "type": "coupons",
        "attributes": {
          "active": false
        }
...
```json
  {
  "data": {
    "id": "0d52381a-a642-4bdb-b0d8-15c1aa2b476b",
    "type": "coupons",
    "attributes": {
      "created_at": "2023-02-08T08:35:12+00:00",
      "updated_at": "2023-02-08T08:35:12+00:00",
      "archived": false,
      "archived_at": null,
      "identifier": "SUMMER20OFF",
      "coupon_type": "percentage",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/coupons/f75edf18-2f10-46ee-ab7d-85e30484714c' \
    --header 'content-type: application/json' \
```
