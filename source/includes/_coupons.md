...
```json
  ...
  "data": [
    {
      "id": "32446f61-165f-409d-83f2-66f13440b0e9",
      "type": "coupons",
      "attributes": {
        "created_at": "2023-02-09T10:17:59+00:00",
        "updated_at": "2023-02-09T10:17:59+00:00",
        "archived": false,
        "archived_at": null,
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/coupons/2c42e206-f9a8-484f-b6df-e39571205f24' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "2c42e206-f9a8-484f-b6df-e39571205f24",
    "type": "coupons",
    "attributes": {
      "created_at": "2023-02-09T10:17:59+00:00",
      "updated_at": "2023-02-09T10:17:59+00:00",
...
```json
  {
  "data": {
    "id": "769613de-5fb7-40bd-bc56-26825d01f5e3",
    "type": "coupons",
    "attributes": {
      "created_at": "2023-02-09T10:17:59+00:00",
      "updated_at": "2023-02-09T10:17:59+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/coupons/390185ec-7f8c-4789-bcf7-4de96d436b59' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "390185ec-7f8c-4789-bcf7-4de96d436b59",
        "type": "coupons",
        "attributes": {
...
```json
  {
  "data": {
    "id": "6720acf6-c537-4861-a115-6ebaf0498224",
    "type": "coupons",
    "attributes": {
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/coupons/5da6d63a-d9a0-4744-a43a-26b828ef8ec7' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "5da6d63a-d9a0-4744-a43a-26b828ef8ec7",
        "type": "coupons",
        "attributes": {
          "active": false
        }
...
```json
  {
  "data": {
    "id": "6d5dfc19-1821-4119-81ee-4571fba98aca",
    "type": "coupons",
    "attributes": {
      "created_at": "2023-02-09T10:18:00+00:00",
      "updated_at": "2023-02-09T10:18:00+00:00",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/coupons/804ca799-7a50-4045-9cbc-cc42464ad435' \
    --header 'content-type: application/json' \
```
