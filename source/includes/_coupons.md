...
```json
  ...
  "data": [
    {
      "id": "ae64f686-cadf-48d7-99af-180ede4a27c5",
      "type": "coupons",
      "attributes": {
        "created_at": "2023-02-08T15:18:10+00:00",
        "updated_at": "2023-02-08T15:18:10+00:00",
        "archived": false,
        "archived_at": null,
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/coupons/7db40188-11c7-4628-9c31-08577def97af' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "7db40188-11c7-4628-9c31-08577def97af",
    "type": "coupons",
    "attributes": {
      "created_at": "2023-02-08T15:18:13+00:00",
      "updated_at": "2023-02-08T15:18:13+00:00",
      "archived": false,
      "archived_at": null,
      "identifier": "SUMMER20OFF",
      "coupon_type": "percentage",
...
```json
  {
  "data": {
    "id": "07e4cab7-f857-47f8-b68d-f9f56c9430e7",
    "type": "coupons",
    "attributes": {
      "created_at": "2023-02-08T15:18:15+00:00",
      "updated_at": "2023-02-08T15:18:15+00:00",
      "archived": false,
      "archived_at": null,
      "identifier": "WINTERDISCOUNT",
      "coupon_type": "cents",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/coupons/b92bfda5-6058-4856-bd1e-1c66aa8605a4' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "b92bfda5-6058-4856-bd1e-1c66aa8605a4",
        "type": "coupons",
        "attributes": {
...
```json
  {
  "data": {
    "id": "91c4a1b0-8def-4f2d-8e5d-f408c13d2f6c",
    "type": "coupons",
    "attributes": {
      "created_at": "2023-02-08T15:18:16+00:00",
      "updated_at": "2023-02-08T15:18:16+00:00",
      "archived": false,
      "archived_at": null,
      "identifier": "SUMMER30OFF",
      "coupon_type": "percentage",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/coupons/034d7fd7-85db-4ae2-b951-987666265cf7' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "034d7fd7-85db-4ae2-b951-987666265cf7",
        "type": "coupons",
        "attributes": {
          "active": false
        }
...
```json
  {
  "data": {
    "id": "6de7f78b-27da-42a3-a40d-fe8e7ca1a35d",
    "type": "coupons",
    "attributes": {
      "created_at": "2023-02-08T15:18:17+00:00",
      "updated_at": "2023-02-08T15:18:17+00:00",
      "archived": false,
      "archived_at": null,
      "identifier": "SUMMER20OFF",
      "coupon_type": "percentage",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/coupons/b06537c8-f4ac-4f4b-ad09-54f73db069cd' \
    --header 'content-type: application/json' \
```
