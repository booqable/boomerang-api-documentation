  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "stock_item_id": "b8d3fee8-f01c-4773-bbe6-fbab6cb8bb71"
        }
      }
    }'
```
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        "type": "stock_item_archivations",
        "attributes": {
          "stock_item_id": "185a9ff4-c257-43ba-b753-6fa82c998e4e"
        }
      }
    }'
```
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        "type": "stock_item_archivations",
        "attributes": {
          "stock_item_id": "b3b1eaaa-705a-4180-87b2-a5c4d65f6f5e"
        }
      }
    }'
```
  ...
  "errors": [
    {
      ...
      "meta": {
        "blocking": [
          {
            "order_ids": [
              "87893812-9cc9-432f-9a77-ec561c28f2ea"
            ]
          }
        ]
      }
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        "type": "stock_item_archivations",
        "attributes": {
          "stock_item_id": "39df094e-0110-423d-abbf-6fa493877bef"
        }
      }
    }'
```
        ...
        "blocking": [
          {
            "reason": "shortage",
            "shortage": 1,
            "item_id": "c129dbeb-6faa-41a1-98a8-6b7199b66693",
            "mutation": -1,
            "order_ids": [
              "e9bb5d70-79d3-4fd5-a537-a9dbe7c5c682"
            ],
            "location_id": "6ebafc1f-033c-4d31-8b75-6bfbdb88bb36",
            "available": 0,
            "plannable": 0,
            "stock_count": 1,
            "planned": 1,
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        "type": "stock_item_archivations",
        "attributes": {
          "stock_item_id": "adea6e64-8369-4ea2-9305-55c2734a01f1"
        }
      }
    }'
```
        ...
        "warning": [
          {
            "reason": "shortage",
            "shortage": 1,
            "item_id": "3f09abac-38d9-46c6-814a-b5b3c7698cec",
            "mutation": -1,
            "order_ids": [
              "79a1d540-a039-40fc-b4ed-3703a98cb691"
            ],
            "location_id": "d100d5be-0f66-4f26-94fa-92667841ed1f",
            "available": 0,
            "plannable": 1,
            "stock_count": 1,
            "planned": 1,
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        "type": "stock_item_archivations",
        "attributes": {
          "stock_item_id": "ffe703f8-a42a-4a70-a037-f029bb958c2a",
...
```json
  {
  "data": {
    "id": "0fb0f625-e5ce-5436-85dd-753097cc9785",
    "type": "stock_item_archivations",
    "attributes": {
      "stock_item_id": "ffe703f8-a42a-4a70-a037-f029bb958c2a"
    },
