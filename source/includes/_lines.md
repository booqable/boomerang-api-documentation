...
```json
  ...
  "data": [
    {
      "id": "f22e48aa-7d06-4a64-88dc-709f9d1e3830",
      "type": "lines",
      "attributes": {
        "created_at": "2023-02-16T10:00:34+00:00",
        "updated_at": "2023-02-16T10:00:34+00:00",
        "archived": false,
        "archived_at": null,
        "title": "Macbook Pro",
        ...
        "line_type": "charge",
        "relevant": true,
        "item_id": "09f3740d-9025-4553-96b8-90a91f0cc82a",
        "tax_category_id": "a9200b13-0df0-4b11-94ef-868bdbe2a4ba",
        "planning_id": "21aede76-277f-4a3b-a388-105a572f646b",
        "parent_line_id": null,
        "owner_id": "6e044568-23b2-4eaf-886f-5bc982806010",
        "owner_type": "orders"
      },
      "relationships": {
        "item": {
          "links": {
            "related": "api/boomerang/items/09f3740d-9025-4553-96b8-90a91f0cc82a"
          }
        },
        "tax_category": {
          "links": {
            "related": "api/boomerang/tax_categories/a9200b13-0df0-4b11-94ef-868bdbe2a4ba"
          }
        },
        "planning": {
          "links": {
            "related": "api/boomerang/plannings/21aede76-277f-4a3b-a388-105a572f646b"
          }
        },
        "parent_line": {
          "links": {
        ...
        "nested_lines": {
          "links": {
            "related": "api/boomerang/lines?filter[parent_line_id]=f22e48aa-7d06-4a64-88dc-709f9d1e3830"
          }
        },
        "owner": {
          "links": {
            "related": "api/boomerang/orders/6e044568-23b2-4eaf-886f-5bc982806010"
          }
        }
      }
    }
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/lines/c021ece4-4f11-4eb7-a93d-0b3dcda5ffe2' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "c021ece4-4f11-4eb7-a93d-0b3dcda5ffe2",
    "type": "lines",
    "attributes": {
      "created_at": "2023-02-16T10:00:36+00:00",
      "updated_at": "2023-02-16T10:00:36+00:00",
      "archived": false,
      "archived_at": null,
      "title": "Macbook Pro",
      "extra_information": "Comes with a mouse",
      ...
      "line_type": "charge",
      "relevant": true,
      "item_id": "e507ed96-a153-4f0a-a2c9-87683cf46bee",
      "tax_category_id": "0d179968-fb83-4114-88ff-0b452da1659f",
      "planning_id": "7fa9768b-fa36-47e7-8aef-537443cde7d5",
      "parent_line_id": null,
      "owner_id": "f0512bf9-e0c7-4148-832e-9ed137e1ea49",
      "owner_type": "orders"
    },
    "relationships": {
      "item": {
        "links": {
          "related": "api/boomerang/items/e507ed96-a153-4f0a-a2c9-87683cf46bee"
        }
      },
      "tax_category": {
        "links": {
          "related": "api/boomerang/tax_categories/0d179968-fb83-4114-88ff-0b452da1659f"
        }
      },
      "planning": {
        "links": {
          "related": "api/boomerang/plannings/7fa9768b-fa36-47e7-8aef-537443cde7d5"
        }
      },
      "parent_line": {
        "links": {
      ...
      "nested_lines": {
        "links": {
          "related": "api/boomerang/lines?filter[parent_line_id]=c021ece4-4f11-4eb7-a93d-0b3dcda5ffe2"
        }
      },
      "owner": {
        "links": {
          "related": "api/boomerang/orders/f0512bf9-e0c7-4148-832e-9ed137e1ea49"
        }
      }
    }
  },
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        "type": "lines",
        "attributes": {
          "owner_id": "e5e28fdb-9130-4cee-9422-3cb2d6f83877",
          "owner_type": "orders",
...
```json
  {
  "data": {
    "id": "217fbcd2-f55a-488e-b5ed-c1296fc235a6",
    "type": "lines",
    "attributes": {
      "created_at": "2023-02-16T10:00:38+00:00",
      "updated_at": "2023-02-16T10:00:38+00:00",
      "archived": false,
      "archived_at": null,
      "title": null,
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/lines/1d5a9ff2-6bcd-43fd-902d-99bc16f1f4ad' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "1d5a9ff2-6bcd-43fd-902d-99bc16f1f4ad",
        "type": "lines",
        "attributes": {
          "price_each_in_cents": 1000
        }
...
```json
  ...
  "data": {
    ...
    "type": "lines",
    "attributes": {
      "created_at": "2023-02-16T10:00:40+00:00",
      "updated_at": "2023-02-16T10:00:40+00:00",
      "archived": false,
      "archived_at": null,
      "title": "Macbook Pro",
      "extra_information": "Comes with a mouse",
      ...
      "line_type": "charge",
      "relevant": true,
      "item_id": "e207f350-8bb1-411f-8e48-f0d9a1c7d45d",
      "tax_category_id": "f530cfed-ce86-4002-b19e-40ee8dd96e77",
      "planning_id": "d5b58302-1cb4-4d55-8010-c7e19372790e",
      "parent_line_id": null,
      "owner_id": "c731f493-3766-4fac-b2ce-3fc36fbe8ddf",
      "owner_type": "orders"
    },
    "relationships": {
      "item": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/lines/2c33f3f2-e8ce-4bae-95b2-b1056e935c71' \
    --header 'content-type: application/json' \
```
