...
```json
  ...
  "data": [
    {
      "id": "4dc6913b-07a8-45cd-866e-a20a10e2a7db",
      "type": "lines",
      "attributes": {
        "created_at": "2021-12-08T11:25:22+00:00",
        "updated_at": "2021-12-08T11:25:22+00:00",
        "title": "Macbook Pro",
        ...
        "line_type": "charge",
        "relevant": true,
        "item_id": "e4649de3-6bec-4111-976c-ed96dece470d",
        "tax_category_id": "d8f36c98-7c52-4acd-a5a4-cefc017eb66b",
        "parent_line_id": null,
        "owner_id": "df424da9-78da-4dcb-ab81-a115512d2289",
        "owner_type": "orders"
      },
      "relationships": {
        "item": {
          "links": {
            "related": "api/boomerang/items/e4649de3-6bec-4111-976c-ed96dece470d"
          }
        },
        "tax_category": {
          "links": {
            "related": "api/boomerang/tax_categories/d8f36c98-7c52-4acd-a5a4-cefc017eb66b"
          }
        },
        "parent_line": {
          "links": {
        ...
        "nested_lines": {
          "links": {
            "related": "api/boomerang/lines?filter[parent_line_id]=4dc6913b-07a8-45cd-866e-a20a10e2a7db"
          }
        },
        "owner": {
          "links": {
            "related": "api/boomerang/orders/df424da9-78da-4dcb-ab81-a115512d2289"
          }
        }
      }
    }
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/lines/9b8b511f-1c60-4637-84cb-08d8147a4bec' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "9b8b511f-1c60-4637-84cb-08d8147a4bec",
    "type": "lines",
    "attributes": {
      "created_at": "2021-12-08T11:25:26+00:00",
      "updated_at": "2021-12-08T11:25:26+00:00",
      "title": "Macbook Pro",
      "extra_information": "Comes with a mouse",
      "quantity": 1,
      "original_price_each_in_cents": 72500,
      ...
      "line_type": "charge",
      "relevant": true,
      "item_id": "d034c2bc-dcda-4b62-bc20-25bdd54ab3ff",
      "tax_category_id": "cc9c7398-9a15-41bd-8fb0-64982ff111cd",
      "parent_line_id": null,
      "owner_id": "22aa9b55-6593-4189-9b95-824a6badc3d0",
      "owner_type": "orders"
    },
    "relationships": {
      "item": {
        "links": {
          "related": "api/boomerang/items/d034c2bc-dcda-4b62-bc20-25bdd54ab3ff"
        }
      },
      "tax_category": {
        "links": {
          "related": "api/boomerang/tax_categories/cc9c7398-9a15-41bd-8fb0-64982ff111cd"
        }
      },
      "parent_line": {
        "links": {
      ...
      "nested_lines": {
        "links": {
          "related": "api/boomerang/lines?filter[parent_line_id]=9b8b511f-1c60-4637-84cb-08d8147a4bec"
        }
      },
      "owner": {
        "links": {
          "related": "api/boomerang/orders/22aa9b55-6593-4189-9b95-824a6badc3d0"
        }
      }
    }
  },
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        "type": "lines",
        "attributes": {
          "owner_id": "8d6728b1-1309-4ddd-8ca8-40cc8fed1825",
          "owner_type": "orders",
...
```json
  {
  "data": {
    "id": "4ae916f4-1d86-4ef0-ae05-b405a7f779a4",
    "type": "lines",
    "attributes": {
      "created_at": "2021-12-08T11:25:29+00:00",
      "updated_at": "2021-12-08T11:25:29+00:00",
      "title": null,
  ...
  "links": {
    "self": "api/boomerang/lines?data%5Battributes%5D%5Bowner_id%5D=8d6728b1-1309-4ddd-8ca8-40cc8fed1825&data%5Battributes%5D%5Bowner_type%5D=orders&data%5Battributes%5D%5Bprice_each_in_cents%5D=1000&data%5Btype%5D=lines&page%5Bnumber%5D=1&page%5Bsize%5D=25",
    "first": "api/boomerang/lines?data%5Battributes%5D%5Bowner_id%5D=8d6728b1-1309-4ddd-8ca8-40cc8fed1825&data%5Battributes%5D%5Bowner_type%5D=orders&data%5Battributes%5D%5Bprice_each_in_cents%5D=1000&data%5Btype%5D=lines&page%5Bnumber%5D=1&page%5Bsize%5D=25",
    "last": "api/boomerang/lines?data%5Battributes%5D%5Bowner_id%5D=8d6728b1-1309-4ddd-8ca8-40cc8fed1825&data%5Battributes%5D%5Bowner_type%5D=orders&data%5Battributes%5D%5Bprice_each_in_cents%5D=1000&data%5Btype%5D=lines&page%5Bnumber%5D=1&page%5Bsize%5D=25"
  },
  "meta": {}
}
```
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/lines/173670bf-404f-4348-b6cb-53b9ea0a50a5' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "173670bf-404f-4348-b6cb-53b9ea0a50a5",
        "type": "lines",
        "attributes": {
          "price_each_in_cents": 1000
        }
...
```json
  ...
  "data": {
    ...
    "type": "lines",
    "attributes": {
      "created_at": "2021-12-08T11:25:30+00:00",
      "updated_at": "2021-12-08T11:25:30+00:00",
      "title": "Macbook Pro",
      "extra_information": "Comes with a mouse",
      "quantity": 1,
      "original_price_each_in_cents": 72500,
      ...
      "line_type": "charge",
      "relevant": true,
      "item_id": "841542f8-5fc3-4d78-9065-3a167109a601",
      "tax_category_id": "dbe68456-4c02-4ebd-849a-1e365e0bc32a",
      "parent_line_id": null,
      "owner_id": "8b38f9de-d9dc-49ef-bba7-73bde7259fe8",
      "owner_type": "orders"
    },
    "relationships": {
      "item": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/lines/95e1f8fc-f51b-4664-b505-441e3956ab38' \
    --header 'content-type: application/json' \
```
