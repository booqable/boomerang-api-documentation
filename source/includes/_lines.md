...
```json
  ...
  "data": [
    {
      "id": "827e21a5-ba26-41b5-adfb-2a11579841f1",
      "type": "lines",
      "attributes": {
        "created_at": "2023-02-07T10:28:23+00:00",
        "updated_at": "2023-02-07T10:28:23+00:00",
        "archived": false,
        "archived_at": null,
        "title": "Macbook Pro",
        ...
        "line_type": "charge",
        "relevant": true,
        "item_id": "cfbc4e07-1ac9-4046-b190-21256c5cfbf6",
        "tax_category_id": "384b7a07-ba22-4e90-bbcf-45b743605355",
        "planning_id": "c032a48d-df5e-45c0-9982-877d66262aee",
        "parent_line_id": null,
        "owner_id": "1c51f093-c41b-47bd-99bf-3d8dd2b5a0aa",
        "owner_type": "orders"
      },
      "relationships": {
        "item": {
          "links": {
            "related": "api/boomerang/items/cfbc4e07-1ac9-4046-b190-21256c5cfbf6"
          }
        },
        "tax_category": {
          "links": {
            "related": "api/boomerang/tax_categories/384b7a07-ba22-4e90-bbcf-45b743605355"
          }
        },
        "planning": {
          "links": {
            "related": "api/boomerang/plannings/c032a48d-df5e-45c0-9982-877d66262aee"
          }
        },
        "parent_line": {
          "links": {
        ...
        "nested_lines": {
          "links": {
            "related": "api/boomerang/lines?filter[parent_line_id]=827e21a5-ba26-41b5-adfb-2a11579841f1"
          }
        },
        "owner": {
          "links": {
            "related": "api/boomerang/orders/1c51f093-c41b-47bd-99bf-3d8dd2b5a0aa"
          }
        }
      }
    }
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/lines/074736e0-b4cb-4c23-ad34-80de125051f8' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "074736e0-b4cb-4c23-ad34-80de125051f8",
    "type": "lines",
    "attributes": {
      ...
      "line_type": "charge",
      "relevant": true,
      "item_id": "aec76fec-42b0-43c6-9a67-bf40ac7e8466",
      "tax_category_id": "54b2d8e4-d418-451c-a7a4-3d31b5375cc3",
      "planning_id": "370f124c-1996-4d17-8da6-4afceb5084bf",
      "parent_line_id": null,
      "owner_id": "8c8c1bab-84be-4c54-b65d-9595482854db",
      "owner_type": "orders"
    },
    "relationships": {
      "item": {
        "links": {
          "related": "api/boomerang/items/aec76fec-42b0-43c6-9a67-bf40ac7e8466"
        }
      },
      "tax_category": {
        "links": {
          "related": "api/boomerang/tax_categories/54b2d8e4-d418-451c-a7a4-3d31b5375cc3"
        }
      },
      "planning": {
        "links": {
          "related": "api/boomerang/plannings/370f124c-1996-4d17-8da6-4afceb5084bf"
        }
      },
      "parent_line": {
        "links": {
      ...
      "nested_lines": {
        "links": {
          "related": "api/boomerang/lines?filter[parent_line_id]=074736e0-b4cb-4c23-ad34-80de125051f8"
        }
      },
      "owner": {
        "links": {
          "related": "api/boomerang/orders/8c8c1bab-84be-4c54-b65d-9595482854db"
        }
      }
    }
  },
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        "type": "lines",
        "attributes": {
          "owner_id": "1527bf98-ad1c-48e0-a2ae-a03483a3cef7",
          "owner_type": "orders",
...
```json
  {
  "data": {
    "id": "62f8b43b-bd81-476e-84cb-b5c89b11dbb8",
    "type": "lines",
    "attributes": {
      "created_at": "2023-02-07T10:28:29+00:00",
      "updated_at": "2023-02-07T10:28:29+00:00",
      "archived": false,
      "archived_at": null,
      "title": null,
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/lines/e17d6576-a848-4fc6-97ad-ae9dc1d82935' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "e17d6576-a848-4fc6-97ad-ae9dc1d82935",
        "type": "lines",
        "attributes": {
          "price_each_in_cents": 1000
        }
...
```json
  ...
  "data": {
    ...
    "type": "lines",
    "attributes": {
      "created_at": "2023-02-07T10:28:32+00:00",
      "updated_at": "2023-02-07T10:28:32+00:00",
      "archived": false,
      "archived_at": null,
      "title": "Macbook Pro",
      "extra_information": "Comes with a mouse",
      ...
      "line_type": "charge",
      "relevant": true,
      "item_id": "71633ff7-282a-4d00-bc16-e0f706d9c6be",
      "tax_category_id": "15d676ac-7209-4996-bcc6-c410537bb728",
      "planning_id": "8d58c773-14bd-4644-a3ed-9d17e6033373",
      "parent_line_id": null,
      "owner_id": "0030f6ec-58af-4f7c-ad31-8cbb4ae8b455",
      "owner_type": "orders"
    },
    "relationships": {
      "item": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/lines/facde0f9-21a8-45cf-a050-c23b8b5239e5' \
    --header 'content-type: application/json' \
```
