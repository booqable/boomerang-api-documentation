...
```json
  ...
  "data": [
    {
      "id": "fa1963b1-9b9c-4488-9f9c-fa8502918d04",
      "type": "lines",
      "attributes": {
        ...
        "line_type": "charge",
        "relevant": true,
        "item_id": "705c4787-ef6d-40dd-8836-6d3af9423381",
        "tax_category_id": "a440814b-ecf1-498f-b726-963d0be4ba16",
        "planning_id": "225a299e-00e9-4d8b-af3b-1bba746d808e",
        "parent_line_id": null,
        "owner_id": "bd61be2d-bc1c-418f-9b01-b867f1f347c8",
        "owner_type": "orders"
      },
      "relationships": {
        "item": {
          "links": {
            "related": "api/boomerang/items/705c4787-ef6d-40dd-8836-6d3af9423381"
          }
        },
        "tax_category": {
          "links": {
            "related": "api/boomerang/tax_categories/a440814b-ecf1-498f-b726-963d0be4ba16"
          }
        },
        "planning": {
          "links": {
            "related": "api/boomerang/plannings/225a299e-00e9-4d8b-af3b-1bba746d808e"
          }
        },
        "parent_line": {
          "links": {
        ...
        "nested_lines": {
          "links": {
            "related": "api/boomerang/lines?filter[parent_line_id]=fa1963b1-9b9c-4488-9f9c-fa8502918d04"
          }
        },
        "owner": {
          "links": {
            "related": "api/boomerang/orders/bd61be2d-bc1c-418f-9b01-b867f1f347c8"
          }
        }
      }
    }
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/lines/6d151151-c0b7-470e-b249-328c01f088de' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "6d151151-c0b7-470e-b249-328c01f088de",
    "type": "lines",
    "attributes": {
      ...
      "line_type": "charge",
      "relevant": true,
      "item_id": "2a58511c-4a76-4b2a-bdf9-7dd92c8f64d6",
      "tax_category_id": "c06ef25d-356f-4a0f-981d-2f944afe659a",
      "planning_id": "874cb73d-6970-4636-88c3-440a4d4c9be0",
      "parent_line_id": null,
      "owner_id": "9ee57611-998d-4406-84e9-248007ecb5ed",
      "owner_type": "orders"
    },
    "relationships": {
      "item": {
        "links": {
          "related": "api/boomerang/items/2a58511c-4a76-4b2a-bdf9-7dd92c8f64d6"
        }
      },
      "tax_category": {
        "links": {
          "related": "api/boomerang/tax_categories/c06ef25d-356f-4a0f-981d-2f944afe659a"
        }
      },
      "planning": {
        "links": {
          "related": "api/boomerang/plannings/874cb73d-6970-4636-88c3-440a4d4c9be0"
        }
      },
      "parent_line": {
        "links": {
      ...
      "nested_lines": {
        "links": {
          "related": "api/boomerang/lines?filter[parent_line_id]=6d151151-c0b7-470e-b249-328c01f088de"
        }
      },
      "owner": {
        "links": {
          "related": "api/boomerang/orders/9ee57611-998d-4406-84e9-248007ecb5ed"
        }
      }
    }
  },
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        "type": "lines",
        "attributes": {
          "owner_id": "ac4d28d3-73c8-472e-b338-62267d236dcc",
          "owner_type": "orders",
...
```json
  {
  "data": {
    "id": "9c48f77e-5d3f-43ac-a72f-ec3e3d4f5fdb",
    "type": "lines",
    "attributes": {
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/lines/a0b088b7-7f02-487e-9030-a574d28ea497' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "a0b088b7-7f02-487e-9030-a574d28ea497",
        "type": "lines",
        "attributes": {
          "price_each_in_cents": 1000
        }
...
```json
  ...
  "data": {
    ...
    "type": "lines",
    "attributes": {
      "created_at": "2023-02-01T15:18:44+00:00",
      "updated_at": "2023-02-01T15:18:44+00:00",
      "archived": false,
      "archived_at": null,
      "title": "Macbook Pro",
      "extra_information": "Comes with a mouse",
      ...
      "line_type": "charge",
      "relevant": true,
      "item_id": "58911a28-addd-42a1-bbc9-23fd345fb8d7",
      "tax_category_id": "69dfa20d-07e1-433a-b882-7d3e0c25733c",
      "planning_id": "7fd6b00a-3b92-4877-ab12-2cacf9dae528",
      "parent_line_id": null,
      "owner_id": "c00b0a83-856f-46f2-91a3-032e0d0029c1",
      "owner_type": "orders"
    },
    "relationships": {
      "item": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/lines/a2e983aa-721d-4b0f-9ad4-ae5d462a94d4' \
    --header 'content-type: application/json' \
```
