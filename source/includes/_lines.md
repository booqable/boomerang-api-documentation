...
```json
  ...
  "data": [
    {
      "id": "3953902c-0e1c-4230-9c5a-e5a420f706ae",
      "type": "lines",
      "attributes": {
        "created_at": "2022-03-15T10:35:22+00:00",
        "updated_at": "2022-03-15T10:35:22+00:00",
        "archived": false,
        "archived_at": null,
        "title": "Macbook Pro",
        ...
        "line_type": "charge",
        "relevant": true,
        "item_id": "7afe55ee-f89c-4c76-80c1-df4b4dd24341",
        "tax_category_id": "79ca327a-544b-40c9-a0d7-cc0c038bf617",
        "planning_id": "6864e338-1a6e-44ff-81ed-bdab0689b851",
        "parent_line_id": null,
        "owner_id": "610dffd2-c787-453c-bd75-1242ecb6df71",
        "owner_type": "orders"
      },
      "relationships": {
        "item": {
          "links": {
            "related": "api/boomerang/items/7afe55ee-f89c-4c76-80c1-df4b4dd24341"
          }
        },
        "tax_category": {
          "links": {
            "related": "api/boomerang/tax_categories/79ca327a-544b-40c9-a0d7-cc0c038bf617"
          }
        },
        "planning": {
          "links": {
            "related": "api/boomerang/plannings/6864e338-1a6e-44ff-81ed-bdab0689b851"
          }
        },
        "parent_line": {
          "links": {
        ...
        "nested_lines": {
          "links": {
            "related": "api/boomerang/lines?filter[parent_line_id]=3953902c-0e1c-4230-9c5a-e5a420f706ae"
          }
        },
        "owner": {
          "links": {
            "related": "api/boomerang/orders/610dffd2-c787-453c-bd75-1242ecb6df71"
          }
        }
      }
    }
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/lines/02a02976-75a3-474a-bf35-91aac58c5c27' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "02a02976-75a3-474a-bf35-91aac58c5c27",
    "type": "lines",
    "attributes": {
      "created_at": "2022-03-15T10:35:24+00:00",
      "updated_at": "2022-03-15T10:35:24+00:00",
      "archived": false,
      "archived_at": null,
      "title": "Macbook Pro",
      "extra_information": "Comes with a mouse",
      ...
      "line_type": "charge",
      "relevant": true,
      "item_id": "dc8939d2-579c-4119-aa5d-438455a74da8",
      "tax_category_id": "4be3cbd6-d4e2-414d-9410-4af7a74b47ac",
      "planning_id": "4ae2bfdd-0bcc-4d5d-91d8-8366e7170916",
      "parent_line_id": null,
      "owner_id": "80abe5c9-642f-40a0-b049-e43e44fc131d",
      "owner_type": "orders"
    },
    "relationships": {
      "item": {
        "links": {
          "related": "api/boomerang/items/dc8939d2-579c-4119-aa5d-438455a74da8"
        }
      },
      "tax_category": {
        "links": {
          "related": "api/boomerang/tax_categories/4be3cbd6-d4e2-414d-9410-4af7a74b47ac"
        }
      },
      "planning": {
        "links": {
          "related": "api/boomerang/plannings/4ae2bfdd-0bcc-4d5d-91d8-8366e7170916"
        }
      },
      "parent_line": {
        "links": {
      ...
      "nested_lines": {
        "links": {
          "related": "api/boomerang/lines?filter[parent_line_id]=02a02976-75a3-474a-bf35-91aac58c5c27"
        }
      },
      "owner": {
        "links": {
          "related": "api/boomerang/orders/80abe5c9-642f-40a0-b049-e43e44fc131d"
        }
      }
    }
  },
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        "type": "lines",
        "attributes": {
          "owner_id": "812698b4-185e-4cb2-855e-681eda2cb2a8",
          "owner_type": "orders",
...
```json
  {
  "data": {
    "id": "d58ae39a-110f-4c51-85ec-79359e7e5ed6",
    "type": "lines",
    "attributes": {
      "created_at": "2022-03-15T10:35:26+00:00",
      "updated_at": "2022-03-15T10:35:26+00:00",
      "archived": false,
      "archived_at": null,
      "title": null,
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/lines/2c5d9fa8-5bf0-4955-93a4-70b496cb20be' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "2c5d9fa8-5bf0-4955-93a4-70b496cb20be",
        "type": "lines",
        "attributes": {
          "price_each_in_cents": 1000
        }
...
```json
  ...
  "data": {
    ...
    "type": "lines",
    "attributes": {
      "created_at": "2022-03-15T10:35:28+00:00",
      "updated_at": "2022-03-15T10:35:28+00:00",
      "archived": false,
      "archived_at": null,
      "title": "Macbook Pro",
      "extra_information": "Comes with a mouse",
      ...
      "line_type": "charge",
      "relevant": true,
      "item_id": "3cea6009-f929-492b-941d-515edba5be7e",
      "tax_category_id": "85f279df-8d6c-4a33-8ad3-197e019b50b2",
      "planning_id": "9e4f227e-983c-438b-b491-a4c085a42ed0",
      "parent_line_id": null,
      "owner_id": "6b9aacce-1764-4b9e-86c8-e281d3b09006",
      "owner_type": "orders"
    },
    "relationships": {
      "item": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/lines/c00fdefc-db29-4d4f-bddf-87d25dc32c2d' \
    --header 'content-type: application/json' \
```
