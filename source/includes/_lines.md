...
```json
  ...
  "data": [
    {
      "id": "9d7e8916-01f2-4682-9ed8-5100be918de4",
      "type": "lines",
      "attributes": {
        "created_at": "2022-07-08T13:11:29+00:00",
        "updated_at": "2022-07-08T13:11:29+00:00",
        "archived": false,
        "archived_at": null,
        "title": "Macbook Pro",
        ...
        "line_type": "charge",
        "relevant": true,
        "item_id": "24076464-fcbc-49ca-bb88-b66bc31a5f7c",
        "tax_category_id": "06b46545-72dd-4437-a7f4-551f4e5d73fc",
        "planning_id": "adda3097-7979-4cd6-8dd6-8016c24713a5",
        "parent_line_id": null,
        "owner_id": "24c7dc76-0727-4710-9422-f43c6f431d6f",
        "owner_type": "orders"
      },
      "relationships": {
        "item": {
          "links": {
            "related": "api/boomerang/items/24076464-fcbc-49ca-bb88-b66bc31a5f7c"
          }
        },
        "tax_category": {
          "links": {
            "related": "api/boomerang/tax_categories/06b46545-72dd-4437-a7f4-551f4e5d73fc"
          }
        },
        "planning": {
          "links": {
            "related": "api/boomerang/plannings/adda3097-7979-4cd6-8dd6-8016c24713a5"
          }
        },
        "parent_line": {
          "links": {
        ...
        "nested_lines": {
          "links": {
            "related": "api/boomerang/lines?filter[parent_line_id]=9d7e8916-01f2-4682-9ed8-5100be918de4"
          }
        },
        "owner": {
          "links": {
            "related": "api/boomerang/orders/24c7dc76-0727-4710-9422-f43c6f431d6f"
          }
        }
      }
    }
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/lines/587c9a74-dc05-4aef-99b4-ffc075d7f64e' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "587c9a74-dc05-4aef-99b4-ffc075d7f64e",
    "type": "lines",
    "attributes": {
      "created_at": "2022-07-08T13:11:31+00:00",
      "updated_at": "2022-07-08T13:11:31+00:00",
      "archived": false,
      "archived_at": null,
      "title": "Macbook Pro",
      "extra_information": "Comes with a mouse",
      ...
      "line_type": "charge",
      "relevant": true,
      "item_id": "84df701b-572a-4d14-ae96-cd6f4bc43d63",
      "tax_category_id": "0cf9933d-d33e-4a1b-8bf8-604552b76b96",
      "planning_id": "e5679236-a23e-405f-b9f1-276ceb0a9c81",
      "parent_line_id": null,
      "owner_id": "0ad8322f-d2ea-4611-be7d-f745ca1347e7",
      "owner_type": "orders"
    },
    "relationships": {
      "item": {
        "links": {
          "related": "api/boomerang/items/84df701b-572a-4d14-ae96-cd6f4bc43d63"
        }
      },
      "tax_category": {
        "links": {
          "related": "api/boomerang/tax_categories/0cf9933d-d33e-4a1b-8bf8-604552b76b96"
        }
      },
      "planning": {
        "links": {
          "related": "api/boomerang/plannings/e5679236-a23e-405f-b9f1-276ceb0a9c81"
        }
      },
      "parent_line": {
        "links": {
      ...
      "nested_lines": {
        "links": {
          "related": "api/boomerang/lines?filter[parent_line_id]=587c9a74-dc05-4aef-99b4-ffc075d7f64e"
        }
      },
      "owner": {
        "links": {
          "related": "api/boomerang/orders/0ad8322f-d2ea-4611-be7d-f745ca1347e7"
        }
      }
    }
  },
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        "type": "lines",
        "attributes": {
          "owner_id": "9b69dc5e-e5c4-4ba7-9832-d2a810f9c8b8",
          "owner_type": "orders",
...
```json
  {
  "data": {
    "id": "a6000bd0-6be4-4a04-ada2-199e3417a6c0",
    "type": "lines",
    "attributes": {
      "created_at": "2022-07-08T13:11:34+00:00",
      "updated_at": "2022-07-08T13:11:34+00:00",
      "archived": false,
      "archived_at": null,
      "title": null,
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/lines/5f9ccd1d-8874-47cf-96df-0a76040accfd' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "5f9ccd1d-8874-47cf-96df-0a76040accfd",
        "type": "lines",
        "attributes": {
          "price_each_in_cents": 1000
        }
...
```json
  ...
  "data": {
    ...
    "type": "lines",
    "attributes": {
      "created_at": "2022-07-08T13:11:35+00:00",
      "updated_at": "2022-07-08T13:11:35+00:00",
      "archived": false,
      "archived_at": null,
      "title": "Macbook Pro",
      "extra_information": "Comes with a mouse",
      ...
      "line_type": "charge",
      "relevant": true,
      "item_id": "9ecf176f-fc5f-47f7-8e52-543ee759dc70",
      "tax_category_id": "dc93c519-c59d-4fb0-833d-b0450547d741",
      "planning_id": "33e1683a-2168-4b97-b563-06bad07c4c69",
      "parent_line_id": null,
      "owner_id": "b706c476-0faf-49d2-93b6-77573f6baa8e",
      "owner_type": "orders"
    },
    "relationships": {
      "item": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/lines/d8bf90f0-bf9e-435c-a621-05df4b6acfa4' \
    --header 'content-type: application/json' \
```
