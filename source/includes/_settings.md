...
```json
  {
  "data": {
    "id": "3668df43-8e4d-53eb-ad98-14eaedb007ff",
    "type": "settings",
    "attributes": {
      "updated_at": "2022-02-16T10:51:43+00:00",
      "currency": {
        "name": "USD",
        "decimal": ".",
        "thousand": ",",
      ...
      "defaults": {
        "timezone": "UTC",
        "tax_category_id": "fe3f5e9a-be9e-4a70-b762-824cb5c4fabd",
        "tax_region_id": "f641e5ea-f9f0-42e4-982f-c2cd597b5518"
      },
      "pricing": {
        "enabled": true,
