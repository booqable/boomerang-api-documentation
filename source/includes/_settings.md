...
```json
  {
  "data": {
    "id": "691f0772-1ad2-599d-a598-909c940b179a",
    "type": "settings",
    "attributes": {
      "updated_at": "2023-03-02T12:43:10+00:00",
      "currency": {
        "name": "USD",
        "decimal": ".",
        "thousand": ",",
      ...
      "defaults": {
        "timezone": "UTC",
        "tax_category_id": "57ed6add-7738-4256-91d0-97733a8c10be",
        "tax_region_id": "4af5ea7a-741e-43b3-a4f2-030ac4fb89f7",
