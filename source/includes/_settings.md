...
```json
  {
  "data": {
    "id": "f25d8853-17fa-5b83-aa63-b956b7655f94",
    "type": "settings",
    "attributes": {
      "updated_at": "2024-02-12T09:18:34+00:00",
      "currency": {
        "name": "USD",
        "decimal": ".",
        "thousand": ",",
      ...
      "defaults": {
        "timezone": "UTC",
        "timezone_offset": 0,
        "tax_category_id": "bb158110-d454-42d5-9001-08068957546f",
        "tax_region_id": "17f3ce90-e25c-4efe-bd15-db209a0581b6",
