...
```json
  {
  "data": {
    "id": "befa715f-4a32-5241-993e-8c287235b3d1",
    "type": "settings",
    "attributes": {
      "updated_at": "2022-04-07T10:06:22+00:00",
      "currency": {
        "name": "USD",
        "decimal": ".",
        "thousand": ",",
      ...
      "defaults": {
        "timezone": "UTC",
        "tax_category_id": "da40f2f2-b6fc-46be-9445-f9218cadba01",
        "tax_region_id": "fcff255f-8439-4042-a4bb-4274eb3a537a",
