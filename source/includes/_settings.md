...
```json
  {
  "data": {
    "id": "b677868c-65fc-5d88-b394-09aebff4f5d6",
    "type": "settings",
    "attributes": {
      "updated_at": "2023-02-24T09:50:59+00:00",
      "currency": {
        "name": "USD",
        "decimal": ".",
        "thousand": ",",
      ...
      "defaults": {
        "timezone": "UTC",
        "tax_category_id": "415ffad8-c119-421b-a3af-3c210512608d",
        "tax_region_id": "f68a4f69-afc7-4817-a89f-85b5205fe141",
