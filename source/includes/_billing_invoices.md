...
```json
  ...
  "data": [
    {
      "id": "56dfe4ee-853a-4a9f-bf94-990c5498f7ad",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/billing_invoices/441da7cf-edcf-436f-9535-0cc8785c194a' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "441da7cf-edcf-436f-9535-0cc8785c194a",
    "type": "billing_invoices",
    "attributes": {
      "number": 10001,
      "status": "open",
