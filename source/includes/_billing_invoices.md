...
```json
  ...
  "data": [
    {
      "id": "26a7b191-06cd-45bb-a4d2-f9edbed24558",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/billing_invoices/a0a6cf92-f0b6-4fff-8353-8894ddc1ee4a' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "a0a6cf92-f0b6-4fff-8353-8894ddc1ee4a",
    "type": "billing_invoices",
    "attributes": {
      "number": 10001,
      "status": "open",
