...
```json
  ...
  "data": [
    {
      "id": "03afeb14-392f-486c-85cd-8789d660f7f5",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/billing_invoices/54731f49-0e9f-48ab-b5fd-56b85f7f1501' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "54731f49-0e9f-48ab-b5fd-56b85f7f1501",
    "type": "billing_invoices",
    "attributes": {
      "number": 10001,
      "status": "open",
