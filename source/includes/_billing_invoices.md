...
```json
  ...
  "data": [
    {
      "id": "8f662a50-b00f-4a36-a9ab-59d5bbc68824",
      "type": "billing_invoices",
      "attributes": {
        "created_at": "2022-01-13T13:08:41+00:00",
        "updated_at": "2022-01-13T13:08:41+00:00",
        "number": 10001,
        "status": "open",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/billing_invoices/b50ee2dd-4135-4336-8014-511dfe73f950' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "b50ee2dd-4135-4336-8014-511dfe73f950",
    "type": "billing_invoices",
    "attributes": {
      "created_at": "2022-01-13T13:08:42+00:00",
      "updated_at": "2022-01-13T13:08:42+00:00",
      "number": 10001,
      "status": "open",
      "billing_reason": "subscription_create",
      "strategy": "charge_automatically",
