...
```json
  ...
  "data": [
    {
      "id": "7162b312-758f-4cc2-8bbd-ba06432c647d",
      ...
      "attributes": {
        ...
        "coupon": null,
        "url": "http://billing.lvh.me:/invoices/bef3c38abcbd98877c50d2783e92b409/518385f4a4517f445ec07d3b0a32ade2"
      }
    }
  ],
  "meta": {}
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/billing_invoices/df35624d-64da-4e3e-a90f-fa3641a249db' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "df35624d-64da-4e3e-a90f-fa3641a249db",
    "type": "billing_invoices",
    "attributes": {
      ...
      "next_payment_attempt_at": null,
      "coupon": null,
      "url": "http://billing.lvh.me:/invoices/c160546e06b90f57c5cfa78249d7adb2/6999945bf6ea1de92065a58011276466"
    }
  },
  "meta": {}
}
