...
```json
  ...
  "data": [
    {
      "id": "9040b4d7-2d78-433c-936a-4a31c73ce326",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/billing_invoices/aa23adc7-3e23-4c70-805b-65d117172526' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "aa23adc7-3e23-4c70-805b-65d117172526",
    "type": "billing_invoices",
    "attributes": {
      "number": 10001,
      "status": "open",
