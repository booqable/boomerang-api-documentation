...
```json
  ...
  "data": [
    {
      "id": "adf862ec-a7fe-46f9-be7d-95bb7e954ac0",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/billing_invoices/389473e0-5d3f-4fcb-a6e1-3fcec8f16907' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "389473e0-5d3f-4fcb-a6e1-3fcec8f16907",
    "type": "billing_invoices",
    "attributes": {
      "number": 10001,
      "status": "open",
