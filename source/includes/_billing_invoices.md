...
```json
  ...
  "data": [
    {
      "id": "6efa2001-46b5-440e-b38b-059d602cd2bf",
      ...
      "attributes": {
        ...
        "coupon": null,
        "url": "http://billing.lvh.me:/invoices/3bf5f1dfa173cf84f7aaac0ddd601e10/e6f4f2ff0bef78bb18b57ccb3897cf44"
      }
    }
  ],
  "meta": {}
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/billing_invoices/295fc664-8493-4b40-bc15-c889cfae026d' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "295fc664-8493-4b40-bc15-c889cfae026d",
    "type": "billing_invoices",
    "attributes": {
      "created_at": "2023-02-08T08:34:48+00:00",
      "updated_at": "2023-02-08T08:34:48+00:00",
      ...
      "next_payment_attempt_at": null,
      "coupon": null,
      "url": "http://billing.lvh.me:/invoices/d295463e23d63f28372459272ffbecdd/f4ee2781838ddf52a6108dbd972f7da2"
    }
  },
  "meta": {}
}
