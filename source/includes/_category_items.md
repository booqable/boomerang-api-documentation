...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/category_items?filter%5Bcategory_id%5D=7e0ecd75-b5ef-461e-a8fd-31b07b7ea85d&includes=item' \
...
```json
  ...
  "data": [
    {
      "id": "f9c5de89-29bf-4b86-9037-897bfb0f299e",
      "created_at": "2022-05-05T09:12:37+00:00",
      "updated_at": "2022-05-05T09:12:37+00:00",
      "position": null,
      "item_id": "c0d279f8-92c5-47b1-9e07-ce82788e73e5",
      "category_id": "7e0ecd75-b5ef-461e-a8fd-31b07b7ea85d"
    }
  ]
}
```
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        "type": "category_item",
        "attributes": {
          "category_id": "052e7293-83f7-456f-8dff-04d3b7661582",
          "item_id": "1db1671f-9dad-43b2-a6a9-78e44ddf3754"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "8773f9cd-3725-46c5-8ca6-bb5b8a399c03",
    "type": "category_items",
    "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/category_items/2a9a786c-41fd-4639-a99c-bc830a17b6b3' \
    --header 'content-type: application/json' \
    --data '{}'
```
