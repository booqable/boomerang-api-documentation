...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/category_items?filter%5Bcategory_id%5D=278d058f-8e94-49d0-8e36-27064c5f3528&includes=item' \
...
```json
  ...
  "data": [
    {
      "id": "830f4e7a-d579-4f25-9827-a45919212236",
      "created_at": "2022-07-14T12:39:29+00:00",
      "updated_at": "2022-07-14T12:39:29+00:00",
      "position": null,
      "item_id": "6aaab8c1-b1c9-41c6-92c6-2d54d4970f2d",
      "category_id": "278d058f-8e94-49d0-8e36-27064c5f3528"
    }
  ]
}
```
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        "type": "category_item",
        "attributes": {
          "category_id": "595ee668-d927-4fb5-92fb-96321f7762fb",
          "item_id": "1a3763e4-0951-4995-9acf-86d02f60097c"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "b199672a-1a98-472f-b805-a256ad7c2fdf",
    "type": "category_items",
    "attributes": {
      "created_at": "2022-07-14T12:39:30+00:00",
      "updated_at": "2022-07-14T12:39:30+00:00",
      "position": null,
      "item_id": "1a3763e4-0951-4995-9acf-86d02f60097c",
      "category_id": "595ee668-d927-4fb5-92fb-96321f7762fb"
    },
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/category_items/9dbcd9a5-1b93-4ed3-ace4-3f400c0592e1' \
    --header 'content-type: application/json' \
    --data '{}'
```
