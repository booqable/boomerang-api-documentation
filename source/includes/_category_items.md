...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/category_items?filter%5Bcategory_id%5D=e160fa6a-59b1-42d6-82dd-985120b2a559&includes=item' \
...
```json
  ...
  "data": [
    {
      "id": "22e43fbc-d874-4881-b7fa-0a01f4514878",
      "created_at": "2022-05-03T10:18:14+00:00",
      "updated_at": "2022-05-03T10:18:14+00:00",
      "position": null,
      "item_id": "dd88c106-bf53-4219-bd02-23702f99b0be",
      "category_id": "e160fa6a-59b1-42d6-82dd-985120b2a559"
    }
  ]
}
```
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        "type": "category_item",
        "attributes": {
          "category_id": "1c652aa5-86de-4a64-88b5-5fae71bcbb65",
          "item_id": "76bad66b-812c-42c6-b5fc-cbc2815961c5"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "a5866414-3850-4e2a-8476-48b739089e30",
    "type": "category_items",
    "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/category_items/271dc238-8aef-4442-a259-df61d93c4551' \
    --header 'content-type: application/json' \
    --data '{}'
```
