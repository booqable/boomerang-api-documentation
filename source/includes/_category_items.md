...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/category_items?filter%5Bcategory_id%5D=623311c0-3b49-4e14-b192-63c44850cff1&includes=item' \
...
```json
  ...
  "data": [
    {
      "id": "886489de-1deb-4ca2-8e4d-2a37a7430488",
      "created_at": "2022-05-19T13:57:47+00:00",
      "updated_at": "2022-05-19T13:57:47+00:00",
      "position": null,
      "item_id": "fc86ce34-7328-4197-abde-d1c6d8c7e6f4",
      "category_id": "623311c0-3b49-4e14-b192-63c44850cff1"
    }
  ]
}
```
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        "type": "category_item",
        "attributes": {
          "category_id": "91b818a4-a5ee-4461-9950-dcc66a0344f6",
          "item_id": "af6ec8a9-8696-4214-892a-c7a79a105482"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "67bd4257-61f1-4495-8e16-a0f20bee3fb8",
    "type": "category_items",
    "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/category_items/31299b00-04b6-4f1b-adb7-06d29be900b1' \
    --header 'content-type: application/json' \
    --data '{}'
```
