...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/category_items?filter%5Bcategory_id%5D=a3864182-2e0b-4341-adeb-3e4fbf775f10&includes=item' \
...
```json
  ...
  "data": [
    {
      "id": "28e586f9-96d3-449e-9ab8-e5dc9ecd840a",
      "created_at": "2022-06-30T08:45:47+00:00",
      "updated_at": "2022-06-30T08:45:47+00:00",
      "position": null,
      "item_id": "e63400ae-4e05-417f-a044-36c28de40f4e",
      "category_id": "a3864182-2e0b-4341-adeb-3e4fbf775f10"
    }
  ]
}
```
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        "type": "category_item",
        "attributes": {
          "category_id": "163557f5-8403-4291-9ca2-e6482b79ac8d",
          "item_id": "b740925f-8972-469f-a818-2111d00d9345"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "ad76a066-46f7-460d-be87-7287839a0732",
    "type": "category_items",
    "attributes": {
      "created_at": "2022-06-30T08:45:48+00:00",
      "updated_at": "2022-06-30T08:45:48+00:00",
      "position": null,
      "item_id": "b740925f-8972-469f-a818-2111d00d9345",
      "category_id": "163557f5-8403-4291-9ca2-e6482b79ac8d"
    },
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/category_items/be1589a6-1751-428c-8821-2fdac0b14e4f' \
    --header 'content-type: application/json' \
    --data '{}'
```
