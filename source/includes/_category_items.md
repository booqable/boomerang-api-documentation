...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/category_items?filter%5Bcategory_id%5D=cb35f79f-0ebb-4c98-b9a8-fb016a924697&includes=item' \
...
```json
  ...
  "data": [
    {
      "id": "6e1b6ad4-ba4a-449d-80e7-29fedff1f2ec",
      "created_at": "2022-06-04T09:50:23+00:00",
      "updated_at": "2022-06-04T09:50:23+00:00",
      "position": null,
      "item_id": "db8c2a0f-000b-4a11-aefb-94867605cf14",
      "category_id": "cb35f79f-0ebb-4c98-b9a8-fb016a924697"
    }
  ]
}
```
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        "type": "category_item",
        "attributes": {
          "category_id": "ebbfde9b-ef05-4cc7-89e0-2313054eb694",
          "item_id": "ee0b184c-a2ff-4643-9c10-c79f9490502d"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "5adb6dd4-aa25-4dc5-9561-4d07646d5791",
    "type": "category_items",
    "attributes": {
      "created_at": "2022-06-04T09:50:23+00:00",
      "updated_at": "2022-06-04T09:50:23+00:00",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/category_items/dd81648e-5106-4cc3-be17-1d517b74d991' \
    --header 'content-type: application/json' \
    --data '{}'
```
