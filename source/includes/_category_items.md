...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/category_items?filter%5Bcategory_id%5D=08fcf72e-f069-4ab8-bb58-a77ce6a52624&includes=item' \
...
```json
  ...
  "data": [
    {
      "id": "a23d6c53-4034-425c-9c87-874896d89b81",
      "created_at": "2022-05-24T07:45:21+00:00",
      "updated_at": "2022-05-24T07:45:21+00:00",
      "position": null,
      "item_id": "a62b1b5f-36ec-444a-bab9-adad13458260",
      "category_id": "08fcf72e-f069-4ab8-bb58-a77ce6a52624"
    }
  ]
}
```
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        "type": "category_item",
        "attributes": {
          "category_id": "eb4db6ea-56f3-4c00-bd0e-75d8f1d792bd",
          "item_id": "283d1dd2-f373-4e54-a6b4-bd3056f6d26a"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "e157b64d-1ea6-4fb4-ac38-e81034fe3df3",
    "type": "category_items",
    "attributes": {
      "created_at": "2022-05-24T07:45:21+00:00",
      "updated_at": "2022-05-24T07:45:21+00:00",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/category_items/a8beafb1-0d92-436c-b62d-2f8ace771daa' \
    --header 'content-type: application/json' \
    --data '{}'
```
