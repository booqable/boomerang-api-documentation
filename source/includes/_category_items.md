...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/category_items?filter%5Bcategory_id%5D=1d18880a-9b1d-4ef3-a316-351456d42a77&includes=item' \
...
```json
  ...
  "data": [
    {
      "id": "6a4012df-3fb5-4646-b22d-5b10fc37b1ef",
      "created_at": "2022-07-08T08:53:41+00:00",
      "updated_at": "2022-07-08T08:53:41+00:00",
      "position": null,
      "item_id": "9cd854e4-bfde-42a7-928e-6d991b96809f",
      "category_id": "1d18880a-9b1d-4ef3-a316-351456d42a77"
    }
  ]
}
```
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        "type": "category_item",
        "attributes": {
          "category_id": "4d66e22d-ef15-40ab-9328-adf2e1579a41",
          "item_id": "975cf39d-cc68-4a07-b387-461c95410378"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "f877e917-7123-4dba-847d-a3192fbd7f7a",
    "type": "category_items",
    "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/category_items/3954d013-6b9d-467a-880b-f47f0f7b4d66' \
    --header 'content-type: application/json' \
    --data '{}'
```
