...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/category_items?filter%5Bcategory_id%5D=d1f1ce04-4758-42c3-8d20-bdc627eb0753&includes=item' \
...
```json
  ...
  "data": [
    {
      "id": "a8b3db20-ee75-42f0-a0b2-95caff3d736d",
      "created_at": "2022-07-14T21:13:27+00:00",
      "updated_at": "2022-07-14T21:13:27+00:00",
      "position": null,
      "item_id": "cdb1da7c-407b-4c2d-b022-fc4eda75b1ed",
      "category_id": "d1f1ce04-4758-42c3-8d20-bdc627eb0753"
    }
  ]
}
```
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        "type": "category_item",
        "attributes": {
          "category_id": "038ad77d-1a64-4fed-8d94-2bb10450a0f1",
          "item_id": "4a963d4f-e240-48f4-9cdf-85b3a5b6d2aa"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "89bba5b8-2855-4dbf-a7bc-d8af7f734a04",
    "type": "category_items",
    "attributes": {
      "created_at": "2022-07-14T21:13:28+00:00",
      "updated_at": "2022-07-14T21:13:28+00:00",
      "position": null,
      "item_id": "4a963d4f-e240-48f4-9cdf-85b3a5b6d2aa",
      "category_id": "038ad77d-1a64-4fed-8d94-2bb10450a0f1"
    },
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/category_items/cccdddd3-9987-4022-9006-b1da0cb912bd' \
    --header 'content-type: application/json' \
    --data '{}'
```
