...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/category_items?filter%5Bcategory_id%5D=a477bad3-fb7d-4213-95b4-8577e3d5d7ae&includes=item' \
...
```json
  ...
  "data": [
    {
      "id": "a6ce8b0b-53e7-4ef6-8a7e-f5d276a68616",
      "created_at": "2022-07-13T08:17:35+00:00",
      "updated_at": "2022-07-13T08:17:35+00:00",
      "position": null,
      "item_id": "c9fd34d4-7eec-4459-a38f-c096c088dcc6",
      "category_id": "a477bad3-fb7d-4213-95b4-8577e3d5d7ae"
    }
  ]
}
```
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        "type": "category_item",
        "attributes": {
          "category_id": "92eecce7-35d7-4bd7-a45f-204e18019cad",
          "item_id": "1017cf40-6e8f-4dfe-a8bf-f740e448fd5c"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "dbd6b17d-528e-4077-be37-7141c89850bd",
    "type": "category_items",
    "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/category_items/9fe914cc-4fe4-4f8c-9da5-da89d76db23c' \
    --header 'content-type: application/json' \
    --data '{}'
```
