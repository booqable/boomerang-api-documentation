...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/category_items?filter%5Bcategory_id%5D=627041f0-dcae-4e35-82d5-e7c61a4cc126&includes=item' \
...
```json
  ...
  "data": [
    {
      "id": "933eccd1-3c84-453d-be23-0887f4b91586",
      "created_at": "2022-03-15T16:23:24+00:00",
      "updated_at": "2022-03-15T16:23:24+00:00",
      "position": null,
      "item_id": "3d60b396-82c1-4128-818f-93bdd7c43c5f",
      "category_id": "627041f0-dcae-4e35-82d5-e7c61a4cc126"
    }
  ]
}
```
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        "type": "category_item",
        "attributes": {
          "category_id": "f912f50e-c8c9-41ea-9841-43e868441541",
          "item_id": "f37fba28-ee02-4b35-abd8-0d5366210d4e"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "3a313f7c-1f5e-4c3b-bba8-8d829121c617",
    "type": "category_items",
    "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/category_items/5b94d7c3-cab4-42d3-9c1e-a41e06ad36ad' \
    --header 'content-type: application/json' \
    --data '{}'
```
