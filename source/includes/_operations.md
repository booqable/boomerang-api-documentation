...
```json
  ...
  "data": [
    {
      "id": "5a35a3b3-baf1-403e-b066-26479c1ac3f5",
      "type": "operations",
      "attributes": {
        "created_at": "2023-01-18T13:36:19+00:00",
        "updated_at": "2023-01-18T13:36:19+00:00",
        "status": "scheduled",
        "status_message": null,
        "finished_at": null,
        "description": null,
        ...
        "error_data": [],
        "error_count": 0,
        "employee_id": "6d065e30-9847-45f4-930c-a4838bea2841"
      },
      "relationships": {
        "employee": {
          "links": {
            "related": "api/boomerang/employees/6d065e30-9847-45f4-930c-a4838bea2841"
          }
        }
      }
    }
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/operations/374ac3c5-a73e-4ef1-88b8-9003fa18ded8' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "374ac3c5-a73e-4ef1-88b8-9003fa18ded8",
    "type": "operations",
    "attributes": {
      "created_at": "2023-01-18T13:36:20+00:00",
      "updated_at": "2023-01-18T13:36:20+00:00",
      "status": "scheduled",
      "status_message": null,
      "finished_at": null,
      "description": null,
      ...
      "error_data": [],
      "error_count": 0,
      "employee_id": "98c672c1-c7a3-44be-bc9b-fcaae2f69425"
    },
    "relationships": {
      "employee": {
        "links": {
          "related": "api/boomerang/employees/98c672c1-c7a3-44be-bc9b-fcaae2f69425"
        }
      }
    }
  },
...
```json
  {
  "data": {
    "id": "e25683b1-bd2b-4a86-82fb-f10771d890f2",
    "type": "operations",
    "attributes": {
      "created_at": "2023-01-18T13:36:20+00:00",
      "updated_at": "2023-01-18T13:36:20+00:00",
      ...
      "error_data": [],
      "error_count": 0,
      "employee_id": "cdcb4f0c-cacb-43a7-aec5-bf9ff7f1966d"
    },
    "relationships": {
      "employee": {
        "meta": {
