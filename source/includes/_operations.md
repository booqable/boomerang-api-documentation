...
```json
  ...
  "data": [
    {
      "id": "4d10f519-c30b-4fdb-ab2a-bbdf56ba3575",
      "type": "operations",
      "attributes": {
        "status": "scheduled",
        "status_message": null,
        ...
        "error_data": [],
        "error_count": 0,
        "employee_id": "ca1f9697-d76e-4409-96be-4520b2239dec"
      },
      "relationships": {
        "employee": {
          "links": {
            "related": "api/boomerang/employees/ca1f9697-d76e-4409-96be-4520b2239dec"
          }
        }
      }
    }
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/operations/be185aed-77c8-4161-a057-a5f8ae1396ca' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "be185aed-77c8-4161-a057-a5f8ae1396ca",
    "type": "operations",
    "attributes": {
      "status": "scheduled",
      "status_message": null,
      ...
      "error_data": [],
      "error_count": 0,
      "employee_id": "8ab516a2-cb2e-403b-9900-a81260db246b"
    },
    "relationships": {
      "employee": {
        "links": {
          "related": "api/boomerang/employees/8ab516a2-cb2e-403b-9900-a81260db246b"
        }
      }
    }
  },
...
```json
  {
  "data": {
    "id": "0d64e1c7-92c8-405f-8760-1456095c981b",
    "type": "operations",
    "attributes": {
      "status": "scheduled",
      "status_message": null,
      ...
      "error_data": [],
      "error_count": 0,
      "employee_id": "c1a3e406-70c6-49a1-b4d8-6ca1622b0885"
    },
    "relationships": {
      "employee": {
        "meta": {
