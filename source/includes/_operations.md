...
```json
  ...
  "data": [
    {
      "id": "8bf08633-9744-4337-8fce-8b114ac1e085",
      "type": "operations",
      "attributes": {
        "created_at": "2023-02-14T15:28:18+00:00",
        "updated_at": "2023-02-14T15:28:18+00:00",
        "status": "scheduled",
        "status_message": null,
        "finished_at": null,
        "description": null,
        ...
        "error_data": [],
        "error_count": 0,
        "employee_id": "97fa75a4-6f83-4072-8859-26812fa14172"
      },
      "relationships": {
        "employee": {
          "links": {
            "related": "api/boomerang/employees/97fa75a4-6f83-4072-8859-26812fa14172"
          }
        }
      }
    }
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/operations/a37aba21-6734-4dc1-b336-027082e58475' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "a37aba21-6734-4dc1-b336-027082e58475",
    "type": "operations",
    "attributes": {
      "created_at": "2023-02-14T15:28:18+00:00",
      "updated_at": "2023-02-14T15:28:18+00:00",
      ...
      "error_data": [],
      "error_count": 0,
      "employee_id": "c4a7dce8-b471-42fd-8acf-8b288ffc633b"
    },
    "relationships": {
      "employee": {
        "links": {
          "related": "api/boomerang/employees/c4a7dce8-b471-42fd-8acf-8b288ffc633b"
        }
      }
    }
  },
...
```json
  {
  "data": {
    "id": "b6bac36d-9ed2-408b-97ce-b8b56585583f",
    "type": "operations",
    "attributes": {
      "created_at": "2023-02-14T15:28:19+00:00",
      "updated_at": "2023-02-14T15:28:19+00:00",
      "status": "scheduled",
      "status_message": null,
      "finished_at": null,
      ...
      "error_data": [],
      "error_count": 0,
      "employee_id": "b753762b-e463-4dfd-b843-6eb0d8c9435c"
    },
    "relationships": {
      "employee": {
        "meta": {
