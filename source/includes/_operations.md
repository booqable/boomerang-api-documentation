...
```json
  ...
  "data": [
    {
      "id": "3166eb9b-01e0-427b-af7c-d585f1949b5b",
      "type": "operations",
      "attributes": {
        "created_at": "2023-01-26T08:10:05+00:00",
        "updated_at": "2023-01-26T08:10:05+00:00",
        "status": "scheduled",
        "status_message": null,
        "finished_at": null,
        "description": null,
        ...
        "error_data": [],
        "error_count": 0,
        "employee_id": "121f46b9-f81d-45b4-8f5f-97946ef94d81"
      },
      "relationships": {
        "employee": {
          "links": {
            "related": "api/boomerang/employees/121f46b9-f81d-45b4-8f5f-97946ef94d81"
          }
        }
      }
    }
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/operations/1d708317-f58c-43c6-892e-f2cabb386122' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "1d708317-f58c-43c6-892e-f2cabb386122",
    "type": "operations",
    "attributes": {
      "created_at": "2023-01-26T08:10:06+00:00",
      "updated_at": "2023-01-26T08:10:06+00:00",
      "status": "scheduled",
      "status_message": null,
      "finished_at": null,
      "description": null,
      ...
      "error_data": [],
      "error_count": 0,
      "employee_id": "746c4d22-d191-4248-b45d-76b8e8750842"
    },
    "relationships": {
      "employee": {
        "links": {
          "related": "api/boomerang/employees/746c4d22-d191-4248-b45d-76b8e8750842"
        }
      }
    }
  },
...
```json
  {
  "data": {
    "id": "fcba6b04-d924-4d53-8fff-24a3751bd300",
    "type": "operations",
    "attributes": {
      "created_at": "2023-01-26T08:10:06+00:00",
      "updated_at": "2023-01-26T08:10:06+00:00",
      ...
      "error_data": [],
      "error_count": 0,
      "employee_id": "f894fe0c-9f39-4253-8309-93d8d90fd288"
    },
    "relationships": {
      "employee": {
        "meta": {
