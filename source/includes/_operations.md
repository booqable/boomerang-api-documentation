...
```json
  ...
  "data": [
    {
      "id": "499be651-3a48-4c51-a013-495647712397",
      "type": "operations",
      "attributes": {
        "created_at": "2022-03-29T09:20:50+00:00",
        "updated_at": "2022-03-29T09:20:50+00:00",
        "status": "scheduled",
        "status_message": null,
        "finished_at": null,
        "description": null,
        ...
        "error_data": [],
        "error_count": 0,
        "employee_id": "54cae6ab-4cae-49dc-949a-e5d745cbbf44"
      },
      "relationships": {
        "employee": {
          "links": {
            "related": "api/boomerang/employees/54cae6ab-4cae-49dc-949a-e5d745cbbf44"
          }
        }
      }
    }
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/operations/1a933903-71ca-4cb0-be21-c9ad96e26e74' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "1a933903-71ca-4cb0-be21-c9ad96e26e74",
    "type": "operations",
    "attributes": {
      "created_at": "2022-03-29T09:20:50+00:00",
      "updated_at": "2022-03-29T09:20:50+00:00",
      ...
      "error_data": [],
      "error_count": 0,
      "employee_id": "632ab1de-a597-4d8e-9132-9a2d002f001c"
    },
    "relationships": {
      "employee": {
        "links": {
          "related": "api/boomerang/employees/632ab1de-a597-4d8e-9132-9a2d002f001c"
        }
      }
    }
  },
...
```json
  {
  "data": {
    "id": "8af7169b-7a4c-4a04-bb9e-c94ee84673ce",
    "type": "operations",
    "attributes": {
      "created_at": "2022-03-29T09:20:50+00:00",
      "updated_at": "2022-03-29T09:20:50+00:00",
      ...
      "error_data": [],
      "error_count": 0,
      "employee_id": "c16d4166-bf78-4061-9597-df4513e66bee"
    },
    "relationships": {
      "employee": {
        "meta": {
