...
```json
  ...
  "data": [
    {
      "id": "3c096654-f1f8-4544-878a-86f1fa816fcd",
      "type": "operations",
      "attributes": {
        "created_at": "2023-02-21T16:15:36+00:00",
        "updated_at": "2023-02-21T16:15:36+00:00",
        "status": "scheduled",
        "status_message": null,
        "finished_at": null,
        "description": null,
        ...
        "error_data": [],
        "error_count": 0,
        "employee_id": "0d2ed9cc-9040-4e34-9335-908d58d0cc31"
      },
      "relationships": {
        "employee": {
          "links": {
            "related": "api/boomerang/employees/0d2ed9cc-9040-4e34-9335-908d58d0cc31"
          }
        }
      }
    }
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/operations/06b538ee-3ac7-44b4-b111-7c995740597c' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "06b538ee-3ac7-44b4-b111-7c995740597c",
    "type": "operations",
    "attributes": {
      "created_at": "2023-02-21T16:15:36+00:00",
      "updated_at": "2023-02-21T16:15:36+00:00",
      ...
      "error_data": [],
      "error_count": 0,
      "employee_id": "d723b343-f1b3-4975-a95b-63e03c2fa222"
    },
    "relationships": {
      "employee": {
        "links": {
          "related": "api/boomerang/employees/d723b343-f1b3-4975-a95b-63e03c2fa222"
        }
      }
    }
  },
...
```json
  {
  "data": {
    "id": "15b0850f-7f5a-49f9-b2a2-eea7b2496907",
    "type": "operations",
    "attributes": {
      "created_at": "2023-02-21T16:15:37+00:00",
      "updated_at": "2023-02-21T16:15:37+00:00",
      "status": "scheduled",
      "status_message": null,
      "finished_at": null,
      ...
      "error_data": [],
      "error_count": 0,
      "employee_id": "c90e5ce7-c7a6-4331-a346-c00489f73509"
    },
    "relationships": {
      "employee": {
        "meta": {
