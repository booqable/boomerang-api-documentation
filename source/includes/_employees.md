...
```json
  ...
  "data": [
    {
      "id": "662db661-44ec-4925-86fc-2258ba51c3a0",
      "type": "employees",
      "attributes": {
        "created_at": "2022-07-14T10:49:36+00:00",
        "updated_at": "2022-07-14T10:49:36+00:00",
        "name": "John Doe",
        "firstname": "John",
        "lastname": "Doe",
        "email": "john@doe.com",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/employees/dd644d57-13d9-4005-8f80-7bd0ccb4a774' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "dd644d57-13d9-4005-8f80-7bd0ccb4a774",
    "type": "employees",
    "attributes": {
      "created_at": "2022-07-14T10:49:36+00:00",
      "updated_at": "2022-07-14T10:49:36+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/employees/859b5b96-1da7-4848-bc48-5b460497a9a5' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "859b5b96-1da7-4848-bc48-5b460497a9a5",
        "type": "employees",
        "attributes": {
          "firstname": "Jane"
        }
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/employees/55608086-4d07-451c-b3c1-a89bd6ace7e4' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "55608086-4d07-451c-b3c1-a89bd6ace7e4",
        "type": "employees",
        "attributes": {
          "active": false
        }
...
```json
  ...
  "data": {
    ...
    "type": "employees",
    "attributes": {
      "created_at": "2022-07-14T10:49:37+00:00",
      "updated_at": "2022-07-14T10:49:37+00:00",
      "name": "John Doe",
      "firstname": "John",
      "lastname": "Doe",
      "email": "jane@doe.com",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/employees/5191a685-2755-44fa-b434-6961cc7e921b' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "5191a685-2755-44fa-b434-6961cc7e921b",
        "type": "employees",
        "attributes": {
          "permissions": [
            "reports",
