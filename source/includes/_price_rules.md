  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        "type": "price_rules",
        "attributes": {
          "price_ruleset_id": "520e28cc-1b04-40fe-90cd-569036adc9d8",
          "name": "Off season",
          "rule_type": "range_of_dates",
          "match_strategy": "span",
          "value": 25,
          "from": "2022-12-05T11:04:59.963Z",
          "till": "2023-02-05T11:04:59.963Z"
        }
      },
      "include": "price_rules"
    }'
...
```json
  {
  "data": {
    "id": "bd9cb894-0ad6-4d5d-a9fa-21d3d670412d",
    "type": "price_rules",
    "attributes": {
      "created_at": "2023-01-05T11:04:59+00:00",
      "updated_at": "2023-01-05T11:04:59+00:00",
      "name": "Off season",
      "rule_type": "range_of_dates",
      "match_strategy": "span",
      "adjustment_strategy": "percentage",
      "value": 25.0,
      "from": "2022-12-05T11:04:59+00:00",
      "till": "2023-02-05T11:04:59+00:00",
      "from_day": null,
      "till_day": null,
      "from_time": null,
      "till_time": null,
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/price_rules/f4d7b3de-3e90-4f53-8b28-e6d6844626e6' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "f4d7b3de-3e90-4f53-8b28-e6d6844626e6",
        "type": "price_rules",
        "attributes": {
          "value": 10
        }
...
```json
  ...
  "data": {
    ...
    "type": "price_rules",
    "attributes": {
      "created_at": "2023-01-05T11:05:00+00:00",
      "updated_at": "2023-01-05T11:05:00+00:00",
      "name": "Holidays",
      "rule_type": "range_of_dates",
      "match_strategy": "span",
      "adjustment_strategy": "percentage",
      ...
      "stacked": false,
      "time": null,
      "price_ruleset_id": "8657c358-975a-4252-aa9a-88e0877bfb0d"
    },
    "relationships": {
      "price_ruleset": {
        "meta": {
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/price_rules/66b74031-a020-4f48-8757-f036c0bc0575' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "66b74031-a020-4f48-8757-f036c0bc0575",
        "type": "price_rules",
        "attributes": {
          "id": "66b74031-a020-4f48-8757-f036c0bc0575",
          "name": "Off season"
...
```json
  ...
  "data": {
    ...
    "attributes": {
      ...
      "stacked": false,
      "time": null,
      "price_ruleset_id": "7aa222be-f713-47a8-b803-de9251a064fd"
    },
    "relationships": {
      "price_ruleset": {
        "meta": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/price_rules/b5d0de5a-4908-40a2-b50e-d98f8b69a887' \
    --header 'content-type: application/json' \
```
