...
`signature_base64` | **String** `required` `writeonly`<br>Base64 encoded signature, use this field to store a signature
`document_id` | **Uuid** <br>Associated Document
`order_id` | **Uuid** `readonly`<br>Associated Order
`customer_id` | **Uuid** `readonly`<br>Associated Customer
...
`document` | **Documents** `readonly`<br>Associated Document
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        "type": "signatures",
        "attributes": {
          "document_id": "eb686582-3f3e-4a59-8329-effa3bdf530b",
...
```json
  {
  "data": {
    "id": "bb3b8a91-7f94-52d3-9eda-f329d8d9058e",
    "type": "signatures",
    "attributes": {
      "document_id": "eb686582-3f3e-4a59-8329-effa3bdf530b",
      "order_id": "dc4f509e-bab5-4103-a8d9-4ea99cbbe466",
      "customer_id": "cba15723-3050-4b5c-ae6a-aa60a4c3f3f7"
    },
    "relationships": {
      "document": {
        "data": {
          "type": "documents",
          "id": "eb686582-3f3e-4a59-8329-effa3bdf530b"
        }
      },
      "order": {
        "data": {
          "type": "orders",
          "id": "dc4f509e-bab5-4103-a8d9-4ea99cbbe466"
        }
      }
    }
  },
  "included": [
    {
      ...
      "type": "documents",
      "attributes": {
        "created_at": "2024-11-25T09:25:44.372458+00:00",
        "updated_at": "2024-11-25T09:25:44.462793+00:00",
        "archived": false,
        "archived_at": null,
        ...
        "confirmed": true,
        "status": "confirmed",
        "signature_url": "/uploads/e62a265b4011fd9cbefa094a02333495/document/contract/signature/eb686582-3f3e-4a59-8329-effa3bdf530b/bc59adb0-6f2f-4181-a152-07280be90d04.png",
        "deposit_type": "none",
        "deposit_value": 0.0,
        "tag_list": [],
        "price_in_cents": 0,
...
`data[attributes][document_id]` | **Uuid** <br>Associated Document
