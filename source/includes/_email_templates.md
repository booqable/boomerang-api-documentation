...
```json
  ...
  "data": [
    {
      "id": "59058427-75c8-46eb-9c54-4919a9f13841",
      "type": "email_templates",
      "attributes": {
        "created_at": "2023-01-26T08:09:12+00:00",
        "updated_at": "2023-01-26T08:09:12+00:00",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/email_templates/cfe5fd67-cfe5-4be1-b68b-205f6b95133e' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "cfe5fd67-cfe5-4be1-b68b-205f6b95133e",
    "type": "email_templates",
    "attributes": {
      "created_at": "2023-01-26T08:09:12+00:00",
      "updated_at": "2023-01-26T08:09:12+00:00",
...
```json
  {
  "data": {
    "id": "36a2dae0-9f56-4cec-9e9b-c8f584d4d8f7",
    "type": "email_templates",
    "attributes": {
      "created_at": "2023-01-26T08:09:13+00:00",
      "updated_at": "2023-01-26T08:09:13+00:00",
      "name": "Webshop confirmation",
      "identifier": "webshop_confirmation",
      "subject": "We received your order (#{{order.number}})",
      "context": "order",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/email_templates/d4e24515-f002-4ba7-bc07-d8d7e850e3a9' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "d4e24515-f002-4ba7-bc07-d8d7e850e3a9",
        "type": "email_templates",
        "attributes": {
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/email_templates/52b45e93-159e-48f8-9194-240b48261366' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "52b45e93-159e-48f8-9194-240b48261366",
        "type": "email_templates",
        "attributes": {
          "name": "Order confirmation"
        }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/email_templates/62734e3d-4620-43f0-ad56-3c23a9e354d5' \
    --header 'content-type: application/json' \
```
