...
```json
  ...
  "data": [
    {
      "id": "e6d9c7f9-8985-4446-abb9-767e50b7c116",
      "type": "email_templates",
      "attributes": {
        "created_at": "2023-02-03T09:52:09+00:00",
        "updated_at": "2023-02-03T09:52:09+00:00",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/email_templates/070cc6cb-625a-4192-878d-ef73a325d443' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "070cc6cb-625a-4192-878d-ef73a325d443",
    "type": "email_templates",
    "attributes": {
      "created_at": "2023-02-03T09:52:09+00:00",
      "updated_at": "2023-02-03T09:52:09+00:00",
...
```json
  {
  "data": {
    "id": "9403abfc-5abe-41bb-aba7-aa159fca8fbb",
    "type": "email_templates",
    "attributes": {
      "created_at": "2023-02-03T09:52:10+00:00",
      "updated_at": "2023-02-03T09:52:10+00:00",
      "name": "Webshop confirmation",
      "identifier": "webshop_confirmation",
      "subject": "We received your order (#{{order.number}})",
      "context": "order",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/email_templates/ed17a810-9c84-4aed-b444-97b9c4fa7fae' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "ed17a810-9c84-4aed-b444-97b9c4fa7fae",
        "type": "email_templates",
        "attributes": {
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/email_templates/8e381d3f-bf98-444c-a7d3-3423b09318f0' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "8e381d3f-bf98-444c-a7d3-3423b09318f0",
        "type": "email_templates",
        "attributes": {
          "name": "Order confirmation"
        }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/email_templates/57d3ca1e-97d6-41ca-86ba-4805efe16b4e' \
    --header 'content-type: application/json' \
```
