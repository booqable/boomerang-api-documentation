...
```json
  ...
  "data": [
    {
      "id": "09048d20-f353-4f7b-97ac-525456834a2a",
      "type": "email_templates",
      "attributes": {
        "created_at": "2022-07-14T10:49:27+00:00",
        "updated_at": "2022-07-14T10:49:27+00:00",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/email_templates/afd27421-7a32-4aee-b8d1-670882218ea0' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "afd27421-7a32-4aee-b8d1-670882218ea0",
    "type": "email_templates",
    "attributes": {
      "created_at": "2022-07-14T10:49:27+00:00",
      "updated_at": "2022-07-14T10:49:27+00:00",
...
```json
  {
  "data": {
    "id": "39f34062-8d25-4faa-8c02-dd2d2934fa41",
    "type": "email_templates",
    "attributes": {
      "created_at": "2022-07-14T10:49:28+00:00",
      "updated_at": "2022-07-14T10:49:28+00:00",
      "name": "Webshop confirmation",
      "identifier": "webshop_confirmation",
      "subject": "We received your order (#{{order.number}})",
      "context": "order",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/email_templates/56a6590a-b86b-4eb3-998f-518ee21d8d56' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "56a6590a-b86b-4eb3-998f-518ee21d8d56",
        "type": "email_templates",
        "attributes": {
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/email_templates/a47d6d15-7a0e-4023-88d9-882a64cba038' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "a47d6d15-7a0e-4023-88d9-882a64cba038",
        "type": "email_templates",
        "attributes": {
          "name": "Order confirmation"
        }
...
```json
  ...
  "data": {
    ...
    "type": "email_templates",
    "attributes": {
      "created_at": "2022-07-14T10:49:29+00:00",
      "updated_at": "2022-07-14T10:49:29+00:00",
      "name": "Order confirmation",
      "identifier": "webshop_confirmation",
      "subject": "We received your order",
      "context": "all",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/email_templates/e4a01e9c-1c60-42d3-836f-fd41a18066dd' \
    --header 'content-type: application/json' \
```
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/email_templates/d1f33eef-e6ff-45f4-b456-0ad9fe63c48b' \
    --header 'content-type: application/json' \
```
