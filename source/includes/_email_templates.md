...
```json
  ...
  "data": [
    {
      "id": "0c46a7f9-ed09-4b26-bc83-2f7fb3413cc7",
      "type": "email_templates",
      "attributes": {
        "created_at": "2023-03-07T08:27:47+00:00",
        "updated_at": "2023-03-07T08:27:47+00:00",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/email_templates/980d5aa2-cb94-411f-a49b-922cae71cc4d' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "980d5aa2-cb94-411f-a49b-922cae71cc4d",
    "type": "email_templates",
    "attributes": {
      "created_at": "2023-03-07T08:27:49+00:00",
      "updated_at": "2023-03-07T08:27:49+00:00",
      "name": "Webshop confirmation",
      "identifier": "webshop_confirmation",
      "subject": "We received your order",
      "context": "all",
...
```json
  {
  "data": {
    "id": "8bb2c430-b894-4506-a87e-e5a0beaddcec",
    "type": "email_templates",
    "attributes": {
      "created_at": "2023-03-07T08:27:49+00:00",
      "updated_at": "2023-03-07T08:27:49+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/email_templates/36f8d82c-d895-41b2-b710-916aaddb3630' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "36f8d82c-d895-41b2-b710-916aaddb3630",
        "type": "email_templates",
        "attributes": {
...
```json
  ...
  "data": {
    ...
    "type": "email_templates",
    "attributes": {
      "created_at": "2023-03-07T08:27:50+00:00",
      "updated_at": "2023-03-07T08:27:50+00:00",
      "name": "Order confirmation",
      "identifier": "webshop_confirmation",
      "subject": "We received your order",
      "context": "all",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/email_templates/138cfcea-d714-4c51-8d1c-3f783c0a1394' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "138cfcea-d714-4c51-8d1c-3f783c0a1394",
        "type": "email_templates",
        "attributes": {
          "name": "Order confirmation"
        }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/email_templates/443bce45-6366-49d4-bf64-719caccb62dc' \
    --header 'content-type: application/json' \
```
