...
```json
  ...
  "data": [
    {
      "id": "16ebf036-b8b6-4f76-8499-b428056c3290",
      "type": "email_templates",
      "attributes": {
        "created_at": "2023-02-17T10:32:58+00:00",
        "updated_at": "2023-02-17T10:32:58+00:00",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/email_templates/dc7acb57-5c1e-4cbb-b509-15857dee6244' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "dc7acb57-5c1e-4cbb-b509-15857dee6244",
    "type": "email_templates",
    "attributes": {
      "created_at": "2023-02-17T10:32:58+00:00",
      "updated_at": "2023-02-17T10:32:58+00:00",
...
```json
  {
  "data": {
    "id": "76f753b9-b58e-4a6d-8d7a-e637bf84ef31",
    "type": "email_templates",
    "attributes": {
      "created_at": "2023-02-17T10:32:59+00:00",
      "updated_at": "2023-02-17T10:32:59+00:00",
      "name": "Webshop confirmation",
      "identifier": "webshop_confirmation",
      "subject": "We received your order (#{{order.number}})",
      "context": "order",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/email_templates/b76ac091-04d5-4c2c-bea1-b06630a4504b' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "b76ac091-04d5-4c2c-bea1-b06630a4504b",
        "type": "email_templates",
        "attributes": {
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/email_templates/7fb47197-972b-49ec-8f09-26833d2ef085' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "7fb47197-972b-49ec-8f09-26833d2ef085",
        "type": "email_templates",
        "attributes": {
          "name": "Order confirmation"
        }
...
```json
  ...
  "data": {
    ...
    "type": "email_templates",
    "attributes": {
      "created_at": "2023-02-17T10:33:00+00:00",
      "updated_at": "2023-02-17T10:33:00+00:00",
      "name": "Order confirmation",
      "identifier": "webshop_confirmation",
      "subject": "We received your order",
      "context": "all",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/email_templates/a51b7870-0712-45ed-9f5c-839c7ee121fa' \
    --header 'content-type: application/json' \
```
