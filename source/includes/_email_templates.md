...
```json
  ...
  "data": [
    {
      "id": "5dedfb45-4dd6-46c0-99db-404d2c8a7300",
      "type": "email_templates",
      "attributes": {
        "created_at": "2023-02-03T08:27:23+00:00",
        "updated_at": "2023-02-03T08:27:23+00:00",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/email_templates/d6d08821-daf8-47d3-ae64-ac8b2e0ccadf' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "d6d08821-daf8-47d3-ae64-ac8b2e0ccadf",
    "type": "email_templates",
    "attributes": {
      "created_at": "2023-02-03T08:27:23+00:00",
      "updated_at": "2023-02-03T08:27:23+00:00",
...
```json
  {
  "data": {
    "id": "f75cb6b3-5035-4eee-bccb-4fbc4ea4dc59",
    "type": "email_templates",
    "attributes": {
      "created_at": "2023-02-03T08:27:24+00:00",
      "updated_at": "2023-02-03T08:27:24+00:00",
      "name": "Webshop confirmation",
      "identifier": "webshop_confirmation",
      "subject": "We received your order (#{{order.number}})",
      "context": "order",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/email_templates/c4033318-e567-4b58-b4ba-984072691848' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "c4033318-e567-4b58-b4ba-984072691848",
        "type": "email_templates",
        "attributes": {
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/email_templates/b4e3e280-1406-47b7-8178-1ce9ab1f2f14' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "b4e3e280-1406-47b7-8178-1ce9ab1f2f14",
        "type": "email_templates",
        "attributes": {
          "name": "Order confirmation"
        }
...
```json
  ...
  "data": {
    ...
    "type": "email_templates",
    "attributes": {
      "created_at": "2023-02-03T08:27:25+00:00",
      "updated_at": "2023-02-03T08:27:25+00:00",
      "name": "Order confirmation",
      "identifier": "webshop_confirmation",
      "subject": "We received your order",
      "context": "all",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/email_templates/259fb50b-0caf-4ed8-a24f-b2770d0b1783' \
    --header 'content-type: application/json' \
```
