...
```json
  ...
  "data": [
    {
      "id": "a2a85e82-d25c-4c5b-a728-51f443ae0594",
      "type": "email_templates",
      "attributes": {
        "created_at": "2023-02-08T08:35:07+00:00",
        "updated_at": "2023-02-08T08:35:07+00:00",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/email_templates/810a4a02-4b69-48f4-b885-5f96d90b1d42' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "810a4a02-4b69-48f4-b885-5f96d90b1d42",
    "type": "email_templates",
    "attributes": {
      "created_at": "2023-02-08T08:35:07+00:00",
      "updated_at": "2023-02-08T08:35:07+00:00",
...
```json
  {
  "data": {
    "id": "70f6f263-d245-4a4e-b1a8-951158fc53bb",
    "type": "email_templates",
    "attributes": {
      "created_at": "2023-02-08T08:35:08+00:00",
      "updated_at": "2023-02-08T08:35:08+00:00",
      "name": "Webshop confirmation",
      "identifier": "webshop_confirmation",
      "subject": "We received your order (#{{order.number}})",
      "context": "order",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/email_templates/1a211ef8-ba1f-4bbb-853b-e7dc9d604a17' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "1a211ef8-ba1f-4bbb-853b-e7dc9d604a17",
        "type": "email_templates",
        "attributes": {
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/email_templates/efba8346-96e0-408c-9893-5287587b7aff' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "efba8346-96e0-408c-9893-5287587b7aff",
        "type": "email_templates",
        "attributes": {
          "name": "Order confirmation"
        }
...
```json
  ...
  "data": {
    ...
    "attributes": {
      "created_at": "2023-02-08T08:35:08+00:00",
      "updated_at": "2023-02-08T08:35:09+00:00",
      "name": "Order confirmation",
      "identifier": "webshop_confirmation",
      "subject": "We received your order",
      "context": "all",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/email_templates/d33f3005-b479-4755-a5a5-f87f4d595c28' \
    --header 'content-type: application/json' \
```
