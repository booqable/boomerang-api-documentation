...
```json
  ...
  "data": [
    {
      "id": "ec7897a0-ecb4-4429-a7c8-d95e6d382da2",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/email_templates/5be2a6e1-00eb-4045-9145-c6896e4b3ce8' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "5be2a6e1-00eb-4045-9145-c6896e4b3ce8",
    "type": "email_templates",
    "attributes": {
...
```json
  {
  "data": {
    "id": "660ed447-d35d-4daf-84c8-7b7aeaddab6a",
    "type": "email_templates",
    "attributes": {
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/email_templates/9c9eb256-09a0-412b-a4cc-928c18513482' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "9c9eb256-09a0-412b-a4cc-928c18513482",
        "type": "email_templates",
        "attributes": {
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/email_templates/60a29a64-6445-487c-be61-cb247e68ff98' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "60a29a64-6445-487c-be61-cb247e68ff98",
        "type": "email_templates",
        "attributes": {
          "name": "Order confirmation"
        }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/email_templates/c24dbd03-daea-4af2-8bbc-e38d9b4a31f5' \
    --header 'content-type: application/json' \
```
