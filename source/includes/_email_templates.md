...
```json
  ...
  "data": [
    {
      "id": "d711ce86-ce46-474d-b5df-40f254c01c81",
      "created_at": "2021-09-22T10:38:36+00:00",
      "updated_at": "2021-09-22T10:38:36+00:00",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/email_templates/a3f4fa0d-4b12-48a3-9449-ee5c1b4c0f46' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "a3f4fa0d-4b12-48a3-9449-ee5c1b4c0f46",
    "created_at": "2021-09-22T10:38:36+00:00",
    "updated_at": "2021-09-22T10:38:36+00:00",
    "name": "Webshop confirmation",
    "identifier": "webshop_confirmation",
...
```json
  {
  "data": {
    "id": "72d0cfbd-4180-46b4-bbea-a17e6bfbec5d",
    "type": "email_templates",
    "attributes": {
      "created_at": "2021-09-22T10:38:36+00:00",
      "updated_at": "2021-09-22T10:38:36+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/email_templates/7e34ca94-d2cd-45e2-9b77-e5abfb10ddfd' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "7e34ca94-d2cd-45e2-9b77-e5abfb10ddfd",
        "type": "email_templates",
        "attributes": {
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/email_templates/d03d9b8c-8d98-4f0c-8b7d-4fbfdf1e5741' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "d03d9b8c-8d98-4f0c-8b7d-4fbfdf1e5741",
        "type": "email_templates",
        "attributes": {
          "name": "Order confirmation"
        }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/email_templates/8a0710ef-4ff1-4291-9d34-ff777aa4978f' \
    --header 'content-type: application/json' \
    --data '{}'
```
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/email_templates/59676e4f-9f2f-463c-8a43-4608e2e92cf4' \
    --header 'content-type: application/json' \
    --data '{}'
```
