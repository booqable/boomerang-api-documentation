...
```json
  ...
  "data": [
    {
      "id": "0d405636-bc7c-4f35-97b4-a3a14c889928",
      "type": "email_templates",
      "attributes": {
        "created_at": "2022-11-22T14:33:17+00:00",
        "updated_at": "2022-11-22T14:33:17+00:00",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/email_templates/4ce30a8a-1b8d-45aa-b848-cbe64263ccf7' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "4ce30a8a-1b8d-45aa-b848-cbe64263ccf7",
    "type": "email_templates",
    "attributes": {
      "created_at": "2022-11-22T14:33:18+00:00",
      "updated_at": "2022-11-22T14:33:18+00:00",
      "name": "Webshop confirmation",
      "identifier": "webshop_confirmation",
      "subject": "We received your order",
      "context": "all",
...
```json
  {
  "data": {
    "id": "51fec6cd-daa6-4b5a-807c-ebd9e63783bb",
    "type": "email_templates",
    "attributes": {
      "created_at": "2022-11-22T14:33:18+00:00",
      "updated_at": "2022-11-22T14:33:18+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/email_templates/8cb9c29c-fa77-4a00-8514-c3bdc670825a' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "8cb9c29c-fa77-4a00-8514-c3bdc670825a",
        "type": "email_templates",
        "attributes": {
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/email_templates/1f2113f2-d806-4a35-90bf-136fb6c46d8d' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "1f2113f2-d806-4a35-90bf-136fb6c46d8d",
        "type": "email_templates",
        "attributes": {
          "name": "Order confirmation"
        }
...
```json
  ...
  "data": {
    ...
    "type": "email_templates",
    "attributes": {
      "created_at": "2022-11-22T14:33:19+00:00",
      "updated_at": "2022-11-22T14:33:19+00:00",
      "name": "Order confirmation",
      "identifier": "webshop_confirmation",
      "subject": "We received your order",
      "context": "all",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/email_templates/34c6b8ec-9daf-4bd1-92e2-92c8a196a888' \
    --header 'content-type: application/json' \
```
