...
```json
  ...
  "data": [
    {
      "id": "a922f24b-c4a8-474b-9530-346f217f0c67",
      "type": "email_templates",
      "attributes": {
        "created_at": "2023-02-07T14:32:59+00:00",
        "updated_at": "2023-02-07T14:32:59+00:00",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/email_templates/43ae8a69-3888-4733-90f6-e5d220e52402' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "43ae8a69-3888-4733-90f6-e5d220e52402",
    "type": "email_templates",
    "attributes": {
      "created_at": "2023-02-07T14:32:59+00:00",
      "updated_at": "2023-02-07T14:32:59+00:00",
...
```json
  {
  "data": {
    "id": "ff9b5de3-3b57-40e7-b091-5f008a78a457",
    "type": "email_templates",
    "attributes": {
      "created_at": "2023-02-07T14:32:59+00:00",
      "updated_at": "2023-02-07T14:32:59+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/email_templates/28c5cc81-04f8-4067-9a5d-4ab5c97a45a3' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "28c5cc81-04f8-4067-9a5d-4ab5c97a45a3",
        "type": "email_templates",
        "attributes": {
...
```json
  ...
  "data": {
    ...
    "type": "email_templates",
    "attributes": {
      "created_at": "2023-02-07T14:33:00+00:00",
      "updated_at": "2023-02-07T14:33:00+00:00",
      "name": "Order confirmation",
      "identifier": "webshop_confirmation",
      "subject": "We received your order",
      "context": "all",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/email_templates/d59ca2ef-8250-4ef3-8600-98404862d515' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "d59ca2ef-8250-4ef3-8600-98404862d515",
        "type": "email_templates",
        "attributes": {
          "name": "Order confirmation"
        }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/email_templates/be433220-b03f-4ddf-930d-be616c4f8174' \
    --header 'content-type: application/json' \
```
