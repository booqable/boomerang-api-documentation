...
```json
  ...
  "data": [
    {
      "id": "dd52f3c6-27de-4b14-9136-d69c17378331",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/email_templates/5c2aef2c-8487-4ecb-b784-e6b6ad3b9d45' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "5c2aef2c-8487-4ecb-b784-e6b6ad3b9d45",
    "type": "email_templates",
    "attributes": {
...
```json
  {
  "data": {
    "id": "f43dbaca-aa12-4edf-a7c3-f21154d17a73",
    "type": "email_templates",
    "attributes": {
      "created_at": "2023-03-09T08:57:50+00:00",
      "updated_at": "2023-03-09T08:57:50+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/email_templates/275faaaa-f073-460e-b6d6-8d0dda694532' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "275faaaa-f073-460e-b6d6-8d0dda694532",
        "type": "email_templates",
        "attributes": {
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/email_templates/56a3071f-32e0-4612-a64a-752603e9ae6e' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "56a3071f-32e0-4612-a64a-752603e9ae6e",
        "type": "email_templates",
        "attributes": {
          "name": "Order confirmation"
        }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/email_templates/76f4e312-f0fd-40ec-a341-76cc584d4330' \
    --header 'content-type: application/json' \
```
