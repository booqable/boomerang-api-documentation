...
```json
  ...
  "data": [
    {
      "id": "2d617bcb-3a4f-412f-97d9-8db8896ff563",
      "type": "email_templates",
      "attributes": {
        "created_at": "2023-02-08T16:18:03+00:00",
        "updated_at": "2023-02-08T16:18:03+00:00",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/email_templates/fd80b4c2-b165-4770-b20b-2f9ba6149206' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "fd80b4c2-b165-4770-b20b-2f9ba6149206",
    "type": "email_templates",
    "attributes": {
      "created_at": "2023-02-08T16:18:03+00:00",
      "updated_at": "2023-02-08T16:18:03+00:00",
...
```json
  {
  "data": {
    "id": "fc2d635e-78e0-4f20-b96f-8d46ed72cf65",
    "type": "email_templates",
    "attributes": {
      "created_at": "2023-02-08T16:18:03+00:00",
      "updated_at": "2023-02-08T16:18:03+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/email_templates/895aaf4d-5a04-43a3-b6ae-33bea4ac0916' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "895aaf4d-5a04-43a3-b6ae-33bea4ac0916",
        "type": "email_templates",
        "attributes": {
...
```json
  ...
  "data": {
    ...
    "type": "email_templates",
    "attributes": {
      "created_at": "2023-02-08T16:18:04+00:00",
      "updated_at": "2023-02-08T16:18:04+00:00",
      "name": "Order confirmation",
      "identifier": "webshop_confirmation",
      "subject": "We received your order",
      "context": "all",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/email_templates/d899c5a9-2325-4be4-a6f0-5da22a06736f' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "d899c5a9-2325-4be4-a6f0-5da22a06736f",
        "type": "email_templates",
        "attributes": {
          "name": "Order confirmation"
        }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/email_templates/ac991b10-85d1-4f15-ab94-efd648290e80' \
    --header 'content-type: application/json' \
```
