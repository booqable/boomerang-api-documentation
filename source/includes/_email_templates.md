...
```json
  ...
  "data": [
    {
      "id": "eabd523b-481e-4cc1-b2db-562a4b745504",
      "type": "email_templates",
      "attributes": {
        "created_at": "2023-02-28T07:30:04+00:00",
        "updated_at": "2023-02-28T07:30:04+00:00",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/email_templates/8fa99d06-d170-43aa-b146-89c98a34102c' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "8fa99d06-d170-43aa-b146-89c98a34102c",
    "type": "email_templates",
    "attributes": {
      "created_at": "2023-02-28T07:30:04+00:00",
      "updated_at": "2023-02-28T07:30:04+00:00",
...
```json
  {
  "data": {
    "id": "78c66093-60d8-471e-89f9-530123f01770",
    "type": "email_templates",
    "attributes": {
      "created_at": "2023-02-28T07:30:05+00:00",
      "updated_at": "2023-02-28T07:30:05+00:00",
      "name": "Webshop confirmation",
      "identifier": "webshop_confirmation",
      "subject": "We received your order (#{{order.number}})",
      "context": "order",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/email_templates/853aea4a-ad2b-4ca2-8c7f-0f0e306daabe' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "853aea4a-ad2b-4ca2-8c7f-0f0e306daabe",
        "type": "email_templates",
        "attributes": {
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/email_templates/8e530711-5b52-428e-b036-efc9b50146cf' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "8e530711-5b52-428e-b036-efc9b50146cf",
        "type": "email_templates",
        "attributes": {
          "name": "Order confirmation"
        }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/email_templates/fc620d35-7d4c-4d19-bdec-06d4497be6d2' \
    --header 'content-type: application/json' \
```
