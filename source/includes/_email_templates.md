...
```json
  ...
  "data": [
    {
      "id": "cd102725-8235-4b59-8789-6f00ba87cce8",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/email_templates/b3420a05-ef12-4598-9500-786d20bfff81' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "b3420a05-ef12-4598-9500-786d20bfff81",
    "type": "email_templates",
    "attributes": {
      "created_at": "2023-02-14T11:06:30+00:00",
      "updated_at": "2023-02-14T11:06:30+00:00",
...
```json
  {
  "data": {
    "id": "6d85c161-3f83-40c8-bd21-087f16ff3de0",
    "type": "email_templates",
    "attributes": {
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/email_templates/5202842b-fc6d-4d0b-b320-121884a87f32' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "5202842b-fc6d-4d0b-b320-121884a87f32",
        "type": "email_templates",
        "attributes": {
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/email_templates/6e7abfe2-6714-4bf3-9344-02326579d37b' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "6e7abfe2-6714-4bf3-9344-02326579d37b",
        "type": "email_templates",
        "attributes": {
          "name": "Order confirmation"
        }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/email_templates/b9ed748f-437e-416c-b79d-e1b1932e0dcc' \
    --header 'content-type: application/json' \
```
