...
```json
  ...
  "data": [
    {
      "id": "6b29d997-8a68-4461-a272-d88b08bbc3aa",
      "type": "email_templates",
      "attributes": {
        "created_at": "2023-02-21T12:16:29+00:00",
        "updated_at": "2023-02-21T12:16:29+00:00",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/email_templates/876edd50-a534-4e0d-a7ac-7d2ea8481236' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "876edd50-a534-4e0d-a7ac-7d2ea8481236",
    "type": "email_templates",
    "attributes": {
      "created_at": "2023-02-21T12:16:29+00:00",
      "updated_at": "2023-02-21T12:16:29+00:00",
...
```json
  {
  "data": {
    "id": "c3555287-7b12-43d4-a19b-f26f679d14da",
    "type": "email_templates",
    "attributes": {
      "created_at": "2023-02-21T12:16:30+00:00",
      "updated_at": "2023-02-21T12:16:30+00:00",
      "name": "Webshop confirmation",
      "identifier": "webshop_confirmation",
      "subject": "We received your order (#{{order.number}})",
      "context": "order",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/email_templates/0c962d54-899f-4690-a572-bd92c548ee58' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "0c962d54-899f-4690-a572-bd92c548ee58",
        "type": "email_templates",
        "attributes": {
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/email_templates/507d8a1f-c7c8-454a-a8d0-f3f8c37bb3b8' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "507d8a1f-c7c8-454a-a8d0-f3f8c37bb3b8",
        "type": "email_templates",
        "attributes": {
          "name": "Order confirmation"
        }
...
```json
  ...
  "data": {
    ...
    "type": "email_templates",
    "attributes": {
      "created_at": "2023-02-21T12:16:31+00:00",
      "updated_at": "2023-02-21T12:16:31+00:00",
      "name": "Order confirmation",
      "identifier": "webshop_confirmation",
      "subject": "We received your order",
      "context": "all",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/email_templates/d4da74e2-0dda-4f56-8581-962bb1f3aa63' \
    --header 'content-type: application/json' \
```
