...
```json
  ...
  "data": [
    {
      "id": "21e503da-a9ed-43f5-938d-712ba0935c3e",
      "type": "email_templates",
      "attributes": {
        "created_at": "2023-02-09T10:19:06+00:00",
        "updated_at": "2023-02-09T10:19:06+00:00",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/email_templates/0b62b61c-2237-43ea-9961-411b4d31c3c8' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "0b62b61c-2237-43ea-9961-411b4d31c3c8",
    "type": "email_templates",
    "attributes": {
      "created_at": "2023-02-09T10:19:06+00:00",
      "updated_at": "2023-02-09T10:19:06+00:00",
...
```json
  {
  "data": {
    "id": "d6259add-afcb-4eaa-922a-ad8f0cfd6e89",
    "type": "email_templates",
    "attributes": {
      "created_at": "2023-02-09T10:19:06+00:00",
      "updated_at": "2023-02-09T10:19:06+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/email_templates/20b37d8d-eafe-4048-86ac-f89a71c7a5a3' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "20b37d8d-eafe-4048-86ac-f89a71c7a5a3",
        "type": "email_templates",
        "attributes": {
...
```json
  ...
  "data": {
    ...
    "type": "email_templates",
    "attributes": {
      "created_at": "2023-02-09T10:19:07+00:00",
      "updated_at": "2023-02-09T10:19:07+00:00",
      "name": "Order confirmation",
      "identifier": "webshop_confirmation",
      "subject": "We received your order",
      "context": "all",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/email_templates/61e10264-69e1-4249-9838-c62aafde80e5' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "61e10264-69e1-4249-9838-c62aafde80e5",
        "type": "email_templates",
        "attributes": {
          "name": "Order confirmation"
        }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/email_templates/05067d76-38ac-4cad-ba80-feabdbcd96b5' \
    --header 'content-type: application/json' \
```
