...
```json
  ...
  "data": [
    {
      "id": "cd45853c-4026-43ca-a70b-7ca4f942e219",
      "type": "email_templates",
      "attributes": {
        "created_at": "2023-01-18T13:35:27+00:00",
        "updated_at": "2023-01-18T13:35:27+00:00",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/email_templates/c2d7dd20-79f8-4a36-89e1-f7f10b363151' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "c2d7dd20-79f8-4a36-89e1-f7f10b363151",
    "type": "email_templates",
    "attributes": {
      "created_at": "2023-01-18T13:35:27+00:00",
      "updated_at": "2023-01-18T13:35:27+00:00",
...
```json
  {
  "data": {
    "id": "8c0d2b29-9236-42e9-acb6-ff1eab2b0239",
    "type": "email_templates",
    "attributes": {
      "created_at": "2023-01-18T13:35:28+00:00",
      "updated_at": "2023-01-18T13:35:28+00:00",
      "name": "Webshop confirmation",
      "identifier": "webshop_confirmation",
      "subject": "We received your order (#{{order.number}})",
      "context": "order",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/email_templates/1fb081e6-b4d3-4ea7-97f1-930afc1ea422' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "1fb081e6-b4d3-4ea7-97f1-930afc1ea422",
        "type": "email_templates",
        "attributes": {
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/email_templates/44c009a2-a07d-45dc-9395-cec3668d7287' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "44c009a2-a07d-45dc-9395-cec3668d7287",
        "type": "email_templates",
        "attributes": {
          "name": "Order confirmation"
        }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/email_templates/044e9ed0-ddf4-41f4-8c35-2074a045430b' \
    --header 'content-type: application/json' \
```
