...
```json
  ...
  "data": [
    {
      "id": "48f59771-f80d-4475-8991-459d72e42f35",
      "type": "email_templates",
      "attributes": {
        "created_at": "2023-02-08T08:35:47+00:00",
        "updated_at": "2023-02-08T08:35:47+00:00",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/email_templates/41897899-f0e0-4be9-867d-eace825391c2' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "41897899-f0e0-4be9-867d-eace825391c2",
    "type": "email_templates",
    "attributes": {
      "created_at": "2023-02-08T08:35:48+00:00",
      "updated_at": "2023-02-08T08:35:48+00:00",
      "name": "Webshop confirmation",
      "identifier": "webshop_confirmation",
      "subject": "We received your order",
      "context": "all",
...
```json
  {
  "data": {
    "id": "fee21423-17c5-49a8-a910-bdcaef40c90e",
    "type": "email_templates",
    "attributes": {
      "created_at": "2023-02-08T08:35:49+00:00",
      "updated_at": "2023-02-08T08:35:49+00:00",
      "name": "Webshop confirmation",
      "identifier": "webshop_confirmation",
      "subject": "We received your order (#{{order.number}})",
      "context": "order",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/email_templates/a139e6b7-9ee4-4c6e-91f7-42c5e293c5f8' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "a139e6b7-9ee4-4c6e-91f7-42c5e293c5f8",
        "type": "email_templates",
        "attributes": {
...
```json
  ...
  "data": {
    ...
    "type": "email_templates",
    "attributes": {
      "created_at": "2023-02-08T08:35:50+00:00",
      "updated_at": "2023-02-08T08:35:50+00:00",
      "name": "Order confirmation",
      "identifier": "webshop_confirmation",
      "subject": "We received your order",
      "context": "all",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/email_templates/8a4e8bb8-406c-484c-93fd-18c8fdded034' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "8a4e8bb8-406c-484c-93fd-18c8fdded034",
        "type": "email_templates",
        "attributes": {
          "name": "Order confirmation"
        }
...
```json
  ...
  "data": {
    ...
    "attributes": {
      "created_at": "2023-02-08T08:35:50+00:00",
      "updated_at": "2023-02-08T08:35:51+00:00",
      "name": "Order confirmation",
      "identifier": "webshop_confirmation",
      "subject": "We received your order",
      "context": "all",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/email_templates/ce2762e8-ffd9-4622-bcc4-7740861dae5b' \
    --header 'content-type: application/json' \
```
