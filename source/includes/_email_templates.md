...
```json
  ...
  "data": [
    {
      "id": "70062c1d-1625-44ad-97bd-bd30f426f85d",
      "type": "email_templates",
      "attributes": {
        "created_at": "2023-02-02T14:15:00+00:00",
        "updated_at": "2023-02-02T14:15:00+00:00",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/email_templates/bd160c91-5e5e-4eb6-96e3-8d3adedbc1d6' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "bd160c91-5e5e-4eb6-96e3-8d3adedbc1d6",
    "type": "email_templates",
    "attributes": {
      "created_at": "2023-02-02T14:15:00+00:00",
      "updated_at": "2023-02-02T14:15:00+00:00",
...
```json
  {
  "data": {
    "id": "2e93894d-2dac-4cbc-989e-39f248bfee71",
    "type": "email_templates",
    "attributes": {
      "created_at": "2023-02-02T14:15:00+00:00",
      "updated_at": "2023-02-02T14:15:00+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/email_templates/d5645489-8a6d-4129-9624-353c510f3d14' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "d5645489-8a6d-4129-9624-353c510f3d14",
        "type": "email_templates",
        "attributes": {
...
```json
  ...
  "data": {
    ...
    "type": "email_templates",
    "attributes": {
      "created_at": "2023-02-02T14:15:01+00:00",
      "updated_at": "2023-02-02T14:15:01+00:00",
      "name": "Order confirmation",
      "identifier": "webshop_confirmation",
      "subject": "We received your order",
      "context": "all",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/email_templates/d1a9220a-b86c-45de-aa6b-91b6c5b18547' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "d1a9220a-b86c-45de-aa6b-91b6c5b18547",
        "type": "email_templates",
        "attributes": {
          "name": "Order confirmation"
        }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/email_templates/0d9d3b4e-4ea6-4eb8-8f0b-d790fe68922d' \
    --header 'content-type: application/json' \
```
