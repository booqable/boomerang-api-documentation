...
```json
  ...
  "data": [
    {
      "id": "87108e32-6a90-4824-9795-c80ad6d4bb65",
      "type": "email_templates",
      "attributes": {
        "created_at": "2023-02-13T12:13:14+00:00",
        "updated_at": "2023-02-13T12:13:14+00:00",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/email_templates/1819a815-ed07-48c4-b091-bafe5627c18d' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "1819a815-ed07-48c4-b091-bafe5627c18d",
    "type": "email_templates",
    "attributes": {
      "created_at": "2023-02-13T12:13:14+00:00",
      "updated_at": "2023-02-13T12:13:14+00:00",
...
```json
  {
  "data": {
    "id": "f31c731a-6a68-4d52-be85-d17517c5dc50",
    "type": "email_templates",
    "attributes": {
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/email_templates/e0a244a2-3bd3-482d-87ab-49c431d29e72' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "e0a244a2-3bd3-482d-87ab-49c431d29e72",
        "type": "email_templates",
        "attributes": {
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/email_templates/0dd02f78-2c7f-4127-bc41-f650668844bf' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "0dd02f78-2c7f-4127-bc41-f650668844bf",
        "type": "email_templates",
        "attributes": {
          "name": "Order confirmation"
        }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/email_templates/33ebd406-b059-4493-9b7f-1a9acf00dc46' \
    --header 'content-type: application/json' \
```
