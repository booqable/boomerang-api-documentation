...
```json
  ...
  "data": [
    {
      "id": "3b5bca05-67bf-4547-8da1-2c1a84a38bca",
      "type": "email_templates",
      "attributes": {
        "created_at": "2023-01-19T10:46:03+00:00",
        "updated_at": "2023-01-19T10:46:03+00:00",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/email_templates/7f4f510b-dfd9-4b8d-926d-4e6dcbb4d56a' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "7f4f510b-dfd9-4b8d-926d-4e6dcbb4d56a",
    "type": "email_templates",
    "attributes": {
      "created_at": "2023-01-19T10:46:03+00:00",
      "updated_at": "2023-01-19T10:46:03+00:00",
...
```json
  {
  "data": {
    "id": "d790c021-be7e-49c6-81f0-64e19420f90c",
    "type": "email_templates",
    "attributes": {
      "created_at": "2023-01-19T10:46:03+00:00",
      "updated_at": "2023-01-19T10:46:03+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/email_templates/b7e6fc92-0678-43c7-8fd5-3799eb800bec' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "b7e6fc92-0678-43c7-8fd5-3799eb800bec",
        "type": "email_templates",
        "attributes": {
...
```json
  ...
  "data": {
    ...
    "type": "email_templates",
    "attributes": {
      "created_at": "2023-01-19T10:46:04+00:00",
      "updated_at": "2023-01-19T10:46:04+00:00",
      "name": "Order confirmation",
      "identifier": "webshop_confirmation",
      "subject": "We received your order",
      "context": "all",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/email_templates/4c1a546f-39ba-4196-acf3-f2b90166e156' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "4c1a546f-39ba-4196-acf3-f2b90166e156",
        "type": "email_templates",
        "attributes": {
          "name": "Order confirmation"
        }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/email_templates/e522810c-a210-4bc0-bec1-80d0824c929f' \
    --header 'content-type: application/json' \
```
