...
```json
  ...
  "data": [
    {
      "id": "4b52333d-1210-4e64-a3e2-4942adb12aa3",
      "type": "email_templates",
      "attributes": {
        "created_at": "2023-03-09T10:27:25+00:00",
        "updated_at": "2023-03-09T10:27:25+00:00",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/email_templates/59b3f35b-6dba-4452-921b-b0b6c2c5390c' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "59b3f35b-6dba-4452-921b-b0b6c2c5390c",
    "type": "email_templates",
    "attributes": {
      "created_at": "2023-03-09T10:27:25+00:00",
      "updated_at": "2023-03-09T10:27:25+00:00",
...
```json
  {
  "data": {
    "id": "2e67453c-8a9d-4a83-9c5b-0218185c6379",
    "type": "email_templates",
    "attributes": {
      "created_at": "2023-03-09T10:27:26+00:00",
      "updated_at": "2023-03-09T10:27:26+00:00",
      "name": "Webshop confirmation",
      "identifier": "webshop_confirmation",
      "subject": "We received your order (#{{order.number}})",
      "context": "order",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/email_templates/0dc8ceee-aa4a-4984-9174-a6742ca2cbee' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "0dc8ceee-aa4a-4984-9174-a6742ca2cbee",
        "type": "email_templates",
        "attributes": {
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/email_templates/6dec2f9a-716a-4b92-a84d-ad4726979037' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "6dec2f9a-716a-4b92-a84d-ad4726979037",
        "type": "email_templates",
        "attributes": {
          "name": "Order confirmation"
        }
...
```json
  ...
  "data": {
    ...
    "type": "email_templates",
    "attributes": {
      "created_at": "2023-03-09T10:27:27+00:00",
      "updated_at": "2023-03-09T10:27:27+00:00",
      "name": "Order confirmation",
      "identifier": "webshop_confirmation",
      "subject": "We received your order",
      "context": "all",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/email_templates/f703611f-871c-49ca-a0c3-32ed9575971d' \
    --header 'content-type: application/json' \
```
