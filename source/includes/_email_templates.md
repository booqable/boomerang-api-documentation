...
```json
  ...
  "data": [
    {
      "id": "26388e85-a4e9-4cf7-bba1-0462008a11f6",
      "type": "email_templates",
      "attributes": {
        "created_at": "2022-07-14T12:00:52+00:00",
        "updated_at": "2022-07-14T12:00:52+00:00",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/email_templates/320c06a5-e2d3-4bda-a2b7-0c6a35314a00' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "320c06a5-e2d3-4bda-a2b7-0c6a35314a00",
    "type": "email_templates",
    "attributes": {
      "created_at": "2022-07-14T12:00:52+00:00",
      "updated_at": "2022-07-14T12:00:52+00:00",
...
```json
  {
  "data": {
    "id": "182918cc-0a66-414e-8955-e7c7b697e6f2",
    "type": "email_templates",
    "attributes": {
      "created_at": "2022-07-14T12:00:53+00:00",
      "updated_at": "2022-07-14T12:00:53+00:00",
      "name": "Webshop confirmation",
      "identifier": "webshop_confirmation",
      "subject": "We received your order (#{{order.number}})",
      "context": "order",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/email_templates/a179dbfd-be8e-4c29-8a7b-3559355c4e50' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "a179dbfd-be8e-4c29-8a7b-3559355c4e50",
        "type": "email_templates",
        "attributes": {
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/email_templates/823cace2-be59-48d9-a818-179b2c76c5ac' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "823cace2-be59-48d9-a818-179b2c76c5ac",
        "type": "email_templates",
        "attributes": {
          "name": "Order confirmation"
        }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/email_templates/57f10eb5-79f5-4f5c-8e7b-d4783332286f' \
    --header 'content-type: application/json' \
```
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/email_templates/5386ae76-2056-4daf-a3d5-d9d25f9ad586' \
    --header 'content-type: application/json' \
```
