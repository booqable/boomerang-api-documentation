...
```json
  ...
  "data": [
    {
      "id": "bb349898-49ae-40d8-9fd5-e79a6d93a6b2",
      "type": "email_templates",
      "attributes": {
        "created_at": "2023-02-28T11:26:35+00:00",
        "updated_at": "2023-02-28T11:26:35+00:00",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/email_templates/edeacbaf-6e32-4a78-910b-e1b1baa7c2d5' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "edeacbaf-6e32-4a78-910b-e1b1baa7c2d5",
    "type": "email_templates",
    "attributes": {
      "created_at": "2023-02-28T11:26:35+00:00",
      "updated_at": "2023-02-28T11:26:35+00:00",
...
```json
  {
  "data": {
    "id": "5e835704-e3d2-48c0-956c-41c41ce30b87",
    "type": "email_templates",
    "attributes": {
      "created_at": "2023-02-28T11:26:36+00:00",
      "updated_at": "2023-02-28T11:26:36+00:00",
      "name": "Webshop confirmation",
      "identifier": "webshop_confirmation",
      "subject": "We received your order (#{{order.number}})",
      "context": "order",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/email_templates/6f369421-72f1-4e14-8818-dc952fa62bd8' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "6f369421-72f1-4e14-8818-dc952fa62bd8",
        "type": "email_templates",
        "attributes": {
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/email_templates/c2fbbf7b-8614-443c-b297-6bb0987e0843' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "c2fbbf7b-8614-443c-b297-6bb0987e0843",
        "type": "email_templates",
        "attributes": {
          "name": "Order confirmation"
        }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/email_templates/61abb092-15a2-4723-87bd-2954c8f54334' \
    --header 'content-type: application/json' \
```
