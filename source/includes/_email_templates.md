...
```json
  ...
  "data": [
    {
      "id": "f7d10472-15e7-42b7-88b3-3c6bb668fc1a",
      "type": "email_templates",
      "attributes": {
        "created_at": "2023-02-22T08:40:39+00:00",
        "updated_at": "2023-02-22T08:40:39+00:00",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/email_templates/c9a50b5a-ab1f-4719-9f7b-ecda96bd93f4' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "c9a50b5a-ab1f-4719-9f7b-ecda96bd93f4",
    "type": "email_templates",
    "attributes": {
      "created_at": "2023-02-22T08:40:39+00:00",
      "updated_at": "2023-02-22T08:40:39+00:00",
...
```json
  {
  "data": {
    "id": "9a4e9f33-d433-46a2-9016-8f3d2fc78441",
    "type": "email_templates",
    "attributes": {
      "created_at": "2023-02-22T08:40:40+00:00",
      "updated_at": "2023-02-22T08:40:40+00:00",
      "name": "Webshop confirmation",
      "identifier": "webshop_confirmation",
      "subject": "We received your order (#{{order.number}})",
      "context": "order",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/email_templates/ddbe6ea9-be66-4506-b7b1-78ae18ed8301' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "ddbe6ea9-be66-4506-b7b1-78ae18ed8301",
        "type": "email_templates",
        "attributes": {
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/email_templates/7e0b2060-7fce-4a55-9765-12fbdbd9322a' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "7e0b2060-7fce-4a55-9765-12fbdbd9322a",
        "type": "email_templates",
        "attributes": {
          "name": "Order confirmation"
        }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/email_templates/309cde55-c73f-4902-9efe-93d620ada5d2' \
    --header 'content-type: application/json' \
```
