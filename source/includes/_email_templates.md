...
```json
  ...
  "data": [
    {
      "id": "1e1d4ead-3320-4cf3-89ef-58f005e67fa4",
      "type": "email_templates",
      "attributes": {
        "created_at": "2022-06-15T09:34:54+00:00",
        "updated_at": "2022-06-15T09:34:54+00:00",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/email_templates/cf20fe31-acb1-4349-8892-6bdf727ef9a6' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "cf20fe31-acb1-4349-8892-6bdf727ef9a6",
    "type": "email_templates",
    "attributes": {
      "created_at": "2022-06-15T09:34:55+00:00",
      "updated_at": "2022-06-15T09:34:55+00:00",
      "name": "Webshop confirmation",
      "identifier": "webshop_confirmation",
      "subject": "We received your order",
      "context": "all",
...
```json
  {
  "data": {
    "id": "777468dc-eb28-496d-aaa5-322a371cec48",
    "type": "email_templates",
    "attributes": {
      "created_at": "2022-06-15T09:34:55+00:00",
      "updated_at": "2022-06-15T09:34:55+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/email_templates/cbcc843b-0971-430d-b2dc-a2ec02e89c00' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "cbcc843b-0971-430d-b2dc-a2ec02e89c00",
        "type": "email_templates",
        "attributes": {
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/email_templates/9b536d9b-254a-458d-a3c4-f4dc606fd1dc' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "9b536d9b-254a-458d-a3c4-f4dc606fd1dc",
        "type": "email_templates",
        "attributes": {
          "name": "Order confirmation"
        }
...
```json
  ...
  "data": {
    ...
    "type": "email_templates",
    "attributes": {
      "created_at": "2022-06-15T09:34:56+00:00",
      "updated_at": "2022-06-15T09:34:56+00:00",
      "name": "Order confirmation",
      "identifier": "webshop_confirmation",
      "subject": "We received your order",
      "context": "all",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/email_templates/6b425e51-1d8f-4c21-a3d8-0aceab932d33' \
    --header 'content-type: application/json' \
```
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/email_templates/3e1fbb94-d5fa-4fa6-8c0a-dbf79c8b0e11' \
    --header 'content-type: application/json' \
```
