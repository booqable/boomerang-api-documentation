...
```json
  ...
  "data": [
    {
      "id": "0ed4d79e-6488-45f7-9e97-f7b3f4c68350",
      "type": "email_templates",
      "attributes": {
        "created_at": "2023-02-06T08:48:05+00:00",
        "updated_at": "2023-02-06T08:48:05+00:00",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/email_templates/8214ff7d-2f4d-472a-a46c-0549d8867dd1' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "8214ff7d-2f4d-472a-a46c-0549d8867dd1",
    "type": "email_templates",
    "attributes": {
      "created_at": "2023-02-06T08:48:05+00:00",
      "updated_at": "2023-02-06T08:48:05+00:00",
...
```json
  {
  "data": {
    "id": "8a3a7957-db33-4af9-9e53-25d8e6768b18",
    "type": "email_templates",
    "attributes": {
      "created_at": "2023-02-06T08:48:06+00:00",
      "updated_at": "2023-02-06T08:48:06+00:00",
      "name": "Webshop confirmation",
      "identifier": "webshop_confirmation",
      "subject": "We received your order (#{{order.number}})",
      "context": "order",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/email_templates/28600289-23ff-4b25-8b0a-ff573f684d94' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "28600289-23ff-4b25-8b0a-ff573f684d94",
        "type": "email_templates",
        "attributes": {
...
```json
  ...
  "data": {
    ...
    "type": "email_templates",
    "attributes": {
      "created_at": "2023-02-06T08:48:08+00:00",
      "updated_at": "2023-02-06T08:48:08+00:00",
      "name": "Order confirmation",
      "identifier": "webshop_confirmation",
      "subject": "We received your order",
      "context": "all",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/email_templates/e27319f4-27e6-4c08-8c6a-3b5289f5a65b' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "e27319f4-27e6-4c08-8c6a-3b5289f5a65b",
        "type": "email_templates",
        "attributes": {
          "name": "Order confirmation"
        }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/email_templates/92233a22-acaa-4b66-9282-a00f11852b96' \
    --header 'content-type: application/json' \
```
