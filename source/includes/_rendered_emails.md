  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "order_id": "fc068804-dec3-4aa7-b2be-ecbcb207d04a",
          "email_template_id": "8d4b494c-28a8-4ebb-a134-1ade9129e5bc"
        }
      }
    }'
```
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        "type": "rendered_emails",
        "attributes": {
          "order_id": "6ba8e2b6-e175-422d-ab33-2e20f5d4324d",
          "email_template_id": "cd43d756-53b1-465f-847b-11a85704499b",
          "body": "<p>Thank you for ordering with us!</p>\n"
        }
      }
    }'
