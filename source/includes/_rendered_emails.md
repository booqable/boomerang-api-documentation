  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "order_id": "3a69d1bb-9287-41a8-ba2e-8042a4b7e688",
          "email_template_id": "1d9d5d87-1107-4a25-867b-2734a3f9d059"
        }
      }
    }'
```
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        "type": "rendered_emails",
        "attributes": {
          "order_id": "c361616d-b5aa-4448-b956-cadb3ff8c447",
          "email_template_id": "cd6caf8a-4353-45c2-a490-07441dc6e310",
          "body": "<p>Thank you for ordering with us!</p>\n"
        }
      }
    }'
