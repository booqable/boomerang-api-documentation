  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "order_id": "3386d5bd-7b55-416a-b9b2-5adb3778837c",
          "email_template_id": "128c83f6-e9c0-47bd-82a9-d288f32b55dd"
        }
      }
    }'
```
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        "type": "rendered_emails",
        "attributes": {
          "order_id": "28b40868-2568-4968-8cc2-5cfc00e2175f",
          "email_template_id": "e8ed8c23-e4b1-4ffe-a2c5-790a30bf6cf9",
          "body": "<p>Thank you for ordering with us!</p>\n"
        }
      }
    }'
