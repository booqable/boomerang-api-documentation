  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "order_id": "df98007e-a5dd-4dfe-8cb0-cb8272fc3aee",
          "email_template_id": "98ae8efb-02db-4ba2-ac95-c7e9bf633157"
        }
      }
    }'
```
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        "type": "rendered_emails",
        "attributes": {
          "order_id": "1ce8b9c7-c7fa-406a-99c5-34732268edb4",
          "email_template_id": "9f6023c6-d4bd-4bfb-9665-712c6527f4a6",
          "body": "<p>Thank you for ordering with us!</p>\n"
        }
      }
    }'
