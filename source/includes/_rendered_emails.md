  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "order_id": "c946041b-2b1a-4115-8128-589748e35e13",
          "email_template_id": "00adb7d4-7287-497f-b30d-b159e7c97107"
        }
      }
    }'
```
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        "type": "rendered_emails",
        "attributes": {
          "order_id": "e7f6115b-a88f-4861-84e6-7f3844d9f7a8",
          "email_template_id": "2bc579d5-837b-4704-be6c-9b5416f028cb",
          "body": "<p>Thank you for ordering with us!</p>\n"
        }
      }
    }'
