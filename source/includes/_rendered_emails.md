  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "order_id": "ddff5f09-f175-4287-adb6-caa6547ca50a",
          "email_template_id": "c49546c7-ab76-44a3-922d-f1c8f2b9954f"
        }
      }
    }'
```
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        "type": "rendered_emails",
        "attributes": {
          "order_id": "0f96b601-2f46-4cfd-a08f-8ecb296b880a",
          "email_template_id": "6722ec06-35d8-41ef-9476-1346fd414239",
          "body": "<p>Thank you for ordering with us!</p>\n"
        }
      }
    }'
