  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "order_id": "7110d2c1-b376-4b7c-b94e-f43f1c849372",
          "email_template_id": "d653ff2e-5867-4dce-8966-8f7d0d0b6b26"
        }
      }
    }'
```
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        "type": "rendered_emails",
        "attributes": {
          "order_id": "61dd6689-62a5-4b54-aac3-700ebe8a79fb",
          "email_template_id": "96520d99-5d3b-4381-be26-0308ff23bf8c",
          "body": "<p>Thank you for ordering with us!</p>\n"
        }
      }
    }'
