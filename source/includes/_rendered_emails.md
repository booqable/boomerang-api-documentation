  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "order_id": "f37396da-2be5-4780-8d6b-902f4d84cd11",
          "email_template_id": "f4b6956b-abf2-4e86-9802-0fd0daadfaf9"
        }
      }
    }'
```
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        "type": "rendered_emails",
        "attributes": {
          "order_id": "dc4f5a83-6798-4d2b-b243-25ae0d2b429e",
          "email_template_id": "a7d57912-ec09-470f-b40f-5799e41d7b9a",
          "body": "<p>Thank you for ordering with us!</p>\n"
        }
      }
    }'
