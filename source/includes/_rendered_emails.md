  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "order_id": "0d7fd9db-5523-4ba4-86ab-3ec099cc77fe",
          "email_template_id": "c344d654-8603-401c-8b45-0e73d3bf2a8e"
        }
      }
    }'
```
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        "type": "rendered_emails",
        "attributes": {
          "order_id": "0ce2f2db-b209-478b-bdb4-72f751e93a16",
          "email_template_id": "74312580-eff8-460e-b976-5bb90f596464",
          "body": "<p>Thank you for ordering with us!</p>\n"
        }
      }
    }'
