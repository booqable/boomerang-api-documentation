  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "order_id": "bd01a36b-6f27-485d-afc5-fd25889d8ed8",
          "email_template_id": "21cdb760-c000-4fe1-8884-8aceb620f9aa"
        }
      }
    }'
```
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        "type": "rendered_emails",
        "attributes": {
          "order_id": "392c3a40-a499-4d92-a318-04d55be342e5",
          "email_template_id": "d54c37cb-e5db-4b0c-93e8-34c92b5270cf",
          "body": "<p>Thank you for ordering with us!</p>\n"
        }
      }
    }'
