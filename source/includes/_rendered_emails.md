  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "order_id": "40bec86c-1a2c-44e3-ac46-082a5335bf45",
          "email_template_id": "fb7ed126-a0a1-4c64-b0e7-701d9cb0ba80"
        }
      }
    }'
```
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        "type": "rendered_emails",
        "attributes": {
          "order_id": "41aed8bc-48a8-4c4b-8eec-1d3ca9bfe3f1",
          "email_template_id": "a016b9d4-fcaf-405c-97f2-ac2f284bc7cb",
          "body": "<p>Thank you for ordering with us!</p>\n"
        }
      }
    }'
