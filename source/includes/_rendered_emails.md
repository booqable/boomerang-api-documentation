  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "order_id": "abc9713e-91bf-485a-b805-f28bffef49de",
          "email_template_id": "108481b6-4d6e-4dcc-845e-965a90cd7be2"
        }
      }
    }'
```
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        "type": "rendered_emails",
        "attributes": {
          "order_id": "a7827947-6807-43a0-8eef-475274a34093",
          "email_template_id": "d13dc77f-9d16-4c4b-83ed-003bd2ac3155",
          "body": "<p>Thank you for ordering with us!</p>\n"
        }
      }
    }'
