  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "order_id": "2ee3b334-c33d-4602-bc9b-f8d0b4a97fec",
          "email_template_id": "6298b7dc-842a-479b-a707-081ee39a0af2"
        }
      }
    }'
```
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        "type": "rendered_emails",
        "attributes": {
          "order_id": "ff396f79-2d53-4ac0-9a73-2b30485c34e0",
          "email_template_id": "6b5e12d7-21be-4b3b-b052-33d0e0f95627",
          "body": "<p>Thank you for ordering with us!</p>\n"
        }
      }
    }'
