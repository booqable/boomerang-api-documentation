  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "order_id": "a3ee0f9e-9c02-4fc6-b7fb-614c51eb04ae",
          "email_template_id": "575fb8ca-dacf-4d75-8992-af11346f138e"
        }
      }
    }'
```
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        "type": "rendered_emails",
        "attributes": {
          "order_id": "8795a83c-996a-41cd-bd32-ceb73e4ce81d",
          "email_template_id": "d94e0e13-1249-4f94-9e38-9670ff5ae99c",
          "body": "<p>Thank you for ordering with us!</p>\n"
        }
      }
    }'
