  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "order_id": "266e6145-f2fc-4fad-982e-49dd19b8dcfa",
          "email_template_id": "0e23001e-d4e1-4624-812c-fae7caef8cb2"
        }
      }
    }'
```
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        "type": "rendered_emails",
        "attributes": {
          "order_id": "57d48eef-415b-4d49-8c2d-1e24ffea7f61",
          "email_template_id": "80acc7a8-902a-48e6-8b56-941b5cd4e41c",
          "body": "<p>Thank you for ordering with us!</p>\n"
        }
      }
    }'
