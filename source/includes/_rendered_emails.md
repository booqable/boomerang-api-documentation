  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "order_id": "3bdf5d5c-b29f-4991-aca6-c6e2fc504f1f",
          "email_template_id": "2ea275f9-0c9b-4b95-882c-2d784dd9ef85"
        }
      }
    }'
```
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        "type": "rendered_emails",
        "attributes": {
          "order_id": "dbf9e063-384e-4093-a30d-625c6ea36502",
          "email_template_id": "73d1ea92-6281-4ab8-80d8-d17abcebe55e",
          "body": "<p>Thank you for ordering with us!</p>\n"
        }
      }
    }'
