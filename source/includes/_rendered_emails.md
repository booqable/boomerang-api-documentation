  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "order_id": "0b796825-b18d-43a8-8426-1eb43438730d",
          "email_template_id": "ac732f80-f3be-467d-ac3b-563839320f61"
        }
      }
    }'
```
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        "type": "rendered_emails",
        "attributes": {
          "order_id": "b8f16705-d17e-48f1-b017-c4d54aea7474",
          "email_template_id": "27972e27-9c0b-4e06-99ad-7d4f4f7aab9b",
          "body": "<p>Thank you for ordering with us!</p>\n"
        }
      }
    }'
