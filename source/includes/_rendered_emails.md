  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "order_id": "4d75eba3-dc8f-44ca-b20d-fa64b009b843",
          "email_template_id": "4ece8ef9-b537-4397-a600-3c1be97cafa7"
        }
      }
    }'
```
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        "type": "rendered_emails",
        "attributes": {
          "order_id": "ebf2bc32-f65c-4a2a-b3f1-e641c843c73e",
          "email_template_id": "b55439a6-2c1e-43c8-bf9c-e58764b8a558",
          "body": "<p>Thank you for ordering with us!</p>\n"
        }
      }
    }'
