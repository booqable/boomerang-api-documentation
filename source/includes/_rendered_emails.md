  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "order_id": "2be55842-531c-4ef0-92fa-696c8a63fcb1",
          "email_template_id": "cf193150-bc2c-49f5-9c92-b3c55423df52"
        }
      }
    }'
```
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        "type": "rendered_emails",
        "attributes": {
          "order_id": "c227ac1b-ea3b-46e5-b274-f2a8194346a8",
          "email_template_id": "818ff80b-4bcc-480d-ac93-e34eae72ad07",
          "body": "<p>Thank you for ordering with us!</p>\n"
        }
      }
    }'
