  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "order_id": "acff8e4c-1ae1-40e4-92b9-9a080ee8f4db",
          "email_template_id": "e35580dc-1d09-4f64-8008-dfae2fbd8295"
        }
      }
    }'
```
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        "type": "rendered_emails",
        "attributes": {
          "order_id": "1622a9f0-fa41-428f-bafe-6844d1618431",
          "email_template_id": "95a50158-3ee1-455a-96e4-7b476dfd5f32",
          "body": "<p>Thank you for ordering with us!</p>\n"
        }
      }
    }'
