  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "order_id": "ca51ad8e-625c-4a9f-8a5b-fb61f15224dd",
          "email_template_id": "d71ac479-4e7e-4234-ac7b-55d3d20d3b8c"
        }
      }
    }'
```
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        "type": "rendered_emails",
        "attributes": {
          "order_id": "370205e4-da1b-43de-b877-4e94514b8e4a",
          "email_template_id": "19302573-6167-41ec-b46c-806e06043def",
          "body": "<p>Thank you for ordering with us!</p>\n"
        }
      }
    }'
