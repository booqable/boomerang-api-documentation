  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "order_id": "7cb37082-5dd3-491a-bec5-f03023b76a76",
          "email_template_id": "0733d1f8-9da8-450d-9acb-6d373d1c5269"
        }
      }
    }'
```
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        "type": "rendered_emails",
        "attributes": {
          "order_id": "d247a36f-c463-44f9-8ef2-f20b8ca4765c",
          "email_template_id": "198c5027-201e-4e93-83c3-2151e109b1df",
          "body": "<p>Thank you for ordering with us!</p>\n"
        }
      }
    }'
