  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "order_id": "4a91e3c5-46d1-4f2a-839f-6f95937e6373",
          "email_template_id": "10217c7a-96d7-4886-8df8-c361fd33e9da"
        }
      }
    }'
```
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        "type": "rendered_emails",
        "attributes": {
          "order_id": "b6269117-96a7-43f9-9dd0-62ec53a4b3a7",
          "email_template_id": "43546b47-784c-4297-833a-7d89b17f6f1b",
          "body": "<p>Thank you for ordering with us!</p>\n"
        }
      }
    }'
