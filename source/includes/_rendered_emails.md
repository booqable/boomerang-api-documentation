  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "order_id": "980be006-93e8-4c53-bdb3-8f7603c97a75",
          "email_template_id": "c11aa513-3ed4-48b1-9aad-a630e6338fea"
        }
      }
    }'
```
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        "type": "rendered_emails",
        "attributes": {
          "order_id": "b28954d9-398c-4bf0-9f5f-557861dd23b5",
          "email_template_id": "07fa6ed9-47a8-4f7a-9f54-4aed0a4bea54",
          "body": "<p>Thank you for ordering with us!</p>\n"
        }
      }
    }'
