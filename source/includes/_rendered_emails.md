  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "order_id": "b7015363-aedc-44ad-a3a8-d0887b9f4f7d",
          "email_template_id": "c34caeaa-6e26-4f7b-81bc-e93507ac769f"
        }
      }
    }'
```
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        "type": "rendered_emails",
        "attributes": {
          "order_id": "69735d5c-06dc-469e-96f9-bc8678088143",
          "email_template_id": "8f17d73f-8160-4091-994f-09a67de4ab09",
          "body": "<p>Thank you for ordering with us!</p>\n"
        }
      }
    }'
