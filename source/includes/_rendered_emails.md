  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "order_id": "97b424af-7086-460a-b5af-166e0c8567e9",
          "email_template_id": "65b7e765-3136-443b-b26c-da6f59cf2f4c"
        }
      }
    }'
```
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        "type": "rendered_emails",
        "attributes": {
          "order_id": "d3a0c9d0-b71a-4b97-ad91-38a8ae9e1026",
          "email_template_id": "0674b77d-1add-483c-823a-4321fe475ecc",
          "body": "<p>Thank you for ordering with us!</p>\n"
        }
      }
    }'
