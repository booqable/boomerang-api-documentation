  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "order_id": "a46103ff-9245-457f-abef-feccb28f79d8",
          "email_template_id": "92208f7f-18b9-4ae1-8036-3caebe9f2a14"
        }
      }
    }'
```
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        "type": "rendered_emails",
        "attributes": {
          "order_id": "75be040a-b940-484f-a54c-86d4794ff667",
          "email_template_id": "70524af4-1129-4159-a2d3-6a1dfe486f35",
          "body": "<p>Thank you for ordering with us!</p>\n"
        }
      }
    }'
