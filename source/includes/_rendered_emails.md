  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "order_id": "4e85ebc2-b1fa-4a8e-9f87-3d3cefa9e2bc",
          "email_template_id": "e659b918-257a-4567-b3f0-cbce4daba95a"
        }
      }
    }'
```
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        "type": "rendered_emails",
        "attributes": {
          "order_id": "685a2ded-5887-402c-9418-e60d9f3d0ec0",
          "email_template_id": "3d86be0e-e9a0-4935-86c3-601890c5b9b5",
          "body": "<p>Thank you for ordering with us!</p>\n"
        }
      }
    }'
