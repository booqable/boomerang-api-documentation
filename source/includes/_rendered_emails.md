  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "order_id": "ba92b3b5-a299-4641-b3c9-b922be3241f1",
          "email_template_id": "c7e0e0c1-a883-4630-a730-44d893481156"
        }
      }
    }'
```
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        "type": "rendered_emails",
        "attributes": {
          "order_id": "2f12ab54-2948-41b4-806d-72f398624617",
          "email_template_id": "4f23ed2b-dbf7-4225-8553-9b603ce16570",
          "body": "<p>Thank you for ordering with us!</p>\n"
        }
      }
    }'
