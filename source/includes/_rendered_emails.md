  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "order_id": "003189bf-d60c-4ed4-9dfe-d2a05dc1b2eb",
          "email_template_id": "e937fa49-bcc8-400f-81d5-2b97fba56bef"
        }
      }
    }'
```
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        "type": "rendered_emails",
        "attributes": {
          "order_id": "b9177db1-7403-4f8e-b4b8-4b48ebc0a646",
          "email_template_id": "8c5f71f0-602a-4d15-955e-7b24d450cae5",
          "body": "<p>Thank you for ordering with us!</p>\n"
        }
      }
    }'
