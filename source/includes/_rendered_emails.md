  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "order_id": "3a49bc1b-812e-4cf3-ad6f-ccfaaee1185f",
          "email_template_id": "e6c50c75-28af-421f-b791-6486590bc61a"
        }
      }
    }'
```
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        "type": "rendered_emails",
        "attributes": {
          "order_id": "19b08cfb-fee3-4719-a0dc-499ca59ba680",
          "email_template_id": "53df074d-c6ee-417a-a333-be3dfee9e896",
          "body": "<p>Thank you for ordering with us!</p>\n"
        }
      }
    }'
