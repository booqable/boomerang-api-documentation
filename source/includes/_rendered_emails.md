  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "order_id": "580ed818-c188-49c5-a353-36880005afbc",
          "email_template_id": "1288dfbd-cdec-4b34-b592-354364990ec6"
        }
      }
    }'
```
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        "type": "rendered_emails",
        "attributes": {
          "order_id": "21d460c3-e4eb-4fa0-98c4-e7a6089fdb39",
          "email_template_id": "6a83185d-dab0-4719-bc21-9978a9902020",
          "body": "<p>Thank you for ordering with us!</p>\n"
        }
      }
    }'
