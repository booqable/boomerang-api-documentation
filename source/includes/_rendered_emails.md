  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "order_id": "13f85298-317b-4fa0-8b45-268e944c0486",
          "email_template_id": "639848da-f19e-479b-80ce-e1c01ed21cd7"
        }
      }
    }'
```
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        "type": "rendered_emails",
        "attributes": {
          "order_id": "4ae484e9-d5b7-4acf-8786-630df0a5dd12",
          "email_template_id": "16eaca68-1a59-4599-af42-68a13638bd7d",
          "body": "<p>Thank you for ordering with us!</p>\n"
        }
      }
    }'
