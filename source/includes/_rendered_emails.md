  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "order_id": "b5f8d375-9669-4b50-ab60-866f345f45ce",
          "email_template_id": "77982ba5-c945-4e8d-a515-0dd9f396e1db"
        }
      }
    }'
```
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        "type": "rendered_emails",
        "attributes": {
          "order_id": "8e84a891-642b-42d6-89dd-c5311f1c3197",
          "email_template_id": "35851645-42bb-421a-be0f-19984a3348d6",
          "body": "<p>Thank you for ordering with us!</p>\n"
        }
      }
    }'
