  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "order_id": "98dff1e6-a649-4312-a1f7-54ab0ad3384d",
          "email_template_id": "eec6f6e8-b0e1-4a3e-a0b9-1138543386d9"
        }
      }
    }'
```
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        "type": "rendered_emails",
        "attributes": {
          "order_id": "19537f6a-856a-4b1a-bc01-2dc872d9c4a0",
          "email_template_id": "0a0f96ec-ec9f-4d7c-b82f-0e24c9a1e85a",
          "body": "<p>Thank you for ordering with us!</p>\n"
        }
      }
    }'
