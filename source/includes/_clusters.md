...
```json
  ...
  "data": [
    {
      "id": "116ad284-6c47-456d-8bf3-3ea4b92ad979",
      "created_at": "2021-09-22T10:38:29+00:00",
      "updated_at": "2021-09-22T10:38:29+00:00",
      "name": "Main",
      "location_ids": []
    }
  ]
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/clusters/dc208be7-7f8e-4de6-baa8-66e407fdc5bf' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "dc208be7-7f8e-4de6-baa8-66e407fdc5bf",
    "created_at": "2021-09-22T10:38:29+00:00",
    "updated_at": "2021-09-22T10:38:29+00:00",
    "name": "Main",
    "location_ids": []
...
```json
  {
  "data": {
    "id": "cdd6a3ad-a867-42c8-8ee7-69b15353ae66",
    "type": "clusters",
    "attributes": {
      "created_at": "2021-09-22T10:38:29+00:00",
      "updated_at": "2021-09-22T10:38:29+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/clusters/733d0832-aac0-44e1-8d9f-83489764badf' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "733d0832-aac0-44e1-8d9f-83489764badf",
        "type": "clusters",
        "attributes": {
          "name": "Rotterdam"
        }
...
```json
  ...
  "data": {
    ...
    "type": "clusters",
    "attributes": {
      "created_at": "2021-09-22T10:38:30+00:00",
      "updated_at": "2021-09-22T10:38:30+00:00",
      "name": "Rotterdam",
      "location_ids": []
    },
    "relationships": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/clusters/f63f90bd-c820-4951-8807-187e75d8c7ad' \
    --header 'content-type: application/json' \
    --data '{}'
```
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/clusters/294d11a5-42b7-4e67-8228-eeec57c8c2ed' \
    --header 'content-type: application/json' \
    --data '{}'
```
  ...
  "errors": [
    {
      ...
      "meta": {
        "location_ids": [
          "3f8e2bbc-3201-42e1-bf3b-cba44ec8c5e6"
        ]
      }
    }
  ]
