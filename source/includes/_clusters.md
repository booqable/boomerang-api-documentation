...
```json
  ...
  "data": [
    {
      "id": "602b5222-1e41-4b0d-81bd-fb067219ea2a",
      "created_at": "2021-09-24T12:39:06+00:00",
      "updated_at": "2021-09-24T12:39:06+00:00",
      "name": "Main",
      "location_ids": []
    }
  ]
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/clusters/bb2eca10-b65a-488d-aa5a-0f39927ede14' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "bb2eca10-b65a-488d-aa5a-0f39927ede14",
    "created_at": "2021-09-24T12:39:06+00:00",
    "updated_at": "2021-09-24T12:39:06+00:00",
    "name": "Main",
    "location_ids": []
...
```json
  {
  "data": {
    "id": "c4f8ccd4-bd43-461b-aeda-0fa9f4972f25",
    "type": "clusters",
    "attributes": {
      "created_at": "2021-09-24T12:39:07+00:00",
      "updated_at": "2021-09-24T12:39:07+00:00",
      "name": "Amsterdam",
      "location_ids": []
    },
    "relationships": {
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/clusters/19f2397e-58d5-4d9c-a82a-6980ca0e4648' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "19f2397e-58d5-4d9c-a82a-6980ca0e4648",
        "type": "clusters",
        "attributes": {
          "name": "Rotterdam"
        }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/clusters/6fd5274b-9b00-427e-bfc9-33910bb62d2c' \
    --header 'content-type: application/json' \
    --data '{}'
```
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/clusters/5ce70824-f5ac-4cba-b3e2-823018e28a0e' \
    --header 'content-type: application/json' \
    --data '{}'
```
  ...
  "errors": [
    {
      ...
      "meta": {
        "location_ids": [
          "e3c8203b-1762-4a00-9a98-8a407094d85c"
        ]
      }
    }
  ]
