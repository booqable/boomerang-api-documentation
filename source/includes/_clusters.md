...
```json
  ...
  "data": [
    {
      "id": "633d164d-0947-4b78-bf69-06958cc2c2ff",
      "created_at": "2021-09-25T11:36:49+00:00",
      "updated_at": "2021-09-25T11:36:49+00:00",
      "name": "Main",
      "location_ids": []
    }
  ]
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/clusters/1fa21cc5-f35b-41a5-b806-04eef97fbbd4' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "1fa21cc5-f35b-41a5-b806-04eef97fbbd4",
    "created_at": "2021-09-25T11:36:50+00:00",
    "updated_at": "2021-09-25T11:36:50+00:00",
    "name": "Main",
    "location_ids": []
  }
}
...
```json
  {
  "data": {
    "id": "7137f9d1-5daf-42e6-a2a1-e76f65e1fafb",
    "type": "clusters",
    "attributes": {
      "created_at": "2021-09-25T11:36:50+00:00",
      "updated_at": "2021-09-25T11:36:50+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/clusters/aa14155f-e193-4dd1-aa0a-acd4203366b0' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "aa14155f-e193-4dd1-aa0a-acd4203366b0",
        "type": "clusters",
        "attributes": {
          "name": "Rotterdam"
        }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/clusters/47695ad8-4a8d-4886-a996-152eb92059b0' \
    --header 'content-type: application/json' \
    --data '{}'
```
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/clusters/5ea4f95e-b46a-4bdb-b3dd-5b6fe53c09e5' \
    --header 'content-type: application/json' \
    --data '{}'
```
  ...
  "errors": [
    {
      ...
      "meta": {
        "location_ids": [
          "f79fd69a-5cc1-4b38-98b3-81c1305e2f71"
        ]
      }
    }
  ]
