...
```json
  ...
  "data": [
    {
      "id": "c1c8ccbc-e5b7-4a69-9a98-70baa094089a",
      "type": "clusters",
      "attributes": {
      ...
      "relationships": {
        "locations": {
          "links": {
            "related": "api/boomerang/locations?filter[cluster_id]=c1c8ccbc-e5b7-4a69-9a98-70baa094089a"
          }
        }
      }
    }
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/clusters/6da8ea2d-5b0f-485b-8440-bcf51ffd43c4' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "6da8ea2d-5b0f-485b-8440-bcf51ffd43c4",
    "type": "clusters",
    "attributes": {
      "created_at": "2023-03-09T13:48:51+00:00",
      "updated_at": "2023-03-09T13:48:51+00:00",
      "name": "Main",
      "location_ids": []
    },
    "relationships": {
      "locations": {
        "links": {
          "related": "api/boomerang/locations?filter[cluster_id]=6da8ea2d-5b0f-485b-8440-bcf51ffd43c4"
        }
      }
    }
  },
...
```json
  {
  "data": {
    "id": "6dbd9c8e-5f24-4d10-95c4-ee705400c7c1",
    "type": "clusters",
    "attributes": {
      "created_at": "2023-03-09T13:48:51+00:00",
      "updated_at": "2023-03-09T13:48:51+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/clusters/2857e830-0bdd-4d41-a6f4-047b46d8a713' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "2857e830-0bdd-4d41-a6f4-047b46d8a713",
        "type": "clusters",
        "attributes": {
          "name": "Rotterdam"
        }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/clusters/4a1039e8-103c-4607-a1d2-fcbd570a3489' \
    --header 'content-type: application/json' \
```
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/clusters/f976b3c5-164d-4e37-b43f-57f54684121a' \
    --header 'content-type: application/json' \
```
  ...
  "errors": [
    {
      ...
      "meta": {
        "location_ids": [
          "e37a35e3-e6f9-4948-bfdc-f0ac884b8c13"
        ]
      }
    }
  ]
