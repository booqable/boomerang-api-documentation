  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "order_id": "3bfd990e-f464-4124-be4e-677098733ac1"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "0f5cc3d9-d456-5391-9e25-0498df095fa7",
    "type": "invoice_revisions",
    "attributes": {
      "order_id": "3bfd990e-f464-4124-be4e-677098733ac1",
      "revised_invoice_id": "396f6cf3-16ba-4400-9441-6836bff1e584",
      "revision_invoice_id": "d91ca938-629e-4533-b887-f4e093390c26"
    },
    "relationships": {
      "order": {
        "meta": {
