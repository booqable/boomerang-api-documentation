  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "order_id": "4ce13c1a-8411-458a-846a-8de1d6f51d0e"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "4b7d537e-1017-52cd-bceb-1f84576d42ca",
    "type": "invoice_revisions",
    "attributes": {
      "order_id": "4ce13c1a-8411-458a-846a-8de1d6f51d0e",
      "revised_invoice_id": "898b7e22-0ad9-4151-9768-6ff4b22720dd",
      "revision_invoice_id": "2e8fc951-2555-46cf-a5f5-8ece99dd361c"
    },
    "relationships": {
      "order": {
        "meta": {
