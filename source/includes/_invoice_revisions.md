  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "order_id": "4522e2e6-a866-4d7c-84cd-4babdfd41f11"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "fb3e7a8d-12ae-5431-91c0-0e24d2733b82",
    "type": "invoice_revisions",
    "attributes": {
      "order_id": "4522e2e6-a866-4d7c-84cd-4babdfd41f11",
      "revised_invoice_id": "9f95c653-c219-4dfd-b769-ae3f9885b079",
      "revision_invoice_id": "fe159323-ca5a-4cbc-87ca-b044cb63c516"
    },
    "relationships": {
      "order": {
        "meta": {
