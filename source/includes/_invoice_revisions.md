  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "order_id": "f37498e5-50d3-420d-a0e7-5b098aa85fe7"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "fe7f6187-c059-522e-89fd-0686975cc7b6",
    "type": "invoice_revisions",
    "attributes": {
      "order_id": "f37498e5-50d3-420d-a0e7-5b098aa85fe7",
      "revised_invoice_id": "740bf58e-0155-4291-8d22-d00d601dd12b",
      "revision_invoice_id": "b533b542-5be9-45ae-b199-ac942cac6e64"
    },
    "relationships": {
      "order": {
        "meta": {
