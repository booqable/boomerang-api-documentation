  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "order_id": "f2947897-56f4-4ee5-8e7b-a1a5311a956a"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "eeb91223-1a51-5114-b280-6e5057f698ed",
    "type": "invoice_revisions",
    "attributes": {
      "order_id": "f2947897-56f4-4ee5-8e7b-a1a5311a956a",
      "revised_invoice_id": "0a6cdaf8-ae1f-4193-9f87-420657f984f1",
      "revision_invoice_id": "d7f5b0d8-40fa-49fe-b72a-310a308cddcf"
    },
    "relationships": {
      "order": {
        "meta": {
