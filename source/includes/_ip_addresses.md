...
```json
  ...
  "data": [
    {
      "id": "015293ba-d1dd-4fc4-a37f-cbc444d3ccf1",
      "type": "ip_addresses",
      "attributes": {
        "created_at": "2023-02-09T15:56:00+00:00",
        "updated_at": "2023-02-09T15:56:00+00:00",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/bb39719f-a7b6-466b-85c6-6dcbdfa95900' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "bb39719f-a7b6-466b-85c6-6dcbdfa95900",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2023-02-09T15:56:00+00:00",
      "updated_at": "2023-02-09T15:56:00+00:00",
...
```json
  {
  "data": {
    "id": "28be1f9e-5831-4fee-a9d7-38de385b60c9",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2023-02-09T15:56:00+00:00",
      "updated_at": "2023-02-09T15:56:00+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/3beb6298-ce04-49b0-b976-aa452c9d0cc0' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "3beb6298-ce04-49b0-b976-aa452c9d0cc0",
        "type": "ip_addresses",
        "attributes": {
...
```json
  ...
  "data": {
    ...
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2023-02-09T15:56:01+00:00",
      "updated_at": "2023-02-09T15:56:01+00:00",
      "label": "Palo Alto office",
      "address": "192.168.0.3"
    }
  },
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/296e05d2-43fa-4c61-bb50-bf11c1778a2e' \
    --header 'content-type: application/json' \
```
