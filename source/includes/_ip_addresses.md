...
```json
  ...
  "data": [
    {
      "id": "d8f5069e-fb9d-41ba-8ba9-95b1b6b062a3",
      "type": "ip_addresses",
      "attributes": {
        "created_at": "2023-02-02T14:15:27+00:00",
        "updated_at": "2023-02-02T14:15:27+00:00",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/abb71ca5-1ea7-444b-9848-6b46ccf97fec' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "abb71ca5-1ea7-444b-9848-6b46ccf97fec",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2023-02-02T14:15:28+00:00",
      "updated_at": "2023-02-02T14:15:28+00:00",
      "label": "John's home office",
      "address": "192.168.0.1"
    }
  },
...
```json
  {
  "data": {
    "id": "a54cfce4-bbec-47f9-9b44-7307f8c86a79",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2023-02-02T14:15:28+00:00",
      "updated_at": "2023-02-02T14:15:28+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/d6e4ba59-d387-4641-8aea-f0374844815f' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "d6e4ba59-d387-4641-8aea-f0374844815f",
        "type": "ip_addresses",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/458ce9ac-be0b-43a7-a1ed-3527a904b686' \
    --header 'content-type: application/json' \
```
