...
```json
  ...
  "data": [
    {
      "id": "b76ce9d8-8417-4e47-8fac-483779a89047",
      "type": "ip_addresses",
      "attributes": {
        "created_at": "2022-06-16T19:31:46+00:00",
        "updated_at": "2022-06-16T19:31:46+00:00",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/dc72d09c-79d0-4200-8850-b7b50896f5c7' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "dc72d09c-79d0-4200-8850-b7b50896f5c7",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2022-06-16T19:31:47+00:00",
      "updated_at": "2022-06-16T19:31:47+00:00",
      "label": "John's home office",
      "address": "192.168.0.1"
    }
  },
...
```json
  {
  "data": {
    "id": "a47c282b-4fc7-4f34-a063-961050b2e623",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2022-06-16T19:31:48+00:00",
      "updated_at": "2022-06-16T19:31:48+00:00",
      "label": "Leeuwarden office",
      "address": "192.168.0.2"
    }
  },
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/867319fb-e506-4f5b-8c34-36728aa9b6a9' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "867319fb-e506-4f5b-8c34-36728aa9b6a9",
        "type": "ip_addresses",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/790b91ea-3dcd-4919-b708-e144bf8a9f3a' \
    --header 'content-type: application/json' \
```
