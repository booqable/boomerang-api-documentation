...
```json
  ...
  "data": [
    {
      "id": "58eb32aa-1e4d-4bb9-b6e9-c97554de7043",
      "type": "ip_addresses",
      "attributes": {
        "created_at": "2023-02-08T15:19:18+00:00",
        "updated_at": "2023-02-08T15:19:18+00:00",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/a1638119-de94-4c8e-8125-6ab6ba96db1c' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "a1638119-de94-4c8e-8125-6ab6ba96db1c",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2023-02-08T15:19:19+00:00",
      "updated_at": "2023-02-08T15:19:19+00:00",
      "label": "John's home office",
      "address": "192.168.0.1"
    }
  },
...
```json
  {
  "data": {
    "id": "0157c6af-0af4-4af6-8630-a9c9fedaef4f",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2023-02-08T15:19:19+00:00",
      "updated_at": "2023-02-08T15:19:19+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/f71a860e-b769-48c2-bed1-1b8ce3be01d9' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "f71a860e-b769-48c2-bed1-1b8ce3be01d9",
        "type": "ip_addresses",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/30a69fb2-b50a-4f45-8237-813bd9061ed9' \
    --header 'content-type: application/json' \
```
