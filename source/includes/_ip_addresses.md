...
```json
  ...
  "data": [
    {
      "id": "2f5c76b3-6711-496d-9bd8-49353baf98d4",
      "type": "ip_addresses",
      "attributes": {
        "created_at": "2023-02-16T10:59:56+00:00",
        "updated_at": "2023-02-16T10:59:56+00:00",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/6a485800-ef58-40db-ac60-648bb92296b4' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "6a485800-ef58-40db-ac60-648bb92296b4",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2023-02-16T10:59:56+00:00",
      "updated_at": "2023-02-16T10:59:56+00:00",
...
```json
  {
  "data": {
    "id": "5c6392b0-4a8f-4558-9afd-0d5eb78dcc5a",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2023-02-16T10:59:57+00:00",
      "updated_at": "2023-02-16T10:59:57+00:00",
      "label": "Leeuwarden office",
      "address": "192.168.0.2"
    }
  },
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/f9f85e37-ccb1-4c65-9caf-4fa2f8fa4a86' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "f9f85e37-ccb1-4c65-9caf-4fa2f8fa4a86",
        "type": "ip_addresses",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/58db78b6-0cf9-4fa2-9352-6a8d153ec6bb' \
    --header 'content-type: application/json' \
```
