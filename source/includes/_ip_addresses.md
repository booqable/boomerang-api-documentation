...
```json
  ...
  "data": [
    {
      "id": "137dff80-f508-45d8-9433-1367e85fcb58",
      "type": "ip_addresses",
      "attributes": {
        "created_at": "2022-04-08T17:52:14+00:00",
        "updated_at": "2022-04-08T17:52:14+00:00",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/b7519bff-c899-4542-8d1b-9ab2ab9f06ee' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "b7519bff-c899-4542-8d1b-9ab2ab9f06ee",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2022-04-08T17:52:14+00:00",
      "updated_at": "2022-04-08T17:52:14+00:00",
...
```json
  {
  "data": {
    "id": "e5b47c58-6d9a-40e5-a506-82417ae84dfc",
    "type": "ip_addresses",
    "attributes": {
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/b391e6ba-0bb2-4ded-a849-bb76092e5f7f' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "b391e6ba-0bb2-4ded-a849-bb76092e5f7f",
        "type": "ip_addresses",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/27ad8784-ff05-4fce-b746-1ecf5ccc9c57' \
    --header 'content-type: application/json' \
```
