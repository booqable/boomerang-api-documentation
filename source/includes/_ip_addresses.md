...
```json
  ...
  "data": [
    {
      "id": "ca0c649f-c3c9-4abd-8d5a-d19e6e3f2183",
      "type": "ip_addresses",
      "attributes": {
        "created_at": "2023-02-08T09:45:39+00:00",
        "updated_at": "2023-02-08T09:45:39+00:00",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/3ece4dcd-8c5f-46a1-b4d1-8d86983d9282' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "3ece4dcd-8c5f-46a1-b4d1-8d86983d9282",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2023-02-08T09:45:40+00:00",
      "updated_at": "2023-02-08T09:45:40+00:00",
      "label": "John's home office",
      "address": "192.168.0.1"
    }
  },
...
```json
  {
  "data": {
    "id": "0f89dcbe-b180-4d7f-ab27-cb03668a770c",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2023-02-08T09:45:40+00:00",
      "updated_at": "2023-02-08T09:45:40+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/4cbf1c5f-cb63-4454-af78-c4a7aef32895' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "4cbf1c5f-cb63-4454-af78-c4a7aef32895",
        "type": "ip_addresses",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/16fe192b-e319-4bd1-9a43-2245e90d4a2e' \
    --header 'content-type: application/json' \
```
