...
```json
  ...
  "data": [
    {
      "id": "0abd0a8d-a8e3-49c9-8d0f-0bdb84cd0294",
      "type": "ip_addresses",
      "attributes": {
        "created_at": "2023-02-09T11:07:26+00:00",
        "updated_at": "2023-02-09T11:07:26+00:00",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/c8df31b1-ea5a-4e46-b6f9-2206c895a680' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "c8df31b1-ea5a-4e46-b6f9-2206c895a680",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2023-02-09T11:07:26+00:00",
      "updated_at": "2023-02-09T11:07:26+00:00",
...
```json
  {
  "data": {
    "id": "146dfb3a-0f97-418f-ae6a-21b2ea911f87",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2023-02-09T11:07:27+00:00",
      "updated_at": "2023-02-09T11:07:27+00:00",
      "label": "Leeuwarden office",
      "address": "192.168.0.2"
    }
  },
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/db1ad742-961d-4325-b65c-7eea268533be' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "db1ad742-961d-4325-b65c-7eea268533be",
        "type": "ip_addresses",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/9c4d0c5c-6c98-4035-9654-6cb13259aee7' \
    --header 'content-type: application/json' \
```
