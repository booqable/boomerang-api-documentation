...
```json
  ...
  "data": [
    {
      "id": "c95030f8-ddc3-4e3b-9ce4-f948aa762d2b",
      "type": "ip_addresses",
      "attributes": {
        "created_at": "2023-02-14T13:02:13+00:00",
        "updated_at": "2023-02-14T13:02:13+00:00",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/6baff129-0ed9-4dd5-b5a5-5e56bac899ac' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "6baff129-0ed9-4dd5-b5a5-5e56bac899ac",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2023-02-14T13:02:13+00:00",
      "updated_at": "2023-02-14T13:02:13+00:00",
...
```json
  {
  "data": {
    "id": "a66da5f0-afad-4e31-9010-76f4d1da4995",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2023-02-14T13:02:14+00:00",
      "updated_at": "2023-02-14T13:02:14+00:00",
      "label": "Leeuwarden office",
      "address": "192.168.0.2"
    }
  },
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/f1e4e499-f566-41e1-91cb-1cb00c790609' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "f1e4e499-f566-41e1-91cb-1cb00c790609",
        "type": "ip_addresses",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/67d3589a-079d-40ed-b09d-1b26aa596ded' \
    --header 'content-type: application/json' \
```
