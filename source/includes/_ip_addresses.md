...
```json
  ...
  "data": [
    {
      "id": "77b9dc52-64e3-4c37-9c2d-fe2f42b434dd",
      "type": "ip_addresses",
      "attributes": {
        "created_at": "2023-02-14T12:46:48+00:00",
        "updated_at": "2023-02-14T12:46:48+00:00",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/b04fd469-7951-4cd9-9252-9498fcce8b7c' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "b04fd469-7951-4cd9-9252-9498fcce8b7c",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2023-02-14T12:46:49+00:00",
      "updated_at": "2023-02-14T12:46:49+00:00",
      "label": "John's home office",
      "address": "192.168.0.1"
    }
  },
...
```json
  {
  "data": {
    "id": "296f4403-b1a6-4eb5-b8bb-78f734e9353a",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2023-02-14T12:46:49+00:00",
      "updated_at": "2023-02-14T12:46:49+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/20e4f516-ba84-4d58-820b-a2ff5cd10fbf' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "20e4f516-ba84-4d58-820b-a2ff5cd10fbf",
        "type": "ip_addresses",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/57ae2833-0e2b-438c-bbe0-bfef1c06fc8a' \
    --header 'content-type: application/json' \
```
