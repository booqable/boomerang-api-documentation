...
```json
  ...
  "data": [
    {
      "id": "22e1852a-97a1-4d9e-bea2-d3acc582cb74",
      "type": "ip_addresses",
      "attributes": {
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/4ab5aaa7-2fec-4223-95d9-8098d6298e7c' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "4ab5aaa7-2fec-4223-95d9-8098d6298e7c",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2022-07-12T14:15:00+00:00",
      "updated_at": "2022-07-12T14:15:00+00:00",
...
```json
  {
  "data": {
    "id": "1087a55b-ecdd-4418-aa69-151152c8f290",
    "type": "ip_addresses",
    "attributes": {
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/f2732063-23a4-4b60-acd9-647644819f5f' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "f2732063-23a4-4b60-acd9-647644819f5f",
        "type": "ip_addresses",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/886327ec-c8c7-4b4f-ae5a-547352b733c4' \
    --header 'content-type: application/json' \
```
