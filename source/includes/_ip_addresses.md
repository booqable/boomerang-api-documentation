...
```json
  ...
  "data": [
    {
      "id": "b6e06538-f62d-42d2-8362-40caf0c59ef0",
      "type": "ip_addresses",
      "attributes": {
        "created_at": "2023-01-24T14:01:19+00:00",
        "updated_at": "2023-01-24T14:01:19+00:00",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/9ab47df0-5de7-4027-b04c-a127e4725fb3' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "9ab47df0-5de7-4027-b04c-a127e4725fb3",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2023-01-24T14:01:19+00:00",
      "updated_at": "2023-01-24T14:01:19+00:00",
...
```json
  {
  "data": {
    "id": "49e330ee-5ab7-4cca-8076-ba77e8b49c1b",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2023-01-24T14:01:19+00:00",
      "updated_at": "2023-01-24T14:01:19+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/d4247706-fda8-417d-a492-2ad091044a36' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "d4247706-fda8-417d-a492-2ad091044a36",
        "type": "ip_addresses",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/88a81b73-5e5c-4998-bbdd-661b8539e031' \
    --header 'content-type: application/json' \
```
