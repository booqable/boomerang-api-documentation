...
```json
  ...
  "data": [
    {
      "id": "90055ac2-0ff0-4c02-b591-9ed278c7df6c",
      "type": "ip_addresses",
      "attributes": {
        "created_at": "2023-02-09T12:17:28+00:00",
        "updated_at": "2023-02-09T12:17:28+00:00",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/245973ee-0c53-4537-b987-23377487e6ae' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "245973ee-0c53-4537-b987-23377487e6ae",
    "type": "ip_addresses",
    "attributes": {
...
```json
  {
  "data": {
    "id": "8b5f5133-9103-4e0b-9ec0-1083f377086e",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2023-02-09T12:17:29+00:00",
      "updated_at": "2023-02-09T12:17:29+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/4f011db9-aafe-4772-ab84-e4b919c99e2e' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "4f011db9-aafe-4772-ab84-e4b919c99e2e",
        "type": "ip_addresses",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/0302c5bd-ed52-4f03-8e60-b23b86f6bb8e' \
    --header 'content-type: application/json' \
```
