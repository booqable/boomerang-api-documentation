...
```json
  ...
  "data": [
    {
      "id": "2f08154d-dbad-4951-ba18-d4eb45b43170",
      "type": "ip_addresses",
      "attributes": {
        "created_at": "2023-02-08T13:51:42+00:00",
        "updated_at": "2023-02-08T13:51:42+00:00",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/d797b674-3a4c-45e5-9f03-ccc249d0d5bc' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "d797b674-3a4c-45e5-9f03-ccc249d0d5bc",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2023-02-08T13:51:42+00:00",
      "updated_at": "2023-02-08T13:51:42+00:00",
...
```json
  {
  "data": {
    "id": "1b6316d6-93cd-4faf-80d8-9843a9482e77",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2023-02-08T13:51:43+00:00",
      "updated_at": "2023-02-08T13:51:43+00:00",
      "label": "Leeuwarden office",
      "address": "192.168.0.2"
    }
  },
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/e4631775-1bd4-42a6-b7db-3da37bb0900d' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "e4631775-1bd4-42a6-b7db-3da37bb0900d",
        "type": "ip_addresses",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/5949f6c1-ce3d-4bc3-beb3-271adaaedfda' \
    --header 'content-type: application/json' \
```
