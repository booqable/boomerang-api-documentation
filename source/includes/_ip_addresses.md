...
```json
  ...
  "data": [
    {
      "id": "fd0ec642-17d5-4351-885a-4b3545ae38cb",
      "type": "ip_addresses",
      "attributes": {
        "created_at": "2022-11-22T16:35:35+00:00",
        "updated_at": "2022-11-22T16:35:35+00:00",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/fc682386-7ff0-459f-96f0-5a121a177183' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "fc682386-7ff0-459f-96f0-5a121a177183",
    "type": "ip_addresses",
    "attributes": {
...
```json
  {
  "data": {
    "id": "40e21c1b-9828-4ebf-a000-079b7b7ad83a",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2022-11-22T16:35:36+00:00",
      "updated_at": "2022-11-22T16:35:36+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/23c5d4ff-ddd6-4fc4-9c93-cd4c80ad1a5a' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "23c5d4ff-ddd6-4fc4-9c93-cd4c80ad1a5a",
        "type": "ip_addresses",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/5c8614eb-17d6-4b91-9ae9-c5faa8055da7' \
    --header 'content-type: application/json' \
```
