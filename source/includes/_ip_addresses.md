...
```json
  ...
  "data": [
    {
      "id": "cdf543bb-0965-4c3e-9e2e-a19600f8b2b7",
      "type": "ip_addresses",
      "attributes": {
        "created_at": "2023-02-07T15:18:34+00:00",
        "updated_at": "2023-02-07T15:18:34+00:00",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/bb38952a-4b4d-4083-9580-d373b222a47b' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "bb38952a-4b4d-4083-9580-d373b222a47b",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2023-02-07T15:18:34+00:00",
      "updated_at": "2023-02-07T15:18:34+00:00",
...
```json
  {
  "data": {
    "id": "8ada7373-c9da-431d-9700-cc41e33b90f2",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2023-02-07T15:18:35+00:00",
      "updated_at": "2023-02-07T15:18:35+00:00",
      "label": "Leeuwarden office",
      "address": "192.168.0.2"
    }
  },
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/ae90e98a-c0e9-451c-a601-7bb13755d462' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "ae90e98a-c0e9-451c-a601-7bb13755d462",
        "type": "ip_addresses",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/d0d72356-b012-4057-bccd-dd7043e44b2f' \
    --header 'content-type: application/json' \
```
