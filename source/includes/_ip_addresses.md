...
```json
  ...
  "data": [
    {
      "id": "cea51057-e218-4cdf-abc7-8ca64f97fb74",
      "type": "ip_addresses",
      "attributes": {
        "created_at": "2022-05-30T12:18:44+00:00",
        "updated_at": "2022-05-30T12:18:44+00:00",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/7701176f-ad62-4823-bb6c-cac0ba55bbbe' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "7701176f-ad62-4823-bb6c-cac0ba55bbbe",
    "type": "ip_addresses",
    "attributes": {
...
```json
  {
  "data": {
    "id": "800f1b4f-ac24-46bb-8ca0-53b33dc15ff9",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2022-05-30T12:18:45+00:00",
      "updated_at": "2022-05-30T12:18:45+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/f1758cee-4f9d-4aea-a04a-e7ea70a4dc5d' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "f1758cee-4f9d-4aea-a04a-e7ea70a4dc5d",
        "type": "ip_addresses",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/f3e1c259-9c79-4dd8-baa5-d5269fdaee51' \
    --header 'content-type: application/json' \
```
