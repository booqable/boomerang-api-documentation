...
```json
  ...
  "data": [
    {
      "id": "9eaa34b7-5159-4375-8e31-bc38b50af44d",
      "type": "ip_addresses",
      "attributes": {
        "created_at": "2022-07-08T13:11:23+00:00",
        "updated_at": "2022-07-08T13:11:23+00:00",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/71b66be9-13ee-4081-90a8-5d7f68c678f5' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "71b66be9-13ee-4081-90a8-5d7f68c678f5",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2022-07-08T13:11:23+00:00",
      "updated_at": "2022-07-08T13:11:23+00:00",
...
```json
  {
  "data": {
    "id": "640832ac-b36b-489e-b286-527b367764d5",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2022-07-08T13:11:24+00:00",
      "updated_at": "2022-07-08T13:11:24+00:00",
      "label": "Leeuwarden office",
      "address": "192.168.0.2"
    }
  },
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/5e092b36-8523-41c3-81cf-3a93d4d77598' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "5e092b36-8523-41c3-81cf-3a93d4d77598",
        "type": "ip_addresses",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/9fa2e6a4-5459-4d98-8c4d-728d22925f16' \
    --header 'content-type: application/json' \
```
