...
```json
  ...
  "data": [
    {
      "id": "279be32b-c347-49fb-bddf-96b75f437f1b",
      "type": "ip_addresses",
      "attributes": {
        "created_at": "2022-11-16T14:31:41+00:00",
        "updated_at": "2022-11-16T14:31:41+00:00",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/e46bba47-9d6b-447c-8faa-dd5eb25fbd98' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "e46bba47-9d6b-447c-8faa-dd5eb25fbd98",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2022-11-16T14:31:41+00:00",
      "updated_at": "2022-11-16T14:31:41+00:00",
...
```json
  {
  "data": {
    "id": "287a239a-f788-439c-a5b1-110d5e3f5a28",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2022-11-16T14:31:42+00:00",
      "updated_at": "2022-11-16T14:31:42+00:00",
      "label": "Leeuwarden office",
      "address": "192.168.0.2"
    }
  },
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/afc82dc1-0b36-4227-9eb3-23e0c04681f0' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "afc82dc1-0b36-4227-9eb3-23e0c04681f0",
        "type": "ip_addresses",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/8bb169ff-d3b5-4ffb-8de8-4317f31dafe0' \
    --header 'content-type: application/json' \
```
