...
```json
  ...
  "data": [
    {
      "id": "5b7fa055-f322-41af-a868-c61128f3352c",
      "type": "ip_addresses",
      "attributes": {
        "created_at": "2023-02-16T15:35:59+00:00",
        "updated_at": "2023-02-16T15:35:59+00:00",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/9c50f548-8a4b-4b4e-9aef-21d505834540' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "9c50f548-8a4b-4b4e-9aef-21d505834540",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2023-02-16T15:35:59+00:00",
      "updated_at": "2023-02-16T15:35:59+00:00",
...
```json
  {
  "data": {
    "id": "53f8d5e4-3ce4-4f2c-a18b-1749c2c0c938",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2023-02-16T15:36:00+00:00",
      "updated_at": "2023-02-16T15:36:00+00:00",
      "label": "Leeuwarden office",
      "address": "192.168.0.2"
    }
  },
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/229ff03a-ff38-4a92-ae66-7775828dcfb8' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "229ff03a-ff38-4a92-ae66-7775828dcfb8",
        "type": "ip_addresses",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/843c4899-a45d-47be-87ce-ac4b5e7c8ef6' \
    --header 'content-type: application/json' \
```
