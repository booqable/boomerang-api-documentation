...
```json
  ...
  "data": [
    {
      "id": "161f914d-2917-48ed-9cba-c7c63154bbc1",
      "type": "ip_addresses",
      "attributes": {
        "created_at": "2023-02-16T23:13:01+00:00",
        "updated_at": "2023-02-16T23:13:01+00:00",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/3a33b8a0-6005-47cb-96fd-1756d5f6d957' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "3a33b8a0-6005-47cb-96fd-1756d5f6d957",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2023-02-16T23:13:01+00:00",
      "updated_at": "2023-02-16T23:13:01+00:00",
...
```json
  {
  "data": {
    "id": "daee7bfd-b741-4cc7-ad59-6b32993043ac",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2023-02-16T23:13:02+00:00",
      "updated_at": "2023-02-16T23:13:02+00:00",
      "label": "Leeuwarden office",
      "address": "192.168.0.2"
    }
  },
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/f5f1e93b-2846-4a6c-9fe2-22a527df782a' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "f5f1e93b-2846-4a6c-9fe2-22a527df782a",
        "type": "ip_addresses",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/dfb1a5c7-956b-439d-9808-4db3692d9d4d' \
    --header 'content-type: application/json' \
```
