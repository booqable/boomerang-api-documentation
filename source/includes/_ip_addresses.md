...
```json
  ...
  "data": [
    {
      "id": "98aeadc9-e7aa-426b-b76e-f62ee9f5b419",
      "type": "ip_addresses",
      "attributes": {
        "created_at": "2022-03-25T08:53:25+00:00",
        "updated_at": "2022-03-25T08:53:25+00:00",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/d4e73ee2-3092-426a-adfe-01fe2331683f' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "d4e73ee2-3092-426a-adfe-01fe2331683f",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2022-03-25T08:53:25+00:00",
      "updated_at": "2022-03-25T08:53:25+00:00",
...
```json
  {
  "data": {
    "id": "4012af35-0e88-4b61-9ec5-6f64e0b5c540",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2022-03-25T08:53:25+00:00",
      "updated_at": "2022-03-25T08:53:25+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/478c083b-3c50-4b5f-8536-68abbc20142c' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "478c083b-3c50-4b5f-8536-68abbc20142c",
        "type": "ip_addresses",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/58a9878c-77fa-48ba-99a3-85da8a9358cd' \
    --header 'content-type: application/json' \
```
