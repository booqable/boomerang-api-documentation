...
```json
  ...
  "data": [
    {
      "id": "cffecc80-9446-4f1d-a0b2-a3a24149fdd6",
      "type": "ip_addresses",
      "attributes": {
        "created_at": "2022-04-13T06:34:45+00:00",
        "updated_at": "2022-04-13T06:34:45+00:00",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/62054a34-c0bd-4e99-a241-1c48216991d2' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "62054a34-c0bd-4e99-a241-1c48216991d2",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2022-04-13T06:34:45+00:00",
      "updated_at": "2022-04-13T06:34:45+00:00",
...
```json
  {
  "data": {
    "id": "d6c4a137-04df-4bc3-9009-f8cbcc5edaac",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2022-04-13T06:34:46+00:00",
      "updated_at": "2022-04-13T06:34:46+00:00",
      "label": "Leeuwarden office",
      "address": "192.168.0.2"
    }
  },
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/5d4693b7-0b80-497f-8cca-9539731e518c' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "5d4693b7-0b80-497f-8cca-9539731e518c",
        "type": "ip_addresses",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/daf0b4fa-ed2a-4021-a681-9a7971d6be86' \
    --header 'content-type: application/json' \
```
