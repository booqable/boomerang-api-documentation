...
```json
  ...
  "data": [
    {
      "id": "b49ee106-9f17-4bc6-a499-b25ad62d5d42",
      "type": "ip_addresses",
      "attributes": {
        "created_at": "2023-02-08T08:36:16+00:00",
        "updated_at": "2023-02-08T08:36:16+00:00",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/8ea03ff0-baef-4637-b4f6-9faace064828' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "8ea03ff0-baef-4637-b4f6-9faace064828",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2023-02-08T08:36:16+00:00",
      "updated_at": "2023-02-08T08:36:16+00:00",
...
```json
  {
  "data": {
    "id": "782b5bb4-4888-4882-b86a-e3e60c5ec932",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2023-02-08T08:36:17+00:00",
      "updated_at": "2023-02-08T08:36:17+00:00",
      "label": "Leeuwarden office",
      "address": "192.168.0.2"
    }
  },
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/900a2ef9-388b-494b-a424-2c2fd32655bd' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "900a2ef9-388b-494b-a424-2c2fd32655bd",
        "type": "ip_addresses",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/84dc8799-11e6-41b2-98b9-e1209a6a6728' \
    --header 'content-type: application/json' \
```
