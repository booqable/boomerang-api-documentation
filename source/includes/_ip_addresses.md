...
```json
  ...
  "data": [
    {
      "id": "0d31fd5f-de19-46b7-8892-2245b1bcb206",
      "type": "ip_addresses",
      "attributes": {
        "created_at": "2021-11-18T15:32:05+00:00",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/690e2e46-16b9-45b0-a638-348646b0f8c2' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "690e2e46-16b9-45b0-a638-348646b0f8c2",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2021-11-18T15:32:05+00:00",
      "updated_at": "2021-11-18T15:32:05+00:00",
...
```json
  {
  "data": {
    "id": "7e24b0b9-c8f1-4b1a-8a42-f698f547a4fd",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2021-11-18T15:32:05+00:00",
      "updated_at": "2021-11-18T15:32:05+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/d150660b-0abb-4c02-a408-1759bc9de913' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "d150660b-0abb-4c02-a408-1759bc9de913",
        "type": "ip_addresses",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/cbb1d324-5f39-48eb-b18c-dd6cdc40c39f' \
    --header 'content-type: application/json' \
```
