...
```json
  ...
  "data": [
    {
      "id": "0baa5a29-42a0-4f99-a8d9-5bf72fdfca0b",
      "type": "ip_addresses",
      "attributes": {
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/d2194cfe-ac22-4926-99bf-482929aa815c' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "d2194cfe-ac22-4926-99bf-482929aa815c",
    "type": "ip_addresses",
    "attributes": {
      "label": "John's home office",
      "address": "192.168.0.1"
...
```json
  {
  "data": {
    "id": "9bb28784-0aa8-4176-a8de-af5bed552dbe",
    "type": "ip_addresses",
    "attributes": {
      "label": "Leeuwarden office",
      "address": "192.168.0.2"
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/d954b7b8-1dd3-4fef-acc2-05589a097091' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "d954b7b8-1dd3-4fef-acc2-05589a097091",
        "type": "ip_addresses",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/b4368996-7adf-4674-a585-1d475b9aa57e' \
    --header 'content-type: application/json' \
```
