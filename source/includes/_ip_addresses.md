...
```json
  ...
  "data": [
    {
      "id": "3b6be237-c76c-4078-86a9-6eed0821e68b",
      "type": "ip_addresses",
      "attributes": {
        "created_at": "2022-11-22T14:42:15+00:00",
        "updated_at": "2022-11-22T14:42:15+00:00",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/4f14a4da-ae0e-4f18-82d4-f06e3bdfa49e' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "4f14a4da-ae0e-4f18-82d4-f06e3bdfa49e",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2022-11-22T14:42:15+00:00",
      "updated_at": "2022-11-22T14:42:15+00:00",
...
```json
  {
  "data": {
    "id": "3af9f74c-c22a-463d-966a-d0533fc7f0f8",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2022-11-22T14:42:16+00:00",
      "updated_at": "2022-11-22T14:42:16+00:00",
      "label": "Leeuwarden office",
      "address": "192.168.0.2"
    }
  },
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/7523453d-f32b-487c-9bf9-9478c51d7456' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "7523453d-f32b-487c-9bf9-9478c51d7456",
        "type": "ip_addresses",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/543396e0-2064-463a-9bcd-a236bd899439' \
    --header 'content-type: application/json' \
```
