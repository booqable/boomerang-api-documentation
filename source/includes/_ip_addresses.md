...
```json
  ...
  "data": [
    {
      "id": "d721de4b-5347-4ab6-89c2-54bdd8a67ad1",
      "type": "ip_addresses",
      "attributes": {
        "created_at": "2023-02-08T08:35:32+00:00",
        "updated_at": "2023-02-08T08:35:32+00:00",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/fbb35471-723b-4056-82bd-31ad4c7974a7' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "fbb35471-723b-4056-82bd-31ad4c7974a7",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2023-02-08T08:35:32+00:00",
      "updated_at": "2023-02-08T08:35:32+00:00",
...
```json
  {
  "data": {
    "id": "7db4a5f3-09cb-4d90-aab6-5f89acef2888",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2023-02-08T08:35:33+00:00",
      "updated_at": "2023-02-08T08:35:33+00:00",
      "label": "Leeuwarden office",
      "address": "192.168.0.2"
    }
  },
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/580f7f22-179a-4ccd-9716-073e445c6d10' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "580f7f22-179a-4ccd-9716-073e445c6d10",
        "type": "ip_addresses",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/1f916eee-7954-49eb-be58-92aca8c2891f' \
    --header 'content-type: application/json' \
```
