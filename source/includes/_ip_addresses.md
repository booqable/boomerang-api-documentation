...
```json
  ...
  "data": [
    {
      "id": "5b75fec3-91dd-45ec-a8fe-21cae711c9cf",
      "type": "ip_addresses",
      "attributes": {
        "created_at": "2023-02-27T10:15:56+00:00",
        "updated_at": "2023-02-27T10:15:56+00:00",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/ae88f840-9854-4eb0-b63d-b1c65b6dd8fc' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "ae88f840-9854-4eb0-b63d-b1c65b6dd8fc",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2023-02-27T10:15:56+00:00",
      "updated_at": "2023-02-27T10:15:56+00:00",
...
```json
  {
  "data": {
    "id": "43f97359-8716-4c3b-a6fd-3e38e165812a",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2023-02-27T10:15:57+00:00",
      "updated_at": "2023-02-27T10:15:57+00:00",
      "label": "Leeuwarden office",
      "address": "192.168.0.2"
    }
  },
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/81491c6e-2c98-4ee4-a6e5-e21213c65d6e' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "81491c6e-2c98-4ee4-a6e5-e21213c65d6e",
        "type": "ip_addresses",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/19185558-2a06-4efd-995c-82c4e666d466' \
    --header 'content-type: application/json' \
```
