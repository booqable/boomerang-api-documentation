...
```json
  ...
  "data": [
    {
      "id": "8c8bd103-efcd-4891-a7ba-4c1c614e1719",
      "type": "ip_addresses",
      "attributes": {
        "created_at": "2022-05-04T10:05:10+00:00",
        "updated_at": "2022-05-04T10:05:10+00:00",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/b3684491-0859-4d79-a18f-9ea9a956cbf6' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "b3684491-0859-4d79-a18f-9ea9a956cbf6",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2022-05-04T10:05:11+00:00",
      "updated_at": "2022-05-04T10:05:11+00:00",
      "label": "John's home office",
      "address": "192.168.0.1"
    }
  },
...
```json
  {
  "data": {
    "id": "f397bdb8-8260-471f-b63f-8fe9ff4728c2",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2022-05-04T10:05:11+00:00",
      "updated_at": "2022-05-04T10:05:11+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/881cf0f5-c7df-442c-bba6-a41be87f5e8a' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "881cf0f5-c7df-442c-bba6-a41be87f5e8a",
        "type": "ip_addresses",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/d486e846-6224-4747-be39-fbb1db02f8b8' \
    --header 'content-type: application/json' \
```
