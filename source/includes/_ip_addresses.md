...
```json
  ...
  "data": [
    {
      "id": "9133b3ef-d6a4-4c9e-8242-15fddb418d65",
      "type": "ip_addresses",
      "attributes": {
        "created_at": "2023-02-21T08:19:55+00:00",
        "updated_at": "2023-02-21T08:19:55+00:00",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/ccabd7b1-87df-4ed4-9664-c728df204921' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "ccabd7b1-87df-4ed4-9664-c728df204921",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2023-02-21T08:19:55+00:00",
      "updated_at": "2023-02-21T08:19:55+00:00",
...
```json
  {
  "data": {
    "id": "a1694ea2-cb5b-4904-8d09-a994a0a61b7d",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2023-02-21T08:19:56+00:00",
      "updated_at": "2023-02-21T08:19:56+00:00",
      "label": "Leeuwarden office",
      "address": "192.168.0.2"
    }
  },
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/9f0b7a12-4e66-4113-9f09-fa92872048e4' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "9f0b7a12-4e66-4113-9f09-fa92872048e4",
        "type": "ip_addresses",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/5350e100-01a1-4ac1-8812-cbeb07dd93b1' \
    --header 'content-type: application/json' \
```
