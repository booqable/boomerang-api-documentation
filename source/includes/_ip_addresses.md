...
```json
  ...
  "data": [
    {
      "id": "1c4b739e-17e3-4ad7-814a-375ce599dc41",
      "type": "ip_addresses",
      "attributes": {
        "created_at": "2022-11-22T17:42:41+00:00",
        "updated_at": "2022-11-22T17:42:41+00:00",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/81c7e38a-e28e-4c9c-9336-fff953114891' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "81c7e38a-e28e-4c9c-9336-fff953114891",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2022-11-22T17:42:41+00:00",
      "updated_at": "2022-11-22T17:42:41+00:00",
...
```json
  {
  "data": {
    "id": "72177bb5-841c-4709-91a1-373e626aa4ae",
    "type": "ip_addresses",
    "attributes": {
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/519f7eb4-afa6-4bda-8537-a7b55723c279' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "519f7eb4-afa6-4bda-8537-a7b55723c279",
        "type": "ip_addresses",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/9d8ebeba-9a6b-40dd-a716-a6d69025d0ae' \
    --header 'content-type: application/json' \
```
