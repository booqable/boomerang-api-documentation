...
```json
  ...
  "data": [
    {
      "id": "814e9b30-dc61-4ee5-866d-25810d5717da",
      "type": "ip_addresses",
      "attributes": {
        "created_at": "2022-05-31T06:55:41+00:00",
        "updated_at": "2022-05-31T06:55:41+00:00",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/97d514a6-339a-425d-b4d7-aa1a70f8ef54' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "97d514a6-339a-425d-b4d7-aa1a70f8ef54",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2022-05-31T06:55:41+00:00",
      "updated_at": "2022-05-31T06:55:41+00:00",
...
```json
  {
  "data": {
    "id": "ccc93318-7c1b-4117-bdd0-7a49ca5b78c7",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2022-05-31T06:55:42+00:00",
      "updated_at": "2022-05-31T06:55:42+00:00",
      "label": "Leeuwarden office",
      "address": "192.168.0.2"
    }
  },
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/d0d95f3f-8a57-4458-b966-8df29003dbe3' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "d0d95f3f-8a57-4458-b966-8df29003dbe3",
        "type": "ip_addresses",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/ad86c8b3-4855-4ec9-8f50-e9ac33e146ff' \
    --header 'content-type: application/json' \
```
