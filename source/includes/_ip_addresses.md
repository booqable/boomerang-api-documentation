...
```json
  ...
  "data": [
    {
      "id": "e350cca9-cd4b-4a78-8829-8d70fbedef92",
      "type": "ip_addresses",
      "attributes": {
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/cec9c7c6-d072-4095-af37-db5886a7e8eb' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "cec9c7c6-d072-4095-af37-db5886a7e8eb",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2023-03-10T08:38:11+00:00",
      "updated_at": "2023-03-10T08:38:11+00:00",
...
```json
  {
  "data": {
    "id": "db14df9c-bbcf-44c6-a86b-520f0f221ec9",
    "type": "ip_addresses",
    "attributes": {
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/afac3ec0-e274-47d9-b1b9-3a525618954f' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "afac3ec0-e274-47d9-b1b9-3a525618954f",
        "type": "ip_addresses",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/ae825b0f-a5a2-4a28-8e8b-c990af7fc472' \
    --header 'content-type: application/json' \
```
