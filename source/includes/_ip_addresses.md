...
```json
  ...
  "data": [
    {
      "id": "9d8127f4-9933-4a6a-ad39-c51c74f6ee4e",
      "type": "ip_addresses",
      "attributes": {
        "created_at": "2023-01-05T13:44:03+00:00",
        "updated_at": "2023-01-05T13:44:03+00:00",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/84ddbe07-da04-4fd3-8d43-9061150adceb' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "84ddbe07-da04-4fd3-8d43-9061150adceb",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2023-01-05T13:44:04+00:00",
      "updated_at": "2023-01-05T13:44:04+00:00",
      "label": "John's home office",
      "address": "192.168.0.1"
    }
  },
...
```json
  {
  "data": {
    "id": "96b9a3c6-9bfd-4035-9e5b-32613bb2fdd6",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2023-01-05T13:44:08+00:00",
      "updated_at": "2023-01-05T13:44:08+00:00",
      "label": "Leeuwarden office",
      "address": "192.168.0.2"
    }
  },
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/8d87afc9-773a-4090-8692-ef9bf8fba43e' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "8d87afc9-773a-4090-8692-ef9bf8fba43e",
        "type": "ip_addresses",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/5704d7b8-9234-48e0-9ba4-746a56a563ab' \
    --header 'content-type: application/json' \
```
