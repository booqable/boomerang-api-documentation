...
```json
  ...
  "data": [
    {
      "id": "8992e8fc-5d4b-4581-a7a0-b17badeec624",
      "type": "ip_addresses",
      "attributes": {
        "created_at": "2022-10-07T15:07:29+00:00",
        "updated_at": "2022-10-07T15:07:29+00:00",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/bf8c9b1f-82a9-4b04-8ca7-e88f6d268127' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "bf8c9b1f-82a9-4b04-8ca7-e88f6d268127",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2022-10-07T15:07:29+00:00",
      "updated_at": "2022-10-07T15:07:29+00:00",
...
```json
  {
  "data": {
    "id": "add9d20b-dd2e-438e-bcb4-ff4165410bf9",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2022-10-07T15:07:30+00:00",
      "updated_at": "2022-10-07T15:07:30+00:00",
      "label": "Leeuwarden office",
      "address": "192.168.0.2"
    }
  },
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/9b0f29bf-0ce1-4e3d-9e03-518eeb0061f9' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "9b0f29bf-0ce1-4e3d-9e03-518eeb0061f9",
        "type": "ip_addresses",
        "attributes": {
...
```json
  ...
  "data": {
    ...
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2022-10-07T15:07:31+00:00",
      "updated_at": "2022-10-07T15:07:31+00:00",
      "label": "Palo Alto office",
      "address": "192.168.0.3"
    }
  },
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/4b8d045a-cd43-4387-9254-d260946dacba' \
    --header 'content-type: application/json' \
```
