...
```json
  ...
  "data": [
    {
      "id": "7a85865d-cd9f-40c0-9a13-b7aaa469bafc",
      "type": "ip_addresses",
      "attributes": {
        "created_at": "2023-02-06T08:40:22+00:00",
        "updated_at": "2023-02-06T08:40:22+00:00",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/2cf68061-a437-4382-880f-95c477b0494a' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "2cf68061-a437-4382-880f-95c477b0494a",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2023-02-06T08:40:22+00:00",
      "updated_at": "2023-02-06T08:40:22+00:00",
...
```json
  {
  "data": {
    "id": "56ee97ad-8eef-4551-b4c0-10eba4aacdb1",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2023-02-06T08:40:22+00:00",
      "updated_at": "2023-02-06T08:40:22+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/2b62ad0b-ead6-4d7e-b2d7-0827631a7cbe' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "2b62ad0b-ead6-4d7e-b2d7-0827631a7cbe",
        "type": "ip_addresses",
        "attributes": {
...
```json
  ...
  "data": {
    ...
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2023-02-06T08:40:23+00:00",
      "updated_at": "2023-02-06T08:40:23+00:00",
      "label": "Palo Alto office",
      "address": "192.168.0.3"
    }
  },
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/778bf448-7403-4e71-98ca-49ecb5826b5c' \
    --header 'content-type: application/json' \
```
