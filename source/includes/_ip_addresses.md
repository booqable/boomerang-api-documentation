...
```json
  ...
  "data": [
    {
      "id": "cd9de3d9-84d6-4beb-9297-9ed258b0ebce",
      "type": "ip_addresses",
      "attributes": {
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/da6b5fca-09ff-4355-976b-bfe90afa5e60' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "da6b5fca-09ff-4355-976b-bfe90afa5e60",
    "type": "ip_addresses",
    "attributes": {
...
```json
  {
  "data": {
    "id": "072f297c-e3a0-4c55-933e-130858e8ab3e",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2023-02-03T11:10:28+00:00",
      "updated_at": "2023-02-03T11:10:28+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/525b2b40-ebe5-4e92-b3e2-861787b3a406' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "525b2b40-ebe5-4e92-b3e2-861787b3a406",
        "type": "ip_addresses",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/16d1ee1a-1af3-419a-b17b-840ec96fa40f' \
    --header 'content-type: application/json' \
```
