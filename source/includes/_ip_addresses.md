...
```json
  ...
  "data": [
    {
      "id": "60e35dab-5eac-4e8a-a02e-4057147fc0a9",
      "type": "ip_addresses",
      "attributes": {
        "created_at": "2023-02-06T18:58:03+00:00",
        "updated_at": "2023-02-06T18:58:03+00:00",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/3b97e9d1-27af-4bf2-8019-af8c069bac99' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "3b97e9d1-27af-4bf2-8019-af8c069bac99",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2023-02-06T18:58:03+00:00",
      "updated_at": "2023-02-06T18:58:03+00:00",
...
```json
  {
  "data": {
    "id": "1c8fbccf-5014-4dc2-b942-b7554e82de60",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2023-02-06T18:58:04+00:00",
      "updated_at": "2023-02-06T18:58:04+00:00",
      "label": "Leeuwarden office",
      "address": "192.168.0.2"
    }
  },
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/8c15f766-c29a-47da-9aa0-6e0479a55c8a' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "8c15f766-c29a-47da-9aa0-6e0479a55c8a",
        "type": "ip_addresses",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/cbe7600c-e5a0-4991-aa55-8774cb74c4e2' \
    --header 'content-type: application/json' \
```
