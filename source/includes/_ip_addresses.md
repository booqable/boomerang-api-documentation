...
```json
  ...
  "data": [
    {
      "id": "a4c72218-62ba-4493-a603-a9497c36b078",
      "type": "ip_addresses",
      "attributes": {
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/76d5df36-aff9-422d-9d4d-32779f993062' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "76d5df36-aff9-422d-9d4d-32779f993062",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2023-02-08T15:00:19+00:00",
      "updated_at": "2023-02-08T15:00:19+00:00",
...
```json
  {
  "data": {
    "id": "e1fcc22a-8261-44d9-a6e0-a32aad3225d7",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2023-02-08T15:00:19+00:00",
      "updated_at": "2023-02-08T15:00:19+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/548e359e-cecd-411f-a2ed-904e33a8e9b9' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "548e359e-cecd-411f-a2ed-904e33a8e9b9",
        "type": "ip_addresses",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/1d179c64-2e2a-47b6-a817-3f19ecdb46aa' \
    --header 'content-type: application/json' \
```
