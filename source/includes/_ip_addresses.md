...
```json
  ...
  "data": [
    {
      "id": "555e0faf-1d50-447a-b7f4-1e594c56afa7",
      "type": "ip_addresses",
      "attributes": {
        "created_at": "2022-11-22T15:33:13+00:00",
        "updated_at": "2022-11-22T15:33:13+00:00",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/f914be21-d6be-4892-9625-d04183552636' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "f914be21-d6be-4892-9625-d04183552636",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2022-11-22T15:33:13+00:00",
      "updated_at": "2022-11-22T15:33:13+00:00",
...
```json
  {
  "data": {
    "id": "f18c0fe7-e61d-475b-b596-3bfed4a5e275",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2022-11-22T15:33:14+00:00",
      "updated_at": "2022-11-22T15:33:14+00:00",
      "label": "Leeuwarden office",
      "address": "192.168.0.2"
    }
  },
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/f97d8ef2-4727-4520-a930-4a26e6d71d72' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "f97d8ef2-4727-4520-a930-4a26e6d71d72",
        "type": "ip_addresses",
        "attributes": {
...
```json
  ...
  "data": {
    ...
    "attributes": {
      "created_at": "2022-11-22T15:33:14+00:00",
      "updated_at": "2022-11-22T15:33:15+00:00",
      "label": "Palo Alto office",
      "address": "192.168.0.3"
    }
  },
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/2eec75e4-3924-4434-bbd2-951f1f469d07' \
    --header 'content-type: application/json' \
```
