...
```json
  ...
  "data": [
    {
      "id": "20553b69-4b0f-45e0-a4ee-8ddf5885627f",
      "type": "ip_addresses",
      "attributes": {
        "created_at": "2023-02-01T13:19:25+00:00",
        "updated_at": "2023-02-01T13:19:25+00:00",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/5154ef13-bd4c-44a9-89d4-bfa8ce66d83b' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "5154ef13-bd4c-44a9-89d4-bfa8ce66d83b",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2023-02-01T13:19:26+00:00",
      "updated_at": "2023-02-01T13:19:26+00:00",
      "label": "John's home office",
      "address": "192.168.0.1"
    }
  },
...
```json
  {
  "data": {
    "id": "b5467601-b662-4545-860a-3fbb63b07845",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2023-02-01T13:19:26+00:00",
      "updated_at": "2023-02-01T13:19:26+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/880e8cf3-596c-436d-beeb-998e225ad7dc' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "880e8cf3-596c-436d-beeb-998e225ad7dc",
        "type": "ip_addresses",
        "attributes": {
...
```json
  ...
  "data": {
    ...
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2023-02-01T13:19:27+00:00",
      "updated_at": "2023-02-01T13:19:27+00:00",
      "label": "Palo Alto office",
      "address": "192.168.0.3"
    }
  },
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/c79fff3f-a084-4c42-b34e-05e9957b8ddb' \
    --header 'content-type: application/json' \
```
