...
```json
  ...
  "data": [
    {
      "id": "08fb7e76-103a-42e0-a550-7563f99e9ff9",
      "type": "ip_addresses",
      "attributes": {
        "created_at": "2023-02-02T08:02:16+00:00",
        "updated_at": "2023-02-02T08:02:16+00:00",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/e0dddb4e-6943-4af4-a9f7-2e8ce7366cc7' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "e0dddb4e-6943-4af4-a9f7-2e8ce7366cc7",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2023-02-02T08:02:18+00:00",
      "updated_at": "2023-02-02T08:02:18+00:00",
      "label": "John's home office",
      "address": "192.168.0.1"
    }
  },
...
```json
  {
  "data": {
    "id": "e4c3df4b-e30c-47a1-9447-fc18271b5322",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2023-02-02T08:02:20+00:00",
      "updated_at": "2023-02-02T08:02:20+00:00",
      "label": "Leeuwarden office",
      "address": "192.168.0.2"
    }
  },
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/82de1e69-92d5-4f11-86b6-e330bd6d0a94' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "82de1e69-92d5-4f11-86b6-e330bd6d0a94",
        "type": "ip_addresses",
        "attributes": {
...
```json
  ...
  "data": {
    ...
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2023-02-02T08:02:21+00:00",
      "updated_at": "2023-02-02T08:02:21+00:00",
      "label": "Palo Alto office",
      "address": "192.168.0.3"
    }
  },
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/3b99a2b1-6220-4266-97e5-29d93319e278' \
    --header 'content-type: application/json' \
```
