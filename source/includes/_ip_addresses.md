...
```json
  ...
  "data": [
    {
      "id": "7fa4b988-48b3-4858-9a79-e6318be3ea2e",
      "type": "ip_addresses",
      "attributes": {
        "created_at": "2022-05-31T08:26:21+00:00",
        "updated_at": "2022-05-31T08:26:21+00:00",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/ae820a27-a422-4d83-8a0e-3c9f6b0cd9b8' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "ae820a27-a422-4d83-8a0e-3c9f6b0cd9b8",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2022-05-31T08:26:22+00:00",
      "updated_at": "2022-05-31T08:26:22+00:00",
      "label": "John's home office",
      "address": "192.168.0.1"
    }
  },
...
```json
  {
  "data": {
    "id": "4e4d3a6c-0d0f-401b-9833-791f5bde65d3",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2022-05-31T08:26:22+00:00",
      "updated_at": "2022-05-31T08:26:22+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/5719081c-2e14-4e3f-9a40-479b1d7f94e8' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "5719081c-2e14-4e3f-9a40-479b1d7f94e8",
        "type": "ip_addresses",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/9e4e13c2-93d3-4cbf-8622-096faa7ec2bf' \
    --header 'content-type: application/json' \
```
