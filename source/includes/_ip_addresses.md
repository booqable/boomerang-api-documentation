...
```json
  ...
  "data": [
    {
      "id": "74a1690e-6efe-4e3e-8757-317e6df075b0",
      "type": "ip_addresses",
      "attributes": {
        "created_at": "2022-07-13T08:18:30+00:00",
        "updated_at": "2022-07-13T08:18:30+00:00",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/a09ed4ac-aed3-4f8e-838f-702d962e2215' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "a09ed4ac-aed3-4f8e-838f-702d962e2215",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2022-07-13T08:18:30+00:00",
      "updated_at": "2022-07-13T08:18:30+00:00",
...
```json
  {
  "data": {
    "id": "51583262-8593-460d-94f5-8f67b87bdfb3",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2022-07-13T08:18:30+00:00",
      "updated_at": "2022-07-13T08:18:30+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/2a6ba820-f06b-40c5-9002-2f1e6ee97e07' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "2a6ba820-f06b-40c5-9002-2f1e6ee97e07",
        "type": "ip_addresses",
        "attributes": {
...
```json
  ...
  "data": {
    ...
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2022-07-13T08:18:31+00:00",
      "updated_at": "2022-07-13T08:18:31+00:00",
      "label": "Palo Alto office",
      "address": "192.168.0.3"
    }
  },
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/a83aa8b2-c01f-4242-9de1-397e090494c7' \
    --header 'content-type: application/json' \
```
