...
```json
  ...
  "data": [
    {
      "id": "ece08927-97b2-4259-bb4f-faede8ecb113",
      "type": "ip_addresses",
      "attributes": {
        "created_at": "2022-05-24T07:20:01+00:00",
        "updated_at": "2022-05-24T07:20:01+00:00",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/40abd240-e145-4072-be24-878dcd3baf9b' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "40abd240-e145-4072-be24-878dcd3baf9b",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2022-05-24T07:20:01+00:00",
      "updated_at": "2022-05-24T07:20:01+00:00",
...
```json
  {
  "data": {
    "id": "99ad2055-6f68-48e1-a629-d1e62e45e88b",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2022-05-24T07:20:01+00:00",
      "updated_at": "2022-05-24T07:20:01+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/8feefb77-9fa4-455c-830c-9b8e5e17318f' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "8feefb77-9fa4-455c-830c-9b8e5e17318f",
        "type": "ip_addresses",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/c89479e2-c36d-4a1d-9952-863ae567c72a' \
    --header 'content-type: application/json' \
```
