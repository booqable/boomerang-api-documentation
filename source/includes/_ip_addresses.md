...
```json
  ...
  "data": [
    {
      "id": "8c5a6295-1d33-4d5d-886e-2defcf069021",
      "type": "ip_addresses",
      "attributes": {
        "created_at": "2023-01-05T09:56:04+00:00",
        "updated_at": "2023-01-05T09:56:04+00:00",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/0b64de2f-0db6-488c-a8a6-8e247f86ddc4' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "0b64de2f-0db6-488c-a8a6-8e247f86ddc4",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2023-01-05T09:56:04+00:00",
      "updated_at": "2023-01-05T09:56:04+00:00",
...
```json
  {
  "data": {
    "id": "82715c3a-8683-47a3-bd3c-171ae31f1377",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2023-01-05T09:56:05+00:00",
      "updated_at": "2023-01-05T09:56:05+00:00",
      "label": "Leeuwarden office",
      "address": "192.168.0.2"
    }
  },
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/5f13e2ba-645d-404d-ad2e-1b097d82d413' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "5f13e2ba-645d-404d-ad2e-1b097d82d413",
        "type": "ip_addresses",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/c38fb081-199a-4a2b-ab5b-6d554928fd44' \
    --header 'content-type: application/json' \
```
