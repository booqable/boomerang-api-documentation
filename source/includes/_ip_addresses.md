...
```json
  ...
  "data": [
    {
      "id": "34c5f331-a72d-4304-a948-3c321313229a",
      "type": "ip_addresses",
      "attributes": {
        "created_at": "2023-02-16T15:49:07+00:00",
        "updated_at": "2023-02-16T15:49:07+00:00",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/9b5dce60-330a-41b6-8da8-940df6b27a2a' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "9b5dce60-330a-41b6-8da8-940df6b27a2a",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2023-02-16T15:49:07+00:00",
      "updated_at": "2023-02-16T15:49:07+00:00",
...
```json
  {
  "data": {
    "id": "8ae5d18d-f68b-4a35-a1f2-cac8d8c657e2",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2023-02-16T15:49:08+00:00",
      "updated_at": "2023-02-16T15:49:08+00:00",
      "label": "Leeuwarden office",
      "address": "192.168.0.2"
    }
  },
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/ce3e2f26-d51a-4c26-b827-5ea09ac631f6' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "ce3e2f26-d51a-4c26-b827-5ea09ac631f6",
        "type": "ip_addresses",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/507bba83-4722-4ac2-af6b-b2af51632b20' \
    --header 'content-type: application/json' \
```
