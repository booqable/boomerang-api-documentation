...
```json
  ...
  "data": [
    {
      "id": "4b8aaa82-9a38-4fe3-bc47-ec6152f93e04",
      "type": "ip_addresses",
      "attributes": {
        "created_at": "2022-04-07T10:05:09+00:00",
        "updated_at": "2022-04-07T10:05:09+00:00",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/d7b795ba-3384-4f0d-a296-595301710f66' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "d7b795ba-3384-4f0d-a296-595301710f66",
    "type": "ip_addresses",
    "attributes": {
...
```json
  {
  "data": {
    "id": "8778bb9b-a192-4320-8b80-32ce57d7c61b",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2022-04-07T10:05:10+00:00",
      "updated_at": "2022-04-07T10:05:10+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/6d649101-6dd9-41c7-99ca-b3da6a398454' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "6d649101-6dd9-41c7-99ca-b3da6a398454",
        "type": "ip_addresses",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/80d8f994-1162-4b10-9e3b-4f4277d3b1f7' \
    --header 'content-type: application/json' \
```
