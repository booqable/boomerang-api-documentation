...
```json
  ...
  "data": [
    {
      "id": "ce6f2d30-59dd-45a5-937c-b6052682c058",
      "type": "ip_addresses",
      "attributes": {
        "created_at": "2023-02-02T16:29:41+00:00",
        "updated_at": "2023-02-02T16:29:41+00:00",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/91d39383-c29f-445a-8779-dc9754be160c' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "91d39383-c29f-445a-8779-dc9754be160c",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2023-02-02T16:29:42+00:00",
      "updated_at": "2023-02-02T16:29:42+00:00",
      "label": "John's home office",
      "address": "192.168.0.1"
    }
  },
...
```json
  {
  "data": {
    "id": "18daac14-d085-404f-86aa-ccf55c3c27bf",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2023-02-02T16:29:42+00:00",
      "updated_at": "2023-02-02T16:29:42+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/50c4db00-4c14-4e90-8d66-9bf4dd2adf5e' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "50c4db00-4c14-4e90-8d66-9bf4dd2adf5e",
        "type": "ip_addresses",
        "attributes": {
...
```json
  ...
  "data": {
    ...
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2023-02-02T16:29:43+00:00",
      "updated_at": "2023-02-02T16:29:43+00:00",
      "label": "Palo Alto office",
      "address": "192.168.0.3"
    }
  },
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/fa9f04c2-33d3-46ed-b7f3-c69b012fcaa3' \
    --header 'content-type: application/json' \
```
