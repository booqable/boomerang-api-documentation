...
```json
  ...
  "data": [
    {
      "id": "02779b5b-81bb-4ab1-81cd-a97afbc69c45",
      "type": "ip_addresses",
      "attributes": {
        "created_at": "2022-11-15T08:05:31+00:00",
        "updated_at": "2022-11-15T08:05:31+00:00",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/3d2939de-542d-43c9-b866-390acbf4396f' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "3d2939de-542d-43c9-b866-390acbf4396f",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2022-11-15T08:05:31+00:00",
      "updated_at": "2022-11-15T08:05:31+00:00",
...
```json
  {
  "data": {
    "id": "0d4d4485-8841-45a1-bd9b-d807e9cdea3a",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2022-11-15T08:05:31+00:00",
      "updated_at": "2022-11-15T08:05:31+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/c91070b3-5b14-45e1-a4bb-fb27cafe02ef' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "c91070b3-5b14-45e1-a4bb-fb27cafe02ef",
        "type": "ip_addresses",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/4c67e67b-8d07-434b-ab61-54547edaacbd' \
    --header 'content-type: application/json' \
```
