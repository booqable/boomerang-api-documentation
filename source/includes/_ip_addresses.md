...
```json
  ...
  "data": [
    {
      "id": "c01c4d0e-69dc-41dd-9787-7b9f095ca073",
      "type": "ip_addresses",
      "attributes": {
        "created_at": "2022-12-19T08:47:03+00:00",
        "updated_at": "2022-12-19T08:47:03+00:00",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/b37d4a59-4562-4613-a2e1-b6249d766573' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "b37d4a59-4562-4613-a2e1-b6249d766573",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2022-12-19T08:47:03+00:00",
      "updated_at": "2022-12-19T08:47:03+00:00",
...
```json
  {
  "data": {
    "id": "c4bc24df-8ca2-4a74-87ec-1d9ce1fb04b8",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2022-12-19T08:47:03+00:00",
      "updated_at": "2022-12-19T08:47:03+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/31f3ac4d-07a2-40fa-9d3d-14fb022893e7' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "31f3ac4d-07a2-40fa-9d3d-14fb022893e7",
        "type": "ip_addresses",
        "attributes": {
...
```json
  ...
  "data": {
    ...
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2022-12-19T08:47:04+00:00",
      "updated_at": "2022-12-19T08:47:04+00:00",
      "label": "Palo Alto office",
      "address": "192.168.0.3"
    }
  },
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/16504a32-27e6-4042-a5b0-b87cb7878e26' \
    --header 'content-type: application/json' \
```
