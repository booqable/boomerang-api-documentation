...
```json
  ...
  "data": [
    {
      "id": "522dc39c-9268-467e-9e99-d0172a29359b",
      "type": "ip_addresses",
      "attributes": {
        "created_at": "2022-06-30T09:45:18+00:00",
        "updated_at": "2022-06-30T09:45:18+00:00",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/b68e83d6-d24b-4670-a173-d55507ccea1e' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "b68e83d6-d24b-4670-a173-d55507ccea1e",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2022-06-30T09:45:18+00:00",
      "updated_at": "2022-06-30T09:45:18+00:00",
...
```json
  {
  "data": {
    "id": "33b48a9c-93ae-40ad-b3ea-d91d9456d9e4",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2022-06-30T09:45:19+00:00",
      "updated_at": "2022-06-30T09:45:19+00:00",
      "label": "Leeuwarden office",
      "address": "192.168.0.2"
    }
  },
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/a1db6793-fa78-4e2b-a638-884bc90e6a1a' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "a1db6793-fa78-4e2b-a638-884bc90e6a1a",
        "type": "ip_addresses",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/b3127c08-e4cc-46c1-8e2b-382433673417' \
    --header 'content-type: application/json' \
```
