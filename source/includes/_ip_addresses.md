...
```json
  ...
  "data": [
    {
      "id": "5c0a13bc-090f-4325-ac77-11f4cc6cf013",
      "type": "ip_addresses",
      "attributes": {
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/0e8accaa-9023-43b0-b73b-fefc049e5da2' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "0e8accaa-9023-43b0-b73b-fefc049e5da2",
    "type": "ip_addresses",
    "attributes": {
...
```json
  {
  "data": {
    "id": "48a19dac-51fb-4460-ae94-692c38f71acf",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2023-03-10T08:37:39+00:00",
      "updated_at": "2023-03-10T08:37:39+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/24786d9f-4490-4633-b6c8-ad62b1220586' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "24786d9f-4490-4633-b6c8-ad62b1220586",
        "type": "ip_addresses",
        "attributes": {
...
```json
  ...
  "data": {
    ...
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2023-03-10T08:37:41+00:00",
      "updated_at": "2023-03-10T08:37:41+00:00",
      "label": "Palo Alto office",
      "address": "192.168.0.3"
    }
  },
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/4aa097b5-bf87-4205-b7eb-8e920937b7cf' \
    --header 'content-type: application/json' \
```
