...
```json
  ...
  "data": [
    {
      "id": "1844147e-8947-4416-a3ad-eceaf0a39b95",
      "type": "ip_addresses",
      "attributes": {
        "created_at": "2022-11-22T14:33:40+00:00",
        "updated_at": "2022-11-22T14:33:40+00:00",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/7539cc35-70d0-4061-9ecf-0bc0a0a15f1f' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "7539cc35-70d0-4061-9ecf-0bc0a0a15f1f",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2022-11-22T14:33:40+00:00",
      "updated_at": "2022-11-22T14:33:40+00:00",
...
```json
  {
  "data": {
    "id": "ec0b6e5e-5efe-4b53-b15c-d896e4177577",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2022-11-22T14:33:41+00:00",
      "updated_at": "2022-11-22T14:33:41+00:00",
      "label": "Leeuwarden office",
      "address": "192.168.0.2"
    }
  },
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/69e467af-c8c5-46df-8872-9257ef43f0d6' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "69e467af-c8c5-46df-8872-9257ef43f0d6",
        "type": "ip_addresses",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/b182bde8-d2f7-4bda-a55d-ca8f655335f7' \
    --header 'content-type: application/json' \
```
