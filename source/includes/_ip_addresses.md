...
```json
  ...
  "data": [
    {
      "id": "681883f6-03b7-427a-ac1b-997c24ce217f",
      "type": "ip_addresses",
      "attributes": {
        "created_at": "2022-06-08T14:25:28+00:00",
        "updated_at": "2022-06-08T14:25:28+00:00",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/5f900ce7-853b-48ae-be98-8b490f46321f' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "5f900ce7-853b-48ae-be98-8b490f46321f",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2022-06-08T14:25:28+00:00",
      "updated_at": "2022-06-08T14:25:28+00:00",
...
```json
  {
  "data": {
    "id": "e306ef58-16f1-48b7-ab8d-5e584ce279d2",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2022-06-08T14:25:28+00:00",
      "updated_at": "2022-06-08T14:25:28+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/082f73e3-dc9a-4d52-b876-5e2eaa9fcc5f' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "082f73e3-dc9a-4d52-b876-5e2eaa9fcc5f",
        "type": "ip_addresses",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/2974770c-ed70-4575-9d6d-80df774a9724' \
    --header 'content-type: application/json' \
```
