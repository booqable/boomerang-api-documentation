...
```json
  ...
  "data": [
    {
      "id": "3afd88c4-2096-4ae9-98b1-da7ee873bf76",
      "type": "ip_addresses",
      "attributes": {
        "created_at": "2023-02-14T11:05:03+00:00",
        "updated_at": "2023-02-14T11:05:03+00:00",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/f5a01509-c52a-4628-b5b9-b168a08622d8' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "f5a01509-c52a-4628-b5b9-b168a08622d8",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2023-02-14T11:05:03+00:00",
      "updated_at": "2023-02-14T11:05:03+00:00",
...
```json
  {
  "data": {
    "id": "c3b952fd-771c-4a8d-bbd2-c53da05106f2",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2023-02-14T11:05:03+00:00",
      "updated_at": "2023-02-14T11:05:03+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/642a9047-a183-4fc7-8158-712507cb5144' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "642a9047-a183-4fc7-8158-712507cb5144",
        "type": "ip_addresses",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/b6c288a6-b45f-4666-ba3d-40c483218589' \
    --header 'content-type: application/json' \
```
