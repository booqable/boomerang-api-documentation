...
```json
  ...
  "data": [
    {
      "id": "e733f165-a255-4ce0-ae23-e1464578ce4f",
      "type": "ip_addresses",
      "attributes": {
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/fd3f1049-b465-46a7-8339-ffeda13eba8d' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "fd3f1049-b465-46a7-8339-ffeda13eba8d",
    "type": "ip_addresses",
    "attributes": {
      "label": "John's home office",
      "address": "192.168.0.1"
...
```json
  {
  "data": {
    "id": "38c45b44-c66f-473c-8fac-f12957a84ae0",
    "type": "ip_addresses",
    "attributes": {
      "label": "Leeuwarden office",
      "address": "192.168.0.2"
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/ae8e76ce-51f4-41fa-bc56-408c42e2bbe9' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "ae8e76ce-51f4-41fa-bc56-408c42e2bbe9",
        "type": "ip_addresses",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/befdf3ca-b05a-40af-bbd9-233af636320b' \
    --header 'content-type: application/json' \
```
