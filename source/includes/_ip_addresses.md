...
```json
  ...
  "data": [
    {
      "id": "7a3ae6af-0c57-4381-a917-f265cd5e9f9f",
      "type": "ip_addresses",
      "attributes": {
        "created_at": "2023-03-08T09:41:19+00:00",
        "updated_at": "2023-03-08T09:41:19+00:00",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/be40c51b-0b2c-4270-ae5c-d2589abb01d4' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "be40c51b-0b2c-4270-ae5c-d2589abb01d4",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2023-03-08T09:41:20+00:00",
      "updated_at": "2023-03-08T09:41:20+00:00",
      "label": "John's home office",
      "address": "192.168.0.1"
    }
  },
...
```json
  {
  "data": {
    "id": "cb9ff38e-3a9e-4716-929b-6a841a7cd4e3",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2023-03-08T09:41:20+00:00",
      "updated_at": "2023-03-08T09:41:20+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/1038acb4-8d4a-4b46-9f1a-51d6a45ed245' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "1038acb4-8d4a-4b46-9f1a-51d6a45ed245",
        "type": "ip_addresses",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/0c57aeeb-c149-4fc2-8ee6-607b71703d24' \
    --header 'content-type: application/json' \
```
