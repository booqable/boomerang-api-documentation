...
```json
  ...
  "data": [
    {
      "id": "47ac9276-5449-4712-978a-6a6023b95238",
      "type": "ip_addresses",
      "attributes": {
        "created_at": "2023-02-09T11:03:00+00:00",
        "updated_at": "2023-02-09T11:03:00+00:00",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/18b94996-dc20-4ef0-befb-4048716cf65b' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "18b94996-dc20-4ef0-befb-4048716cf65b",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2023-02-09T11:03:00+00:00",
      "updated_at": "2023-02-09T11:03:00+00:00",
...
```json
  {
  "data": {
    "id": "ec009bfb-f5b4-4b8a-9a59-be1c1f1a7c9e",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2023-02-09T11:03:01+00:00",
      "updated_at": "2023-02-09T11:03:01+00:00",
      "label": "Leeuwarden office",
      "address": "192.168.0.2"
    }
  },
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/9ce8d802-8608-4e62-8765-e22b8e2bb6b5' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "9ce8d802-8608-4e62-8765-e22b8e2bb6b5",
        "type": "ip_addresses",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/713c0659-8c0b-4fe1-a881-9bd98dbfdc06' \
    --header 'content-type: application/json' \
```
