...
```json
  ...
  "data": [
    {
      "id": "f1a4ffe1-ea70-4e74-be3b-d08053ec3f3b",
      "type": "ip_addresses",
      "attributes": {
        "created_at": "2023-01-26T10:20:35+00:00",
        "updated_at": "2023-01-26T10:20:35+00:00",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/bb160e45-1eee-4114-99a2-c75dfa195229' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "bb160e45-1eee-4114-99a2-c75dfa195229",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2023-01-26T10:20:35+00:00",
      "updated_at": "2023-01-26T10:20:35+00:00",
...
```json
  {
  "data": {
    "id": "59567b85-665c-4f3f-ae56-1e8313d83735",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2023-01-26T10:20:36+00:00",
      "updated_at": "2023-01-26T10:20:36+00:00",
      "label": "Leeuwarden office",
      "address": "192.168.0.2"
    }
  },
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/f85e5024-a231-470c-a21c-b013a001c195' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "f85e5024-a231-470c-a21c-b013a001c195",
        "type": "ip_addresses",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/6e503d02-adb5-4e14-a9f5-57528789bc29' \
    --header 'content-type: application/json' \
```
