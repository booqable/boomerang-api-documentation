...
```json
  ...
  "data": [
    {
      "id": "c191165a-715c-4b9d-b9d4-525d92ed5d7b",
      "type": "ip_addresses",
      "attributes": {
        "created_at": "2022-05-05T09:13:31+00:00",
        "updated_at": "2022-05-05T09:13:31+00:00",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/8c60d2f3-a0f3-405b-b831-6e4608a45e7c' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "8c60d2f3-a0f3-405b-b831-6e4608a45e7c",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2022-05-05T09:13:31+00:00",
      "updated_at": "2022-05-05T09:13:31+00:00",
...
```json
  {
  "data": {
    "id": "fafbd969-e7a6-434a-b606-c6e2364a5e9c",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2022-05-05T09:13:31+00:00",
      "updated_at": "2022-05-05T09:13:31+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/074aa7e5-8a6b-4c5f-bc11-9e5b3f8f0d99' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "074aa7e5-8a6b-4c5f-bc11-9e5b3f8f0d99",
        "type": "ip_addresses",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/fedd72fb-75f3-4b35-ad99-6841419bb106' \
    --header 'content-type: application/json' \
```
