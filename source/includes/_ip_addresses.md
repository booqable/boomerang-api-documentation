...
```json
  ...
  "data": [
    {
      "id": "a2a6bb1e-feda-4e2c-aa57-07fed8a69282",
      "type": "ip_addresses",
      "attributes": {
        "created_at": "2022-10-07T12:08:42+00:00",
        "updated_at": "2022-10-07T12:08:42+00:00",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/0fac6cc8-cd12-477c-bbfc-ad477d30d18d' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "0fac6cc8-cd12-477c-bbfc-ad477d30d18d",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2022-10-07T12:08:42+00:00",
      "updated_at": "2022-10-07T12:08:42+00:00",
...
```json
  {
  "data": {
    "id": "559809c6-1b14-40f0-8b43-c03016834074",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2022-10-07T12:08:43+00:00",
      "updated_at": "2022-10-07T12:08:43+00:00",
      "label": "Leeuwarden office",
      "address": "192.168.0.2"
    }
  },
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/33ad4a29-80c1-4a86-8ddf-84f55b98b69f' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "33ad4a29-80c1-4a86-8ddf-84f55b98b69f",
        "type": "ip_addresses",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/ff78321e-9eb5-4711-89d1-9aaf02068af5' \
    --header 'content-type: application/json' \
```
