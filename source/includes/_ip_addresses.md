...
```json
  ...
  "data": [
    {
      "id": "a5d179cf-7ca1-4a04-9ea0-7ac61820a4b2",
      "type": "ip_addresses",
      "attributes": {
        "created_at": "2022-07-19T12:36:23+00:00",
        "updated_at": "2022-07-19T12:36:23+00:00",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/e07ef9c4-be6f-4c77-8380-cdca93c3662c' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "e07ef9c4-be6f-4c77-8380-cdca93c3662c",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2022-07-19T12:36:23+00:00",
      "updated_at": "2022-07-19T12:36:23+00:00",
...
```json
  {
  "data": {
    "id": "b2e4a343-86f3-4c77-b6be-a48b9b88f6b1",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2022-07-19T12:36:24+00:00",
      "updated_at": "2022-07-19T12:36:24+00:00",
      "label": "Leeuwarden office",
      "address": "192.168.0.2"
    }
  },
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/32f90603-90ac-4dcb-b14e-3837dd5cb4a6' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "32f90603-90ac-4dcb-b14e-3837dd5cb4a6",
        "type": "ip_addresses",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/2423d0fd-7f23-4408-a021-9233c54388a4' \
    --header 'content-type: application/json' \
```
