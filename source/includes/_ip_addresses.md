...
```json
  ...
  "data": [
    {
      "id": "dbbeea79-a2ec-4f36-a008-dbc9fbffb371",
      "type": "ip_addresses",
      "attributes": {
        "created_at": "2023-02-07T15:00:45+00:00",
        "updated_at": "2023-02-07T15:00:45+00:00",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/3fdab03a-6325-4998-a425-c36fc09a4d66' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "3fdab03a-6325-4998-a425-c36fc09a4d66",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2023-02-07T15:00:45+00:00",
      "updated_at": "2023-02-07T15:00:45+00:00",
...
```json
  {
  "data": {
    "id": "96b21ef4-ce7d-48a6-aa31-caae6c6be63d",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2023-02-07T15:00:46+00:00",
      "updated_at": "2023-02-07T15:00:46+00:00",
      "label": "Leeuwarden office",
      "address": "192.168.0.2"
    }
  },
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/eb40945a-bd26-4fc6-87e6-03cdf5d03c50' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "eb40945a-bd26-4fc6-87e6-03cdf5d03c50",
        "type": "ip_addresses",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/5a1862f0-c624-407c-8b0b-99aef9adc536' \
    --header 'content-type: application/json' \
```
