...
```json
  ...
  "data": [
    {
      "id": "7596f42f-0990-401f-a873-8a09f69ad4b1",
      "type": "ip_addresses",
      "attributes": {
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/6456e747-ce3b-4d38-a4b3-de1341cb98cd' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "6456e747-ce3b-4d38-a4b3-de1341cb98cd",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2023-02-24T14:56:40+00:00",
      "updated_at": "2023-02-24T14:56:40+00:00",
...
```json
  {
  "data": {
    "id": "7d974677-7314-476f-9621-f62b57d0f8b3",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2023-02-24T14:56:40+00:00",
      "updated_at": "2023-02-24T14:56:40+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/c11145f7-73e5-4d05-9470-c0f8177e70b7' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "c11145f7-73e5-4d05-9470-c0f8177e70b7",
        "type": "ip_addresses",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/2f8f9b78-fd58-4c2c-9ffb-16e9b34bf1b3' \
    --header 'content-type: application/json' \
```
