...
```json
  ...
  "data": [
    {
      "id": "3b984835-9783-46af-942b-9f3a6af4262b",
      "type": "ip_addresses",
      "attributes": {
        "created_at": "2023-01-25T12:35:31+00:00",
        "updated_at": "2023-01-25T12:35:31+00:00",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/9c4e9a70-e7f0-4caf-a2c5-381386acd9e9' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "9c4e9a70-e7f0-4caf-a2c5-381386acd9e9",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2023-01-25T12:35:31+00:00",
      "updated_at": "2023-01-25T12:35:31+00:00",
...
```json
  {
  "data": {
    "id": "50b472e8-d03f-414e-88e0-50cdd974548f",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2023-01-25T12:35:31+00:00",
      "updated_at": "2023-01-25T12:35:31+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/8bbafe6a-f2e8-4a91-93a5-34c014580086' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "8bbafe6a-f2e8-4a91-93a5-34c014580086",
        "type": "ip_addresses",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/e47a39da-acc5-4b7f-aba2-13fef80fef6c' \
    --header 'content-type: application/json' \
```
