...
```json
  ...
  "data": [
    {
      "id": "c64a2cbb-7a90-4bb1-abf9-1d60da16f744",
      "type": "ip_addresses",
      "attributes": {
        "created_at": "2021-12-02T23:49:12+00:00",
        "updated_at": "2021-12-02T23:49:12+00:00",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/5687d1d7-e661-42fc-976f-e55c8dde0eed' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "5687d1d7-e661-42fc-976f-e55c8dde0eed",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2021-12-02T23:49:12+00:00",
      "updated_at": "2021-12-02T23:49:12+00:00",
...
```json
  {
  "data": {
    "id": "89a8654a-f51e-4e4e-8e2b-505d3aadf7bc",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2021-12-02T23:49:12+00:00",
      "updated_at": "2021-12-02T23:49:12+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/bdc4e6cb-52cd-474e-aecb-4414703890f3' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "bdc4e6cb-52cd-474e-aecb-4414703890f3",
        "type": "ip_addresses",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/56a90c52-519a-4010-ac64-0d0dcd9cae90' \
    --header 'content-type: application/json' \
```
