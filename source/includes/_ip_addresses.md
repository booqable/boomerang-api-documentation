...
```json
  ...
  "data": [
    {
      "id": "d24af2a7-d4c2-445d-bf70-6eac7952a915",
      "type": "ip_addresses",
      "attributes": {
        "created_at": "2023-01-18T13:35:49+00:00",
        "updated_at": "2023-01-18T13:35:49+00:00",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/6e3f6883-94c1-474b-8541-b327466e9f28' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "6e3f6883-94c1-474b-8541-b327466e9f28",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2023-01-18T13:35:49+00:00",
      "updated_at": "2023-01-18T13:35:49+00:00",
...
```json
  {
  "data": {
    "id": "cae8aaa4-e901-43f7-9316-ce8c1e345e5d",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2023-01-18T13:35:49+00:00",
      "updated_at": "2023-01-18T13:35:49+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/2d328a06-92c7-4ab0-b800-95b7334cfc98' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "2d328a06-92c7-4ab0-b800-95b7334cfc98",
        "type": "ip_addresses",
        "attributes": {
...
```json
  ...
  "data": {
    ...
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2023-01-18T13:35:50+00:00",
      "updated_at": "2023-01-18T13:35:50+00:00",
      "label": "Palo Alto office",
      "address": "192.168.0.3"
    }
  },
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/95831ac9-d4e0-400c-83d4-79c022ba89eb' \
    --header 'content-type: application/json' \
```
