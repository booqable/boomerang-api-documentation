...
```json
  ...
  "data": [
    {
      "id": "14077f3b-6ef1-4d9d-8cd5-8c1f00650099",
      "type": "ip_addresses",
      "attributes": {
        "created_at": "2022-11-22T16:47:29+00:00",
        "updated_at": "2022-11-22T16:47:29+00:00",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/f95a2386-c8a6-4104-83a6-be61a394965e' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "f95a2386-c8a6-4104-83a6-be61a394965e",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2022-11-22T16:47:29+00:00",
      "updated_at": "2022-11-22T16:47:29+00:00",
...
```json
  {
  "data": {
    "id": "2a58f050-2fd5-4b1a-b8e1-590497930031",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2022-11-22T16:47:30+00:00",
      "updated_at": "2022-11-22T16:47:30+00:00",
      "label": "Leeuwarden office",
      "address": "192.168.0.2"
    }
  },
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/6da68c29-b027-4a52-898e-c2775b504013' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "6da68c29-b027-4a52-898e-c2775b504013",
        "type": "ip_addresses",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/8803eb99-eb53-4b80-86ea-acab133b4723' \
    --header 'content-type: application/json' \
```
