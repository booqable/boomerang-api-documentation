...
```json
  ...
  "data": [
    {
      "id": "58222ab9-2709-4f38-8e9c-e5fd0d20b1f6",
      "type": "ip_addresses",
      "attributes": {
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/6ba6c0a2-2ea3-4e6a-9d70-4ae7ae184173' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "6ba6c0a2-2ea3-4e6a-9d70-4ae7ae184173",
    "type": "ip_addresses",
    "attributes": {
...
```json
  {
  "data": {
    "id": "1a741670-a0cf-4db4-877f-e38a5df7ae9f",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2022-01-12T10:55:39+00:00",
      "updated_at": "2022-01-12T10:55:39+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/0ea5d496-4072-4b83-9f2c-de5ec875718e' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "0ea5d496-4072-4b83-9f2c-de5ec875718e",
        "type": "ip_addresses",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/b42015da-c243-4391-b981-113e2b2ef989' \
    --header 'content-type: application/json' \
```
