...
```json
  ...
  "data": [
    {
      "id": "ac63f150-9cf4-4eab-9ce0-9301173b106b",
      "type": "ip_addresses",
      "attributes": {
        "created_at": "2022-07-13T11:50:36+00:00",
        "updated_at": "2022-07-13T11:50:36+00:00",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/42f69a9a-7540-4d88-a00c-55b5e99d1709' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "42f69a9a-7540-4d88-a00c-55b5e99d1709",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2022-07-13T11:50:36+00:00",
      "updated_at": "2022-07-13T11:50:36+00:00",
...
```json
  {
  "data": {
    "id": "bf67622f-ccab-43e3-a2fe-6b0438e2e678",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2022-07-13T11:50:37+00:00",
      "updated_at": "2022-07-13T11:50:37+00:00",
      "label": "Leeuwarden office",
      "address": "192.168.0.2"
    }
  },
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/97c1a503-9f73-4812-af91-282a590f8539' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "97c1a503-9f73-4812-af91-282a590f8539",
        "type": "ip_addresses",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/5ad3db7b-438a-4130-abd6-b798b64d2e79' \
    --header 'content-type: application/json' \
```
