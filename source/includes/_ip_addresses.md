...
```json
  ...
  "data": [
    {
      "id": "f40e6b60-e7fc-485b-81e8-3dabb8c6110f",
      "type": "ip_addresses",
      "attributes": {
        "created_at": "2023-02-10T11:16:15+00:00",
        "updated_at": "2023-02-10T11:16:15+00:00",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/6299ffbf-c630-466c-a109-263fce41e6ae' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "6299ffbf-c630-466c-a109-263fce41e6ae",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2023-02-10T11:16:15+00:00",
      "updated_at": "2023-02-10T11:16:15+00:00",
...
```json
  {
  "data": {
    "id": "c33b8fed-1916-42c2-9e14-8e787dabad24",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2023-02-10T11:16:15+00:00",
      "updated_at": "2023-02-10T11:16:15+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/bac51c34-16bd-46c4-8b81-8b62a1875d37' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "bac51c34-16bd-46c4-8b81-8b62a1875d37",
        "type": "ip_addresses",
        "attributes": {
...
```json
  ...
  "data": {
    ...
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2023-02-10T11:16:16+00:00",
      "updated_at": "2023-02-10T11:16:16+00:00",
      "label": "Palo Alto office",
      "address": "192.168.0.3"
    }
  },
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/69f216a6-9aa9-4bad-a4d3-9c1f1bfa6955' \
    --header 'content-type: application/json' \
```
