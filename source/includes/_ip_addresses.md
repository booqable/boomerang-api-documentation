...
```json
  ...
  "data": [
    {
      "id": "cc394f27-dcfb-4cca-910d-e65a0a8b3f61",
      "type": "ip_addresses",
      "attributes": {
        "created_at": "2023-02-28T08:45:20+00:00",
        "updated_at": "2023-02-28T08:45:20+00:00",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/8512b32b-e09b-40d1-8df4-70b39e0f27a6' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "8512b32b-e09b-40d1-8df4-70b39e0f27a6",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2023-02-28T08:45:21+00:00",
      "updated_at": "2023-02-28T08:45:21+00:00",
      "label": "John's home office",
      "address": "192.168.0.1"
    }
  },
...
```json
  {
  "data": {
    "id": "94444842-1c95-436c-8c88-4bc872553594",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2023-02-28T08:45:21+00:00",
      "updated_at": "2023-02-28T08:45:21+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/267ca0a9-33b7-4be3-9f5b-bac676027ab2' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "267ca0a9-33b7-4be3-9f5b-bac676027ab2",
        "type": "ip_addresses",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/145c38ad-ca90-4565-9f1e-1685d447efce' \
    --header 'content-type: application/json' \
```
