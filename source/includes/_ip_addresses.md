...
```json
  ...
  "data": [
    {
      "id": "b37d8b42-24d1-45b0-b8da-c808c6d28a0b",
      "type": "ip_addresses",
      "attributes": {
        "created_at": "2023-02-09T10:11:12+00:00",
        "updated_at": "2023-02-09T10:11:12+00:00",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/9c6bb2e1-a5d0-4444-b2f6-d61136c0aab1' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "9c6bb2e1-a5d0-4444-b2f6-d61136c0aab1",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2023-02-09T10:11:12+00:00",
      "updated_at": "2023-02-09T10:11:12+00:00",
...
```json
  {
  "data": {
    "id": "70ffbb11-09ae-4378-a7d5-ceec3bcd4276",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2023-02-09T10:11:13+00:00",
      "updated_at": "2023-02-09T10:11:13+00:00",
      "label": "Leeuwarden office",
      "address": "192.168.0.2"
    }
  },
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/54a0ed47-bb48-412b-a673-712eafebefac' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "54a0ed47-bb48-412b-a673-712eafebefac",
        "type": "ip_addresses",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/c2f4550b-0514-4e3d-a685-7a934c187979' \
    --header 'content-type: application/json' \
```
