...
```json
  ...
  "data": [
    {
      "id": "03d70e41-c264-42f7-94ae-4b3b6060a787",
      "type": "ip_addresses",
      "attributes": {
        "created_at": "2023-01-05T16:27:48+00:00",
        "updated_at": "2023-01-05T16:27:48+00:00",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/72df9c0b-3216-4a69-a55f-e09b50c7219d' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "72df9c0b-3216-4a69-a55f-e09b50c7219d",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2023-01-05T16:27:48+00:00",
      "updated_at": "2023-01-05T16:27:48+00:00",
...
```json
  {
  "data": {
    "id": "7936db32-8f29-4d18-9080-4d0d372720a3",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2023-01-05T16:27:49+00:00",
      "updated_at": "2023-01-05T16:27:49+00:00",
      "label": "Leeuwarden office",
      "address": "192.168.0.2"
    }
  },
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/811dd2f2-3676-453c-99fc-dcfcf5d8f74c' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "811dd2f2-3676-453c-99fc-dcfcf5d8f74c",
        "type": "ip_addresses",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/20d8a91f-33a5-4aa2-934e-6277eef87b01' \
    --header 'content-type: application/json' \
```
