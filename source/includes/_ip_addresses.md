...
```json
  ...
  "data": [
    {
      "id": "15cf3bbd-fd0d-4752-a04f-74190e0ed346",
      "type": "ip_addresses",
      "attributes": {
        "created_at": "2023-02-06T19:29:37+00:00",
        "updated_at": "2023-02-06T19:29:37+00:00",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/9c93b6ed-0f4c-49d5-81c5-7bed6534c042' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "9c93b6ed-0f4c-49d5-81c5-7bed6534c042",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2023-02-06T19:29:37+00:00",
      "updated_at": "2023-02-06T19:29:37+00:00",
...
```json
  {
  "data": {
    "id": "d1dc9880-0aa1-4a9b-a258-116d965a2d70",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2023-02-06T19:29:37+00:00",
      "updated_at": "2023-02-06T19:29:37+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/9bcd3103-e4ab-411b-9b76-05a7244fc25a' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "9bcd3103-e4ab-411b-9b76-05a7244fc25a",
        "type": "ip_addresses",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/6472f0ca-755d-4367-86dd-a9cdbe99e112' \
    --header 'content-type: application/json' \
```
