...
```json
  ...
  "data": [
    {
      "id": "8af8602d-725e-4f8e-8099-b6b6804b45e5",
      "type": "ip_addresses",
      "attributes": {
        "created_at": "2023-01-19T10:46:25+00:00",
        "updated_at": "2023-01-19T10:46:25+00:00",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/1c567250-645c-42b6-a0d7-1083024c5521' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "1c567250-645c-42b6-a0d7-1083024c5521",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2023-01-19T10:46:25+00:00",
      "updated_at": "2023-01-19T10:46:25+00:00",
...
```json
  {
  "data": {
    "id": "61ce43e7-c306-484a-8dc7-d9f8b84bb1ba",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2023-01-19T10:46:25+00:00",
      "updated_at": "2023-01-19T10:46:25+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/bc6d9936-6fe0-47e9-a593-c582acc9abc5' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "bc6d9936-6fe0-47e9-a593-c582acc9abc5",
        "type": "ip_addresses",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/f0217146-8af6-48d1-a9d8-d40578010af3' \
    --header 'content-type: application/json' \
```
