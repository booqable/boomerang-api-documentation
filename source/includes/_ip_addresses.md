...
```json
  ...
  "data": [
    {
      "id": "70a8309e-1901-4188-a26d-0a20f78b39f8",
      "type": "ip_addresses",
      "attributes": {
        "created_at": "2022-05-19T14:23:18+00:00",
        "updated_at": "2022-05-19T14:23:18+00:00",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/91b08598-e280-4dfe-b209-6a0584a47a60' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "91b08598-e280-4dfe-b209-6a0584a47a60",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2022-05-19T14:23:18+00:00",
      "updated_at": "2022-05-19T14:23:18+00:00",
...
```json
  {
  "data": {
    "id": "35fb56ce-1d56-4ec9-b5c8-bad256cb550e",
    "type": "ip_addresses",
    "attributes": {
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/ec95fd58-d282-4618-8c14-59ba2f91de46' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "ec95fd58-d282-4618-8c14-59ba2f91de46",
        "type": "ip_addresses",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/23207e78-f15e-4528-90f9-5ae46dd99ac7' \
    --header 'content-type: application/json' \
```
