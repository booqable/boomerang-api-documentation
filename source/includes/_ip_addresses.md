...
```json
  ...
  "data": [
    {
      "id": "462b5acb-67df-44c5-966a-80c8081e64cd",
      "type": "ip_addresses",
      "attributes": {
        "created_at": "2022-04-12T18:25:34+00:00",
        "updated_at": "2022-04-12T18:25:34+00:00",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/00fef983-176d-4e39-8b15-94e5edf09672' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "00fef983-176d-4e39-8b15-94e5edf09672",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2022-04-12T18:25:34+00:00",
      "updated_at": "2022-04-12T18:25:34+00:00",
...
```json
  {
  "data": {
    "id": "56ae2871-a5ce-43c4-970a-cbcf8c28615d",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2022-04-12T18:25:34+00:00",
      "updated_at": "2022-04-12T18:25:34+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/bd7bee80-9f10-4fe3-ba77-cb79e10781ca' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "bd7bee80-9f10-4fe3-ba77-cb79e10781ca",
        "type": "ip_addresses",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/1e4ea3c9-4213-44bd-a650-27f41c8e9d78' \
    --header 'content-type: application/json' \
```
