...
```json
  ...
  "data": [
    {
      "id": "73bdbab6-48b4-47e3-a511-271d3c181e9c",
      "type": "ip_addresses",
      "attributes": {
        "created_at": "2022-07-06T08:13:43+00:00",
        "updated_at": "2022-07-06T08:13:43+00:00",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/9c9acbf3-cb96-4ac1-be77-4374da72e5ab' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "9c9acbf3-cb96-4ac1-be77-4374da72e5ab",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2022-07-06T08:13:44+00:00",
      "updated_at": "2022-07-06T08:13:44+00:00",
      "label": "John's home office",
      "address": "192.168.0.1"
    }
  },
...
```json
  {
  "data": {
    "id": "5f91d037-af93-42a4-bfbd-4196d5f849ce",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2022-07-06T08:13:44+00:00",
      "updated_at": "2022-07-06T08:13:44+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/aa054074-e804-499c-a455-fc1b6c65d470' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "aa054074-e804-499c-a455-fc1b6c65d470",
        "type": "ip_addresses",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/1ea0ae90-7b33-4aae-87c3-545fceeaaeb6' \
    --header 'content-type: application/json' \
```
