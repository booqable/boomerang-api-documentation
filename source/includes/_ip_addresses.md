...
```json
  ...
  "data": [
    {
      "id": "5f7657d8-1cdc-4308-a7f0-b45be3db9285",
      "type": "ip_addresses",
      "attributes": {
        "created_at": "2023-02-28T08:11:45+00:00",
        "updated_at": "2023-02-28T08:11:45+00:00",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/1742a2ee-5327-4b9c-96ae-bd2198032db3' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "1742a2ee-5327-4b9c-96ae-bd2198032db3",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2023-02-28T08:11:45+00:00",
      "updated_at": "2023-02-28T08:11:45+00:00",
...
```json
  {
  "data": {
    "id": "549276be-dd5f-40fe-ac10-2bc3524690d7",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2023-02-28T08:11:46+00:00",
      "updated_at": "2023-02-28T08:11:46+00:00",
      "label": "Leeuwarden office",
      "address": "192.168.0.2"
    }
  },
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/b2086e39-0d1b-4ff9-9152-46c458ab5ca7' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "b2086e39-0d1b-4ff9-9152-46c458ab5ca7",
        "type": "ip_addresses",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/200b233f-b968-490a-b7af-63c767c7c901' \
    --header 'content-type: application/json' \
```
