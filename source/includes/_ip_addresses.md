...
```json
  ...
  "data": [
    {
      "id": "6208ba88-71de-4668-95c5-9a6462ce388e",
      "type": "ip_addresses",
      "attributes": {
        "created_at": "2023-02-22T08:41:01+00:00",
        "updated_at": "2023-02-22T08:41:01+00:00",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/6b1d6482-8907-418a-b3a3-f52275f509db' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "6b1d6482-8907-418a-b3a3-f52275f509db",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2023-02-22T08:41:02+00:00",
      "updated_at": "2023-02-22T08:41:02+00:00",
      "label": "John's home office",
      "address": "192.168.0.1"
    }
  },
...
```json
  {
  "data": {
    "id": "b052db2f-67f2-4982-acc6-a8e3b1224531",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2023-02-22T08:41:02+00:00",
      "updated_at": "2023-02-22T08:41:02+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/0ad4737d-00dd-4564-b7a9-a6061279339f' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "0ad4737d-00dd-4564-b7a9-a6061279339f",
        "type": "ip_addresses",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/b9ddca36-1d2d-492c-8ead-1b05b718316a' \
    --header 'content-type: application/json' \
```
