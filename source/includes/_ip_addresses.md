...
```json
  ...
  "data": [
    {
      "id": "49b1fb06-1b74-4519-8342-39f0e968d9be",
      "type": "ip_addresses",
      "attributes": {
        "created_at": "2023-02-24T09:47:57+00:00",
        "updated_at": "2023-02-24T09:47:57+00:00",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/d48c3337-1854-4d30-82cf-7e7e90d9cce7' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "d48c3337-1854-4d30-82cf-7e7e90d9cce7",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2023-02-24T09:47:57+00:00",
      "updated_at": "2023-02-24T09:47:57+00:00",
...
```json
  {
  "data": {
    "id": "07ca2951-977d-4cb6-a099-48a140d81eaa",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2023-02-24T09:47:58+00:00",
      "updated_at": "2023-02-24T09:47:58+00:00",
      "label": "Leeuwarden office",
      "address": "192.168.0.2"
    }
  },
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/a7d471b2-284f-4567-9816-93adafc17a90' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "a7d471b2-284f-4567-9816-93adafc17a90",
        "type": "ip_addresses",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/ce67691c-135e-47cd-aee8-e02f5a1bf168' \
    --header 'content-type: application/json' \
```
