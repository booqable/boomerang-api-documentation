...
```json
  ...
  "data": [
    {
      "id": "bf6d5311-af79-4116-b977-f266113b9b37",
      "type": "ip_addresses",
      "attributes": {
        "created_at": "2023-02-21T12:16:52+00:00",
        "updated_at": "2023-02-21T12:16:52+00:00",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/6eae506d-aab9-46aa-96ba-f1aed6c12ef2' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "6eae506d-aab9-46aa-96ba-f1aed6c12ef2",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2023-02-21T12:16:52+00:00",
      "updated_at": "2023-02-21T12:16:52+00:00",
...
```json
  {
  "data": {
    "id": "e23d7cac-e347-41e9-b746-b3aa36ff03d5",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2023-02-21T12:16:52+00:00",
      "updated_at": "2023-02-21T12:16:52+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/3dfe53ab-33f3-44ec-932f-42f9c05a5167' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "3dfe53ab-33f3-44ec-932f-42f9c05a5167",
        "type": "ip_addresses",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/9be0b58b-e7ab-457b-80de-248ed4fcd43c' \
    --header 'content-type: application/json' \
```
