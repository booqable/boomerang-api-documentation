...
```json
  ...
  "data": [
    {
      "id": "955fc3b0-3ae5-4cc6-9cf5-4f370e2662fe",
      "type": "ip_addresses",
      "attributes": {
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/b132fcd8-0d8f-46d8-82ed-6326c6064dd1' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "b132fcd8-0d8f-46d8-82ed-6326c6064dd1",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2023-02-14T11:05:04+00:00",
      "updated_at": "2023-02-14T11:05:04+00:00",
...
```json
  {
  "data": {
    "id": "a3520b31-fe06-40ff-83e3-6fcf3423e66f",
    "type": "ip_addresses",
    "attributes": {
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/4850d7c0-1a05-4931-876f-a0532f764d45' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "4850d7c0-1a05-4931-876f-a0532f764d45",
        "type": "ip_addresses",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/10638e43-8f5c-4e39-ab5d-8e1314584a0e' \
    --header 'content-type: application/json' \
```
