...
```json
  ...
  "data": [
    {
      "id": "022e2dd4-16aa-41fc-8dd1-399cf2ca4625",
      "type": "ip_addresses",
      "attributes": {
        "created_at": "2022-05-24T07:46:06+00:00",
        "updated_at": "2022-05-24T07:46:06+00:00",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/c01d9ece-4ddc-4efc-9d79-61dc3345b03d' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "c01d9ece-4ddc-4efc-9d79-61dc3345b03d",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2022-05-24T07:46:06+00:00",
      "updated_at": "2022-05-24T07:46:06+00:00",
...
```json
  {
  "data": {
    "id": "943296aa-e09a-48f7-8526-692450546de6",
    "type": "ip_addresses",
    "attributes": {
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/b6ff5ae1-7a00-43da-a328-92eac363c982' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "b6ff5ae1-7a00-43da-a328-92eac363c982",
        "type": "ip_addresses",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/2c8c84b4-ddae-48ba-a87a-fedb398c34de' \
    --header 'content-type: application/json' \
```
