...
```json
  ...
  "data": [
    {
      "id": "2253fd4b-bc6e-4a3d-ad8a-4a498da3b255",
      "type": "ip_addresses",
      "attributes": {
        "created_at": "2023-02-23T13:37:23+00:00",
        "updated_at": "2023-02-23T13:37:23+00:00",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/52fca605-1c79-4ceb-9f8d-f59274a7a1a5' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "52fca605-1c79-4ceb-9f8d-f59274a7a1a5",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2023-02-23T13:37:24+00:00",
      "updated_at": "2023-02-23T13:37:24+00:00",
      "label": "John's home office",
      "address": "192.168.0.1"
    }
  },
...
```json
  {
  "data": {
    "id": "46efff0b-9383-4deb-819f-8a20b4cd0900",
    "type": "ip_addresses",
    "attributes": {
      "created_at": "2023-02-23T13:37:24+00:00",
      "updated_at": "2023-02-23T13:37:24+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/f3388251-2484-4e31-aa08-6279375247c9' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "f3388251-2484-4e31-aa08-6279375247c9",
        "type": "ip_addresses",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/ip_addresses/918c4fd4-3ee3-41f6-bf92-19db1d36660f' \
    --header 'content-type: application/json' \
```
