...
`mode` | **String** <br>Mode. One of `manual`, `direct`, `request`, `terminal`. `checkout` mode is reserved for checkout payments, not available for API.
...
```json
  ...
  "data": [
    {
      "id": "6793bf66-f544-49d3-ac86-b0a5bf97de3b",
      "type": "payment_charges",
      "attributes": {
        "created_at": "2024-10-07T09:32:26.755014+00:00",
        "updated_at": "2024-10-07T09:32:26.755014+00:00",
        "status": "created",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/payment_charges/06d73830-fe76-4c05-aeb5-efa85b9eca2c' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "06d73830-fe76-4c05-aeb5-efa85b9eca2c",
    "type": "payment_charges",
    "attributes": {
      "created_at": "2024-10-07T09:32:29.179499+00:00",
      "updated_at": "2024-10-07T09:32:29.179499+00:00",
      "status": "created",
      "amount_in_cents": 5000,
      "deposit_in_cents": 0,
      "total_in_cents": 5000,
...
```json
  {
  "data": {
    "id": "dc59e7a6-a646-41cc-870c-d14c9dd2e76e",
    "type": "payment_charges",
    "attributes": {
      "created_at": "2024-10-07T09:32:27.767563+00:00",
      "updated_at": "2024-10-07T09:32:27.767563+00:00",
      "status": "succeeded",
      "amount_in_cents": 10000,
      "deposit_in_cents": 5000,
      ...
      "total_refunded_in_cents": 0,
      "succeeded_at": "2024-10-07T09:32:27.766091+00:00",
      "failed_at": null,
      "canceled_at": null,
      "expired_at": null,
      "employee_id": "84e58ec6-5544-4437-a8b9-8d79bececc30",
      "order_id": null,
      "customer_id": null
    },
    "relationships": {}
...
`data[attributes][mode]` | **String** <br>Mode. One of `manual`, `direct`, `request`, `terminal`. `checkout` mode is reserved for checkout payments, not available for API.
