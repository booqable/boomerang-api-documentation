...
```json
  ...
  "data": [
    {
      "id": "9a310820-569c-460b-a3b6-c6f1a6acd28c",
      "created_at": "2022-06-30T08:45:45+00:00",
      "updated_at": "2022-06-30T08:45:45+00:00",
      "name": "Cameras",
      "slug": "cameras",
      "position": 1,
      "show_in_store": true,
  ...
  "meta": {
    "stats": {
      "children": {
        "count_each": {
          "9a310820-569c-460b-a3b6-c6f1a6acd28c": 1
        }
      }
    }
  }
...
```json
  {
  "data": {
    "id": "f88b9484-7403-40fc-b682-392f82d25c10",
    "type": "categories",
    "attributes": {
      "created_at": "2022-06-30T08:45:45+00:00",
      "updated_at": "2022-06-30T08:45:45+00:00",
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "name": "Nikon",
          "parent_id": "7e225e64-aee9-4445-80ad-fd2f980c7ae2"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "e8f15cff-e5b7-4f92-a4d3-ace0843293c1",
    "type": "categories",
    "attributes": {
      "created_at": "2022-06-30T08:45:46+00:00",
      "updated_at": "2022-06-30T08:45:46+00:00",
      "name": "Nikon",
      "slug": "nikon",
      "position": null,
      "show_in_store": true,
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/categories/a3a9a736-dc6c-4c29-a51e-2f4bbb85f251' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "a3a9a736-dc6c-4c29-a51e-2f4bbb85f251",
        "type": "categories",
        "attributes": {
          "name": "Photo cameras"
        }
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/categories/7d30a463-bfe0-4642-bea1-d767d49a075e' \
    --header 'content-type: application/json' \
    --data '{
      "includes": "items",
      "data": {
        "id": "7d30a463-bfe0-4642-bea1-d767d49a075e",
        "type": "categories",
        "attributes": {
          "item_ids": [
            "3c04354c-c09c-4f6e-b282-a0c681fc1999",
            "94b40828-33d1-42dc-ba8d-fd15199fd64c"
          ]
        }
      }
    }'
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/categories/cc16c543-6e3f-4872-8258-557ab44cd4ef' \
    --header 'content-type: application/json' \
    --data '{}'
```
