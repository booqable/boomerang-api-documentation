...
```json
  ...
  "data": [
    {
      "id": "e0cdf8bd-f4e1-4e84-8825-1628aeea5d75",
      "created_at": "2022-06-08T08:05:05+00:00",
  ...
  "meta": {
    "stats": {
      "children": {
        "count_each": {
          "e0cdf8bd-f4e1-4e84-8825-1628aeea5d75": 1
        }
      }
    }
  }
...
```json
  {
  "data": {
    "id": "70e22ac1-e5ba-42c2-846b-7636325194eb",
    "type": "categories",
    "attributes": {
      "created_at": "2022-06-08T08:05:06+00:00",
      "updated_at": "2022-06-08T08:05:06+00:00",
      "name": "Accesories",
      "slug": "accesories",
      "position": null,
      "show_in_store": true,
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "name": "Nikon",
          "parent_id": "77cdf613-d564-4f21-a03b-9e53d16d7775"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "237fdfb4-8974-4390-ad2d-3cf18c719698",
    "type": "categories",
    "attributes": {
      "created_at": "2022-06-08T08:05:06+00:00",
      "updated_at": "2022-06-08T08:05:06+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/categories/70561f96-0c17-4974-b0f8-164f84b315c3' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "70561f96-0c17-4974-b0f8-164f84b315c3",
        "type": "categories",
        "attributes": {
          "name": "Photo cameras"
        }
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/categories/c0f2e7b7-e677-4f21-b248-8d121d50bc63' \
    --header 'content-type: application/json' \
    --data '{
      "includes": "items",
      "data": {
        "id": "c0f2e7b7-e677-4f21-b248-8d121d50bc63",
        "type": "categories",
        "attributes": {
          "item_ids": [
            "0e9a2b51-2c49-4f07-ac45-567d76a16556",
            "77af4a3b-29c5-4ac3-819f-4295c7fb3ac9"
          ]
        }
      }
    }'
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/categories/13c9d2ae-0fb9-4b05-b45e-fbb074e1f710' \
    --header 'content-type: application/json' \
    --data '{}'
```
