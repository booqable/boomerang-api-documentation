...
```json
  ...
  "data": [
    {
      "id": "063e6a7e-135e-4b64-abd9-a3bf693ef058",
      "created_at": "2022-06-09T12:37:25+00:00",
      "updated_at": "2022-06-09T12:37:25+00:00",
      "name": "Cameras",
      "slug": "cameras",
      "position": 1,
      "show_in_store": true,
  ...
  "meta": {
    "stats": {
      "children": {
        "count_each": {
          "063e6a7e-135e-4b64-abd9-a3bf693ef058": 1
        }
      }
    }
  }
...
```json
  {
  "data": {
    "id": "4d341bca-25d7-4086-99fd-57616ad8480d",
    "type": "categories",
    "attributes": {
      "created_at": "2022-06-09T12:37:25+00:00",
      "updated_at": "2022-06-09T12:37:25+00:00",
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "name": "Nikon",
          "parent_id": "6a443ff9-931d-4504-8aec-126f15192826"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "6ebf7650-da06-493c-8df3-eed741a685bd",
    "type": "categories",
    "attributes": {
      "created_at": "2022-06-09T12:37:26+00:00",
      "updated_at": "2022-06-09T12:37:26+00:00",
      "name": "Nikon",
      "slug": "nikon",
      "position": null,
      "show_in_store": true,
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/categories/a96ca4c1-fbd2-4134-8426-974728fde9be' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "a96ca4c1-fbd2-4134-8426-974728fde9be",
        "type": "categories",
        "attributes": {
          "name": "Photo cameras"
        }
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/categories/2a69dca1-66fc-49cd-b473-d924580e9e48' \
    --header 'content-type: application/json' \
    --data '{
      "includes": "items",
      "data": {
        "id": "2a69dca1-66fc-49cd-b473-d924580e9e48",
        "type": "categories",
        "attributes": {
          "item_ids": [
            "36a045ea-6762-4edc-aa9a-a6e6aed76076",
            "f7d9b4ec-96b5-40b5-ad7c-29919a286b2f"
          ]
        }
      }
    }'
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/categories/c179f975-b134-42d7-a5a6-0b1f458f4e11' \
    --header 'content-type: application/json' \
    --data '{}'
```
