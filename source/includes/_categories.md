...
```json
  ...
  "data": [
    {
      "id": "5608e306-cda9-4917-ad6c-3129fbf6a02d",
      "created_at": "2022-05-31T06:54:43+00:00",
      "updated_at": "2022-05-31T06:54:43+00:00",
      "name": "Cameras",
      "slug": "cameras",
      "position": 1,
      "show_in_store": true,
  ...
  "meta": {
    "stats": {
      "children": {
        "count_each": {
          "5608e306-cda9-4917-ad6c-3129fbf6a02d": 1
        }
      }
    }
  }
...
```json
  {
  "data": {
    "id": "a1674f7d-1343-4965-80e5-a877f3bebfdb",
    "type": "categories",
    "attributes": {
      "created_at": "2022-05-31T06:54:43+00:00",
      "updated_at": "2022-05-31T06:54:43+00:00",
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "name": "Nikon",
          "parent_id": "46df8cba-2ab0-48ad-bad4-0dda381ba018"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "a7d9fcf7-d569-4157-86c5-2f1c6ca66778",
    "type": "categories",
    "attributes": {
      "created_at": "2022-05-31T06:54:43+00:00",
      "updated_at": "2022-05-31T06:54:43+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/categories/86c8e871-4e2f-4ddd-a160-ccfbd9d5bb79' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "86c8e871-4e2f-4ddd-a160-ccfbd9d5bb79",
        "type": "categories",
        "attributes": {
          "name": "Photo cameras"
        }
...
```json
  ...
  "data": {
    ...
    "type": "categories",
    "attributes": {
      "created_at": "2022-05-31T06:54:44+00:00",
      "updated_at": "2022-05-31T06:54:44+00:00",
      "name": "Photo cameras",
      "slug": "cameras",
      "position": 1,
      "show_in_store": true,
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/categories/f9617d90-abe6-4077-8a6f-d1ea366c69a8' \
    --header 'content-type: application/json' \
    --data '{
      "includes": "items",
      "data": {
        "id": "f9617d90-abe6-4077-8a6f-d1ea366c69a8",
        "type": "categories",
        "attributes": {
          "item_ids": [
            "41fd7c0d-81d2-4279-901c-9b19dcbce65c",
            "efd92708-532c-4c71-a317-166129f81f3b"
          ]
        }
      }
    }'
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/categories/2d710808-0e5e-4578-ae48-a1ab418149b0' \
    --header 'content-type: application/json' \
    --data '{}'
```
