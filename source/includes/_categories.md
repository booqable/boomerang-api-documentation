...
```json
  ...
  "data": [
    {
      "id": "edf92efe-44a4-46c6-a426-e8d769aef775",
      "created_at": "2022-03-15T10:34:30+00:00",
      "updated_at": "2022-03-15T10:34:30+00:00",
      "name": "Cameras",
      "slug": "cameras",
      "position": 1,
      "show_in_store": true,
  ...
  "meta": {
    "stats": {
      "children": {
        "count_each": {
          "edf92efe-44a4-46c6-a426-e8d769aef775": 1
        }
      }
    }
  }
...
```json
  {
  "data": {
    "id": "500cdd84-7af4-4399-83c9-9092489405f2",
    "type": "categories",
    "attributes": {
      "created_at": "2022-03-15T10:34:30+00:00",
      "updated_at": "2022-03-15T10:34:30+00:00",
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "name": "Nikon",
          "parent_id": "ac818d2a-b88e-4e3f-9a72-f249764c351f"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "5c75f899-836d-4a63-94fe-23b0571d0fe2",
    "type": "categories",
    "attributes": {
      "created_at": "2022-03-15T10:34:30+00:00",
      "updated_at": "2022-03-15T10:34:30+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/categories/c41202f0-29bf-470f-8ed8-0a41c6c3237a' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "c41202f0-29bf-470f-8ed8-0a41c6c3237a",
        "type": "categories",
        "attributes": {
          "name": "Photo cameras"
        }
...
```json
  ...
  "data": {
    ...
    "type": "categories",
    "attributes": {
      "created_at": "2022-03-15T10:34:31+00:00",
      "updated_at": "2022-03-15T10:34:31+00:00",
      "name": "Photo cameras",
      "slug": "cameras",
      "position": 1,
      "show_in_store": true,
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/categories/986ea4aa-f159-4e4d-91ee-23a8845db25f' \
    --header 'content-type: application/json' \
    --data '{
      "includes": "items",
      "data": {
        "id": "986ea4aa-f159-4e4d-91ee-23a8845db25f",
        "type": "categories",
        "attributes": {
          "item_ids": [
            "14536350-3a10-4c7e-bdb4-d3a9c75f708d",
            "2f099634-114f-4e07-b6dc-085ae670c7a0"
          ]
        }
      }
    }'
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/categories/e8a4f7ab-3ea9-4330-8cf4-209e2c8da4ee' \
    --header 'content-type: application/json' \
    --data '{}'
```
