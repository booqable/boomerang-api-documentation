...
```json
  ...
  "data": [
    {
      "id": "937253e1-6448-44ff-a7ce-b75dcfcd68ff",
      "created_at": "2022-05-05T12:26:06+00:00",
      "updated_at": "2022-05-05T12:26:06+00:00",
      "name": "Cameras",
      "slug": "cameras",
      "position": 1,
      "show_in_store": true,
  ...
  "meta": {
    "stats": {
      "children": {
        "count_each": {
          "937253e1-6448-44ff-a7ce-b75dcfcd68ff": 1
        }
      }
    }
  }
...
```json
  {
  "data": {
    "id": "af2af575-be59-4e23-af29-f2a5ead27a46",
    "type": "categories",
    "attributes": {
      "created_at": "2022-05-05T12:26:07+00:00",
      "updated_at": "2022-05-05T12:26:07+00:00",
      "name": "Accesories",
      "slug": "accesories",
      "position": null,
      "show_in_store": true,
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "name": "Nikon",
          "parent_id": "299fed14-06bf-49a7-a3b5-da65b4955fcc"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "c591c4c3-6c55-49a1-951a-474ebf4b6e61",
    "type": "categories",
    "attributes": {
      "created_at": "2022-05-05T12:26:07+00:00",
      "updated_at": "2022-05-05T12:26:07+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/categories/255325f9-aa72-4293-9c3b-b4c8f293a46b' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "255325f9-aa72-4293-9c3b-b4c8f293a46b",
        "type": "categories",
        "attributes": {
          "name": "Photo cameras"
        }
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/categories/a0bf8070-8752-4ef3-af85-d6f0fbba62d9' \
    --header 'content-type: application/json' \
    --data '{
      "includes": "items",
      "data": {
        "id": "a0bf8070-8752-4ef3-af85-d6f0fbba62d9",
        "type": "categories",
        "attributes": {
          "item_ids": [
            "03dd340a-f272-413b-8a00-16a0c77abaf3",
            "003ae3b0-4b3e-47d6-8abc-9971541ab2d7"
          ]
        }
      }
    }'
...
```json
  ...
  "data": {
    ...
    "type": "categories",
    "attributes": {
      "created_at": "2022-05-05T12:26:08+00:00",
      "updated_at": "2022-05-05T12:26:08+00:00",
      "name": "Cameras",
      "slug": "cameras",
      "position": 1,
      "show_in_store": true,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/categories/e4cdc906-6221-4799-817f-f3df830ce998' \
    --header 'content-type: application/json' \
    --data '{}'
```
