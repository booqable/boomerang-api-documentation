...
```json
  ...
  "data": [
    {
      "id": "b4f40753-881a-4d4c-8b51-6e892c3a8979",
      "created_at": "2022-01-12T14:02:30+00:00",
      "updated_at": "2022-01-12T14:02:30+00:00",
      "name": "Cameras",
      "slug": "cameras",
      "position": 1,
      "show_in_store": true,
  ...
  "meta": {
    "stats": {
      "children": {
        "count_each": {
          "b4f40753-881a-4d4c-8b51-6e892c3a8979": 1
        }
      }
    }
  }
...
```json
  {
  "data": {
    "id": "d6692ddb-964e-4a08-bbec-a9776cfb9f1d",
    "type": "categories",
    "attributes": {
      "created_at": "2022-01-12T14:02:30+00:00",
      "updated_at": "2022-01-12T14:02:30+00:00",
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "name": "Nikon",
          "parent_id": "611de86e-27d6-4934-9138-98377ff6fab5"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "f10e196c-2dee-46b2-b26f-b56137f46104",
    "type": "categories",
    "attributes": {
      "created_at": "2022-01-12T14:02:31+00:00",
      "updated_at": "2022-01-12T14:02:31+00:00",
      "name": "Nikon",
      "slug": "nikon",
      "position": null,
      "show_in_store": true,
  ...
  "links": {
    "self": "api/boomerang/categories?data%5Battributes%5D%5Bname%5D=Nikon&data%5Battributes%5D%5Bparent_id%5D=611de86e-27d6-4934-9138-98377ff6fab5&data%5Btype%5D=categories&page%5Bnumber%5D=1&page%5Bsize%5D=25",
    "first": "api/boomerang/categories?data%5Battributes%5D%5Bname%5D=Nikon&data%5Battributes%5D%5Bparent_id%5D=611de86e-27d6-4934-9138-98377ff6fab5&data%5Btype%5D=categories&page%5Bnumber%5D=1&page%5Bsize%5D=25",
    "last": "api/boomerang/categories?data%5Battributes%5D%5Bname%5D=Nikon&data%5Battributes%5D%5Bparent_id%5D=611de86e-27d6-4934-9138-98377ff6fab5&data%5Btype%5D=categories&page%5Bnumber%5D=1&page%5Bsize%5D=25"
  },
  "meta": {}
}
```
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/categories/26bdb06a-5cb7-402f-8cd4-842defc41335' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "26bdb06a-5cb7-402f-8cd4-842defc41335",
        "type": "categories",
        "attributes": {
          "name": "Photo cameras"
        }
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/categories/1de8183e-a4d9-42c7-aaaa-5cce6238626e' \
    --header 'content-type: application/json' \
    --data '{
      "includes": "items",
      "data": {
        "id": "1de8183e-a4d9-42c7-aaaa-5cce6238626e",
        "type": "categories",
        "attributes": {
          "item_ids": [
            "82baa4e9-47bc-4abe-bae3-0261873550fc",
            "1e834845-fc08-4ab4-8e46-459a9135ec57"
          ]
        }
      }
    }'
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/categories/24b6f2b4-74bf-4e2c-88ea-09745d216ca8' \
    --header 'content-type: application/json' \
    --data '{}'
```
