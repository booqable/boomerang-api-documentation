...
```json
  ...
  "data": [
    {
      "id": "49d5c682-fa05-434c-a1e9-788e856f8e22",
      "created_at": "2022-05-05T09:12:35+00:00",
      "updated_at": "2022-05-05T09:12:35+00:00",
      "name": "Cameras",
      "slug": "cameras",
      "position": 1,
      "show_in_store": true,
  ...
  "meta": {
    "stats": {
      "children": {
        "count_each": {
          "49d5c682-fa05-434c-a1e9-788e856f8e22": 1
        }
      }
    }
  }
...
```json
  {
  "data": {
    "id": "78fe048c-3855-4794-a968-6c30256536d2",
    "type": "categories",
    "attributes": {
      "created_at": "2022-05-05T09:12:35+00:00",
      "updated_at": "2022-05-05T09:12:35+00:00",
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "name": "Nikon",
          "parent_id": "f2826b5b-32a3-4289-995c-00c74043fefc"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "6b81d727-a0c1-4bcd-89e5-62badec3ead9",
    "type": "categories",
    "attributes": {
      "created_at": "2022-05-05T09:12:36+00:00",
      "updated_at": "2022-05-05T09:12:36+00:00",
      "name": "Nikon",
      "slug": "nikon",
      "position": null,
      "show_in_store": true,
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/categories/35e46b6d-a2c9-4c66-827a-6c2e7712145a' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "35e46b6d-a2c9-4c66-827a-6c2e7712145a",
        "type": "categories",
        "attributes": {
          "name": "Photo cameras"
        }
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/categories/ef4585a9-d30f-4f94-8d38-2f5caff5abc3' \
    --header 'content-type: application/json' \
    --data '{
      "includes": "items",
      "data": {
        "id": "ef4585a9-d30f-4f94-8d38-2f5caff5abc3",
        "type": "categories",
        "attributes": {
          "item_ids": [
            "d38a899d-c130-4633-987d-0dca9a7756f1",
            "9c1497a1-899d-4534-8b43-18f8eeaaea73"
          ]
        }
      }
    }'
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/categories/ec3fe53f-98ea-48c5-a31c-0b973b2f40c4' \
    --header 'content-type: application/json' \
    --data '{}'
```
