...
```json
  ...
  "data": [
    {
      "id": "bff453dc-5a04-4e82-9550-c43cece0d60f",
  ...
  "meta": {
    "stats": {
      "children": {
        "count_each": {
          "bff453dc-5a04-4e82-9550-c43cece0d60f": 1
        }
      }
    }
  }
...
```json
  {
  "data": {
    "id": "5f34cdbd-6713-4f37-81cb-90a7ce3e8167",
    "type": "categories",
    "attributes": {
      "created_at": "2022-05-19T11:08:47+00:00",
      "updated_at": "2022-05-19T11:08:47+00:00",
      "name": "Accesories",
      "slug": "accesories",
      "position": null,
      "show_in_store": true,
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "name": "Nikon",
          "parent_id": "1c29408d-f5d9-4c6f-9d40-2b1780fe2e19"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "80fe9391-9a79-4a6b-9a4e-15bda2727809",
    "type": "categories",
    "attributes": {
      "created_at": "2022-05-19T11:08:47+00:00",
      "updated_at": "2022-05-19T11:08:47+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/categories/90173904-8e42-4199-a220-6136fa135af4' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "90173904-8e42-4199-a220-6136fa135af4",
        "type": "categories",
        "attributes": {
          "name": "Photo cameras"
        }
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/categories/4938cf26-a8fb-46bd-a9fc-83b1625768dc' \
    --header 'content-type: application/json' \
    --data '{
      "includes": "items",
      "data": {
        "id": "4938cf26-a8fb-46bd-a9fc-83b1625768dc",
        "type": "categories",
        "attributes": {
          "item_ids": [
            "bdacfa50-32ab-4583-b97d-2c599ec21ce5",
            "aff7027d-0124-4020-b565-4c8fa843657a"
          ]
        }
      }
    }'
...
```json
  ...
  "data": {
    ...
    "type": "categories",
    "attributes": {
      "created_at": "2022-05-19T11:08:48+00:00",
      "updated_at": "2022-05-19T11:08:48+00:00",
      "name": "Cameras",
      "slug": "cameras",
      "position": 1,
      "show_in_store": true,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/categories/5d1f6079-f973-466e-aa73-6a93cf2ed8a9' \
    --header 'content-type: application/json' \
    --data '{}'
```
