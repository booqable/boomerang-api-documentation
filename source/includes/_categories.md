...
```json
  ...
  "data": [
    {
      "id": "bacd0468-f4ed-44bb-9b79-444c774ddf53",
      "created_at": "2022-05-24T07:23:51+00:00",
      "updated_at": "2022-05-24T07:23:51+00:00",
      "name": "Cameras",
      "slug": "cameras",
      "position": 1,
      "show_in_store": true,
  ...
  "meta": {
    "stats": {
      "children": {
        "count_each": {
          "bacd0468-f4ed-44bb-9b79-444c774ddf53": 1
        }
      }
    }
  }
...
```json
  {
  "data": {
    "id": "c720b13c-becb-4283-b52c-92b34792c3ec",
    "type": "categories",
    "attributes": {
      "created_at": "2022-05-24T07:23:51+00:00",
      "updated_at": "2022-05-24T07:23:51+00:00",
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "name": "Nikon",
          "parent_id": "ef39b4f1-49b5-40a9-83bc-7cee714786d4"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "63c7d2ed-2146-409a-bfbd-b9e52a17c545",
    "type": "categories",
    "attributes": {
      "created_at": "2022-05-24T07:23:52+00:00",
      "updated_at": "2022-05-24T07:23:52+00:00",
      "name": "Nikon",
      "slug": "nikon",
      "position": null,
      "show_in_store": true,
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/categories/6f4520c8-a0e3-48d0-9ef1-0a38573839dd' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "6f4520c8-a0e3-48d0-9ef1-0a38573839dd",
        "type": "categories",
        "attributes": {
          "name": "Photo cameras"
        }
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/categories/53abc803-0c8d-4f5a-b4fc-2b65c7e5e085' \
    --header 'content-type: application/json' \
    --data '{
      "includes": "items",
      "data": {
        "id": "53abc803-0c8d-4f5a-b4fc-2b65c7e5e085",
        "type": "categories",
        "attributes": {
          "item_ids": [
            "9fbd08e5-0cbd-416d-8bf3-161fa0724c70",
            "9564cf19-5f29-4098-b9cd-29118e5c4af8"
          ]
        }
      }
    }'
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/categories/3d652e7a-401f-4619-b2ff-ed200eaf01c2' \
    --header 'content-type: application/json' \
    --data '{}'
```
