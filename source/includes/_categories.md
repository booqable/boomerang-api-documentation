...
```json
  ...
  "data": [
    {
      "id": "cb02952f-254a-4117-b5e4-6968788756aa",
      "created_at": "2022-05-04T10:04:23+00:00",
      "updated_at": "2022-05-04T10:04:23+00:00",
      "name": "Cameras",
      "slug": "cameras",
      "position": 1,
      "show_in_store": true,
  ...
  "meta": {
    "stats": {
      "children": {
        "count_each": {
          "cb02952f-254a-4117-b5e4-6968788756aa": 1
        }
      }
    }
  }
...
```json
  {
  "data": {
    "id": "97768cea-9fe2-421c-a687-284d06f831ae",
    "type": "categories",
    "attributes": {
      "created_at": "2022-05-04T10:04:23+00:00",
      "updated_at": "2022-05-04T10:04:23+00:00",
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "name": "Nikon",
          "parent_id": "0b9e7343-de42-4384-8822-bdc961c74e66"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "e30e3501-a6ee-4c40-bc7e-47139ece2743",
    "type": "categories",
    "attributes": {
      "created_at": "2022-05-04T10:04:23+00:00",
      "updated_at": "2022-05-04T10:04:23+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/categories/66970d94-c3b2-4d55-afcf-1e33adcfbb2e' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "66970d94-c3b2-4d55-afcf-1e33adcfbb2e",
        "type": "categories",
        "attributes": {
          "name": "Photo cameras"
        }
...
```json
  ...
  "data": {
    ...
    "type": "categories",
    "attributes": {
      "created_at": "2022-05-04T10:04:24+00:00",
      "updated_at": "2022-05-04T10:04:24+00:00",
      "name": "Photo cameras",
      "slug": "cameras",
      "position": 1,
      "show_in_store": true,
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/categories/1b40b72a-6bbf-4bf1-a921-3597f83e6662' \
    --header 'content-type: application/json' \
    --data '{
      "includes": "items",
      "data": {
        "id": "1b40b72a-6bbf-4bf1-a921-3597f83e6662",
        "type": "categories",
        "attributes": {
          "item_ids": [
            "b1b8a15b-ac6e-44b4-877b-269faeb0f6b4",
            "03799db9-4984-4972-8822-ba6b1ba59740"
          ]
        }
      }
    }'
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/categories/3936d3d5-53b1-4be3-9245-c2affa683728' \
    --header 'content-type: application/json' \
    --data '{}'
```
