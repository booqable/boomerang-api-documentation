...
```json
  ...
  "data": [
    {
      "id": "fbaaaba8-795e-4bb6-9198-a66bee12409c",
  ...
  "meta": {
    "stats": {
      "children": {
        "count_each": {
          "fbaaaba8-795e-4bb6-9198-a66bee12409c": 1
        }
      }
    }
  }
...
```json
  {
  "data": {
    "id": "5e32fb64-ffc6-49e6-867d-128790c2e63b",
    "type": "categories",
    "attributes": {
      "created_at": "2022-04-13T09:08:25+00:00",
      "updated_at": "2022-04-13T09:08:25+00:00",
      "name": "Accesories",
      "slug": "accesories",
      "position": null,
      "show_in_store": true,
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "name": "Nikon",
          "parent_id": "a58287fa-396c-4b53-9476-dfe4965f00d7"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "7ac6555a-e430-45b8-bb04-32c7a87f010e",
    "type": "categories",
    "attributes": {
      "created_at": "2022-04-13T09:08:25+00:00",
      "updated_at": "2022-04-13T09:08:25+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/categories/9a86ce1e-67f5-4f9d-a1c8-f5b74ead68a7' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "9a86ce1e-67f5-4f9d-a1c8-f5b74ead68a7",
        "type": "categories",
        "attributes": {
          "name": "Photo cameras"
        }
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/categories/8a20eef8-3901-443a-9903-a043dd1d342a' \
    --header 'content-type: application/json' \
    --data '{
      "includes": "items",
      "data": {
        "id": "8a20eef8-3901-443a-9903-a043dd1d342a",
        "type": "categories",
        "attributes": {
          "item_ids": [
            "b695eb15-5609-4072-8560-7149fb86dd94",
            "32608ff2-49da-43ee-a034-8a38934eaaab"
          ]
        }
      }
    }'
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/categories/ab16991b-2908-43a9-9132-18b150d1ee1b' \
    --header 'content-type: application/json' \
    --data '{}'
```
