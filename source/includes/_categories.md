...
```json
  ...
  "data": [
    {
      "id": "e0bd6430-c6c5-48cc-870f-a4fa5f348463",
  ...
  "meta": {
    "stats": {
      "children": {
        "count_each": {
          "e0bd6430-c6c5-48cc-870f-a4fa5f348463": 1
        }
      }
    }
  }
...
```json
  {
  "data": {
    "id": "57779bd2-90dc-4d9c-8bf5-50e9bb5e5c1f",
    "type": "categories",
    "attributes": {
      "created_at": "2022-04-08T17:51:35+00:00",
      "updated_at": "2022-04-08T17:51:35+00:00",
      "name": "Accesories",
      "slug": "accesories",
      "position": null,
      "show_in_store": true,
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "name": "Nikon",
          "parent_id": "89440c70-f5ec-458f-b440-03fc1d3d7113"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "55d76b59-08dd-4964-beb0-8717e1e859e4",
    "type": "categories",
    "attributes": {
      "created_at": "2022-04-08T17:51:35+00:00",
      "updated_at": "2022-04-08T17:51:35+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/categories/7400c6a7-7212-49cf-b71c-90f3dc47b09f' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "7400c6a7-7212-49cf-b71c-90f3dc47b09f",
        "type": "categories",
        "attributes": {
          "name": "Photo cameras"
        }
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/categories/3b1e3895-9717-4a53-96d2-bdd92f0602c0' \
    --header 'content-type: application/json' \
    --data '{
      "includes": "items",
      "data": {
        "id": "3b1e3895-9717-4a53-96d2-bdd92f0602c0",
        "type": "categories",
        "attributes": {
          "item_ids": [
            "b5be5871-a0e7-4313-878e-fbc683a7a8d4",
            "8107dc4d-f435-4dcf-a5bb-8166657b96c8"
          ]
        }
      }
    }'
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/categories/77288bf7-bef5-4e2b-88b1-7ed7f48b6017' \
    --header 'content-type: application/json' \
    --data '{}'
```
