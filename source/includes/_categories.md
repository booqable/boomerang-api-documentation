...
```json
  ...
  "data": [
    {
      "id": "8edeef26-7414-48bd-91c1-3788a531b3a3",
      "created_at": "2022-05-31T08:25:39+00:00",
      "updated_at": "2022-05-31T08:25:39+00:00",
      "name": "Cameras",
      "slug": "cameras",
      "position": 1,
      "show_in_store": true,
  ...
  "meta": {
    "stats": {
      "children": {
        "count_each": {
          "8edeef26-7414-48bd-91c1-3788a531b3a3": 1
        }
      }
    }
  }
...
```json
  {
  "data": {
    "id": "e112e9c6-cf1b-43aa-ad0a-d1b4a1dea150",
    "type": "categories",
    "attributes": {
      "created_at": "2022-05-31T08:25:39+00:00",
      "updated_at": "2022-05-31T08:25:39+00:00",
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "name": "Nikon",
          "parent_id": "051c7818-8c3d-47e4-8bb8-ce5dff7312d9"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "d20807fe-3676-41e7-8497-24a5a02df352",
    "type": "categories",
    "attributes": {
      "created_at": "2022-05-31T08:25:39+00:00",
      "updated_at": "2022-05-31T08:25:39+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/categories/3095c641-3468-4c28-82ab-18a58fcfe612' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "3095c641-3468-4c28-82ab-18a58fcfe612",
        "type": "categories",
        "attributes": {
          "name": "Photo cameras"
        }
...
```json
  ...
  "data": {
    ...
    "attributes": {
      "created_at": "2022-05-31T08:25:39+00:00",
      "updated_at": "2022-05-31T08:25:40+00:00",
      "name": "Photo cameras",
      "slug": "cameras",
      "position": 1,
      "show_in_store": true,
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/categories/f969d215-0b76-427d-9213-7670d46e3c10' \
    --header 'content-type: application/json' \
    --data '{
      "includes": "items",
      "data": {
        "id": "f969d215-0b76-427d-9213-7670d46e3c10",
        "type": "categories",
        "attributes": {
          "item_ids": [
            "a8ca7c0f-e98a-400a-b5a4-2ccb12956473",
            "554e2e17-5f3d-46a7-b96b-172c076f3188"
          ]
        }
      }
    }'
...
```json
  ...
  "data": {
    ...
    "type": "categories",
    "attributes": {
      "created_at": "2022-05-31T08:25:40+00:00",
      "updated_at": "2022-05-31T08:25:40+00:00",
      "name": "Cameras",
      "slug": "cameras",
      "position": 1,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/categories/f8b18cf8-0a42-49ff-b78e-bd0cf81f4273' \
    --header 'content-type: application/json' \
    --data '{}'
```
