...
```json
  ...
  "data": [
    {
      "id": "baa8d097-6690-440d-93e0-d9ccba4dda0f",
      "created_at": "2022-04-12T18:24:47+00:00",
      "updated_at": "2022-04-12T18:24:47+00:00",
      "name": "Cameras",
      "slug": "cameras",
      "position": 1,
      "show_in_store": true,
  ...
  "meta": {
    "stats": {
      "children": {
        "count_each": {
          "baa8d097-6690-440d-93e0-d9ccba4dda0f": 1
        }
      }
    }
  }
...
```json
  {
  "data": {
    "id": "b7acd0f8-e70c-4c9e-8df2-47353fe18dc0",
    "type": "categories",
    "attributes": {
      "created_at": "2022-04-12T18:24:47+00:00",
      "updated_at": "2022-04-12T18:24:47+00:00",
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "name": "Nikon",
          "parent_id": "62b7bb8b-55ff-4213-a591-4b7ce79cb1a7"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "30928d2e-ab90-4c45-a3a3-a469838b69fa",
    "type": "categories",
    "attributes": {
      "created_at": "2022-04-12T18:24:47+00:00",
      "updated_at": "2022-04-12T18:24:47+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/categories/6cbeaf4e-384e-4d7c-a7ea-25cef60a717a' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "6cbeaf4e-384e-4d7c-a7ea-25cef60a717a",
        "type": "categories",
        "attributes": {
          "name": "Photo cameras"
        }
...
```json
  ...
  "data": {
    ...
    "attributes": {
      "created_at": "2022-04-12T18:24:47+00:00",
      "updated_at": "2022-04-12T18:24:48+00:00",
      "name": "Photo cameras",
      "slug": "cameras",
      "position": 1,
      "show_in_store": true,
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/categories/eceb55a2-a4c7-46fe-ae3e-d1b029bd812f' \
    --header 'content-type: application/json' \
    --data '{
      "includes": "items",
      "data": {
        "id": "eceb55a2-a4c7-46fe-ae3e-d1b029bd812f",
        "type": "categories",
        "attributes": {
          "item_ids": [
            "93516f04-6a06-4e85-b4e7-c197c2f48111",
            "4f69dca0-da24-47c2-93df-9d0295262f07"
          ]
        }
      }
    }'
...
```json
  ...
  "data": {
    ...
    "type": "categories",
    "attributes": {
      "created_at": "2022-04-12T18:24:48+00:00",
      "updated_at": "2022-04-12T18:24:48+00:00",
      "name": "Cameras",
      "slug": "cameras",
      "position": 1,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/categories/78b0736b-e7cd-4f84-b6b6-1b2bf49d1eb2' \
    --header 'content-type: application/json' \
    --data '{}'
```
