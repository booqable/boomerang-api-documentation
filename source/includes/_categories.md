...
```json
  ...
  "data": [
    {
      "id": "7188871a-260b-479b-a763-e4a8a5eb4f9f",
      "created_at": "2022-06-01T08:55:41+00:00",
      "updated_at": "2022-06-01T08:55:41+00:00",
      "name": "Cameras",
      "slug": "cameras",
      "position": 1,
      "show_in_store": true,
  ...
  "meta": {
    "stats": {
      "children": {
        "count_each": {
          "7188871a-260b-479b-a763-e4a8a5eb4f9f": 1
        }
      }
    }
  }
...
```json
  {
  "data": {
    "id": "d763be1d-a9dc-4366-ada9-7b301d39b0b4",
    "type": "categories",
    "attributes": {
      "created_at": "2022-06-01T08:55:41+00:00",
      "updated_at": "2022-06-01T08:55:41+00:00",
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "name": "Nikon",
          "parent_id": "2ffb7eba-6f04-4672-8a9e-5bcb8969dbcb"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "d3537ec1-8d5b-4923-bdd2-e494c93e380e",
    "type": "categories",
    "attributes": {
      "created_at": "2022-06-01T08:55:41+00:00",
      "updated_at": "2022-06-01T08:55:41+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/categories/1f6c3c5a-86ed-4bcf-9041-a5b5e69643ad' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "1f6c3c5a-86ed-4bcf-9041-a5b5e69643ad",
        "type": "categories",
        "attributes": {
          "name": "Photo cameras"
        }
...
```json
  ...
  "data": {
    ...
    "type": "categories",
    "attributes": {
      "created_at": "2022-06-01T08:55:42+00:00",
      "updated_at": "2022-06-01T08:55:42+00:00",
      "name": "Photo cameras",
      "slug": "cameras",
      "position": 1,
      "show_in_store": true,
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/categories/e8befa94-13bd-4457-9d63-fdd823163385' \
    --header 'content-type: application/json' \
    --data '{
      "includes": "items",
      "data": {
        "id": "e8befa94-13bd-4457-9d63-fdd823163385",
        "type": "categories",
        "attributes": {
          "item_ids": [
            "36270c03-2b0e-420b-b0ef-961b08784fd0",
            "12e32b8c-8d9e-420f-ba28-b0d706c06773"
          ]
        }
      }
    }'
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/categories/01e7a0cc-e119-43bd-8d60-a73bff9421d4' \
    --header 'content-type: application/json' \
    --data '{}'
```
