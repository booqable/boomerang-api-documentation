...
```json
  ...
  "data": [
    {
      "id": "d7b7015c-df3f-47c6-a93c-2b1481688812",
      "created_at": "2022-07-07T11:58:15+00:00",
      "updated_at": "2022-07-07T11:58:15+00:00",
      "name": "Cameras",
      "slug": "cameras",
      "position": 1,
      "show_in_store": true,
  ...
  "meta": {
    "stats": {
      "children": {
        "count_each": {
          "d7b7015c-df3f-47c6-a93c-2b1481688812": 1
        }
      }
    }
  }
...
```json
  {
  "data": {
    "id": "2f0eeeed-3ca9-4887-850a-a96f5e00a797",
    "type": "categories",
    "attributes": {
      "created_at": "2022-07-07T11:58:16+00:00",
      "updated_at": "2022-07-07T11:58:16+00:00",
      "name": "Accesories",
      "slug": "accesories",
      "position": null,
      "show_in_store": true,
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "name": "Nikon",
          "parent_id": "1a276f0c-b95f-4b97-b56f-3ff9e2080715"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "d8cd4756-87a6-4190-8f85-113be4e264b9",
    "type": "categories",
    "attributes": {
      "created_at": "2022-07-07T11:58:17+00:00",
      "updated_at": "2022-07-07T11:58:17+00:00",
      "name": "Nikon",
      "slug": "nikon",
      "position": null,
      "show_in_store": true,
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/categories/7ee9bbc8-e93c-4cf0-97ce-c4d608c6d310' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "7ee9bbc8-e93c-4cf0-97ce-c4d608c6d310",
        "type": "categories",
        "attributes": {
          "name": "Photo cameras"
        }
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/categories/a347aff4-f53c-4e59-b43e-a4b20d9da936' \
    --header 'content-type: application/json' \
    --data '{
      "includes": "items",
      "data": {
        "id": "a347aff4-f53c-4e59-b43e-a4b20d9da936",
        "type": "categories",
        "attributes": {
          "item_ids": [
            "65f3a74f-5ec1-4d0d-95aa-0bffb326699c",
            "79ac9057-6bef-4c17-a50a-e6f8e5fbf97e"
          ]
        }
      }
    }'
...
```json
  ...
  "data": {
    ...
    "type": "categories",
    "attributes": {
      "created_at": "2022-07-07T11:58:18+00:00",
      "updated_at": "2022-07-07T11:58:18+00:00",
      "name": "Cameras",
      "slug": "cameras",
      "position": 1,
      "show_in_store": true,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/categories/7d80834c-a3ca-4ac4-8ff9-b65566eebb3c' \
    --header 'content-type: application/json' \
    --data '{}'
```
