...
```json
  ...
  "data": [
    {
      "id": "c2ff25f1-76d6-49a3-b9d1-b93c2350ec81",
      "created_at": "2022-06-04T09:50:21+00:00",
      "updated_at": "2022-06-04T09:50:21+00:00",
      "name": "Cameras",
      "slug": "cameras",
      "position": 1,
      "show_in_store": true,
  ...
  "meta": {
    "stats": {
      "children": {
        "count_each": {
          "c2ff25f1-76d6-49a3-b9d1-b93c2350ec81": 1
        }
      }
    }
  }
...
```json
  {
  "data": {
    "id": "49699fc4-f8a9-45cf-9b2e-d24d2a49e6a3",
    "type": "categories",
    "attributes": {
      "created_at": "2022-06-04T09:50:21+00:00",
      "updated_at": "2022-06-04T09:50:21+00:00",
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "name": "Nikon",
          "parent_id": "6146ec4e-1f3f-4957-963b-81dc4c0eccc4"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "0c2be5ad-4d5c-4d4e-85a2-6e2e163f260f",
    "type": "categories",
    "attributes": {
      "created_at": "2022-06-04T09:50:21+00:00",
      "updated_at": "2022-06-04T09:50:21+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/categories/f6acf0cf-9a1a-4520-9374-8a44af71f777' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "f6acf0cf-9a1a-4520-9374-8a44af71f777",
        "type": "categories",
        "attributes": {
          "name": "Photo cameras"
        }
...
```json
  ...
  "data": {
    ...
    "attributes": {
      "created_at": "2022-06-04T09:50:21+00:00",
      "updated_at": "2022-06-04T09:50:22+00:00",
      "name": "Photo cameras",
      "slug": "cameras",
      "position": 1,
      "show_in_store": true,
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/categories/d11fd1bc-75f1-40d3-9268-eabd29ec75a0' \
    --header 'content-type: application/json' \
    --data '{
      "includes": "items",
      "data": {
        "id": "d11fd1bc-75f1-40d3-9268-eabd29ec75a0",
        "type": "categories",
        "attributes": {
          "item_ids": [
            "a265056b-0f52-4535-b928-92ab5045c74c",
            "418102a8-7cb4-471c-b30e-9b53eb826c9e"
          ]
        }
      }
    }'
...
```json
  ...
  "data": {
    ...
    "type": "categories",
    "attributes": {
      "created_at": "2022-06-04T09:50:22+00:00",
      "updated_at": "2022-06-04T09:50:22+00:00",
      "name": "Cameras",
      "slug": "cameras",
      "position": 1,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/categories/9d6f7e1b-3e72-4c4c-92e6-2137c0cbfd0c' \
    --header 'content-type: application/json' \
    --data '{}'
```
