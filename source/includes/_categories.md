...
```json
  ...
  "data": [
    {
      "id": "cedecf05-0121-4218-bc67-19ccdb045ceb",
  ...
  "meta": {
    "stats": {
      "children": {
        "count_each": {
          "cedecf05-0121-4218-bc67-19ccdb045ceb": 1
        }
      }
    }
  }
...
```json
  {
  "data": {
    "id": "b0fde355-43e7-473b-8c5a-7f103a7fc10a",
    "type": "categories",
    "attributes": {
      "created_at": "2022-06-24T14:45:11+00:00",
      "updated_at": "2022-06-24T14:45:11+00:00",
      "name": "Accesories",
      "slug": "accesories",
      "position": null,
      "show_in_store": true,
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "name": "Nikon",
          "parent_id": "1dcd8386-28d5-4014-81f7-f6a44cce2385"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "c5eb4c77-2b61-4580-930f-5d9fabce0606",
    "type": "categories",
    "attributes": {
      "created_at": "2022-06-24T14:45:11+00:00",
      "updated_at": "2022-06-24T14:45:11+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/categories/33f21398-4403-4e4e-82eb-04974ff4037c' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "33f21398-4403-4e4e-82eb-04974ff4037c",
        "type": "categories",
        "attributes": {
          "name": "Photo cameras"
        }
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/categories/9df262b9-ac83-4fae-9612-257aeb4a4be1' \
    --header 'content-type: application/json' \
    --data '{
      "includes": "items",
      "data": {
        "id": "9df262b9-ac83-4fae-9612-257aeb4a4be1",
        "type": "categories",
        "attributes": {
          "item_ids": [
            "85462761-1cdf-4300-978d-75e9df843040",
            "fec551cd-fbf2-4875-8779-856b65fd68e3"
          ]
        }
      }
    }'
...
```json
  ...
  "data": {
    ...
    "type": "categories",
    "attributes": {
      "created_at": "2022-06-24T14:45:12+00:00",
      "updated_at": "2022-06-24T14:45:12+00:00",
      "name": "Cameras",
      "slug": "cameras",
      "position": 1,
      "show_in_store": true,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/categories/e93152ca-92d4-4fe8-89ee-1d0afb6eca7d' \
    --header 'content-type: application/json' \
    --data '{}'
```
