...
```json
  ...
  "data": [
    {
      "id": "6e9ad4e8-84d6-4d2c-9cd3-eb2bc48abb7f",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2023-02-03T11:12:20+00:00",
        "updated_at": "2023-02-03T11:12:20+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/7d2f461d-c4c6-4a46-bdbe-2d631ab06ed4' \
    --header 'content-type: application/json' \
```
