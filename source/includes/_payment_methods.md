...
```json
  ...
  "data": [
    {
      "id": "8352d6b7-c9e9-4b28-adb4-11265f5ef5f7",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2022-06-09T12:39:36+00:00",
        "updated_at": "2022-06-09T12:39:36+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/77dd719d-d80b-4d0e-88a4-1cb8739ad8de' \
    --header 'content-type: application/json' \
```
