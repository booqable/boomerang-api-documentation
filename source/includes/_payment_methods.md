...
```json
  ...
  "data": [
    {
      "id": "8dac1458-0d3a-4054-b3f3-72ae05192775",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2023-02-08T15:21:00+00:00",
        "updated_at": "2023-02-08T15:21:00+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/349d1e65-b786-4643-be88-a3d123f9e46c' \
    --header 'content-type: application/json' \
```
