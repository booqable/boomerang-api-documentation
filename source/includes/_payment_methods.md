...
```json
  ...
  "data": [
    {
      "id": "c78e5082-31bc-4ef4-a133-3026ba184855",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2022-09-16T12:14:18+00:00",
        "updated_at": "2022-09-16T12:14:18+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/07436a89-e4bc-47cb-ab40-746f69bb82a7' \
    --header 'content-type: application/json' \
```
