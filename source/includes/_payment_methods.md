...
```json
  ...
  "data": [
    {
      "id": "a4dc21a6-81a6-48c6-b16c-7931db7a2a28",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2022-12-19T08:48:33+00:00",
        "updated_at": "2022-12-19T08:48:33+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/1ce5e809-3ec2-4e3d-9c73-a886772f486f' \
    --header 'content-type: application/json' \
```
