...
```json
  ...
  "data": [
    {
      "id": "8c12f853-9e05-43f4-a5dc-a3f82ae102f2",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2022-05-19T14:24:00+00:00",
        "updated_at": "2022-05-19T14:24:00+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/17af70d3-01b6-4331-847f-c1adfb7b25c7' \
    --header 'content-type: application/json' \
```
