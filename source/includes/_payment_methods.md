...
```json
  ...
  "data": [
    {
      "id": "0f949793-bc8e-4e1f-8eee-8fed786a07b2",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2023-02-02T11:18:01+00:00",
        "updated_at": "2023-02-02T11:18:01+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/dea43607-1a14-4e88-90ee-0e5438ccc58d' \
    --header 'content-type: application/json' \
```
