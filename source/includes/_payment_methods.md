...
```json
  ...
  "data": [
    {
      "id": "50fff4cb-a0d5-4811-b29a-6bc24ee2cf27",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2023-02-02T14:16:47+00:00",
        "updated_at": "2023-02-02T14:16:47+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/72245d58-0439-4662-a92f-acd4a89580e2' \
    --header 'content-type: application/json' \
```
