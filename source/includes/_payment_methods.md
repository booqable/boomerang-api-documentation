...
```json
  ...
  "data": [
    {
      "id": "7dcf526a-ef90-4cc9-85bf-ec615b526d71",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2023-02-02T08:04:04+00:00",
        "updated_at": "2023-02-02T08:04:04+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/446927d0-1fd4-4857-9fb9-06f0a60baa77' \
    --header 'content-type: application/json' \
```
