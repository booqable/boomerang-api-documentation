...
```json
  ...
  "data": [
    {
      "id": "efea4a20-e58f-4e6d-8e24-871520996de7",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2022-11-02T10:21:09+00:00",
        "updated_at": "2022-11-02T10:21:09+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/45e63f13-c1c8-4f00-b951-166319dfca3a' \
    --header 'content-type: application/json' \
```
