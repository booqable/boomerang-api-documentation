...
```json
  ...
  "data": [
    {
      "id": "d6de3c7e-f3ad-47c1-8d61-cd397f56b2b5",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2023-02-28T11:28:31+00:00",
        "updated_at": "2023-02-28T11:28:31+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/7e282afd-a447-41b5-a876-54d6cf1de930' \
    --header 'content-type: application/json' \
```
