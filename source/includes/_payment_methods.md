...
```json
  ...
  "data": [
    {
      "id": "561ddc8e-ae4e-46f2-a9cb-12139e3b56aa",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2023-03-07T08:29:45+00:00",
        "updated_at": "2023-03-07T08:29:45+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/3734a982-df77-4084-a88b-5d04fab8d077' \
    --header 'content-type: application/json' \
```
