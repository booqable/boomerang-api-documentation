...
```json
  ...
  "data": [
    {
      "id": "ae16a915-b3e3-4cfb-823c-7455b97cd049",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2022-11-16T14:25:00+00:00",
        "updated_at": "2022-11-16T14:25:00+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/1b5f9f55-7bfc-42c5-89be-26b31f0bb46d' \
    --header 'content-type: application/json' \
```
