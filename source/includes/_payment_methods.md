...
```json
  ...
  "data": [
    {
      "id": "27e8f835-0b75-4443-8e21-2e97d7db7460",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2023-02-21T16:24:08+00:00",
        "updated_at": "2023-02-21T16:24:08+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/7f3f8b61-972b-44c3-8ec5-c3d22d857646' \
    --header 'content-type: application/json' \
```
