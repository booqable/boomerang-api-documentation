...
```json
  ...
  "data": [
    {
      "id": "ce83a683-acd9-4ce4-b0a1-356741ed576d",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2022-01-06T14:34:07+00:00",
        "updated_at": "2022-01-06T14:34:07+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/6da14084-5cb1-4d97-8210-47ee332e01ac' \
    --header 'content-type: application/json' \
```
