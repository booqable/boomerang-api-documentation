...
```json
  ...
  "data": [
    {
      "id": "29909b7d-7e4d-4982-9ed6-b1d4a8e14038",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2023-02-20T11:48:46+00:00",
        "updated_at": "2023-02-20T11:48:46+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/25cb74a8-0bad-4971-9706-387f780f8fe1' \
    --header 'content-type: application/json' \
```
