...
```json
  ...
  "data": [
    {
      "id": "515117f0-a786-4c47-98cb-dca331528f29",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2022-11-22T14:35:15+00:00",
        "updated_at": "2022-11-22T14:35:15+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/5e8a112a-9f36-4339-84fe-cd82f1d91016' \
    --header 'content-type: application/json' \
```
