...
```json
  ...
  "data": [
    {
      "id": "1d71f693-1400-45ef-b61f-ef2ec6cbe754",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2023-02-03T08:16:30+00:00",
        "updated_at": "2023-02-03T08:16:30+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/c15ffe77-c126-40d9-9bfc-eb78103e8e65' \
    --header 'content-type: application/json' \
```
