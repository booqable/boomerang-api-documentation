...
```json
  ...
  "data": [
    {
      "id": "0a07892a-f7bf-4b47-bad2-ced8cf025e65",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2022-11-17T10:18:51+00:00",
        "updated_at": "2022-11-17T10:18:51+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/1b5a78eb-fe07-49cc-9eff-0947f0680404' \
    --header 'content-type: application/json' \
```
