...
```json
  ...
  "data": [
    {
      "id": "7da5fd9c-4342-4e27-9be0-400390a26c3d",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2023-02-09T11:09:09+00:00",
        "updated_at": "2023-02-09T11:09:09+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/998733dd-b68f-49d0-9b52-a405d9147dcf' \
    --header 'content-type: application/json' \
```
