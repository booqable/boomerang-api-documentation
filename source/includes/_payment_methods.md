...
```json
  ...
  "data": [
    {
      "id": "1ad192a5-99ed-462d-bb42-9141f6c2148d",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2022-06-30T08:47:23+00:00",
        "updated_at": "2022-06-30T08:47:23+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/0c74830e-af22-44e7-8f82-35d0498fe0da' \
    --header 'content-type: application/json' \
```
