...
```json
  ...
  "data": [
    {
      "id": "b94923b3-2e09-48a5-ad27-ca3d368a22d8",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2023-03-01T14:50:35+00:00",
        "updated_at": "2023-03-01T14:50:35+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/a8feeef5-4fbe-4957-8312-85d1cb33411f' \
    --header 'content-type: application/json' \
```
