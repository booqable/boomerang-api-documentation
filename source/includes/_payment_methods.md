...
```json
  ...
  "data": [
    {
      "id": "1bd751ee-b282-4e6e-8637-fec5ef82b694",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2023-02-02T19:28:42+00:00",
        "updated_at": "2023-02-02T19:28:42+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/3cca89bf-9951-4ae8-8b95-42164ff7effe' \
    --header 'content-type: application/json' \
```
