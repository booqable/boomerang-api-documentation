...
```json
  ...
  "data": [
    {
      "id": "4266233a-5a78-4fbe-892d-afceb95de430",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2021-11-17T09:30:45+00:00",
        "updated_at": "2021-11-17T09:30:45+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/660cb98c-c669-462f-afaf-958ebe518534' \
    --header 'content-type: application/json' \
```
