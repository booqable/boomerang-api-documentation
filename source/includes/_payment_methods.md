...
```json
  ...
  "data": [
    {
      "id": "f92399f0-e899-44c7-a789-20da95ae01fe",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2023-03-09T10:29:48+00:00",
        "updated_at": "2023-03-09T10:29:48+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/e38435a7-78c2-44b5-8f0c-05b1595b1247' \
    --header 'content-type: application/json' \
```
