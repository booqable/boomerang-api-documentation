...
```json
  ...
  "data": [
    {
      "id": "8e383d0d-95be-4d8c-9180-dc9e27d63d6e",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2023-02-09T14:24:44+00:00",
        "updated_at": "2023-02-09T14:24:44+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/15ebd59a-a420-47cd-b291-cacde058ecfa' \
    --header 'content-type: application/json' \
```
