...
```json
  ...
  "data": [
    {
      "id": "427d74e9-d0cd-4af3-83fc-deeff4d4bc12",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2023-03-09T09:36:16+00:00",
        "updated_at": "2023-03-09T09:36:16+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/31814b10-17c4-4e82-870d-5f252ecd2af0' \
    --header 'content-type: application/json' \
```
