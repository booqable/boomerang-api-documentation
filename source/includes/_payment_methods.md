...
```json
  ...
  "data": [
    {
      "id": "5421ba7c-d9b6-459e-a670-5276a75bd6c4",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2022-04-13T06:35:32+00:00",
        "updated_at": "2022-04-13T06:35:32+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/85f739b3-ebea-4c31-a6e2-9a7eecf220c7' \
    --header 'content-type: application/json' \
```
