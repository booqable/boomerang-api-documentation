...
```json
  ...
  "data": [
    {
      "id": "4176fb9a-1f53-4096-97c1-fdd69808af0e",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2022-10-25T17:54:02+00:00",
        "updated_at": "2022-10-25T17:54:02+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/dc1a7070-1a3e-4eed-8822-63754b87d3ad' \
    --header 'content-type: application/json' \
```
