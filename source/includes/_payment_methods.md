...
```json
  ...
  "data": [
    {
      "id": "bec48942-738d-4030-a8bc-80b6decd57cc",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2023-02-28T08:13:28+00:00",
        "updated_at": "2023-02-28T08:13:28+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/758e21be-8714-40f7-883a-b995c8cc05e5' \
    --header 'content-type: application/json' \
```
