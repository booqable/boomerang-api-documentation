...
```json
  ...
  "data": [
    {
      "id": "83dc1134-c203-4eef-bf58-771122b0e7d8",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2023-02-08T09:47:13+00:00",
        "updated_at": "2023-02-08T09:47:13+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/4c94c18c-f8e5-42f7-ac26-378599f51ecd' \
    --header 'content-type: application/json' \
```
