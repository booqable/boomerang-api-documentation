...
```json
  ...
  "data": [
    {
      "id": "79450713-2119-4142-9b4d-ded0bb911401",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2023-02-14T11:08:33+00:00",
        "updated_at": "2023-02-14T11:08:33+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/cd7bd136-adac-4ac0-a48f-c6bc0b21daa7' \
    --header 'content-type: application/json' \
```
