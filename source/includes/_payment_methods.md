...
```json
  ...
  "data": [
    {
      "id": "a974aa6d-fdd5-4c15-9c4b-c1dfd27fbb9d",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2023-02-07T10:29:53+00:00",
        "updated_at": "2023-02-07T10:29:53+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/9e35466d-91bf-4ce6-9755-4e1e99ff780a' \
    --header 'content-type: application/json' \
```
