...
```json
  ...
  "data": [
    {
      "id": "5df9728a-ff52-4dcc-b700-19858edc5550",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2023-02-07T16:06:46+00:00",
        "updated_at": "2023-02-07T16:06:46+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/395f769e-084d-4b4e-a0e3-6e688966e319' \
    --header 'content-type: application/json' \
```
