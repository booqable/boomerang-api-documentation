...
```json
  ...
  "data": [
    {
      "id": "2946614e-f3db-4a41-8f82-228e9c12aaba",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2022-10-25T18:51:17+00:00",
        "updated_at": "2022-10-25T18:51:17+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/ed1f5447-661d-4343-aa71-67752aa5ebf1' \
    --header 'content-type: application/json' \
```
