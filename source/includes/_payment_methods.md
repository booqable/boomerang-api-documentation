...
```json
  ...
  "data": [
    {
      "id": "e01e0e4d-feda-4dd3-aa70-093b3d79121e",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2022-07-21T10:58:57+00:00",
        "updated_at": "2022-07-21T10:58:57+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/3dbecc36-69a0-4277-91a6-69ce4f6e3d9a' \
    --header 'content-type: application/json' \
```
