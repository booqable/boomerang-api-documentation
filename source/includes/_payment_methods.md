...
```json
  ...
  "data": [
    {
      "id": "ca402896-4341-4e7f-bfad-85383461805a",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2023-02-07T14:35:32+00:00",
        "updated_at": "2023-02-07T14:35:32+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/271f6bb7-af6a-44c7-acad-e13290bb6176' \
    --header 'content-type: application/json' \
```
