...
```json
  ...
  "data": [
    {
      "id": "ebed531f-8f19-4fd4-bcbc-be05daf1e757",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2022-07-12T14:16:07+00:00",
        "updated_at": "2022-07-12T14:16:07+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/56c08978-83c4-4050-b043-f5279b16808d' \
    --header 'content-type: application/json' \
```
