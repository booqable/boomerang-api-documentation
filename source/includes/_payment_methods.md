...
```json
  ...
  "data": [
    {
      "id": "373e4e09-b485-43f3-a947-d934eac8dcc7",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2023-01-26T10:22:29+00:00",
        "updated_at": "2023-01-26T10:22:29+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/df02ae1c-4a15-4e2f-b7b1-007628e66788' \
    --header 'content-type: application/json' \
```
