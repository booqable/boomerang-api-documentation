...
```json
  ...
  "data": [
    {
      "id": "d2fd91ba-18a7-4c11-b983-8d86c4bed8b1",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2022-10-07T11:58:10+00:00",
        "updated_at": "2022-10-07T11:58:10+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/e0fec2d7-40b0-44fa-aacf-0eb816de42cc' \
    --header 'content-type: application/json' \
```
