...
```json
  ...
  "data": [
    {
      "id": "061a5133-b2fc-4b00-a374-40b056ae9e02",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2022-05-05T09:14:22+00:00",
        "updated_at": "2022-05-05T09:14:22+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/811a838d-8650-4f4b-9d75-7ef7c128a35c' \
    --header 'content-type: application/json' \
```
