...
```json
  ...
  "data": [
    {
      "id": "1040f6d0-86a5-4ec8-b823-f64539ae0f52",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2023-03-07T11:37:22+00:00",
        "updated_at": "2023-03-07T11:37:22+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/73061fb8-3e04-45f8-a616-6b885f52b25c' \
    --header 'content-type: application/json' \
```
