...
```json
  ...
  "data": [
    {
      "id": "eeddb436-ac78-482a-8763-37d7ff6a4860",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2023-01-12T14:29:01+00:00",
        "updated_at": "2023-01-12T14:29:01+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/190a3bf7-cf94-4b1e-8364-c5987ef47be2' \
    --header 'content-type: application/json' \
```
