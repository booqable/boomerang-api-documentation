...
```json
  ...
  "data": [
    {
      "id": "238d80b9-a9f9-461a-81fb-3b321ec174ca",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2022-07-12T08:49:06+00:00",
        "updated_at": "2022-07-12T08:49:06+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/f1499529-0b90-469e-9c6e-96d051381d88' \
    --header 'content-type: application/json' \
```
