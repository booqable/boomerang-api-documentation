...
```json
  ...
  "data": [
    {
      "id": "315b632f-3f84-4b4c-8935-0bdbe7df4081",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2023-01-10T14:08:34+00:00",
        "updated_at": "2023-01-10T14:08:34+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/b43c8c19-b042-48cc-8985-7037ae3f2bf7' \
    --header 'content-type: application/json' \
```
