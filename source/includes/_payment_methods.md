...
```json
  ...
  "data": [
    {
      "id": "7b39dc9d-c18f-4db7-90e4-9676bce8bab0",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2022-06-24T14:46:55+00:00",
        "updated_at": "2022-06-24T14:46:55+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/56400ae1-3828-476d-b59d-1cca3ca1cb0d' \
    --header 'content-type: application/json' \
```
