...
```json
  ...
  "data": [
    {
      "id": "9fbeb803-ab28-467f-b000-5fccdb331e1c",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2023-02-16T09:17:07+00:00",
        "updated_at": "2023-02-16T09:17:07+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/58c5e2fc-9e3f-47c9-ad5d-c894810bfc91' \
    --header 'content-type: application/json' \
```
