...
```json
  ...
  "data": [
    {
      "id": "205bedd9-da2c-442d-8ea1-ab9c7739b2a9",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2023-02-08T15:01:28+00:00",
        "updated_at": "2023-02-08T15:01:28+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/cbb5e682-d6af-41a3-a9dd-73b9a6fb9f80' \
    --header 'content-type: application/json' \
```
