...
```json
  ...
  "data": [
    {
      "id": "328f8b22-7884-4f61-b798-2725b523f0ef",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2022-06-30T09:46:12+00:00",
        "updated_at": "2022-06-30T09:46:12+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/69884259-8de3-4ad6-ba7f-974290bbd04b' \
    --header 'content-type: application/json' \
```
