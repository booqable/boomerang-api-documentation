...
```json
  ...
  "data": [
    {
      "id": "3ba57de6-5366-492b-8dfa-01565418decb",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2022-01-20T12:34:32+00:00",
        "updated_at": "2022-01-20T12:34:32+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/e68f28a8-cbcf-4e24-91b0-a18609022047' \
    --header 'content-type: application/json' \
```
