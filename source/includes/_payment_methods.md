...
```json
  ...
  "data": [
    {
      "id": "ff7923ca-6c0a-4538-ab1a-f35a8940a094",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2023-03-02T09:26:17+00:00",
        "updated_at": "2023-03-02T09:26:17+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/09a0138a-59dd-4c23-84bf-ee13e9919b49' \
    --header 'content-type: application/json' \
```
