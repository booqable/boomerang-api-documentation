...
```json
  ...
  "data": [
    {
      "id": "9bf842c0-d2e5-4b52-bc16-d1a4c1c9d9a6",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2023-03-09T13:51:29+00:00",
        "updated_at": "2023-03-09T13:51:29+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/1817f7a9-349d-4160-bd00-f753b64756db' \
    --header 'content-type: application/json' \
```
