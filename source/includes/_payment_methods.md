...
```json
  ...
  "data": [
    {
      "id": "05d4e08a-4ead-466a-9d7e-a32f514e8eb5",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2022-11-30T08:59:48+00:00",
        "updated_at": "2022-11-30T08:59:48+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/26c4f7e6-c5aa-4e54-8b52-c22282730a58' \
    --header 'content-type: application/json' \
```
