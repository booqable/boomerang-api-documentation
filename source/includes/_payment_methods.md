...
```json
  ...
  "data": [
    {
      "id": "42af903d-b590-4814-9223-06fbd53b85d4",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2023-01-19T10:47:47+00:00",
        "updated_at": "2023-01-19T10:47:47+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/1ddc5dbd-20e3-438c-90fd-93d75e192e0f' \
    --header 'content-type: application/json' \
```
