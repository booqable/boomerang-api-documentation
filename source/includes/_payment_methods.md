...
```json
  ...
  "data": [
    {
      "id": "e3c282d4-f3f6-458f-adeb-7a40a917dec9",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2023-02-24T08:45:23+00:00",
        "updated_at": "2023-02-24T08:45:23+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/998e92a5-3055-4ed8-8aaa-0411862956bd' \
    --header 'content-type: application/json' \
```
