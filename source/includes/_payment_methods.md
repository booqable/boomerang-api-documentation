...
```json
  ...
  "data": [
    {
      "id": "345fed21-8e7e-4e76-9262-dd95e60d9a84",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2023-02-09T15:57:34+00:00",
        "updated_at": "2023-02-09T15:57:34+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/dbcea6b7-0a26-4111-8083-5dfbbe251298' \
    --header 'content-type: application/json' \
```
