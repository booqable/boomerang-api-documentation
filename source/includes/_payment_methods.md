...
```json
  ...
  "data": [
    {
      "id": "a4e41be6-e5bb-4b86-b2dd-ecc8a486b763",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2023-03-01T17:39:41+00:00",
        "updated_at": "2023-03-01T17:39:41+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/67ae7a92-7431-4410-8b64-98956e6e6564' \
    --header 'content-type: application/json' \
```
