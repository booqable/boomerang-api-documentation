...
```json
  ...
  "data": [
    {
      "id": "67c3e7ec-ef74-475d-ab13-61dc4d8777b5",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2022-07-13T11:20:18+00:00",
        "updated_at": "2022-07-13T11:20:18+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/753b6680-fcb0-46f2-a202-0c585ac2295d' \
    --header 'content-type: application/json' \
```
