...
```json
  ...
  "data": [
    {
      "id": "bf77cc48-0785-457d-8c28-cda6fbad82be",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2023-02-21T12:18:14+00:00",
        "updated_at": "2023-02-21T12:18:14+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/44a5f2ef-5ae9-4bda-be72-6634e3bbfced' \
    --header 'content-type: application/json' \
```
