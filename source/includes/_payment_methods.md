...
```json
  ...
  "data": [
    {
      "id": "9eb96d7b-cd1c-4807-8c31-cfffff0af394",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2023-03-08T09:21:01+00:00",
        "updated_at": "2023-03-08T09:21:01+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/2008df86-d782-4877-a665-f474882e1ffd' \
    --header 'content-type: application/json' \
```
