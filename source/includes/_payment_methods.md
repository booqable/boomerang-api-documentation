...
```json
  ...
  "data": [
    {
      "id": "e8a71f3c-a1d3-454b-b6c2-1103f90eef30",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2023-02-24T09:49:52+00:00",
        "updated_at": "2023-02-24T09:49:52+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/5614060f-9854-4b8f-95f3-c72145a3f4f1' \
    --header 'content-type: application/json' \
```
