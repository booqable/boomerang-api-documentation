...
```json
  ...
  "data": [
    {
      "id": "6f700ca1-c002-4f6e-ab36-56e8e65cc8d0",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2022-11-22T15:34:51+00:00",
        "updated_at": "2022-11-22T15:34:51+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/85dd7223-abd5-4e8b-98ce-a88b7d66b7f6' \
    --header 'content-type: application/json' \
```
