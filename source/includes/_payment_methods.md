...
```json
  ...
  "data": [
    {
      "id": "1f21c056-acb8-41d5-9675-6617a7d16bbd",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2022-12-09T08:14:55+00:00",
        "updated_at": "2022-12-09T08:14:55+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/c7971425-f04c-4d62-a698-711fe11e581c' \
    --header 'content-type: application/json' \
```
