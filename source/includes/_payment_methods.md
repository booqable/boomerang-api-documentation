...
```json
  ...
  "data": [
    {
      "id": "556d7843-97b9-4cb6-8404-ba2c759f10a5",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2021-12-13T08:15:03+00:00",
        "updated_at": "2021-12-13T08:15:03+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/781749f0-a4fa-40a0-8b4d-1c8602dacdc1' \
    --header 'content-type: application/json' \
```
