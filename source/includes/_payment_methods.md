...
```json
  ...
  "data": [
    {
      "id": "9416fbbd-d023-453a-940a-dfe5f1466348",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2022-06-04T09:51:45+00:00",
        "updated_at": "2022-06-04T09:51:45+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/e86ba66d-e1a8-4990-899c-4d05930635f0' \
    --header 'content-type: application/json' \
```
