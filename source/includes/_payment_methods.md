...
```json
  ...
  "data": [
    {
      "id": "211d24bc-2e86-4d7e-b295-1199a406e788",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2022-05-24T07:25:15+00:00",
        "updated_at": "2022-05-24T07:25:15+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/78d1c30f-9be4-4fae-aecf-8b7ffdf732bf' \
    --header 'content-type: application/json' \
```
