...
```json
  ...
  "data": [
    {
      "id": "a7911339-d2ae-461d-a3f4-65ca99ccc979",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2022-12-08T11:05:27+00:00",
        "updated_at": "2022-12-08T11:05:27+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/9f00c043-b29f-41f6-b057-537102ab1599' \
    --header 'content-type: application/json' \
```
