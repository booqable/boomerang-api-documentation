...
```json
  ...
  "data": [
    {
      "id": "ce04db31-767d-4bec-b707-05aa532242f9",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2022-05-24T07:46:57+00:00",
        "updated_at": "2022-05-24T07:46:57+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/260e8cdc-9699-409b-b255-4f7adac04f5e' \
    --header 'content-type: application/json' \
```
