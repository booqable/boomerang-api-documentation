...
```json
  ...
  "data": [
    {
      "id": "f0280a02-9bc8-41e8-a173-e04975231c19",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2022-03-17T10:04:00+00:00",
        "updated_at": "2022-03-17T10:04:00+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/ad1451b9-8256-4605-8875-c7e269e3311d' \
    --header 'content-type: application/json' \
```
