...
```json
  ...
  "data": [
    {
      "id": "557c8e96-c1f5-4a78-9464-d314d1f00245",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2022-01-13T13:10:40+00:00",
        "updated_at": "2022-01-13T13:10:40+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/11698c3d-de79-4e4b-8124-35e6b3c864fe' \
    --header 'content-type: application/json' \
```
