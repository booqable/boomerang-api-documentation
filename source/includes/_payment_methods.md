...
```json
  ...
  "data": [
    {
      "id": "88c1e036-8333-4607-8ca8-0dca4d390c34",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2023-02-01T13:34:05+00:00",
        "updated_at": "2023-02-01T13:34:05+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/d5d462b0-01b9-403c-9986-69b2a6a88839' \
    --header 'content-type: application/json' \
```
