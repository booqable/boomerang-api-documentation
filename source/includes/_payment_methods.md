...
```json
  ...
  "data": [
    {
      "id": "327c4ea6-506f-4323-aec0-1ce28f4fe899",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2023-03-08T15:26:03+00:00",
        "updated_at": "2023-03-08T15:26:03+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/162cafac-4fd0-4567-9573-a3892c047fe4' \
    --header 'content-type: application/json' \
```
