...
```json
  ...
  "data": [
    {
      "id": "4c1de5b6-f987-432a-ad00-f7f7447bf51b",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2022-10-25T16:32:39+00:00",
        "updated_at": "2022-10-25T16:32:39+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/db579524-1f3a-4d33-b252-bbfc1d67d65a' \
    --header 'content-type: application/json' \
```
