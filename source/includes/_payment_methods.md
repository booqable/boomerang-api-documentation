...
```json
  ...
  "data": [
    {
      "id": "9698c887-2cd7-49ae-903b-265ce3f03752",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2023-02-21T10:50:37+00:00",
        "updated_at": "2023-02-21T10:50:37+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/b763736a-0de6-4619-b3c8-de2314baaf2d' \
    --header 'content-type: application/json' \
```
