...
```json
  ...
  "data": [
    {
      "id": "8add01c2-be6e-4bc3-9946-21dc18a6832f",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2022-07-08T11:45:57+00:00",
        "updated_at": "2022-07-08T11:45:57+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/0552b9b9-a39b-43db-b4d5-81f1078b9ab5' \
    --header 'content-type: application/json' \
```
