...
```json
  ...
  "data": [
    {
      "id": "3f501d06-2bda-4794-8219-40c5b18e96f0",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2023-02-22T11:54:34+00:00",
        "updated_at": "2023-02-22T11:54:34+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/cbab6827-6495-4eed-8908-814c4d9dbfa0' \
    --header 'content-type: application/json' \
```
