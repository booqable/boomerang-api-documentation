...
```json
  ...
  "data": [
    {
      "id": "acdedf31-fc35-416c-8b5c-621904c28205",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2022-11-08T13:54:51+00:00",
        "updated_at": "2022-11-08T13:54:51+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/99495a97-0867-4b40-9aa9-ce419b505834' \
    --header 'content-type: application/json' \
```
