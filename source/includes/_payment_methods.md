...
```json
  ...
  "data": [
    {
      "id": "a8d94a8d-3849-419d-b459-5f35d8c4c781",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2023-02-13T16:02:45+00:00",
        "updated_at": "2023-02-13T16:02:45+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/5cd70bac-5ca9-4ce9-a48f-b1288309a4ff' \
    --header 'content-type: application/json' \
```
