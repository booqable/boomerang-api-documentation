...
```json
  ...
  "data": [
    {
      "id": "b199a989-8eb2-4aca-a9b7-ca19a1c119da",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2022-06-08T08:06:39+00:00",
        "updated_at": "2022-06-08T08:06:39+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/618f044c-aace-48e0-9959-685c2d93608a' \
    --header 'content-type: application/json' \
```
