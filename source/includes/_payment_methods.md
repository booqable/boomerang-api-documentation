...
```json
  ...
  "data": [
    {
      "id": "889f3d56-b18f-417d-b962-c2676f8ab463",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2023-02-24T08:55:12+00:00",
        "updated_at": "2023-02-24T08:55:12+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/15de689e-b3cf-404b-aaac-95de744d6aa7' \
    --header 'content-type: application/json' \
```
