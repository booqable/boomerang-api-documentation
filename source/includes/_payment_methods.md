...
```json
  ...
  "data": [
    {
      "id": "cc818805-75ba-4f4e-9573-7f8d5ea58d73",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2023-02-20T10:25:43+00:00",
        "updated_at": "2023-02-20T10:25:43+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/af9aef9b-294e-4ecd-9025-ac165692c35f' \
    --header 'content-type: application/json' \
```
