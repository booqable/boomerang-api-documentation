...
```json
  ...
  "data": [
    {
      "id": "ac2689eb-37ba-4f0e-9ad9-e4eb006753c2",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2023-03-07T08:11:18+00:00",
        "updated_at": "2023-03-07T08:11:18+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/34300ad2-101e-41da-85fb-57478e09a1a4' \
    --header 'content-type: application/json' \
```
