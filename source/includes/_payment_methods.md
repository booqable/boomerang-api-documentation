...
```json
  ...
  "data": [
    {
      "id": "88382625-83c5-49b0-a573-a791f612e92e",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2023-02-03T09:54:15+00:00",
        "updated_at": "2023-02-03T09:54:15+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/350e2674-2fa7-403d-a55f-2765ff1e0c28' \
    --header 'content-type: application/json' \
```
