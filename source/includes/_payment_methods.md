...
```json
  ...
  "data": [
    {
      "id": "89337ad7-af4c-4ca6-b08d-656db844ad55",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2023-02-15T13:24:17+00:00",
        "updated_at": "2023-02-15T13:24:17+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/0f9dc12e-48da-41ee-b81f-3ed77451c81b' \
    --header 'content-type: application/json' \
```
