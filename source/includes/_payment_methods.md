...
```json
  ...
  "data": [
    {
      "id": "1ce49654-df68-4fd8-b925-7cf2f4a87ed9",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2023-02-07T14:52:42+00:00",
        "updated_at": "2023-02-07T14:52:42+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/d60b99bb-78f8-4f1a-b70b-5a8ff9cbfb0d' \
    --header 'content-type: application/json' \
```
