...
```json
  ...
  "data": [
    {
      "id": "bba28957-f4a9-454d-b255-fd1f0f3c6694",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2022-10-05T11:37:19+00:00",
        "updated_at": "2022-10-05T11:37:19+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/e7d25637-3fc2-4e8c-a12a-3cf63412877b' \
    --header 'content-type: application/json' \
```
