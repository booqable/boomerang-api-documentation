...
```json
  ...
  "data": [
    {
      "id": "82d56bbc-6ab1-47a5-aafc-7b4be52e566d",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2022-10-25T15:54:27+00:00",
        "updated_at": "2022-10-25T15:54:27+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/48cfb046-57f8-4416-8ad0-665cc150d0de' \
    --header 'content-type: application/json' \
```
