...
```json
  ...
  "data": [
    {
      "id": "be6ff6e4-bd01-45ea-a670-b3ee896a52e5",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2023-02-01T15:16:53+00:00",
        "updated_at": "2023-02-01T15:16:53+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/84fac378-e344-4a74-b9c2-3499bf2a3260' \
    --header 'content-type: application/json' \
```
