...
```json
  ...
  "data": [
    {
      "id": "73707fbd-6c5d-4f1f-ad89-9bc3c4af154d",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2023-02-23T08:22:25+00:00",
        "updated_at": "2023-02-23T08:22:25+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/0b5dc8c5-b8d5-42c4-9043-6eaf489e1e5a' \
    --header 'content-type: application/json' \
```
