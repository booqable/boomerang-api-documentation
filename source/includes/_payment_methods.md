...
```json
  ...
  "data": [
    {
      "id": "eed63ef8-1c8e-4a20-8009-9ba2c4ee884e",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2022-08-22T15:52:38+00:00",
        "updated_at": "2022-08-22T15:52:38+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/161ed598-25e5-4034-b20e-f3c87ae3b3dd' \
    --header 'content-type: application/json' \
```
