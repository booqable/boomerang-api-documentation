...
```json
  ...
  "data": [
    {
      "id": "47688b76-ae31-4959-b9fb-a70cacefb4de",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2023-02-01T13:02:22+00:00",
        "updated_at": "2023-02-01T13:02:22+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/a33e18f7-dbb7-40a6-afb4-d9179500535b' \
    --header 'content-type: application/json' \
```
