...
```json
  ...
  "data": [
    {
      "id": "ebaed6da-f6a7-478e-971f-b8d7e33f304d",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2022-02-21T07:53:38+00:00",
        "updated_at": "2022-02-21T07:53:38+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/2b5c7699-a056-4913-83b2-08cbb8b6a8e3' \
    --header 'content-type: application/json' \
```
