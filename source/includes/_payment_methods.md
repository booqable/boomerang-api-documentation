...
```json
  ...
  "data": [
    {
      "id": "b1f3dd2e-f022-4921-8e8d-f98222591e08",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2023-02-02T07:57:48+00:00",
        "updated_at": "2023-02-02T07:57:48+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/74d65f12-0748-4469-adbe-191777f31cd9' \
    --header 'content-type: application/json' \
```
