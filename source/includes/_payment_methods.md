...
```json
  ...
  "data": [
    {
      "id": "edbca241-a272-4226-bbcf-ce1a5d9e34d8",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2022-07-14T21:15:27+00:00",
        "updated_at": "2022-07-14T21:15:27+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/83ddeb30-9616-4eb8-9ecf-a8f11bfaf6db' \
    --header 'content-type: application/json' \
```
