...
```json
  ...
  "data": [
    {
      "id": "31532b20-29e4-4960-a714-f54e70b9afaf",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2023-03-02T13:57:33+00:00",
        "updated_at": "2023-03-02T13:57:33+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/4208458c-f287-4948-9e9a-7e3f2407b8cc' \
    --header 'content-type: application/json' \
```
