...
```json
  ...
  "data": [
    {
      "id": "7e4b420d-4cff-4ae0-9864-8a5593171ee0",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2022-05-03T10:19:48+00:00",
        "updated_at": "2022-05-03T10:19:48+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/27b2e928-42da-4cdd-b4ba-cf9ea2c90546' \
    --header 'content-type: application/json' \
```
