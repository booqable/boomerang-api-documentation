...
```json
  ...
  "data": [
    {
      "id": "e2e3e959-d355-46bc-8e76-67d14dc9df16",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2023-02-07T15:19:52+00:00",
        "updated_at": "2023-02-07T15:19:52+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/422e62b7-414d-4835-9d9b-8e5580ff63b7' \
    --header 'content-type: application/json' \
```
