...
```json
  ...
  "data": [
    {
      "id": "a70ce9ba-854a-444d-bf50-c8343eb9b395",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2022-07-18T07:36:25+00:00",
        "updated_at": "2022-07-18T07:36:25+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/0d30b51a-5f68-41ae-988b-94fa04112526' \
    --header 'content-type: application/json' \
```
