...
```json
  ...
  "data": [
    {
      "id": "ac892058-3b7f-4e9b-9d4b-ff5f55bf32bd",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2021-12-15T11:45:11+00:00",
        "updated_at": "2021-12-15T11:45:11+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/2d24e856-2e0b-4e72-8fea-dbc3d9d070da' \
    --header 'content-type: application/json' \
```
