...
```json
  ...
  "data": [
    {
      "id": "d0b7c556-17a6-42d6-918f-64c6ce8a36a5",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2023-01-18T13:37:17+00:00",
        "updated_at": "2023-01-18T13:37:17+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/61929c1d-978a-4748-9875-2e27064d8293' \
    --header 'content-type: application/json' \
```
