...
```json
  ...
  "data": [
    {
      "id": "c176f579-ccb4-4528-9cc3-c3777146d073",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2022-07-14T12:02:17+00:00",
        "updated_at": "2022-07-14T12:02:17+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/e671d6cf-8e29-40b3-8226-9f07b77d6069' \
    --header 'content-type: application/json' \
```
