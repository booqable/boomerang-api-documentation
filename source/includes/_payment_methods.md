...
```json
  ...
  "data": [
    {
      "id": "23f3998b-7f0a-4bb5-b8c4-cec71bd02dce",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2023-02-01T13:21:05+00:00",
        "updated_at": "2023-02-01T13:21:05+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/5e9f5997-6d38-4374-a930-4c327dc27f09' \
    --header 'content-type: application/json' \
```
