...
```json
  ...
  "data": [
    {
      "id": "c7af2825-b6fd-4c8c-998d-c9e43c174bed",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2023-02-02T14:30:07+00:00",
        "updated_at": "2023-02-02T14:30:07+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/159112f8-e2c1-4252-a846-5d87589e382c' \
    --header 'content-type: application/json' \
```
