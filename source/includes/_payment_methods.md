...
```json
  ...
  "data": [
    {
      "id": "61a3ecb5-529d-448c-8280-49ce822aab6f",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2023-02-23T13:38:47+00:00",
        "updated_at": "2023-02-23T13:38:47+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/36f3ef36-fce0-425b-a27a-cec89a3c6d95' \
    --header 'content-type: application/json' \
```
