...
```json
  ...
  "data": [
    {
      "id": "91bb4dcf-185f-4d9e-b2fa-e23a374e9bce",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2022-08-19T07:58:14+00:00",
        "updated_at": "2022-08-19T07:58:14+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/ca0f240e-1330-4a3d-b590-918c4c044df4' \
    --header 'content-type: application/json' \
```
