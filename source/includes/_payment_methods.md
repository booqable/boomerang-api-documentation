...
```json
  ...
  "data": [
    {
      "id": "66d47b5b-70b3-42bc-8a8d-a2e04733427b",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2023-03-06T10:42:27+00:00",
        "updated_at": "2023-03-06T10:42:27+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/2cfc6515-5743-4bf3-8dc4-cb526966ff2a' \
    --header 'content-type: application/json' \
```
