...
```json
  ...
  "data": [
    {
      "id": "875cfd0c-5992-46e4-8dec-cdeac10e4196",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2023-02-10T11:17:38+00:00",
        "updated_at": "2023-02-10T11:17:38+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/b959fa8d-d38a-4b5a-8a2a-13108b8d1fae' \
    --header 'content-type: application/json' \
```
