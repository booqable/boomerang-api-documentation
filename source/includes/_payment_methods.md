...
```json
  ...
  "data": [
    {
      "id": "86f4ac13-5bbc-4722-ad92-ccd58d47f08e",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2022-10-13T14:31:44+00:00",
        "updated_at": "2022-10-13T14:31:44+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/d7e47d66-6f4c-4456-9437-8e6a124d3dad' \
    --header 'content-type: application/json' \
```
