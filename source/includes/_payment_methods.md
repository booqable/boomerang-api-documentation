...
```json
  ...
  "data": [
    {
      "id": "1e2b269a-af69-4ae8-b484-f68085c8e6d3",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2022-06-23T19:02:56+00:00",
        "updated_at": "2022-06-23T19:02:56+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/3bfef21f-7380-43c0-9e10-3a1b6dfbcc09' \
    --header 'content-type: application/json' \
```
