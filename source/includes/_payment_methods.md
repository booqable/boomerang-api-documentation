...
```json
  ...
  "data": [
    {
      "id": "9d283086-63ba-4d6d-8529-20b02e40ce47",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2023-02-02T16:39:26+00:00",
        "updated_at": "2023-02-02T16:39:26+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/6cec0cfe-13ec-45a3-8d23-01a1a88af044' \
    --header 'content-type: application/json' \
```
