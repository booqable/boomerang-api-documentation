...
```json
  ...
  "data": [
    {
      "id": "5a30f850-4de2-4662-97cd-6639c2c41a6d",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2023-02-21T10:58:55+00:00",
        "updated_at": "2023-02-21T10:58:55+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/6dc09cc4-3982-43c0-bce4-3525b0f38c8f' \
    --header 'content-type: application/json' \
```
