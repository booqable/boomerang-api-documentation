...
```json
  ...
  "data": [
    {
      "id": "6bfafc68-0b53-4bd2-9ad3-fd4f04195aca",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2022-01-14T18:54:38+00:00",
        "updated_at": "2022-01-14T18:54:38+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/bbffd63a-34fa-4237-b2a9-c4e277ace8d4' \
    --header 'content-type: application/json' \
```
