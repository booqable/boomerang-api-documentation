...
```json
  ...
  "data": [
    {
      "id": "48bc6767-c1c2-4861-bba1-34c3273f387e",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2023-02-02T16:31:26+00:00",
        "updated_at": "2023-02-02T16:31:26+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/cdac50e0-1eef-46c6-8228-47b0d338a233' \
    --header 'content-type: application/json' \
```
