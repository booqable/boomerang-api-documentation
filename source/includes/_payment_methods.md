...
```json
  ...
  "data": [
    {
      "id": "66ed97fb-5e80-421c-b503-63c38cc63aed",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2023-01-05T13:45:56+00:00",
        "updated_at": "2023-01-05T13:45:56+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/006950e5-a414-4143-9e05-e3f9dc8a5892' \
    --header 'content-type: application/json' \
```
