...
```json
  ...
  "data": [
    {
      "id": "32afaaf6-e4c7-4d7c-a0a7-df6b13ed07dc",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2022-11-16T14:33:42+00:00",
        "updated_at": "2022-11-16T14:33:42+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/192e17e5-8e6e-481f-8bb1-e2d11299ff4a' \
    --header 'content-type: application/json' \
```
