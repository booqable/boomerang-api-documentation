...
```json
  ...
  "data": [
    {
      "id": "9ea3e819-2b81-428f-b498-ee33632c247d",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2023-03-07T12:12:54+00:00",
        "updated_at": "2023-03-07T12:12:54+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/6d22514e-ffff-4af8-b052-8fb36e1841ac' \
    --header 'content-type: application/json' \
```
