...
```json
  ...
  "data": [
    {
      "id": "089e9d2a-f81f-40ac-ab30-86372d8e9b5b",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2022-07-14T14:28:25+00:00",
        "updated_at": "2022-07-14T14:28:25+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/b0c14617-98ec-445d-b294-f81a1fe4c9e5' \
    --header 'content-type: application/json' \
```
