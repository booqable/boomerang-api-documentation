...
```json
  ...
  "data": [
    {
      "id": "f7bcd0d8-bb51-4099-b2b2-64acafdb9c89",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2023-01-05T13:11:40+00:00",
        "updated_at": "2023-01-05T13:11:40+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/9131297b-f979-4e2e-81eb-6904c8919676' \
    --header 'content-type: application/json' \
```
