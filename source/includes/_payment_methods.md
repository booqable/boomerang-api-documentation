...
```json
  ...
  "data": [
    {
      "id": "d11ca17c-73a7-42dd-99b2-8b6d9a316e8e",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2022-11-22T14:43:59+00:00",
        "updated_at": "2022-11-22T14:43:59+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/a2dde5e2-4a49-43e9-b762-618db843288c' \
    --header 'content-type: application/json' \
```
