...
```json
  ...
  "data": [
    {
      "id": "f27711bc-9e5f-495f-9350-3021fe3dde01",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2023-02-06T08:41:36+00:00",
        "updated_at": "2023-02-06T08:41:36+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/a337992b-dd5d-4534-a35d-0cd4470b4bce' \
    --header 'content-type: application/json' \
```
