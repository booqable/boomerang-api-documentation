...
```json
  ...
  "data": [
    {
      "id": "db46acf8-372e-4966-a49e-92bc83cac096",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2023-02-23T08:57:12+00:00",
        "updated_at": "2023-02-23T08:57:12+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/62a94ae2-8c43-4fca-8498-8be17d310930' \
    --header 'content-type: application/json' \
```
