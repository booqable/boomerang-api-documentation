...
```json
  ...
  "data": [
    {
      "id": "2a90ca15-29f7-4241-af5d-04d5df76e394",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2023-02-07T09:29:33+00:00",
        "updated_at": "2023-02-07T09:29:33+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/1dca6e58-17e2-4618-93a4-ccea0c78b091' \
    --header 'content-type: application/json' \
```
