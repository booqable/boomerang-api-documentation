...
```json
  ...
  "data": [
    {
      "id": "73403ba1-77d1-4454-841e-77b39f9b368b",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2022-10-07T15:09:11+00:00",
        "updated_at": "2022-10-07T15:09:11+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/8d8a3b40-8929-4d78-9566-c53b5552ad0f' \
    --header 'content-type: application/json' \
```
