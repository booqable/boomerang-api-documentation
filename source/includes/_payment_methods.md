...
```json
  ...
  "data": [
    {
      "id": "e5d3d67d-54b9-4759-bb14-cc8a3008ec88",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2021-12-08T11:26:03+00:00",
        "updated_at": "2021-12-08T11:26:03+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/003a4fdb-fb03-4823-88fa-b0f74d341763' \
    --header 'content-type: application/json' \
```
