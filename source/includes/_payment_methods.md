...
```json
  ...
  "data": [
    {
      "id": "7d7281e2-a660-452f-ac47-c2ad7d2148b7",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2022-06-30T13:12:24+00:00",
        "updated_at": "2022-06-30T13:12:24+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/a8974e60-1b34-46f7-a557-e914255673af' \
    --header 'content-type: application/json' \
```
