...
```json
  ...
  "data": [
    {
      "id": "a0c7d27c-a04a-4097-8bc1-f04ec8750467",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2023-02-16T23:14:34+00:00",
        "updated_at": "2023-02-16T23:14:34+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/a708db80-c331-4a32-8167-54d2140d47b3' \
    --header 'content-type: application/json' \
```
