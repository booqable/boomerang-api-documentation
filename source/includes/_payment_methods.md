...
```json
  ...
  "data": [
    {
      "id": "f8cba542-250f-4367-b28b-238ddf84c34f",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2022-11-04T15:25:33+00:00",
        "updated_at": "2022-11-04T15:25:33+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/3fe85d41-6f0a-4fe8-b445-a312cf1573ad' \
    --header 'content-type: application/json' \
```
