...
```json
  ...
  "data": [
    {
      "id": "e9b51dfb-a301-4cbc-a6aa-c107f7dacd51",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2022-07-14T13:05:14+00:00",
        "updated_at": "2022-07-14T13:05:14+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/036d3e02-c875-44b9-b359-82dd8d14ddaa' \
    --header 'content-type: application/json' \
```
