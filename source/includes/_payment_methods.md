...
```json
  ...
  "data": [
    {
      "id": "a812c9c6-5de4-47d0-b3e2-a02dda4ec222",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2023-02-16T11:22:37+00:00",
        "updated_at": "2023-02-16T11:22:37+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/544fe332-06ed-4c44-8ebb-420646465052' \
    --header 'content-type: application/json' \
```
