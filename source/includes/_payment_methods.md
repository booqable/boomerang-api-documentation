...
```json
  ...
  "data": [
    {
      "id": "e2159bc5-8f87-4948-9641-e4b9810775dc",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2022-11-17T11:35:25+00:00",
        "updated_at": "2022-11-17T11:35:25+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/cf904eac-a5e3-4b37-9779-32211e1ec4f7' \
    --header 'content-type: application/json' \
```
