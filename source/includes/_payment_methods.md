...
```json
  ...
  "data": [
    {
      "id": "9c7372c3-f939-436f-9b5f-f7ef786a78fb",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2022-05-04T10:06:08+00:00",
        "updated_at": "2022-05-04T10:06:08+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/f36e06bf-43b3-40a2-a649-545658bcb786' \
    --header 'content-type: application/json' \
```
