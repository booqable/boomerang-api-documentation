...
```json
  ...
  "data": [
    {
      "id": "256bdbda-0539-4b2b-9e22-a0f08d4a4cbd",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2022-06-07T06:52:30+00:00",
        "updated_at": "2022-06-07T06:52:30+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/4a11f40c-b016-4f46-aef5-213a3f58f2e8' \
    --header 'content-type: application/json' \
```
