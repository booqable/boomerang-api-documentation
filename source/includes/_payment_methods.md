...
```json
  ...
  "data": [
    {
      "id": "1a2403d6-acf9-40b9-8b34-965a53ff1f24",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2023-02-02T15:27:25+00:00",
        "updated_at": "2023-02-02T15:27:25+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/068f3a78-7c24-4a27-984d-c00225c57055' \
    --header 'content-type: application/json' \
```
