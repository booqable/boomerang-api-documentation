...
```json
  ...
  "data": [
    {
      "id": "2928222e-1c2d-4e40-ac53-e273948e39ab",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2022-01-12T14:03:44+00:00",
        "updated_at": "2022-01-12T14:03:44+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/6a2cddcf-88c8-43da-8e11-9c24ce30711d' \
    --header 'content-type: application/json' \
```
