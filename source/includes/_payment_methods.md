...
```json
  ...
  "data": [
    {
      "id": "f230ca62-0331-4144-bc16-2fb44d986cd0",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2022-07-07T12:19:01+00:00",
        "updated_at": "2022-07-07T12:19:01+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/c844b492-acdf-4f16-97cd-965733d625e9' \
    --header 'content-type: application/json' \
```
