...
```json
  ...
  "data": [
    {
      "id": "15ae59a6-2dbb-4122-bc11-c0e3d14447f9",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2022-06-30T12:42:50+00:00",
        "updated_at": "2022-06-30T12:42:50+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/888447bf-f94c-4863-a14d-76b194deab0c' \
    --header 'content-type: application/json' \
```
