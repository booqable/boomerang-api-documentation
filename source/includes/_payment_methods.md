...
```json
  ...
  "data": [
    {
      "id": "833832d2-da00-4b86-b29f-0060724e203d",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2022-11-22T16:49:56+00:00",
        "updated_at": "2022-11-22T16:49:56+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/e4ab899f-0ed5-46b3-b0c0-ad270e827df3' \
    --header 'content-type: application/json' \
```
