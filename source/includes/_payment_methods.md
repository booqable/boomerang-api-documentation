...
```json
  ...
  "data": [
    {
      "id": "562a9f08-0bdd-4e85-8f3c-39085181d528",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2022-07-14T12:41:10+00:00",
        "updated_at": "2022-07-14T12:41:10+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/5a2e232f-acbc-4e03-b861-d6475b60aad7' \
    --header 'content-type: application/json' \
```
