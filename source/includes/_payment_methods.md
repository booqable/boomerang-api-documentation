...
```json
  ...
  "data": [
    {
      "id": "39af70ee-17aa-4f43-8222-77a286cc8ef5",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2023-02-09T13:02:32+00:00",
        "updated_at": "2023-02-09T13:02:32+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/0b509a5a-af10-497d-ae61-bf190859ae42' \
    --header 'content-type: application/json' \
```
