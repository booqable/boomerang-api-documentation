...
```json
  ...
  "data": [
    {
      "id": "1768347c-5dd0-4960-8cb4-a7e0cb5119f8",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2023-03-02T12:22:27+00:00",
        "updated_at": "2023-03-02T12:22:27+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/22339e6f-f01d-4283-abbf-d5afed9eb335' \
    --header 'content-type: application/json' \
```
