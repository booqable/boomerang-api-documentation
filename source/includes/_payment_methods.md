...
```json
  ...
  "data": [
    {
      "id": "80e20b59-f36d-4f14-b2ea-809db6169334",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2022-07-07T12:00:29+00:00",
        "updated_at": "2022-07-07T12:00:29+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/89fc530a-3c4a-4a9c-8bf1-8c4008cd12b5' \
    --header 'content-type: application/json' \
```
