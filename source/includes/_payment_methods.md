...
```json
  ...
  "data": [
    {
      "id": "e75b397e-6c87-4c63-8f99-d0b38db4a141",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2023-03-01T10:33:16+00:00",
        "updated_at": "2023-03-01T10:33:16+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/a41d798a-9b39-477d-844c-4b2f91c8b230' \
    --header 'content-type: application/json' \
```
