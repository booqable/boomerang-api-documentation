...
```json
  ...
  "data": [
    {
      "id": "5cc60936-3bee-46ab-b16a-ec3ac623ddd5",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2022-07-19T12:37:36+00:00",
        "updated_at": "2022-07-19T12:37:36+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/39c1549e-8883-4653-9d55-4229b3509448' \
    --header 'content-type: application/json' \
```
