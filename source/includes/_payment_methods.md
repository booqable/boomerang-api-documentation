...
```json
  ...
  "data": [
    {
      "id": "f972626e-3775-4e2e-98bc-73fde8e9eebe",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2023-01-26T12:18:53+00:00",
        "updated_at": "2023-01-26T12:18:53+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/053b8ea3-a7e3-4746-ad05-e1573fec3fe5' \
    --header 'content-type: application/json' \
```
