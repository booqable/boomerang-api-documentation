...
```json
  ...
  "data": [
    {
      "id": "e906c31c-ae17-4585-b737-65d9589570d1",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2023-02-16T15:50:40+00:00",
        "updated_at": "2023-02-16T15:50:40+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/70d3814e-831e-45ae-b755-ab8a3a5f12c9' \
    --header 'content-type: application/json' \
```
