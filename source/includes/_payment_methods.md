...
```json
  ...
  "data": [
    {
      "id": "ec2a020b-6409-4d3e-81b6-060f3fd58a8f",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2022-11-22T15:52:11+00:00",
        "updated_at": "2022-11-22T15:52:11+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/38f7995f-5b5d-40db-ada7-d87341007ca1' \
    --header 'content-type: application/json' \
```
