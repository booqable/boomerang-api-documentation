...
```json
  ...
  "data": [
    {
      "id": "24984227-771a-4658-b586-5a024f929d42",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2022-07-08T13:12:11+00:00",
        "updated_at": "2022-07-08T13:12:11+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/d6831ce8-0a7e-45d0-ae4e-7edfa83095c2' \
    --header 'content-type: application/json' \
```
