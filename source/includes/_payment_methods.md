...
```json
  ...
  "data": [
    {
      "id": "03172dd9-a42e-46eb-91dc-b4d9c117c08f",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2023-01-24T16:33:35+00:00",
        "updated_at": "2023-01-24T16:33:35+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/1844fd99-84b3-46f5-a60b-31155cdd87fd' \
    --header 'content-type: application/json' \
```
