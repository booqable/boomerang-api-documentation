...
```json
  ...
  "data": [
    {
      "id": "8369f11f-5cfd-4b7c-9c6f-81e8c9e62c02",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2022-05-31T06:56:39+00:00",
        "updated_at": "2022-05-31T06:56:39+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/8988524e-0f9c-4f9e-a54a-f9fddbc8996b' \
    --header 'content-type: application/json' \
```
