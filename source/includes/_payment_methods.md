...
```json
  ...
  "data": [
    {
      "id": "b56e8c35-6412-4c63-96d7-dcfc19806285",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2023-01-25T12:36:57+00:00",
        "updated_at": "2023-01-25T12:36:57+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/ce2cbe9f-8d48-45f5-88ae-39ed4165bdd5' \
    --header 'content-type: application/json' \
```
