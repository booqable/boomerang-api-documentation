...
```json
  ...
  "data": [
    {
      "id": "5208c07f-a63d-4d81-8a9a-d97231344deb",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2022-01-12T10:56:29+00:00",
        "updated_at": "2022-01-12T10:56:29+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/1db8fcea-e236-43a0-b218-48e880c5b4b2' \
    --header 'content-type: application/json' \
```
