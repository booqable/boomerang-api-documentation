...
```json
  ...
  "data": [
    {
      "id": "a863a010-8e5e-4b84-855c-c46a42573dc6",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2023-02-09T13:21:38+00:00",
        "updated_at": "2023-02-09T13:21:38+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/6b5aca1d-2cb2-4729-ad91-58f45ab3bbd4' \
    --header 'content-type: application/json' \
```
