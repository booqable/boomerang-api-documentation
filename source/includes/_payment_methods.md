...
```json
  ...
  "data": [
    {
      "id": "cfd75b97-69a1-4714-b4bf-241d0a2c6095",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2022-05-19T11:10:35+00:00",
        "updated_at": "2022-05-19T11:10:35+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/f240a7ae-5134-43db-9104-7dbca502d8da' \
    --header 'content-type: application/json' \
```
