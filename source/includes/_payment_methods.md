...
```json
  ...
  "data": [
    {
      "id": "0eb92dc3-f6ca-4a37-914f-19da7bc604cc",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2023-02-14T15:29:42+00:00",
        "updated_at": "2023-02-14T15:29:42+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/79bc38ee-06e9-4fea-977f-c71eab4731a8' \
    --header 'content-type: application/json' \
```
