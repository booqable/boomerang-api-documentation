...
```json
  ...
  "data": [
    {
      "id": "95982063-9b40-45a2-955e-d0f87a98416e",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2022-06-23T12:52:47+00:00",
        "updated_at": "2022-06-23T12:52:47+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/6e91e28b-dae2-4765-b919-a6b97a9e6166' \
    --header 'content-type: application/json' \
```
