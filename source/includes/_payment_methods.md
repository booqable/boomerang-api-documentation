...
```json
  ...
  "data": [
    {
      "id": "c70470c6-9b25-445e-b609-fd934b0f895a",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2023-02-09T09:42:17+00:00",
        "updated_at": "2023-02-09T09:42:17+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/f59a29e8-0457-4efa-b2ca-cb7fe6f6b3aa' \
    --header 'content-type: application/json' \
```
