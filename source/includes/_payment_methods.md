...
```json
  ...
  "data": [
    {
      "id": "781e6fac-a7c8-48aa-9c6e-78cc531ddd91",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2023-03-06T08:25:13+00:00",
        "updated_at": "2023-03-06T08:25:13+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/8b96f187-a680-4746-93a0-a7186ea69bbd' \
    --header 'content-type: application/json' \
```
