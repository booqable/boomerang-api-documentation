...
```json
  ...
  "data": [
    {
      "id": "a168936b-558a-4fa6-b7d7-cfffea07d9ad",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2022-06-01T08:57:10+00:00",
        "updated_at": "2022-06-01T08:57:10+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/9fe92844-81fb-4862-aa88-e9b1fc70677b' \
    --header 'content-type: application/json' \
```
