...
```json
  ...
  "data": [
    {
      "id": "a0949a61-fe15-47da-a4d5-d4cd4d79ef14",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2023-02-14T11:10:00+00:00",
        "updated_at": "2023-02-14T11:10:00+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/79db3208-6379-4a81-afed-5194ca07c0ec' \
    --header 'content-type: application/json' \
```
