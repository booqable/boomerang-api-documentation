...
```json
  ...
  "data": [
    {
      "id": "8ba8e7d1-cacf-40f1-8178-530ede3bfbf4",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2021-12-16T09:39:11+00:00",
        "updated_at": "2021-12-16T09:39:11+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/0ce256b3-31e8-47b6-9617-d49c304cfc01' \
    --header 'content-type: application/json' \
```
