...
```json
  ...
  "data": [
    {
      "id": "466b7d6d-1b97-4a4f-bd03-7cb45831d724",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2023-01-24T13:23:17+00:00",
        "updated_at": "2023-01-24T13:23:17+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/b425b586-477c-48d3-82a9-3b33a7cd103d' \
    --header 'content-type: application/json' \
```
