...
```json
  ...
  "data": [
    {
      "id": "2a5895bb-6835-4f5b-a6a3-2381a41a4451",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2023-02-16T22:58:23+00:00",
        "updated_at": "2023-02-16T22:58:23+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/11274afc-0e49-4dfe-a196-553c5ce9350d' \
    --header 'content-type: application/json' \
```
