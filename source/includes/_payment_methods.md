...
```json
  ...
  "data": [
    {
      "id": "442571e8-2ed9-417b-a563-9bd70d1ae22c",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2023-03-08T07:54:41+00:00",
        "updated_at": "2023-03-08T07:54:41+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/c8bca4e5-4af3-459b-9d4d-05375ac15cfd' \
    --header 'content-type: application/json' \
```
