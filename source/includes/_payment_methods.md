...
```json
  ...
  "data": [
    {
      "id": "a8db1b3d-20c0-401d-a83c-93b1f6b3fc00",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2023-02-01T15:20:05+00:00",
        "updated_at": "2023-02-01T15:20:05+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/82f7b9f1-f3a2-4f37-8409-b7bf5f9121fd' \
    --header 'content-type: application/json' \
```
