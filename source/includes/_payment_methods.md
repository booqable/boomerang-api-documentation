...
```json
  ...
  "data": [
    {
      "id": "8c0cd703-5923-4ecf-8a9a-08c0faee939d",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2022-09-16T09:03:52+00:00",
        "updated_at": "2022-09-16T09:03:52+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/fc69386e-0a63-4ae7-aabb-6504b6e73464' \
    --header 'content-type: application/json' \
```
