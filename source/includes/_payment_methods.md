...
```json
  ...
  "data": [
    {
      "id": "fb735743-9f6c-4962-875f-a61231ed1173",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2023-02-14T12:48:34+00:00",
        "updated_at": "2023-02-14T12:48:34+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/34883e80-8b5a-4d24-b65f-fbe6e3e04f61' \
    --header 'content-type: application/json' \
```
