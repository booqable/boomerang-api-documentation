...
```json
  ...
  "data": [
    {
      "id": "59121ef1-4158-4841-b295-5a871857af47",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2023-03-01T10:03:07+00:00",
        "updated_at": "2023-03-01T10:03:07+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/83051f1c-70fc-4ddb-bba2-a1a3316addc7' \
    --header 'content-type: application/json' \
```
