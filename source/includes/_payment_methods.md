...
```json
  ...
  "data": [
    {
      "id": "399f0a2c-7189-4215-bf2f-726026fd74c7",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2023-02-06T08:50:25+00:00",
        "updated_at": "2023-02-06T08:50:25+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/d8a6f334-8370-467c-a162-1dfbea9a442b' \
    --header 'content-type: application/json' \
```
