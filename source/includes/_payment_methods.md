...
```json
  ...
  "data": [
    {
      "id": "30764fa8-a7ff-45bc-ac91-23f545f44e47",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2022-07-15T11:22:58+00:00",
        "updated_at": "2022-07-15T11:22:58+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/a449aa4e-b955-48f6-b5c4-82cf54a54083' \
    --header 'content-type: application/json' \
```
