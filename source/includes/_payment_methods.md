...
```json
  ...
  "data": [
    {
      "id": "9e2143ee-5791-4662-b5ef-888eb4ddb1bd",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2021-12-07T11:02:19+00:00",
        "updated_at": "2021-12-07T11:02:19+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/2b9d52e9-eaa1-41a2-ac05-1c5ed8d03d2a' \
    --header 'content-type: application/json' \
```
