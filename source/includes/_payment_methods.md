...
```json
  ...
  "data": [
    {
      "id": "690212a8-9686-4536-9578-825740a5b02c",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2023-03-08T09:43:08+00:00",
        "updated_at": "2023-03-08T09:43:08+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/5fab303e-023f-4d06-9c7c-ff0e78a7247f' \
    --header 'content-type: application/json' \
```
