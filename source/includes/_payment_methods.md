...
```json
  ...
  "data": [
    {
      "id": "b2a10233-d4ca-4558-9273-9ee5f50607e2",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2023-02-14T13:04:21+00:00",
        "updated_at": "2023-02-14T13:04:21+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/43bf0718-bd33-4f67-9775-cfad8e81b4b2' \
    --header 'content-type: application/json' \
```
