...
```json
  ...
  "data": [
    {
      "id": "0acce290-042a-4553-9c6a-1de96502e136",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2022-07-13T08:19:30+00:00",
        "updated_at": "2022-07-13T08:19:30+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/40740b75-6373-4cbf-9f17-1b90cd3cb54d' \
    --header 'content-type: application/json' \
```
