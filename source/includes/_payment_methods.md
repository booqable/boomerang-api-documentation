...
```json
  ...
  "data": [
    {
      "id": "3f8e5659-ccc4-4682-abe3-2314bf60d94a",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2023-02-07T08:08:40+00:00",
        "updated_at": "2023-02-07T08:08:40+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/8965befc-e254-4ff3-897c-3fcbdea6fde9' \
    --header 'content-type: application/json' \
```
