...
```json
  ...
  "data": [
    {
      "id": "6ae405b9-675b-4ab5-abc6-142197900bcf",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2022-10-12T12:59:43+00:00",
        "updated_at": "2022-10-12T12:59:43+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/810140cd-abcb-44ec-ae03-f4d2b3feb76d' \
    --header 'content-type: application/json' \
```
