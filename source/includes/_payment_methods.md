...
```json
  ...
  "data": [
    {
      "id": "c54266e8-f63d-4e37-8e58-81db5a34f8d1",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2022-07-14T10:35:26+00:00",
        "updated_at": "2022-07-14T10:35:26+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/d52b5bc5-6396-4062-9594-cffe61a672fa' \
    --header 'content-type: application/json' \
```
