...
```json
  ...
  "data": [
    {
      "id": "de23dd0c-db26-4e55-a6d8-95d6a811750a",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2022-05-19T13:59:24+00:00",
        "updated_at": "2022-05-19T13:59:24+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/6d9a022e-c95e-4e72-9cf2-0455550440a7' \
    --header 'content-type: application/json' \
```
