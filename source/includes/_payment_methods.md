...
```json
  ...
  "data": [
    {
      "id": "70b1b479-4edc-4890-85c1-9401f120c0be",
      "type": "payment_methods",
      "attributes": {
        "created_at": "2023-02-09T10:20:52+00:00",
        "updated_at": "2023-02-09T10:20:52+00:00",
        "data": {
          "name": null,
          "brand": null,
          "exp_month": null,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/payment_methods/9d98a474-718c-46fe-914c-9a5056593d18' \
    --header 'content-type: application/json' \
```
