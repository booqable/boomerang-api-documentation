...
```json
  ...
  "data": [
    {
      "id": "299028a6-3da1-4c0b-94e8-c16988731de9",
      "type": "operating_rules",
      "attributes": {
        "created_at": "2023-03-08T09:41:52+00:00",
        "updated_at": "2023-03-08T09:41:52+00:00",
        "data_type": "away",
        "data": {
          "away": {
            "from": "2020-01-01",
...
```json
  {
  "data": {
    "id": "d691670a-245f-455f-8a00-7eec407273a4",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-03-08T09:41:52+00:00",
      "updated_at": "2023-03-08T09:41:52+00:00",
...
```json
  {
  "data": {
    "id": "689426ac-d77b-4504-abe8-cefe924a0a28",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-03-08T09:41:53+00:00",
      "updated_at": "2023-03-08T09:41:53+00:00",
      "data_type": "hours",
      "data": {
        "weekday": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "9e714cb3-7a33-4e26-b948-acb8d368492b",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-03-08T09:41:53+00:00",
      "updated_at": "2023-03-08T09:41:53+00:00",
...
```json
  {
  "data": {
    "id": "798b3fee-e9bd-4d94-b260-66274cc5cc73",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-03-08T09:41:54+00:00",
      "updated_at": "2023-03-08T09:41:54+00:00",
      "data_type": "timeslot_fixed",
      "data": {
        "weekend": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "1b682b19-4f0f-4d2e-b5a0-0001f0fecfe7",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-03-08T09:41:54+00:00",
      "updated_at": "2023-03-08T09:41:54+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/23424048-37b0-4d0c-91c5-80edec18bdaf' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "23424048-37b0-4d0c-91c5-80edec18bdaf",
        "type": "operating_rules",
        "attributes": {
          "data": {
            "away": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/0ecb0e3b-219b-481a-a42e-b0d66431cb79' \
    --header 'content-type: application/json' \
```
