...
```json
  ...
  "data": [
    {
      "id": "a43044d0-580c-490a-9b00-54e3c495f0c2",
      "type": "operating_rules",
      "attributes": {
        "created_at": "2023-02-23T08:56:06+00:00",
        "updated_at": "2023-02-23T08:56:06+00:00",
        "data_type": "away",
        "data": {
          "away": {
            "from": "2020-01-01",
...
```json
  {
  "data": {
    "id": "0c99ef60-fab0-46e6-b411-5a62423fb9c1",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-23T08:56:06+00:00",
      "updated_at": "2023-02-23T08:56:06+00:00",
...
```json
  {
  "data": {
    "id": "b75fd3c0-21b3-4e82-8a50-18170d92b33d",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-23T08:56:07+00:00",
      "updated_at": "2023-02-23T08:56:07+00:00",
      "data_type": "hours",
      "data": {
        "weekday": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "720fa6a0-3cc4-495d-8357-15673990856b",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-23T08:56:07+00:00",
      "updated_at": "2023-02-23T08:56:07+00:00",
...
```json
  {
  "data": {
    "id": "c1bd36b5-3d94-474b-afca-95566ecb1761",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-23T08:56:07+00:00",
      "updated_at": "2023-02-23T08:56:07+00:00",
...
```json
  {
  "data": {
    "id": "c7c33d5b-4089-41de-9dc1-9d0706f3b7d9",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-23T08:56:08+00:00",
      "updated_at": "2023-02-23T08:56:08+00:00",
      "data_type": "timeslot_duration",
      "data": {
        "length": 86000
      }
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/2f0492d1-96d8-4437-a84e-d9c735d201d4' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "2f0492d1-96d8-4437-a84e-d9c735d201d4",
        "type": "operating_rules",
        "attributes": {
          "data": {
            "away": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/8a46839d-8208-40f1-9424-2fe65a95f528' \
    --header 'content-type: application/json' \
```
