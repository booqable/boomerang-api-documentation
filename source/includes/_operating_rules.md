...
```json
  ...
  "data": [
    {
      "id": "af7b40d7-73a7-4c97-8b7f-b7235c0d3cd5",
...
```json
  {
  "data": {
    "id": "5bf6ff7e-c4b8-4013-89d5-c31413ee0080",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-21T08:20:18+00:00",
      "updated_at": "2023-02-21T08:20:18+00:00",
      "data_type": "hours",
      "data": {
        "mon": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "3b5361cd-b582-4b98-8c84-e2ef62226319",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-21T08:20:18+00:00",
      "updated_at": "2023-02-21T08:20:18+00:00",
...
```json
  {
  "data": {
    "id": "125e0282-af22-4dbd-a3a5-971112a30312",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-21T08:20:18+00:00",
      "updated_at": "2023-02-21T08:20:18+00:00",
...
```json
  {
  "data": {
    "id": "72bec8b8-5a5b-4952-b7e1-89da1967a4f3",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-21T08:20:19+00:00",
      "updated_at": "2023-02-21T08:20:19+00:00",
      "data_type": "timeslot_fixed",
      "data": {
        "weekend": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "0d34f7bd-8cea-4ee1-b563-777b7824934b",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-21T08:20:19+00:00",
      "updated_at": "2023-02-21T08:20:19+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/76276977-4f68-495a-8a3f-5c44ed0e012a' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "76276977-4f68-495a-8a3f-5c44ed0e012a",
        "type": "operating_rules",
        "attributes": {
          "data": {
            "away": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/50c04c3c-905b-4030-8452-cbfe132e0393' \
    --header 'content-type: application/json' \
```
