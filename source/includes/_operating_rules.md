...
```json
  ...
  "data": [
    {
      "id": "f77292f4-7d36-4a6b-840e-554aa68458e1",
      "type": "operating_rules",
      "attributes": {
        "created_at": "2023-03-01T10:01:45+00:00",
        "updated_at": "2023-03-01T10:01:45+00:00",
        "data_type": "away",
        "data": {
          "away": {
            "from": "2020-01-01",
...
```json
  {
  "data": {
    "id": "242d3349-1d7a-42cc-9e2f-0df384bed024",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-03-01T10:01:45+00:00",
      "updated_at": "2023-03-01T10:01:45+00:00",
...
```json
  {
  "data": {
    "id": "8b4bd560-e94c-4f44-a8c8-e430f9a9ea91",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-03-01T10:01:46+00:00",
      "updated_at": "2023-03-01T10:01:46+00:00",
      "data_type": "hours",
      "data": {
        "weekday": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "299e138e-f261-44a3-bca8-456e02ee6226",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-03-01T10:01:46+00:00",
      "updated_at": "2023-03-01T10:01:46+00:00",
...
```json
  {
  "data": {
    "id": "9655f663-5fc3-41a1-bad4-f7f22c0783a4",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-03-01T10:01:46+00:00",
      "updated_at": "2023-03-01T10:01:46+00:00",
...
```json
  {
  "data": {
    "id": "6c59479c-e634-4323-8c34-369d57bbd50e",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-03-01T10:01:47+00:00",
      "updated_at": "2023-03-01T10:01:47+00:00",
      "data_type": "timeslot_duration",
      "data": {
        "length": 86000
      }
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/ac7fff4c-8fc5-41c4-a52d-75f79f8dd413' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "ac7fff4c-8fc5-41c4-a52d-75f79f8dd413",
        "type": "operating_rules",
        "attributes": {
          "data": {
            "away": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/b302d056-28e5-42c4-af92-fa65e19f1a9c' \
    --header 'content-type: application/json' \
```
