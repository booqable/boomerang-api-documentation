...
```json
  ...
  "data": [
    {
      "id": "da315fc9-52ff-4f0b-b379-49ea71f52831",
      "type": "operating_rules",
      "attributes": {
        "created_at": "2022-04-13T09:09:27+00:00",
        "updated_at": "2022-04-13T09:09:27+00:00",
        "data_type": "away",
        "data": {
          "away": {
            "from": "2020-01-01",
...
```json
  {
  "data": {
    "id": "6ceaf3cf-01a3-4e17-9b82-6dd3b8e457e0",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-04-13T09:09:27+00:00",
      "updated_at": "2022-04-13T09:09:27+00:00",
...
```json
  {
  "data": {
    "id": "7a5cdfcd-b227-415d-8e87-2baffc515b24",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-04-13T09:09:28+00:00",
      "updated_at": "2022-04-13T09:09:28+00:00",
      "data_type": "hours",
      "data": {
        "weekday": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "3d591e7e-2aaf-4b92-be0e-a5a19f848661",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-04-13T09:09:28+00:00",
      "updated_at": "2022-04-13T09:09:28+00:00",
...
```json
  {
  "data": {
    "id": "72912948-c517-4b7f-b8e0-4571bf6bfe1c",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-04-13T09:09:29+00:00",
      "updated_at": "2022-04-13T09:09:29+00:00",
      "data_type": "timeslot_fixed",
      "data": {
        "weekend": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "04b07954-839f-49c5-88b5-3cfebf21bac5",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-04-13T09:09:29+00:00",
      "updated_at": "2022-04-13T09:09:29+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/1a669484-65f1-4c15-8cb9-500f45e4330d' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "1a669484-65f1-4c15-8cb9-500f45e4330d",
        "type": "operating_rules",
        "attributes": {
          "data": {
            "away": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/b57dd583-232f-47fd-9ea9-80cf50849856' \
    --header 'content-type: application/json' \
```
