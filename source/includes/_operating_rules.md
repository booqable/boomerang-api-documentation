...
```json
  ...
  "data": [
    {
      "id": "b65f4bb8-3f53-490f-9a43-44147f90e8af",
      "type": "operating_rules",
      "attributes": {
        "created_at": "2023-02-28T08:45:46+00:00",
        "updated_at": "2023-02-28T08:45:46+00:00",
        "data_type": "away",
        "data": {
          "away": {
            "from": "2020-01-01",
...
```json
  {
  "data": {
    "id": "32a49255-a2bc-43aa-b16c-45c293782b04",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-28T08:45:47+00:00",
      "updated_at": "2023-02-28T08:45:47+00:00",
      "data_type": "hours",
      "data": {
        "mon": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "28e2d52a-011f-4fdf-92a4-24b1eacb51e5",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-28T08:45:47+00:00",
      "updated_at": "2023-02-28T08:45:47+00:00",
...
```json
  {
  "data": {
    "id": "93e18448-d39a-4d9e-91c5-14f8af0df815",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-28T08:45:47+00:00",
      "updated_at": "2023-02-28T08:45:47+00:00",
...
```json
  {
  "data": {
    "id": "c6f559b5-0ac3-4afc-aa63-063b12331851",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-28T08:45:48+00:00",
      "updated_at": "2023-02-28T08:45:48+00:00",
      "data_type": "timeslot_fixed",
      "data": {
        "weekend": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "256a59a9-e59b-4180-ab07-7858c1a34f5a",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-28T08:45:48+00:00",
      "updated_at": "2023-02-28T08:45:48+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/e3d86da2-3b18-49f5-abf7-ace129e1edab' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "e3d86da2-3b18-49f5-abf7-ace129e1edab",
        "type": "operating_rules",
        "attributes": {
          "data": {
            "away": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/a3a87c78-1282-4132-8710-70b2f5be85be' \
    --header 'content-type: application/json' \
```
