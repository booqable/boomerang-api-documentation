...
```json
  ...
  "data": [
    {
      "id": "82d340a0-0d81-4c2c-9e25-fc09377e3d6c",
...
```json
  {
  "data": {
    "id": "ee53114c-81cb-4ee6-99e2-ab068962ba68",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-11-22T14:42:51+00:00",
      "updated_at": "2022-11-22T14:42:51+00:00",
      "data_type": "hours",
      "data": {
        "mon": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "7963736d-4513-4b70-a852-5354c0f1dd40",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-11-22T14:42:52+00:00",
      "updated_at": "2022-11-22T14:42:52+00:00",
      "data_type": "hours",
      "data": {
        "weekday": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "1b9716c6-f294-4f52-bdf0-563bd7f63a32",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-11-22T14:42:52+00:00",
      "updated_at": "2022-11-22T14:42:52+00:00",
...
```json
  {
  "data": {
    "id": "8741f8bb-d7b3-4b5b-8aa3-91a1916deaa8",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-11-22T14:42:52+00:00",
      "updated_at": "2022-11-22T14:42:52+00:00",
...
```json
  {
  "data": {
    "id": "0a362e0a-f984-405e-9d30-d951b2a5e6f9",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-11-22T14:42:53+00:00",
      "updated_at": "2022-11-22T14:42:53+00:00",
      "data_type": "timeslot_duration",
      "data": {
        "length": 86000
      }
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/feea7c4e-7f14-447b-bded-b5524a593de6' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "feea7c4e-7f14-447b-bded-b5524a593de6",
        "type": "operating_rules",
        "attributes": {
          "data": {
            "away": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/5ac20131-f842-4af7-a47d-3cfd51beee76' \
    --header 'content-type: application/json' \
```
