...
```json
  ...
  "data": [
    {
      "id": "6378995c-9630-45a5-92bc-8294babf32c5",
      "type": "operating_rules",
      "attributes": {
        "created_at": "2023-02-07T14:51:40+00:00",
        "updated_at": "2023-02-07T14:51:40+00:00",
        "data_type": "away",
        "data": {
          "away": {
            "from": "2020-01-01",
...
```json
  {
  "data": {
    "id": "c450cd2e-49f7-49c0-8821-a22fb6cacfe9",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-07T14:51:41+00:00",
      "updated_at": "2023-02-07T14:51:41+00:00",
      "data_type": "hours",
      "data": {
        "mon": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "17fa95c6-d543-4816-9e63-332276bddb5a",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-07T14:51:41+00:00",
      "updated_at": "2023-02-07T14:51:41+00:00",
...
```json
  {
  "data": {
    "id": "ff04ac14-2e5d-4139-bc7c-b093c6ff9865",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-07T14:51:41+00:00",
      "updated_at": "2023-02-07T14:51:41+00:00",
...
```json
  {
  "data": {
    "id": "a95074f4-156c-4c3f-b724-e7d1705bea4c",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-07T14:51:42+00:00",
      "updated_at": "2023-02-07T14:51:42+00:00",
      "data_type": "timeslot_fixed",
      "data": {
        "weekend": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "c4636f68-3c6d-4489-9550-318817bbaefd",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-07T14:51:42+00:00",
      "updated_at": "2023-02-07T14:51:42+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/088a832c-3f7c-48fc-848e-5733b7ab83b3' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "088a832c-3f7c-48fc-848e-5733b7ab83b3",
        "type": "operating_rules",
        "attributes": {
          "data": {
            "away": {
...
```json
  ...
  "data": {
    ...
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-07T14:51:43+00:00",
      "updated_at": "2023-02-07T14:51:43+00:00",
      "data_type": "away",
      "data": {
        "away": {
          "from": "2020-04-01",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/367078d2-98c1-4870-8475-6694c000ac91' \
    --header 'content-type: application/json' \
```
