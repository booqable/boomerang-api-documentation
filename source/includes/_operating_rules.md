...
```json
  ...
  "data": [
    {
      "id": "d1f8f742-3579-47a6-b587-c37fad3503d5",
      "data_type": "away",
      "data": {
        "away": {
          "from": "2020-01-01",
...
```json
  {
  "data": {
    "id": "824da850-10be-431d-8f98-a92ce4881b49",
    "type": "operating_rules",
    "attributes": {
      "data_type": "hours",
      "data": {
...
```json
  {
  "data": {
    "id": "9bea4b3b-023b-4a2d-b2dc-a6190bc049ed",
    "type": "operating_rules",
    "attributes": {
      "data_type": "hours",
      "data": {
...
```json
  {
  "data": {
    "id": "c40f89b8-80a0-4f7e-b977-d5882eca0d97",
    "type": "operating_rules",
    "attributes": {
      "data_type": "away",
      "data": {
...
```json
  {
  "data": {
    "id": "360f56dd-14a9-47d7-bd4b-769e7421914a",
    "type": "operating_rules",
    "attributes": {
      "data_type": "timeslot_fixed",
      "data": {
...
```json
  {
  "data": {
    "id": "16c86d5a-7c17-43d3-a568-0ae353749015",
    "type": "operating_rules",
    "attributes": {
      "data_type": "timeslot_duration",
      "data": {
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/f75385e3-6e9f-4667-8de6-01b547c2b60d' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "f75385e3-6e9f-4667-8de6-01b547c2b60d",
        "type": "operating_rules",
        "attributes": {
          "data": {
            "away": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/b32e7e51-6288-49f2-8e82-f70ad1ab925a' \
    --header 'content-type: application/json' \
    --data '{}'
```
