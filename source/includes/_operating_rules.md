...
```json
  ...
  "data": [
    {
      "id": "e20fe337-d4f5-4651-a110-dc7637c8963f",
      "type": "operating_rules",
      "attributes": {
        "created_at": "2023-02-27T10:47:49+00:00",
        "updated_at": "2023-02-27T10:47:49+00:00",
        "data_type": "away",
        "data": {
          "away": {
            "from": "2020-01-01",
...
```json
  {
  "data": {
    "id": "e86a559a-b907-41c7-9e1f-bbaecdd93aea",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-27T10:47:49+00:00",
      "updated_at": "2023-02-27T10:47:49+00:00",
...
```json
  {
  "data": {
    "id": "7c1d4ccc-057f-474f-94af-ef2aa87d83f0",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-27T10:47:50+00:00",
      "updated_at": "2023-02-27T10:47:50+00:00",
      "data_type": "hours",
      "data": {
        "weekday": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "f13ca713-65fa-45c1-86aa-8df27dfd0a1f",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-27T10:47:50+00:00",
      "updated_at": "2023-02-27T10:47:50+00:00",
...
```json
  {
  "data": {
    "id": "8d2e0ffc-3a24-44bc-8efe-2f29ebf6c906",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-27T10:47:51+00:00",
      "updated_at": "2023-02-27T10:47:51+00:00",
      "data_type": "timeslot_fixed",
      "data": {
        "weekend": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "db2a5b0b-b6d3-4f6c-811a-be0f2e96b59b",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-27T10:47:51+00:00",
      "updated_at": "2023-02-27T10:47:51+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/2b202e83-881f-4c72-911f-54f1bfb19ca5' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "2b202e83-881f-4c72-911f-54f1bfb19ca5",
        "type": "operating_rules",
        "attributes": {
          "data": {
            "away": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/6d25ed9d-c04e-4cd2-a00b-ccf8f37df420' \
    --header 'content-type: application/json' \
```
