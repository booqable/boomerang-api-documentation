...
```json
  ...
  "data": [
    {
      "id": "a0f6999a-1c96-47bb-b184-170551d47cb6",
      "type": "operating_rules",
      "attributes": {
        "created_at": "2023-02-24T08:54:10+00:00",
        "updated_at": "2023-02-24T08:54:10+00:00",
        "data_type": "away",
        "data": {
          "away": {
            "from": "2020-01-01",
...
```json
  {
  "data": {
    "id": "c1d5b3eb-ee89-4bac-9d8d-874a89f3a2d8",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-24T08:54:11+00:00",
      "updated_at": "2023-02-24T08:54:11+00:00",
      "data_type": "hours",
      "data": {
        "mon": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "ce857702-b39a-4843-aeb5-4ee6a03016ce",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-24T08:54:11+00:00",
      "updated_at": "2023-02-24T08:54:11+00:00",
...
```json
  {
  "data": {
    "id": "c3b29065-f3c6-4f93-a3a2-261a6aefddb1",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-24T08:54:11+00:00",
      "updated_at": "2023-02-24T08:54:11+00:00",
...
```json
  {
  "data": {
    "id": "ed07044c-b58a-4f47-900c-82c80a10206b",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-24T08:54:12+00:00",
      "updated_at": "2023-02-24T08:54:12+00:00",
      "data_type": "timeslot_fixed",
      "data": {
        "weekend": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "2671e014-a1f5-400c-a932-01ae93621cb5",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-24T08:54:12+00:00",
      "updated_at": "2023-02-24T08:54:12+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/ba672ef3-4222-4121-a881-4a87ad67095c' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "ba672ef3-4222-4121-a881-4a87ad67095c",
        "type": "operating_rules",
        "attributes": {
          "data": {
            "away": {
...
```json
  ...
  "data": {
    ...
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-24T08:54:13+00:00",
      "updated_at": "2023-02-24T08:54:13+00:00",
      "data_type": "away",
      "data": {
        "away": {
          "from": "2020-04-01",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/9a0355cc-a599-4152-acb4-ff21ebfa9860' \
    --header 'content-type: application/json' \
```
