...
```json
  ...
  "data": [
    {
      "id": "2397b7b7-c4f0-4ee8-ab5b-4b2cf392d84b",
...
```json
  {
  "data": {
    "id": "3a81e610-174e-42d4-b8dc-985ed78ddd89",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-07T09:28:27+00:00",
      "updated_at": "2023-02-07T09:28:27+00:00",
      "data_type": "hours",
      "data": {
        "mon": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "df3fbbda-8569-4e68-a4ba-77f54599f526",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-07T09:28:27+00:00",
      "updated_at": "2023-02-07T09:28:27+00:00",
...
```json
  {
  "data": {
    "id": "4b8c9927-09a0-4c75-913a-a9e1d07f800b",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-07T09:28:28+00:00",
      "updated_at": "2023-02-07T09:28:28+00:00",
      "data_type": "away",
      "data": {
        "away": {
          "from": "2030-01-01",
...
```json
  {
  "data": {
    "id": "66d7d1d1-96b7-4986-a38a-df0cb0313a1b",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-07T09:28:28+00:00",
      "updated_at": "2023-02-07T09:28:28+00:00",
...
```json
  {
  "data": {
    "id": "a35557d8-91f2-447c-848d-13c2161ec678",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-07T09:28:28+00:00",
      "updated_at": "2023-02-07T09:28:28+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/79ec4987-700a-4a96-9689-3c9b046b5d89' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "79ec4987-700a-4a96-9689-3c9b046b5d89",
        "type": "operating_rules",
        "attributes": {
          "data": {
            "away": {
...
```json
  ...
  "data": {
    ...
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-07T09:28:29+00:00",
      "updated_at": "2023-02-07T09:28:29+00:00",
      "data_type": "away",
      "data": {
        "away": {
          "from": "2020-04-01",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/6e49021a-ec75-4307-bc65-89f13ea30248' \
    --header 'content-type: application/json' \
```
