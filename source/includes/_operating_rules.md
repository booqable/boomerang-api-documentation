...
```json
  ...
  "data": [
    {
      "id": "ead248dd-681c-461f-8089-ee4ae9aeacbb",
...
```json
  {
  "data": {
    "id": "63c6b337-e4c1-4bf5-a527-8610f1d7b917",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-11-17T10:17:49+00:00",
      "updated_at": "2022-11-17T10:17:49+00:00",
      "data_type": "hours",
      "data": {
        "mon": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "40eba02f-b947-4039-94f1-b43767a30bf1",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-11-17T10:17:49+00:00",
      "updated_at": "2022-11-17T10:17:49+00:00",
...
```json
  {
  "data": {
    "id": "a565a2dd-d8dd-41ab-ac42-944f47793464",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-11-17T10:17:49+00:00",
      "updated_at": "2022-11-17T10:17:49+00:00",
...
```json
  {
  "data": {
    "id": "88b3235c-7072-4d31-9a55-370bd164c3b5",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-11-17T10:17:50+00:00",
      "updated_at": "2022-11-17T10:17:50+00:00",
      "data_type": "timeslot_fixed",
      "data": {
        "weekend": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "16dc92f7-9c5a-47bd-b2e0-d03d2d1feb9d",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-11-17T10:17:50+00:00",
      "updated_at": "2022-11-17T10:17:50+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/fd82ce93-a46c-4624-b75f-b3be30cdc202' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "fd82ce93-a46c-4624-b75f-b3be30cdc202",
        "type": "operating_rules",
        "attributes": {
          "data": {
            "away": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/9408bc27-de79-4f07-99a1-69ce8a39e934' \
    --header 'content-type: application/json' \
```
