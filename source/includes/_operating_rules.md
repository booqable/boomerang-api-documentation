...
```json
  ...
  "data": [
    {
      "id": "5bcb80f8-dfca-4cef-bfe3-ff34ead625a0",
      "type": "operating_rules",
      "attributes": {
        "created_at": "2023-01-24T13:22:20+00:00",
        "updated_at": "2023-01-24T13:22:20+00:00",
        "data_type": "away",
        "data": {
          "away": {
            "from": "2020-01-01",
...
```json
  {
  "data": {
    "id": "cd2bce92-4ef9-49d5-a2bc-43206fc92d79",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-01-24T13:22:20+00:00",
      "updated_at": "2023-01-24T13:22:20+00:00",
...
```json
  {
  "data": {
    "id": "d38ac9b2-df20-4f36-9273-a9616cfa9946",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-01-24T13:22:20+00:00",
      "updated_at": "2023-01-24T13:22:20+00:00",
...
```json
  {
  "data": {
    "id": "497168cd-7f98-47bb-b5e8-8436933b41e5",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-01-24T13:22:21+00:00",
      "updated_at": "2023-01-24T13:22:21+00:00",
      "data_type": "away",
      "data": {
        "away": {
          "from": "2030-01-01",
...
```json
  {
  "data": {
    "id": "f8e6a47c-9c76-4039-a31b-d93496c3c6da",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-01-24T13:22:21+00:00",
      "updated_at": "2023-01-24T13:22:21+00:00",
...
```json
  {
  "data": {
    "id": "3be32a12-cfb5-4b95-a50a-fbdf373d46bf",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-01-24T13:22:21+00:00",
      "updated_at": "2023-01-24T13:22:21+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/8ad5792b-a02a-474b-bede-60a2e1d9b4cf' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "8ad5792b-a02a-474b-bede-60a2e1d9b4cf",
        "type": "operating_rules",
        "attributes": {
          "data": {
            "away": {
...
```json
  ...
  "data": {
    ...
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-01-24T13:22:22+00:00",
      "updated_at": "2023-01-24T13:22:22+00:00",
      "data_type": "away",
      "data": {
        "away": {
          "from": "2020-04-01",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/31f38ab9-3083-42f0-bb0d-e44f13875668' \
    --header 'content-type: application/json' \
```
