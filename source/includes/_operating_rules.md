...
```json
  ...
  "data": [
    {
      "id": "b9f1c445-10e6-4764-b99b-786c42fa74ed",
...
```json
  {
  "data": {
    "id": "9b99ab9a-a6cc-4c29-8d83-74b96b8205ba",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-14T11:05:32+00:00",
      "updated_at": "2023-02-14T11:05:32+00:00",
...
```json
  {
  "data": {
    "id": "7c792211-ff2b-4730-b70f-a0fa8ab33277",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-14T11:05:32+00:00",
      "updated_at": "2023-02-14T11:05:32+00:00",
...
```json
  {
  "data": {
    "id": "90676c72-fccc-48d9-bba5-4f7f0443fdff",
    "type": "operating_rules",
    "attributes": {
...
```json
  {
  "data": {
    "id": "49ce4dfb-8a31-4d93-b364-d215b984772e",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-14T11:05:33+00:00",
      "updated_at": "2023-02-14T11:05:33+00:00",
...
```json
  {
  "data": {
    "id": "0c958993-fa9a-47fa-ad8d-269396f9d753",
    "type": "operating_rules",
    "attributes": {
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/336457ad-007f-48de-ac82-7f1da6a53548' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "336457ad-007f-48de-ac82-7f1da6a53548",
        "type": "operating_rules",
        "attributes": {
          "data": {
            "away": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/86cba4a6-c5b1-4465-8394-c87686ffd374' \
    --header 'content-type: application/json' \
```
