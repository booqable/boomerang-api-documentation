...
```json
  ...
  "data": [
    {
      "id": "347f4e7e-3678-410a-b0d2-0c8831b8dc81",
      "type": "operating_rules",
      "attributes": {
        "created_at": "2023-03-09T08:59:02+00:00",
        "updated_at": "2023-03-09T08:59:02+00:00",
        "data_type": "away",
        "data": {
          "away": {
            "from": "2020-01-01",
...
```json
  {
  "data": {
    "id": "79fee2e8-c134-4816-9f14-c7ca52a3af9a",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-03-09T08:59:03+00:00",
      "updated_at": "2023-03-09T08:59:03+00:00",
      "data_type": "hours",
      "data": {
        "mon": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "d546a1e6-a307-47f1-a88a-dde7145d323f",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-03-09T08:59:03+00:00",
      "updated_at": "2023-03-09T08:59:03+00:00",
...
```json
  {
  "data": {
    "id": "fb0c70a0-08f6-47d0-8f4d-6a59481b773f",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-03-09T08:59:03+00:00",
      "updated_at": "2023-03-09T08:59:03+00:00",
...
```json
  {
  "data": {
    "id": "fcc4cdf6-fb3d-4862-b1cf-eb78b912398c",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-03-09T08:59:04+00:00",
      "updated_at": "2023-03-09T08:59:04+00:00",
      "data_type": "timeslot_fixed",
      "data": {
        "weekend": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "b861e513-8f95-4e9c-8c11-7457a2449f90",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-03-09T08:59:04+00:00",
      "updated_at": "2023-03-09T08:59:04+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/fe0342c1-ed2d-45d7-b498-d5f76ab8a673' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "fe0342c1-ed2d-45d7-b498-d5f76ab8a673",
        "type": "operating_rules",
        "attributes": {
          "data": {
            "away": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/3395f742-aaad-4fbf-a816-efbeffecc21a' \
    --header 'content-type: application/json' \
```
