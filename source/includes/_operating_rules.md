...
```json
  ...
  "data": [
    {
      "id": "ff365902-5065-4d68-9108-3a6b0f449a0c",
...
```json
  {
  "data": {
    "id": "bef25610-7edc-47ed-80c4-368296353e3e",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-11-22T15:33:43+00:00",
      "updated_at": "2022-11-22T15:33:43+00:00",
      "data_type": "hours",
      "data": {
        "mon": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "9190cfb4-a2ad-43ec-8c66-92c241821a20",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-11-22T15:33:43+00:00",
      "updated_at": "2022-11-22T15:33:43+00:00",
...
```json
  {
  "data": {
    "id": "8e377643-d818-4e82-a121-a6f22d902470",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-11-22T15:33:43+00:00",
      "updated_at": "2022-11-22T15:33:43+00:00",
...
```json
  {
  "data": {
    "id": "a35f3003-d0d0-4439-9fc4-4c2fc86b1420",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-11-22T15:33:44+00:00",
      "updated_at": "2022-11-22T15:33:44+00:00",
      "data_type": "timeslot_fixed",
      "data": {
        "weekend": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "d95eb530-932f-44dc-b82a-b2d9ef7e2ed0",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-11-22T15:33:44+00:00",
      "updated_at": "2022-11-22T15:33:44+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/91440063-127d-4e00-a7f1-0a33139944c2' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "91440063-127d-4e00-a7f1-0a33139944c2",
        "type": "operating_rules",
        "attributes": {
          "data": {
            "away": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/f762df2b-8cba-43ee-a509-3466023225c9' \
    --header 'content-type: application/json' \
```
