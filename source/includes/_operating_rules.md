...
```json
  ...
  "data": [
    {
      "id": "716b7a29-8892-44c1-af81-c9b1260b81b6",
...
```json
  {
  "data": {
    "id": "8614630c-f266-46f8-94f0-917b95e2db98",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-08T08:35:58+00:00",
      "updated_at": "2023-02-08T08:35:58+00:00",
...
```json
  {
  "data": {
    "id": "98dd1f27-b7c5-4955-8766-e48396ecea46",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-08T08:35:58+00:00",
      "updated_at": "2023-02-08T08:35:58+00:00",
...
```json
  {
  "data": {
    "id": "0228badf-ce08-4a84-aeb0-eec09ae38f9c",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-08T08:35:59+00:00",
      "updated_at": "2023-02-08T08:35:59+00:00",
      "data_type": "away",
      "data": {
        "away": {
          "from": "2030-01-01",
...
```json
  {
  "data": {
    "id": "57e09aee-e696-402a-8c30-7b0de25b1eeb",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-08T08:35:59+00:00",
      "updated_at": "2023-02-08T08:35:59+00:00",
...
```json
  {
  "data": {
    "id": "9923ea6f-a14b-4639-a400-03a073ddd223",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-08T08:36:00+00:00",
      "updated_at": "2023-02-08T08:36:00+00:00",
      "data_type": "timeslot_duration",
      "data": {
        "length": 86000
      }
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/044c52ea-5485-4339-be6a-918cdf4c24b0' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "044c52ea-5485-4339-be6a-918cdf4c24b0",
        "type": "operating_rules",
        "attributes": {
          "data": {
            "away": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/d4cb57b2-5d54-4843-9e94-071d99608e48' \
    --header 'content-type: application/json' \
```
