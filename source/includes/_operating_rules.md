...
```json
  ...
  "data": [
    {
      "id": "4e80ae94-fcba-47a0-a001-67b3151688ca",
      "type": "operating_rules",
      "attributes": {
        "created_at": "2023-03-09T10:28:31+00:00",
        "updated_at": "2023-03-09T10:28:31+00:00",
        "data_type": "away",
        "data": {
          "away": {
            "from": "2020-01-01",
...
```json
  {
  "data": {
    "id": "2928f182-ff99-44e8-9d05-94c3807061be",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-03-09T10:28:32+00:00",
      "updated_at": "2023-03-09T10:28:32+00:00",
      "data_type": "hours",
      "data": {
        "mon": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "ec311425-1cc3-4097-b6cd-74f49532580e",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-03-09T10:28:32+00:00",
      "updated_at": "2023-03-09T10:28:32+00:00",
...
```json
  {
  "data": {
    "id": "329388f2-6f54-4767-9d0e-4e788aeaf040",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-03-09T10:28:33+00:00",
      "updated_at": "2023-03-09T10:28:33+00:00",
      "data_type": "away",
      "data": {
        "away": {
          "from": "2030-01-01",
...
```json
  {
  "data": {
    "id": "daeca53b-1202-4212-a3af-6ebabdcfebec",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-03-09T10:28:33+00:00",
      "updated_at": "2023-03-09T10:28:33+00:00",
...
```json
  {
  "data": {
    "id": "37c6e32d-0f6c-4123-a186-808cb2c0b7a0",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-03-09T10:28:34+00:00",
      "updated_at": "2023-03-09T10:28:34+00:00",
      "data_type": "timeslot_duration",
      "data": {
        "length": 86000
      }
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/d6ea0852-5b04-480f-a595-b9ba4bed7be3' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "d6ea0852-5b04-480f-a595-b9ba4bed7be3",
        "type": "operating_rules",
        "attributes": {
          "data": {
            "away": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/623a4c7d-f864-4d48-a969-a88bef4e87f9' \
    --header 'content-type: application/json' \
```
