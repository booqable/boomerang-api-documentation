...
```json
  ...
  "data": [
    {
      "id": "4c41926d-d1be-4aa6-b29e-d6c6acb7f4fb",
      "type": "operating_rules",
      "attributes": {
        "created_at": "2023-02-21T12:17:19+00:00",
        "updated_at": "2023-02-21T12:17:19+00:00",
        "data_type": "away",
        "data": {
          "away": {
            "from": "2020-01-01",
...
```json
  {
  "data": {
    "id": "f06e026a-ddc2-4423-bee9-08670bba64e6",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-21T12:17:19+00:00",
      "updated_at": "2023-02-21T12:17:19+00:00",
...
```json
  {
  "data": {
    "id": "749f05b2-41e2-4eb0-8eda-107f859b8319",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-21T12:17:19+00:00",
      "updated_at": "2023-02-21T12:17:19+00:00",
...
```json
  {
  "data": {
    "id": "8d45ef8e-f7c4-4ac5-b4c0-03000e2e09ae",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-21T12:17:20+00:00",
      "updated_at": "2023-02-21T12:17:20+00:00",
      "data_type": "away",
      "data": {
        "away": {
          "from": "2030-01-01",
...
```json
  {
  "data": {
    "id": "80c6ef71-ba55-446e-aa2d-27a5bc3a6079",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-21T12:17:20+00:00",
      "updated_at": "2023-02-21T12:17:20+00:00",
...
```json
  {
  "data": {
    "id": "4458388c-5648-42d5-8f0e-a30cf0906178",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-21T12:17:21+00:00",
      "updated_at": "2023-02-21T12:17:21+00:00",
      "data_type": "timeslot_duration",
      "data": {
        "length": 86000
      }
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/2b82a28e-d1a0-45aa-ba02-a3ff231be936' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "2b82a28e-d1a0-45aa-ba02-a3ff231be936",
        "type": "operating_rules",
        "attributes": {
          "data": {
            "away": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/4bedeb47-ddfb-4cd5-87ce-2b7264fd4377' \
    --header 'content-type: application/json' \
```
