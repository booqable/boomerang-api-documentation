...
```json
  ...
  "data": [
    {
      "id": "71e1e49b-5d24-45b2-af73-17c3507f0ead",
      "type": "operating_rules",
      "attributes": {
        "created_at": "2023-02-14T11:05:39+00:00",
        "updated_at": "2023-02-14T11:05:39+00:00",
        "data_type": "away",
        "data": {
          "away": {
            "from": "2020-01-01",
...
```json
  {
  "data": {
    "id": "a84b6b5f-dfc6-4ef7-870e-9708df45507f",
    "type": "operating_rules",
    "attributes": {
...
```json
  {
  "data": {
    "id": "1f05abaa-bcd2-4253-9f03-4c45ef54decc",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-14T11:05:40+00:00",
      "updated_at": "2023-02-14T11:05:40+00:00",
...
```json
  {
  "data": {
    "id": "c89cbcdd-2361-4806-922b-699ed622cbe5",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-14T11:05:40+00:00",
      "updated_at": "2023-02-14T11:05:40+00:00",
...
```json
  {
  "data": {
    "id": "6c26aeb7-4ae6-4ba8-ab50-b1f242569be8",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-14T11:05:41+00:00",
...
```json
  {
  "data": {
    "id": "1edddcd1-6e7d-485f-b9f3-0cc5d94db7fb",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-14T11:05:41+00:00",
      "updated_at": "2023-02-14T11:05:41+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/236acae0-2446-4b26-b474-9f1b5d055d3b' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "236acae0-2446-4b26-b474-9f1b5d055d3b",
        "type": "operating_rules",
        "attributes": {
          "data": {
            "away": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/971f0109-52b5-4a38-9b03-b6253ee5d9c4' \
    --header 'content-type: application/json' \
```
