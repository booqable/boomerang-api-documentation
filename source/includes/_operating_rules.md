...
```json
  ...
  "data": [
    {
      "id": "89bd08a9-dc43-42d6-a82b-3780ef511482",
...
```json
  {
  "data": {
    "id": "8a52eeed-5f26-4ba0-a0d5-df0400acbf8a",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-05-24T07:20:19+00:00",
      "updated_at": "2022-05-24T07:20:19+00:00",
...
```json
  {
  "data": {
    "id": "1eb799c3-316c-4169-ae8d-633139abfd85",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-05-24T07:20:20+00:00",
      "updated_at": "2022-05-24T07:20:20+00:00",
      "data_type": "hours",
      "data": {
        "weekday": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "b5150cbd-9bbc-4d5f-a6a2-21cafbc70b7e",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-05-24T07:20:20+00:00",
      "updated_at": "2022-05-24T07:20:20+00:00",
...
```json
  {
  "data": {
    "id": "ea91f49e-7cb1-4d70-963b-2bbd85839769",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-05-24T07:20:20+00:00",
      "updated_at": "2022-05-24T07:20:20+00:00",
...
```json
  {
  "data": {
    "id": "ba8a183b-db8f-4127-9740-3b5a7df67779",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-05-24T07:20:20+00:00",
      "updated_at": "2022-05-24T07:20:20+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/711974f3-304d-4caf-923a-ee09ca0d511d' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "711974f3-304d-4caf-923a-ee09ca0d511d",
        "type": "operating_rules",
        "attributes": {
          "data": {
            "away": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/bd5d5257-a50d-46d8-8e9d-c574fa6945ec' \
    --header 'content-type: application/json' \
```
