...
```json
  ...
  "data": [
    {
      "id": "6cdf34b5-6898-4c3a-8f6b-d55d735e275d",
      "type": "operating_rules",
      "attributes": {
        "created_at": "2023-03-07T08:09:51+00:00",
        "updated_at": "2023-03-07T08:09:51+00:00",
        "data_type": "away",
        "data": {
          "away": {
            "from": "2020-01-01",
...
```json
  {
  "data": {
    "id": "c6d80724-f482-4505-8b0f-307075e7c136",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-03-07T08:09:52+00:00",
      "updated_at": "2023-03-07T08:09:52+00:00",
      "data_type": "hours",
      "data": {
        "mon": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "5fa47d53-0f4b-4ff5-b84e-4ea2fb3361a2",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-03-07T08:09:52+00:00",
      "updated_at": "2023-03-07T08:09:52+00:00",
...
```json
  {
  "data": {
    "id": "a3c4e9a8-4c17-496e-ad07-cb7394d9bbbd",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-03-07T08:09:52+00:00",
      "updated_at": "2023-03-07T08:09:52+00:00",
...
```json
  {
  "data": {
    "id": "b28cb8ac-67ee-45c0-a8c8-b6277908d2ea",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-03-07T08:09:53+00:00",
      "updated_at": "2023-03-07T08:09:53+00:00",
      "data_type": "timeslot_fixed",
      "data": {
        "weekend": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "791d2ddb-95e6-4c0b-9c94-95ee83842c08",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-03-07T08:09:53+00:00",
      "updated_at": "2023-03-07T08:09:53+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/6c566f4c-01c3-442a-ba1c-e6859d987656' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "6c566f4c-01c3-442a-ba1c-e6859d987656",
        "type": "operating_rules",
        "attributes": {
          "data": {
            "away": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/3c7a2c93-dd24-4414-9920-6e8188a7f1d5' \
    --header 'content-type: application/json' \
```
