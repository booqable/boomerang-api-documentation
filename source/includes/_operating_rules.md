...
```json
  ...
  "data": [
    {
      "id": "fe8b3372-ba25-4e5b-880a-0f2d81aef221",
      "type": "operating_rules",
      "attributes": {
        "created_at": "2023-02-08T08:36:43+00:00",
        "updated_at": "2023-02-08T08:36:43+00:00",
        "data_type": "away",
        "data": {
          "away": {
            "from": "2020-01-01",
...
```json
  {
  "data": {
    "id": "0ab9b097-b6c2-422f-b1c9-c074a0c5fadd",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-08T08:36:43+00:00",
      "updated_at": "2023-02-08T08:36:43+00:00",
...
```json
  {
  "data": {
    "id": "7e49081f-9fab-4f41-97a6-79c567bd313d",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-08T08:36:43+00:00",
      "updated_at": "2023-02-08T08:36:43+00:00",
...
```json
  {
  "data": {
    "id": "dea55c1e-9870-46e6-9ac0-2de848ef7396",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-08T08:36:44+00:00",
      "updated_at": "2023-02-08T08:36:44+00:00",
      "data_type": "away",
      "data": {
        "away": {
          "from": "2030-01-01",
...
```json
  {
  "data": {
    "id": "a44f9dc4-afe9-4da5-9718-1f8888090444",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-08T08:36:44+00:00",
      "updated_at": "2023-02-08T08:36:44+00:00",
...
```json
  {
  "data": {
    "id": "c0f695f1-faa5-4e1a-8620-36926f361282",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-08T08:36:45+00:00",
      "updated_at": "2023-02-08T08:36:45+00:00",
      "data_type": "timeslot_duration",
      "data": {
        "length": 86000
      }
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/6a27bc34-e83e-4217-8177-6d2687df5753' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "6a27bc34-e83e-4217-8177-6d2687df5753",
        "type": "operating_rules",
        "attributes": {
          "data": {
            "away": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/5d5b13b7-a55f-4946-85a6-870ef30cf975' \
    --header 'content-type: application/json' \
```
