...
```json
  ...
  "data": [
    {
      "id": "98d12f81-2fe1-4338-b3bc-c1a65dd59726",
      "type": "operating_rules",
      "attributes": {
        "created_at": "2023-02-13T12:15:04+00:00",
        "updated_at": "2023-02-13T12:15:04+00:00",
        "data_type": "away",
        "data": {
          "away": {
            "from": "2020-01-01",
...
```json
  {
  "data": {
    "id": "af3d7d38-2866-4ccb-b9c5-29eb8f49ff7d",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-13T12:15:04+00:00",
      "updated_at": "2023-02-13T12:15:04+00:00",
...
```json
  {
  "data": {
    "id": "db95c87b-4c28-4b02-a5f6-c5ec6f179a4e",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-13T12:15:05+00:00",
      "updated_at": "2023-02-13T12:15:05+00:00",
      "data_type": "hours",
      "data": {
        "weekday": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "92eb1046-1466-44c7-8fee-455c1e19adf7",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-13T12:15:05+00:00",
      "updated_at": "2023-02-13T12:15:05+00:00",
...
```json
  {
  "data": {
    "id": "c61156f7-2cea-4a80-94f9-4f52aad528af",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-13T12:15:05+00:00",
      "updated_at": "2023-02-13T12:15:05+00:00",
...
```json
  {
  "data": {
    "id": "66c7e4f5-0bfc-4ec8-814a-a85380cea228",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-13T12:15:06+00:00",
      "updated_at": "2023-02-13T12:15:06+00:00",
      "data_type": "timeslot_duration",
      "data": {
        "length": 86000
      }
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/863078e2-60b3-4f34-8e9d-c757f524aaf6' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "863078e2-60b3-4f34-8e9d-c757f524aaf6",
        "type": "operating_rules",
        "attributes": {
          "data": {
            "away": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/6eb1b703-6a82-4ded-8d9a-985539aae666' \
    --header 'content-type: application/json' \
```
