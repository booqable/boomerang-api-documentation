...
```json
  ...
  "data": [
    {
      "id": "8a7bfae9-de32-4140-bb1c-f405e0451a9c",
      "type": "operating_rules",
      "attributes": {
        "created_at": "2023-02-16T09:22:13+00:00",
        "updated_at": "2023-02-16T09:22:13+00:00",
        "data_type": "away",
        "data": {
          "away": {
            "from": "2020-01-01",
...
```json
  {
  "data": {
    "id": "8fe718f4-aa85-41ae-8de0-ff55d68e4733",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-16T09:22:13+00:00",
      "updated_at": "2023-02-16T09:22:13+00:00",
...
```json
  {
  "data": {
    "id": "d59b86b7-a932-4a81-a03c-19d847e9e2f9",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-16T09:22:14+00:00",
      "updated_at": "2023-02-16T09:22:14+00:00",
      "data_type": "hours",
      "data": {
        "weekday": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "caa24d71-b12b-4309-80a3-78c0b6f3e7e1",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-16T09:22:14+00:00",
      "updated_at": "2023-02-16T09:22:14+00:00",
...
```json
  {
  "data": {
    "id": "fec7e1eb-a663-4647-a27a-25fc3c14b1dd",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-16T09:22:15+00:00",
      "updated_at": "2023-02-16T09:22:15+00:00",
      "data_type": "timeslot_fixed",
      "data": {
        "weekend": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "1508234a-7990-4dd6-b1c9-d90f1043de2a",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-16T09:22:16+00:00",
      "updated_at": "2023-02-16T09:22:16+00:00",
      "data_type": "timeslot_duration",
      "data": {
        "length": 86000
      }
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/a7841cde-b39f-4f0a-97fd-e8ea322b8eee' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "a7841cde-b39f-4f0a-97fd-e8ea322b8eee",
        "type": "operating_rules",
        "attributes": {
          "data": {
            "away": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/1c43f10e-15eb-4cb9-bdfa-ace99f9bf49a' \
    --header 'content-type: application/json' \
```
