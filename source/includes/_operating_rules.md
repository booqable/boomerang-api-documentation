...
```json
  ...
  "data": [
    {
      "id": "7c1b9255-af17-4f27-839d-3b502def4af3",
      "type": "operating_rules",
      "attributes": {
        "created_at": "2023-02-02T16:30:10+00:00",
        "updated_at": "2023-02-02T16:30:10+00:00",
        "data_type": "away",
        "data": {
          "away": {
            "from": "2020-01-01",
...
```json
  {
  "data": {
    "id": "64e69849-9ae6-46bb-8971-0845864a93a6",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-02T16:30:11+00:00",
      "updated_at": "2023-02-02T16:30:11+00:00",
      "data_type": "hours",
      "data": {
        "mon": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "4c036db2-c412-4935-aaa0-2cd8d7e17b6a",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-02T16:30:11+00:00",
      "updated_at": "2023-02-02T16:30:11+00:00",
...
```json
  {
  "data": {
    "id": "94fd3674-1e53-404d-b53b-fc64715126d6",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-02T16:30:12+00:00",
      "updated_at": "2023-02-02T16:30:12+00:00",
      "data_type": "away",
      "data": {
        "away": {
          "from": "2030-01-01",
...
```json
  {
  "data": {
    "id": "0b479087-0c9e-486a-b532-518de426d7c9",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-02T16:30:12+00:00",
      "updated_at": "2023-02-02T16:30:12+00:00",
...
```json
  {
  "data": {
    "id": "ecd568ad-9911-4ad0-99ec-daeb10e17fbd",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-02T16:30:13+00:00",
      "updated_at": "2023-02-02T16:30:13+00:00",
      "data_type": "timeslot_duration",
      "data": {
        "length": 86000
      }
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/0e5a68e9-20e6-4fd8-b3a3-6860bf09b882' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "0e5a68e9-20e6-4fd8-b3a3-6860bf09b882",
        "type": "operating_rules",
        "attributes": {
          "data": {
            "away": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/80c157c2-c676-4607-8aa7-c836757b042f' \
    --header 'content-type: application/json' \
```
