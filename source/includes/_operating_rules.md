...
```json
  ...
  "data": [
    {
      "id": "936e79bf-12c3-4fff-adbc-1b5281570756",
      "type": "operating_rules",
      "attributes": {
        "created_at": "2023-02-09T11:03:29+00:00",
        "updated_at": "2023-02-09T11:03:29+00:00",
        "data_type": "away",
        "data": {
          "away": {
            "from": "2020-01-01",
...
```json
  {
  "data": {
    "id": "cd659a54-fde5-4cbb-a71f-209d8d746c54",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-09T11:03:29+00:00",
      "updated_at": "2023-02-09T11:03:29+00:00",
...
```json
  {
  "data": {
    "id": "86ae5b35-34d1-46d9-82e2-be6add126795",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-09T11:03:29+00:00",
      "updated_at": "2023-02-09T11:03:29+00:00",
...
```json
  {
  "data": {
    "id": "1d4c7c28-c976-48ae-8982-c93149e0cbac",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-09T11:03:30+00:00",
      "updated_at": "2023-02-09T11:03:30+00:00",
      "data_type": "away",
      "data": {
        "away": {
          "from": "2030-01-01",
...
```json
  {
  "data": {
    "id": "5f9fcd80-7118-4e49-b04b-70663830f0ee",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-09T11:03:30+00:00",
      "updated_at": "2023-02-09T11:03:30+00:00",
...
```json
  {
  "data": {
    "id": "1c81986c-fabe-4ac0-9914-f49d5ad6e9e3",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-09T11:03:30+00:00",
      "updated_at": "2023-02-09T11:03:30+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/5eac3b6c-1afd-492e-ab93-2c995efcab24' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "5eac3b6c-1afd-492e-ab93-2c995efcab24",
        "type": "operating_rules",
        "attributes": {
          "data": {
            "away": {
...
```json
  ...
  "data": {
    ...
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-09T11:03:31+00:00",
      "updated_at": "2023-02-09T11:03:31+00:00",
      "data_type": "away",
      "data": {
        "away": {
          "from": "2020-04-01",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/df780a9b-861b-4a81-8bd3-9adceee5c7df' \
    --header 'content-type: application/json' \
```
