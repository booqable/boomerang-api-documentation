...
```json
  ...
  "data": [
    {
      "id": "a1a0d750-9c31-4f7c-9465-b56197284b26",
      "type": "operating_rules",
      "attributes": {
        "created_at": "2022-06-30T13:11:56+00:00",
        "updated_at": "2022-06-30T13:11:56+00:00",
        "data_type": "away",
        "data": {
          "away": {
            "from": "2020-01-01",
...
```json
  {
  "data": {
    "id": "76986918-7eda-4e7a-b846-bab5e9ad6c6f",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-06-30T13:11:56+00:00",
      "updated_at": "2022-06-30T13:11:56+00:00",
...
```json
  {
  "data": {
    "id": "a1b3000b-c1ea-41c9-b6f9-6421daf7bee0",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-06-30T13:11:56+00:00",
      "updated_at": "2022-06-30T13:11:56+00:00",
...
```json
  {
  "data": {
    "id": "4a46025b-147f-49bf-92b0-fd52085ab52f",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-06-30T13:11:56+00:00",
      "updated_at": "2022-06-30T13:11:56+00:00",
...
```json
  {
  "data": {
    "id": "8cdabe53-ab24-4a04-a93a-4d7086d536e6",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-06-30T13:11:57+00:00",
      "updated_at": "2022-06-30T13:11:57+00:00",
      "data_type": "timeslot_fixed",
      "data": {
        "weekend": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "24800cb9-cefb-4081-aa52-7358b1e41983",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-06-30T13:11:57+00:00",
      "updated_at": "2022-06-30T13:11:57+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/b3bb4ad4-3db2-4a7e-a4bc-2ef7d1efa12b' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "b3bb4ad4-3db2-4a7e-a4bc-2ef7d1efa12b",
        "type": "operating_rules",
        "attributes": {
          "data": {
            "away": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/3bb22613-3c6a-48a2-9255-0fac80de5c51' \
    --header 'content-type: application/json' \
```
