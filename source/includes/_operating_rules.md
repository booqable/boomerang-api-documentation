...
```json
  ...
  "data": [
    {
      "id": "f210ac8d-f52e-4e39-8b04-3912825aaadb",
...
```json
  {
  "data": {
    "id": "bb82f079-7454-43f7-9447-b54ddbc86814",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-05-05T09:13:52+00:00",
      "updated_at": "2022-05-05T09:13:52+00:00",
      "data_type": "hours",
      "data": {
        "mon": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "530850d4-55e9-46ef-93d7-0ae7217e3349",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-05-05T09:13:52+00:00",
      "updated_at": "2022-05-05T09:13:52+00:00",
...
```json
  {
  "data": {
    "id": "25137ade-a5e1-40ab-a3e3-6b4473748374",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-05-05T09:13:52+00:00",
      "updated_at": "2022-05-05T09:13:52+00:00",
...
```json
  {
  "data": {
    "id": "cc14b180-cb25-4fa0-a203-aa91d13a7c30",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-05-05T09:13:52+00:00",
      "updated_at": "2022-05-05T09:13:52+00:00",
...
```json
  {
  "data": {
    "id": "2b236235-d3a8-4761-b63a-9221a483f859",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-05-05T09:13:53+00:00",
      "updated_at": "2022-05-05T09:13:53+00:00",
      "data_type": "timeslot_duration",
      "data": {
        "length": 86000
      }
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/2101bcfe-e0d8-42d6-ac45-0fbcea02c85d' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "2101bcfe-e0d8-42d6-ac45-0fbcea02c85d",
        "type": "operating_rules",
        "attributes": {
          "data": {
            "away": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/93102dc4-7e63-4b88-bb65-b663f7960541' \
    --header 'content-type: application/json' \
```
