...
```json
  ...
  "data": [
    {
      "id": "ad95979e-4aaf-4303-9a85-60e0026138c9",
...
```json
  {
  "data": {
    "id": "5cc0921f-b2d2-46d6-9543-bee75709318c",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-02T15:26:29+00:00",
      "updated_at": "2023-02-02T15:26:29+00:00",
      "data_type": "hours",
      "data": {
        "mon": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "b6e51783-8ca5-4d3a-a8fe-ed726eb3527b",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-02T15:26:29+00:00",
      "updated_at": "2023-02-02T15:26:29+00:00",
...
```json
  {
  "data": {
    "id": "07354c86-9370-448b-9f07-297a9a413876",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-02T15:26:29+00:00",
      "updated_at": "2023-02-02T15:26:29+00:00",
...
```json
  {
  "data": {
    "id": "c24053ae-2e37-443c-9815-aa4c1e6aeaac",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-02T15:26:30+00:00",
      "updated_at": "2023-02-02T15:26:30+00:00",
      "data_type": "timeslot_fixed",
      "data": {
        "weekend": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "9e854994-656d-44f7-96bd-76596dd3de69",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-02T15:26:30+00:00",
      "updated_at": "2023-02-02T15:26:30+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/c14c4fd8-4941-4ee9-b12a-714525c208cc' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "c14c4fd8-4941-4ee9-b12a-714525c208cc",
        "type": "operating_rules",
        "attributes": {
          "data": {
            "away": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/1b9a0dc5-9d95-406f-a72a-8ffa221a20c6' \
    --header 'content-type: application/json' \
```
