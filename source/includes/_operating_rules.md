...
```json
  ...
  "data": [
    {
      "id": "889f1b5f-9c04-449b-a29a-be4674ce380a",
      "type": "operating_rules",
      "attributes": {
        "created_at": "2023-03-08T07:53:38+00:00",
        "updated_at": "2023-03-08T07:53:38+00:00",
        "data_type": "away",
        "data": {
          "away": {
            "from": "2020-01-01",
...
```json
  {
  "data": {
    "id": "fe757f0a-58a9-4c63-afaa-35b682cb1bd7",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-03-08T07:53:38+00:00",
      "updated_at": "2023-03-08T07:53:38+00:00",
...
```json
  {
  "data": {
    "id": "856d2d59-1c35-41c5-8145-47376816fcb3",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-03-08T07:53:39+00:00",
      "updated_at": "2023-03-08T07:53:39+00:00",
      "data_type": "hours",
      "data": {
        "weekday": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "0dcff6a5-031c-4dd7-b169-31e879c758da",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-03-08T07:53:39+00:00",
      "updated_at": "2023-03-08T07:53:39+00:00",
...
```json
  {
  "data": {
    "id": "50ac2788-32ad-451f-a868-b98b120af283",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-03-08T07:53:39+00:00",
      "updated_at": "2023-03-08T07:53:39+00:00",
...
```json
  {
  "data": {
    "id": "a8f82972-4d64-4723-a69f-72d09b1177ee",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-03-08T07:53:40+00:00",
      "updated_at": "2023-03-08T07:53:40+00:00",
      "data_type": "timeslot_duration",
      "data": {
        "length": 86000
      }
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/535cf8d8-b5ea-4e8b-b32b-8307a9698381' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "535cf8d8-b5ea-4e8b-b32b-8307a9698381",
        "type": "operating_rules",
        "attributes": {
          "data": {
            "away": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/f84fb97e-d36b-43bd-9143-0d37380fbf8f' \
    --header 'content-type: application/json' \
```
