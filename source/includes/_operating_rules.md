...
```json
  ...
  "data": [
    {
      "id": "2adc681b-0749-41c7-b410-eb4292c53f83",
      "type": "operating_rules",
      "attributes": {
        "created_at": "2023-02-22T11:53:22+00:00",
        "updated_at": "2023-02-22T11:53:22+00:00",
        "data_type": "away",
        "data": {
          "away": {
            "from": "2020-01-01",
...
```json
  {
  "data": {
    "id": "aef414c1-b7fb-4c2a-868d-59dcda28fec4",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-22T11:53:23+00:00",
      "updated_at": "2023-02-22T11:53:23+00:00",
      "data_type": "hours",
      "data": {
        "mon": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "f830773b-0d8b-4041-99e0-0db863b08149",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-22T11:53:23+00:00",
      "updated_at": "2023-02-22T11:53:23+00:00",
...
```json
  {
  "data": {
    "id": "6272e738-953e-4f55-9e93-17561e21aa86",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-22T11:53:24+00:00",
      "updated_at": "2023-02-22T11:53:24+00:00",
      "data_type": "away",
      "data": {
        "away": {
          "from": "2030-01-01",
...
```json
  {
  "data": {
    "id": "70c2eb35-7b21-4c7e-a857-8188d75d569d",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-22T11:53:24+00:00",
      "updated_at": "2023-02-22T11:53:24+00:00",
...
```json
  {
  "data": {
    "id": "f563575e-439d-4c7c-a928-27aa712a249d",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-22T11:53:25+00:00",
      "updated_at": "2023-02-22T11:53:25+00:00",
      "data_type": "timeslot_duration",
      "data": {
        "length": 86000
      }
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/d8e0a89f-6e5a-4641-9755-cd22cfb8ac4a' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "d8e0a89f-6e5a-4641-9755-cd22cfb8ac4a",
        "type": "operating_rules",
        "attributes": {
          "data": {
            "away": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/90244b2d-2dd9-4525-8541-25a7bfde0d77' \
    --header 'content-type: application/json' \
```
