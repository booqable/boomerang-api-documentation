...
```json
  ...
  "data": [
    {
      "id": "296e99b8-da46-4268-855e-3f01db75d788",
      "type": "operating_rules",
      "attributes": {
        "created_at": "2023-02-13T12:14:00+00:00",
        "updated_at": "2023-02-13T12:14:00+00:00",
        "data_type": "away",
        "data": {
          "away": {
            "from": "2020-01-01",
...
```json
  {
  "data": {
    "id": "7bf630ec-f360-48d6-8fcc-5990a55004f9",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-13T12:14:00+00:00",
      "updated_at": "2023-02-13T12:14:00+00:00",
...
```json
  {
  "data": {
    "id": "30be80b3-25be-4d66-a419-5e2170384ee8",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-13T12:14:01+00:00",
      "updated_at": "2023-02-13T12:14:01+00:00",
      "data_type": "hours",
      "data": {
        "weekday": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "a4996525-41e0-4f9a-a55f-922326d23736",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-13T12:14:01+00:00",
      "updated_at": "2023-02-13T12:14:01+00:00",
...
```json
  {
  "data": {
    "id": "b229bb29-ef1c-4f62-a8db-fed2c00953d3",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-13T12:14:02+00:00",
      "updated_at": "2023-02-13T12:14:02+00:00",
      "data_type": "timeslot_fixed",
      "data": {
        "weekend": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "a263c741-41dd-41c8-ba8a-9d588fa90adc",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-13T12:14:02+00:00",
      "updated_at": "2023-02-13T12:14:02+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/4d190f36-9cea-4b58-a289-1b5d492cde9e' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "4d190f36-9cea-4b58-a289-1b5d492cde9e",
        "type": "operating_rules",
        "attributes": {
          "data": {
            "away": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/2dd097d9-f17a-403a-bd53-d997a244deed' \
    --header 'content-type: application/json' \
```
