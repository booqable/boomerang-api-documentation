...
```json
  ...
  "data": [
    {
      "id": "e9520a4c-04d1-4729-8f81-9d8765eda9d8",
...
```json
  {
  "data": {
    "id": "9c951ff5-11f1-4f4c-bd25-828812db8512",
    "type": "operating_rules",
    "attributes": {
...
```json
  {
  "data": {
    "id": "26e9ac62-770b-4d0a-93d9-47a838351c50",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-14T11:07:27+00:00",
      "updated_at": "2023-02-14T11:07:27+00:00",
...
```json
  {
  "data": {
    "id": "648796b4-f618-4498-b756-84ea8b93d68d",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-14T11:07:27+00:00",
      "updated_at": "2023-02-14T11:07:27+00:00",
...
```json
  {
  "data": {
    "id": "a511b579-ad34-46f8-8daa-f44802986007",
    "type": "operating_rules",
    "attributes": {
...
```json
  {
  "data": {
    "id": "df27eed2-215a-49e1-b16d-5552682021ee",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-14T11:07:28+00:00",
      "updated_at": "2023-02-14T11:07:28+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/98d0327d-e87f-4e38-b022-bf8088b2cf47' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "98d0327d-e87f-4e38-b022-bf8088b2cf47",
        "type": "operating_rules",
        "attributes": {
          "data": {
            "away": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/4c0901fb-1c5c-42a4-a4ac-419ea3c4ca55' \
    --header 'content-type: application/json' \
```
