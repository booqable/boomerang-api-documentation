...
```json
  ...
  "data": [
    {
      "id": "58bfbce9-a51c-4b62-b0a5-87404cf0977c",
      "type": "operating_rules",
      "attributes": {
        "created_at": "2023-02-28T08:12:16+00:00",
        "updated_at": "2023-02-28T08:12:16+00:00",
        "data_type": "away",
        "data": {
          "away": {
            "from": "2020-01-01",
...
```json
  {
  "data": {
    "id": "13db6777-f19e-49dc-b7a2-b7dcc0f9aa84",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-28T08:12:16+00:00",
      "updated_at": "2023-02-28T08:12:16+00:00",
...
```json
  {
  "data": {
    "id": "27b4f3c3-4b7d-4310-873d-96b156b15add",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-28T08:12:16+00:00",
      "updated_at": "2023-02-28T08:12:16+00:00",
...
```json
  {
  "data": {
    "id": "f6ebf165-2d7c-4240-8141-d526da965a30",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-28T08:12:17+00:00",
      "updated_at": "2023-02-28T08:12:17+00:00",
      "data_type": "away",
      "data": {
        "away": {
          "from": "2030-01-01",
...
```json
  {
  "data": {
    "id": "1ca26a92-5416-4ed7-ac65-f6571bfb3bc3",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-28T08:12:17+00:00",
      "updated_at": "2023-02-28T08:12:17+00:00",
...
```json
  {
  "data": {
    "id": "a6ad3113-f4b8-4b98-a48f-2f8aca2d9042",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-28T08:12:17+00:00",
      "updated_at": "2023-02-28T08:12:17+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/543f7159-8b58-40e2-b245-fd7bd0d99645' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "543f7159-8b58-40e2-b245-fd7bd0d99645",
        "type": "operating_rules",
        "attributes": {
          "data": {
            "away": {
...
```json
  ...
  "data": {
    ...
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-28T08:12:18+00:00",
      "updated_at": "2023-02-28T08:12:18+00:00",
      "data_type": "away",
      "data": {
        "away": {
          "from": "2020-04-01",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/b74a008e-629b-46e5-b1cd-98fc19d8dbd0' \
    --header 'content-type: application/json' \
```
