...
```json
  ...
  "data": [
    {
      "id": "56a55ed8-085e-4383-8425-0796477cee5c",
      "type": "operating_rules",
      "attributes": {
        "created_at": "2023-03-02T12:40:53+00:00",
        "updated_at": "2023-03-02T12:40:53+00:00",
        "data_type": "away",
        "data": {
          "away": {
            "from": "2020-01-01",
...
```json
  {
  "data": {
    "id": "1d36cb10-fd4c-41c8-8dcc-2d79b6257ca1",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-03-02T12:40:53+00:00",
      "updated_at": "2023-03-02T12:40:53+00:00",
...
```json
  {
  "data": {
    "id": "9412e6bc-242f-45d5-bc0c-3178f6c6d893",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-03-02T12:40:54+00:00",
      "updated_at": "2023-03-02T12:40:54+00:00",
      "data_type": "hours",
      "data": {
        "weekday": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "8c56eb53-17e9-4bcb-a8d8-de08819edc5c",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-03-02T12:40:54+00:00",
      "updated_at": "2023-03-02T12:40:54+00:00",
...
```json
  {
  "data": {
    "id": "6ea48e92-ebcf-407e-bdce-77d035e9dc18",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-03-02T12:40:55+00:00",
      "updated_at": "2023-03-02T12:40:55+00:00",
      "data_type": "timeslot_fixed",
      "data": {
        "weekend": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "f18a1da7-d3b0-4018-8fce-ef7e6ed2ed87",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-03-02T12:40:55+00:00",
      "updated_at": "2023-03-02T12:40:55+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/298520ff-7eea-42d0-a924-3f49052bf388' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "298520ff-7eea-42d0-a924-3f49052bf388",
        "type": "operating_rules",
        "attributes": {
          "data": {
            "away": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/0be0586c-b4ad-4cc0-979d-0e29abd7cf93' \
    --header 'content-type: application/json' \
```
