...
```json
  ...
  "data": [
    {
      "id": "e0b0ff6c-7826-421d-add6-f7be725765eb",
      "type": "operating_rules",
      "attributes": {
        "created_at": "2022-04-12T18:25:53+00:00",
        "updated_at": "2022-04-12T18:25:53+00:00",
        "data_type": "away",
        "data": {
          "away": {
            "from": "2020-01-01",
...
```json
  {
  "data": {
    "id": "6c698fdd-3551-427c-91b7-6ee1f2ca28f5",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-04-12T18:25:53+00:00",
      "updated_at": "2022-04-12T18:25:53+00:00",
...
```json
  {
  "data": {
    "id": "776be997-3695-4d91-9384-76bf67e4513d",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-04-12T18:25:53+00:00",
      "updated_at": "2022-04-12T18:25:53+00:00",
...
```json
  {
  "data": {
    "id": "4af59265-9835-4ee7-8a51-b329a73b77a8",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-04-12T18:25:53+00:00",
      "updated_at": "2022-04-12T18:25:53+00:00",
...
```json
  {
  "data": {
    "id": "2a5412c0-3c7c-434d-a262-5733a989c466",
    "type": "operating_rules",
    "attributes": {
...
```json
  {
  "data": {
    "id": "17e30e36-33c9-44db-a296-5f3e33047d06",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-04-12T18:25:54+00:00",
      "updated_at": "2022-04-12T18:25:54+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/c80fbcff-80ab-44ec-a308-808a5079e99e' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "c80fbcff-80ab-44ec-a308-808a5079e99e",
        "type": "operating_rules",
        "attributes": {
          "data": {
            "away": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/acdb35a2-e01a-43a2-9957-c1c93c57c54a' \
    --header 'content-type: application/json' \
```
