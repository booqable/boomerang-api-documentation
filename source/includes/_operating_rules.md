...
```json
  ...
  "data": [
    {
      "id": "8b936d8c-427b-4d0d-97dd-0817e7147f83",
...
```json
  {
  "data": {
    "id": "ece0d1e4-d607-4c13-924a-366a6ab8cf56",
    "type": "operating_rules",
    "attributes": {
...
```json
  {
  "data": {
    "id": "5548f835-bad3-416c-b837-cf956a310d4f",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-07T10:28:52+00:00",
      "updated_at": "2023-02-07T10:28:52+00:00",
...
```json
  {
  "data": {
    "id": "a5de8b44-1443-4a9c-8e10-6b6ad07beeff",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-07T10:28:53+00:00",
      "updated_at": "2023-02-07T10:28:53+00:00",
      "data_type": "away",
      "data": {
        "away": {
          "from": "2030-01-01",
...
```json
  {
  "data": {
    "id": "f230f8ff-1f56-4742-90d1-92e611142ed1",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-07T10:28:53+00:00",
      "updated_at": "2023-02-07T10:28:53+00:00",
...
```json
  {
  "data": {
    "id": "be426570-9786-4545-be0f-f5c6f4606ec0",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-07T10:28:54+00:00",
      "updated_at": "2023-02-07T10:28:54+00:00",
      "data_type": "timeslot_duration",
      "data": {
        "length": 86000
      }
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/3d7754b9-b48b-49ce-bf45-a8a86994af87' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "3d7754b9-b48b-49ce-bf45-a8a86994af87",
        "type": "operating_rules",
        "attributes": {
          "data": {
            "away": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/8dce8feb-a52f-4455-962e-40a9030c9e97' \
    --header 'content-type: application/json' \
```
