...
```json
  ...
  "data": [
    {
      "id": "f673acca-0b8c-4d2e-baec-2eda52e33e50",
      "type": "operating_rules",
      "attributes": {
        "created_at": "2022-06-15T09:35:40+00:00",
        "updated_at": "2022-06-15T09:35:40+00:00",
        "data_type": "away",
        "data": {
          "away": {
            "from": "2020-01-01",
...
```json
  {
  "data": {
    "id": "2c0bdb7c-4697-440c-bd82-c6384f2972cc",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-06-15T09:35:40+00:00",
      "updated_at": "2022-06-15T09:35:40+00:00",
...
```json
  {
  "data": {
    "id": "dfb51e36-b484-41f4-91b7-d4fb50f5c107",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-06-15T09:35:41+00:00",
      "updated_at": "2022-06-15T09:35:41+00:00",
      "data_type": "hours",
      "data": {
        "weekday": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "92a4f2d7-0f13-4bed-a57b-c0fb302aab20",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-06-15T09:35:41+00:00",
      "updated_at": "2022-06-15T09:35:41+00:00",
...
```json
  {
  "data": {
    "id": "9dfc5fd9-217c-4a38-8b45-c5b6a3b320e8",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-06-15T09:35:41+00:00",
      "updated_at": "2022-06-15T09:35:41+00:00",
...
```json
  {
  "data": {
    "id": "48d0d6f1-a52e-4eba-a806-e90b11c2a337",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-06-15T09:35:42+00:00",
      "updated_at": "2022-06-15T09:35:42+00:00",
      "data_type": "timeslot_duration",
      "data": {
        "length": 86000
      }
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/5d791537-45b5-42a0-861e-4a7f9260ae2c' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "5d791537-45b5-42a0-861e-4a7f9260ae2c",
        "type": "operating_rules",
        "attributes": {
          "data": {
            "away": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/4752f43c-cebe-469d-8c71-2fe486e0e757' \
    --header 'content-type: application/json' \
```
