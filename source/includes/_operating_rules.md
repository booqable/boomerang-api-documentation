...
```json
  ...
  "data": [
    {
      "id": "fadcbd74-4e79-40b7-b6fb-d62ae6841e3c",
      "type": "operating_rules",
      "attributes": {
        "created_at": "2022-07-15T09:24:59+00:00",
        "updated_at": "2022-07-15T09:24:59+00:00",
        "data_type": "away",
        "data": {
          "away": {
            "from": "2020-01-01",
...
```json
  {
  "data": {
    "id": "85bf8764-c542-4f50-ac74-24e33e278585",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-07-15T09:24:59+00:00",
      "updated_at": "2022-07-15T09:24:59+00:00",
...
```json
  {
  "data": {
    "id": "f4728542-3d55-41ed-8b8a-e36446a0db43",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-07-15T09:25:00+00:00",
      "updated_at": "2022-07-15T09:25:00+00:00",
      "data_type": "hours",
      "data": {
        "weekday": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "b5f44b5a-d9d1-4809-aa16-ddb7a746b975",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-07-15T09:25:00+00:00",
      "updated_at": "2022-07-15T09:25:00+00:00",
...
```json
  {
  "data": {
    "id": "d362e0f9-7857-46f5-bf49-614f4c249bcf",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-07-15T09:25:01+00:00",
      "updated_at": "2022-07-15T09:25:01+00:00",
      "data_type": "timeslot_fixed",
      "data": {
        "weekend": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "7c8470dd-7878-45c3-b09e-d20eb6acb4e1",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-07-15T09:25:01+00:00",
      "updated_at": "2022-07-15T09:25:01+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/c8ab5884-c8b0-4912-b813-e93497e80b5a' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "c8ab5884-c8b0-4912-b813-e93497e80b5a",
        "type": "operating_rules",
        "attributes": {
          "data": {
            "away": {
...
```json
  ...
  "data": {
    ...
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-07-15T09:25:02+00:00",
      "updated_at": "2022-07-15T09:25:02+00:00",
      "data_type": "away",
      "data": {
        "away": {
          "from": "2020-04-01",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/6217f5d7-6403-412c-a625-358a837774b2' \
    --header 'content-type: application/json' \
```
