...
```json
  ...
  "data": [
    {
      "id": "585c96a1-2771-4fec-86a8-b50100c10760",
      "type": "operating_rules",
      "attributes": {
        "created_at": "2023-02-24T09:48:34+00:00",
        "updated_at": "2023-02-24T09:48:34+00:00",
        "data_type": "away",
        "data": {
          "away": {
            "from": "2020-01-01",
...
```json
  {
  "data": {
    "id": "657f3187-c46e-46b0-9122-1bbc189da52d",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-24T09:48:34+00:00",
      "updated_at": "2023-02-24T09:48:34+00:00",
...
```json
  {
  "data": {
    "id": "a46da10a-e095-493c-8e4e-b6f8147ed161",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-24T09:48:35+00:00",
      "updated_at": "2023-02-24T09:48:35+00:00",
      "data_type": "hours",
      "data": {
        "weekday": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "c64741cb-3c81-4929-9b84-7785dfc26cbc",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-24T09:48:35+00:00",
      "updated_at": "2023-02-24T09:48:35+00:00",
...
```json
  {
  "data": {
    "id": "f737f423-6569-4060-b9e8-1da0a702449c",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-24T09:48:35+00:00",
      "updated_at": "2023-02-24T09:48:35+00:00",
...
```json
  {
  "data": {
    "id": "c67320a8-6b96-40cc-a65a-40a63214c371",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-24T09:48:36+00:00",
      "updated_at": "2023-02-24T09:48:36+00:00",
      "data_type": "timeslot_duration",
      "data": {
        "length": 86000
      }
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/806ad89c-0559-4a59-9599-8ab7782ba765' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "806ad89c-0559-4a59-9599-8ab7782ba765",
        "type": "operating_rules",
        "attributes": {
          "data": {
            "away": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/447b0733-ab15-4c09-974e-a091ed9eb8a0' \
    --header 'content-type: application/json' \
```
