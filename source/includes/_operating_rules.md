...
```json
  ...
  "data": [
    {
      "id": "cee460e5-f30e-4878-9ed5-452921e3fe78",
...
```json
  {
  "data": {
    "id": "6dfdbcd7-116c-4778-be69-492f0120ea8c",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-05-30T12:19:06+00:00",
      "updated_at": "2022-05-30T12:19:06+00:00",
      "data_type": "hours",
      "data": {
        "mon": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "d2cee451-d6ce-4fb1-bc4d-204759da8545",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-05-30T12:19:06+00:00",
      "updated_at": "2022-05-30T12:19:06+00:00",
...
```json
  {
  "data": {
    "id": "9e32f47e-4317-42bf-b5c7-2874aa575f18",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-05-30T12:19:06+00:00",
      "updated_at": "2022-05-30T12:19:06+00:00",
...
```json
  {
  "data": {
    "id": "3a9cdcb3-b535-4239-8524-b625f67c1312",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-05-30T12:19:07+00:00",
      "updated_at": "2022-05-30T12:19:07+00:00",
      "data_type": "timeslot_fixed",
      "data": {
        "weekend": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "f589164c-03b6-4dff-881d-82ce9ce64fb1",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-05-30T12:19:07+00:00",
      "updated_at": "2022-05-30T12:19:07+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/c619032f-cf73-43d2-80d2-a1969814dc56' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "c619032f-cf73-43d2-80d2-a1969814dc56",
        "type": "operating_rules",
        "attributes": {
          "data": {
            "away": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/150ae965-abbb-4cfa-b601-e884147b08b5' \
    --header 'content-type: application/json' \
```
