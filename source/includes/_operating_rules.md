...
```json
  ...
  "data": [
    {
      "id": "4c41c8b8-d4bc-4a2a-af61-2ba71d1a365b",
...
```json
  {
  "data": {
    "id": "7df3c076-6c8e-44ee-bc83-5d088406c86b",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-01-20T12:34:11+00:00",
      "updated_at": "2022-01-20T12:34:11+00:00",
      "data_type": "hours",
      "data": {
        "mon": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "29100c31-141f-4df9-8922-82d7f474d07c",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-01-20T12:34:11+00:00",
      "updated_at": "2022-01-20T12:34:11+00:00",
...
```json
  {
  "data": {
    "id": "b394437d-cc43-44fb-baa5-590fc64d70ce",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-01-20T12:34:11+00:00",
      "updated_at": "2022-01-20T12:34:11+00:00",
...
```json
  {
  "data": {
    "id": "18feade1-d99e-4a01-b1d5-dd61d7b22155",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-01-20T12:34:11+00:00",
      "updated_at": "2022-01-20T12:34:11+00:00",
...
```json
  {
  "data": {
    "id": "577b948b-7ccc-4d92-a980-c721d8b46945",
    "type": "operating_rules",
    "attributes": {
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/89c06afd-3c00-4431-a813-e4b29b0d0ef3' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "89c06afd-3c00-4431-a813-e4b29b0d0ef3",
        "type": "operating_rules",
        "attributes": {
          "data": {
            "away": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/89200314-023e-4c88-9387-25a35f859ee9' \
    --header 'content-type: application/json' \
```
