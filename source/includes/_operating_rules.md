...
```json
  ...
  "data": [
    {
      "id": "5a038d7c-6d90-4f85-ac6e-900cbdf2e61a",
      "type": "operating_rules",
      "attributes": {
        "created_at": "2023-02-21T10:57:41+00:00",
        "updated_at": "2023-02-21T10:57:41+00:00",
        "data_type": "away",
        "data": {
          "away": {
            "from": "2020-01-01",
...
```json
  {
  "data": {
    "id": "f2aabbff-1474-43d4-9e32-1c2a50637d8a",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-21T10:57:41+00:00",
      "updated_at": "2023-02-21T10:57:41+00:00",
...
```json
  {
  "data": {
    "id": "dec0eb89-0487-40a3-8dc2-f14ac33e43eb",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-21T10:57:41+00:00",
      "updated_at": "2023-02-21T10:57:41+00:00",
...
```json
  {
  "data": {
    "id": "f0262c2e-5bc2-453c-9374-bfb89a205f7f",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-21T10:57:42+00:00",
      "updated_at": "2023-02-21T10:57:42+00:00",
      "data_type": "away",
      "data": {
        "away": {
          "from": "2030-01-01",
...
```json
  {
  "data": {
    "id": "1ca25302-e6cc-4017-969a-82f6902b6f9d",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-21T10:57:42+00:00",
      "updated_at": "2023-02-21T10:57:42+00:00",
...
```json
  {
  "data": {
    "id": "5b81d05d-0990-4174-bb94-5e65408587b9",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-21T10:57:43+00:00",
      "updated_at": "2023-02-21T10:57:43+00:00",
      "data_type": "timeslot_duration",
      "data": {
        "length": 86000
      }
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/8d8585dd-bb11-4a3d-84d3-81857d0c6572' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "8d8585dd-bb11-4a3d-84d3-81857d0c6572",
        "type": "operating_rules",
        "attributes": {
          "data": {
            "away": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/14e3647b-c03e-496f-97bf-249472579d16' \
    --header 'content-type: application/json' \
```
