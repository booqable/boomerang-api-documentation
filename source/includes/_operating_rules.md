...
```json
  ...
  "data": [
    {
      "id": "1440fefd-933a-4734-a266-2aa8b27c86e6",
      "type": "operating_rules",
      "attributes": {
        "created_at": "2022-10-25T19:10:55+00:00",
        "updated_at": "2022-10-25T19:10:55+00:00",
        "data_type": "away",
        "data": {
          "away": {
            "from": "2020-01-01",
...
```json
  {
  "data": {
    "id": "584ce29f-320d-4269-a284-51559a3ff092",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-10-25T19:10:55+00:00",
      "updated_at": "2022-10-25T19:10:55+00:00",
...
```json
  {
  "data": {
    "id": "195a2a83-aedc-44c5-a5fa-3492b8d5c1b2",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-10-25T19:10:55+00:00",
      "updated_at": "2022-10-25T19:10:55+00:00",
...
```json
  {
  "data": {
    "id": "3f5385f8-3de6-401f-8e01-524649cab466",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-10-25T19:10:56+00:00",
      "updated_at": "2022-10-25T19:10:56+00:00",
      "data_type": "away",
      "data": {
        "away": {
          "from": "2030-01-01",
...
```json
  {
  "data": {
    "id": "fce5b384-7f13-43f4-9955-0d9f2cc3abce",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-10-25T19:10:56+00:00",
      "updated_at": "2022-10-25T19:10:56+00:00",
...
```json
  {
  "data": {
    "id": "b60e177c-906c-4e1f-bc7f-178b728004a0",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-10-25T19:10:57+00:00",
      "updated_at": "2022-10-25T19:10:57+00:00",
      "data_type": "timeslot_duration",
      "data": {
        "length": 86000
      }
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/bb44b77d-89a8-401a-a562-775c45ea4955' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "bb44b77d-89a8-401a-a562-775c45ea4955",
        "type": "operating_rules",
        "attributes": {
          "data": {
            "away": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/27b4c229-32d3-40d2-8de2-7cf692c72ad9' \
    --header 'content-type: application/json' \
```
