...
```json
  ...
  "data": [
    {
      "id": "90af64f3-5461-4487-8cee-5a439d6d8514",
      "type": "operating_rules",
      "attributes": {
        "created_at": "2022-03-04T10:46:59+00:00",
        "updated_at": "2022-03-04T10:46:59+00:00",
        "data_type": "away",
        "data": {
          "away": {
            "from": "2020-01-01",
...
```json
  {
  "data": {
    "id": "a7d74c63-1cb5-4f0e-83c1-88d85e481a89",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-03-04T10:46:59+00:00",
      "updated_at": "2022-03-04T10:46:59+00:00",
...
```json
  {
  "data": {
    "id": "e31ac1c4-2215-48c6-9f62-ad2a065e84fc",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-03-04T10:46:59+00:00",
      "updated_at": "2022-03-04T10:46:59+00:00",
...
```json
  {
  "data": {
    "id": "9839e271-2702-4277-b87e-2f85aacfb297",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-03-04T10:46:59+00:00",
      "updated_at": "2022-03-04T10:46:59+00:00",
...
```json
  {
  "data": {
    "id": "a2d37266-3e8c-467d-b8d5-940b4c971950",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-03-04T10:47:00+00:00",
      "updated_at": "2022-03-04T10:47:00+00:00",
      "data_type": "timeslot_fixed",
      "data": {
        "weekend": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "f3ef968f-d56c-4523-9b7e-b66a133caeeb",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-03-04T10:47:00+00:00",
      "updated_at": "2022-03-04T10:47:00+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/fafa10d1-7426-498e-a65e-392a107370ec' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "fafa10d1-7426-498e-a65e-392a107370ec",
        "type": "operating_rules",
        "attributes": {
          "data": {
            "away": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/dd9011bd-9186-4135-adfe-f0d6b49c027f' \
    --header 'content-type: application/json' \
```
