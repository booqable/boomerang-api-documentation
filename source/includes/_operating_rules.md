...
```json
  ...
  "data": [
    {
      "id": "b208235e-32c2-466c-8064-4c7a1cd2b1dd",
      "type": "operating_rules",
      "attributes": {
        "created_at": "2023-02-13T09:09:47+00:00",
        "updated_at": "2023-02-13T09:09:47+00:00",
        "data_type": "away",
        "data": {
          "away": {
            "from": "2020-01-01",
...
```json
  {
  "data": {
    "id": "abdedc28-51df-4959-b8e9-2f39f500fdfa",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-13T09:09:48+00:00",
      "updated_at": "2023-02-13T09:09:48+00:00",
      "data_type": "hours",
      "data": {
        "mon": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "d0d3dc97-0e71-4494-9da8-39d6836582ec",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-13T09:09:48+00:00",
      "updated_at": "2023-02-13T09:09:48+00:00",
...
```json
  {
  "data": {
    "id": "9f59bb3c-64db-48fc-afed-14a4e550c03b",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-13T09:09:49+00:00",
      "updated_at": "2023-02-13T09:09:49+00:00",
      "data_type": "away",
      "data": {
        "away": {
          "from": "2030-01-01",
...
```json
  {
  "data": {
    "id": "eb09be98-3565-4ea9-b6e5-6813e6fceb9f",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-13T09:09:49+00:00",
      "updated_at": "2023-02-13T09:09:49+00:00",
...
```json
  {
  "data": {
    "id": "8f6e330e-4296-4f2b-bdad-7525351cec6f",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-13T09:09:50+00:00",
      "updated_at": "2023-02-13T09:09:50+00:00",
      "data_type": "timeslot_duration",
      "data": {
        "length": 86000
      }
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/6def8b2a-d06d-46cd-a936-14b53a87b598' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "6def8b2a-d06d-46cd-a936-14b53a87b598",
        "type": "operating_rules",
        "attributes": {
          "data": {
            "away": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/9637bda4-3e91-43b9-b2b3-c084f71c1584' \
    --header 'content-type: application/json' \
```
