...
```json
  ...
  "data": [
    {
      "id": "9708657a-a0b6-4c58-81e0-5da318ec1c90",
      "data_type": "away",
      "data": {
        "away": {
          "from": "2020-01-01",
...
```json
  {
  "data": {
    "id": "9f596942-a59e-4568-94d7-41a4317a82ca",
    "type": "operating_rules",
    "attributes": {
      "data_type": "hours",
      "data": {
...
```json
  {
  "data": {
    "id": "a40ab371-e3a8-434d-bb24-c230bf73ced9",
    "type": "operating_rules",
    "attributes": {
      "data_type": "hours",
      "data": {
...
```json
  {
  "data": {
    "id": "569f3f89-7d0f-4436-b819-af546b4dc919",
    "type": "operating_rules",
    "attributes": {
      "data_type": "away",
      "data": {
...
```json
  {
  "data": {
    "id": "7512bab7-7cde-4fe8-8f76-6a3e6a32299f",
    "type": "operating_rules",
    "attributes": {
      "data_type": "timeslot_fixed",
      "data": {
...
```json
  {
  "data": {
    "id": "d9ac9163-77ef-453b-adeb-6e0735c2b28e",
    "type": "operating_rules",
    "attributes": {
      "data_type": "timeslot_duration",
      "data": {
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/e414567a-a80d-470a-a6fe-0af741f09402' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "e414567a-a80d-470a-a6fe-0af741f09402",
        "type": "operating_rules",
        "attributes": {
          "data": {
            "away": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/fed8e319-e3f8-4131-82a5-a057b18c4406' \
    --header 'content-type: application/json' \
    --data '{}'
```
