...
```json
  ...
  "data": [
    {
      "id": "ac8c83bd-3844-4476-ab39-3b4d12caac7e",
...
```json
  {
  "data": {
    "id": "201fbbe8-2bc6-4182-b50a-8b14acb90ceb",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-01-05T13:10:22+00:00",
      "updated_at": "2023-01-05T13:10:22+00:00",
      "data_type": "hours",
      "data": {
        "mon": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "3c01af08-98c5-493a-a8cc-2722f1bdaf4c",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-01-05T13:10:22+00:00",
      "updated_at": "2023-01-05T13:10:22+00:00",
...
```json
  {
  "data": {
    "id": "e1f2a0cf-87b6-4590-848a-dd97af37e976",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-01-05T13:10:22+00:00",
      "updated_at": "2023-01-05T13:10:22+00:00",
...
```json
  {
  "data": {
    "id": "f9aa59f1-e596-4c7e-b627-9a12231fe737",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-01-05T13:10:23+00:00",
      "updated_at": "2023-01-05T13:10:23+00:00",
      "data_type": "timeslot_fixed",
      "data": {
        "weekend": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "5ca98da5-ad00-4071-9603-5f4da97fe035",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-01-05T13:10:23+00:00",
      "updated_at": "2023-01-05T13:10:23+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/294c15f4-74f1-4ddf-af81-212416ec2fd8' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "294c15f4-74f1-4ddf-af81-212416ec2fd8",
        "type": "operating_rules",
        "attributes": {
          "data": {
            "away": {
...
```json
  ...
  "data": {
    ...
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-01-05T13:10:24+00:00",
      "updated_at": "2023-01-05T13:10:24+00:00",
      "data_type": "away",
      "data": {
        "away": {
          "from": "2020-04-01",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/066f6751-0eeb-41a4-ac29-9fa574361a78' \
    --header 'content-type: application/json' \
```
