...
```json
  ...
  "data": [
    {
      "id": "16c35b61-927d-4067-bb31-382aa6501049",
      "type": "operating_rules",
      "attributes": {
        "created_at": "2023-02-09T10:20:05+00:00",
        "updated_at": "2023-02-09T10:20:05+00:00",
        "data_type": "away",
        "data": {
          "away": {
            "from": "2020-01-01",
...
```json
  {
  "data": {
    "id": "3b0eca20-2c16-4cc4-b77e-c3823e4e55f9",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-09T10:20:05+00:00",
      "updated_at": "2023-02-09T10:20:05+00:00",
...
```json
  {
  "data": {
    "id": "d30ff5bf-e9f5-49b0-8b06-b15315e1153d",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-09T10:20:06+00:00",
      "updated_at": "2023-02-09T10:20:06+00:00",
      "data_type": "hours",
      "data": {
        "weekday": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "41598338-fec0-4559-bc54-f9291bbec97c",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-09T10:20:06+00:00",
      "updated_at": "2023-02-09T10:20:06+00:00",
...
```json
  {
  "data": {
    "id": "e5587079-9ac5-4bf1-abe9-cc9ced76e468",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-09T10:20:07+00:00",
      "updated_at": "2023-02-09T10:20:07+00:00",
      "data_type": "timeslot_fixed",
      "data": {
        "weekend": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "0db3dd13-1ba0-4402-a851-c20485812b13",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-09T10:20:07+00:00",
      "updated_at": "2023-02-09T10:20:07+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/c0fe3c4a-1e24-4beb-b03e-7bcf8ab4bf45' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "c0fe3c4a-1e24-4beb-b03e-7bcf8ab4bf45",
        "type": "operating_rules",
        "attributes": {
          "data": {
            "away": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/446ab79b-c0e1-4e4b-9797-ed651222cb4d' \
    --header 'content-type: application/json' \
```
