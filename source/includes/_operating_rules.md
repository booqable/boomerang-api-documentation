...
```json
  ...
  "data": [
    {
      "id": "e10b0c5f-d0b1-46d7-90bf-5baaed365fd6",
      "type": "operating_rules",
      "attributes": {
        "created_at": "2023-02-02T08:02:52+00:00",
        "updated_at": "2023-02-02T08:02:52+00:00",
        "data_type": "away",
        "data": {
          "away": {
            "from": "2020-01-01",
...
```json
  {
  "data": {
    "id": "25abc2bb-2923-4f9c-8fc3-ab778d9e10d6",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-02T08:02:52+00:00",
      "updated_at": "2023-02-02T08:02:52+00:00",
...
```json
  {
  "data": {
    "id": "95ed1f4d-d60b-4d93-ba8a-a06270bd6956",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-02T08:02:53+00:00",
      "updated_at": "2023-02-02T08:02:53+00:00",
      "data_type": "hours",
      "data": {
        "weekday": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "c4295fbf-7e76-4250-9af7-b930142d3468",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-02T08:02:53+00:00",
      "updated_at": "2023-02-02T08:02:53+00:00",
...
```json
  {
  "data": {
    "id": "c2f31225-1d88-41de-9784-cd442d0704f6",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-02T08:02:54+00:00",
      "updated_at": "2023-02-02T08:02:54+00:00",
      "data_type": "timeslot_fixed",
      "data": {
        "weekend": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "7a436a42-e86a-4e70-af6f-df8a325227db",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-02T08:02:54+00:00",
      "updated_at": "2023-02-02T08:02:54+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/f3162a38-e251-4130-8e8a-5ba7b157025d' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "f3162a38-e251-4130-8e8a-5ba7b157025d",
        "type": "operating_rules",
        "attributes": {
          "data": {
            "away": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/ed610d88-df7e-4ad2-8923-3572dbd43637' \
    --header 'content-type: application/json' \
```
