...
```json
  ...
  "data": [
    {
      "id": "4ef6eedf-4ad8-4093-a0e3-2dc1f5cbe05c",
...
```json
  {
  "data": {
    "id": "dbe4a619-b248-4b68-9fd2-a902b0fb14a8",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-01-19T10:29:11+00:00",
      "updated_at": "2023-01-19T10:29:11+00:00",
      "data_type": "hours",
      "data": {
        "mon": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "305a2b3b-354d-42fc-b122-05531b417307",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-01-19T10:29:11+00:00",
      "updated_at": "2023-01-19T10:29:11+00:00",
...
```json
  {
  "data": {
    "id": "2cc3190c-4e52-4421-ab8d-d999d63cb896",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-01-19T10:29:12+00:00",
      "updated_at": "2023-01-19T10:29:12+00:00",
      "data_type": "away",
      "data": {
        "away": {
          "from": "2030-01-01",
...
```json
  {
  "data": {
    "id": "efcab6f0-dc8b-465f-a5ea-06eb3793e07d",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-01-19T10:29:12+00:00",
      "updated_at": "2023-01-19T10:29:12+00:00",
...
```json
  {
  "data": {
    "id": "b333552a-0f74-4a80-b90e-f669f7dc7e9a",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-01-19T10:29:12+00:00",
      "updated_at": "2023-01-19T10:29:12+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/48309841-fc06-4ea1-8858-23b3cca10c5f' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "48309841-fc06-4ea1-8858-23b3cca10c5f",
        "type": "operating_rules",
        "attributes": {
          "data": {
            "away": {
...
```json
  ...
  "data": {
    ...
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-01-19T10:29:13+00:00",
      "updated_at": "2023-01-19T10:29:13+00:00",
      "data_type": "away",
      "data": {
        "away": {
          "from": "2020-04-01",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/1424dbf3-7bb4-4d71-9409-263302b6cf36' \
    --header 'content-type: application/json' \
```
