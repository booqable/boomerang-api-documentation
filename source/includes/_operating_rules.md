...
```json
  ...
  "data": [
    {
      "id": "32860c0a-60ec-4d8a-a539-2bb404bc7e94",
      "type": "operating_rules",
      "attributes": {
        "created_at": "2023-03-07T11:36:25+00:00",
        "updated_at": "2023-03-07T11:36:25+00:00",
        "data_type": "away",
        "data": {
          "away": {
            "from": "2020-01-01",
...
```json
  {
  "data": {
    "id": "b306a161-9bb6-49f8-8d60-839b79ce173a",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-03-07T11:36:26+00:00",
      "updated_at": "2023-03-07T11:36:26+00:00",
      "data_type": "hours",
      "data": {
        "mon": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "eaadead1-1b58-47bd-9c57-caf9afdc24b5",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-03-07T11:36:26+00:00",
      "updated_at": "2023-03-07T11:36:26+00:00",
...
```json
  {
  "data": {
    "id": "37a4bc5e-daa0-42f9-a1b7-f9ccbf089021",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-03-07T11:36:26+00:00",
      "updated_at": "2023-03-07T11:36:26+00:00",
...
```json
  {
  "data": {
    "id": "168b1cb6-f5d5-4444-8ae5-853599bf9ddf",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-03-07T11:36:27+00:00",
      "updated_at": "2023-03-07T11:36:27+00:00",
      "data_type": "timeslot_fixed",
      "data": {
        "weekend": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "cba7eb54-72b2-4b75-9eee-42ba87dafd94",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-03-07T11:36:27+00:00",
      "updated_at": "2023-03-07T11:36:27+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/c2ca493f-a8a6-43e6-99e0-a1981f91c116' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "c2ca493f-a8a6-43e6-99e0-a1981f91c116",
        "type": "operating_rules",
        "attributes": {
          "data": {
            "away": {
...
```json
  ...
  "data": {
    ...
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-03-07T11:36:28+00:00",
      "updated_at": "2023-03-07T11:36:28+00:00",
      "data_type": "away",
      "data": {
        "away": {
          "from": "2020-04-01",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/62c3878f-5364-4b6e-bf2a-fc4e550e06f4' \
    --header 'content-type: application/json' \
```
