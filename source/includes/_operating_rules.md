...
```json
  ...
  "data": [
    {
      "id": "e09d9f2d-b9f8-41f6-8cf4-3f1e8645c680",
...
```json
  {
  "data": {
    "id": "3dd5c245-6a47-48d6-96ba-395af60ae2cb",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-03T11:10:52+00:00",
      "updated_at": "2023-02-03T11:10:52+00:00",
...
```json
  {
  "data": {
    "id": "30b2c4d3-b43f-4b12-b942-303f72515877",
    "type": "operating_rules",
    "attributes": {
...
```json
  {
  "data": {
    "id": "6c6e4639-00fd-448d-9af4-64e4c8cb0e7e",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-03T11:10:53+00:00",
      "updated_at": "2023-02-03T11:10:53+00:00",
...
```json
  {
  "data": {
    "id": "690c8011-1ebd-4de4-8be3-b8c93331e760",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-03T11:10:53+00:00",
      "updated_at": "2023-02-03T11:10:53+00:00",
...
```json
  {
  "data": {
    "id": "4dacdd09-21b5-4732-97db-d741a8a1c2c6",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-03T11:10:54+00:00",
      "updated_at": "2023-02-03T11:10:54+00:00",
      "data_type": "timeslot_duration",
      "data": {
        "length": 86000
      }
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/1253e100-6973-4086-bc32-988d309b46ce' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "1253e100-6973-4086-bc32-988d309b46ce",
        "type": "operating_rules",
        "attributes": {
          "data": {
            "away": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/22037af8-b00e-4e13-83a2-f68b44333696' \
    --header 'content-type: application/json' \
```
