...
```json
  ...
  "data": [
    {
      "id": "355fd94c-3666-4056-b25a-e7191b65d8a4",
...
```json
  {
  "data": {
    "id": "9a94e60d-5e21-4633-8450-b5436f2e540b",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-05-24T07:24:51+00:00",
      "updated_at": "2022-05-24T07:24:51+00:00",
...
```json
  {
  "data": {
    "id": "eb6568f3-ad6a-4a16-821b-1f059f489fb1",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-05-24T07:24:51+00:00",
      "updated_at": "2022-05-24T07:24:51+00:00",
...
```json
  {
  "data": {
    "id": "2752e4dd-05ac-430a-9200-8584203f25fb",
    "type": "operating_rules",
    "attributes": {
...
```json
  {
  "data": {
    "id": "7901b208-9a6a-4615-8720-a831035ea2c6",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-05-24T07:24:52+00:00",
      "updated_at": "2022-05-24T07:24:52+00:00",
...
```json
  {
  "data": {
    "id": "2bd20bb1-a727-411c-ba03-177080463931",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-05-24T07:24:52+00:00",
      "updated_at": "2022-05-24T07:24:52+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/085d57b3-5cf0-4c71-b18d-7ae05bc99509' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "085d57b3-5cf0-4c71-b18d-7ae05bc99509",
        "type": "operating_rules",
        "attributes": {
          "data": {
            "away": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/b237352f-da91-4dec-bc82-1e91d3b3431d' \
    --header 'content-type: application/json' \
```
