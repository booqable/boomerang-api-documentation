...
```json
  ...
  "data": [
    {
      "id": "05404101-ed31-48e2-b9db-e5570ef634d4",
...
```json
  {
  "data": {
    "id": "83e282f1-111a-43fa-bf87-3bdb5d643113",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-02T16:38:26+00:00",
      "updated_at": "2023-02-02T16:38:26+00:00",
      "data_type": "hours",
      "data": {
        "mon": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "eeeaeef8-4ad3-46eb-96b0-8ad8748edb9f",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-02T16:38:26+00:00",
      "updated_at": "2023-02-02T16:38:26+00:00",
...
```json
  {
  "data": {
    "id": "e7c31718-2cef-4d7e-8375-ed3b36345508",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-02T16:38:27+00:00",
      "updated_at": "2023-02-02T16:38:27+00:00",
      "data_type": "away",
      "data": {
        "away": {
          "from": "2030-01-01",
...
```json
  {
  "data": {
    "id": "10fff66b-094e-4427-b9b9-63fea9514d87",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-02T16:38:27+00:00",
      "updated_at": "2023-02-02T16:38:27+00:00",
...
```json
  {
  "data": {
    "id": "73637733-6e57-4b52-a99f-861b489505f9",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-02T16:38:27+00:00",
      "updated_at": "2023-02-02T16:38:27+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/432a793a-d3c5-4f0d-a996-b3d47507c924' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "432a793a-d3c5-4f0d-a996-b3d47507c924",
        "type": "operating_rules",
        "attributes": {
          "data": {
            "away": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/1cc2ccff-e260-4191-82c9-8149fd7c82f4' \
    --header 'content-type: application/json' \
```
