...
```json
  ...
  "data": [
    {
      "id": "ac606488-d032-46af-8963-037926d6e639",
...
```json
  {
  "data": {
    "id": "f829a15b-94f2-423d-8060-df2a58fdcc5e",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-05-31T08:26:39+00:00",
      "updated_at": "2022-05-31T08:26:39+00:00",
...
```json
  {
  "data": {
    "id": "fee64900-0a81-4527-8edf-1404421c248e",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-05-31T08:26:40+00:00",
      "updated_at": "2022-05-31T08:26:40+00:00",
      "data_type": "hours",
      "data": {
        "weekday": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "d3b55586-74ff-45e0-a59f-fd5b8f8fdc24",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-05-31T08:26:40+00:00",
      "updated_at": "2022-05-31T08:26:40+00:00",
...
```json
  {
  "data": {
    "id": "955edf26-6532-4ff1-b44f-4086073b2505",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-05-31T08:26:40+00:00",
      "updated_at": "2022-05-31T08:26:40+00:00",
...
```json
  {
  "data": {
    "id": "83ec03a9-d044-456d-8c7e-d74b720e8f5a",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-05-31T08:26:40+00:00",
      "updated_at": "2022-05-31T08:26:40+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/a1e14614-d75f-4563-adbb-ed668a934c72' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "a1e14614-d75f-4563-adbb-ed668a934c72",
        "type": "operating_rules",
        "attributes": {
          "data": {
            "away": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/4ba63ffd-0257-48eb-b936-954ec6b73e3e' \
    --header 'content-type: application/json' \
```
