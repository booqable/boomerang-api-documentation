...
```json
  ...
  "data": [
    {
      "id": "7fe34708-90ab-4624-b04f-1228d36c4d16",
      "type": "operating_rules",
      "attributes": {
        "created_at": "2023-02-09T13:01:20+00:00",
        "updated_at": "2023-02-09T13:01:20+00:00",
        "data_type": "away",
        "data": {
          "away": {
            "from": "2020-01-01",
...
```json
  {
  "data": {
    "id": "4ea56c2b-bea0-4a63-aab9-9859093db2a4",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-09T13:01:20+00:00",
      "updated_at": "2023-02-09T13:01:20+00:00",
...
```json
  {
  "data": {
    "id": "4fb1dd54-a84e-4604-8bec-6cf05cb21e68",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-09T13:01:20+00:00",
      "updated_at": "2023-02-09T13:01:20+00:00",
...
```json
  {
  "data": {
    "id": "2c9d55bf-2371-45a1-9a91-c6ea89b38b29",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-09T13:01:21+00:00",
      "updated_at": "2023-02-09T13:01:21+00:00",
      "data_type": "away",
      "data": {
        "away": {
          "from": "2030-01-01",
...
```json
  {
  "data": {
    "id": "c8258eac-90e0-4954-9693-0f91c20aabde",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-09T13:01:21+00:00",
      "updated_at": "2023-02-09T13:01:21+00:00",
...
```json
  {
  "data": {
    "id": "b4c17c06-7271-4d44-bc58-6d71b2138e8c",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-09T13:01:21+00:00",
      "updated_at": "2023-02-09T13:01:21+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/8f94b1b4-ab8a-42a1-b22e-c9ba964c41a5' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "8f94b1b4-ab8a-42a1-b22e-c9ba964c41a5",
        "type": "operating_rules",
        "attributes": {
          "data": {
            "away": {
...
```json
  ...
  "data": {
    ...
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-09T13:01:22+00:00",
      "updated_at": "2023-02-09T13:01:22+00:00",
      "data_type": "away",
      "data": {
        "away": {
          "from": "2020-04-01",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/45708ce6-fb8a-47e5-b28d-8d27f5c8ee14' \
    --header 'content-type: application/json' \
```
