...
```json
  ...
  "data": [
    {
      "id": "8258f91e-c95b-45a4-9acf-902ea8b2c4b0",
      "type": "operating_rules",
      "attributes": {
        "created_at": "2023-02-21T10:49:40+00:00",
        "updated_at": "2023-02-21T10:49:40+00:00",
        "data_type": "away",
        "data": {
          "away": {
            "from": "2020-01-01",
...
```json
  {
  "data": {
    "id": "a78821b1-679e-48bb-91af-2b9622c0c87e",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-21T10:49:40+00:00",
      "updated_at": "2023-02-21T10:49:40+00:00",
...
```json
  {
  "data": {
    "id": "7e093476-ec07-4768-afd5-eefce51dc418",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-21T10:49:41+00:00",
      "updated_at": "2023-02-21T10:49:41+00:00",
      "data_type": "hours",
      "data": {
        "weekday": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "20823550-f50e-4ab6-825d-ddd0c725d4bb",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-21T10:49:41+00:00",
      "updated_at": "2023-02-21T10:49:41+00:00",
...
```json
  {
  "data": {
    "id": "ede6a941-5cea-4a84-8d43-0179384e4d49",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-21T10:49:41+00:00",
      "updated_at": "2023-02-21T10:49:41+00:00",
...
```json
  {
  "data": {
    "id": "44bcd2cc-663f-4db8-967c-c481d4657373",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-21T10:49:42+00:00",
      "updated_at": "2023-02-21T10:49:42+00:00",
      "data_type": "timeslot_duration",
      "data": {
        "length": 86000
      }
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/ef712aff-4591-4e9f-b340-d457307d5d81' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "ef712aff-4591-4e9f-b340-d457307d5d81",
        "type": "operating_rules",
        "attributes": {
          "data": {
            "away": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/f228d38a-7971-44a3-8e0c-8c0f9a279347' \
    --header 'content-type: application/json' \
```
