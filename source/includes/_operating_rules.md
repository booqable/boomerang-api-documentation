...
```json
  ...
  "data": [
    {
      "id": "048123bb-76cd-42c8-bf27-0729342c742b",
...
```json
  {
  "data": {
    "id": "fd68a7bb-5145-478e-8531-00eaff5484ab",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-05-05T12:27:30+00:00",
      "updated_at": "2022-05-05T12:27:30+00:00",
...
```json
  {
  "data": {
    "id": "93452dd1-7c9d-4e49-86d2-cad8089a9183",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-05-05T12:27:31+00:00",
      "updated_at": "2022-05-05T12:27:31+00:00",
      "data_type": "hours",
      "data": {
        "weekday": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "85720aed-9bcc-4a51-8ba0-62b1abadef3d",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-05-05T12:27:31+00:00",
      "updated_at": "2022-05-05T12:27:31+00:00",
...
```json
  {
  "data": {
    "id": "fc65cced-5288-49bd-a5f2-fe5225d379b4",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-05-05T12:27:31+00:00",
      "updated_at": "2022-05-05T12:27:31+00:00",
...
```json
  {
  "data": {
    "id": "6a296b22-1c21-4deb-99ec-48882247cc02",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-05-05T12:27:31+00:00",
      "updated_at": "2022-05-05T12:27:31+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/bbaddd75-45e7-4043-9cc9-034ff94bed6d' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "bbaddd75-45e7-4043-9cc9-034ff94bed6d",
        "type": "operating_rules",
        "attributes": {
          "data": {
            "away": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/e05846bf-3231-4c34-86ef-9a6733fa151a' \
    --header 'content-type: application/json' \
```
