...
```json
  ...
  "data": [
    {
      "id": "7f264c59-a230-4f37-9d54-5f40c7a4daf7",
      "type": "operating_rules",
      "attributes": {
        "created_at": "2023-02-16T09:16:01+00:00",
        "updated_at": "2023-02-16T09:16:01+00:00",
        "data_type": "away",
        "data": {
          "away": {
            "from": "2020-01-01",
...
```json
  {
  "data": {
    "id": "67abd015-7513-4013-b3ee-144d0df4fe6a",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-16T09:16:02+00:00",
      "updated_at": "2023-02-16T09:16:02+00:00",
      "data_type": "hours",
      "data": {
        "mon": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "95519b89-f739-4973-9338-b7378ad4261d",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-16T09:16:02+00:00",
      "updated_at": "2023-02-16T09:16:02+00:00",
...
```json
  {
  "data": {
    "id": "29f155a8-2dc0-416f-958f-84a5e871658c",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-16T09:16:02+00:00",
      "updated_at": "2023-02-16T09:16:02+00:00",
...
```json
  {
  "data": {
    "id": "0df21ca5-85ea-4bcf-bf59-c6ec389c7e2f",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-16T09:16:03+00:00",
      "updated_at": "2023-02-16T09:16:03+00:00",
      "data_type": "timeslot_fixed",
      "data": {
        "weekend": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "c4d17284-74c6-4c70-8377-f0471d73b0b4",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-16T09:16:03+00:00",
      "updated_at": "2023-02-16T09:16:03+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/04882a8c-63a4-424d-bd72-28c4e9aef5b9' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "04882a8c-63a4-424d-bd72-28c4e9aef5b9",
        "type": "operating_rules",
        "attributes": {
          "data": {
            "away": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/b66a46fa-a03b-47e8-bda4-02c987655cf2' \
    --header 'content-type: application/json' \
```
