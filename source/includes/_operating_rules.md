...
```json
  ...
  "data": [
    {
      "id": "e68b92c9-6dc0-4d59-b44e-d3c69af2ee92",
      "type": "operating_rules",
      "attributes": {
        "created_at": "2023-03-02T13:56:19+00:00",
        "updated_at": "2023-03-02T13:56:19+00:00",
        "data_type": "away",
        "data": {
          "away": {
            "from": "2020-01-01",
...
```json
  {
  "data": {
    "id": "dc7c8514-7243-44c2-8458-5d7837961864",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-03-02T13:56:20+00:00",
      "updated_at": "2023-03-02T13:56:20+00:00",
      "data_type": "hours",
      "data": {
        "mon": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "590c3cca-6020-4e7d-a5af-32af19396471",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-03-02T13:56:20+00:00",
      "updated_at": "2023-03-02T13:56:20+00:00",
...
```json
  {
  "data": {
    "id": "c5b76b67-6609-4a13-bb3b-02c17972453d",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-03-02T13:56:21+00:00",
      "updated_at": "2023-03-02T13:56:21+00:00",
      "data_type": "away",
      "data": {
        "away": {
          "from": "2030-01-01",
...
```json
  {
  "data": {
    "id": "1fdd3deb-2ef4-473a-b525-fb30763da2a5",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-03-02T13:56:21+00:00",
      "updated_at": "2023-03-02T13:56:21+00:00",
...
```json
  {
  "data": {
    "id": "d86ccbc5-80cd-4424-baf3-d609f39f2bde",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-03-02T13:56:21+00:00",
      "updated_at": "2023-03-02T13:56:21+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/e5a7a569-540a-4805-8b56-18967c6ecbe0' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "e5a7a569-540a-4805-8b56-18967c6ecbe0",
        "type": "operating_rules",
        "attributes": {
          "data": {
            "away": {
...
```json
  ...
  "data": {
    ...
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-03-02T13:56:22+00:00",
      "updated_at": "2023-03-02T13:56:22+00:00",
      "data_type": "away",
      "data": {
        "away": {
          "from": "2020-04-01",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/19cc82e0-84b2-4124-9d86-045df2630ce8' \
    --header 'content-type: application/json' \
```
