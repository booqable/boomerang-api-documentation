...
```json
  ...
  "data": [
    {
      "id": "bd4e7149-7545-4e1a-ae0e-a350308eb75d",
      "type": "operating_rules",
      "attributes": {
        "created_at": "2023-03-06T10:41:22+00:00",
        "updated_at": "2023-03-06T10:41:22+00:00",
        "data_type": "away",
        "data": {
          "away": {
            "from": "2020-01-01",
...
```json
  {
  "data": {
    "id": "1dc58a56-7dc9-43db-b4d1-41dc09bd77bf",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-03-06T10:41:23+00:00",
      "updated_at": "2023-03-06T10:41:23+00:00",
      "data_type": "hours",
      "data": {
        "mon": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "06a99a55-3de9-4b84-ba28-b3fbbccdb6cc",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-03-06T10:41:23+00:00",
      "updated_at": "2023-03-06T10:41:23+00:00",
...
```json
  {
  "data": {
    "id": "99378b4d-fb52-47d6-bcd8-9831bb3a6a99",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-03-06T10:41:23+00:00",
      "updated_at": "2023-03-06T10:41:23+00:00",
...
```json
  {
  "data": {
    "id": "db84c5f6-6649-47ee-b8ff-e26c653a5a42",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-03-06T10:41:24+00:00",
      "updated_at": "2023-03-06T10:41:24+00:00",
      "data_type": "timeslot_fixed",
      "data": {
        "weekend": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "02f8f215-a972-4093-a3d0-aa0a21b7d80b",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-03-06T10:41:24+00:00",
      "updated_at": "2023-03-06T10:41:24+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/825510a9-e4b4-475f-9072-696f0db31f97' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "825510a9-e4b4-475f-9072-696f0db31f97",
        "type": "operating_rules",
        "attributes": {
          "data": {
            "away": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/5cdb0a19-22c6-4128-9722-22e5263e9835' \
    --header 'content-type: application/json' \
```
