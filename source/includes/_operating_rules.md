...
```json
  ...
  "data": [
    {
      "id": "9ff7850f-fd82-4a6f-9a97-9c136d0023c2",
...
```json
  {
  "data": {
    "id": "a505ea9f-d803-4b53-bdbc-725961a280ce",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-06-07T06:52:04+00:00",
      "updated_at": "2022-06-07T06:52:04+00:00",
...
```json
  {
  "data": {
    "id": "9f8e28e0-a5d7-4fc9-904c-5116882f525a",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-06-07T06:52:05+00:00",
      "updated_at": "2022-06-07T06:52:05+00:00",
      "data_type": "hours",
      "data": {
        "weekday": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "5bfc8989-cdc9-419a-a0f3-1b8bd2399437",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-06-07T06:52:05+00:00",
      "updated_at": "2022-06-07T06:52:05+00:00",
...
```json
  {
  "data": {
    "id": "29f5aeb0-f6f9-4be1-b7f9-f93f95ea5cf5",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-06-07T06:52:05+00:00",
      "updated_at": "2022-06-07T06:52:05+00:00",
...
```json
  {
  "data": {
    "id": "c816aa00-027d-47ed-abbd-9fe20947baac",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-06-07T06:52:05+00:00",
      "updated_at": "2022-06-07T06:52:05+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/ae1d488a-1266-4488-b7da-31091928e6e7' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "ae1d488a-1266-4488-b7da-31091928e6e7",
        "type": "operating_rules",
        "attributes": {
          "data": {
            "away": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/e335918e-bb3b-4264-89e4-57f2c5466cf6' \
    --header 'content-type: application/json' \
```
