...
```json
  ...
  "data": [
    {
      "id": "1278adee-a4d3-43c1-a5fe-03d9d0735d95",
...
```json
  {
  "data": {
    "id": "c88e8a46-c9e6-49ed-9c23-6e2f62cf6d68",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-01-24T14:01:51+00:00",
      "updated_at": "2023-01-24T14:01:51+00:00",
      "data_type": "hours",
      "data": {
        "mon": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "46513b39-f72e-4d99-b26d-330dca288ec6",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-01-24T14:01:51+00:00",
      "updated_at": "2023-01-24T14:01:51+00:00",
...
```json
  {
  "data": {
    "id": "00e45136-5a07-48a2-8ef2-cd476f72b4d2",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-01-24T14:01:52+00:00",
      "updated_at": "2023-01-24T14:01:52+00:00",
      "data_type": "away",
      "data": {
        "away": {
          "from": "2030-01-01",
...
```json
  {
  "data": {
    "id": "5f12c3d9-0442-4c78-be4f-29db4524259b",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-01-24T14:01:52+00:00",
      "updated_at": "2023-01-24T14:01:52+00:00",
...
```json
  {
  "data": {
    "id": "5b7f5606-5b0a-4884-b133-da85cbab3613",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-01-24T14:01:52+00:00",
      "updated_at": "2023-01-24T14:01:52+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/e5294b1e-89cc-44c0-a21c-45a3041f34d5' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "e5294b1e-89cc-44c0-a21c-45a3041f34d5",
        "type": "operating_rules",
        "attributes": {
          "data": {
            "away": {
...
```json
  ...
  "data": {
    ...
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-01-24T14:01:53+00:00",
      "updated_at": "2023-01-24T14:01:53+00:00",
      "data_type": "away",
      "data": {
        "away": {
          "from": "2020-04-01",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/5e04deb8-d7b4-4756-81e0-9991a54d67b7' \
    --header 'content-type: application/json' \
```
