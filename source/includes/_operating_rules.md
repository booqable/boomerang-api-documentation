...
```json
  ...
  "data": [
    {
      "id": "ff6b0c3f-3899-476f-866c-b73013f1a391",
...
```json
  {
  "data": {
    "id": "8ae3da0d-47e6-4521-be7c-0ef0d52e3015",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-11-22T17:43:08+00:00",
      "updated_at": "2022-11-22T17:43:08+00:00",
...
```json
  {
  "data": {
    "id": "06f4788c-54f9-450d-b4d5-7caf0ee10714",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-11-22T17:43:09+00:00",
      "updated_at": "2022-11-22T17:43:09+00:00",
      "data_type": "hours",
      "data": {
        "weekday": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "a4988164-dae0-4a7c-a844-12a6a28e3904",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-11-22T17:43:09+00:00",
      "updated_at": "2022-11-22T17:43:09+00:00",
...
```json
  {
  "data": {
    "id": "8dba3ee0-736f-4067-8941-c6cb6555116d",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-11-22T17:43:10+00:00",
      "updated_at": "2022-11-22T17:43:10+00:00",
      "data_type": "timeslot_fixed",
      "data": {
        "weekend": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "c429c0bc-67e0-4476-b10e-4f6348b50f91",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-11-22T17:43:10+00:00",
      "updated_at": "2022-11-22T17:43:10+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/92bae53a-0128-49be-aea9-e534e2d96747' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "92bae53a-0128-49be-aea9-e534e2d96747",
        "type": "operating_rules",
        "attributes": {
          "data": {
            "away": {
...
```json
  ...
  "data": {
    ...
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-11-22T17:43:11+00:00",
      "updated_at": "2022-11-22T17:43:11+00:00",
      "data_type": "away",
      "data": {
        "away": {
          "from": "2020-04-01",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/7b66b03b-9dad-4781-93e9-d5ddd3fa75a5' \
    --header 'content-type: application/json' \
```
