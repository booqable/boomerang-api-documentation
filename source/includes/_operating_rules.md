...
```json
  ...
  "data": [
    {
      "id": "f95880fb-63e3-4c04-9b79-7429a7a050a2",
      "type": "operating_rules",
      "attributes": {
        "created_at": "2022-11-17T11:34:15+00:00",
        "updated_at": "2022-11-17T11:34:15+00:00",
        "data_type": "away",
        "data": {
          "away": {
            "from": "2020-01-01",
...
```json
  {
  "data": {
    "id": "3a28cbed-f176-490f-bc7b-61a60b682db6",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-11-17T11:34:15+00:00",
      "updated_at": "2022-11-17T11:34:15+00:00",
...
```json
  {
  "data": {
    "id": "80711e4b-0503-44bb-abcb-0dd46408a603",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-11-17T11:34:15+00:00",
      "updated_at": "2022-11-17T11:34:15+00:00",
...
```json
  {
  "data": {
    "id": "53cdc523-0e24-458a-8370-8e7a8d3c41c5",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-11-17T11:34:16+00:00",
      "updated_at": "2022-11-17T11:34:16+00:00",
      "data_type": "away",
      "data": {
        "away": {
          "from": "2030-01-01",
...
```json
  {
  "data": {
    "id": "8d008ac4-b5a6-46a5-b2f9-2323537e7156",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-11-17T11:34:16+00:00",
      "updated_at": "2022-11-17T11:34:16+00:00",
...
```json
  {
  "data": {
    "id": "ac4c5418-33ff-4545-a1a1-f6e5259efe52",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-11-17T11:34:17+00:00",
      "updated_at": "2022-11-17T11:34:17+00:00",
      "data_type": "timeslot_duration",
      "data": {
        "length": 86000
      }
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/ed9812b8-0b70-4036-90fe-d09e6cb2807d' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "ed9812b8-0b70-4036-90fe-d09e6cb2807d",
        "type": "operating_rules",
        "attributes": {
          "data": {
            "away": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/bcd5077f-e464-4217-b105-b5232fe9b3fc' \
    --header 'content-type: application/json' \
```
