...
```json
  ...
  "data": [
    {
      "id": "8404a11f-cfe7-4dd1-a460-a9a18e82fdaf",
...
```json
  {
  "data": {
    "id": "28ff6c8f-150c-4693-84d5-b51d91fb2bde",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-11-22T15:51:13+00:00",
      "updated_at": "2022-11-22T15:51:13+00:00",
      "data_type": "hours",
      "data": {
        "mon": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "97c7276d-5ff1-4618-894f-022a4c08bf2c",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-11-22T15:51:13+00:00",
      "updated_at": "2022-11-22T15:51:13+00:00",
...
```json
  {
  "data": {
    "id": "82c99f35-3951-4048-802e-05cfa835de5d",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-11-22T15:51:13+00:00",
      "updated_at": "2022-11-22T15:51:13+00:00",
...
```json
  {
  "data": {
    "id": "6b32e42c-15c3-46d1-ad0b-0e80f16b6a10",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-11-22T15:51:14+00:00",
      "updated_at": "2022-11-22T15:51:14+00:00",
      "data_type": "timeslot_fixed",
      "data": {
        "weekend": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "9c53c380-9156-4e4a-92cb-00d1ac491d9b",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-11-22T15:51:14+00:00",
      "updated_at": "2022-11-22T15:51:14+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/340cc6de-6a42-491d-80eb-3b59806ccf49' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "340cc6de-6a42-491d-80eb-3b59806ccf49",
        "type": "operating_rules",
        "attributes": {
          "data": {
            "away": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/ff1752ce-0c23-4906-9dd0-829a15051a44' \
    --header 'content-type: application/json' \
```
