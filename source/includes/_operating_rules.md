...
```json
  ...
  "data": [
    {
      "id": "8f86cbb4-2e47-4cc8-aa05-0add19d45093",
      "type": "operating_rules",
      "attributes": {
        "created_at": "2023-03-01T14:18:06+00:00",
        "updated_at": "2023-03-01T14:18:06+00:00",
        "data_type": "away",
        "data": {
          "away": {
            "from": "2020-01-01",
...
```json
  {
  "data": {
    "id": "210e5a94-43b6-4fda-8858-8a0d3dd9c165",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-03-01T14:18:07+00:00",
      "updated_at": "2023-03-01T14:18:07+00:00",
      "data_type": "hours",
      "data": {
        "mon": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "b6695353-c23f-403c-a32e-71fd30ff84f2",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-03-01T14:18:07+00:00",
      "updated_at": "2023-03-01T14:18:07+00:00",
...
```json
  {
  "data": {
    "id": "c831f5f2-8549-4e6a-a218-af8c73564d60",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-03-01T14:18:08+00:00",
      "updated_at": "2023-03-01T14:18:08+00:00",
      "data_type": "away",
      "data": {
        "away": {
          "from": "2030-01-01",
...
```json
  {
  "data": {
    "id": "e93b2c77-713e-48fc-8cd2-5cbdb041beb5",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-03-01T14:18:08+00:00",
      "updated_at": "2023-03-01T14:18:08+00:00",
...
```json
  {
  "data": {
    "id": "4d7f7d62-d9b5-44ee-9883-df89e49bf0cd",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-03-01T14:18:09+00:00",
      "updated_at": "2023-03-01T14:18:09+00:00",
      "data_type": "timeslot_duration",
      "data": {
        "length": 86000
      }
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/561bc5ce-f82d-413a-b18a-c54227db0eef' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "561bc5ce-f82d-413a-b18a-c54227db0eef",
        "type": "operating_rules",
        "attributes": {
          "data": {
            "away": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/1d31e8f6-7bea-428f-ada1-09ab154c68cd' \
    --header 'content-type: application/json' \
```
