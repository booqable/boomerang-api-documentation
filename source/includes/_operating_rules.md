...
```json
  ...
  "data": [
    {
      "id": "de342ef8-ee43-4294-a418-91d781e90a92",
      "type": "operating_rules",
      "attributes": {
        "created_at": "2023-01-26T08:10:02+00:00",
        "updated_at": "2023-01-26T08:10:02+00:00",
        "data_type": "away",
        "data": {
          "away": {
            "from": "2020-01-01",
...
```json
  {
  "data": {
    "id": "9dbfa2eb-6f21-4443-b312-5b8d9599b0cf",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-01-26T08:10:02+00:00",
      "updated_at": "2023-01-26T08:10:02+00:00",
...
```json
  {
  "data": {
    "id": "19b3f3ca-3146-46df-989a-8862c2b057b4",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-01-26T08:10:03+00:00",
      "updated_at": "2023-01-26T08:10:03+00:00",
      "data_type": "hours",
      "data": {
        "weekday": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "a8640445-e96c-4056-aed8-e53f46528ec5",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-01-26T08:10:03+00:00",
      "updated_at": "2023-01-26T08:10:03+00:00",
...
```json
  {
  "data": {
    "id": "affe6070-179e-4dc0-bfdc-a35e65e2e380",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-01-26T08:10:04+00:00",
      "updated_at": "2023-01-26T08:10:04+00:00",
      "data_type": "timeslot_fixed",
      "data": {
        "weekend": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "db5e8038-cc8a-498e-bf0a-68f4817ea442",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-01-26T08:10:04+00:00",
      "updated_at": "2023-01-26T08:10:04+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/b1bd3d98-88e6-48cb-bc0a-2bde7e0f6c5e' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "b1bd3d98-88e6-48cb-bc0a-2bde7e0f6c5e",
        "type": "operating_rules",
        "attributes": {
          "data": {
            "away": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/aabc16b8-3f64-475c-9762-7ac1edafcc3b' \
    --header 'content-type: application/json' \
```
