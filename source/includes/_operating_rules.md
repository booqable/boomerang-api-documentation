...
```json
  ...
  "data": [
    {
      "id": "9e124f3f-6bf5-4991-96ae-960243e9a591",
      "type": "operating_rules",
      "attributes": {
        "created_at": "2023-02-09T09:41:04+00:00",
        "updated_at": "2023-02-09T09:41:04+00:00",
        "data_type": "away",
        "data": {
          "away": {
            "from": "2020-01-01",
...
```json
  {
  "data": {
    "id": "08fc1607-83eb-41a9-829b-20d265a6a478",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-09T09:41:04+00:00",
      "updated_at": "2023-02-09T09:41:04+00:00",
...
```json
  {
  "data": {
    "id": "a02a3d10-aa97-4e7a-a093-7fe1de076949",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-09T09:41:05+00:00",
      "updated_at": "2023-02-09T09:41:05+00:00",
      "data_type": "hours",
      "data": {
        "weekday": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "b1396dec-c930-4c2a-8009-14d6288f35bb",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-09T09:41:05+00:00",
      "updated_at": "2023-02-09T09:41:05+00:00",
...
```json
  {
  "data": {
    "id": "461e31a5-30cb-41c5-8507-d7d5ff55d94f",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-09T09:41:05+00:00",
      "updated_at": "2023-02-09T09:41:05+00:00",
...
```json
  {
  "data": {
    "id": "d486dab7-03d5-4bd0-a479-a48cc4cf296e",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-09T09:41:06+00:00",
      "updated_at": "2023-02-09T09:41:06+00:00",
      "data_type": "timeslot_duration",
      "data": {
        "length": 86000
      }
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/c62e637e-fd0a-4bdd-85b3-bce03aedf477' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "c62e637e-fd0a-4bdd-85b3-bce03aedf477",
        "type": "operating_rules",
        "attributes": {
          "data": {
            "away": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/77f9e272-0ccb-412a-9c2b-f935e674d192' \
    --header 'content-type: application/json' \
```
