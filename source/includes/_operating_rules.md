...
```json
  ...
  "data": [
    {
      "id": "57937c03-4cc1-47d6-9ede-5f2db03a876f",
      "type": "operating_rules",
      "attributes": {
        "created_at": "2023-02-09T09:29:08+00:00",
        "updated_at": "2023-02-09T09:29:08+00:00",
        "data_type": "away",
        "data": {
          "away": {
            "from": "2020-01-01",
...
```json
  {
  "data": {
    "id": "949bde9f-9c59-4c6a-b999-0be4a671323d",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-09T09:29:09+00:00",
      "updated_at": "2023-02-09T09:29:09+00:00",
      "data_type": "hours",
      "data": {
        "mon": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "20a1b634-42db-4960-b390-6a6e3e183633",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-09T09:29:10+00:00",
      "updated_at": "2023-02-09T09:29:10+00:00",
      "data_type": "hours",
      "data": {
        "weekday": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "c288f47b-d92f-4d72-b430-655fb1fbeb8a",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-09T09:29:10+00:00",
      "updated_at": "2023-02-09T09:29:10+00:00",
...
```json
  {
  "data": {
    "id": "cbec53cd-cacf-42fc-baa9-6ce22185fcf4",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-09T09:29:11+00:00",
      "updated_at": "2023-02-09T09:29:11+00:00",
      "data_type": "timeslot_fixed",
      "data": {
        "weekend": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "e1ad50e7-f64c-4e10-b396-6a1631be707d",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-09T09:29:11+00:00",
      "updated_at": "2023-02-09T09:29:11+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/f51f79d3-6447-413d-8a83-a322d6e11ee4' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "f51f79d3-6447-413d-8a83-a322d6e11ee4",
        "type": "operating_rules",
        "attributes": {
          "data": {
            "away": {
...
```json
  ...
  "data": {
    ...
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-09T09:29:12+00:00",
      "updated_at": "2023-02-09T09:29:12+00:00",
      "data_type": "away",
      "data": {
        "away": {
          "from": "2020-04-01",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/00f5486b-9b99-4148-96d0-d07a42f325da' \
    --header 'content-type: application/json' \
```
