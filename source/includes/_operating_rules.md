...
```json
  ...
  "data": [
    {
      "id": "4c565774-8ea6-4218-a59d-80d39a987154",
      "type": "operating_rules",
      "attributes": {
        "created_at": "2023-02-09T10:19:40+00:00",
        "updated_at": "2023-02-09T10:19:40+00:00",
        "data_type": "away",
        "data": {
          "away": {
            "from": "2020-01-01",
...
```json
  {
  "data": {
    "id": "a70abcd8-b185-494e-9da5-6951df6141bc",
    "type": "operating_rules",
    "attributes": {
...
```json
  {
  "data": {
    "id": "d0ae7051-e3ad-4f52-b344-6995d89bdb7d",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-09T10:19:41+00:00",
      "updated_at": "2023-02-09T10:19:41+00:00",
...
```json
  {
  "data": {
    "id": "85e69b7d-32b2-4ab4-a979-a35acd4710a5",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-09T10:19:41+00:00",
      "updated_at": "2023-02-09T10:19:41+00:00",
...
```json
  {
  "data": {
    "id": "cb57f4c4-c6a3-47a7-9c09-620acd8c11b9",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-09T10:19:42+00:00",
      "updated_at": "2023-02-09T10:19:42+00:00",
      "data_type": "timeslot_fixed",
      "data": {
        "weekend": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "d2dada42-1509-4209-89da-e74ee17aae45",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-09T10:19:42+00:00",
      "updated_at": "2023-02-09T10:19:42+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/1a294759-7111-4f78-bc8d-bce61cf2c984' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "1a294759-7111-4f78-bc8d-bce61cf2c984",
        "type": "operating_rules",
        "attributes": {
          "data": {
            "away": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/f816d938-e105-47e6-99ac-03e9b5b04290' \
    --header 'content-type: application/json' \
```
