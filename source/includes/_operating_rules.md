...
```json
  ...
  "data": [
    {
      "id": "ba89102e-1bac-4e80-98d5-a374767f9cfa",
      "type": "operating_rules",
      "attributes": {
        "created_at": "2023-02-13T08:15:55+00:00",
        "updated_at": "2023-02-13T08:15:55+00:00",
        "data_type": "away",
        "data": {
          "away": {
            "from": "2020-01-01",
...
```json
  {
  "data": {
    "id": "595dac06-1607-452b-af84-9aff34a8db60",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-13T08:15:55+00:00",
      "updated_at": "2023-02-13T08:15:55+00:00",
...
```json
  {
  "data": {
    "id": "b09fb87f-eb2e-4233-ac0e-c9cf57c19a80",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-13T08:15:56+00:00",
      "updated_at": "2023-02-13T08:15:56+00:00",
      "data_type": "hours",
      "data": {
        "weekday": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "7c904e55-32e4-4b38-a83f-301318292ad3",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-13T08:15:56+00:00",
      "updated_at": "2023-02-13T08:15:56+00:00",
...
```json
  {
  "data": {
    "id": "88e95ef7-c021-46a6-8285-d120a0996d7f",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-13T08:15:56+00:00",
      "updated_at": "2023-02-13T08:15:56+00:00",
...
```json
  {
  "data": {
    "id": "000157c5-a990-4cf2-a0cc-721abf4f2c8f",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-13T08:15:57+00:00",
      "updated_at": "2023-02-13T08:15:57+00:00",
      "data_type": "timeslot_duration",
      "data": {
        "length": 86000
      }
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/358ff516-8e73-4c07-ab34-d821365a34f8' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "358ff516-8e73-4c07-ab34-d821365a34f8",
        "type": "operating_rules",
        "attributes": {
          "data": {
            "away": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/6a541680-13b6-4fc1-990d-1f0e62ac5b9a' \
    --header 'content-type: application/json' \
```
