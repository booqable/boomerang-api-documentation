...
```json
  ...
  "data": [
    {
      "id": "64ad8ba4-b8a0-4284-bd16-2980682359ec",
...
```json
  {
  "data": {
    "id": "27751efa-fbac-4108-9930-f0f7d8419f2c",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-01T13:01:08+00:00",
      "updated_at": "2023-02-01T13:01:08+00:00",
      "data_type": "hours",
      "data": {
        "mon": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "9e1fb344-7b98-4ac7-9b4f-de773a9edac4",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-01T13:01:08+00:00",
      "updated_at": "2023-02-01T13:01:08+00:00",
...
```json
  {
  "data": {
    "id": "1cfa1c84-dac9-4a93-926d-32c4f1ae44d3",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-01T13:01:09+00:00",
      "updated_at": "2023-02-01T13:01:09+00:00",
      "data_type": "away",
      "data": {
        "away": {
          "from": "2030-01-01",
...
```json
  {
  "data": {
    "id": "625701b7-b4f3-46eb-acc9-b44c2a322216",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-01T13:01:09+00:00",
      "updated_at": "2023-02-01T13:01:09+00:00",
...
```json
  {
  "data": {
    "id": "b4f5c2cd-f077-4508-8239-cec01b2e4105",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-01T13:01:10+00:00",
      "updated_at": "2023-02-01T13:01:10+00:00",
      "data_type": "timeslot_duration",
      "data": {
        "length": 86000
      }
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/ca2cf2dc-4e4c-48bd-b889-3eda7ecf6f02' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "ca2cf2dc-4e4c-48bd-b889-3eda7ecf6f02",
        "type": "operating_rules",
        "attributes": {
          "data": {
            "away": {
...
```json
  ...
  "data": {
    ...
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-01T13:01:11+00:00",
      "updated_at": "2023-02-01T13:01:11+00:00",
      "data_type": "away",
      "data": {
        "away": {
          "from": "2020-04-01",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/ea8e922e-7d94-4a5e-984f-662a5e4893d0' \
    --header 'content-type: application/json' \
```
