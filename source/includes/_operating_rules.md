...
```json
  ...
  "data": [
    {
      "id": "27f19e4d-d441-4b15-9879-490838345934",
      "type": "operating_rules",
      "attributes": {
        "created_at": "2023-03-06T08:24:04+00:00",
        "updated_at": "2023-03-06T08:24:04+00:00",
        "data_type": "away",
        "data": {
          "away": {
            "from": "2020-01-01",
...
```json
  {
  "data": {
    "id": "8243951c-5c69-4e92-a46c-8fe23fbc409e",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-03-06T08:24:04+00:00",
      "updated_at": "2023-03-06T08:24:04+00:00",
...
```json
  {
  "data": {
    "id": "914eaea2-3142-4c46-a882-2ab534c1ff52",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-03-06T08:24:05+00:00",
      "updated_at": "2023-03-06T08:24:05+00:00",
      "data_type": "hours",
      "data": {
        "weekday": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "87ef3e15-0dad-47e2-afb8-ffc1a2e818f3",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-03-06T08:24:05+00:00",
      "updated_at": "2023-03-06T08:24:05+00:00",
...
```json
  {
  "data": {
    "id": "4bbb065c-7b9d-4cef-9e1e-71651e0e7dce",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-03-06T08:24:05+00:00",
      "updated_at": "2023-03-06T08:24:05+00:00",
...
```json
  {
  "data": {
    "id": "7ab4c384-5513-4a3d-8851-33ab4e6989d4",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-03-06T08:24:06+00:00",
      "updated_at": "2023-03-06T08:24:06+00:00",
      "data_type": "timeslot_duration",
      "data": {
        "length": 86000
      }
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/fc620fdf-934c-4ea7-9b33-f782f158b5a0' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "fc620fdf-934c-4ea7-9b33-f782f158b5a0",
        "type": "operating_rules",
        "attributes": {
          "data": {
            "away": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/c726d1ca-da41-4c0e-ac08-95b9e7f3531d' \
    --header 'content-type: application/json' \
```
