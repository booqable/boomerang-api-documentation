...
```json
  ...
  "data": [
    {
      "id": "aadeb2f3-6df8-4ee7-9447-c439f75cdd71",
...
```json
  {
  "data": {
    "id": "feec1e93-7553-49a7-bba2-e1d599703787",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-01-13T11:42:29+00:00",
      "updated_at": "2022-01-13T11:42:29+00:00",
...
```json
  {
  "data": {
    "id": "a72de465-e826-47dd-8f6b-64dbe649369f",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-01-13T11:42:30+00:00",
      "updated_at": "2022-01-13T11:42:30+00:00",
      "data_type": "hours",
      "data": {
        "weekday": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "41a9f7da-8586-44c2-b46a-f10c1c6985f2",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-01-13T11:42:30+00:00",
      "updated_at": "2022-01-13T11:42:30+00:00",
...
```json
  {
  "data": {
    "id": "26d29334-a8db-4e19-b760-b4266d91e197",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-01-13T11:42:30+00:00",
      "updated_at": "2022-01-13T11:42:30+00:00",
...
```json
  {
  "data": {
    "id": "6184552e-d807-4187-9358-eebfee5f6313",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-01-13T11:42:30+00:00",
      "updated_at": "2022-01-13T11:42:30+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/a7b41c9f-4095-40a6-92d7-21d1a67fcf62' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "a7b41c9f-4095-40a6-92d7-21d1a67fcf62",
        "type": "operating_rules",
        "attributes": {
          "data": {
            "away": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/6f907a25-9e7a-4b7d-954a-7f4185354312' \
    --header 'content-type: application/json' \
```
