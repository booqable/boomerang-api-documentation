...
```json
  ...
  "data": [
    {
      "id": "69ef2234-3811-4be7-8f00-cd110eadbe1f",
      "type": "operating_rules",
      "attributes": {
        "created_at": "2022-05-03T10:19:19+00:00",
        "updated_at": "2022-05-03T10:19:19+00:00",
        "data_type": "away",
        "data": {
          "away": {
            "from": "2020-01-01",
...
```json
  {
  "data": {
    "id": "d9fadc04-2f7e-4021-b11b-76874328b20e",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-05-03T10:19:19+00:00",
      "updated_at": "2022-05-03T10:19:19+00:00",
...
```json
  {
  "data": {
    "id": "b47df566-fb2f-43cf-b641-128a729f1857",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-05-03T10:19:19+00:00",
      "updated_at": "2022-05-03T10:19:19+00:00",
...
```json
  {
  "data": {
    "id": "d5ab4d43-7fdc-4797-8fab-9522cc44bf70",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-05-03T10:19:20+00:00",
      "updated_at": "2022-05-03T10:19:20+00:00",
      "data_type": "away",
      "data": {
        "away": {
          "from": "2030-01-01",
...
```json
  {
  "data": {
    "id": "8582a205-a355-4df5-a787-586bf4250602",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-05-03T10:19:20+00:00",
      "updated_at": "2022-05-03T10:19:20+00:00",
...
```json
  {
  "data": {
    "id": "c441f208-6944-4953-9f4c-08ae48479f88",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-05-03T10:19:21+00:00",
      "updated_at": "2022-05-03T10:19:21+00:00",
      "data_type": "timeslot_duration",
      "data": {
        "length": 86000
      }
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/4117b1dc-4d1b-4a6b-aa4b-2c0e04560441' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "4117b1dc-4d1b-4a6b-aa4b-2c0e04560441",
        "type": "operating_rules",
        "attributes": {
          "data": {
            "away": {
...
```json
  ...
  "data": {
    ...
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-05-03T10:19:22+00:00",
      "updated_at": "2022-05-03T10:19:22+00:00",
      "data_type": "away",
      "data": {
        "away": {
          "from": "2020-04-01",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/8a346330-3496-40d4-8257-5caa9a44885e' \
    --header 'content-type: application/json' \
```
