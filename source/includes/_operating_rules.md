...
```json
  ...
  "data": [
    {
      "id": "7e0a395f-cb4c-4a01-bb7d-fe67bcec6969",
...
```json
  {
  "data": {
    "id": "c3871cbc-1201-4fe8-97de-ccf4940ed2eb",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-01-05T09:56:28+00:00",
      "updated_at": "2023-01-05T09:56:28+00:00",
      "data_type": "hours",
      "data": {
        "mon": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "af3979ba-b5be-46f7-ad07-bb92561ed5e0",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-01-05T09:56:28+00:00",
      "updated_at": "2023-01-05T09:56:28+00:00",
...
```json
  {
  "data": {
    "id": "1da29f98-fd27-4f31-a150-d4ad77160e26",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-01-05T09:56:28+00:00",
      "updated_at": "2023-01-05T09:56:28+00:00",
...
```json
  {
  "data": {
    "id": "48f599c6-24f1-4281-bffd-b45325c7a31e",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-01-05T09:56:29+00:00",
      "updated_at": "2023-01-05T09:56:29+00:00",
      "data_type": "timeslot_fixed",
      "data": {
        "weekend": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "8ee4eb6a-9b01-45ab-b76d-a3d47d7633cc",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-01-05T09:56:29+00:00",
      "updated_at": "2023-01-05T09:56:29+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/a6bf38e8-1a89-4204-b8b1-40e8323b3120' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "a6bf38e8-1a89-4204-b8b1-40e8323b3120",
        "type": "operating_rules",
        "attributes": {
          "data": {
            "away": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/59ac9520-5af7-46f2-bb57-84beec3c19ce' \
    --header 'content-type: application/json' \
```
