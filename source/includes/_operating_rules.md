...
```json
  ...
  "data": [
    {
      "id": "32d5f84e-bcfa-45aa-84f7-b97eda5749cc",
...
```json
  {
  "data": {
    "id": "26c03199-7eb0-4401-b6f8-73e41ae7517d",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-05-12T06:35:17+00:00",
      "updated_at": "2022-05-12T06:35:17+00:00",
      "data_type": "hours",
      "data": {
        "mon": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "6efdf9fe-23c9-4391-a106-13f353ccb318",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-05-12T06:35:17+00:00",
      "updated_at": "2022-05-12T06:35:17+00:00",
...
```json
  {
  "data": {
    "id": "f346677d-4763-48b3-9854-5096cd8aaa8d",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-05-12T06:35:17+00:00",
      "updated_at": "2022-05-12T06:35:17+00:00",
...
```json
  {
  "data": {
    "id": "112d45bf-a3d1-4ffa-a0da-ca00a9a16271",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-05-12T06:35:17+00:00",
      "updated_at": "2022-05-12T06:35:17+00:00",
...
```json
  {
  "data": {
    "id": "2405578c-770e-406b-8890-2bb2e7f64a60",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-05-12T06:35:18+00:00",
      "updated_at": "2022-05-12T06:35:18+00:00",
      "data_type": "timeslot_duration",
      "data": {
        "length": 86000
      }
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/fe05d54e-76af-4879-b45e-631b2a8ddde4' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "fe05d54e-76af-4879-b45e-631b2a8ddde4",
        "type": "operating_rules",
        "attributes": {
          "data": {
            "away": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/55584e06-afa4-4709-b07e-ac72f26db85e' \
    --header 'content-type: application/json' \
```
