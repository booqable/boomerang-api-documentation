...
```json
  ...
  "data": [
    {
      "id": "f834c0e8-6b69-4a90-929c-146422109998",
      "type": "operating_rules",
      "attributes": {
        "created_at": "2023-02-24T14:58:07+00:00",
        "updated_at": "2023-02-24T14:58:07+00:00",
        "data_type": "away",
        "data": {
          "away": {
            "from": "2020-01-01",
...
```json
  {
  "data": {
    "id": "39ea804b-f3f9-46bd-a74d-270e35685b98",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-24T14:58:08+00:00",
...
```json
  {
  "data": {
    "id": "7bf0b47b-a1d5-4f14-b4a9-0ec1752c4b6b",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-24T14:58:08+00:00",
      "updated_at": "2023-02-24T14:58:08+00:00",
...
```json
  {
  "data": {
    "id": "336fe098-6d69-423f-b173-17fdb01cdf5b",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-24T14:58:08+00:00",
      "updated_at": "2023-02-24T14:58:08+00:00",
...
```json
  {
  "data": {
    "id": "b322f16d-1ed8-497b-b9b0-594199d3f53f",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-24T14:58:09+00:00",
      "updated_at": "2023-02-24T14:58:09+00:00",
      "data_type": "timeslot_fixed",
      "data": {
        "weekend": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "ce82fe5f-6fec-4e0d-a50b-54bf3caa0356",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-24T14:58:09+00:00",
      "updated_at": "2023-02-24T14:58:09+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/a546a4b8-d217-4153-ad38-28ebb5a8df1c' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "a546a4b8-d217-4153-ad38-28ebb5a8df1c",
        "type": "operating_rules",
        "attributes": {
          "data": {
            "away": {
...
```json
  ...
  "data": {
    ...
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-24T14:58:10+00:00",
      "updated_at": "2023-02-24T14:58:10+00:00",
      "data_type": "away",
      "data": {
        "away": {
          "from": "2020-04-01",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/a7f33686-3dc1-422d-89ac-d1f9bdc3d6ed' \
    --header 'content-type: application/json' \
```
