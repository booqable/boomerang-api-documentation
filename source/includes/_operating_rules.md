...
```json
  ...
  "data": [
    {
      "id": "9b9b7d02-dc5c-46f4-aa32-81641944f89f",
      "type": "operating_rules",
      "attributes": {
        "created_at": "2022-05-19T11:10:04+00:00",
        "updated_at": "2022-05-19T11:10:04+00:00",
        "data_type": "away",
        "data": {
          "away": {
            "from": "2020-01-01",
...
```json
  {
  "data": {
    "id": "00584834-961f-4e86-b051-351a4955ceeb",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-05-19T11:10:04+00:00",
      "updated_at": "2022-05-19T11:10:04+00:00",
...
```json
  {
  "data": {
    "id": "5366e5fd-0225-49bc-b10b-9bcc6b31996b",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-05-19T11:10:04+00:00",
      "updated_at": "2022-05-19T11:10:04+00:00",
...
```json
  {
  "data": {
    "id": "ddc5ac24-8331-40a3-be1a-aea95396059c",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-05-19T11:10:05+00:00",
      "updated_at": "2022-05-19T11:10:05+00:00",
      "data_type": "away",
      "data": {
        "away": {
          "from": "2030-01-01",
...
```json
  {
  "data": {
    "id": "f166f6a7-29f1-4a0d-bd7e-c6b7585a3da1",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-05-19T11:10:05+00:00",
      "updated_at": "2022-05-19T11:10:05+00:00",
...
```json
  {
  "data": {
    "id": "a5552fb9-cbb7-498c-ae6c-51afcabeba8e",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-05-19T11:10:05+00:00",
      "updated_at": "2022-05-19T11:10:05+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/43ce0be6-2a84-4af1-bf1e-9695e50e65c8' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "43ce0be6-2a84-4af1-bf1e-9695e50e65c8",
        "type": "operating_rules",
        "attributes": {
          "data": {
            "away": {
...
```json
  ...
  "data": {
    ...
    "attributes": {
      "created_at": "2022-05-19T11:10:05+00:00",
      "updated_at": "2022-05-19T11:10:06+00:00",
      "data_type": "away",
      "data": {
        "away": {
          "from": "2020-04-01",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/8bc734aa-5055-438f-884f-00269fa8979c' \
    --header 'content-type: application/json' \
```
