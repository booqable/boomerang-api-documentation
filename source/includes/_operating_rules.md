...
```json
  ...
  "data": [
    {
      "id": "69ef01bf-a933-4ead-a454-077593ef9338",
      "type": "operating_rules",
      "attributes": {
        "created_at": "2023-02-16T08:13:23+00:00",
        "updated_at": "2023-02-16T08:13:23+00:00",
        "data_type": "away",
        "data": {
          "away": {
            "from": "2020-01-01",
...
```json
  {
  "data": {
    "id": "b62830e9-5d6c-4127-b3e7-e26a36b950de",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-16T08:13:23+00:00",
      "updated_at": "2023-02-16T08:13:23+00:00",
...
```json
  {
  "data": {
    "id": "a7e014bf-f737-4223-b998-287cb1394f00",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-16T08:13:24+00:00",
      "updated_at": "2023-02-16T08:13:24+00:00",
      "data_type": "hours",
      "data": {
        "weekday": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "2542afe6-70e8-4239-8df2-9b34995a3292",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-16T08:13:24+00:00",
      "updated_at": "2023-02-16T08:13:24+00:00",
...
```json
  {
  "data": {
    "id": "3522dada-ce15-4a92-8f0f-7f7ea30dba23",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-16T08:13:24+00:00",
      "updated_at": "2023-02-16T08:13:24+00:00",
...
```json
  {
  "data": {
    "id": "07278cf5-52b7-4f85-9a2e-3cefaf9f8790",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-16T08:13:25+00:00",
      "updated_at": "2023-02-16T08:13:25+00:00",
      "data_type": "timeslot_duration",
      "data": {
        "length": 86000
      }
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/03d30b67-3b9d-4d08-a508-0a42cace11e8' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "03d30b67-3b9d-4d08-a508-0a42cace11e8",
        "type": "operating_rules",
        "attributes": {
          "data": {
            "away": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/483a3fab-8129-4166-96c9-040534ad271e' \
    --header 'content-type: application/json' \
```
