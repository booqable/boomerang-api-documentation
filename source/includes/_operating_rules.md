...
```json
  ...
  "data": [
    {
      "id": "5699b982-63c3-4921-b5f8-dbf8cbd02c87",
      "type": "operating_rules",
      "attributes": {
        "created_at": "2023-02-01T13:19:54+00:00",
        "updated_at": "2023-02-01T13:19:54+00:00",
        "data_type": "away",
        "data": {
          "away": {
            "from": "2020-01-01",
...
```json
  {
  "data": {
    "id": "7b6ff5fd-41b1-4b30-bd83-5b93a6a1c981",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-01T13:19:55+00:00",
      "updated_at": "2023-02-01T13:19:55+00:00",
      "data_type": "hours",
      "data": {
        "mon": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "627a3d7a-da4e-4e6e-9627-5ecd6881745c",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-01T13:19:56+00:00",
      "updated_at": "2023-02-01T13:19:56+00:00",
      "data_type": "hours",
      "data": {
        "weekday": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "02b3aac6-c56c-454b-8e75-02240b4807a4",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-01T13:19:57+00:00",
      "updated_at": "2023-02-01T13:19:57+00:00",
      "data_type": "away",
      "data": {
        "away": {
          "from": "2030-01-01",
...
```json
  {
  "data": {
    "id": "4a4f11cc-0642-47c1-bc37-4f181fe2b22a",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-01T13:19:57+00:00",
      "updated_at": "2023-02-01T13:19:57+00:00",
...
```json
  {
  "data": {
    "id": "6df024b7-b590-4da9-b375-ed7c8a908599",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-01T13:19:58+00:00",
      "updated_at": "2023-02-01T13:19:58+00:00",
      "data_type": "timeslot_duration",
      "data": {
        "length": 86000
      }
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/f5f1173c-14d3-4b5f-8976-5fb15fd6f6a7' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "f5f1173c-14d3-4b5f-8976-5fb15fd6f6a7",
        "type": "operating_rules",
        "attributes": {
          "data": {
            "away": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/2d594575-a779-48e4-a61a-fa346a2b52d2' \
    --header 'content-type: application/json' \
```
