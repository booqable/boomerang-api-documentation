...
```json
  ...
  "data": [
    {
      "id": "752508de-d095-4ec3-8a0d-31a9ba9f4a3b",
      "type": "operating_rules",
      "attributes": {
        "created_at": "2023-02-02T07:56:53+00:00",
        "updated_at": "2023-02-02T07:56:53+00:00",
        "data_type": "away",
        "data": {
          "away": {
            "from": "2020-01-01",
...
```json
  {
  "data": {
    "id": "9446f0b2-d086-4233-b6e2-c36ecc5e92db",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-02T07:56:53+00:00",
      "updated_at": "2023-02-02T07:56:53+00:00",
...
```json
  {
  "data": {
    "id": "2b515473-a4ee-4f4e-822a-1bebce24907d",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-02T07:56:54+00:00",
      "updated_at": "2023-02-02T07:56:54+00:00",
      "data_type": "hours",
      "data": {
        "weekday": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "09c4fdb3-42ec-467f-9a36-c02797796ecb",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-02T07:56:54+00:00",
      "updated_at": "2023-02-02T07:56:54+00:00",
...
```json
  {
  "data": {
    "id": "9546789e-852b-4f39-b4a9-6b306fe5fbdb",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-02T07:56:54+00:00",
      "updated_at": "2023-02-02T07:56:54+00:00",
...
```json
  {
  "data": {
    "id": "19b7ac0f-80da-4de5-8cb5-7650270ace7b",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-02T07:56:54+00:00",
      "updated_at": "2023-02-02T07:56:54+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/4980fa98-7d64-4e9e-8134-09a1108bea72' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "4980fa98-7d64-4e9e-8134-09a1108bea72",
        "type": "operating_rules",
        "attributes": {
          "data": {
            "away": {
...
```json
  ...
  "data": {
    ...
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-02T07:56:55+00:00",
      "updated_at": "2023-02-02T07:56:55+00:00",
      "data_type": "away",
      "data": {
        "away": {
          "from": "2020-04-01",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/28ca61af-666a-4fb0-8422-69e272913bc8' \
    --header 'content-type: application/json' \
```
