...
```json
  ...
  "data": [
    {
      "id": "b26c00e1-8c44-48ce-9845-17d6efa1b5d0",
...
```json
  {
  "data": {
    "id": "7759aca6-01fc-426d-b159-8e6a077232d5",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-07T16:05:57+00:00",
      "updated_at": "2023-02-07T16:05:57+00:00",
      "data_type": "hours",
      "data": {
        "mon": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "953a20fb-b523-498c-94fc-5ddae8850cce",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-07T16:05:58+00:00",
      "updated_at": "2023-02-07T16:05:58+00:00",
      "data_type": "hours",
      "data": {
        "weekday": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "789992c0-ee04-4f00-a7fe-5386abd504c5",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-07T16:05:58+00:00",
      "updated_at": "2023-02-07T16:05:58+00:00",
...
```json
  {
  "data": {
    "id": "0dc2e4d4-85ad-4603-a45b-584db8ff961d",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-07T16:05:59+00:00",
      "updated_at": "2023-02-07T16:05:59+00:00",
      "data_type": "timeslot_fixed",
      "data": {
        "weekend": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "0382f452-693a-45df-981c-c4514aad1b92",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-07T16:05:59+00:00",
      "updated_at": "2023-02-07T16:05:59+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/c186ace5-080f-4262-ab70-03c1e28ba21f' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "c186ace5-080f-4262-ab70-03c1e28ba21f",
        "type": "operating_rules",
        "attributes": {
          "data": {
            "away": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/f1b74c64-c01e-42b0-a082-9eb7cfc9ee0e' \
    --header 'content-type: application/json' \
```
