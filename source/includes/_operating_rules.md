...
```json
  ...
  "data": [
    {
      "id": "c2b08b79-4ad5-4fe6-843d-2286bac67007",
...
```json
  {
  "data": {
    "id": "d75080aa-b33d-415f-ba31-7ad8086e5a7a",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-01-18T13:36:14+00:00",
      "updated_at": "2023-01-18T13:36:14+00:00",
      "data_type": "hours",
      "data": {
        "mon": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "4b29ff97-3df2-4815-ad62-0a49858ef0ac",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-01-18T13:36:14+00:00",
      "updated_at": "2023-01-18T13:36:14+00:00",
...
```json
  {
  "data": {
    "id": "6063c4f9-97e2-4507-aa88-97e6f5dff3f7",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-01-18T13:36:15+00:00",
      "updated_at": "2023-01-18T13:36:15+00:00",
      "data_type": "away",
      "data": {
        "away": {
          "from": "2030-01-01",
...
```json
  {
  "data": {
    "id": "e8c198e2-a013-487d-a685-cf092ce55bfb",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-01-18T13:36:15+00:00",
      "updated_at": "2023-01-18T13:36:15+00:00",
...
```json
  {
  "data": {
    "id": "643e3b2d-ddb1-41fe-8c8d-9a55980303be",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-01-18T13:36:17+00:00",
      "updated_at": "2023-01-18T13:36:17+00:00",
      "data_type": "timeslot_duration",
      "data": {
        "length": 86000
      }
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/b772111b-c3f6-414e-ab4f-ce5bef15aaba' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "b772111b-c3f6-414e-ab4f-ce5bef15aaba",
        "type": "operating_rules",
        "attributes": {
          "data": {
            "away": {
...
```json
  ...
  "data": {
    ...
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-01-18T13:36:18+00:00",
      "updated_at": "2023-01-18T13:36:18+00:00",
      "data_type": "away",
      "data": {
        "away": {
          "from": "2020-04-01",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/0fca89a2-47d8-4729-96d1-6f4c13dffe75' \
    --header 'content-type: application/json' \
```
