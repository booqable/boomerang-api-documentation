...
```json
  ...
  "data": [
    {
      "id": "e32f3ded-1efe-488f-b241-20ae915daf28",
...
```json
  {
  "data": {
    "id": "0bfd1a1d-0b82-4ca4-8ac8-6dd6cd3afb3a",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-07T15:18:56+00:00",
      "updated_at": "2023-02-07T15:18:56+00:00",
      "data_type": "hours",
      "data": {
        "mon": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "6d2dc34a-cd6a-432f-9d6f-cdb67e78cbd6",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-07T15:18:56+00:00",
      "updated_at": "2023-02-07T15:18:56+00:00",
...
```json
  {
  "data": {
    "id": "21fe8eb8-86f1-4379-9573-e5c85f969272",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-07T15:18:56+00:00",
      "updated_at": "2023-02-07T15:18:56+00:00",
...
```json
  {
  "data": {
    "id": "468c8e97-8339-4c0d-8808-a0c827811ff2",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-07T15:18:57+00:00",
      "updated_at": "2023-02-07T15:18:57+00:00",
      "data_type": "timeslot_fixed",
      "data": {
        "weekend": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "85431b65-99ef-4901-b81b-d9edd7c003b2",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-07T15:18:57+00:00",
      "updated_at": "2023-02-07T15:18:57+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/8b703889-f29f-4d89-9b3f-ea4eea8492e4' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "8b703889-f29f-4d89-9b3f-ea4eea8492e4",
        "type": "operating_rules",
        "attributes": {
          "data": {
            "away": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/629ccae4-19fd-431d-8a78-95876892b759' \
    --header 'content-type: application/json' \
```
