...
```json
  ...
  "data": [
    {
      "id": "55eba3f3-50e0-4ca8-8b31-1ed2579ff2af",
      "type": "operating_rules",
      "attributes": {
        "created_at": "2022-11-22T17:44:01+00:00",
        "updated_at": "2022-11-22T17:44:01+00:00",
        "data_type": "away",
        "data": {
          "away": {
            "from": "2020-01-01",
...
```json
  {
  "data": {
    "id": "613ae173-48cd-4e6f-ae59-26dcae41d0e4",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-11-22T17:44:01+00:00",
      "updated_at": "2022-11-22T17:44:01+00:00",
...
```json
  {
  "data": {
    "id": "0886cdbc-018b-4015-9fd6-b2f2e6e835e2",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-11-22T17:44:02+00:00",
      "updated_at": "2022-11-22T17:44:02+00:00",
      "data_type": "hours",
      "data": {
        "weekday": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "0e13b86a-3207-4ad8-94f6-f57b78618760",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-11-22T17:44:02+00:00",
      "updated_at": "2022-11-22T17:44:02+00:00",
...
```json
  {
  "data": {
    "id": "47a813ba-a21b-454c-85da-925bef1845cf",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-11-22T17:44:02+00:00",
      "updated_at": "2022-11-22T17:44:02+00:00",
...
```json
  {
  "data": {
    "id": "c9f85571-f6f9-4321-97a9-9509972bcb3a",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-11-22T17:44:02+00:00",
      "updated_at": "2022-11-22T17:44:02+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/04a80ab2-b364-47a2-80d6-081cccb19efb' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "04a80ab2-b364-47a2-80d6-081cccb19efb",
        "type": "operating_rules",
        "attributes": {
          "data": {
            "away": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/6fb4ab09-64ed-43f2-8061-1c7d8481fa86' \
    --header 'content-type: application/json' \
```
