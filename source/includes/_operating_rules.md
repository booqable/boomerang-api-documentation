...
```json
  ...
  "data": [
    {
      "id": "e84b9592-2efd-46b7-83e5-e10f4192bcdd",
      "type": "operating_rules",
      "attributes": {
        "created_at": "2022-01-14T18:54:11+00:00",
        "updated_at": "2022-01-14T18:54:11+00:00",
        "data_type": "away",
        "data": {
          "away": {
            "from": "2020-01-01",
...
```json
  {
  "data": {
    "id": "1f530ec1-4321-4033-8436-01261851f53d",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-01-14T18:54:11+00:00",
      "updated_at": "2022-01-14T18:54:11+00:00",
...
```json
  {
  "data": {
    "id": "a168aaec-610c-49fd-bc97-3caa6d327d34",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-01-14T18:54:11+00:00",
      "updated_at": "2022-01-14T18:54:11+00:00",
...
```json
  {
  "data": {
    "id": "b087dc9d-f007-44c6-832e-9115cacdd8ed",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-01-14T18:54:12+00:00",
      "updated_at": "2022-01-14T18:54:12+00:00",
      "data_type": "away",
      "data": {
        "away": {
          "from": "2030-01-01",
...
```json
  {
  "data": {
    "id": "7ecb001c-facf-43ca-8f45-6a5e683c1882",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-01-14T18:54:12+00:00",
      "updated_at": "2022-01-14T18:54:12+00:00",
...
```json
  {
  "data": {
    "id": "d9138b9f-1d06-473b-8f6b-57f5175c729f",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-01-14T18:54:12+00:00",
      "updated_at": "2022-01-14T18:54:12+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/7033be57-c57a-4eeb-9e68-bde1565f6e49' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "7033be57-c57a-4eeb-9e68-bde1565f6e49",
        "type": "operating_rules",
        "attributes": {
          "data": {
            "away": {
...
```json
  ...
  "data": {
    ...
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-01-14T18:54:13+00:00",
      "updated_at": "2022-01-14T18:54:13+00:00",
      "data_type": "away",
      "data": {
        "away": {
          "from": "2020-04-01",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/a1972cf0-318d-4eef-8332-1e51db6804ae' \
    --header 'content-type: application/json' \
```
