...
```json
  ...
  "data": [
    {
      "id": "77be6449-235e-44d1-9531-5ded4a532461",
...
```json
  {
  "data": {
    "id": "be0eba03-51e0-4f9b-b020-75d5c2007a0f",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-07-15T11:22:26+00:00",
      "updated_at": "2022-07-15T11:22:26+00:00",
      "data_type": "hours",
      "data": {
        "mon": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "fbfd8e1f-1013-418b-8ee3-7f42ba78cbb2",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-07-15T11:22:26+00:00",
      "updated_at": "2022-07-15T11:22:26+00:00",
...
```json
  {
  "data": {
    "id": "74da26a1-26cd-4419-81a2-cb037a6abdab",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-07-15T11:22:26+00:00",
      "updated_at": "2022-07-15T11:22:26+00:00",
...
```json
  {
  "data": {
    "id": "0e4bc408-9fcb-429b-9a95-b6828f329c5e",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-07-15T11:22:27+00:00",
      "updated_at": "2022-07-15T11:22:27+00:00",
      "data_type": "timeslot_fixed",
      "data": {
        "weekend": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "281309cb-c69e-4828-98a6-ad21dcfc937f",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-07-15T11:22:27+00:00",
      "updated_at": "2022-07-15T11:22:27+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/5f323270-7415-420a-82c6-22b748723ef9' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "5f323270-7415-420a-82c6-22b748723ef9",
        "type": "operating_rules",
        "attributes": {
          "data": {
            "away": {
...
```json
  ...
  "data": {
    ...
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-07-15T11:22:28+00:00",
      "updated_at": "2022-07-15T11:22:28+00:00",
      "data_type": "away",
      "data": {
        "away": {
          "from": "2020-04-01",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/ce5e158d-bd52-47da-b918-57cf05e4fcdd' \
    --header 'content-type: application/json' \
```
