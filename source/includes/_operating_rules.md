...
```json
  ...
  "data": [
    {
      "id": "ca4325e5-bfa3-4754-86c5-4abe38620657",
      "type": "operating_rules",
      "attributes": {
        "created_at": "2023-03-10T08:38:12+00:00",
        "updated_at": "2023-03-10T08:38:12+00:00",
        "data_type": "away",
        "data": {
          "away": {
            "from": "2020-01-01",
...
```json
  {
  "data": {
    "id": "04f747b6-de1e-4218-9a12-25d2311819ee",
    "type": "operating_rules",
    "attributes": {
...
```json
  {
  "data": {
    "id": "806d14ba-ca84-4a7b-817b-ef4229471553",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-03-10T08:38:13+00:00",
      "updated_at": "2023-03-10T08:38:13+00:00",
...
```json
  {
  "data": {
    "id": "51fac14f-0c47-48b3-a9c6-d96b6b23e6c2",
    "type": "operating_rules",
    "attributes": {
...
```json
  {
  "data": {
    "id": "571d5cdb-69eb-422e-b9d7-f748c107bc53",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-03-10T08:38:14+00:00",
      "updated_at": "2023-03-10T08:38:14+00:00",
...
```json
  {
  "data": {
    "id": "d84f62f7-9d93-438d-a5ab-0463b7f4ba9b",
    "type": "operating_rules",
    "attributes": {
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/ae1062b0-208e-43d4-b1a7-778c7c3326bb' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "ae1062b0-208e-43d4-b1a7-778c7c3326bb",
        "type": "operating_rules",
        "attributes": {
          "data": {
            "away": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/4588caa5-3ae8-4897-bef9-1fbb0ecaf6b2' \
    --header 'content-type: application/json' \
```
