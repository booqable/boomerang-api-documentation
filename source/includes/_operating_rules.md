...
```json
  ...
  "data": [
    {
      "id": "9254693c-f5cc-4b5e-8621-2c48059e19d8",
      "type": "operating_rules",
      "attributes": {
        "created_at": "2023-02-06T08:40:42+00:00",
        "updated_at": "2023-02-06T08:40:42+00:00",
        "data_type": "away",
        "data": {
          "away": {
            "from": "2020-01-01",
...
```json
  {
  "data": {
    "id": "afb55de4-0ef5-4d35-8f1d-711617fa8ea3",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-06T08:40:42+00:00",
      "updated_at": "2023-02-06T08:40:42+00:00",
...
```json
  {
  "data": {
    "id": "29608858-400c-4c43-a334-ceccd1dce45d",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-06T08:40:42+00:00",
      "updated_at": "2023-02-06T08:40:42+00:00",
...
```json
  {
  "data": {
    "id": "b0317c15-72fe-4df6-a5d3-82c52d666456",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-06T08:40:43+00:00",
      "updated_at": "2023-02-06T08:40:43+00:00",
      "data_type": "away",
      "data": {
        "away": {
          "from": "2030-01-01",
...
```json
  {
  "data": {
    "id": "9d6153c9-866f-4209-8a2f-c75f25dd3fcd",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-06T08:40:43+00:00",
      "updated_at": "2023-02-06T08:40:43+00:00",
...
```json
  {
  "data": {
    "id": "1c5b8171-ceec-4297-afdd-00f40dc58184",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-06T08:40:43+00:00",
      "updated_at": "2023-02-06T08:40:43+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/4e7a625e-2e13-4758-a519-b373b20851a2' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "4e7a625e-2e13-4758-a519-b373b20851a2",
        "type": "operating_rules",
        "attributes": {
          "data": {
            "away": {
...
```json
  ...
  "data": {
    ...
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-06T08:40:44+00:00",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/f1ee1fc8-bec9-44b1-b5b8-87b2cf0c1760' \
    --header 'content-type: application/json' \
```
