...
```json
  ...
  "data": [
    {
      "id": "4801256c-9eda-426b-aab3-828e4da7a0a6",
      "type": "operating_rules",
      "attributes": {
        "created_at": "2022-11-16T14:23:51+00:00",
        "updated_at": "2022-11-16T14:23:51+00:00",
        "data_type": "away",
        "data": {
          "away": {
            "from": "2020-01-01",
...
```json
  {
  "data": {
    "id": "929c2522-4c6e-4280-8ccc-826b54d38dfe",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-11-16T14:23:51+00:00",
      "updated_at": "2022-11-16T14:23:51+00:00",
...
```json
  {
  "data": {
    "id": "0c3787ed-5820-43f1-9410-d66f7426982f",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-11-16T14:23:51+00:00",
      "updated_at": "2022-11-16T14:23:51+00:00",
...
```json
  {
  "data": {
    "id": "743dadde-b4d2-4ffc-8313-29298d401de5",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-11-16T14:23:52+00:00",
      "updated_at": "2022-11-16T14:23:52+00:00",
      "data_type": "away",
      "data": {
        "away": {
          "from": "2030-01-01",
...
```json
  {
  "data": {
    "id": "56f0e7ca-d554-40b0-b24f-a42f511964f3",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-11-16T14:23:52+00:00",
      "updated_at": "2022-11-16T14:23:52+00:00",
...
```json
  {
  "data": {
    "id": "12874d61-47b5-4da3-af22-fe5ade31d0b4",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-11-16T14:23:52+00:00",
      "updated_at": "2022-11-16T14:23:52+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/a5cb294f-dda7-461a-882f-6ce3c9bae734' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "a5cb294f-dda7-461a-882f-6ce3c9bae734",
        "type": "operating_rules",
        "attributes": {
          "data": {
            "away": {
...
```json
  ...
  "data": {
    ...
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-11-16T14:23:53+00:00",
      "updated_at": "2022-11-16T14:23:53+00:00",
      "data_type": "away",
      "data": {
        "away": {
          "from": "2020-04-01",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/c0bb407f-2bc8-4ba7-b263-324b4a21bfbc' \
    --header 'content-type: application/json' \
```
