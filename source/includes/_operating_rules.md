...
```json
  ...
  "data": [
    {
      "id": "63b76be5-9ad3-41b2-9562-71bdf828b8d6",
      "type": "operating_rules",
      "attributes": {
        "created_at": "2023-03-01T10:32:05+00:00",
        "updated_at": "2023-03-01T10:32:05+00:00",
        "data_type": "away",
        "data": {
          "away": {
            "from": "2020-01-01",
...
```json
  {
  "data": {
    "id": "f777f0cf-2b08-48ae-b671-b358faf5e449",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-03-01T10:32:05+00:00",
      "updated_at": "2023-03-01T10:32:05+00:00",
...
```json
  {
  "data": {
    "id": "ca9916dd-4448-4380-856a-f490f42cfe58",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-03-01T10:32:05+00:00",
      "updated_at": "2023-03-01T10:32:05+00:00",
...
```json
  {
  "data": {
    "id": "476989ef-3222-4cab-a4e9-364c16006f66",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-03-01T10:32:06+00:00",
      "updated_at": "2023-03-01T10:32:06+00:00",
      "data_type": "away",
      "data": {
        "away": {
          "from": "2030-01-01",
...
```json
  {
  "data": {
    "id": "ea114733-b05b-4dda-9a11-46b33ea65c76",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-03-01T10:32:06+00:00",
      "updated_at": "2023-03-01T10:32:06+00:00",
...
```json
  {
  "data": {
    "id": "c008c595-f199-49cb-9c26-1f149845c9da",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-03-01T10:32:07+00:00",
      "updated_at": "2023-03-01T10:32:07+00:00",
      "data_type": "timeslot_duration",
      "data": {
        "length": 86000
      }
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/e2b0812f-e92c-42db-87e9-ec872d6410d3' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "e2b0812f-e92c-42db-87e9-ec872d6410d3",
        "type": "operating_rules",
        "attributes": {
          "data": {
            "away": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/5347da9a-c1dd-4b1a-b741-d8b2ed2b6e17' \
    --header 'content-type: application/json' \
```
