...
```json
  ...
  "data": [
    {
      "id": "244f8e3c-3882-4bc0-91d3-b9c3addce5db",
...
```json
  {
  "data": {
    "id": "4733a1af-a5b7-46d4-a7e6-d3c5366db709",
    "type": "operating_rules",
    "attributes": {
...
```json
  {
  "data": {
    "id": "88129108-beef-4000-aa85-5019c5c8e26b",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-09T12:19:47+00:00",
      "updated_at": "2023-02-09T12:19:47+00:00",
...
```json
  {
  "data": {
    "id": "ae15e8f2-b245-43c3-a4aa-a5ee3ddd7b70",
    "type": "operating_rules",
    "attributes": {
...
```json
  {
  "data": {
    "id": "d4a83098-d11d-4697-b917-8b38db94c21c",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-09T12:19:48+00:00",
      "updated_at": "2023-02-09T12:19:48+00:00",
...
```json
  {
  "data": {
    "id": "a8fe9759-a27f-4c04-b5ce-1348a0c747a5",
    "type": "operating_rules",
    "attributes": {
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/5d077c77-6f03-401c-ac4f-fe769f19aac0' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "5d077c77-6f03-401c-ac4f-fe769f19aac0",
        "type": "operating_rules",
        "attributes": {
          "data": {
            "away": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/32b48cf5-e126-4dd8-ad53-b81bf32515fb' \
    --header 'content-type: application/json' \
```
