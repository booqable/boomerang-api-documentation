...
```json
  ...
  "data": [
    {
      "id": "f2ebbab3-d948-4a09-8249-35373e94b18f",
      "type": "operating_rules",
      "attributes": {
        "created_at": "2023-03-02T09:25:07+00:00",
        "updated_at": "2023-03-02T09:25:07+00:00",
        "data_type": "away",
        "data": {
          "away": {
            "from": "2020-01-01",
...
```json
  {
  "data": {
    "id": "65390fbb-41e8-44b8-9d01-ddcdd9ddae5b",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-03-02T09:25:07+00:00",
      "updated_at": "2023-03-02T09:25:07+00:00",
...
```json
  {
  "data": {
    "id": "19504285-bb77-4287-a85c-6e487eedaeef",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-03-02T09:25:07+00:00",
      "updated_at": "2023-03-02T09:25:07+00:00",
...
```json
  {
  "data": {
    "id": "50501335-7263-4f2b-b120-c01cd97bec50",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-03-02T09:25:08+00:00",
      "updated_at": "2023-03-02T09:25:08+00:00",
      "data_type": "away",
      "data": {
        "away": {
          "from": "2030-01-01",
...
```json
  {
  "data": {
    "id": "d10737fc-0abd-47bd-80cb-9a252db59360",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-03-02T09:25:08+00:00",
      "updated_at": "2023-03-02T09:25:08+00:00",
...
```json
  {
  "data": {
    "id": "b8294189-1539-4e66-8517-31977ca31262",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-03-02T09:25:09+00:00",
      "updated_at": "2023-03-02T09:25:09+00:00",
      "data_type": "timeslot_duration",
      "data": {
        "length": 86000
      }
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/27995242-4300-4f55-bedb-553f3d3367d1' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "27995242-4300-4f55-bedb-553f3d3367d1",
        "type": "operating_rules",
        "attributes": {
          "data": {
            "away": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/997b0fd1-ba28-4ab9-bec7-98479ef88e45' \
    --header 'content-type: application/json' \
```
