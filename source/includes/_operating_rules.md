...
```json
  ...
  "data": [
    {
      "id": "7f32213d-9f84-4434-9e51-cd5fd1d49d0f",
...
```json
  {
  "data": {
    "id": "2473b7bd-2784-4be0-add7-b080db602d26",
    "type": "operating_rules",
    "attributes": {
...
```json
  {
  "data": {
    "id": "f4fd34ac-6056-4625-bbe8-4aef02032dfd",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-11-22T16:34:54+00:00",
      "updated_at": "2022-11-22T16:34:54+00:00",
...
```json
  {
  "data": {
    "id": "b69dd9bc-bba8-4c0f-bd4c-eaeb5c517f30",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-11-22T16:34:54+00:00",
      "updated_at": "2022-11-22T16:34:54+00:00",
...
```json
  {
  "data": {
    "id": "564ec5c6-6797-42e8-a13b-5ca49187739b",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-11-22T16:34:55+00:00",
      "updated_at": "2022-11-22T16:34:55+00:00",
      "data_type": "timeslot_fixed",
      "data": {
        "weekend": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "4836129d-177f-4fa3-8522-25eccddba0fc",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-11-22T16:34:55+00:00",
      "updated_at": "2022-11-22T16:34:55+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/ea4bee68-3306-4ade-9487-741c6af19a91' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "ea4bee68-3306-4ade-9487-741c6af19a91",
        "type": "operating_rules",
        "attributes": {
          "data": {
            "away": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/fdc9ef2c-a9b2-40b3-a84d-3a0a18f4f768' \
    --header 'content-type: application/json' \
```
