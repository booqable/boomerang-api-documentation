...
```json
  ...
  "data": [
    {
      "id": "7355c2d9-38ce-4d6e-89b7-38fa3be825fd",
      "type": "operating_rules",
      "attributes": {
        "created_at": "2023-02-08T13:52:05+00:00",
        "updated_at": "2023-02-08T13:52:05+00:00",
        "data_type": "away",
        "data": {
          "away": {
            "from": "2020-01-01",
...
```json
  {
  "data": {
    "id": "7055353a-c67b-4894-a6b8-31e721699e4b",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-08T13:52:05+00:00",
      "updated_at": "2023-02-08T13:52:05+00:00",
...
```json
  {
  "data": {
    "id": "9c79c4d4-4f30-4b66-99d1-8e3eb89c3508",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-08T13:52:05+00:00",
      "updated_at": "2023-02-08T13:52:05+00:00",
...
```json
  {
  "data": {
    "id": "ef22e486-5eaa-4d80-a27f-9e5066700acf",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-08T13:52:06+00:00",
      "updated_at": "2023-02-08T13:52:06+00:00",
      "data_type": "away",
      "data": {
        "away": {
          "from": "2030-01-01",
...
```json
  {
  "data": {
    "id": "b8496dd2-ad39-457d-9c60-755d3a7533dd",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-08T13:52:06+00:00",
      "updated_at": "2023-02-08T13:52:06+00:00",
...
```json
  {
  "data": {
    "id": "883c2fbe-8363-4433-ba92-7186de5867ff",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-08T13:52:06+00:00",
      "updated_at": "2023-02-08T13:52:06+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/c119f56e-c542-4ce7-8c77-015aeb7573f0' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "c119f56e-c542-4ce7-8c77-015aeb7573f0",
        "type": "operating_rules",
        "attributes": {
          "data": {
            "away": {
...
```json
  ...
  "data": {
    ...
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-08T13:52:07+00:00",
      "updated_at": "2023-02-08T13:52:07+00:00",
      "data_type": "away",
      "data": {
        "away": {
          "from": "2020-04-01",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/27431672-0b3b-4cac-b807-5fafa4064934' \
    --header 'content-type: application/json' \
```
