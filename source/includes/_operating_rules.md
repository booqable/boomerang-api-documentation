...
```json
  ...
  "data": [
    {
      "id": "2a5490ba-b980-4dfa-860d-f51dbee063ab",
      "type": "operating_rules",
      "attributes": {
        "created_at": "2023-01-05T13:03:47+00:00",
        "updated_at": "2023-01-05T13:03:47+00:00",
        "data_type": "away",
        "data": {
          "away": {
            "from": "2020-01-01",
...
```json
  {
  "data": {
    "id": "b74cd841-997a-42d3-a53d-8ce63505f363",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-01-05T13:03:47+00:00",
      "updated_at": "2023-01-05T13:03:47+00:00",
...
```json
  {
  "data": {
    "id": "378b38bf-e74a-4ec5-8f27-06d483c79af4",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-01-05T13:03:47+00:00",
      "updated_at": "2023-01-05T13:03:47+00:00",
...
```json
  {
  "data": {
    "id": "8957d325-bd5f-4ca6-80d0-7f09fc6b1fd2",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-01-05T13:03:48+00:00",
      "updated_at": "2023-01-05T13:03:48+00:00",
      "data_type": "away",
      "data": {
        "away": {
          "from": "2030-01-01",
...
```json
  {
  "data": {
    "id": "3586aefc-dcba-4888-9251-f643347e962d",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-01-05T13:03:48+00:00",
      "updated_at": "2023-01-05T13:03:48+00:00",
...
```json
  {
  "data": {
    "id": "0ebd3ff0-3f45-47be-94c2-822452c98f74",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-01-05T13:03:49+00:00",
      "updated_at": "2023-01-05T13:03:49+00:00",
      "data_type": "timeslot_duration",
      "data": {
        "length": 86000
      }
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/4309d0c9-101f-4df0-b378-d9459be37e83' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "4309d0c9-101f-4df0-b378-d9459be37e83",
        "type": "operating_rules",
        "attributes": {
          "data": {
            "away": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/d91b647f-0623-4dda-8338-8964f94161a1' \
    --header 'content-type: application/json' \
```
