...
```json
  ...
  "data": [
    {
      "id": "c5242807-1045-42d0-9b28-ed095384437d",
      "type": "operating_rules",
      "attributes": {
        "created_at": "2023-02-13T12:53:55+00:00",
        "updated_at": "2023-02-13T12:53:55+00:00",
        "data_type": "away",
        "data": {
          "away": {
            "from": "2020-01-01",
...
```json
  {
  "data": {
    "id": "1cdd7c4c-77b8-441e-92eb-a34c3507fa5e",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-13T12:53:55+00:00",
      "updated_at": "2023-02-13T12:53:55+00:00",
...
```json
  {
  "data": {
    "id": "078b631f-3a1f-49e9-90c7-513aa42d3875",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-13T12:53:56+00:00",
      "updated_at": "2023-02-13T12:53:56+00:00",
      "data_type": "hours",
      "data": {
        "weekday": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "5183a4ed-ef5c-4958-a3b3-bec477430d76",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-13T12:53:56+00:00",
      "updated_at": "2023-02-13T12:53:56+00:00",
...
```json
  {
  "data": {
    "id": "2f4f3f96-2d4f-4d3e-a373-72a4fbd82808",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-13T12:53:56+00:00",
      "updated_at": "2023-02-13T12:53:56+00:00",
...
```json
  {
  "data": {
    "id": "3724a58a-c423-437e-a48f-a12c5d53a550",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-13T12:53:57+00:00",
      "updated_at": "2023-02-13T12:53:57+00:00",
      "data_type": "timeslot_duration",
      "data": {
        "length": 86000
      }
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/51f6e227-3029-4828-820a-c0938968827b' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "51f6e227-3029-4828-820a-c0938968827b",
        "type": "operating_rules",
        "attributes": {
          "data": {
            "away": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/fdd9bf16-f8aa-4090-8601-e11373cf3ba3' \
    --header 'content-type: application/json' \
```
