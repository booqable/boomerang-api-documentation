...
```json
  ...
  "data": [
    {
      "id": "93ac6bff-718e-4736-8c86-f46ec4a2aaf6",
      "type": "operating_rules",
      "attributes": {
        "created_at": "2023-02-08T15:00:17+00:00",
        "updated_at": "2023-02-08T15:00:17+00:00",
        "data_type": "away",
        "data": {
          "away": {
            "from": "2020-01-01",
...
```json
  {
  "data": {
    "id": "f94fb156-0e7f-4de6-a15d-dafbb90e2eb4",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-08T15:00:18+00:00",
      "updated_at": "2023-02-08T15:00:18+00:00",
      "data_type": "hours",
      "data": {
        "mon": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "a2b6b792-f022-49a9-90b7-ee7b501f4c94",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-08T15:00:18+00:00",
      "updated_at": "2023-02-08T15:00:18+00:00",
...
```json
  {
  "data": {
    "id": "e8483317-a08d-4c4b-baee-175824128865",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-08T15:00:19+00:00",
      "updated_at": "2023-02-08T15:00:19+00:00",
      "data_type": "away",
      "data": {
        "away": {
          "from": "2030-01-01",
...
```json
  {
  "data": {
    "id": "7041f5e2-f66b-44d7-9cea-8b83ff785414",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-08T15:00:19+00:00",
      "updated_at": "2023-02-08T15:00:19+00:00",
...
```json
  {
  "data": {
    "id": "5d3c74c7-9056-4e30-b85b-8a6a2f3c6f42",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-08T15:00:19+00:00",
      "updated_at": "2023-02-08T15:00:19+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/f6d01fc6-6810-49d3-8225-3ee674bfb7c6' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "f6d01fc6-6810-49d3-8225-3ee674bfb7c6",
        "type": "operating_rules",
        "attributes": {
          "data": {
            "away": {
...
```json
  ...
  "data": {
    ...
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-08T15:00:20+00:00",
      "updated_at": "2023-02-08T15:00:20+00:00",
      "data_type": "away",
      "data": {
        "away": {
          "from": "2020-04-01",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/bed1b769-d627-41db-bdc0-ccaeb794110d' \
    --header 'content-type: application/json' \
```
