...
```json
  ...
  "data": [
    {
      "id": "200697d2-80ae-4147-bbe0-2055aef7eb00",
      "type": "operating_rules",
      "attributes": {
        "created_at": "2023-02-03T09:53:04+00:00",
        "updated_at": "2023-02-03T09:53:04+00:00",
        "data_type": "away",
        "data": {
          "away": {
            "from": "2020-01-01",
...
```json
  {
  "data": {
    "id": "b411739a-be33-41ab-a76d-ca7900b5869c",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-03T09:53:04+00:00",
      "updated_at": "2023-02-03T09:53:04+00:00",
...
```json
  {
  "data": {
    "id": "932235cc-05d4-46af-9020-70edf1e528ea",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-03T09:53:05+00:00",
      "updated_at": "2023-02-03T09:53:05+00:00",
      "data_type": "hours",
      "data": {
        "weekday": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "4bbc38ca-5e89-45b0-8563-f6e4888eb1cd",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-03T09:53:05+00:00",
      "updated_at": "2023-02-03T09:53:05+00:00",
...
```json
  {
  "data": {
    "id": "ca3a3e3a-4d63-45d0-ac91-db6c9a047fa8",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-03T09:53:05+00:00",
      "updated_at": "2023-02-03T09:53:05+00:00",
...
```json
  {
  "data": {
    "id": "d6197f29-4f42-43e2-9937-2d9d620d4562",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2023-02-03T09:53:06+00:00",
      "updated_at": "2023-02-03T09:53:06+00:00",
      "data_type": "timeslot_duration",
      "data": {
        "length": 86000
      }
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/d08f408e-24f3-4929-b690-6bb40a8358fd' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "d08f408e-24f3-4929-b690-6bb40a8358fd",
        "type": "operating_rules",
        "attributes": {
          "data": {
            "away": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/045cfa4f-a275-4713-979f-293e7c1e278d' \
    --header 'content-type: application/json' \
```
