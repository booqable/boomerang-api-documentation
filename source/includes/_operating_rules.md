...
```json
  ...
  "data": [
    {
      "id": "5f4fc1e9-96a7-4b7b-b860-f895aff62a39",
      "type": "operating_rules",
      "attributes": {
        "created_at": "2022-11-30T08:58:46+00:00",
        "updated_at": "2022-11-30T08:58:46+00:00",
        "data_type": "away",
        "data": {
          "away": {
            "from": "2020-01-01",
...
```json
  {
  "data": {
    "id": "10334fda-bea4-4bed-a95f-b7b85989db0c",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-11-30T08:58:47+00:00",
      "updated_at": "2022-11-30T08:58:47+00:00",
      "data_type": "hours",
      "data": {
        "mon": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "24e3e113-82fb-44cb-bdcb-b37584e0b262",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-11-30T08:58:47+00:00",
      "updated_at": "2022-11-30T08:58:47+00:00",
...
```json
  {
  "data": {
    "id": "e5dcaf1e-e984-4e9e-8739-6903db090e48",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-11-30T08:58:47+00:00",
      "updated_at": "2022-11-30T08:58:47+00:00",
...
```json
  {
  "data": {
    "id": "004b87a3-d9d8-4647-9f73-7a4288d0ed48",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-11-30T08:58:48+00:00",
      "updated_at": "2022-11-30T08:58:48+00:00",
      "data_type": "timeslot_fixed",
      "data": {
        "weekend": {
          "from": "09:00",
...
```json
  {
  "data": {
    "id": "bc1521b6-3bcb-4d9f-932e-8d59339ed647",
    "type": "operating_rules",
    "attributes": {
      "created_at": "2022-11-30T08:58:48+00:00",
      "updated_at": "2022-11-30T08:58:48+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/a64135cc-1770-43d9-92a9-d7038fa8e98d' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "a64135cc-1770-43d9-92a9-d7038fa8e98d",
        "type": "operating_rules",
        "attributes": {
          "data": {
            "away": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/operating_rules/bd05c34d-3c29-4e44-a58d-e22e434473ad' \
    --header 'content-type: application/json' \
```
