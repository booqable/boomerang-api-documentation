...
```json
  ...
  "data": [
    {
      "id": "397095c0-1274-4ada-b7d8-55c8a9bf4934",
      "type": "notification_subscriptions",
      "attributes": {
        "created_at": "2023-03-07T11:36:23+00:00",
        "updated_at": "2023-03-07T11:36:23+00:00",
    ...
    {
      "id": "a20fd975-ace4-4e7c-b54f-0b9183421826",
      "type": "notification_subscriptions",
      "attributes": {
        "created_at": "2023-03-07T11:36:23+00:00",
        "updated_at": "2023-03-07T11:36:23+00:00",
        ...
        "global": false,
        "owner_id": "c0d9a150-d2d4-463e-98b2-8abf801e79e5",
        "owner_type": "orders"
      },
      "relationships": {
        "owner": {
          "links": {
            "related": "api/boomerang/orders/c0d9a150-d2d4-463e-98b2-8abf801e79e5"
          }
        }
      }
    },
    {
      "id": "e1f44a4b-7d57-45f3-96fd-7a12f5c9e3f9",
      "type": "notification_subscriptions",
      "attributes": {
        "created_at": "2023-03-07T11:36:23+00:00",
        "updated_at": "2023-03-07T11:36:23+00:00",
    ...
    {
      "id": "fd971585-0e10-4668-9d5e-fd94f2558f26",
      "type": "notification_subscriptions",
      "attributes": {
        "created_at": "2023-03-07T11:36:23+00:00",
        "updated_at": "2023-03-07T11:36:23+00:00",
...
```json
  ...
  "data": [
    {
      "id": "fae44e42-230a-4ac3-825c-dd195f422a62",
      "type": "notification_subscriptions",
      "attributes": {
        "created_at": "2023-03-07T11:36:23+00:00",
        "updated_at": "2023-03-07T11:36:23+00:00",
    ...
    {
      "id": "a4275aff-f78a-4885-95a9-2ccb96646d20",
      "type": "notification_subscriptions",
      "attributes": {
        "created_at": "2023-03-07T11:36:23+00:00",
        "updated_at": "2023-03-07T11:36:23+00:00",
    ...
    {
      "id": "b808421b-67db-4aa0-9275-eeb9c9d343e0",
      "type": "notification_subscriptions",
      "attributes": {
        "created_at": "2023-03-07T11:36:23+00:00",
        "updated_at": "2023-03-07T11:36:23+00:00",
...
```json
  ...
  "data": [
    {
      "id": "1aac3f24-4821-48af-a09a-518744f8bb7a",
      "type": "notification_subscriptions",
      "attributes": {
        "created_at": "2023-03-07T11:36:24+00:00",
        "updated_at": "2023-03-07T11:36:24+00:00",
        "category": "order_updated",
        "global": false,
        "owner_id": "b4626d5f-a2b8-4d26-86bf-4612eb3c40eb",
        "owner_type": "orders"
      },
      "relationships": {
        "owner": {
          "links": {
            "related": "api/boomerang/orders/b4626d5f-a2b8-4d26-86bf-4612eb3c40eb"
          }
        }
      }
    }
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/notification_subscriptions/a4f71712-2a00-4ab6-9a3e-c6374103efc3' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "a4f71712-2a00-4ab6-9a3e-c6374103efc3",
    "type": "notification_subscriptions",
    "attributes": {
      "created_at": "2023-03-07T11:36:24+00:00",
      "updated_at": "2023-03-07T11:36:24+00:00",
      "category": "order_updated",
      "global": false,
      "owner_id": "4a644f85-7e84-4777-b6b3-6e73668d1866",
      "owner_type": "orders"
    },
    "relationships": {
      "owner": {
        "links": {
          "related": "api/boomerang/orders/4a644f85-7e84-4777-b6b3-6e73668d1866"
        }
      }
    }
  },
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "category": "order_updated",
          "owner_id": "859e2b17-5926-460a-b6fa-cbdaa62cbe1f",
          "owner_type": "orders"
        }
      }
    }'
...
```json
  {
  "data": {
    "id": "f5eb18c5-3c9c-40d3-b753-d196292da17c",
    "type": "notification_subscriptions",
    "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/notification_subscriptions/9a4fbecd-e6a4-414c-97a8-d4d7cab65c54' \
    --header 'content-type: application/json' \
```
