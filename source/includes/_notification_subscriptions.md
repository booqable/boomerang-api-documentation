...
```json
  ...
  "data": [
    {
      "id": "0577ddbc-4285-4dbc-b5b6-b2627960720b",
      "type": "notification_subscriptions",
      "attributes": {
        "created_at": "2023-03-01T10:01:42+00:00",
        "updated_at": "2023-03-01T10:01:42+00:00",
    ...
    {
      "id": "2e043601-25d0-4264-9234-9fa512c8ccde",
      "type": "notification_subscriptions",
      "attributes": {
        "created_at": "2023-03-01T10:01:42+00:00",
        "updated_at": "2023-03-01T10:01:42+00:00",
        ...
        "global": false,
        "owner_id": "75fbb18f-f1e8-495b-854b-5d1da2e5f87e",
        "owner_type": "orders"
      },
      "relationships": {
        "owner": {
          "links": {
            "related": "api/boomerang/orders/75fbb18f-f1e8-495b-854b-5d1da2e5f87e"
          }
        }
      }
    },
    {
      "id": "a92b6a8c-a7be-46f7-bdb9-76f179528d82",
      "type": "notification_subscriptions",
      "attributes": {
        "created_at": "2023-03-01T10:01:42+00:00",
        "updated_at": "2023-03-01T10:01:42+00:00",
    ...
    {
      "id": "4e26e40f-8803-4c42-9f1e-1554c173cbc6",
      "type": "notification_subscriptions",
      "attributes": {
        "created_at": "2023-03-01T10:01:42+00:00",
        "updated_at": "2023-03-01T10:01:42+00:00",
...
```json
  ...
  "data": [
    {
      "id": "be84540e-cd31-43eb-958e-15c1515ef2da",
      "type": "notification_subscriptions",
      "attributes": {
        "created_at": "2023-03-01T10:01:42+00:00",
        "updated_at": "2023-03-01T10:01:42+00:00",
    ...
    {
      "id": "be76ff2c-2760-40f1-a5a1-3201d9774c59",
      "type": "notification_subscriptions",
      "attributes": {
        "created_at": "2023-03-01T10:01:42+00:00",
        "updated_at": "2023-03-01T10:01:42+00:00",
    ...
    {
      "id": "f88739de-2566-4391-9974-a4494ba0d512",
      "type": "notification_subscriptions",
      "attributes": {
        "created_at": "2023-03-01T10:01:42+00:00",
        "updated_at": "2023-03-01T10:01:42+00:00",
...
```json
  ...
  "data": [
    {
      "id": "7ac34b3f-464a-442d-aa6a-6472e713c8cc",
      "type": "notification_subscriptions",
      "attributes": {
        "created_at": "2023-03-01T10:01:43+00:00",
        "updated_at": "2023-03-01T10:01:43+00:00",
        "category": "order_updated",
        "global": false,
        "owner_id": "41294ba0-e218-4a41-975c-c9bcd4437794",
        "owner_type": "orders"
      },
      "relationships": {
        "owner": {
          "links": {
            "related": "api/boomerang/orders/41294ba0-e218-4a41-975c-c9bcd4437794"
          }
        }
      }
    }
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/notification_subscriptions/74fb5c60-e57e-4020-9896-aed3bc4c1f43' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "74fb5c60-e57e-4020-9896-aed3bc4c1f43",
    "type": "notification_subscriptions",
    "attributes": {
      "created_at": "2023-03-01T10:01:43+00:00",
      "updated_at": "2023-03-01T10:01:43+00:00",
      "category": "order_updated",
      "global": false,
      "owner_id": "efbcd4e9-1e83-4b2d-97c4-1f769f825152",
      "owner_type": "orders"
    },
    "relationships": {
      "owner": {
        "links": {
          "related": "api/boomerang/orders/efbcd4e9-1e83-4b2d-97c4-1f769f825152"
        }
      }
    }
  },
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "category": "order_updated",
          "owner_id": "d8fb901b-b62a-459d-904e-3ad35559ed98",
          "owner_type": "orders"
        }
      }
    }'
...
```json
  {
  "data": {
    "id": "983649ce-f0ce-4cc8-a6ca-f952f3fed3d7",
    "type": "notification_subscriptions",
    "attributes": {
      "created_at": "2023-03-01T10:01:44+00:00",
      "updated_at": "2023-03-01T10:01:44+00:00",
      "category": "order_updated",
      "global": false,
      "owner_id": "d8fb901b-b62a-459d-904e-3ad35559ed98",
      "owner_type": "orders"
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/notification_subscriptions/971a062a-1260-4463-a4db-5080762bc386' \
    --header 'content-type: application/json' \
```
