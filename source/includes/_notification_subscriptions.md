...
```json
  ...
  "data": [
    {
      "id": "30672363-7c34-46c4-b246-33765d4dbce3",
    ...
    {
      "id": "df0cf4b7-a03c-434f-a12e-8cc4de3c9093",
      "type": "notification_subscriptions",
      "attributes": {
        "created_at": "2023-03-09T08:58:52+00:00",
        "updated_at": "2023-03-09T08:58:52+00:00",
        ...
        "global": false,
        "owner_id": "d1ec9a8f-22a3-4ee5-bca0-2f0722eb601d",
        "owner_type": "orders"
      },
      "relationships": {
        "owner": {
          "links": {
            "related": "api/boomerang/orders/d1ec9a8f-22a3-4ee5-bca0-2f0722eb601d"
          }
        }
      }
    },
    {
      "id": "bc389925-a945-4c5f-b7f7-09f0869853d9",
      "type": "notification_subscriptions",
      "attributes": {
        "created_at": "2023-03-09T08:58:52+00:00",
        "updated_at": "2023-03-09T08:58:52+00:00",
    ...
    {
      "id": "a1997746-a336-4d23-9285-f3e6b8d57f95",
      "type": "notification_subscriptions",
      "attributes": {
        "created_at": "2023-03-09T08:58:52+00:00",
        "updated_at": "2023-03-09T08:58:52+00:00",
...
```json
  ...
  "data": [
    {
      "id": "1fcfecb2-e45a-4fc1-946c-c8f5f834061d",
      "type": "notification_subscriptions",
      "attributes": {
        "created_at": "2023-03-09T08:58:53+00:00",
    ...
    {
      "id": "4d902c1a-90c2-4cf3-b3e0-2f3203863d13",
      "type": "notification_subscriptions",
      "attributes": {
        "created_at": "2023-03-09T08:58:52+00:00",
        "updated_at": "2023-03-09T08:58:52+00:00",
    ...
    {
      "id": "f675f7ba-a367-4022-b785-a5ca13e24e5d",
      "type": "notification_subscriptions",
      "attributes": {
        "created_at": "2023-03-09T08:58:52+00:00",
        "updated_at": "2023-03-09T08:58:52+00:00",
...
```json
  ...
  "data": [
    {
      "id": "2ffa8cf0-c1a7-4b9f-942c-662c921959c6",
      "type": "notification_subscriptions",
      "attributes": {
        "created_at": "2023-03-09T08:58:53+00:00",
        "updated_at": "2023-03-09T08:58:53+00:00",
        "category": "order_updated",
        "global": false,
        "owner_id": "cdacc7ff-bf9f-4a73-9254-59ba56bfff3c",
        "owner_type": "orders"
      },
      "relationships": {
        "owner": {
          "links": {
            "related": "api/boomerang/orders/cdacc7ff-bf9f-4a73-9254-59ba56bfff3c"
          }
        }
      }
    }
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/notification_subscriptions/6ecefa67-6e19-43c0-a8ca-a9060fa90904' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "6ecefa67-6e19-43c0-a8ca-a9060fa90904",
    "type": "notification_subscriptions",
    "attributes": {
      ...
      "category": "order_updated",
      "global": false,
      "owner_id": "3e80e859-3355-4fd0-bb3c-823e0c2ebe9e",
      "owner_type": "orders"
    },
    "relationships": {
      "owner": {
        "links": {
          "related": "api/boomerang/orders/3e80e859-3355-4fd0-bb3c-823e0c2ebe9e"
        }
      }
    }
  },
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "category": "order_updated",
          "owner_id": "7292886f-b3ce-4a6e-b9e4-e511e7f7ea84",
          "owner_type": "orders"
        }
      }
    }'
...
```json
  {
  "data": {
    "id": "21a8d00e-9af4-4f91-80fe-5b8086eea3c4",
    "type": "notification_subscriptions",
    "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/notification_subscriptions/dda59f37-d51e-4def-bc9d-7ae01e55a9cd' \
    --header 'content-type: application/json' \
```
