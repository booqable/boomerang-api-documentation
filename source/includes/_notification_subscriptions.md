...
```json
  ...
  "data": [
    {
      "id": "b926af1c-f621-41f2-ae23-22dcd4e72fd5",
      "type": "notification_subscriptions",
      "attributes": {
        "created_at": "2023-02-09T12:19:42+00:00",
        "updated_at": "2023-02-09T12:19:42+00:00",
    ...
    {
      "id": "c8fb7c70-e75c-4ccd-9525-8ea0c803d048",
      "type": "notification_subscriptions",
      "attributes": {
        "created_at": "2023-02-09T12:19:42+00:00",
        "updated_at": "2023-02-09T12:19:42+00:00",
        ...
        "global": false,
        "owner_id": "6e8962b1-d6ad-4856-9d03-a50aa644e825",
        "owner_type": "orders"
      },
      "relationships": {
        "owner": {
          "links": {
            "related": "api/boomerang/orders/6e8962b1-d6ad-4856-9d03-a50aa644e825"
          }
        }
      }
    },
    {
      "id": "84723915-8903-4af1-bc6b-e2f573a3b7a8",
      "type": "notification_subscriptions",
      "attributes": {
        "created_at": "2023-02-09T12:19:42+00:00",
        "updated_at": "2023-02-09T12:19:42+00:00",
    ...
    {
      "id": "368d1ead-6a8b-452a-886d-cd4dc8aac66d",
      "type": "notification_subscriptions",
      "attributes": {
        "created_at": "2023-02-09T12:19:42+00:00",
        "updated_at": "2023-02-09T12:19:42+00:00",
...
```json
  ...
  "data": [
    {
      "id": "08b028fd-1555-4b53-b932-ccda2f808d85",
      "type": "notification_subscriptions",
      "attributes": {
        "created_at": "2023-02-09T12:19:43+00:00",
        "updated_at": "2023-02-09T12:19:43+00:00",
        "category": "order_started",
        "global": true,
        "owner_id": null,
        "owner_type": null
    ...
    {
      "id": "3fc327c5-02e9-4160-a2cd-085e1308d249",
      "type": "notification_subscriptions",
      "attributes": {
        "created_at": "2023-02-09T12:19:43+00:00",
        "updated_at": "2023-02-09T12:19:43+00:00",
    ...
    {
      "id": "b4f1d7b2-6fea-45c0-bc5c-b06891b57bf4",
      "type": "notification_subscriptions",
      "attributes": {
        "created_at": "2023-02-09T12:19:43+00:00",
        "updated_at": "2023-02-09T12:19:43+00:00",
...
```json
  ...
  "data": [
    {
      "id": "1975c9fa-b259-4025-83f7-e58a3df311ac",
      "type": "notification_subscriptions",
      "attributes": {
        ...
        "category": "order_updated",
        "global": false,
        "owner_id": "23dc60db-8017-4a59-85bb-fd6ef7ceefa7",
        "owner_type": "orders"
      },
      "relationships": {
        "owner": {
          "links": {
            "related": "api/boomerang/orders/23dc60db-8017-4a59-85bb-fd6ef7ceefa7"
          }
        }
      }
    }
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/notification_subscriptions/5acb6de4-4674-4d0b-aead-775c0a81ef87' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "5acb6de4-4674-4d0b-aead-775c0a81ef87",
    "type": "notification_subscriptions",
    "attributes": {
      "created_at": "2023-02-09T12:19:44+00:00",
      "updated_at": "2023-02-09T12:19:44+00:00",
      "category": "order_updated",
      "global": false,
      "owner_id": "a220d329-8a85-41da-b1ca-32b9d4d15f3e",
      "owner_type": "orders"
    },
    "relationships": {
      "owner": {
        "links": {
          "related": "api/boomerang/orders/a220d329-8a85-41da-b1ca-32b9d4d15f3e"
        }
      }
    }
  },
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "category": "order_updated",
          "owner_id": "edd5c5db-4290-4ae0-9ac2-767644f990b0",
          "owner_type": "orders"
        }
      }
    }'
...
```json
  {
  "data": {
    "id": "b2a601a7-92d7-4b4f-b110-6b50abfeec0b",
    "type": "notification_subscriptions",
    "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/notification_subscriptions/1eaf965c-7d00-47cb-b5c7-59e419f91f0c' \
    --header 'content-type: application/json' \
```
