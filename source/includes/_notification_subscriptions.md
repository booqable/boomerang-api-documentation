...
```json
  ...
  "data": [
    {
      "id": "e2050fde-203b-4033-9fa8-e2dfc1cca1b5",
    ...
    {
      "id": "dfde18bd-4749-41be-9d96-116a545ec49c",
      "type": "notification_subscriptions",
      "attributes": {
        "created_at": "2023-02-14T11:08:30+00:00",
        "updated_at": "2023-02-14T11:08:30+00:00",
        ...
        "global": false,
        "owner_id": "613c1c76-d843-488c-84de-0cb0411aa991",
        "owner_type": "orders"
      },
      "relationships": {
        "owner": {
          "links": {
            "related": "api/boomerang/orders/613c1c76-d843-488c-84de-0cb0411aa991"
          }
        }
      }
    },
    {
      "id": "3ba8b7f2-7113-43be-a19b-70dcef1a45a3",
      "type": "notification_subscriptions",
      "attributes": {
        "created_at": "2023-02-14T11:08:30+00:00",
        "updated_at": "2023-02-14T11:08:30+00:00",
    ...
    {
      "id": "aa40dc88-f43a-410f-84fd-c25279050daf",
      "type": "notification_subscriptions",
      "attributes": {
        "created_at": "2023-02-14T11:08:30+00:00",
        "updated_at": "2023-02-14T11:08:30+00:00",
...
```json
  ...
  "data": [
    {
      "id": "654181c3-0c35-44c1-b625-a8fc2a321b50",
      "type": "notification_subscriptions",
      "attributes": {
    ...
    {
      "id": "9192a92a-a666-436d-8656-9cbeadfd0005",
      "type": "notification_subscriptions",
      "attributes": {
        "created_at": "2023-02-14T11:08:31+00:00",
        "updated_at": "2023-02-14T11:08:31+00:00",
    ...
    {
      "id": "2912fcb7-f49a-4eff-8fd5-2ec5491791c9",
      "type": "notification_subscriptions",
      "attributes": {
        "created_at": "2023-02-14T11:08:31+00:00",
        "updated_at": "2023-02-14T11:08:31+00:00",
...
```json
  ...
  "data": [
    {
      "id": "d0153976-cac6-4526-b03d-1e4dece3ab26",
      "type": "notification_subscriptions",
      "attributes": {
        "created_at": "2023-02-14T11:08:32+00:00",
        "updated_at": "2023-02-14T11:08:32+00:00",
        "category": "order_updated",
        "global": false,
        "owner_id": "7ed7f588-4bbd-49cd-8e4f-d10aa15d1133",
        "owner_type": "orders"
      },
      "relationships": {
        "owner": {
          "links": {
            "related": "api/boomerang/orders/7ed7f588-4bbd-49cd-8e4f-d10aa15d1133"
          }
        }
      }
    }
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/notification_subscriptions/406ddbbd-aa2c-407a-9d6f-7aa9058ed979' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "406ddbbd-aa2c-407a-9d6f-7aa9058ed979",
    "type": "notification_subscriptions",
    "attributes": {
      ...
      "category": "order_updated",
      "global": false,
      "owner_id": "efd6c8b3-f0c2-452a-ae7a-b91f7801c811",
      "owner_type": "orders"
    },
    "relationships": {
      "owner": {
        "links": {
          "related": "api/boomerang/orders/efd6c8b3-f0c2-452a-ae7a-b91f7801c811"
        }
      }
    }
  },
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "category": "order_updated",
          "owner_id": "d8c86150-81b1-4e5b-bcbb-ac2d9521b9d3",
          "owner_type": "orders"
        }
      }
    }'
...
```json
  {
  "data": {
    "id": "1f588a06-bae2-4b94-aa1c-f5996b6f30ac",
    "type": "notification_subscriptions",
    "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/notification_subscriptions/6e0daf4d-c738-4ac7-bbfa-eb102332c2a5' \
    --header 'content-type: application/json' \
```
