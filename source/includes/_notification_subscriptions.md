...
```json
  ...
  "data": [
    {
      "id": "5ef23435-3595-47fd-9801-b3948b8ad748",
      "type": "notification_subscriptions",
      "attributes": {
        "created_at": "2023-02-09T09:29:01+00:00",
        "updated_at": "2023-02-09T09:29:01+00:00",
    ...
    {
      "id": "fc6e7269-54d2-453f-badc-378f87cf9ec7",
      "type": "notification_subscriptions",
      "attributes": {
        "created_at": "2023-02-09T09:29:01+00:00",
        "updated_at": "2023-02-09T09:29:01+00:00",
        ...
        "global": false,
        "owner_id": "400f2ba6-465e-4fb5-b9c2-45947a3e90f1",
        "owner_type": "orders"
      },
      "relationships": {
        "owner": {
          "links": {
            "related": "api/boomerang/orders/400f2ba6-465e-4fb5-b9c2-45947a3e90f1"
          }
        }
      }
    },
    {
      "id": "ad1e150c-9d54-431f-8e03-ce76333e4843",
      "type": "notification_subscriptions",
      "attributes": {
        "created_at": "2023-02-09T09:29:01+00:00",
        "updated_at": "2023-02-09T09:29:01+00:00",
    ...
    {
      "id": "1ab85560-3fc4-4d7f-a4d7-8c25f68a0615",
      "type": "notification_subscriptions",
      "attributes": {
        "created_at": "2023-02-09T09:29:01+00:00",
        "updated_at": "2023-02-09T09:29:01+00:00",
...
```json
  ...
  "data": [
    {
      "id": "c40e93bb-b3ab-4420-a7b2-7e4868e11feb",
      "type": "notification_subscriptions",
      "attributes": {
        "created_at": "2023-02-09T09:29:02+00:00",
        "updated_at": "2023-02-09T09:29:02+00:00",
        "category": "order_started",
        "global": true,
        "owner_id": null,
        "owner_type": null
    ...
    {
      "id": "af7a9da9-3560-4407-b556-138f3c843995",
      "type": "notification_subscriptions",
      "attributes": {
        "created_at": "2023-02-09T09:29:02+00:00",
        "updated_at": "2023-02-09T09:29:02+00:00",
    ...
    {
      "id": "a13cf5a1-e015-4d54-931c-3ce98f6cf5f5",
      "type": "notification_subscriptions",
      "attributes": {
        "created_at": "2023-02-09T09:29:02+00:00",
        "updated_at": "2023-02-09T09:29:02+00:00",
...
```json
  ...
  "data": [
    {
      "id": "ac004d58-8fd7-4962-bd6a-b9c90a2984bb",
      "type": "notification_subscriptions",
      "attributes": {
        "created_at": "2023-02-09T09:29:04+00:00",
        "updated_at": "2023-02-09T09:29:04+00:00",
        "category": "order_updated",
        "global": false,
        "owner_id": "1d71eeab-5eb0-410b-b360-afe3907eb531",
        "owner_type": "orders"
      },
      "relationships": {
        "owner": {
          "links": {
            "related": "api/boomerang/orders/1d71eeab-5eb0-410b-b360-afe3907eb531"
          }
        }
      }
    }
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/notification_subscriptions/f2abd57a-7b3c-44b1-a288-3c3ebaeaba56' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "f2abd57a-7b3c-44b1-a288-3c3ebaeaba56",
    "type": "notification_subscriptions",
    "attributes": {
      "created_at": "2023-02-09T09:29:06+00:00",
      "updated_at": "2023-02-09T09:29:06+00:00",
      "category": "order_updated",
      "global": false,
      "owner_id": "c8aae658-ff4a-4ef9-8a86-513018a0dcb1",
      "owner_type": "orders"
    },
    "relationships": {
      "owner": {
        "links": {
          "related": "api/boomerang/orders/c8aae658-ff4a-4ef9-8a86-513018a0dcb1"
        }
      }
    }
  },
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "category": "order_updated",
          "owner_id": "04bd4597-63be-46c2-97e5-462b3c865b86",
          "owner_type": "orders"
        }
      }
    }'
...
```json
  {
  "data": {
    "id": "ea89780b-60d1-4223-aa89-1ac156adcacc",
    "type": "notification_subscriptions",
    "attributes": {
      "created_at": "2023-02-09T09:29:06+00:00",
      "updated_at": "2023-02-09T09:29:06+00:00",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/notification_subscriptions/0d5960b3-ea4c-496c-82c6-e5f8adabeef1' \
    --header 'content-type: application/json' \
```
