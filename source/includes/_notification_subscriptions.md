...
```json
  ...
  "data": [
    {
      "id": "c52eeaf0-7451-46e5-8520-1fb6cf7d89a0",
      "type": "notification_subscriptions",
      "attributes": {
        "created_at": "2023-02-22T14:14:20+00:00",
        "updated_at": "2023-02-22T14:14:20+00:00",
    ...
    {
      "id": "4090ac31-4173-484f-8bed-cf6fa88c60ba",
      "type": "notification_subscriptions",
      "attributes": {
        "created_at": "2023-02-22T14:14:20+00:00",
        "updated_at": "2023-02-22T14:14:20+00:00",
        ...
        "global": false,
        "owner_id": "b4ba388c-a923-40bb-8c8f-7a4fdb0a6094",
        "owner_type": "orders"
      },
      "relationships": {
        "owner": {
          "links": {
            "related": "api/boomerang/orders/b4ba388c-a923-40bb-8c8f-7a4fdb0a6094"
          }
        }
      }
    },
    {
      "id": "85c77d75-1c43-44db-84e6-51eccf0a9c77",
      "type": "notification_subscriptions",
      "attributes": {
        "created_at": "2023-02-22T14:14:20+00:00",
        "updated_at": "2023-02-22T14:14:20+00:00",
    ...
    {
      "id": "5b0711d9-c55d-4b9c-bf76-6327705019af",
      "type": "notification_subscriptions",
      "attributes": {
        "created_at": "2023-02-22T14:14:20+00:00",
        "updated_at": "2023-02-22T14:14:20+00:00",
...
```json
  ...
  "data": [
    {
      "id": "75c4cf24-a655-4887-b0c8-a6ce57731fd0",
      "type": "notification_subscriptions",
      "attributes": {
        "created_at": "2023-02-22T14:14:21+00:00",
        "updated_at": "2023-02-22T14:14:21+00:00",
        "category": "order_started",
        "global": true,
        "owner_id": null,
        "owner_type": null
    ...
    {
      "id": "abe22840-d298-4193-b21f-462e7e1ec7c9",
      "type": "notification_subscriptions",
      "attributes": {
        "created_at": "2023-02-22T14:14:21+00:00",
        "updated_at": "2023-02-22T14:14:21+00:00",
    ...
    {
      "id": "b00a1fd5-3ce3-48aa-be53-9616f0b6c3e8",
      "type": "notification_subscriptions",
      "attributes": {
        "created_at": "2023-02-22T14:14:21+00:00",
        "updated_at": "2023-02-22T14:14:21+00:00",
...
```json
  ...
  "data": [
    {
      "id": "bcf1b526-48ba-488e-9a5d-d28fbac4abce",
      "type": "notification_subscriptions",
      "attributes": {
        "created_at": "2023-02-22T14:14:21+00:00",
        "updated_at": "2023-02-22T14:14:21+00:00",
        "category": "order_updated",
        "global": false,
        "owner_id": "0fd9b75c-8ec8-4519-a3f0-f7c5e1086702",
        "owner_type": "orders"
      },
      "relationships": {
        "owner": {
          "links": {
            "related": "api/boomerang/orders/0fd9b75c-8ec8-4519-a3f0-f7c5e1086702"
          }
        }
      }
    }
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/notification_subscriptions/543428cc-1d71-4271-843b-813fd52678c3' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "543428cc-1d71-4271-843b-813fd52678c3",
    "type": "notification_subscriptions",
    "attributes": {
      "created_at": "2023-02-22T14:14:22+00:00",
      "updated_at": "2023-02-22T14:14:22+00:00",
      "category": "order_updated",
      "global": false,
      "owner_id": "1684465d-982a-4e73-a832-7a5296a4572f",
      "owner_type": "orders"
    },
    "relationships": {
      "owner": {
        "links": {
          "related": "api/boomerang/orders/1684465d-982a-4e73-a832-7a5296a4572f"
        }
      }
    }
  },
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "category": "order_updated",
          "owner_id": "a6f26916-1203-4858-9799-22ee7f38fb7b",
          "owner_type": "orders"
        }
      }
    }'
...
```json
  {
  "data": {
    "id": "1ff54d43-a51a-4747-8997-0c99678e2750",
    "type": "notification_subscriptions",
    "attributes": {
      "created_at": "2023-02-22T14:14:23+00:00",
      "updated_at": "2023-02-22T14:14:23+00:00",
      "category": "order_updated",
      "global": false,
      "owner_id": "a6f26916-1203-4858-9799-22ee7f38fb7b",
      "owner_type": "orders"
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/notification_subscriptions/48b3e71f-e9cc-4e8c-b16b-f6508dabc355' \
    --header 'content-type: application/json' \
```
