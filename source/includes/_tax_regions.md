...
```json
  ...
  "data": [
    {
      "id": "c117c463-e7d1-4fd3-ba22-2efcc1ee3fcd",
      "created_at": "2023-02-21T16:18:11+00:00",
      "updated_at": "2023-02-21T16:18:11+00:00",
      "archived": false,
      "archived_at": null,
      "name": "Sales Tax",
      "strategy": "add_to",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/tax_regions/d3b709b9-871c-4b21-8d45-2d593b451d80?include=tax_rates' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "d3b709b9-871c-4b21-8d45-2d593b451d80",
    "created_at": "2023-02-21T16:18:11+00:00",
    "updated_at": "2023-02-21T16:18:11+00:00",
    "archived": false,
    "archived_at": null,
    ...
    "tax_rates": [
      {
        "id": "38ca39d6-6451-4a0b-8a96-546faba4245b",
        "created_at": "2023-02-21T16:18:11+00:00",
        "updated_at": "2023-02-21T16:18:11+00:00",
        "name": "VAT",
        "value": 21.0,
        "position": 1,
        "owner_id": "d3b709b9-871c-4b21-8d45-2d593b451d80",
...
```json
  {
  "data": {
    "id": "035530bf-819b-4e19-86f9-607e533c650b",
    "type": "tax_regions",
    "attributes": {
      "created_at": "2023-02-21T16:18:12+00:00",
      "updated_at": "2023-02-21T16:18:12+00:00",
      "archived": false,
      "archived_at": null,
      "name": "Sales Tax",
      "strategy": "compound",
    ...
    "relationships": {
      "tax_rates": {
        "data": [
          {
            "type": "tax_rates",
            "id": "db5fc0a4-18e5-4f81-b675-6c8c07bbe00e"
          }
        ]
      }
    }
  ...
  "included": [
    {
      ...
      "attributes": {
        ...
        "value": 21.0,
        "position": 1,
        "owner_id": "035530bf-819b-4e19-86f9-607e533c650b",
        "owner_type": "tax_regions"
      },
      "relationships": {
        "owner": {
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/tax_regions/795ed79b-bff2-4578-a034-fd596224ea27' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "795ed79b-bff2-4578-a034-fd596224ea27",
        "type": "tax_regions",
        "attributes": {
          "name": "State Tax",
          "tax_rates_attributes": [
            ...
            {
              "id": "68ece270-0879-440f-bad2-7af243267aca",
              "_destroy": true
            }
          ]
        }
    ...
    "relationships": {
      "tax_rates": {
        "data": [
          {
            "type": "tax_rates",
            "id": "8b59620d-48fe-4005-bb6e-8c736ae3e9ce"
          }
        ]
      }
    }
  ...
  "included": [
    {
      ...
      "attributes": {
        ...
        "value": 9.0,
        "position": 2,
        "owner_id": "795ed79b-bff2-4578-a034-fd596224ea27",
        "owner_type": "tax_regions"
      },
      "relationships": {
        "owner": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/tax_regions/30a173a3-76e6-4617-90ff-c7f1db07dcb5' \
    --header 'content-type: application/json' \
    --data '{}'
```
