...
```json
  ...
  "data": [
    {
      "id": "93b84860-9590-40e3-9dbe-c635574b2b80",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/tax_regions/6be61d4e-a1a5-4e3e-9df8-825d3eeab9a7?include=tax_rates' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "6be61d4e-a1a5-4e3e-9df8-825d3eeab9a7",
    "created_at": "2022-06-30T08:48:10+00:00",
    "updated_at": "2022-06-30T08:48:10+00:00",
    "archived": false,
    "archived_at": null,
    ...
    "tax_rates": [
      {
        "id": "56a829a2-1b60-4754-8da8-45de1b1f63de",
        "created_at": "2022-06-30T08:48:10+00:00",
        "updated_at": "2022-06-30T08:48:10+00:00",
        "name": "VAT",
        "value": 21.0,
        "position": 1,
        "owner_id": "6be61d4e-a1a5-4e3e-9df8-825d3eeab9a7",
...
```json
  {
  "data": {
    "id": "5a8b819a-f576-4182-9c4e-fc313af273d4",
    "type": "tax_regions",
    "attributes": {
      "created_at": "2022-06-30T08:48:11+00:00",
      "updated_at": "2022-06-30T08:48:11+00:00",
      "archived": false,
      "archived_at": null,
      "name": "Sales Tax",
      "strategy": "compound",
    ...
    "relationships": {
      "tax_rates": {
        "data": [
          {
            "type": "tax_rates",
            "id": "65ad3397-ebd6-400b-bb7f-94583936fa15"
          }
        ]
      }
    }
  ...
  "included": [
    {
      ...
      "attributes": {
        ...
        "value": 21.0,
        "position": 1,
        "owner_id": "5a8b819a-f576-4182-9c4e-fc313af273d4",
        "owner_type": "tax_regions"
      },
      "relationships": {
        "owner": {
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/tax_regions/137e9aca-180d-42ed-932a-eda7fe354dea' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "137e9aca-180d-42ed-932a-eda7fe354dea",
        "type": "tax_regions",
        "attributes": {
          "name": "State Tax",
          "tax_rates_attributes": [
            ...
            {
              "id": "3fa542cc-0ac3-4720-a22a-e85e0ad9b664",
              "_destroy": true
            }
          ]
        }
    ...
    "relationships": {
      "tax_rates": {
        "data": [
          {
            "type": "tax_rates",
            "id": "28137c33-feda-4d70-a477-7515f3639473"
          }
        ]
      }
    }
  ...
  "included": [
    {
      ...
      "attributes": {
        ...
        "value": 9.0,
        "position": 2,
        "owner_id": "137e9aca-180d-42ed-932a-eda7fe354dea",
        "owner_type": "tax_regions"
      },
      "relationships": {
        "owner": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/tax_regions/d883b0eb-bec2-411c-b952-d34dd0396021' \
    --header 'content-type: application/json' \
    --data '{}'
```
