...
```json
  ...
  "data": [
    {
      "id": "90103307-e8ad-4e32-9ca7-ca3fb9e3792f",
      "created_at": "2023-02-14T15:31:20+00:00",
      "updated_at": "2023-02-14T15:31:20+00:00",
      "archived": false,
      "archived_at": null,
      "name": "Sales Tax",
      "strategy": "add_to",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/tax_regions/527f8854-088e-4bbd-b64c-cf32250a1446?include=tax_rates' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "527f8854-088e-4bbd-b64c-cf32250a1446",
    "created_at": "2023-02-14T15:31:20+00:00",
    "updated_at": "2023-02-14T15:31:20+00:00",
    "archived": false,
    "archived_at": null,
    ...
    "tax_rates": [
      {
        "id": "938cced0-fab9-4b53-8f90-63c6819e2569",
        "created_at": "2023-02-14T15:31:20+00:00",
        "updated_at": "2023-02-14T15:31:20+00:00",
        "name": "VAT",
        "value": 21.0,
        "position": 1,
        "owner_id": "527f8854-088e-4bbd-b64c-cf32250a1446",
...
```json
  {
  "data": {
    "id": "0099d53c-9554-452a-a36e-e69211323168",
    "type": "tax_regions",
    "attributes": {
      "created_at": "2023-02-14T15:31:21+00:00",
      "updated_at": "2023-02-14T15:31:21+00:00",
      "archived": false,
      "archived_at": null,
      "name": "Sales Tax",
      "strategy": "compound",
    ...
    "relationships": {
      "tax_rates": {
        "data": [
          {
            "type": "tax_rates",
            "id": "e56dbbf8-bccb-4d5a-9949-bdfdb442c6b3"
          }
        ]
      }
    }
  ...
  "included": [
    {
      ...
      "attributes": {
        ...
        "value": 21.0,
        "position": 1,
        "owner_id": "0099d53c-9554-452a-a36e-e69211323168",
        "owner_type": "tax_regions"
      },
      "relationships": {
        "owner": {
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/tax_regions/9c8120ea-68e9-4f08-ade5-59af174b1e25' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "9c8120ea-68e9-4f08-ade5-59af174b1e25",
        "type": "tax_regions",
        "attributes": {
          "name": "State Tax",
          "tax_rates_attributes": [
            ...
            {
              "id": "fc80a08e-3795-475c-a347-ac4407561462",
              "_destroy": true
            }
          ]
        }
    ...
    "relationships": {
      "tax_rates": {
        "data": [
          {
            "type": "tax_rates",
            "id": "fbb543a5-c470-4677-a64d-38baf1184c8a"
          }
        ]
      }
    }
  ...
  "included": [
    {
      ...
      "attributes": {
        ...
        "value": 9.0,
        "position": 2,
        "owner_id": "9c8120ea-68e9-4f08-ade5-59af174b1e25",
        "owner_type": "tax_regions"
      },
      "relationships": {
        "owner": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/tax_regions/781342fc-ff0f-4a49-9a6c-c4b6e8ee6aab' \
    --header 'content-type: application/json' \
    --data '{}'
```
