...
```json
  ...
  "data": [
    {
      "id": "239af147-ab0a-47f8-9f9f-f87307efd756",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/tax_regions/331e3776-6838-46fe-a92f-4c9d5b0f8809?include=tax_rates' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "331e3776-6838-46fe-a92f-4c9d5b0f8809",
    "created_at": "2021-10-12T14:54:34+00:00",
    "updated_at": "2021-10-12T14:54:34+00:00",
    "name": "Sales Tax",
    "strategy": "add_to",
    ...
    "tax_rates": [
      {
        "id": "8a6ef7d4-c849-4908-be2d-79d8189bdc9c",
        "created_at": "2021-10-12T14:54:34+00:00",
        "updated_at": "2021-10-12T14:54:34+00:00",
        "name": "VAT",
        "value": 21.0,
        "position": 1,
        "owner_id": "331e3776-6838-46fe-a92f-4c9d5b0f8809",
...
```json
  {
  "data": {
    "id": "05d66156-fd3b-4027-aae2-ec2b3276bcc9",
    "type": "tax_regions",
    "attributes": {
      "created_at": "2021-10-12T14:54:35+00:00",
      "updated_at": "2021-10-12T14:54:35+00:00",
      "name": "Sales Tax",
      "strategy": "compound",
      "default": false
    },
    "relationships": {
      "tax_rates": {
        "data": [
          {
            "type": "tax_rates",
            "id": "96da4a80-3b3e-4845-ae4f-8a95a7a28499"
          }
        ]
      }
    }
  ...
  "included": [
    {
      ...
      "attributes": {
        ...
        "value": 21.0,
        "position": 1,
        "owner_id": "05d66156-fd3b-4027-aae2-ec2b3276bcc9",
        "owner_type": "TaxRegion"
      },
      "relationships": {
        "owner": {
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/tax_regions/12074c9b-0a2b-4654-808f-22add981c047' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "12074c9b-0a2b-4654-808f-22add981c047",
        "type": "tax_regions",
        "attributes": {
          "name": "State Tax",
          "tax_rates_attributes": [
            ...
            {
              "id": "295fb122-e5d3-4e9b-8d27-6f7110af4d67",
              "_destroy": true
            }
          ]
        }
    ...
    "relationships": {
      "tax_rates": {
        "data": [
          {
            "type": "tax_rates",
            "id": "0790ef2e-4e17-41d0-81d4-0f677d798e5c"
          }
        ]
      }
    }
  ...
  "included": [
    {
      ...
      "attributes": {
        ...
        "value": 9.0,
        "position": 2,
        "owner_id": "12074c9b-0a2b-4654-808f-22add981c047",
        "owner_type": "TaxRegion"
      },
      "relationships": {
        "owner": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/tax_regions/28bc94cd-01eb-4475-9db3-a83c28118a4b' \
    --header 'content-type: application/json' \
    --data '{}'
```
