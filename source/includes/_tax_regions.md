...
```json
  ...
  "data": [
    {
      "id": "fff8d84a-227e-4f42-800b-ec5091386cc9",
      "created_at": "2023-02-16T23:16:07+00:00",
      "updated_at": "2023-02-16T23:16:07+00:00",
      "archived": false,
      "archived_at": null,
      "name": "Sales Tax",
      "strategy": "add_to",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/tax_regions/e6f290b0-42e3-49bc-9d3e-5b0864f590bf?include=tax_rates' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "e6f290b0-42e3-49bc-9d3e-5b0864f590bf",
    "created_at": "2023-02-16T23:16:07+00:00",
    "updated_at": "2023-02-16T23:16:07+00:00",
    "archived": false,
    "archived_at": null,
    ...
    "tax_rates": [
      {
        "id": "464c3b8a-e7e7-4d95-ab47-0f395cd48cf9",
        "created_at": "2023-02-16T23:16:07+00:00",
        "updated_at": "2023-02-16T23:16:07+00:00",
        "name": "VAT",
        "value": 21.0,
        "position": 1,
        "owner_id": "e6f290b0-42e3-49bc-9d3e-5b0864f590bf",
...
```json
  {
  "data": {
    "id": "87422806-5b97-4fd4-b78a-a54af57c2e4e",
    "type": "tax_regions",
    "attributes": {
      "created_at": "2023-02-16T23:16:08+00:00",
      "updated_at": "2023-02-16T23:16:08+00:00",
      "archived": false,
      "archived_at": null,
      "name": "Sales Tax",
      "strategy": "compound",
    ...
    "relationships": {
      "tax_rates": {
        "data": [
          {
            "type": "tax_rates",
            "id": "f44fa869-2aad-4c53-947e-6e4fa9b976b9"
          }
        ]
      }
    }
  ...
  "included": [
    {
      ...
      "attributes": {
        ...
        "value": 21.0,
        "position": 1,
        "owner_id": "87422806-5b97-4fd4-b78a-a54af57c2e4e",
        "owner_type": "tax_regions"
      },
      "relationships": {
        "owner": {
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/tax_regions/c57a8509-2985-474c-827c-9fb9a5d9babe' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "c57a8509-2985-474c-827c-9fb9a5d9babe",
        "type": "tax_regions",
        "attributes": {
          "name": "State Tax",
          "tax_rates_attributes": [
            ...
            {
              "id": "8335fb6b-b121-4dcf-87ef-2689916ba07b",
              "_destroy": true
            }
          ]
        }
    ...
    "relationships": {
      "tax_rates": {
        "data": [
          {
            "type": "tax_rates",
            "id": "7d6ab479-40ca-4a35-8106-3654f6aad3f7"
          }
        ]
      }
    }
  ...
  "included": [
    {
      ...
      "attributes": {
        ...
        "value": 9.0,
        "position": 2,
        "owner_id": "c57a8509-2985-474c-827c-9fb9a5d9babe",
        "owner_type": "tax_regions"
      },
      "relationships": {
        "owner": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/tax_regions/281e1510-3605-46da-bcda-6764005819d1' \
    --header 'content-type: application/json' \
    --data '{}'
```
