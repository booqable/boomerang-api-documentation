...
```json
  ...
  "data": [
    {
      "id": "a5121d46-65a6-4ab3-b669-5b0f177135ad",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/tax_regions/ec2d588d-369d-4e77-8997-bcd702618720?include=tax_rates' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "ec2d588d-369d-4e77-8997-bcd702618720",
    ...
    "tax_rates": [
      {
        "id": "f45d8b2a-431c-447f-af9a-778acf89bce6",
        "created_at": "2023-02-14T11:07:58+00:00",
        "updated_at": "2023-02-14T11:07:58+00:00",
        "name": "VAT",
        "value": 21.0,
        "position": 1,
        "owner_id": "ec2d588d-369d-4e77-8997-bcd702618720",
...
```json
  {
  "data": {
    "id": "ed6d0449-9412-439e-8060-a8b169960c54",
    "type": "tax_regions",
    "attributes": {
      "created_at": "2023-02-14T11:07:58+00:00",
      "updated_at": "2023-02-14T11:07:58+00:00",
    ...
    "relationships": {
      "tax_rates": {
        "data": [
          {
            "type": "tax_rates",
            "id": "ff77dd99-571a-492c-a3de-a899e3ced342"
          }
        ]
      }
    }
  ...
  "included": [
    {
      ...
      "attributes": {
        ...
        "value": 21.0,
        "position": 1,
        "owner_id": "ed6d0449-9412-439e-8060-a8b169960c54",
        "owner_type": "tax_regions"
      },
      "relationships": {
        "owner": {
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/tax_regions/82e23f42-f593-4a4c-a90f-939eb1f7f69d' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "82e23f42-f593-4a4c-a90f-939eb1f7f69d",
        "type": "tax_regions",
        "attributes": {
          "name": "State Tax",
          "tax_rates_attributes": [
            ...
            {
              "id": "e8589ec1-4433-4ab3-a2fa-4c5eec9a04c4",
              "_destroy": true
            }
          ]
        }
    ...
    "relationships": {
      "tax_rates": {
        "data": [
          {
            "type": "tax_rates",
            "id": "0c9ac757-cf75-492b-91d2-1ce552895d39"
          }
        ]
      }
    }
  ...
  "included": [
    {
      ...
      "attributes": {
        ...
        "value": 9.0,
        "position": 2,
        "owner_id": "82e23f42-f593-4a4c-a90f-939eb1f7f69d",
        "owner_type": "tax_regions"
      },
      "relationships": {
        "owner": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/tax_regions/1b0439d6-a771-486c-bc71-f7b200be8241' \
    --header 'content-type: application/json' \
    --data '{}'
```
