...
```json
  ...
  "data": [
    {
      "id": "59b4240e-39a2-42f2-9ad4-2f74a8367aca",
      "created_at": "2023-01-26T08:12:23+00:00",
      "updated_at": "2023-01-26T08:12:23+00:00",
      "archived": false,
      "archived_at": null,
      "name": "Sales Tax",
      "strategy": "add_to",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/tax_regions/6a58018e-813b-4fb0-99bf-700297ae140b?include=tax_rates' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "6a58018e-813b-4fb0-99bf-700297ae140b",
    "created_at": "2023-01-26T08:12:23+00:00",
    "updated_at": "2023-01-26T08:12:23+00:00",
    "archived": false,
    "archived_at": null,
    ...
    "tax_rates": [
      {
        "id": "4d684f4e-3f0b-4cc9-9790-0aae2d9d51e7",
        "created_at": "2023-01-26T08:12:23+00:00",
        "updated_at": "2023-01-26T08:12:23+00:00",
        "name": "VAT",
        "value": 21.0,
        "position": 1,
        "owner_id": "6a58018e-813b-4fb0-99bf-700297ae140b",
...
```json
  {
  "data": {
    "id": "19f723a2-5f23-4e46-af77-35156a9402f8",
    "type": "tax_regions",
    "attributes": {
      "created_at": "2023-01-26T08:12:24+00:00",
      "updated_at": "2023-01-26T08:12:24+00:00",
      "archived": false,
      "archived_at": null,
      "name": "Sales Tax",
      "strategy": "compound",
    ...
    "relationships": {
      "tax_rates": {
        "data": [
          {
            "type": "tax_rates",
            "id": "973a4247-0413-49ae-ab27-458e20556e74"
          }
        ]
      }
    }
  ...
  "included": [
    {
      ...
      "attributes": {
        ...
        "value": 21.0,
        "position": 1,
        "owner_id": "19f723a2-5f23-4e46-af77-35156a9402f8",
        "owner_type": "tax_regions"
      },
      "relationships": {
        "owner": {
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/tax_regions/c308bc89-f1b8-4c09-9f26-24d31638f522' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "c308bc89-f1b8-4c09-9f26-24d31638f522",
        "type": "tax_regions",
        "attributes": {
          "name": "State Tax",
          "tax_rates_attributes": [
            ...
            {
              "id": "165333cc-947f-4423-affd-b320db60244b",
              "_destroy": true
            }
          ]
        }
    ...
    "relationships": {
      "tax_rates": {
        "data": [
          {
            "type": "tax_rates",
            "id": "cfdc4dda-b6a2-4c16-a85a-449e2d9fab3e"
          }
        ]
      }
    }
  ...
  "included": [
    {
      ...
      "attributes": {
        ...
        "value": 9.0,
        "position": 2,
        "owner_id": "c308bc89-f1b8-4c09-9f26-24d31638f522",
        "owner_type": "tax_regions"
      },
      "relationships": {
        "owner": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/tax_regions/50ffbefb-3b6e-4729-92f4-18db8581cc20' \
    --header 'content-type: application/json' \
    --data '{}'
```
