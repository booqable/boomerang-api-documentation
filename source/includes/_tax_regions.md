...
```json
  ...
  "data": [
    {
      "id": "c6927800-1eb9-4df9-b225-b2bbf8222f74",
      "created_at": "2022-06-30T09:47:15+00:00",
      "updated_at": "2022-06-30T09:47:15+00:00",
      "archived": false,
      "archived_at": null,
      "name": "Sales Tax",
      "strategy": "add_to",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/tax_regions/6418f151-1fd3-4e2c-a838-379a6a404a6b?include=tax_rates' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "6418f151-1fd3-4e2c-a838-379a6a404a6b",
    "created_at": "2022-06-30T09:47:15+00:00",
    "updated_at": "2022-06-30T09:47:15+00:00",
    "archived": false,
    "archived_at": null,
    ...
    "tax_rates": [
      {
        "id": "752e8628-cf08-416e-9730-00110c0f665b",
        "created_at": "2022-06-30T09:47:15+00:00",
        "updated_at": "2022-06-30T09:47:15+00:00",
        "name": "VAT",
        "value": 21.0,
        "position": 1,
        "owner_id": "6418f151-1fd3-4e2c-a838-379a6a404a6b",
...
```json
  {
  "data": {
    "id": "e3b57bd0-40bf-4875-b6ff-927704139712",
    "type": "tax_regions",
    "attributes": {
      "created_at": "2022-06-30T09:47:16+00:00",
      "updated_at": "2022-06-30T09:47:16+00:00",
      "archived": false,
      "archived_at": null,
      "name": "Sales Tax",
      "strategy": "compound",
    ...
    "relationships": {
      "tax_rates": {
        "data": [
          {
            "type": "tax_rates",
            "id": "6b4c4dfb-d120-4e21-8d6c-9e10e51db8cc"
          }
        ]
      }
    }
  ...
  "included": [
    {
      ...
      "attributes": {
        ...
        "value": 21.0,
        "position": 1,
        "owner_id": "e3b57bd0-40bf-4875-b6ff-927704139712",
        "owner_type": "tax_regions"
      },
      "relationships": {
        "owner": {
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/tax_regions/efc423c7-35f8-4227-afd1-db4fabb8dc2c' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "efc423c7-35f8-4227-afd1-db4fabb8dc2c",
        "type": "tax_regions",
        "attributes": {
          "name": "State Tax",
          "tax_rates_attributes": [
            ...
            {
              "id": "b69f116a-f784-44c5-99fb-4d9ec931f187",
              "_destroy": true
            }
          ]
        }
    ...
    "relationships": {
      "tax_rates": {
        "data": [
          {
            "type": "tax_rates",
            "id": "ce94aa86-4a95-4403-bb22-0c343c378ba9"
          }
        ]
      }
    }
  ...
  "included": [
    {
      ...
      "attributes": {
        ...
        "value": 9.0,
        "position": 2,
        "owner_id": "efc423c7-35f8-4227-afd1-db4fabb8dc2c",
        "owner_type": "tax_regions"
      },
      "relationships": {
        "owner": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/tax_regions/04d3c303-aa6a-4508-82cb-da1668149701' \
    --header 'content-type: application/json' \
    --data '{}'
```
