...
```json
  ...
  "data": [
    {
      "id": "a4731aad-b43b-46ab-8ecf-f2a3b5c06911",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/tax_regions/a6ff4b9a-da9e-4083-979c-54134bacae06?include=tax_rates' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "a6ff4b9a-da9e-4083-979c-54134bacae06",
    "created_at": "2023-02-02T11:19:14+00:00",
    "updated_at": "2023-02-02T11:19:14+00:00",
    "archived": false,
    "archived_at": null,
    "name": "Sales Tax",
    "strategy": "add_to",
    ...
    "tax_rates": [
      {
        "id": "ed151e54-2919-445d-aa6d-4763ff8d7737",
        "created_at": "2023-02-02T11:19:14+00:00",
        "updated_at": "2023-02-02T11:19:14+00:00",
        "name": "VAT",
        "value": 21.0,
        "position": 1,
        "owner_id": "a6ff4b9a-da9e-4083-979c-54134bacae06",
...
```json
  {
  "data": {
    "id": "2c441b6a-2af4-4496-b9ef-5c44c5dc8298",
    "type": "tax_regions",
    "attributes": {
      "created_at": "2023-02-02T11:19:14+00:00",
      "updated_at": "2023-02-02T11:19:14+00:00",
    ...
    "relationships": {
      "tax_rates": {
        "data": [
          {
            "type": "tax_rates",
            "id": "8e86e354-18f1-42ed-a68e-fccd57485b23"
          }
        ]
      }
    }
  ...
  "included": [
    {
      ...
      "attributes": {
        ...
        "value": 21.0,
        "position": 1,
        "owner_id": "2c441b6a-2af4-4496-b9ef-5c44c5dc8298",
        "owner_type": "tax_regions"
      },
      "relationships": {
        "owner": {
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/tax_regions/204ecfd0-f20f-4c4b-be04-6c80f4e1ad02' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "204ecfd0-f20f-4c4b-be04-6c80f4e1ad02",
        "type": "tax_regions",
        "attributes": {
          "name": "State Tax",
          "tax_rates_attributes": [
            ...
            {
              "id": "a1313655-37ac-4eec-be04-445b92030ff1",
              "_destroy": true
            }
          ]
        }
...
```json
  ...
  "data": {
    ...
    "attributes": {
      "created_at": "2023-02-02T11:19:14+00:00",
      "updated_at": "2023-02-02T11:19:15+00:00",
      "archived": false,
      "archived_at": null,
      "name": "State Tax",
      "strategy": "add_to",
    ...
    "relationships": {
      "tax_rates": {
        "data": [
          {
            "type": "tax_rates",
            "id": "3f93645a-2230-4b6d-8338-3e59d1a2390c"
          }
        ]
      }
    }
  ...
  "included": [
    {
      ...
      "type": "tax_rates",
      "attributes": {
        "created_at": "2023-02-02T11:19:15+00:00",
        "updated_at": "2023-02-02T11:19:15+00:00",
        "name": "VAT",
        "value": 9.0,
        "position": 2,
        "owner_id": "204ecfd0-f20f-4c4b-be04-6c80f4e1ad02",
        "owner_type": "tax_regions"
      },
      "relationships": {
        "owner": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/tax_regions/2b00d048-f795-406e-a8c8-ca52f1356a5b' \
    --header 'content-type: application/json' \
    --data '{}'
```
