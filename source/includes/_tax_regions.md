...
```json
  ...
  "data": [
    {
      "id": "dbbaf109-4b4f-4b6c-ae7b-4c149f03c05a",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/tax_regions/9875566e-7e4d-48e8-8971-8559b4535dee?include=tax_rates' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "9875566e-7e4d-48e8-8971-8559b4535dee",
    "created_at": "2022-07-08T13:13:06+00:00",
    "updated_at": "2022-07-08T13:13:06+00:00",
    "archived": false,
    "archived_at": null,
    "name": "Sales Tax",
    "strategy": "add_to",
    ...
    "tax_rates": [
      {
        "id": "3e87dad2-adac-454b-87f6-b04d3cacd2ee",
        "created_at": "2022-07-08T13:13:06+00:00",
        "updated_at": "2022-07-08T13:13:06+00:00",
        "name": "VAT",
        "value": 21.0,
        "position": 1,
        "owner_id": "9875566e-7e4d-48e8-8971-8559b4535dee",
...
```json
  {
  "data": {
    "id": "ede23b6e-08f3-4284-b074-55600cdc06c9",
    "type": "tax_regions",
    "attributes": {
      "created_at": "2022-07-08T13:13:06+00:00",
      "updated_at": "2022-07-08T13:13:06+00:00",
    ...
    "relationships": {
      "tax_rates": {
        "data": [
          {
            "type": "tax_rates",
            "id": "08dc24b6-9bce-4e01-9768-5c913df2fe9c"
          }
        ]
      }
    }
  ...
  "included": [
    {
      ...
      "attributes": {
        ...
        "value": 21.0,
        "position": 1,
        "owner_id": "ede23b6e-08f3-4284-b074-55600cdc06c9",
        "owner_type": "tax_regions"
      },
      "relationships": {
        "owner": {
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/tax_regions/de332ceb-933a-47ef-9091-786dd4d21e91' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "de332ceb-933a-47ef-9091-786dd4d21e91",
        "type": "tax_regions",
        "attributes": {
          "name": "State Tax",
          "tax_rates_attributes": [
            ...
            {
              "id": "12d2d51d-859c-4d3c-a94e-939fcf6a197a",
              "_destroy": true
            }
          ]
        }
    ...
    "relationships": {
      "tax_rates": {
        "data": [
          {
            "type": "tax_rates",
            "id": "1331b680-b62b-413f-9f25-742f64c1cc8c"
          }
        ]
      }
    }
  ...
  "included": [
    {
      ...
      "attributes": {
        ...
        "value": 9.0,
        "position": 2,
        "owner_id": "de332ceb-933a-47ef-9091-786dd4d21e91",
        "owner_type": "tax_regions"
      },
      "relationships": {
        "owner": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/tax_regions/87dbe424-473e-4e9a-9504-8230db9328ae' \
    --header 'content-type: application/json' \
    --data '{}'
```
