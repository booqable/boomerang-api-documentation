...
```json
  ...
  "data": [
    {
      "id": "97e78fca-0a38-41d3-be6f-0685e4b67694",
      "created_at": "2022-11-22T14:36:35+00:00",
      "updated_at": "2022-11-22T14:36:35+00:00",
      "archived": false,
      "archived_at": null,
      "name": "Sales Tax",
      "strategy": "add_to",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/tax_regions/0220c264-bcfb-437c-b156-a78e549efd4c?include=tax_rates' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "0220c264-bcfb-437c-b156-a78e549efd4c",
    "created_at": "2022-11-22T14:36:35+00:00",
    "updated_at": "2022-11-22T14:36:35+00:00",
    "archived": false,
    "archived_at": null,
    ...
    "tax_rates": [
      {
        "id": "47f54270-fd12-4da0-a2de-ba70c54f29b8",
        "created_at": "2022-11-22T14:36:35+00:00",
        "updated_at": "2022-11-22T14:36:35+00:00",
        "name": "VAT",
        "value": 21.0,
        "position": 1,
        "owner_id": "0220c264-bcfb-437c-b156-a78e549efd4c",
...
```json
  {
  "data": {
    "id": "60af9c05-cada-42c3-b21b-864074c96a80",
    "type": "tax_regions",
    "attributes": {
      "created_at": "2022-11-22T14:36:36+00:00",
      "updated_at": "2022-11-22T14:36:36+00:00",
      "archived": false,
      "archived_at": null,
      "name": "Sales Tax",
      "strategy": "compound",
    ...
    "relationships": {
      "tax_rates": {
        "data": [
          {
            "type": "tax_rates",
            "id": "d4d2a5f4-b2d8-485e-99e1-e85a59f715f3"
          }
        ]
      }
    }
  ...
  "included": [
    {
      ...
      "attributes": {
        ...
        "value": 21.0,
        "position": 1,
        "owner_id": "60af9c05-cada-42c3-b21b-864074c96a80",
        "owner_type": "tax_regions"
      },
      "relationships": {
        "owner": {
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/tax_regions/a3a37351-6257-4f0e-b4bb-c0be0d6c2ffa' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "a3a37351-6257-4f0e-b4bb-c0be0d6c2ffa",
        "type": "tax_regions",
        "attributes": {
          "name": "State Tax",
          "tax_rates_attributes": [
            ...
            {
              "id": "cb05ae75-d416-4bed-b846-dd009689ff62",
              "_destroy": true
            }
          ]
        }
    ...
    "relationships": {
      "tax_rates": {
        "data": [
          {
            "type": "tax_rates",
            "id": "e33c6e31-b8a3-4489-bef3-a71d0eea8d2b"
          }
        ]
      }
    }
  ...
  "included": [
    {
      ...
      "attributes": {
        ...
        "value": 9.0,
        "position": 2,
        "owner_id": "a3a37351-6257-4f0e-b4bb-c0be0d6c2ffa",
        "owner_type": "tax_regions"
      },
      "relationships": {
        "owner": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/tax_regions/48356aa4-ef79-41d2-adb5-f3043e60460f' \
    --header 'content-type: application/json' \
    --data '{}'
```
