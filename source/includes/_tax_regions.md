...
```json
  ...
  "data": [
    {
      "id": "bda3663f-7207-4ad2-bc67-6f45249e8838",
      "created_at": "2023-02-08T08:39:49+00:00",
      "updated_at": "2023-02-08T08:39:49+00:00",
      "archived": false,
      "archived_at": null,
      "name": "Sales Tax",
      "strategy": "add_to",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/tax_regions/5a7cdb46-451b-4d81-a636-b55e6cc18c52?include=tax_rates' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "5a7cdb46-451b-4d81-a636-b55e6cc18c52",
    "created_at": "2023-02-08T08:39:50+00:00",
    "updated_at": "2023-02-08T08:39:50+00:00",
    "archived": false,
    "archived_at": null,
    "name": "Sales Tax",
    "strategy": "add_to",
    ...
    "tax_rates": [
      {
        "id": "f76855af-b049-4760-bfa9-7ee72e843aea",
        "created_at": "2023-02-08T08:39:50+00:00",
        "updated_at": "2023-02-08T08:39:50+00:00",
        "name": "VAT",
        "value": 21.0,
        "position": 1,
        "owner_id": "5a7cdb46-451b-4d81-a636-b55e6cc18c52",
...
```json
  {
  "data": {
    "id": "cf343f70-e61e-4440-b9b9-521ea8826c5c",
    "type": "tax_regions",
    "attributes": {
      "created_at": "2023-02-08T08:39:51+00:00",
      "updated_at": "2023-02-08T08:39:51+00:00",
      "archived": false,
      "archived_at": null,
      "name": "Sales Tax",
      "strategy": "compound",
    ...
    "relationships": {
      "tax_rates": {
        "data": [
          {
            "type": "tax_rates",
            "id": "db33c850-85cd-4b01-b6a6-1da5730d9aae"
          }
        ]
      }
    }
  ...
  "included": [
    {
      ...
      "attributes": {
        ...
        "value": 21.0,
        "position": 1,
        "owner_id": "cf343f70-e61e-4440-b9b9-521ea8826c5c",
        "owner_type": "tax_regions"
      },
      "relationships": {
        "owner": {
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/tax_regions/27e46978-958f-4b83-ac09-17d013acac5e' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "27e46978-958f-4b83-ac09-17d013acac5e",
        "type": "tax_regions",
        "attributes": {
          "name": "State Tax",
          "tax_rates_attributes": [
            ...
            {
              "id": "033ae282-3b82-465e-8516-a95cc97ac8f6",
              "_destroy": true
            }
          ]
        }
    ...
    "relationships": {
      "tax_rates": {
        "data": [
          {
            "type": "tax_rates",
            "id": "0c1f111f-d4fc-45f3-a865-34697c0813dc"
          }
        ]
      }
    }
  ...
  "included": [
    {
      ...
      "attributes": {
        ...
        "value": 9.0,
        "position": 2,
        "owner_id": "27e46978-958f-4b83-ac09-17d013acac5e",
        "owner_type": "tax_regions"
      },
      "relationships": {
        "owner": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/tax_regions/d1ae24d9-ba63-4126-aceb-6b0019066056' \
    --header 'content-type: application/json' \
    --data '{}'
```
