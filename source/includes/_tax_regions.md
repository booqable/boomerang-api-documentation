...
```json
  ...
  "data": [
    {
      "id": "6ce42d40-310b-407e-b906-c4c6dcb23c55",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/tax_regions/fcd9e488-dc28-4568-bff3-9b285c443c6a?include=tax_rates' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "fcd9e488-dc28-4568-bff3-9b285c443c6a",
    "created_at": "2022-04-04T13:23:28+00:00",
    "updated_at": "2022-04-04T13:23:28+00:00",
    "archived": false,
    "archived_at": null,
    "name": "Sales Tax",
    "strategy": "add_to",
    ...
    "tax_rates": [
      {
        "id": "499ad0a0-d37c-4e8d-9917-ca27c099a536",
        "created_at": "2022-04-04T13:23:28+00:00",
        "updated_at": "2022-04-04T13:23:28+00:00",
        "name": "VAT",
        "value": 21.0,
        "position": 1,
        "owner_id": "fcd9e488-dc28-4568-bff3-9b285c443c6a",
...
```json
  {
  "data": {
    "id": "edad0cfb-7ac1-4da6-997b-e3dd82062b4a",
    "type": "tax_regions",
    "attributes": {
      "created_at": "2022-04-04T13:23:28+00:00",
      "updated_at": "2022-04-04T13:23:28+00:00",
    ...
    "relationships": {
      "tax_rates": {
        "data": [
          {
            "type": "tax_rates",
            "id": "9695e199-1fc0-4b7e-8313-0be5a8868fe3"
          }
        ]
      }
    }
  ...
  "included": [
    {
      ...
      "attributes": {
        ...
        "value": 21.0,
        "position": 1,
        "owner_id": "edad0cfb-7ac1-4da6-997b-e3dd82062b4a",
        "owner_type": "tax_regions"
      },
      "relationships": {
        "owner": {
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/tax_regions/0efcbc28-e578-4a62-a02f-ab181d6bb417' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "0efcbc28-e578-4a62-a02f-ab181d6bb417",
        "type": "tax_regions",
        "attributes": {
          "name": "State Tax",
          "tax_rates_attributes": [
            ...
            {
              "id": "40e9bdbf-a210-4dfe-81c1-9b2f009d220d",
              "_destroy": true
            }
          ]
        }
    ...
    "relationships": {
      "tax_rates": {
        "data": [
          {
            "type": "tax_rates",
            "id": "fc022f1f-b08e-4791-98ef-4f1d9f6f957d"
          }
        ]
      }
    }
  ...
  "included": [
    {
      ...
      "attributes": {
        ...
        "value": 9.0,
        "position": 2,
        "owner_id": "0efcbc28-e578-4a62-a02f-ab181d6bb417",
        "owner_type": "tax_regions"
      },
      "relationships": {
        "owner": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/tax_regions/e69d6549-d0d4-4cad-986a-88361f58b636' \
    --header 'content-type: application/json' \
    --data '{}'
```
