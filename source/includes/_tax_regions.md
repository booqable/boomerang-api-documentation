...
```json
  ...
  "data": [
    {
      "id": "01e6a876-9c0d-424f-974d-f6ac34706ed2",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/tax_regions/9aa17916-e299-498a-a412-50b9016d3f6e?include=tax_rates' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "9aa17916-e299-498a-a412-50b9016d3f6e",
    "created_at": "2022-04-13T09:10:30+00:00",
    "updated_at": "2022-04-13T09:10:30+00:00",
    "archived": false,
    "archived_at": null,
    ...
    "tax_rates": [
      {
        "id": "9dda60ed-02b2-4fe8-bf3b-ba65da993967",
        "created_at": "2022-04-13T09:10:30+00:00",
        "updated_at": "2022-04-13T09:10:30+00:00",
        "name": "VAT",
        "value": 21.0,
        "position": 1,
        "owner_id": "9aa17916-e299-498a-a412-50b9016d3f6e",
...
```json
  {
  "data": {
    "id": "76872422-8fd3-421f-ae9d-1ee73fa5bf98",
    "type": "tax_regions",
    "attributes": {
      "created_at": "2022-04-13T09:10:31+00:00",
      "updated_at": "2022-04-13T09:10:31+00:00",
      "archived": false,
      "archived_at": null,
      "name": "Sales Tax",
      "strategy": "compound",
    ...
    "relationships": {
      "tax_rates": {
        "data": [
          {
            "type": "tax_rates",
            "id": "e2853601-9853-42c8-bca2-90b6f3adef4b"
          }
        ]
      }
    }
  ...
  "included": [
    {
      ...
      "attributes": {
        ...
        "value": 21.0,
        "position": 1,
        "owner_id": "76872422-8fd3-421f-ae9d-1ee73fa5bf98",
        "owner_type": "tax_regions"
      },
      "relationships": {
        "owner": {
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/tax_regions/e31b6226-ce0d-4c70-a614-99271bf4cdd7' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "e31b6226-ce0d-4c70-a614-99271bf4cdd7",
        "type": "tax_regions",
        "attributes": {
          "name": "State Tax",
          "tax_rates_attributes": [
            ...
            {
              "id": "017d56b1-8913-4b4e-be26-5bc8dc4ae0f8",
              "_destroy": true
            }
          ]
        }
    ...
    "relationships": {
      "tax_rates": {
        "data": [
          {
            "type": "tax_rates",
            "id": "4da02271-b529-4c3d-9fc8-815a5bfc2324"
          }
        ]
      }
    }
  ...
  "included": [
    {
      ...
      "attributes": {
        ...
        "value": 9.0,
        "position": 2,
        "owner_id": "e31b6226-ce0d-4c70-a614-99271bf4cdd7",
        "owner_type": "tax_regions"
      },
      "relationships": {
        "owner": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/tax_regions/5b5e97f8-0b14-4e14-9676-8bbfa32e78d1' \
    --header 'content-type: application/json' \
    --data '{}'
```
