...
```json
  ...
  "data": [
    {
      "id": "c31bee52-ec75-4776-a851-8fc9437e3e0d",
      "created_at": "2023-02-09T09:31:53+00:00",
      "updated_at": "2023-02-09T09:31:53+00:00",
      "archived": false,
      "archived_at": null,
      "name": "Sales Tax",
      "strategy": "add_to",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/tax_regions/f275d764-e67a-43ff-b6d3-db846f93e800?include=tax_rates' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "f275d764-e67a-43ff-b6d3-db846f93e800",
    "created_at": "2023-02-09T09:31:53+00:00",
    "updated_at": "2023-02-09T09:31:53+00:00",
    "archived": false,
    "archived_at": null,
    ...
    "tax_rates": [
      {
        "id": "e0309277-3ef7-40a2-8305-aecb8df05a9b",
        "created_at": "2023-02-09T09:31:53+00:00",
        "updated_at": "2023-02-09T09:31:53+00:00",
        "name": "VAT",
        "value": 21.0,
        "position": 1,
        "owner_id": "f275d764-e67a-43ff-b6d3-db846f93e800",
...
```json
  {
  "data": {
    "id": "f16e6bad-953a-4e2e-8a3e-2169ba35da87",
    "type": "tax_regions",
    "attributes": {
      "created_at": "2023-02-09T09:31:54+00:00",
      "updated_at": "2023-02-09T09:31:54+00:00",
      "archived": false,
      "archived_at": null,
      "name": "Sales Tax",
      "strategy": "compound",
    ...
    "relationships": {
      "tax_rates": {
        "data": [
          {
            "type": "tax_rates",
            "id": "437a215f-e7b7-4c6b-ab62-345e7fdbe160"
          }
        ]
      }
    }
  ...
  "included": [
    {
      ...
      "attributes": {
        ...
        "value": 21.0,
        "position": 1,
        "owner_id": "f16e6bad-953a-4e2e-8a3e-2169ba35da87",
        "owner_type": "tax_regions"
      },
      "relationships": {
        "owner": {
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/tax_regions/5b597b57-6bbb-474c-b531-f0f8987f6e88' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "5b597b57-6bbb-474c-b531-f0f8987f6e88",
        "type": "tax_regions",
        "attributes": {
          "name": "State Tax",
          "tax_rates_attributes": [
            ...
            {
              "id": "924adbce-9b72-4b3b-97b1-aa24850e6212",
              "_destroy": true
            }
          ]
        }
    ...
    "relationships": {
      "tax_rates": {
        "data": [
          {
            "type": "tax_rates",
            "id": "e3206ee6-1345-4f26-ac74-bf457aba7b95"
          }
        ]
      }
    }
  ...
  "included": [
    {
      ...
      "attributes": {
        ...
        "value": 9.0,
        "position": 2,
        "owner_id": "5b597b57-6bbb-474c-b531-f0f8987f6e88",
        "owner_type": "tax_regions"
      },
      "relationships": {
        "owner": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/tax_regions/5ebd736b-d89c-40d8-a4b8-27f7e3056350' \
    --header 'content-type: application/json' \
    --data '{}'
```
