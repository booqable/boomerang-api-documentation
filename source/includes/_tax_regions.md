...
```json
  ...
  "data": [
    {
      "id": "67f72e25-3aea-4500-b7d6-5f4d37959cf8",
      "created_at": "2023-02-01T13:03:43+00:00",
      "updated_at": "2023-02-01T13:03:43+00:00",
      "archived": false,
      "archived_at": null,
      "name": "Sales Tax",
      "strategy": "add_to",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/tax_regions/fc5a1d0f-fafa-4c83-9def-047a2393db3b?include=tax_rates' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "fc5a1d0f-fafa-4c83-9def-047a2393db3b",
    "created_at": "2023-02-01T13:03:43+00:00",
    "updated_at": "2023-02-01T13:03:43+00:00",
    "archived": false,
    "archived_at": null,
    ...
    "tax_rates": [
      {
        "id": "a8ffab6a-2a75-4c28-9842-7ec27bd319fd",
        "created_at": "2023-02-01T13:03:43+00:00",
        "updated_at": "2023-02-01T13:03:43+00:00",
        "name": "VAT",
        "value": 21.0,
        "position": 1,
        "owner_id": "fc5a1d0f-fafa-4c83-9def-047a2393db3b",
...
```json
  {
  "data": {
    "id": "20f6d013-071b-4975-9de8-a140c8dcfc14",
    "type": "tax_regions",
    "attributes": {
      "created_at": "2023-02-01T13:03:43+00:00",
      "updated_at": "2023-02-01T13:03:43+00:00",
    ...
    "relationships": {
      "tax_rates": {
        "data": [
          {
            "type": "tax_rates",
            "id": "7c62aabf-c685-4e37-909a-8694f38aba77"
          }
        ]
      }
    }
  ...
  "included": [
    {
      ...
      "attributes": {
        ...
        "value": 21.0,
        "position": 1,
        "owner_id": "20f6d013-071b-4975-9de8-a140c8dcfc14",
        "owner_type": "tax_regions"
      },
      "relationships": {
        "owner": {
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/tax_regions/18092ab2-0adf-45c8-8c98-a62c858b64d6' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "18092ab2-0adf-45c8-8c98-a62c858b64d6",
        "type": "tax_regions",
        "attributes": {
          "name": "State Tax",
          "tax_rates_attributes": [
            ...
            {
              "id": "b00c24ea-3442-403b-85c2-e05591f95c29",
              "_destroy": true
            }
          ]
        }
...
```json
  ...
  "data": {
    ...
    "type": "tax_regions",
    "attributes": {
      "created_at": "2023-02-01T13:03:44+00:00",
      "updated_at": "2023-02-01T13:03:44+00:00",
      "archived": false,
      "archived_at": null,
      "name": "State Tax",
      "strategy": "add_to",
    ...
    "relationships": {
      "tax_rates": {
        "data": [
          {
            "type": "tax_rates",
            "id": "687bc36f-0bc8-46f8-9db5-0f450add9b5d"
          }
        ]
      }
    }
  ...
  "included": [
    {
      ...
      "attributes": {
        ...
        "value": 9.0,
        "position": 2,
        "owner_id": "18092ab2-0adf-45c8-8c98-a62c858b64d6",
        "owner_type": "tax_regions"
      },
      "relationships": {
        "owner": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/tax_regions/277de679-994a-4364-b221-2468be561eff' \
    --header 'content-type: application/json' \
    --data '{}'
```
