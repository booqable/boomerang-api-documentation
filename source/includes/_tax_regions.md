...
```json
  ...
  "data": [
    {
      "id": "29c9c75a-c8c7-4268-9197-7bc2ffc9e920",
      "created_at": "2022-11-22T15:36:14+00:00",
      "updated_at": "2022-11-22T15:36:14+00:00",
      "archived": false,
      "archived_at": null,
      "name": "Sales Tax",
      "strategy": "add_to",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/tax_regions/6f53e777-fade-4f5f-9efe-95fa73bd265e?include=tax_rates' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "6f53e777-fade-4f5f-9efe-95fa73bd265e",
    "created_at": "2022-11-22T15:36:14+00:00",
    "updated_at": "2022-11-22T15:36:14+00:00",
    "archived": false,
    "archived_at": null,
    ...
    "tax_rates": [
      {
        "id": "7cf32bc0-14ca-49a0-a631-867e5c0d796f",
        "created_at": "2022-11-22T15:36:14+00:00",
        "updated_at": "2022-11-22T15:36:14+00:00",
        "name": "VAT",
        "value": 21.0,
        "position": 1,
        "owner_id": "6f53e777-fade-4f5f-9efe-95fa73bd265e",
...
```json
  {
  "data": {
    "id": "ffafd482-76d2-464f-8471-01542734e6d8",
    "type": "tax_regions",
    "attributes": {
      "created_at": "2022-11-22T15:36:15+00:00",
      "updated_at": "2022-11-22T15:36:15+00:00",
      "archived": false,
      "archived_at": null,
      "name": "Sales Tax",
      "strategy": "compound",
    ...
    "relationships": {
      "tax_rates": {
        "data": [
          {
            "type": "tax_rates",
            "id": "3537771f-1079-4ad9-8657-37275b74098f"
          }
        ]
      }
    }
  ...
  "included": [
    {
      ...
      "attributes": {
        ...
        "value": 21.0,
        "position": 1,
        "owner_id": "ffafd482-76d2-464f-8471-01542734e6d8",
        "owner_type": "tax_regions"
      },
      "relationships": {
        "owner": {
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/tax_regions/dae07489-03fa-43a3-baf5-769fbb53e357' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "dae07489-03fa-43a3-baf5-769fbb53e357",
        "type": "tax_regions",
        "attributes": {
          "name": "State Tax",
          "tax_rates_attributes": [
            ...
            {
              "id": "bf791be5-cc9e-401c-a2d6-36dc2616f18c",
              "_destroy": true
            }
          ]
        }
    ...
    "relationships": {
      "tax_rates": {
        "data": [
          {
            "type": "tax_rates",
            "id": "4af05c38-a6a4-4b83-9037-59b0a8060736"
          }
        ]
      }
    }
  ...
  "included": [
    {
      ...
      "attributes": {
        ...
        "value": 9.0,
        "position": 2,
        "owner_id": "dae07489-03fa-43a3-baf5-769fbb53e357",
        "owner_type": "tax_regions"
      },
      "relationships": {
        "owner": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/tax_regions/da6acafa-8629-4a87-bfb2-b4698b315256' \
    --header 'content-type: application/json' \
    --data '{}'
```
