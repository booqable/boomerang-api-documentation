...
```json
  ...
  "data": [
    {
      "id": "8e6993f6-23fb-4d09-9a55-bd657fc19241",
      "created_at": "2023-02-21T10:51:47+00:00",
      "updated_at": "2023-02-21T10:51:47+00:00",
      "archived": false,
      "archived_at": null,
      "name": "Sales Tax",
      "strategy": "add_to",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/tax_regions/23c26c85-8595-466a-9a9d-6a73e56a91aa?include=tax_rates' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "23c26c85-8595-466a-9a9d-6a73e56a91aa",
    "created_at": "2023-02-21T10:51:47+00:00",
    "updated_at": "2023-02-21T10:51:47+00:00",
    "archived": false,
    "archived_at": null,
    ...
    "tax_rates": [
      {
        "id": "b43bf9b2-6001-4440-8b93-f863374ca0bd",
        "created_at": "2023-02-21T10:51:47+00:00",
        "updated_at": "2023-02-21T10:51:47+00:00",
        "name": "VAT",
        "value": 21.0,
        "position": 1,
        "owner_id": "23c26c85-8595-466a-9a9d-6a73e56a91aa",
...
```json
  {
  "data": {
    "id": "b51ac447-5210-43c8-82cc-48a02d697be3",
    "type": "tax_regions",
    "attributes": {
      "created_at": "2023-02-21T10:51:48+00:00",
      "updated_at": "2023-02-21T10:51:48+00:00",
      "archived": false,
      "archived_at": null,
      "name": "Sales Tax",
      "strategy": "compound",
    ...
    "relationships": {
      "tax_rates": {
        "data": [
          {
            "type": "tax_rates",
            "id": "a19262a0-be87-4148-852b-34382605f810"
          }
        ]
      }
    }
  ...
  "included": [
    {
      ...
      "attributes": {
        ...
        "value": 21.0,
        "position": 1,
        "owner_id": "b51ac447-5210-43c8-82cc-48a02d697be3",
        "owner_type": "tax_regions"
      },
      "relationships": {
        "owner": {
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/tax_regions/1fffb69a-48e5-42d2-b468-7af6b3e23853' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "1fffb69a-48e5-42d2-b468-7af6b3e23853",
        "type": "tax_regions",
        "attributes": {
          "name": "State Tax",
          "tax_rates_attributes": [
            ...
            {
              "id": "66f50b2f-10ad-4a06-b076-c64d10240973",
              "_destroy": true
            }
          ]
        }
    ...
    "relationships": {
      "tax_rates": {
        "data": [
          {
            "type": "tax_rates",
            "id": "c76f4e52-5d0c-432d-b64f-fd644652569c"
          }
        ]
      }
    }
  ...
  "included": [
    {
      ...
      "attributes": {
        ...
        "value": 9.0,
        "position": 2,
        "owner_id": "1fffb69a-48e5-42d2-b468-7af6b3e23853",
        "owner_type": "tax_regions"
      },
      "relationships": {
        "owner": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/tax_regions/63924c6d-49cc-4f12-8b2c-8112eb93d551' \
    --header 'content-type: application/json' \
    --data '{}'
```
