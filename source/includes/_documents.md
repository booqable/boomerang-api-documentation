...
```json
  ...
  "data": [
    {
      "id": "e71beaaa-282d-402f-bb27-8f79b4b77cf4",
      "type": "documents",
      "attributes": {
        "created_at": "2023-02-01T13:18:50+00:00",
        "updated_at": "2023-02-01T13:18:50+00:00",
        "archived": false,
        "archived_at": null,
        ...
        "order_id": "25b98e5a-f2b9-4c27-9113-b6837b2c77d2",
        "customer_id": "8cfd3e82-09f8-455d-ad6d-b5ebcf54861d",
        "tax_region_id": null,
        "coupon_id": null
      },
      "relationships": {
        "order": {
          "links": {
            "related": "api/boomerang/orders/25b98e5a-f2b9-4c27-9113-b6837b2c77d2"
          }
        },
        "customer": {
          "links": {
            "related": "api/boomerang/customers/8cfd3e82-09f8-455d-ad6d-b5ebcf54861d"
          }
        },
        "tax_region": {
          "links": {
        ...
        "lines": {
          "links": {
            "related": "api/boomerang/lines?filter[owner_id]=e71beaaa-282d-402f-bb27-8f79b4b77cf4&filter[owner_type]=documents"
          }
        },
        "tax_values": {
          "links": {
            "related": "api/boomerang/tax_values?filter[owner_id]=e71beaaa-282d-402f-bb27-8f79b4b77cf4&filter[owner_type]=documents"
          }
        }
      }
    }
          ...
          "attributes": [
            ...
            },
            {
              ...
              "attributes": [
                {
                  "date": {
                    "gte": "2023-01-29T13:18:56.543Z"
                  }
                },
                {
                  "date": {
                    "lte": "2023-02-04T13:18:56.543Z"
                  }
                }
              ]
            }
...
```json
  ...
  "data": [
    {
      "id": "369ab803-c6b6-4455-be64-7cfd288bcb59"
    },
    {
      "id": "657a376c-0885-4e9f-9055-3f8fdd409b8d"
    }
  ]
}
```
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/documents/4587cde9-d7bd-4ed2-baad-7155ca28252c' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "4587cde9-d7bd-4ed2-baad-7155ca28252c",
    "type": "documents",
    "attributes": {
      "created_at": "2023-02-01T13:18:57+00:00",
      "updated_at": "2023-02-01T13:18:57+00:00",
      "archived": false,
      "archived_at": null,
      "document_type": "invoice",
      "number": null,
      ...
      "tax_in_cents": 15167,
      "discount_percentage": 10.0,
      "order_id": "27924fd4-ca33-42aa-a013-9630e0ecf77a",
      "customer_id": "544164a7-2cab-4b58-a9d0-d2441fbb7bb4",
      "tax_region_id": null,
      "coupon_id": null
    },
    "relationships": {
      "order": {
        "links": {
          "related": "api/boomerang/orders/27924fd4-ca33-42aa-a013-9630e0ecf77a"
        }
      },
      "customer": {
        "links": {
          "related": "api/boomerang/customers/544164a7-2cab-4b58-a9d0-d2441fbb7bb4"
        }
      },
      "tax_region": {
        "links": {
      ...
      "lines": {
        "links": {
          "related": "api/boomerang/lines?filter[owner_id]=4587cde9-d7bd-4ed2-baad-7155ca28252c&filter[owner_type]=documents"
        }
      },
      "tax_values": {
        "links": {
          "related": "api/boomerang/tax_values?filter[owner_id]=4587cde9-d7bd-4ed2-baad-7155ca28252c&filter[owner_type]=documents"
        }
      }
    }
  },
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          ...
          "order_id": "76a4d88c-4b3e-4560-8c1e-75602efa1b79"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "ac8a409a-868e-43d7-bdac-4ac0b75751bb",
    "type": "documents",
    "attributes": {
      "created_at": "2023-02-01T13:18:59+00:00",
      "updated_at": "2023-02-01T13:18:59+00:00",
      "archived": false,
      "archived_at": null,
      "document_type": "contract",
      "number": 1,
      ...
      "discount_percentage": 10.0,
      "order_id": "76a4d88c-4b3e-4560-8c1e-75602efa1b79",
      "customer_id": "72fea6b5-cb84-41bd-adc4-9faddfd960da",
      "tax_region_id": null,
      "coupon_id": null
    },
    "relationships": {
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/documents/6ec121bc-19e6-4775-a77b-ecd9da788fd8' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "6ec121bc-19e6-4775-a77b-ecd9da788fd8",
        "type": "documents",
        "attributes": {
          "name": "Jane Doe"
        }
...
```json
  ...
  "data": {
    ...
    "type": "documents",
    "attributes": {
      "created_at": "2023-02-01T13:19:00+00:00",
      "updated_at": "2023-02-01T13:19:00+00:00",
      "archived": false,
      "archived_at": null,
      "document_type": "invoice",
      "number": null,
      ...
      "tax_in_cents": 15167,
      "discount_percentage": 10.0,
      "order_id": "b98dfeb3-ef3f-4552-9a18-028b0a89b2ed",
      "customer_id": "84021e11-7845-4aa1-b4e4-4ce49564482a",
      "tax_region_id": null,
      "coupon_id": null
    },
    "relationships": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/documents/487ddc97-bed5-456a-bc8f-e40e978d4e02' \
    --header 'content-type: application/json' \
```
