          ...
          "attributes": [
            ...
            },
            {
              ...
              "attributes": [
                {
                  "date": {
                    "gte": "2023-12-04T14:00:00.714Z"
                  }
                },
                {
                  "date": {
                    "lte": "2023-12-10T14:00:00.714Z"
                  }
                }
              ]
            }
...
```json
  ...
  "data": [
    {
      "id": "c4b716d9-b88c-48fa-aacd-4b133c35100c"
    },
    {
      "id": "d9a0f902-92b0-42df-ad11-1bd0316ed9a3"
    }
  ]
}
```
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/documents/39998dd9-6339-48b4-ad50-16fda6629bae' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "39998dd9-6339-48b4-ad50-16fda6629bae",
    "type": "documents",
    "attributes": {
      "created_at": "2023-12-07T14:00:02+00:00",
      "updated_at": "2023-12-07T14:00:02+00:00",
      "archived": false,
      "archived_at": null,
      ...
      "order_id": "184aa0a6-a67a-4b4d-a370-d5fca30e8964",
      "customer_id": "5447cbee-9e3b-4e49-a9ec-5b19348f1b5c",
      "tax_region_id": null,
      "coupon_id": null
    },
    "relationships": {
      "order": {
        "links": {
          "related": "api/boomerang/orders/184aa0a6-a67a-4b4d-a370-d5fca30e8964"
        }
      },
      "customer": {
        "links": {
          "related": "api/boomerang/customers/5447cbee-9e3b-4e49-a9ec-5b19348f1b5c"
        }
      },
      "tax_region": {
        "links": {
      ...
      "lines": {
        "links": {
          "related": "api/boomerang/lines?filter[owner_id]=39998dd9-6339-48b4-ad50-16fda6629bae&filter[owner_type]=documents"
        }
      },
      "tax_values": {
        "links": {
          "related": "api/boomerang/tax_values?filter[owner_id]=39998dd9-6339-48b4-ad50-16fda6629bae&filter[owner_type]=documents"
        }
      }
    }
  },
...
```json
  ...
  "data": [
    {
      "id": "706ee9e4-9180-4d95-96d8-6e4819b2db7b",
      "type": "documents",
      "attributes": {
        "created_at": "2023-12-07T14:00:05+00:00",
        "updated_at": "2023-12-07T14:00:06+00:00",
        "archived": false,
        "archived_at": null,
        "document_type": "invoice",
        "number": null,
        ...
        "tax_in_cents": 15167,
        "discount_percentage": 10.0,
        "order_id": "a6585f06-0b3c-45fc-bcaf-f64219ce79b5",
        "customer_id": "58d370b7-f64b-4d9a-95ae-c13a76af3bd0",
        "tax_region_id": null,
        "coupon_id": null
      },
      "relationships": {
        "order": {
          "links": {
            "related": "api/boomerang/orders/a6585f06-0b3c-45fc-bcaf-f64219ce79b5"
          }
        },
        "customer": {
          "links": {
            "related": "api/boomerang/customers/58d370b7-f64b-4d9a-95ae-c13a76af3bd0"
          }
        },
        "tax_region": {
          "links": {
        ...
        "lines": {
          "links": {
            "related": "api/boomerang/lines?filter[owner_id]=706ee9e4-9180-4d95-96d8-6e4819b2db7b&filter[owner_type]=documents"
          }
        },
        "tax_values": {
          "links": {
            "related": "api/boomerang/tax_values?filter[owner_id]=706ee9e4-9180-4d95-96d8-6e4819b2db7b&filter[owner_type]=documents"
          }
        }
      }
    }
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/documents/5e9291a6-5cc6-4e01-a012-2b2adbbfe7c1' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "5e9291a6-5cc6-4e01-a012-2b2adbbfe7c1",
        "type": "documents",
        "attributes": {
          "name": "Jane Doe"
        }
...
```json
  ...
  "data": {
    ...
    "type": "documents",
    "attributes": {
      "created_at": "2023-12-07T14:00:09+00:00",
      "updated_at": "2023-12-07T14:00:10+00:00",
      "archived": false,
      "archived_at": null,
      "document_type": "invoice",
      "number": null,
      ...
      "tax_in_cents": 15167,
      "discount_percentage": 10.0,
      "order_id": "9636dcf4-ee00-4a58-8b41-4192dd9d993d",
      "customer_id": "06570a4b-ab9b-4f0a-88de-787ff59d2af1",
      "tax_region_id": null,
      "coupon_id": null
    },
    "relationships": {
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          ...
          "order_id": "4cf48d1c-19ad-4a95-b987-b73dc0baf63c"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "2730a1a1-27f4-4b1e-b810-9981fb84f902",
    "type": "documents",
    "attributes": {
      "created_at": "2023-12-07T14:00:13+00:00",
      "updated_at": "2023-12-07T14:00:13+00:00",
      "archived": false,
      "archived_at": null,
      "document_type": "contract",
      "number": 1,
      ...
      "discount_percentage": 10.0,
      "order_id": "4cf48d1c-19ad-4a95-b987-b73dc0baf63c",
      "customer_id": "2c09a2e7-cbc2-4af0-ad17-8fa2371a72b5",
      "tax_region_id": null,
      "coupon_id": null
    },
    "relationships": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/documents/cead73d6-c24b-437a-b452-f1bba0e0bb07' \
    --header 'content-type: application/json' \
```
