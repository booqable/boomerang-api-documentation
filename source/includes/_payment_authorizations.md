...
```json
  ...
  "data": [
    {
      "id": "2d0dd9cd-2fb4-4b43-86f8-44f6ffed9217",
      "type": "payment_authorizations",
      "attributes": {
        "created_at": "2024-10-14T09:26:08.209739+00:00",
        "updated_at": "2024-10-14T09:26:08.209739+00:00",
        "status": "created",
        "amount_in_cents": 100,
        "deposit_in_cents": 0,
        "total_in_cents": 100,
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/payment_authorizations/66d8b535-1740-4d57-a159-34bd5a66115b' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "66d8b535-1740-4d57-a159-34bd5a66115b",
    "type": "payment_authorizations",
    "attributes": {
      "created_at": "2024-10-14T09:26:07.783449+00:00",
      "updated_at": "2024-10-14T09:26:07.783449+00:00",
      "status": "created",
      "amount_in_cents": 100,
      "deposit_in_cents": 0,
      "total_in_cents": 100,
...
```json
  {
  "data": {
    "id": "a06af910-28d0-445d-9f8c-67ad4d12440e",
    "type": "payment_authorizations",
    "attributes": {
      "created_at": "2024-10-14T09:26:07.378509+00:00",
      "updated_at": "2024-10-14T09:26:07.378509+00:00",
      "status": "created",
      "amount_in_cents": 10000,
      "deposit_in_cents": 5000,
      ...
      "canceled_at": null,
      "expired_at": null,
      "employee_id": "691fa381-fd82-49d2-a8a2-d8577b5a6ae0",
      "order_id": null,
      "customer_id": null,
      "payment_method_id": null
    },
