...
```json
  ...
  "data": [
    {
      "id": "343e9e95-d975-400c-afe7-f30c31aaa9fe",
      "type": "customers",
      "attributes": {
        "created_at": "2022-12-20T14:48:26+00:00",
        "updated_at": "2022-12-20T14:48:26+00:00",
        "archived": false,
        "archived_at": null,
        "number": 1,
        "name": "John Doe",
      ...
      "relationships": {
        ...
        "properties": {
          "links": {
            "related": "api/boomerang/properties?filter[owner_id]=343e9e95-d975-400c-afe7-f30c31aaa9fe&filter[owner_type]=customers"
          }
        },
        "barcode": {
          "links": {
            "related": "api/boomerang/barcodes?filter[owner_id]=343e9e95-d975-400c-afe7-f30c31aaa9fe&filter[owner_type]=customers"
          }
        },
        "notes": {
          "links": {
            "related": "api/boomerang/notes?filter[owner_id]=343e9e95-d975-400c-afe7-f30c31aaa9fe&filter[owner_type]=customers"
          }
        }
      }
    }
...
```json
  ...
  "data": [
    {
      "id": "409cfdff-d797-41fb-bca3-fd41a0801062"
    },
    {
      "id": "74f5821c-7b2e-45d7-880b-a5bbc83908bd"
    }
  ]
}
```
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/customers/2b8bf01b-c20e-45fa-a49d-292c2b6edec1?include=barcode%2Cproperties' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "2b8bf01b-c20e-45fa-a49d-292c2b6edec1",
    "type": "customers",
    "attributes": {
      "created_at": "2022-12-20T14:48:29+00:00",
      "updated_at": "2022-12-20T14:48:29+00:00",
      "archived": false,
      "archived_at": null,
      "number": 1,
      "name": "John Doe",
    ...
    "relationships": {
      ...
      "properties": {
        "links": {
          "related": "api/boomerang/properties?filter[owner_id]=2b8bf01b-c20e-45fa-a49d-292c2b6edec1&filter[owner_type]=customers"
        },
        "data": []
      },
      "barcode": {
        "links": {
          "related": "api/boomerang/barcodes?filter[owner_id]=2b8bf01b-c20e-45fa-a49d-292c2b6edec1&filter[owner_type]=customers"
        },
        "data": null
      },
      "notes": {
        "links": {
          "related": "api/boomerang/notes?filter[owner_id]=2b8bf01b-c20e-45fa-a49d-292c2b6edec1&filter[owner_type]=customers"
        }
      }
    }
  },
...
```json
  {
  "data": {
    "id": "c0cb9e30-6485-4f32-8f70-750011462eea",
    "type": "customers",
    "attributes": {
      "created_at": "2022-12-20T14:48:31+00:00",
      "updated_at": "2022-12-20T14:48:31+00:00",
      "archived": false,
      "archived_at": null,
      "number": 2,
      "name": "John Doe",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/customers/dec354e5-42eb-402f-90a1-fd3360958a04' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "dec354e5-42eb-402f-90a1-fd3360958a04",
        "type": "customers",
        "attributes": {
          "name": "Jane Doe"
        }
...
```json
  ...
  "data": {
    ...
    "type": "customers",
    "attributes": {
      "created_at": "2022-12-20T14:48:32+00:00",
      "updated_at": "2022-12-20T14:48:33+00:00",
      "archived": false,
      "archived_at": null,
      "number": 1,
      "name": "Jane Doe",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/customers/9cee28d2-fa96-4c15-8260-c3fa60165ea9' \
    --header 'content-type: application/json' \
```
