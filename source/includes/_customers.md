...
```json
  ...
  "data": [
    {
      "id": "66d9b908-b709-4f07-aa2b-e412c5c14e22",
      "type": "customers",
      "attributes": {
        "created_at": "2022-06-30T09:44:34+00:00",
        "updated_at": "2022-06-30T09:44:34+00:00",
        "archived": false,
        "archived_at": null,
        "number": 1,
        "name": "John Doe",
        "email": "doe.john@will.com",
      ...
      "relationships": {
        ...
        "properties": {
          "links": {
            "related": "api/boomerang/properties?filter[owner_id]=66d9b908-b709-4f07-aa2b-e412c5c14e22&filter[owner_type]=customers"
          }
        },
        "barcode": {
          "links": {
            "related": "api/boomerang/barcodes?filter[owner_id]=66d9b908-b709-4f07-aa2b-e412c5c14e22&filter[owner_type]=customers"
          }
        },
        "notes": {
          "links": {
            "related": "api/boomerang/notes?filter[owner_id]=66d9b908-b709-4f07-aa2b-e412c5c14e22&filter[owner_type]=customers"
          }
        }
      }
    }
...
```json
  ...
  "data": [
    {
      "id": "2e7197f8-37cf-4cc0-b15c-4cb1978ce876"
    },
    {
      "id": "09395c7f-3aac-42a1-9c8b-f38bc6df766e"
    }
  ]
}
```
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/customers/c2eafcc4-0ea1-4a5e-a18d-6c0ac0878469?include=barcode%2Cproperties' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "c2eafcc4-0ea1-4a5e-a18d-6c0ac0878469",
    "type": "customers",
    "attributes": {
      "created_at": "2022-06-30T09:44:37+00:00",
      "updated_at": "2022-06-30T09:44:37+00:00",
      "archived": false,
      "archived_at": null,
      "number": 1,
      "name": "John Doe",
      "email": "john.doe@macejkovic.biz",
      "deposit_type": "default",
      "deposit_value": 0.0,
      "discount_percentage": 0.0,
      "legal_type": "person",
    ...
    "relationships": {
      ...
      "properties": {
        "links": {
          "related": "api/boomerang/properties?filter[owner_id]=c2eafcc4-0ea1-4a5e-a18d-6c0ac0878469&filter[owner_type]=customers"
        },
        "data": []
      },
      "barcode": {
        "links": {
          "related": "api/boomerang/barcodes?filter[owner_id]=c2eafcc4-0ea1-4a5e-a18d-6c0ac0878469&filter[owner_type]=customers"
        },
        "data": null
      },
      "notes": {
        "links": {
          "related": "api/boomerang/notes?filter[owner_id]=c2eafcc4-0ea1-4a5e-a18d-6c0ac0878469&filter[owner_type]=customers"
        }
      }
    }
  },
...
```json
  {
  "data": {
    "id": "1711fd0d-92ec-4f18-aea5-e95dcd6f37d9",
    "type": "customers",
    "attributes": {
      "created_at": "2022-06-30T09:44:38+00:00",
      "updated_at": "2022-06-30T09:44:38+00:00",
      "archived": false,
      "archived_at": null,
      "number": 2,
      "name": "John Doe",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/customers/5a773d06-1dee-4b01-8bf5-1a749c7e2fcc' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "5a773d06-1dee-4b01-8bf5-1a749c7e2fcc",
        "type": "customers",
        "attributes": {
          "name": "Jane Doe"
        }
...
```json
  ...
  "data": {
    ...
    "type": "customers",
    "attributes": {
      "created_at": "2022-06-30T09:44:39+00:00",
      "updated_at": "2022-06-30T09:44:39+00:00",
      "archived": false,
      "archived_at": null,
      "number": 1,
      "name": "Jane Doe",
      "email": "john.doe@botsford.biz",
      "deposit_type": "default",
      "deposit_value": 0.0,
      "discount_percentage": 0.0,
      "legal_type": "person",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/customers/c6fee7a6-339a-4b82-a1d3-b99b24044702' \
    --header 'content-type: application/json' \
```
