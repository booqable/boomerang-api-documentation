...
```json
  ...
  "data": [
    {
      "id": "5ef8305b-a4a0-4d3d-9467-f74f96833dac",
      "type": "customers",
      "attributes": {
        "created_at": "2022-02-21T07:52:23+00:00",
        "updated_at": "2022-02-21T07:52:23+00:00",
        "archived": false,
        "archived_at": null,
        "number": 1,
        "name": "John Doe",
        "email": "doe_john@schimmel.com",
      ...
      "relationships": {
        ...
        "properties": {
          "links": {
            "related": "api/boomerang/properties?filter[owner_id]=5ef8305b-a4a0-4d3d-9467-f74f96833dac&filter[owner_type]=customers"
          }
        },
        "barcode": {
          "links": {
            "related": "api/boomerang/barcodes?filter[owner_id]=5ef8305b-a4a0-4d3d-9467-f74f96833dac&filter[owner_type]=customers"
          }
        },
        "notes": {
          "links": {
            "related": "api/boomerang/notes?filter[owner_id]=5ef8305b-a4a0-4d3d-9467-f74f96833dac&filter[owner_type]=customers"
          }
        }
      }
    }
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/customers/fbe642db-5be0-4ab8-882c-eff9d48d48a1?include=barcode%2Cproperties' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "fbe642db-5be0-4ab8-882c-eff9d48d48a1",
    "type": "customers",
    "attributes": {
      "created_at": "2022-02-21T07:52:24+00:00",
      "updated_at": "2022-02-21T07:52:24+00:00",
      "archived": false,
      "archived_at": null,
      "number": 1,
      "name": "John Doe",
      "email": "john_doe@beier.org",
      "deposit_type": "default",
      "deposit_value": 0.0,
      "discount_percentage": 0.0,
      "legal_type": "person",
    ...
    "relationships": {
      ...
      "properties": {
        "links": {
          "related": "api/boomerang/properties?filter[owner_id]=fbe642db-5be0-4ab8-882c-eff9d48d48a1&filter[owner_type]=customers"
        },
        "data": []
      },
      "barcode": {
        "links": {
          "related": "api/boomerang/barcodes?filter[owner_id]=fbe642db-5be0-4ab8-882c-eff9d48d48a1&filter[owner_type]=customers"
        },
        "data": null
      },
      "notes": {
        "links": {
          "related": "api/boomerang/notes?filter[owner_id]=fbe642db-5be0-4ab8-882c-eff9d48d48a1&filter[owner_type]=customers"
        }
      }
    }
  },
...
```json
  {
  "data": {
    "id": "7d521bbd-6b88-460a-a0ce-9967adb54d5f",
    "type": "customers",
    "attributes": {
      "created_at": "2022-02-21T07:52:25+00:00",
      "updated_at": "2022-02-21T07:52:25+00:00",
      "archived": false,
      "archived_at": null,
      "number": 2,
      "name": "John Doe",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/customers/017dc3c4-c61c-4268-913f-16a4ade15780' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "017dc3c4-c61c-4268-913f-16a4ade15780",
        "type": "customers",
        "attributes": {
          "name": "Jane Doe"
        }
...
```json
  ...
  "data": {
    ...
    "attributes": {
      "created_at": "2022-02-21T07:52:25+00:00",
      "updated_at": "2022-02-21T07:52:26+00:00",
      "archived": false,
      "archived_at": null,
      "number": 1,
      "name": "Jane Doe",
      "email": "john.doe@langworth.info",
      "deposit_type": "default",
      "deposit_value": 0.0,
      "discount_percentage": 0.0,
      "legal_type": "person",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/customers/ea77ecd6-d61c-4e54-8d65-884189914c7e' \
    --header 'content-type: application/json' \
```
