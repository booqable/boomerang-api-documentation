...
```json
  ...
  "data": [
    {
      "id": "6d52af6c-736e-4216-a78e-96baabcfab65",
      "type": "customers",
      "attributes": {
        "created_at": "2021-10-07T08:41:10+00:00",
        "updated_at": "2021-10-07T08:41:10+00:00",
        "number": 1,
        "name": "John Doe",
        "email": "doe_john@wolff.co",
        "archived": false,
      ...
      "relationships": {
        ...
        "barcode": {
          "links": {
            "related": "api/boomerang/barcodes?filter[owner_id]=6d52af6c-736e-4216-a78e-96baabcfab65"
          }
        }
      }
    }
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/customers/e440f4af-bb8c-44db-afeb-2635d567823e' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "e440f4af-bb8c-44db-afeb-2635d567823e",
    "type": "customers",
    "attributes": {
      "created_at": "2021-10-07T08:41:12+00:00",
      "updated_at": "2021-10-07T08:41:12+00:00",
      "number": 1,
      "name": "John Doe",
      "email": "doe.john@huels.info",
      "archived": false,
      "deposit_type": "default",
      "deposit_value": 0.0,
      "discount_percentage": 0.0,
    ...
    "relationships": {
      ...
      "barcode": {
        "links": {
          "related": "api/boomerang/barcodes?filter[owner_id]=e440f4af-bb8c-44db-afeb-2635d567823e"
        }
      }
    }
  },
...
```json
  {
  "data": {
    "id": "c7d9f5f1-0999-434a-9e22-a5d10fb608ff",
    "type": "customers",
    "attributes": {
      "created_at": "2021-10-07T08:41:13+00:00",
      "updated_at": "2021-10-07T08:41:13+00:00",
      "number": 2,
      "name": "John Doe",
      "email": "john@doe.com",
      "archived": false,
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/customers/862a7d4d-979c-4e8c-8f61-e736a4f94a3e' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "862a7d4d-979c-4e8c-8f61-e736a4f94a3e",
        "type": "customers",
        "attributes": {
          "name": "Jane Doe"
        }
...
```json
  ...
  "data": {
    ...
    "type": "customers",
    "attributes": {
      "created_at": "2021-10-07T08:41:14+00:00",
      "updated_at": "2021-10-07T08:41:15+00:00",
      "number": 1,
      "name": "Jane Doe",
      "email": "john.doe@bode.com",
      "archived": false,
      "deposit_type": "default",
      "deposit_value": 0.0,
      "discount_percentage": 0.0,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/customers/8becc14b-7c2c-4355-ab9d-0d346128e6db' \
    --header 'content-type: application/json' \
```
