...
```json
  ...
  "data": [
    {
      "id": "05ea0bce-9749-4a44-b19c-8891dfb93cc3",
      "created_at": "2021-09-25T11:36:52+00:00",
      "updated_at": "2021-09-25T11:36:52+00:00",
      "number": 1,
      "name": "John Doe",
      "email": "john_doe@cartwright.info",
      "archived": false,
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/customers/cdcc36c4-3ba1-4d39-8e8a-6f2d8ba66457' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "cdcc36c4-3ba1-4d39-8e8a-6f2d8ba66457",
    "created_at": "2021-09-25T11:36:53+00:00",
    "updated_at": "2021-09-25T11:36:53+00:00",
    "number": 1,
    "name": "John Doe",
    "email": "john_doe@stokes-abernathy.org",
    "archived": false,
    "deposit_type": "default",
    "deposit_value": 0.0,
    "discount_percentage": 0.0,
...
```json
  {
  "data": {
    "id": "11f963a3-c3f0-46f6-8966-8e0782af21df",
    "type": "customers",
    "attributes": {
      "created_at": "2021-09-25T11:36:54+00:00",
      "updated_at": "2021-09-25T11:36:54+00:00",
      "number": 2,
      "name": "John Doe",
      "email": "john@doe.com",
      "archived": false,
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/customers/3b9d2435-ff91-414e-af13-8d56c9d6e8a4' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "3b9d2435-ff91-414e-af13-8d56c9d6e8a4",
        "type": "customers",
        "attributes": {
          "name": "Jane Doe"
        }
...
```json
  ...
  "data": {
    ...
    "type": "customers",
    "attributes": {
      "created_at": "2021-09-25T11:36:55+00:00",
      "updated_at": "2021-09-25T11:36:55+00:00",
      "number": 1,
      "name": "Jane Doe",
      "email": "doe.john@jacobson-adams.net",
      "archived": false,
      "deposit_type": "default",
      "deposit_value": 0.0,
      "discount_percentage": 0.0,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/customers/b159326c-2f02-4455-84c5-8cc7a9fe31dc' \
    --header 'content-type: application/json' \
    --data '{}'
```
