...
```json
  ...
  "data": [
    {
      "id": "15456be0-bb2c-4594-b52a-bbe74a13b9ac",
      "type": "customers",
      "attributes": {
        "number": 1,
        "name": "John Doe",
      ...
      "relationships": {
        ...
        "properties": {
          "links": {
            "related": "api/boomerang/properties?filter[owner_id]=15456be0-bb2c-4594-b52a-bbe74a13b9ac&filter[owner_type]=Customer"
          }
        },
        "barcode": {
          "links": {
            "related": "api/boomerang/barcodes?filter[owner_id]=15456be0-bb2c-4594-b52a-bbe74a13b9ac"
          }
        },
        "notes": {
          "links": {
            "related": "api/boomerang/notes?filter[notable_id]=15456be0-bb2c-4594-b52a-bbe74a13b9ac&filter[notable_type]=Customer"
          }
        }
      }
    }
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/customers/61407811-f1ac-47b6-bec8-d2b526b0497a' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "61407811-f1ac-47b6-bec8-d2b526b0497a",
    "type": "customers",
    "attributes": {
      "number": 1,
      "name": "John Doe",
      "email": "doe.john@gutmann-kuhn.co",
      "archived": false,
      "deposit_type": "default",
      "deposit_value": 0.0,
      "discount_percentage": 0.0,
    ...
    "relationships": {
      ...
      "properties": {
        "links": {
          "related": "api/boomerang/properties?filter[owner_id]=61407811-f1ac-47b6-bec8-d2b526b0497a&filter[owner_type]=Customer"
        }
      },
      "barcode": {
        "links": {
          "related": "api/boomerang/barcodes?filter[owner_id]=61407811-f1ac-47b6-bec8-d2b526b0497a"
        }
      },
      "notes": {
        "links": {
          "related": "api/boomerang/notes?filter[notable_id]=61407811-f1ac-47b6-bec8-d2b526b0497a&filter[notable_type]=Customer"
        }
      }
    }
  },
...
```json
  {
  "data": {
    "id": "20e2476a-e850-46a1-9545-46f329f6e06b",
    "type": "customers",
    "attributes": {
      "number": 2,
      "name": "John Doe",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/customers/ebf23dc1-a871-4a7e-8b3d-e3cc87d5da2a' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "ebf23dc1-a871-4a7e-8b3d-e3cc87d5da2a",
        "type": "customers",
        "attributes": {
          "name": "Jane Doe"
        }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/customers/d8055dd8-7ae2-4204-8bab-e05ed400a550' \
    --header 'content-type: application/json' \
```
