...
```json
  ...
  "data": [
    {
      "id": "f1dbcc0c-b8f1-442a-861f-86f7d848af13",
      "created_at": "2021-09-17T09:18:03+00:00",
      "updated_at": "2021-09-17T09:18:03+00:00",
      "number": 1,
      "name": "John Doe",
      "email": "john.doe@schaefer-ernser.name",
      "archived": false,
...
`filter` | **Hash**<br>The filters to apply `?filter[created_at][gte]=2021-09-17T09:17:58Z`
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/customers/e211f7f7-d9bb-4e0f-aa16-25a6eefddba6' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "e211f7f7-d9bb-4e0f-aa16-25a6eefddba6",
    "created_at": "2021-09-17T09:18:04+00:00",
    "updated_at": "2021-09-17T09:18:04+00:00",
    "number": 1,
    "name": "John Doe",
    "email": "doe.john@hamill-green.io",
    "archived": false,
    "deposit_type": "default",
    "deposit_value": 0.0,
    "discount_percentage": 0.0,
...
```json
  {
  "data": {
    "id": "0651b565-902a-4acb-ab42-b8a6ca4aadfa",
    "type": "customers",
    "attributes": {
      "created_at": "2021-09-17T09:18:05+00:00",
      "updated_at": "2021-09-17T09:18:05+00:00",
      "number": 2,
      "name": "John Doe",
      "email": "john@doe.com",
      "archived": false,
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/customers/0acd621e-7c57-4289-8b57-1d5ed45b9dd8' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "0acd621e-7c57-4289-8b57-1d5ed45b9dd8",
        "type": "customers",
        "attributes": {
          "name": "Jane Doe"
        }
...
```json
  ...
  "data": {
    ...
    "type": "customers",
    "attributes": {
      "created_at": "2021-09-17T09:18:06+00:00",
      "updated_at": "2021-09-17T09:18:06+00:00",
      "number": 1,
      "name": "Jane Doe",
      "email": "doe_john@bailey-bogisich.io",
      "archived": false,
      "deposit_type": "default",
      "deposit_value": 0.0,
      "discount_percentage": 0.0,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/customers/82e6bc49-94db-4787-ad7a-f80c44bf01a5' \
    --header 'content-type: application/json' \
    --data '{}'
```
