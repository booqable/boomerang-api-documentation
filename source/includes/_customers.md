...
```json
  ...
  "data": [
    {
      "id": "8b411520-673b-4940-a8a0-872fc30d1c40",
      "type": "customers",
      "attributes": {
        "created_at": "2021-10-14T12:06:44+00:00",
        "updated_at": "2021-10-14T12:06:44+00:00",
        "number": 1,
        "name": "John Doe",
        "email": "doe.john@murphy.info",
        "archived": false,
      ...
      "relationships": {
        ...
        "barcode": {
          "links": {
            "related": "api/boomerang/barcodes?filter[owner_id]=8b411520-673b-4940-a8a0-872fc30d1c40"
          }
        }
      }
    }
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/customers/7285419c-6bf0-46e5-8be5-c393d32fb009' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "7285419c-6bf0-46e5-8be5-c393d32fb009",
    "type": "customers",
    "attributes": {
      "created_at": "2021-10-14T12:06:45+00:00",
      "updated_at": "2021-10-14T12:06:45+00:00",
      "number": 1,
      "name": "John Doe",
      "email": "john_doe@fay-mcglynn.org",
      "archived": false,
      "deposit_type": "default",
      "deposit_value": 0.0,
      "discount_percentage": 0.0,
    ...
    "relationships": {
      ...
      "barcode": {
        "links": {
          "related": "api/boomerang/barcodes?filter[owner_id]=7285419c-6bf0-46e5-8be5-c393d32fb009"
        }
      }
    }
  },
...
```json
  {
  "data": {
    "id": "516c9412-6c13-42b7-9b19-435e81c81a83",
    "type": "customers",
    "attributes": {
      "created_at": "2021-10-14T12:06:46+00:00",
      "updated_at": "2021-10-14T12:06:46+00:00",
      "number": 2,
      "name": "John Doe",
      "email": "john@doe.com",
      "archived": false,
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/customers/34be6267-e253-4b77-baf0-03bb93263f3f' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "34be6267-e253-4b77-baf0-03bb93263f3f",
        "type": "customers",
        "attributes": {
          "name": "Jane Doe"
        }
...
```json
  ...
  "data": {
    ...
    "type": "customers",
    "attributes": {
      "created_at": "2021-10-14T12:06:47+00:00",
      "updated_at": "2021-10-14T12:06:47+00:00",
      "number": 1,
      "name": "Jane Doe",
      "email": "doe.john@schroeder-rutherford.info",
      "archived": false,
      "deposit_type": "default",
      "deposit_value": 0.0,
      "discount_percentage": 0.0,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/customers/c631a5ed-f7b3-4f18-b529-b28ba8fcef81' \
    --header 'content-type: application/json' \
```
