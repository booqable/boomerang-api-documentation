...
```json
  ...
  "data": [
    {
      "id": "cc83ae16-67d9-4d95-843f-acf9e00d7ce8",
      "type": "customers",
      "attributes": {
        "created_at": "2022-07-12T08:47:19+00:00",
        "updated_at": "2022-07-12T08:47:19+00:00",
        "archived": false,
        "archived_at": null,
        "number": 1,
        "name": "John Doe",
        "email": "doe.john@osinski.info",
      ...
      "relationships": {
        ...
        "properties": {
          "links": {
            "related": "api/boomerang/properties?filter[owner_id]=cc83ae16-67d9-4d95-843f-acf9e00d7ce8&filter[owner_type]=customers"
          }
        },
        "barcode": {
          "links": {
            "related": "api/boomerang/barcodes?filter[owner_id]=cc83ae16-67d9-4d95-843f-acf9e00d7ce8&filter[owner_type]=customers"
          }
        },
        "notes": {
          "links": {
            "related": "api/boomerang/notes?filter[owner_id]=cc83ae16-67d9-4d95-843f-acf9e00d7ce8&filter[owner_type]=customers"
          }
        }
      }
    }
...
```json
  ...
  "data": [
    {
      "id": "1d48b219-73f7-4d36-a886-db28a6dac541"
    },
    {
      "id": "9f9076c3-a527-42cf-881f-75aa21a32d12"
    }
  ]
}
```
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/customers/59e0c237-e674-4c0b-bc96-333a8e16acc6?include=barcode%2Cproperties' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "59e0c237-e674-4c0b-bc96-333a8e16acc6",
    "type": "customers",
    "attributes": {
      "created_at": "2022-07-12T08:47:21+00:00",
      "updated_at": "2022-07-12T08:47:21+00:00",
      "archived": false,
      "archived_at": null,
      "number": 1,
      "name": "John Doe",
      "email": "john_doe@marquardt.biz",
      "deposit_type": "default",
      "deposit_value": 0.0,
      "discount_percentage": 0.0,
      "legal_type": "person",
    ...
    "relationships": {
      ...
      "properties": {
        "links": {
          "related": "api/boomerang/properties?filter[owner_id]=59e0c237-e674-4c0b-bc96-333a8e16acc6&filter[owner_type]=customers"
        },
        "data": []
      },
      "barcode": {
        "links": {
          "related": "api/boomerang/barcodes?filter[owner_id]=59e0c237-e674-4c0b-bc96-333a8e16acc6&filter[owner_type]=customers"
        },
        "data": null
      },
      "notes": {
        "links": {
          "related": "api/boomerang/notes?filter[owner_id]=59e0c237-e674-4c0b-bc96-333a8e16acc6&filter[owner_type]=customers"
        }
      }
    }
  },
...
```json
  {
  "data": {
    "id": "f85ee4cc-5604-4de6-93c2-0cf86b659d72",
    "type": "customers",
    "attributes": {
      "created_at": "2022-07-12T08:47:22+00:00",
      "updated_at": "2022-07-12T08:47:22+00:00",
      "archived": false,
      "archived_at": null,
      "number": 2,
      "name": "John Doe",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/customers/f8705378-2cf2-49c8-a787-e2d9ddeceb56' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "f8705378-2cf2-49c8-a787-e2d9ddeceb56",
        "type": "customers",
        "attributes": {
          "name": "Jane Doe"
        }
...
```json
  ...
  "data": {
    ...
    "type": "customers",
    "attributes": {
      "created_at": "2022-07-12T08:47:23+00:00",
      "updated_at": "2022-07-12T08:47:24+00:00",
      "archived": false,
      "archived_at": null,
      "number": 1,
      "name": "Jane Doe",
      "email": "doe.john@davis.biz",
      "deposit_type": "default",
      "deposit_value": 0.0,
      "discount_percentage": 0.0,
      "legal_type": "person",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/customers/be644c27-c612-4cb8-a878-5d3ec43ad96f' \
    --header 'content-type: application/json' \
```
