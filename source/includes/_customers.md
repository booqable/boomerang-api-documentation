...
```json
  ...
  "data": [
    {
      "id": "a10c7194-c7c1-4eb4-b7a7-cdcac6ab25e3",
      "created_at": "2021-08-27T11:57:15+00:00",
      "updated_at": "2021-08-27T11:57:15+00:00",
      "number": 1,
      "name": "John Doe",
      "email": "john_doe@ritchie.info",
      "archived": false,
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/customers/41bd92a7-dbfd-4de5-b205-1d3922b30ad3' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "41bd92a7-dbfd-4de5-b205-1d3922b30ad3",
    "created_at": "2021-08-27T11:57:17+00:00",
    "updated_at": "2021-08-27T11:57:17+00:00",
    "number": 1,
    "name": "John Doe",
    "email": "john.doe@schimmel.com",
    "archived": false,
    "deposit_type": "default",
    "deposit_value": 0.0,
    "discount_percentage": 0.0,
...
```json
  {
  "data": {
    "id": "e25e8a3c-6d4b-461a-8e7e-eb72410bd85e",
    "type": "customers",
    "attributes": {
      "created_at": "2021-08-27T11:57:18+00:00",
      "updated_at": "2021-08-27T11:57:18+00:00",
      "number": 2,
      "name": "John Doe",
      "email": "john@doe.com",
      "archived": false,
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/customers/0fcbf1a2-a7cb-41a1-9e97-5b495d403004' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "0fcbf1a2-a7cb-41a1-9e97-5b495d403004",
        "type": "customers",
        "attributes": {
          "name": "Jane Doe"
        }
...
```json
  ...
  "data": {
    ...
    "type": "customers",
    "attributes": {
      "created_at": "2021-08-27T11:57:19+00:00",
      "updated_at": "2021-08-27T11:57:19+00:00",
      "number": 1,
      "name": "Jane Doe",
      "email": "john.doe@bednar.biz",
      "archived": false,
      "deposit_type": "default",
      "deposit_value": 0.0,
      "discount_percentage": 0.0,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/customers/cf2926a2-86d4-4064-866c-c018515d3270' \
    --header 'content-type: application/json' \
    --data '{}'
```
