...
```json
  ...
  "data": [
    {
      "id": "783bd88c-2c85-4be2-bebe-60e6c5695aac",
      "type": "customers",
      "attributes": {
        "created_at": "2022-04-13T09:08:33+00:00",
        "updated_at": "2022-04-13T09:08:33+00:00",
        "archived": false,
        "archived_at": null,
        "number": 1,
        "name": "John Doe",
        "email": "doe.john@frami-crooks.org",
      ...
      "relationships": {
        ...
        "properties": {
          "links": {
            "related": "api/boomerang/properties?filter[owner_id]=783bd88c-2c85-4be2-bebe-60e6c5695aac&filter[owner_type]=customers"
          }
        },
        "barcode": {
          "links": {
            "related": "api/boomerang/barcodes?filter[owner_id]=783bd88c-2c85-4be2-bebe-60e6c5695aac&filter[owner_type]=customers"
          }
        },
        "notes": {
          "links": {
            "related": "api/boomerang/notes?filter[owner_id]=783bd88c-2c85-4be2-bebe-60e6c5695aac&filter[owner_type]=customers"
          }
        }
      }
    }
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/customers/4a0664dd-ae86-4f56-ba7f-a92483b6df0a?include=barcode%2Cproperties' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "4a0664dd-ae86-4f56-ba7f-a92483b6df0a",
    "type": "customers",
    "attributes": {
      "created_at": "2022-04-13T09:08:34+00:00",
      "updated_at": "2022-04-13T09:08:34+00:00",
      "archived": false,
      "archived_at": null,
      "number": 1,
      "name": "John Doe",
      "email": "doe.john@walsh.com",
      "deposit_type": "default",
      "deposit_value": 0.0,
      "discount_percentage": 0.0,
      "legal_type": "person",
    ...
    "relationships": {
      ...
      "properties": {
        "links": {
          "related": "api/boomerang/properties?filter[owner_id]=4a0664dd-ae86-4f56-ba7f-a92483b6df0a&filter[owner_type]=customers"
        },
        "data": []
      },
      "barcode": {
        "links": {
          "related": "api/boomerang/barcodes?filter[owner_id]=4a0664dd-ae86-4f56-ba7f-a92483b6df0a&filter[owner_type]=customers"
        },
        "data": null
      },
      "notes": {
        "links": {
          "related": "api/boomerang/notes?filter[owner_id]=4a0664dd-ae86-4f56-ba7f-a92483b6df0a&filter[owner_type]=customers"
        }
      }
    }
  },
...
```json
  {
  "data": {
    "id": "85e62e98-7cb1-4c77-b9bd-6fcf8c952a8f",
    "type": "customers",
    "attributes": {
      "created_at": "2022-04-13T09:08:35+00:00",
      "updated_at": "2022-04-13T09:08:35+00:00",
      "archived": false,
      "archived_at": null,
      "number": 2,
      "name": "John Doe",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/customers/5a9d0a68-01e3-4c4c-9d44-4f72d4412b81' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "5a9d0a68-01e3-4c4c-9d44-4f72d4412b81",
        "type": "customers",
        "attributes": {
          "name": "Jane Doe"
        }
...
```json
  ...
  "data": {
    ...
    "attributes": {
      ...
      "number": 1,
      "name": "Jane Doe",
      "email": "john_doe@brakus-hartmann.info",
      "deposit_type": "default",
      "deposit_value": 0.0,
      "discount_percentage": 0.0,
      "legal_type": "person",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/customers/7e2eac15-28c5-4cbc-be98-d2e68cd7a0d2' \
    --header 'content-type: application/json' \
```
