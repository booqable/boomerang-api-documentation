...
```json
  ...
  "data": [
    {
      "id": "0d5673c4-fe3a-44cc-bda1-f384ffd85fe3",
      "type": "tax_categories",
      "attributes": {
        "name": "Sales Tax",
        "default": false
      ...
      "relationships": {
        "tax_rates": {
          "links": {
            "related": "api/boomerang/tax_rates?filter[owner_id]=0d5673c4-fe3a-44cc-bda1-f384ffd85fe3&filter[owner_type]=TaxCategory"
          }
        }
      }
    }
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/tax_categories/d867c0eb-67e6-44b7-b532-2de11701c3fd?include=tax_rates' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "d867c0eb-67e6-44b7-b532-2de11701c3fd",
    "type": "tax_categories",
    "attributes": {
      "name": "Sales Tax",
      "default": false
    ...
    "relationships": {
      "tax_rates": {
        "links": {
          "related": "api/boomerang/tax_rates?filter[owner_id]=d867c0eb-67e6-44b7-b532-2de11701c3fd&filter[owner_type]=TaxCategory"
        },
        "data": [
          {
            "type": "tax_rates",
            "id": "bd36eaa1-860a-446c-8ba8-0d4977e8233c"
          }
        ]
      }
    }
  ...
  "included": [
    {
      ...
      "attributes": {
        ...
        "value": 21.0,
        "position": 1,
        "owner_id": "d867c0eb-67e6-44b7-b532-2de11701c3fd",
        "owner_type": "TaxCategory"
      },
      "relationships": {
        "owner": {
          "links": {
            "related": "api/boomerang/tax_categories/d867c0eb-67e6-44b7-b532-2de11701c3fd"
          }
        }
      }
    }
...
```json
  {
  "data": {
    "id": "00491a69-1054-45c3-9b1c-97973e109dc5",
    "type": "tax_categories",
    "attributes": {
      "name": "Sales Tax",
      "default": false
    ...
    "relationships": {
      "tax_rates": {
        "data": [
          {
            "type": "tax_rates",
            "id": "5d0aab5b-ef8e-4a15-83f8-93e63c2ea8a0"
          }
        ]
      }
    }
  ...
  "included": [
    {
      ...
      "attributes": {
        ...
        "value": 21.0,
        "position": 1,
        "owner_id": "00491a69-1054-45c3-9b1c-97973e109dc5",
        "owner_type": "TaxCategory"
      },
      "relationships": {
        "owner": {
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/tax_categories/9b65c473-679b-4354-84d6-043ea661ff80' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "9b65c473-679b-4354-84d6-043ea661ff80",
        "type": "tax_categories",
        "attributes": {
          "name": "State Tax",
          "tax_rates_attributes": [
            ...
            {
              "id": "5f3ba692-43b4-4642-9a4b-fe9090ce3fb1",
              "_destroy": true
            }
          ]
        }
    ...
    "relationships": {
      "tax_rates": {
        "data": [
          {
            "type": "tax_rates",
            "id": "02860104-686f-4654-ae93-4944349dd5f7"
          }
        ]
      }
    }
  ...
  "included": [
    {
      ...
      "attributes": {
        ...
        "value": 9.0,
        "position": 2,
        "owner_id": "9b65c473-679b-4354-84d6-043ea661ff80",
        "owner_type": "TaxCategory"
      },
      "relationships": {
        "owner": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/tax_categories/a147e8a2-607b-4b1e-a217-28f79d8b471d' \
    --header 'content-type: application/json' \
```
