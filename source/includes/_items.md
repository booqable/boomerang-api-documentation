...
```json
  ...
  "data": [
    {
      "id": "0e4f3e41-e615-4e84-97d5-5ca980820e1b",
      "type": "bundles",
      "attributes": {
        "created_at": "2023-02-20T10:24:03+00:00",
        "updated_at": "2023-02-20T10:24:03+00:00",
        "archived": false,
        "archived_at": null,
        "type": "bundles",
        "name": "iPad Bundle",
      ...
      "relationships": {
        ...
        "bundle_items": {
          "links": {
            "related": "api/boomerang/bundle_items?filter[bundle_id]=0e4f3e41-e615-4e84-97d5-5ca980820e1b"
          }
        },
        "inventory_levels": {
          "links": {
            "related": "api/boomerang/inventory_levels?filter[item_id]=0e4f3e41-e615-4e84-97d5-5ca980820e1b"
          }
        }
      }
    },
    {
      "id": "657adb21-fb4d-4bab-badd-f2510318603c",
      "type": "product_groups",
      "attributes": {
        "created_at": "2023-02-20T10:24:03+00:00",
        "updated_at": "2023-02-20T10:24:03+00:00",
        ...
        "properties": {},
        "photo_id": null,
        "tax_category_id": "8d77bd62-fc81-4983-84b9-5dd8b8ebf056",
      ...
      "relationships": {
        ...
        "tax_category": {
          "links": {
            "related": "api/boomerang/tax_categories/8d77bd62-fc81-4983-84b9-5dd8b8ebf056"
          }
        },
        "price_ruleset": {
          "links": {
        ...
        "inventory_levels": {
          "links": {
            "related": "api/boomerang/inventory_levels?filter[item_id]=657adb21-fb4d-4bab-badd-f2510318603c"
          }
        },
        "properties": {
          "links": {
            "related": "api/boomerang/properties?filter[owner_id]=657adb21-fb4d-4bab-badd-f2510318603c&filter[owner_type]=product_groups"
          }
        },
        "products": {
          "links": {
            "related": "api/boomerang/products?filter[product_group_id]=657adb21-fb4d-4bab-badd-f2510318603c"
          }
        }
      }
    },
    {
      "id": "04e43635-ca21-423f-9331-fe1924328d59",
      "type": "products",
      "attributes": {
        "created_at": "2023-02-20T10:24:03+00:00",
        "updated_at": "2023-02-20T10:24:03+00:00",
        ...
        "allow_shortage": true,
        "shortage_limit": 3,
        "product_group_id": "657adb21-fb4d-4bab-badd-f2510318603c"
      },
      "relationships": {
        "photo": {
          "links": {
        ...
        "inventory_levels": {
          "links": {
            "related": "api/boomerang/inventory_levels?filter[item_id]=04e43635-ca21-423f-9331-fe1924328d59"
          }
        },
        "properties": {
          "links": {
            "related": "api/boomerang/properties?filter[owner_id]=657adb21-fb4d-4bab-badd-f2510318603c&filter[owner_type]=products"
          }
        },
        "product_group": {
          "links": {
            "related": "api/boomerang/product_groups/657adb21-fb4d-4bab-badd-f2510318603c"
          }
        },
        "barcode": {
          "links": {
            "related": "api/boomerang/barcodes?filter[owner_id]=04e43635-ca21-423f-9331-fe1924328d59&filter[owner_type]=products"
          }
        }
      }
    }
...
```json
  ...
  "data": [
    {
      "id": "050aff4a-bf59-4267-ac91-906c9b336297"
    },
    {
      "id": "016455be-6991-43a6-a6eb-ff2915914c9a"
    },
    {
      "id": "73889a71-539f-4c49-9e75-a52bc4d20d81"
    },
    {
      "id": "4d7b0af5-f4ea-4af6-b41a-20322bc7e648"
    },
    {
      "id": "d29d857b-1b68-48cc-97e6-4560a9c1dd31"
    }
  ]
}
```
