...
```json
  ...
  "data": [
    {
      "id": "95569d3e-53c2-46bb-b93e-6d4b30676953",
      "type": "bundles",
      "attributes": {
        "created_at": "2023-02-03T11:10:28+00:00",
        "updated_at": "2023-02-03T11:10:28+00:00",
        "archived": false,
        "archived_at": null,
        "type": "bundles",
        "name": "iPad Bundle",
      ...
      "relationships": {
        ...
        "bundle_items": {
          "links": {
            "related": "api/boomerang/bundle_items?filter[bundle_id]=95569d3e-53c2-46bb-b93e-6d4b30676953"
          }
        },
        "inventory_levels": {
          "links": {
            "related": "api/boomerang/inventory_levels?filter[item_id]=95569d3e-53c2-46bb-b93e-6d4b30676953"
          }
        }
      }
    },
    {
      "id": "0c66cf11-8206-4aa4-b5ff-21c7f1027b79",
      "type": "product_groups",
      "attributes": {
        ...
        "tax_category_id": "9e1c12d5-03ac-4e90-8ea0-9938aa5eaaae",
      ...
      "relationships": {
        ...
        "products": {
          "links": {
            "related": "api/boomerang/products?filter[product_group_id]=0c66cf11-8206-4aa4-b5ff-21c7f1027b79"
          }
        },
        "tax_category": {
          "links": {
            "related": "api/boomerang/tax_categories/9e1c12d5-03ac-4e90-8ea0-9938aa5eaaae"
          }
        },
        "price_ruleset": {
          "links": {
        ...
        "properties": {
          "links": {
            "related": "api/boomerang/properties?filter[owner_id]=0c66cf11-8206-4aa4-b5ff-21c7f1027b79&filter[owner_type]=product_groups"
          }
        }
      }
    },
    {
      "id": "0c4b0f9f-7f56-45dd-b40d-117652e1e0e1",
      "type": "products",
      "attributes": {
        "created_at": "2023-02-03T11:10:29+00:00",
        "updated_at": "2023-02-03T11:10:29+00:00",
        ...
        "allow_shortage": true,
        "shortage_limit": 3,
        "product_group_id": "0c66cf11-8206-4aa4-b5ff-21c7f1027b79",
        "tax_category_id": "9e1c12d5-03ac-4e90-8ea0-9938aa5eaaae",
        "price_structure_id": null,
        "price_ruleset_id": null
      },
      "relationships": {
        ...
        "product_group": {
          "links": {
            "related": "api/boomerang/product_groups/0c66cf11-8206-4aa4-b5ff-21c7f1027b79"
          }
        },
        "tax_category": {
          "links": {
        ...
        "barcode": {
          "links": {
            "related": "api/boomerang/barcodes?filter[owner_id]=0c4b0f9f-7f56-45dd-b40d-117652e1e0e1&filter[owner_type]=products"
          }
        },
        "price_structure": {
          "links": {
        ...
        "inventory_levels": {
          "links": {
            "related": "api/boomerang/inventory_levels?filter[item_id]=0c4b0f9f-7f56-45dd-b40d-117652e1e0e1"
          }
        },
        "price_ruleset": {
          "links": {
        ...
        "properties": {
          "links": {
            "related": "api/boomerang/properties?filter[owner_id]=0c66cf11-8206-4aa4-b5ff-21c7f1027b79&filter[owner_type]=products"
          }
        }
      }
    }
...
```json
  ...
  "data": [
    {
      "id": "769e22f2-70d6-4ac6-9b3e-56aee4fd3710"
    },
    {
      "id": "d0d83ba0-7e22-4e32-9d94-1ab9f783bdb4"
    },
    {
      "id": "d26681a8-59f3-44f8-bcd1-819f25fe7994"
    },
    {
      "id": "7e2cb8a7-36dc-4141-b10a-739e7640a265"
    },
    {
      "id": "03f21169-e549-4d3c-adf8-fc9a6068a150"
    }
  ]
}
```
