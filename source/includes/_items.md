...
```json
  ...
  "data": [
    {
      "id": "4e4b38cb-5697-4388-aa47-68127e6ebe08",
      "type": "bundles",
      "attributes": {
        "created_at": "2023-01-05T11:03:45+00:00",
        "updated_at": "2023-01-05T11:03:45+00:00",
        "archived": false,
        "archived_at": null,
        "type": "bundles",
        "name": "iPad Bundle",
      ...
      "relationships": {
        ...
        "bundle_items": {
          "links": {
            "related": "api/boomerang/bundle_items?filter[bundle_id]=4e4b38cb-5697-4388-aa47-68127e6ebe08"
          }
        },
        "inventory_levels": {
          "links": {
            "related": "api/boomerang/inventory_levels?filter[item_id]=4e4b38cb-5697-4388-aa47-68127e6ebe08"
          }
        }
      }
    },
    {
      "id": "307557b7-e809-40e2-a19f-2db85dfc44e4",
      "type": "product_groups",
      "attributes": {
        "created_at": "2023-01-05T11:03:45+00:00",
        "updated_at": "2023-01-05T11:03:45+00:00",
        ...
        "tax_category_id": "bd30c994-7fd1-4621-bd83-8ce6dd3f1f67",
      ...
      "relationships": {
        ...
        "products": {
          "links": {
            "related": "api/boomerang/products?filter[product_group_id]=307557b7-e809-40e2-a19f-2db85dfc44e4"
          }
        },
        "tax_category": {
          "links": {
            "related": "api/boomerang/tax_categories/bd30c994-7fd1-4621-bd83-8ce6dd3f1f67"
          }
        },
        "price_ruleset": {
          "links": {
        ...
        "properties": {
          "links": {
            "related": "api/boomerang/properties?filter[owner_id]=307557b7-e809-40e2-a19f-2db85dfc44e4&filter[owner_type]=product_groups"
          }
        }
      }
    },
    {
      "id": "ce603ee9-5003-433d-b807-de9e55ba2c35",
      "type": "products",
      "attributes": {
        "created_at": "2023-01-05T11:03:45+00:00",
        "updated_at": "2023-01-05T11:03:45+00:00",
        ...
        "allow_shortage": true,
        "shortage_limit": 3,
        "product_group_id": "307557b7-e809-40e2-a19f-2db85dfc44e4",
        "tax_category_id": "bd30c994-7fd1-4621-bd83-8ce6dd3f1f67",
        "price_structure_id": null,
        "price_ruleset_id": null
      },
      "relationships": {
        ...
        "product_group": {
          "links": {
            "related": "api/boomerang/product_groups/307557b7-e809-40e2-a19f-2db85dfc44e4"
          }
        },
        "tax_category": {
          "links": {
        ...
        "barcode": {
          "links": {
            "related": "api/boomerang/barcodes?filter[owner_id]=ce603ee9-5003-433d-b807-de9e55ba2c35&filter[owner_type]=products"
          }
        },
        "price_structure": {
          "links": {
        ...
        "inventory_levels": {
          "links": {
            "related": "api/boomerang/inventory_levels?filter[item_id]=ce603ee9-5003-433d-b807-de9e55ba2c35"
          }
        },
        "price_ruleset": {
          "links": {
        ...
        "properties": {
          "links": {
            "related": "api/boomerang/properties?filter[owner_id]=307557b7-e809-40e2-a19f-2db85dfc44e4&filter[owner_type]=products"
          }
        }
      }
    }
...
```json
  ...
  "data": [
    {
      "id": "4289eeda-f35d-4df3-8514-af0ed234b983"
    },
    {
      "id": "87e4dc0c-4b81-42d4-8f67-ee705116773b"
    },
    {
      "id": "29224b35-8037-449f-8959-e67f44685add"
    },
    {
      "id": "85262ca7-cb8f-49f6-85ae-21d5afebc999"
    },
    {
      "id": "4971ae84-6aae-4599-936b-3ca24616fb2d"
    }
  ]
}
```
