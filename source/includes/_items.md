...
```json
  ...
  "data": [
    {
      "id": "6078758f-dfcc-474c-bc8f-c018a06fd113",
      "type": "bundles",
      "attributes": {
      ...
      "relationships": {
        ...
        "bundle_items": {
          "links": {
            "related": "api/boomerang/bundle_items?filter[bundle_id]=6078758f-dfcc-474c-bc8f-c018a06fd113"
          }
        },
        "inventory_levels": {
          "links": {
            "related": "api/boomerang/inventory_levels?filter[item_id]=6078758f-dfcc-474c-bc8f-c018a06fd113"
          }
        }
      }
    },
    {
      "id": "0507b6b7-1770-4387-9ef1-34e6864c1baa",
      "type": "product_groups",
      "attributes": {
        "created_at": "2023-03-02T11:08:50+00:00",
        "updated_at": "2023-03-02T11:08:50+00:00",
        "archived": false,
        "archived_at": null,
        "type": "product_groups",
        "name": "iPad Pro",
        ...
        "properties": {},
        "photo_id": null,
        "tax_category_id": "c44fd56b-1131-45b8-ae1e-070bd90dceec",
      ...
      "relationships": {
        ...
        "tax_category": {
          "links": {
            "related": "api/boomerang/tax_categories/c44fd56b-1131-45b8-ae1e-070bd90dceec"
          }
        },
        "price_ruleset": {
          "links": {
        ...
        "inventory_levels": {
          "links": {
            "related": "api/boomerang/inventory_levels?filter[item_id]=0507b6b7-1770-4387-9ef1-34e6864c1baa"
          }
        },
        "properties": {
          "links": {
            "related": "api/boomerang/properties?filter[owner_id]=0507b6b7-1770-4387-9ef1-34e6864c1baa&filter[owner_type]=product_groups"
          }
        },
        "products": {
          "links": {
            "related": "api/boomerang/products?filter[product_group_id]=0507b6b7-1770-4387-9ef1-34e6864c1baa"
          }
        }
      }
    },
    {
      "id": "56497aae-9126-4209-adf4-41dc76cb1b8f",
      "type": "products",
      "attributes": {
        "created_at": "2023-03-02T11:08:50+00:00",
        "updated_at": "2023-03-02T11:08:50+00:00",
        ...
        "allow_shortage": true,
        "shortage_limit": 3,
        "product_group_id": "0507b6b7-1770-4387-9ef1-34e6864c1baa"
      },
      "relationships": {
        "photo": {
          "links": {
        ...
        "inventory_levels": {
          "links": {
            "related": "api/boomerang/inventory_levels?filter[item_id]=56497aae-9126-4209-adf4-41dc76cb1b8f"
          }
        },
        "properties": {
          "links": {
            "related": "api/boomerang/properties?filter[owner_id]=0507b6b7-1770-4387-9ef1-34e6864c1baa&filter[owner_type]=products"
          }
        },
        "product_group": {
          "links": {
            "related": "api/boomerang/product_groups/0507b6b7-1770-4387-9ef1-34e6864c1baa"
          }
        },
        "barcode": {
          "links": {
            "related": "api/boomerang/barcodes?filter[owner_id]=56497aae-9126-4209-adf4-41dc76cb1b8f&filter[owner_type]=products"
          }
        }
      }
    }
...
```json
  ...
  "data": [
    {
      "id": "3a0e2584-4695-4924-a6a2-e7df782a8ac1"
    },
    {
      "id": "dbc353b6-8d32-48c9-b2fc-c44a14a1465c"
    },
    {
      "id": "e6c02bb7-ba62-4062-996b-daf40044173c"
    },
    {
      "id": "292c2eb2-31f8-4461-8c5b-168b1ed0e4b8"
    },
    {
      "id": "b0aaaaa9-7024-40b8-9a1c-2f98fa7df053"
    }
  ]
}
```
