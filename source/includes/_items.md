...
```json
  ...
  "data": [
    {
      "id": "87062289-92f8-4265-8120-4f772142cb12",
      "type": "bundles",
      "attributes": {
      ...
      "relationships": {
        ...
        "bundle_items": {
          "links": {
            "related": "api/boomerang/bundle_items?filter[bundle_id]=87062289-92f8-4265-8120-4f772142cb12"
          }
        },
        "inventory_levels": {
          "links": {
            "related": "api/boomerang/inventory_levels?filter[item_id]=87062289-92f8-4265-8120-4f772142cb12"
          }
        }
      }
    },
    {
      "id": "952e4a9c-1486-42b1-b85b-be05def64e84",
      "type": "product_groups",
      "attributes": {
        ...
        "tax_category_id": "f6edfa0f-2445-4599-861a-effed136aea5",
      ...
      "relationships": {
        ...
        "products": {
          "links": {
            "related": "api/boomerang/products?filter[product_group_id]=952e4a9c-1486-42b1-b85b-be05def64e84"
          }
        },
        "tax_category": {
          "links": {
            "related": "api/boomerang/tax_categories/f6edfa0f-2445-4599-861a-effed136aea5"
          }
        },
        "price_ruleset": {
          "links": {
        ...
        "properties": {
          "links": {
            "related": "api/boomerang/properties?filter[owner_id]=952e4a9c-1486-42b1-b85b-be05def64e84&filter[owner_type]=product_groups"
          }
        }
      }
    },
    {
      "id": "c359348a-27fd-46ab-a8b4-9bef093b75fa",
      "type": "products",
      "attributes": {
        "created_at": "2023-02-09T10:19:35+00:00",
        "updated_at": "2023-02-09T10:19:35+00:00",
        ...
        "allow_shortage": true,
        "shortage_limit": 3,
        "product_group_id": "952e4a9c-1486-42b1-b85b-be05def64e84",
        "tax_category_id": "f6edfa0f-2445-4599-861a-effed136aea5",
        "price_structure_id": null,
        "price_ruleset_id": null
      },
      "relationships": {
        ...
        "product_group": {
          "links": {
            "related": "api/boomerang/product_groups/952e4a9c-1486-42b1-b85b-be05def64e84"
          }
        },
        "tax_category": {
          "links": {
        ...
        "barcode": {
          "links": {
            "related": "api/boomerang/barcodes?filter[owner_id]=c359348a-27fd-46ab-a8b4-9bef093b75fa&filter[owner_type]=products"
          }
        },
        "price_structure": {
          "links": {
        ...
        "inventory_levels": {
          "links": {
            "related": "api/boomerang/inventory_levels?filter[item_id]=c359348a-27fd-46ab-a8b4-9bef093b75fa"
          }
        },
        "price_ruleset": {
          "links": {
        ...
        "properties": {
          "links": {
            "related": "api/boomerang/properties?filter[owner_id]=952e4a9c-1486-42b1-b85b-be05def64e84&filter[owner_type]=products"
          }
        }
      }
    }
...
```json
  ...
  "data": [
    {
      "id": "152cf0c7-45a0-4529-9871-32aa001e21fd"
    },
    {
      "id": "19f6f327-4e49-4365-a550-d408a96600f3"
    },
    {
      "id": "9600b831-33a6-456a-acaf-aba87c00004f"
    },
    {
      "id": "f3fad9a7-867c-4055-b978-af0948b49a24"
    },
    {
      "id": "9ed98320-eb29-4794-9e2f-7061e979629d"
    }
  ]
}
```
