...
```json
  ...
  "data": [
    {
      "id": "5200b10f-2cef-4bb0-9d4d-7f3418eac09f",
      "type": "bundles",
      "attributes": {
        "created_at": "2023-02-14T11:07:00+00:00",
        "updated_at": "2023-02-14T11:07:00+00:00",
        "archived": false,
        "archived_at": null,
        "type": "bundles",
        "name": "iPad Bundle",
      ...
      "relationships": {
        ...
        "bundle_items": {
          "links": {
            "related": "api/boomerang/bundle_items?filter[bundle_id]=5200b10f-2cef-4bb0-9d4d-7f3418eac09f"
          }
        },
        "inventory_levels": {
          "links": {
            "related": "api/boomerang/inventory_levels?filter[item_id]=5200b10f-2cef-4bb0-9d4d-7f3418eac09f"
          }
        }
      }
    },
    {
      "id": "624aacbb-af54-41e9-8dad-1538d467cb54",
      "type": "product_groups",
      "attributes": {
        "created_at": "2023-02-14T11:07:00+00:00",
        "updated_at": "2023-02-14T11:07:00+00:00",
        ...
        "properties": {},
        "photo_id": null,
        "tax_category_id": "b819a13c-38ee-434e-89b1-2798f4571c3e",
      ...
      "relationships": {
        ...
        "tax_category": {
          "links": {
            "related": "api/boomerang/tax_categories/b819a13c-38ee-434e-89b1-2798f4571c3e"
          }
        },
        "price_ruleset": {
          "links": {
        ...
        "inventory_levels": {
          "links": {
            "related": "api/boomerang/inventory_levels?filter[item_id]=624aacbb-af54-41e9-8dad-1538d467cb54"
          }
        },
        "properties": {
          "links": {
            "related": "api/boomerang/properties?filter[owner_id]=624aacbb-af54-41e9-8dad-1538d467cb54&filter[owner_type]=product_groups"
          }
        },
        "products": {
          "links": {
            "related": "api/boomerang/products?filter[product_group_id]=624aacbb-af54-41e9-8dad-1538d467cb54"
          }
        }
      }
    },
    {
      "id": "2b5ca318-440c-4a94-9a1c-8f71a497f2a0",
      "type": "products",
      "attributes": {
        "created_at": "2023-02-14T11:07:00+00:00",
        "updated_at": "2023-02-14T11:07:00+00:00",
        ...
        "allow_shortage": true,
        "shortage_limit": 3,
        "product_group_id": "624aacbb-af54-41e9-8dad-1538d467cb54"
      },
      "relationships": {
        "photo": {
          "links": {
        ...
        "inventory_levels": {
          "links": {
            "related": "api/boomerang/inventory_levels?filter[item_id]=2b5ca318-440c-4a94-9a1c-8f71a497f2a0"
          }
        },
        "properties": {
          "links": {
            "related": "api/boomerang/properties?filter[owner_id]=624aacbb-af54-41e9-8dad-1538d467cb54&filter[owner_type]=products"
          }
        },
        "product_group": {
          "links": {
            "related": "api/boomerang/product_groups/624aacbb-af54-41e9-8dad-1538d467cb54"
          }
        },
        "barcode": {
          "links": {
            "related": "api/boomerang/barcodes?filter[owner_id]=2b5ca318-440c-4a94-9a1c-8f71a497f2a0&filter[owner_type]=products"
          }
        }
      }
    }
...
```json
  ...
  "data": [
    {
      "id": "f04dbfee-b397-4c8d-878d-3fe081aed040"
    },
    {
      "id": "f747fd06-419a-4511-8937-dcf0077e2bdb"
    },
    {
      "id": "79c34395-32bb-4b9f-ae74-0dcb4d2d1d67"
    },
    {
      "id": "3a0cf044-ff52-446c-a9ab-7b0e02f76903"
    },
    {
      "id": "a5e76ada-9aef-4835-8d02-7dd919b90b51"
    }
  ]
}
```
