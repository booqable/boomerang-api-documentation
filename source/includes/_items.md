...
```json
  ...
  "data": [
    {
      "id": "512750b3-b494-449d-8ef9-bb3ba8561a45",
      "type": "bundles",
      "attributes": {
        "created_at": "2023-02-07T14:51:20+00:00",
        "updated_at": "2023-02-07T14:51:20+00:00",
        "archived": false,
        "archived_at": null,
        "type": "bundles",
        "name": "iPad Bundle",
      ...
      "relationships": {
        ...
        "bundle_items": {
          "links": {
            "related": "api/boomerang/bundle_items?filter[bundle_id]=512750b3-b494-449d-8ef9-bb3ba8561a45"
          }
        },
        "inventory_levels": {
          "links": {
            "related": "api/boomerang/inventory_levels?filter[item_id]=512750b3-b494-449d-8ef9-bb3ba8561a45"
          }
        }
      }
    },
    {
      "id": "547ba405-07db-4d5e-98d0-c48dfef53454",
      "type": "product_groups",
      "attributes": {
        "created_at": "2023-02-07T14:51:20+00:00",
        "updated_at": "2023-02-07T14:51:20+00:00",
        ...
        "tax_category_id": "982ab665-7a7d-45d9-8e03-175c7cfa4d93",
      ...
      "relationships": {
        ...
        "products": {
          "links": {
            "related": "api/boomerang/products?filter[product_group_id]=547ba405-07db-4d5e-98d0-c48dfef53454"
          }
        },
        "tax_category": {
          "links": {
            "related": "api/boomerang/tax_categories/982ab665-7a7d-45d9-8e03-175c7cfa4d93"
          }
        },
        "price_ruleset": {
          "links": {
        ...
        "properties": {
          "links": {
            "related": "api/boomerang/properties?filter[owner_id]=547ba405-07db-4d5e-98d0-c48dfef53454&filter[owner_type]=product_groups"
          }
        }
      }
    },
    {
      "id": "7e67f84f-9607-4ae6-aaeb-083167002b0f",
      "type": "products",
      "attributes": {
        "created_at": "2023-02-07T14:51:20+00:00",
        "updated_at": "2023-02-07T14:51:20+00:00",
        ...
        "allow_shortage": true,
        "shortage_limit": 3,
        "product_group_id": "547ba405-07db-4d5e-98d0-c48dfef53454",
        "tax_category_id": "982ab665-7a7d-45d9-8e03-175c7cfa4d93",
        "price_structure_id": null,
        "price_ruleset_id": null
      },
      "relationships": {
        ...
        "product_group": {
          "links": {
            "related": "api/boomerang/product_groups/547ba405-07db-4d5e-98d0-c48dfef53454"
          }
        },
        "tax_category": {
          "links": {
        ...
        "barcode": {
          "links": {
            "related": "api/boomerang/barcodes?filter[owner_id]=7e67f84f-9607-4ae6-aaeb-083167002b0f&filter[owner_type]=products"
          }
        },
        "price_structure": {
          "links": {
        ...
        "inventory_levels": {
          "links": {
            "related": "api/boomerang/inventory_levels?filter[item_id]=7e67f84f-9607-4ae6-aaeb-083167002b0f"
          }
        },
        "price_ruleset": {
          "links": {
        ...
        "properties": {
          "links": {
            "related": "api/boomerang/properties?filter[owner_id]=547ba405-07db-4d5e-98d0-c48dfef53454&filter[owner_type]=products"
          }
        }
      }
    }
...
```json
  ...
  "data": [
    {
      "id": "01ba8295-201f-46a7-820c-dc6b5961e787"
    },
    {
      "id": "59bf9798-5f93-49f7-8edb-72840c63cca0"
    },
    {
      "id": "8eab5e58-8039-4fd4-bf2b-1737064c16d8"
    },
    {
      "id": "ade21680-4e5c-4cd1-a79a-e72a9a7b9a62"
    },
    {
      "id": "03250f17-ebc8-4897-9b4b-15f9f68708ee"
    }
  ]
}
```
