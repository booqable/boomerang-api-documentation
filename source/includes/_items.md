...
```json
  ...
  "data": [
    {
      "id": "d18ff7aa-c2c6-45aa-929b-b19fc147f4be",
      "type": "bundles",
      "attributes": {
      ...
      "relationships": {
        ...
        "bundle_items": {
          "links": {
            "related": "api/boomerang/bundle_items?filter[bundle_id]=d18ff7aa-c2c6-45aa-929b-b19fc147f4be"
          }
        },
        "inventory_levels": {
          "links": {
            "related": "api/boomerang/inventory_levels?filter[item_id]=d18ff7aa-c2c6-45aa-929b-b19fc147f4be"
          }
        }
      }
    },
    {
      "id": "4a583ccb-30a3-43ed-82cb-08d96647430f",
      "type": "product_groups",
      "attributes": {
        "created_at": "2023-02-02T07:56:33+00:00",
        "updated_at": "2023-02-02T07:56:33+00:00",
        ...
        "tax_category_id": "f11e247a-b26a-46cf-ae8b-d8e10945d258",
      ...
      "relationships": {
        ...
        "products": {
          "links": {
            "related": "api/boomerang/products?filter[product_group_id]=4a583ccb-30a3-43ed-82cb-08d96647430f"
          }
        },
        "tax_category": {
          "links": {
            "related": "api/boomerang/tax_categories/f11e247a-b26a-46cf-ae8b-d8e10945d258"
          }
        },
        "price_ruleset": {
          "links": {
        ...
        "properties": {
          "links": {
            "related": "api/boomerang/properties?filter[owner_id]=4a583ccb-30a3-43ed-82cb-08d96647430f&filter[owner_type]=product_groups"
          }
        }
      }
    },
    {
      "id": "d5be78f7-4b9e-4c53-a808-76ec2e2d8aff",
      "type": "products",
      "attributes": {
        "created_at": "2023-02-02T07:56:33+00:00",
        "updated_at": "2023-02-02T07:56:33+00:00",
        ...
        "allow_shortage": true,
        "shortage_limit": 3,
        "product_group_id": "4a583ccb-30a3-43ed-82cb-08d96647430f",
        "tax_category_id": "f11e247a-b26a-46cf-ae8b-d8e10945d258",
        "price_structure_id": null,
        "price_ruleset_id": null
      },
      "relationships": {
        ...
        "product_group": {
          "links": {
            "related": "api/boomerang/product_groups/4a583ccb-30a3-43ed-82cb-08d96647430f"
          }
        },
        "tax_category": {
          "links": {
        ...
        "barcode": {
          "links": {
            "related": "api/boomerang/barcodes?filter[owner_id]=d5be78f7-4b9e-4c53-a808-76ec2e2d8aff&filter[owner_type]=products"
          }
        },
        "price_structure": {
          "links": {
        ...
        "inventory_levels": {
          "links": {
            "related": "api/boomerang/inventory_levels?filter[item_id]=d5be78f7-4b9e-4c53-a808-76ec2e2d8aff"
          }
        },
        "price_ruleset": {
          "links": {
        ...
        "properties": {
          "links": {
            "related": "api/boomerang/properties?filter[owner_id]=4a583ccb-30a3-43ed-82cb-08d96647430f&filter[owner_type]=products"
          }
        }
      }
    }
...
```json
  ...
  "data": [
    {
      "id": "245af58b-5483-4366-a6bd-b7d03ab41822"
    },
    {
      "id": "41d91520-a4bd-4f0d-8929-5a26ebd009a1"
    },
    {
      "id": "668db0db-f2a5-4b90-8129-9c02dbd394f3"
    },
    {
      "id": "fbe20323-b11b-49df-a392-6368e77990c2"
    },
    {
      "id": "6e72d444-f215-48af-a422-750454eba5ec"
    }
  ]
}
```
