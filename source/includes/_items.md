...
```json
  ...
  "data": [
    {
      "id": "08a8cf40-6b04-492d-b621-e8a1c927a9a6",
      "type": "bundles",
      "attributes": {
      ...
      "relationships": {
        ...
        "bundle_items": {
          "links": {
            "related": "api/boomerang/bundle_items?filter[bundle_id]=08a8cf40-6b04-492d-b621-e8a1c927a9a6"
          }
        },
        "inventory_levels": {
          "links": {
            "related": "api/boomerang/inventory_levels?filter[item_id]=08a8cf40-6b04-492d-b621-e8a1c927a9a6"
          }
        }
      }
    },
    {
      "id": "135259d7-4bce-47bd-bdb4-98ac75b9f304",
      "type": "product_groups",
      "attributes": {
        "created_at": "2023-02-07T15:00:48+00:00",
        "updated_at": "2023-02-07T15:00:48+00:00",
        ...
        "tax_category_id": "099c7a05-e636-4889-8407-320748d51146",
      ...
      "relationships": {
        ...
        "products": {
          "links": {
            "related": "api/boomerang/products?filter[product_group_id]=135259d7-4bce-47bd-bdb4-98ac75b9f304"
          }
        },
        "tax_category": {
          "links": {
            "related": "api/boomerang/tax_categories/099c7a05-e636-4889-8407-320748d51146"
          }
        },
        "price_ruleset": {
          "links": {
        ...
        "properties": {
          "links": {
            "related": "api/boomerang/properties?filter[owner_id]=135259d7-4bce-47bd-bdb4-98ac75b9f304&filter[owner_type]=product_groups"
          }
        }
      }
    },
    {
      "id": "650d8b8d-6e8d-4ab5-a4b6-d446a57717fd",
      "type": "products",
      "attributes": {
        "created_at": "2023-02-07T15:00:48+00:00",
        "updated_at": "2023-02-07T15:00:48+00:00",
        ...
        "allow_shortage": true,
        "shortage_limit": 3,
        "product_group_id": "135259d7-4bce-47bd-bdb4-98ac75b9f304",
        "tax_category_id": "099c7a05-e636-4889-8407-320748d51146",
        "price_structure_id": null,
        "price_ruleset_id": null
      },
      "relationships": {
        ...
        "product_group": {
          "links": {
            "related": "api/boomerang/product_groups/135259d7-4bce-47bd-bdb4-98ac75b9f304"
          }
        },
        "tax_category": {
          "links": {
        ...
        "barcode": {
          "links": {
            "related": "api/boomerang/barcodes?filter[owner_id]=650d8b8d-6e8d-4ab5-a4b6-d446a57717fd&filter[owner_type]=products"
          }
        },
        "price_structure": {
          "links": {
        ...
        "inventory_levels": {
          "links": {
            "related": "api/boomerang/inventory_levels?filter[item_id]=650d8b8d-6e8d-4ab5-a4b6-d446a57717fd"
          }
        },
        "price_ruleset": {
          "links": {
        ...
        "properties": {
          "links": {
            "related": "api/boomerang/properties?filter[owner_id]=135259d7-4bce-47bd-bdb4-98ac75b9f304&filter[owner_type]=products"
          }
        }
      }
    }
...
```json
  ...
  "data": [
    {
      "id": "8cefe7d9-cc54-46d6-9c2d-92f215f8ba02"
    },
    {
      "id": "129557ac-1b44-4168-a692-9c9a7dafbf3b"
    },
    {
      "id": "b28ca133-6de0-473a-8e81-c2aad631c683"
    },
    {
      "id": "88fda5a4-de44-4be0-aaf6-08a8455cd2bc"
    },
    {
      "id": "3336cac9-32f8-44df-9f3b-0ceb374857a6"
    }
  ]
}
```
