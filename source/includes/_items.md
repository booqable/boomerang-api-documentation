...
```json
  ...
  "data": [
    {
      "id": "23f818f6-b445-4230-9894-77d2fd7ce216",
      "type": "bundles",
      "attributes": {
        "created_at": "2022-06-16T15:45:52+00:00",
        "updated_at": "2022-06-16T15:45:52+00:00",
        "archived": false,
        "archived_at": null,
        "type": "bundles",
        "name": "iPad Bundle",
      ...
      "relationships": {
        ...
        "bundle_items": {
          "links": {
            "related": "api/boomerang/bundle_items?filter[bundle_id]=23f818f6-b445-4230-9894-77d2fd7ce216"
          }
        },
        "categories": {
          "links": {
            "related": "api/boomerang/categories?filter[item_id]=23f818f6-b445-4230-9894-77d2fd7ce216"
          }
        }
      }
    },
    {
      "id": "f31d38f7-e70f-4480-a746-61173b16ca14",
      "type": "product_groups",
      "attributes": {
        "created_at": "2022-06-16T15:45:52+00:00",
        "updated_at": "2022-06-16T15:45:52+00:00",
        ...
        "tax_category_id": "ebb3ea61-3a98-4171-94b7-c904960f9225"
      },
      "relationships": {
        "categories": {
          "links": {
            "related": "api/boomerang/categories?filter[item_id]=f31d38f7-e70f-4480-a746-61173b16ca14"
          }
        },
        "photo": {
          "links": {
        ...
        "products": {
          "links": {
            "related": "api/boomerang/products?filter[product_group_id]=f31d38f7-e70f-4480-a746-61173b16ca14"
          }
        },
        "tax_category": {
          "links": {
            "related": "api/boomerang/tax_categories/ebb3ea61-3a98-4171-94b7-c904960f9225"
          }
        },
        "properties": {
          "links": {
            "related": "api/boomerang/properties?filter[owner_id]=f31d38f7-e70f-4480-a746-61173b16ca14&filter[owner_type]=product_groups"
          }
        }
      }
    },
    {
      "id": "1f5a7146-0665-427f-957a-27669fb3b6c4",
      "type": "products",
      "attributes": {
        "created_at": "2022-06-16T15:45:52+00:00",
        "updated_at": "2022-06-16T15:45:52+00:00",
        ...
        "allow_shortage": true,
        "shortage_limit": 3,
        "product_group_id": "f31d38f7-e70f-4480-a746-61173b16ca14",
        "tax_category_id": "ebb3ea61-3a98-4171-94b7-c904960f9225",
      ...
      "relationships": {
        ...
        "product_group": {
          "links": {
            "related": "api/boomerang/product_groups/f31d38f7-e70f-4480-a746-61173b16ca14"
          }
        },
        "tax_category": {
          "links": {
        ...
        "barcode": {
          "links": {
            "related": "api/boomerang/barcodes?filter[owner_id]=1f5a7146-0665-427f-957a-27669fb3b6c4&filter[owner_type]=products"
          }
        },
        "price_structure": {
          "links": {
        ...
        "properties": {
          "links": {
            "related": "api/boomerang/properties?filter[owner_id]=f31d38f7-e70f-4480-a746-61173b16ca14&filter[owner_type]=products"
          }
        },
        "categories": {
          "links": {
            "related": "/api/boomerang/categories?filter%5Bitem_id%5D=f31d38f7-e70f-4480-a746-61173b16ca14"
          }
        }
      }
    }
...
```json
  ...
  "data": [
    {
      "id": "f0d84aba-7091-4066-a69d-7de86c0bcb3e"
    },
    {
      "id": "f1873d44-5541-4b41-9791-a1c44cbc9e80"
    },
    {
      "id": "b63f7ff9-2b58-4b7d-aebe-c8f97aeef3ea"
    },
    {
      "id": "4d174bf6-8ac5-445f-aa7a-89467b80c06f"
    },
    {
      "id": "9e112117-5c62-425b-b6bb-a15ed1c340a1"
    }
  ]
}
```
