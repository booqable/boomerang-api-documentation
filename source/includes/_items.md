...
```json
  ...
  "data": [
    {
      "id": "b7256ef2-c6e2-4dd4-99b6-b33b88717b84",
      "type": "bundles",
      "attributes": {
      ...
      "relationships": {
        ...
        "bundle_items": {
          "links": {
            "related": "api/boomerang/bundle_items?filter[bundle_id]=b7256ef2-c6e2-4dd4-99b6-b33b88717b84"
          }
        },
        "inventory_levels": {
          "links": {
            "related": "api/boomerang/inventory_levels?filter[item_id]=b7256ef2-c6e2-4dd4-99b6-b33b88717b84"
          }
        }
      }
    },
    {
      "id": "61e97ffa-d400-4f9e-879f-dad7f94a3559",
      "type": "product_groups",
      "attributes": {
        "created_at": "2023-02-28T08:11:48+00:00",
        "updated_at": "2023-02-28T08:11:48+00:00",
        ...
        "properties": {},
        "photo_id": null,
        "tax_category_id": "650d837e-14cf-4b34-89a2-73fe2f00fa59",
      ...
      "relationships": {
        ...
        "tax_category": {
          "links": {
            "related": "api/boomerang/tax_categories/650d837e-14cf-4b34-89a2-73fe2f00fa59"
          }
        },
        "price_ruleset": {
          "links": {
        ...
        "inventory_levels": {
          "links": {
            "related": "api/boomerang/inventory_levels?filter[item_id]=61e97ffa-d400-4f9e-879f-dad7f94a3559"
          }
        },
        "properties": {
          "links": {
            "related": "api/boomerang/properties?filter[owner_id]=61e97ffa-d400-4f9e-879f-dad7f94a3559&filter[owner_type]=product_groups"
          }
        },
        "products": {
          "links": {
            "related": "api/boomerang/products?filter[product_group_id]=61e97ffa-d400-4f9e-879f-dad7f94a3559"
          }
        }
      }
    },
    {
      "id": "31afd350-5daf-4a88-8bda-6bce44d2d059",
      "type": "products",
      "attributes": {
        "created_at": "2023-02-28T08:11:48+00:00",
        "updated_at": "2023-02-28T08:11:48+00:00",
        ...
        "allow_shortage": true,
        "shortage_limit": 3,
        "product_group_id": "61e97ffa-d400-4f9e-879f-dad7f94a3559"
      },
      "relationships": {
        "photo": {
          "links": {
        ...
        "inventory_levels": {
          "links": {
            "related": "api/boomerang/inventory_levels?filter[item_id]=31afd350-5daf-4a88-8bda-6bce44d2d059"
          }
        },
        "properties": {
          "links": {
            "related": "api/boomerang/properties?filter[owner_id]=61e97ffa-d400-4f9e-879f-dad7f94a3559&filter[owner_type]=products"
          }
        },
        "product_group": {
          "links": {
            "related": "api/boomerang/product_groups/61e97ffa-d400-4f9e-879f-dad7f94a3559"
          }
        },
        "barcode": {
          "links": {
            "related": "api/boomerang/barcodes?filter[owner_id]=31afd350-5daf-4a88-8bda-6bce44d2d059&filter[owner_type]=products"
          }
        }
      }
    }
...
```json
  ...
  "data": [
    {
      "id": "9b29ee8e-862f-465b-8453-181fbe485302"
    },
    {
      "id": "772610b7-0f11-49f9-bd5d-c75cd31501fa"
    },
    {
      "id": "9bc65511-c84f-46ff-9ab7-775016d985c2"
    },
    {
      "id": "7935f1eb-8aee-4c72-bb02-8a2522293611"
    },
    {
      "id": "b97b6bad-a43c-40ff-bb1e-81124434de6a"
    }
  ]
}
```
