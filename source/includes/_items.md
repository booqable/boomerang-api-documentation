...
```json
  ...
  "data": [
    {
      "id": "e2fb2994-1ff1-42cd-9756-d29050a1cbea",
      "type": "bundles",
      "attributes": {
        "created_at": "2023-02-09T13:20:11+00:00",
        "updated_at": "2023-02-09T13:20:11+00:00",
        "archived": false,
        "archived_at": null,
        "type": "bundles",
        "name": "iPad Bundle",
      ...
      "relationships": {
        ...
        "bundle_items": {
          "links": {
            "related": "api/boomerang/bundle_items?filter[bundle_id]=e2fb2994-1ff1-42cd-9756-d29050a1cbea"
          }
        },
        "inventory_levels": {
          "links": {
            "related": "api/boomerang/inventory_levels?filter[item_id]=e2fb2994-1ff1-42cd-9756-d29050a1cbea"
          }
        }
      }
    },
    {
      "id": "cd8e76e8-fcd2-4881-a59e-3e5a3d55f63b",
      "type": "product_groups",
      "attributes": {
        "created_at": "2023-02-09T13:20:11+00:00",
        "updated_at": "2023-02-09T13:20:11+00:00",
        ...
        "tax_category_id": "dd41e69e-5825-49bd-beb9-946c2e94428c",
      ...
      "relationships": {
        ...
        "products": {
          "links": {
            "related": "api/boomerang/products?filter[product_group_id]=cd8e76e8-fcd2-4881-a59e-3e5a3d55f63b"
          }
        },
        "tax_category": {
          "links": {
            "related": "api/boomerang/tax_categories/dd41e69e-5825-49bd-beb9-946c2e94428c"
          }
        },
        "price_ruleset": {
          "links": {
        ...
        "properties": {
          "links": {
            "related": "api/boomerang/properties?filter[owner_id]=cd8e76e8-fcd2-4881-a59e-3e5a3d55f63b&filter[owner_type]=product_groups"
          }
        }
      }
    },
    {
      "id": "60e24919-c4d8-41fa-8e4f-b4fecc3d6717",
      "type": "products",
      "attributes": {
        "created_at": "2023-02-09T13:20:11+00:00",
        "updated_at": "2023-02-09T13:20:11+00:00",
        ...
        "allow_shortage": true,
        "shortage_limit": 3,
        "product_group_id": "cd8e76e8-fcd2-4881-a59e-3e5a3d55f63b",
        "tax_category_id": "dd41e69e-5825-49bd-beb9-946c2e94428c",
        "price_structure_id": null,
        "price_ruleset_id": null
      },
      "relationships": {
        ...
        "product_group": {
          "links": {
            "related": "api/boomerang/product_groups/cd8e76e8-fcd2-4881-a59e-3e5a3d55f63b"
          }
        },
        "tax_category": {
          "links": {
        ...
        "barcode": {
          "links": {
            "related": "api/boomerang/barcodes?filter[owner_id]=60e24919-c4d8-41fa-8e4f-b4fecc3d6717&filter[owner_type]=products"
          }
        },
        "price_structure": {
          "links": {
        ...
        "inventory_levels": {
          "links": {
            "related": "api/boomerang/inventory_levels?filter[item_id]=60e24919-c4d8-41fa-8e4f-b4fecc3d6717"
          }
        },
        "price_ruleset": {
          "links": {
        ...
        "properties": {
          "links": {
            "related": "api/boomerang/properties?filter[owner_id]=cd8e76e8-fcd2-4881-a59e-3e5a3d55f63b&filter[owner_type]=products"
          }
        }
      }
    }
...
```json
  ...
  "data": [
    {
      "id": "de9c7e99-8a29-4b78-a91a-538dbc8233cf"
    },
    {
      "id": "78a9c44d-8aae-43bd-b18e-0a0c5b321342"
    },
    {
      "id": "bf0198af-3e87-47e8-9be6-e58fcacbc194"
    },
    {
      "id": "b330a93f-de3f-4a4c-bf00-d9ec97b37104"
    },
    {
      "id": "04439ef5-0724-486d-9502-df62ab0ed582"
    }
  ]
}
```
