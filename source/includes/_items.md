...
```json
  ...
  "data": [
    {
      "id": "b0acd136-c38b-4fc9-b072-6ea6c657b151",
      "type": "bundles",
      "attributes": {
        "created_at": "2023-02-17T10:33:37+00:00",
        "updated_at": "2023-02-17T10:33:37+00:00",
        "archived": false,
        "archived_at": null,
        "type": "bundles",
        "name": "iPad Bundle",
      ...
      "relationships": {
        ...
        "bundle_items": {
          "links": {
            "related": "api/boomerang/bundle_items?filter[bundle_id]=b0acd136-c38b-4fc9-b072-6ea6c657b151"
          }
        },
        "inventory_levels": {
          "links": {
            "related": "api/boomerang/inventory_levels?filter[item_id]=b0acd136-c38b-4fc9-b072-6ea6c657b151"
          }
        }
      }
    },
    {
      "id": "2bda843a-6ff6-4443-9e4d-3fa33f01c617",
      "type": "product_groups",
      "attributes": {
        "created_at": "2023-02-17T10:33:37+00:00",
        "updated_at": "2023-02-17T10:33:37+00:00",
        ...
        "properties": {},
        "photo_id": null,
        "tax_category_id": "38009d0a-962d-4946-82a2-07c4261fbd68",
      ...
      "relationships": {
        ...
        "tax_category": {
          "links": {
            "related": "api/boomerang/tax_categories/38009d0a-962d-4946-82a2-07c4261fbd68"
          }
        },
        "price_ruleset": {
          "links": {
        ...
        "inventory_levels": {
          "links": {
            "related": "api/boomerang/inventory_levels?filter[item_id]=2bda843a-6ff6-4443-9e4d-3fa33f01c617"
          }
        },
        "properties": {
          "links": {
            "related": "api/boomerang/properties?filter[owner_id]=2bda843a-6ff6-4443-9e4d-3fa33f01c617&filter[owner_type]=product_groups"
          }
        },
        "products": {
          "links": {
            "related": "api/boomerang/products?filter[product_group_id]=2bda843a-6ff6-4443-9e4d-3fa33f01c617"
          }
        }
      }
    },
    {
      "id": "9e9b15a6-3875-43b6-85a4-01c2ebb30545",
      "type": "products",
      "attributes": {
        "created_at": "2023-02-17T10:33:37+00:00",
        "updated_at": "2023-02-17T10:33:37+00:00",
        ...
        "allow_shortage": true,
        "shortage_limit": 3,
        "product_group_id": "2bda843a-6ff6-4443-9e4d-3fa33f01c617"
      },
      "relationships": {
        "photo": {
          "links": {
        ...
        "inventory_levels": {
          "links": {
            "related": "api/boomerang/inventory_levels?filter[item_id]=9e9b15a6-3875-43b6-85a4-01c2ebb30545"
          }
        },
        "properties": {
          "links": {
            "related": "api/boomerang/properties?filter[owner_id]=2bda843a-6ff6-4443-9e4d-3fa33f01c617&filter[owner_type]=products"
          }
        },
        "product_group": {
          "links": {
            "related": "api/boomerang/product_groups/2bda843a-6ff6-4443-9e4d-3fa33f01c617"
          }
        },
        "barcode": {
          "links": {
            "related": "api/boomerang/barcodes?filter[owner_id]=9e9b15a6-3875-43b6-85a4-01c2ebb30545&filter[owner_type]=products"
          }
        }
      }
    }
...
```json
  ...
  "data": [
    {
      "id": "4d0bb3e5-86e0-46d3-972b-4d5a3d9dee60"
    },
    {
      "id": "5582e46c-2fc2-4321-97be-5ad5896ef3ea"
    },
    {
      "id": "fde5cd6a-ae21-4e5c-a026-67ddd3b00e67"
    },
    {
      "id": "642ae733-aec6-45d0-9796-344e4cb490ba"
    },
    {
      "id": "804c5462-3307-4d9f-8966-56b3a8621139"
    }
  ]
}
```
