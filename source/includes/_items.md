...
```json
  ...
  "data": [
    {
      "id": "caf84e8a-6db3-4781-892a-f7e852547602",
      "type": "bundles",
      "attributes": {
        "created_at": "2023-02-06T08:48:35+00:00",
        "updated_at": "2023-02-06T08:48:35+00:00",
        "archived": false,
        "archived_at": null,
        "type": "bundles",
        "name": "iPad Bundle",
      ...
      "relationships": {
        ...
        "bundle_items": {
          "links": {
            "related": "api/boomerang/bundle_items?filter[bundle_id]=caf84e8a-6db3-4781-892a-f7e852547602"
          }
        },
        "inventory_levels": {
          "links": {
            "related": "api/boomerang/inventory_levels?filter[item_id]=caf84e8a-6db3-4781-892a-f7e852547602"
          }
        }
      }
    },
    {
      "id": "574fe7eb-c5da-48d5-ba04-fa238d1fee19",
      "type": "product_groups",
      "attributes": {
        "created_at": "2023-02-06T08:48:35+00:00",
        "updated_at": "2023-02-06T08:48:35+00:00",
        ...
        "tax_category_id": "c735cc60-20ef-4ca4-9d67-799f43729d78",
      ...
      "relationships": {
        ...
        "products": {
          "links": {
            "related": "api/boomerang/products?filter[product_group_id]=574fe7eb-c5da-48d5-ba04-fa238d1fee19"
          }
        },
        "tax_category": {
          "links": {
            "related": "api/boomerang/tax_categories/c735cc60-20ef-4ca4-9d67-799f43729d78"
          }
        },
        "price_ruleset": {
          "links": {
        ...
        "properties": {
          "links": {
            "related": "api/boomerang/properties?filter[owner_id]=574fe7eb-c5da-48d5-ba04-fa238d1fee19&filter[owner_type]=product_groups"
          }
        }
      }
    },
    {
      "id": "b9827d26-120f-4a69-b25d-130e8db22c42",
      "type": "products",
      "attributes": {
        "created_at": "2023-02-06T08:48:35+00:00",
        "updated_at": "2023-02-06T08:48:35+00:00",
        ...
        "allow_shortage": true,
        "shortage_limit": 3,
        "product_group_id": "574fe7eb-c5da-48d5-ba04-fa238d1fee19",
        "tax_category_id": "c735cc60-20ef-4ca4-9d67-799f43729d78",
        "price_structure_id": null,
        "price_ruleset_id": null
      },
      "relationships": {
        ...
        "product_group": {
          "links": {
            "related": "api/boomerang/product_groups/574fe7eb-c5da-48d5-ba04-fa238d1fee19"
          }
        },
        "tax_category": {
          "links": {
        ...
        "barcode": {
          "links": {
            "related": "api/boomerang/barcodes?filter[owner_id]=b9827d26-120f-4a69-b25d-130e8db22c42&filter[owner_type]=products"
          }
        },
        "price_structure": {
          "links": {
        ...
        "inventory_levels": {
          "links": {
            "related": "api/boomerang/inventory_levels?filter[item_id]=b9827d26-120f-4a69-b25d-130e8db22c42"
          }
        },
        "price_ruleset": {
          "links": {
        ...
        "properties": {
          "links": {
            "related": "api/boomerang/properties?filter[owner_id]=574fe7eb-c5da-48d5-ba04-fa238d1fee19&filter[owner_type]=products"
          }
        }
      }
    }
...
```json
  ...
  "data": [
    {
      "id": "39ad7e97-f738-4dcc-af49-8c6e436fb783"
    },
    {
      "id": "3b7e284a-11a5-44ad-b1ec-b569d77473c0"
    },
    {
      "id": "56931870-a947-4e47-80f4-c6a562f28b36"
    },
    {
      "id": "f8c758a7-6869-48f2-8111-67ee9f94a027"
    },
    {
      "id": "c75daec4-0f0f-43e9-98e2-f5cd887e60ba"
    }
  ]
}
```
