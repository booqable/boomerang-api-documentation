...
```json
  ...
  "data": [
    {
      "id": "54cfe578-d7b1-47be-a300-35405704134a",
      "type": "bundles",
      "attributes": {
      ...
      "relationships": {
        ...
        "bundle_items": {
          "links": {
            "related": "api/boomerang/bundle_items?filter[bundle_id]=54cfe578-d7b1-47be-a300-35405704134a"
          }
        },
        "inventory_levels": {
          "links": {
            "related": "api/boomerang/inventory_levels?filter[item_id]=54cfe578-d7b1-47be-a300-35405704134a"
          }
        }
      }
    },
    {
      "id": "e9759871-a9d7-43de-bd12-d2db6f6eab5c",
      "type": "product_groups",
      "attributes": {
        "created_at": "2023-01-24T16:32:11+00:00",
        "updated_at": "2023-01-24T16:32:11+00:00",
        ...
        "tax_category_id": "3f101af2-dc29-42af-aae2-a5b396545537",
      ...
      "relationships": {
        ...
        "products": {
          "links": {
            "related": "api/boomerang/products?filter[product_group_id]=e9759871-a9d7-43de-bd12-d2db6f6eab5c"
          }
        },
        "tax_category": {
          "links": {
            "related": "api/boomerang/tax_categories/3f101af2-dc29-42af-aae2-a5b396545537"
          }
        },
        "price_ruleset": {
          "links": {
        ...
        "properties": {
          "links": {
            "related": "api/boomerang/properties?filter[owner_id]=e9759871-a9d7-43de-bd12-d2db6f6eab5c&filter[owner_type]=product_groups"
          }
        }
      }
    },
    {
      "id": "cb0e82ec-215d-4acb-acb7-6f1c8b024d09",
      "type": "products",
      "attributes": {
        "created_at": "2023-01-24T16:32:11+00:00",
        "updated_at": "2023-01-24T16:32:11+00:00",
        ...
        "allow_shortage": true,
        "shortage_limit": 3,
        "product_group_id": "e9759871-a9d7-43de-bd12-d2db6f6eab5c",
        "tax_category_id": "3f101af2-dc29-42af-aae2-a5b396545537",
        "price_structure_id": null,
        "price_ruleset_id": null
      },
      "relationships": {
        ...
        "product_group": {
          "links": {
            "related": "api/boomerang/product_groups/e9759871-a9d7-43de-bd12-d2db6f6eab5c"
          }
        },
        "tax_category": {
          "links": {
        ...
        "barcode": {
          "links": {
            "related": "api/boomerang/barcodes?filter[owner_id]=cb0e82ec-215d-4acb-acb7-6f1c8b024d09&filter[owner_type]=products"
          }
        },
        "price_structure": {
          "links": {
        ...
        "inventory_levels": {
          "links": {
            "related": "api/boomerang/inventory_levels?filter[item_id]=cb0e82ec-215d-4acb-acb7-6f1c8b024d09"
          }
        },
        "price_ruleset": {
          "links": {
        ...
        "properties": {
          "links": {
            "related": "api/boomerang/properties?filter[owner_id]=e9759871-a9d7-43de-bd12-d2db6f6eab5c&filter[owner_type]=products"
          }
        }
      }
    }
...
```json
  ...
  "data": [
    {
      "id": "9d984ee4-1b1d-4b4e-a24e-cebf7828d26c"
    },
    {
      "id": "2127dc89-0fe6-48c2-9ef3-09cab1eac7c0"
    },
    {
      "id": "a4a63785-1ef1-4fcc-8ec5-e76907602de0"
    },
    {
      "id": "e5187916-dd87-4ce5-b409-24e6e5f1065c"
    },
    {
      "id": "1dccdd80-a146-4c00-8d95-0c7394b9742c"
    }
  ]
}
```
