...
```json
  ...
  "data": [
    {
      "id": "b3e3864f-4bbc-4721-8e3a-cef6a1586bdd",
      "type": "bundles",
      "attributes": {
        "created_at": "2022-06-30T08:46:41+00:00",
        "updated_at": "2022-06-30T08:46:41+00:00",
        "archived": false,
        "archived_at": null,
        "type": "bundles",
        "name": "iPad Bundle",
      ...
      "relationships": {
        ...
        "bundle_items": {
          "links": {
            "related": "api/boomerang/bundle_items?filter[bundle_id]=b3e3864f-4bbc-4721-8e3a-cef6a1586bdd"
          }
        },
        "categories": {
          "links": {
            "related": "api/boomerang/categories?filter[item_id]=b3e3864f-4bbc-4721-8e3a-cef6a1586bdd"
          }
        }
      }
    },
    {
      "id": "003c850b-14a1-45f4-a8e0-6fd3d1e1c70b",
      "type": "product_groups",
      "attributes": {
        "created_at": "2022-06-30T08:46:41+00:00",
        "updated_at": "2022-06-30T08:46:41+00:00",
        ...
        "tax_category_id": "2f83c4cc-4f87-47bf-bf30-10032ad55fff"
      },
      "relationships": {
        "categories": {
          "links": {
            "related": "api/boomerang/categories?filter[item_id]=003c850b-14a1-45f4-a8e0-6fd3d1e1c70b"
          }
        },
        "photo": {
          "links": {
        ...
        "products": {
          "links": {
            "related": "api/boomerang/products?filter[product_group_id]=003c850b-14a1-45f4-a8e0-6fd3d1e1c70b"
          }
        },
        "tax_category": {
          "links": {
            "related": "api/boomerang/tax_categories/2f83c4cc-4f87-47bf-bf30-10032ad55fff"
          }
        },
        "properties": {
          "links": {
            "related": "api/boomerang/properties?filter[owner_id]=003c850b-14a1-45f4-a8e0-6fd3d1e1c70b&filter[owner_type]=product_groups"
          }
        }
      }
    },
    {
      "id": "6384a6d2-8c51-4f88-98c8-b8b55bede2af",
      "type": "products",
      "attributes": {
        "created_at": "2022-06-30T08:46:41+00:00",
        "updated_at": "2022-06-30T08:46:41+00:00",
        ...
        "allow_shortage": true,
        "shortage_limit": 3,
        "product_group_id": "003c850b-14a1-45f4-a8e0-6fd3d1e1c70b",
        "tax_category_id": "2f83c4cc-4f87-47bf-bf30-10032ad55fff",
      ...
      "relationships": {
        ...
        "product_group": {
          "links": {
            "related": "api/boomerang/product_groups/003c850b-14a1-45f4-a8e0-6fd3d1e1c70b"
          }
        },
        "tax_category": {
          "links": {
        ...
        "barcode": {
          "links": {
            "related": "api/boomerang/barcodes?filter[owner_id]=6384a6d2-8c51-4f88-98c8-b8b55bede2af&filter[owner_type]=products"
          }
        },
        "price_structure": {
          "links": {
        ...
        "properties": {
          "links": {
            "related": "api/boomerang/properties?filter[owner_id]=003c850b-14a1-45f4-a8e0-6fd3d1e1c70b&filter[owner_type]=products"
          }
        },
        "categories": {
          "links": {
            "related": "/api/boomerang/categories?filter%5Bitem_id%5D=003c850b-14a1-45f4-a8e0-6fd3d1e1c70b"
          }
        }
      }
    }
...
```json
  ...
  "data": [
    {
      "id": "a108435e-c498-41e1-8a22-072495eca88a"
    },
    {
      "id": "dae21a48-fc65-41ac-9ae8-9fd42baf6606"
    },
    {
      "id": "d6c0aada-d3f3-4f5f-b485-641f612e044c"
    },
    {
      "id": "34c9bce3-0469-44f7-bd8a-6d040110d0de"
    },
    {
      "id": "e60a2dc6-fde2-4a3d-8331-17f6258bcb12"
    }
  ]
}
```
