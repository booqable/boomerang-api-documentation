...
```json
  ...
  "data": [
    {
      "id": "03938ae1-16bb-4940-9cda-7780261f0cfb",
      "type": "bundles",
      "attributes": {
        "created_at": "2023-03-08T07:53:17+00:00",
        "updated_at": "2023-03-08T07:53:17+00:00",
        "archived": false,
        "archived_at": null,
        "type": "bundles",
        "name": "iPad Bundle",
      ...
      "relationships": {
        ...
        "bundle_items": {
          "links": {
            "related": "api/boomerang/bundle_items?filter[bundle_id]=03938ae1-16bb-4940-9cda-7780261f0cfb"
          }
        },
        "inventory_levels": {
          "links": {
            "related": "api/boomerang/inventory_levels?filter[item_id]=03938ae1-16bb-4940-9cda-7780261f0cfb"
          }
        }
      }
    },
    {
      "id": "380d4c37-2c75-4bf6-b94d-3a012a4faa69",
      "type": "product_groups",
      "attributes": {
        "created_at": "2023-03-08T07:53:17+00:00",
        "updated_at": "2023-03-08T07:53:17+00:00",
        ...
        "properties": {},
        "photo_id": null,
        "tax_category_id": "4061c274-b10d-4372-8ed3-4d48210b5459",
      ...
      "relationships": {
        ...
        "tax_category": {
          "links": {
            "related": "api/boomerang/tax_categories/4061c274-b10d-4372-8ed3-4d48210b5459"
          }
        },
        "price_ruleset": {
          "links": {
        ...
        "inventory_levels": {
          "links": {
            "related": "api/boomerang/inventory_levels?filter[item_id]=380d4c37-2c75-4bf6-b94d-3a012a4faa69"
          }
        },
        "properties": {
          "links": {
            "related": "api/boomerang/properties?filter[owner_id]=380d4c37-2c75-4bf6-b94d-3a012a4faa69&filter[owner_type]=product_groups"
          }
        },
        "products": {
          "links": {
            "related": "api/boomerang/products?filter[product_group_id]=380d4c37-2c75-4bf6-b94d-3a012a4faa69"
          }
        }
      }
    },
    {
      "id": "7f312df2-3e7b-4e40-bf11-3f69d206e8c0",
      "type": "products",
      "attributes": {
        "created_at": "2023-03-08T07:53:17+00:00",
        "updated_at": "2023-03-08T07:53:17+00:00",
        ...
        "allow_shortage": true,
        "shortage_limit": 3,
        "product_group_id": "380d4c37-2c75-4bf6-b94d-3a012a4faa69"
      },
      "relationships": {
        "photo": {
          "links": {
        ...
        "inventory_levels": {
          "links": {
            "related": "api/boomerang/inventory_levels?filter[item_id]=7f312df2-3e7b-4e40-bf11-3f69d206e8c0"
          }
        },
        "properties": {
          "links": {
            "related": "api/boomerang/properties?filter[owner_id]=380d4c37-2c75-4bf6-b94d-3a012a4faa69&filter[owner_type]=products"
          }
        },
        "product_group": {
          "links": {
            "related": "api/boomerang/product_groups/380d4c37-2c75-4bf6-b94d-3a012a4faa69"
          }
        },
        "barcode": {
          "links": {
            "related": "api/boomerang/barcodes?filter[owner_id]=7f312df2-3e7b-4e40-bf11-3f69d206e8c0&filter[owner_type]=products"
          }
        }
      }
    }
...
```json
  ...
  "data": [
    {
      "id": "2494086c-9766-43c0-b4d3-3bef0fe2c41a"
    },
    {
      "id": "4d163ea8-4101-483d-893d-b4785a700bc2"
    },
    {
      "id": "2782240a-e6e4-46f8-bc3f-d3afb6c725a6"
    },
    {
      "id": "310cbf74-6255-44eb-8eee-61cc84d0ca7c"
    },
    {
      "id": "dcf17a14-47f8-44e0-89e1-d658ba100da7"
    }
  ]
}
```
