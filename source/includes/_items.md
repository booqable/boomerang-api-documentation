...
```json
  ...
  "data": [
    {
      "id": "16f4a278-da70-4420-8375-df6df3a8f9da",
      "type": "bundles",
      "attributes": {
      ...
      "relationships": {
        ...
        "bundle_items": {
          "links": {
            "related": "api/boomerang/bundle_items?filter[bundle_id]=16f4a278-da70-4420-8375-df6df3a8f9da"
          }
        },
        "inventory_levels": {
          "links": {
            "related": "api/boomerang/inventory_levels?filter[item_id]=16f4a278-da70-4420-8375-df6df3a8f9da"
          }
        }
      }
    },
    {
      "id": "75520f7e-ccb2-45ae-905d-d3f34948a579",
      "type": "product_groups",
      "attributes": {
        "created_at": "2023-02-08T09:19:17+00:00",
        "updated_at": "2023-02-08T09:19:17+00:00",
        ...
        "tax_category_id": "c11f89fe-d085-4150-a4ab-a5931ef25f37",
      ...
      "relationships": {
        ...
        "products": {
          "links": {
            "related": "api/boomerang/products?filter[product_group_id]=75520f7e-ccb2-45ae-905d-d3f34948a579"
          }
        },
        "tax_category": {
          "links": {
            "related": "api/boomerang/tax_categories/c11f89fe-d085-4150-a4ab-a5931ef25f37"
          }
        },
        "price_ruleset": {
          "links": {
        ...
        "properties": {
          "links": {
            "related": "api/boomerang/properties?filter[owner_id]=75520f7e-ccb2-45ae-905d-d3f34948a579&filter[owner_type]=product_groups"
          }
        }
      }
    },
    {
      "id": "4f228e80-0fe2-41db-94d4-2fa3ae6e3d0b",
      "type": "products",
      "attributes": {
        "created_at": "2023-02-08T09:19:17+00:00",
        "updated_at": "2023-02-08T09:19:17+00:00",
        ...
        "allow_shortage": true,
        "shortage_limit": 3,
        "product_group_id": "75520f7e-ccb2-45ae-905d-d3f34948a579",
        "tax_category_id": "c11f89fe-d085-4150-a4ab-a5931ef25f37",
        "price_structure_id": null,
        "price_ruleset_id": null
      },
      "relationships": {
        ...
        "product_group": {
          "links": {
            "related": "api/boomerang/product_groups/75520f7e-ccb2-45ae-905d-d3f34948a579"
          }
        },
        "tax_category": {
          "links": {
        ...
        "barcode": {
          "links": {
            "related": "api/boomerang/barcodes?filter[owner_id]=4f228e80-0fe2-41db-94d4-2fa3ae6e3d0b&filter[owner_type]=products"
          }
        },
        "price_structure": {
          "links": {
        ...
        "inventory_levels": {
          "links": {
            "related": "api/boomerang/inventory_levels?filter[item_id]=4f228e80-0fe2-41db-94d4-2fa3ae6e3d0b"
          }
        },
        "price_ruleset": {
          "links": {
        ...
        "properties": {
          "links": {
            "related": "api/boomerang/properties?filter[owner_id]=75520f7e-ccb2-45ae-905d-d3f34948a579&filter[owner_type]=products"
          }
        }
      }
    }
...
```json
  ...
  "data": [
    {
      "id": "80d8458a-d07e-4a3c-8404-82c012d0f972"
    },
    {
      "id": "56b5967b-52fe-4601-bfec-e6b723364ca7"
    },
    {
      "id": "4bd16505-43e5-475e-a592-d351dd41ee88"
    },
    {
      "id": "4012090e-a57e-49eb-baf0-3ca03022413d"
    },
    {
      "id": "df2683be-4f87-47ae-a16d-8bff8f7e1969"
    }
  ]
}
```
