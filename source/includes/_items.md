...
```json
  ...
  "data": [
    {
      "id": "bfba97d3-1031-4f22-a662-c0095bc59d18",
      "type": "bundles",
      "attributes": {
      ...
      "relationships": {
        ...
        "bundle_items": {
          "links": {
            "related": "api/boomerang/bundle_items?filter[bundle_id]=bfba97d3-1031-4f22-a662-c0095bc59d18"
          }
        },
        "inventory_levels": {
          "links": {
            "related": "api/boomerang/inventory_levels?filter[item_id]=bfba97d3-1031-4f22-a662-c0095bc59d18"
          }
        }
      }
    },
    {
      "id": "cf89c951-a90d-429b-b0a4-b9f7eea20c55",
      "type": "product_groups",
      "attributes": {
        "created_at": "2023-02-08T14:59:54+00:00",
        "updated_at": "2023-02-08T14:59:54+00:00",
        ...
        "tax_category_id": "ff71ee01-d264-4c92-b8f8-f36782c01a67",
      ...
      "relationships": {
        ...
        "products": {
          "links": {
            "related": "api/boomerang/products?filter[product_group_id]=cf89c951-a90d-429b-b0a4-b9f7eea20c55"
          }
        },
        "tax_category": {
          "links": {
            "related": "api/boomerang/tax_categories/ff71ee01-d264-4c92-b8f8-f36782c01a67"
          }
        },
        "price_ruleset": {
          "links": {
        ...
        "properties": {
          "links": {
            "related": "api/boomerang/properties?filter[owner_id]=cf89c951-a90d-429b-b0a4-b9f7eea20c55&filter[owner_type]=product_groups"
          }
        }
      }
    },
    {
      "id": "7ef70ffc-0ff8-4b68-8960-57df86a7a96b",
      "type": "products",
      "attributes": {
        "created_at": "2023-02-08T14:59:54+00:00",
        "updated_at": "2023-02-08T14:59:54+00:00",
        ...
        "allow_shortage": true,
        "shortage_limit": 3,
        "product_group_id": "cf89c951-a90d-429b-b0a4-b9f7eea20c55",
        "tax_category_id": "ff71ee01-d264-4c92-b8f8-f36782c01a67",
        "price_structure_id": null,
        "price_ruleset_id": null
      },
      "relationships": {
        ...
        "product_group": {
          "links": {
            "related": "api/boomerang/product_groups/cf89c951-a90d-429b-b0a4-b9f7eea20c55"
          }
        },
        "tax_category": {
          "links": {
        ...
        "barcode": {
          "links": {
            "related": "api/boomerang/barcodes?filter[owner_id]=7ef70ffc-0ff8-4b68-8960-57df86a7a96b&filter[owner_type]=products"
          }
        },
        "price_structure": {
          "links": {
        ...
        "inventory_levels": {
          "links": {
            "related": "api/boomerang/inventory_levels?filter[item_id]=7ef70ffc-0ff8-4b68-8960-57df86a7a96b"
          }
        },
        "price_ruleset": {
          "links": {
        ...
        "properties": {
          "links": {
            "related": "api/boomerang/properties?filter[owner_id]=cf89c951-a90d-429b-b0a4-b9f7eea20c55&filter[owner_type]=products"
          }
        }
      }
    }
...
```json
  ...
  "data": [
    {
      "id": "61097c0c-2a11-4e5d-9fb6-c775d0570247"
    },
    {
      "id": "261ad7f8-5201-4b40-bb4c-a84e37beb885"
    },
    {
      "id": "fe944c26-38b6-4bc6-87a7-f771bb495e5a"
    },
    {
      "id": "94bfcc73-8750-48e0-babc-37711b1a0063"
    },
    {
      "id": "82b9ed2f-37b1-417d-9331-a001434d68a9"
    }
  ]
}
```
