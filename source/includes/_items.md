...
```json
  ...
  "data": [
    {
      "id": "1969d821-124c-4424-923f-45e380267048",
      "type": "bundles",
      "attributes": {
        "created_at": "2022-06-01T08:56:27+00:00",
        "updated_at": "2022-06-01T08:56:27+00:00",
        "archived": false,
        "archived_at": null,
        "type": "bundles",
        "name": "iPad Bundle",
      ...
      "relationships": {
        ...
        "bundle_items": {
          "links": {
            "related": "api/boomerang/bundle_items?filter[bundle_id]=1969d821-124c-4424-923f-45e380267048"
          }
        },
        "categories": {
          "links": {
            "related": "api/boomerang/categories?filter[item_id]=1969d821-124c-4424-923f-45e380267048"
          }
        }
      }
    },
    {
      "id": "a0068180-bee3-47f1-ac81-60367d141031",
      "type": "product_groups",
      "attributes": {
        "created_at": "2022-06-01T08:56:27+00:00",
        "updated_at": "2022-06-01T08:56:27+00:00",
        ...
        "tax_category_id": "b4c63d81-705f-4340-9c51-762cd283f8b7"
      },
      "relationships": {
        "categories": {
          "links": {
            "related": "api/boomerang/categories?filter[item_id]=a0068180-bee3-47f1-ac81-60367d141031"
          }
        },
        "photo": {
          "links": {
        ...
        "products": {
          "links": {
            "related": "api/boomerang/products?filter[product_group_id]=a0068180-bee3-47f1-ac81-60367d141031"
          }
        },
        "tax_category": {
          "links": {
            "related": "api/boomerang/tax_categories/b4c63d81-705f-4340-9c51-762cd283f8b7"
          }
        },
        "properties": {
          "links": {
            "related": "api/boomerang/properties?filter[owner_id]=a0068180-bee3-47f1-ac81-60367d141031&filter[owner_type]=product_groups"
          }
        }
      }
    },
    {
      "id": "744787c2-1088-486a-9f3d-c0a99b4cbf28",
      "type": "products",
      "attributes": {
        "created_at": "2022-06-01T08:56:27+00:00",
        "updated_at": "2022-06-01T08:56:27+00:00",
        ...
        "allow_shortage": true,
        "shortage_limit": 3,
        "product_group_id": "a0068180-bee3-47f1-ac81-60367d141031",
        "tax_category_id": "b4c63d81-705f-4340-9c51-762cd283f8b7",
      ...
      "relationships": {
        ...
        "product_group": {
          "links": {
            "related": "api/boomerang/product_groups/a0068180-bee3-47f1-ac81-60367d141031"
          }
        },
        "tax_category": {
          "links": {
        ...
        "barcode": {
          "links": {
            "related": "api/boomerang/barcodes?filter[owner_id]=744787c2-1088-486a-9f3d-c0a99b4cbf28&filter[owner_type]=products"
          }
        },
        "price_structure": {
          "links": {
        ...
        "properties": {
          "links": {
            "related": "api/boomerang/properties?filter[owner_id]=a0068180-bee3-47f1-ac81-60367d141031&filter[owner_type]=products"
          }
        },
        "categories": {
          "links": {
            "related": "/api/boomerang/categories?filter%5Bitem_id%5D=a0068180-bee3-47f1-ac81-60367d141031"
          }
        }
      }
    }
...
```json
  ...
  "data": [
    {
      "id": "048e569e-1607-4882-80ff-7df8e218efe8"
    },
    {
      "id": "52734686-4ccf-47be-8bde-7376ca03f642"
    },
    {
      "id": "14a39be1-0906-45cb-a2b4-8658a41a299a"
    },
    {
      "id": "b28e8281-f429-4f07-99f2-a29dceedd807"
    },
    {
      "id": "759c3d7c-694a-4df2-8db2-79b94ec9f3ca"
    }
  ]
}
```
