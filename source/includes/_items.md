...
```json
  ...
  "data": [
    {
      "id": "7237b460-c217-4c3f-ae97-9e133fe511e5",
      "type": "bundles",
      "attributes": {
        "created_at": "2023-02-16T22:56:40+00:00",
        "updated_at": "2023-02-16T22:56:40+00:00",
        "archived": false,
        "archived_at": null,
        "type": "bundles",
        "name": "iPad Bundle",
      ...
      "relationships": {
        ...
        "bundle_items": {
          "links": {
            "related": "api/boomerang/bundle_items?filter[bundle_id]=7237b460-c217-4c3f-ae97-9e133fe511e5"
          }
        },
        "inventory_levels": {
          "links": {
            "related": "api/boomerang/inventory_levels?filter[item_id]=7237b460-c217-4c3f-ae97-9e133fe511e5"
          }
        }
      }
    },
    {
      "id": "10e5c0e0-9b60-4116-990e-edce392f4eb4",
      "type": "product_groups",
      "attributes": {
        "created_at": "2023-02-16T22:56:40+00:00",
        "updated_at": "2023-02-16T22:56:40+00:00",
        ...
        "properties": {},
        "photo_id": null,
        "tax_category_id": "75f9f73e-ddff-43ea-adf0-eba478c5ff52",
      ...
      "relationships": {
        ...
        "tax_category": {
          "links": {
            "related": "api/boomerang/tax_categories/75f9f73e-ddff-43ea-adf0-eba478c5ff52"
          }
        },
        "price_ruleset": {
          "links": {
        ...
        "inventory_levels": {
          "links": {
            "related": "api/boomerang/inventory_levels?filter[item_id]=10e5c0e0-9b60-4116-990e-edce392f4eb4"
          }
        },
        "properties": {
          "links": {
            "related": "api/boomerang/properties?filter[owner_id]=10e5c0e0-9b60-4116-990e-edce392f4eb4&filter[owner_type]=product_groups"
          }
        },
        "products": {
          "links": {
            "related": "api/boomerang/products?filter[product_group_id]=10e5c0e0-9b60-4116-990e-edce392f4eb4"
          }
        }
      }
    },
    {
      "id": "f7949823-367a-4758-8f97-9100634016be",
      "type": "products",
      "attributes": {
        "created_at": "2023-02-16T22:56:40+00:00",
        "updated_at": "2023-02-16T22:56:40+00:00",
        ...
        "allow_shortage": true,
        "shortage_limit": 3,
        "product_group_id": "10e5c0e0-9b60-4116-990e-edce392f4eb4"
      },
      "relationships": {
        "photo": {
          "links": {
        ...
        "inventory_levels": {
          "links": {
            "related": "api/boomerang/inventory_levels?filter[item_id]=f7949823-367a-4758-8f97-9100634016be"
          }
        },
        "properties": {
          "links": {
            "related": "api/boomerang/properties?filter[owner_id]=10e5c0e0-9b60-4116-990e-edce392f4eb4&filter[owner_type]=products"
          }
        },
        "product_group": {
          "links": {
            "related": "api/boomerang/product_groups/10e5c0e0-9b60-4116-990e-edce392f4eb4"
          }
        },
        "barcode": {
          "links": {
            "related": "api/boomerang/barcodes?filter[owner_id]=f7949823-367a-4758-8f97-9100634016be&filter[owner_type]=products"
          }
        }
      }
    }
...
```json
  ...
  "data": [
    {
      "id": "e78777cb-6079-4ebd-919e-e20c7138c12e"
    },
    {
      "id": "d8eeb117-3105-4ceb-858b-42da05544066"
    },
    {
      "id": "353a63ba-9f7d-4ab0-ae1f-c4d3bfef8ce6"
    },
    {
      "id": "27486bec-fec4-485a-9e6d-febfcf032afc"
    },
    {
      "id": "45dfb82f-9f03-4b74-bd7f-fad32b5b9c3f"
    }
  ]
}
```
