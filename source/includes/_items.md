...
```json
  ...
  "data": [
    {
      "id": "4505e22a-fdea-493f-a9e6-972507e106f7",
      "type": "bundles",
      "attributes": {
        "created_at": "2022-06-23T19:02:06+00:00",
        "updated_at": "2022-06-23T19:02:06+00:00",
        "archived": false,
        "archived_at": null,
        "type": "bundles",
        "name": "iPad Bundle",
      ...
      "relationships": {
        ...
        "bundle_items": {
          "links": {
            "related": "api/boomerang/bundle_items?filter[bundle_id]=4505e22a-fdea-493f-a9e6-972507e106f7"
          }
        },
        "categories": {
          "links": {
            "related": "api/boomerang/categories?filter[item_id]=4505e22a-fdea-493f-a9e6-972507e106f7"
          }
        }
      }
    },
    {
      "id": "9164434f-3333-404a-9c2f-08a156f60d47",
      "type": "product_groups",
      "attributes": {
        "created_at": "2022-06-23T19:02:06+00:00",
        "updated_at": "2022-06-23T19:02:06+00:00",
        ...
        "tax_category_id": "81026263-1843-44be-a1f6-9f0e4e1476ce"
      },
      "relationships": {
        "categories": {
          "links": {
            "related": "api/boomerang/categories?filter[item_id]=9164434f-3333-404a-9c2f-08a156f60d47"
          }
        },
        "photo": {
          "links": {
        ...
        "products": {
          "links": {
            "related": "api/boomerang/products?filter[product_group_id]=9164434f-3333-404a-9c2f-08a156f60d47"
          }
        },
        "tax_category": {
          "links": {
            "related": "api/boomerang/tax_categories/81026263-1843-44be-a1f6-9f0e4e1476ce"
          }
        },
        "properties": {
          "links": {
            "related": "api/boomerang/properties?filter[owner_id]=9164434f-3333-404a-9c2f-08a156f60d47&filter[owner_type]=product_groups"
          }
        }
      }
    },
    {
      "id": "4ba17264-229e-4df9-803f-22c4c0f7c483",
      "type": "products",
      "attributes": {
        "created_at": "2022-06-23T19:02:06+00:00",
        "updated_at": "2022-06-23T19:02:06+00:00",
        ...
        "allow_shortage": true,
        "shortage_limit": 3,
        "product_group_id": "9164434f-3333-404a-9c2f-08a156f60d47",
        "tax_category_id": "81026263-1843-44be-a1f6-9f0e4e1476ce",
      ...
      "relationships": {
        ...
        "product_group": {
          "links": {
            "related": "api/boomerang/product_groups/9164434f-3333-404a-9c2f-08a156f60d47"
          }
        },
        "tax_category": {
          "links": {
        ...
        "barcode": {
          "links": {
            "related": "api/boomerang/barcodes?filter[owner_id]=4ba17264-229e-4df9-803f-22c4c0f7c483&filter[owner_type]=products"
          }
        },
        "price_structure": {
          "links": {
        ...
        "properties": {
          "links": {
            "related": "api/boomerang/properties?filter[owner_id]=9164434f-3333-404a-9c2f-08a156f60d47&filter[owner_type]=products"
          }
        },
        "categories": {
          "links": {
            "related": "/api/boomerang/categories?filter%5Bitem_id%5D=9164434f-3333-404a-9c2f-08a156f60d47"
          }
        }
      }
    }
...
```json
  ...
  "data": [
    {
      "id": "58a1a100-bb25-4ec2-ae7b-577cbf96c56a"
    },
    {
      "id": "a549a51a-9e8b-4041-a7de-53bcea0fb31b"
    },
    {
      "id": "2504461c-2a87-438a-9e01-eeae40641958"
    },
    {
      "id": "934b9b98-f398-4921-b06d-5c3cc4cbe580"
    },
    {
      "id": "8781a77c-b7ff-42e0-a084-6d5241742384"
    }
  ]
}
```
