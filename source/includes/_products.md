...
```json
  ...
  "data": [
    {
      "id": "f090f2dc-b745-40be-b084-de23af2d822d",
      "type": "products",
      "attributes": {
        "created_at": "2023-02-13T12:16:28+00:00",
        "updated_at": "2023-02-13T12:16:28+00:00",
        "archived": false,
        "archived_at": null,
        "type": "products",
        "name": "iPad Pro",
        ...
        "shortage_limit": 0,
        "product_group_id": "64e07f84-d915-4b0b-a08a-e13af749bc52"
      },
      "relationships": {
        "photo": {
          "links": {
        ...
        "inventory_levels": {
          "links": {
            "related": "api/boomerang/inventory_levels?filter[item_id]=f090f2dc-b745-40be-b084-de23af2d822d"
          }
        },
        "properties": {
          "links": {
            "related": "api/boomerang/properties?filter[owner_id]=64e07f84-d915-4b0b-a08a-e13af749bc52&filter[owner_type]=products"
          }
        },
        "product_group": {
          "links": {
            "related": "api/boomerang/product_groups/64e07f84-d915-4b0b-a08a-e13af749bc52"
          }
        },
        "barcode": {
          "links": {
            "related": "api/boomerang/barcodes?filter[owner_id]=f090f2dc-b745-40be-b084-de23af2d822d&filter[owner_type]=products"
          }
        }
      }
    },
    {
      "id": "9ea3b7c6-8e76-4e92-a06b-95afc9c0091a",
      "type": "products",
      "attributes": {
        "created_at": "2023-02-13T12:16:29+00:00",
        "updated_at": "2023-02-13T12:16:29+00:00",
        "archived": false,
        "archived_at": null,
        "type": "products",
        "name": "iPad Pro - blue",
      ...
      "relationships": {
        ...
        "inventory_levels": {
          "links": {
            "related": "api/boomerang/inventory_levels?filter[item_id]=9ea3b7c6-8e76-4e92-a06b-95afc9c0091a"
          }
        },
        "properties": {
          "links": {
        ...
        "barcode": {
          "links": {
            "related": "api/boomerang/barcodes?filter[owner_id]=9ea3b7c6-8e76-4e92-a06b-95afc9c0091a&filter[owner_type]=products"
          }
        }
      }
    }
...
```json
  ...
  "data": [
    {
      "id": "70b72ea9-7980-409c-887e-ffa42252a074"
    },
    {
      "id": "9fb15580-4ce3-49a6-8a6c-f200f7879f0f"
    },
    {
      "id": "a9edeea8-11fc-4bab-8568-348e4af16fea"
    },
    {
      "id": "ec5368aa-13bd-4050-8895-48287a9f1864"
    }
  ]
}
```
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/products/aef6b424-89b5-4de5-bdd0-388c538b0e40' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "aef6b424-89b5-4de5-bdd0-388c538b0e40",
    "type": "products",
    "attributes": {
      "created_at": "2023-02-13T12:16:32+00:00",
      "updated_at": "2023-02-13T12:16:32+00:00",
      "archived": false,
      "archived_at": null,
      "type": "products",
      "name": "iPad Pro",
      ...
      "allow_shortage": false,
      "shortage_limit": 0,
      "product_group_id": "7cfd1947-f68e-4fc8-9cdd-87f02a9f8696"
    },
    "relationships": {
      "photo": {
        "links": {
      ...
      "inventory_levels": {
        "links": {
          "related": "api/boomerang/inventory_levels?filter[item_id]=aef6b424-89b5-4de5-bdd0-388c538b0e40"
        }
      },
      "properties": {
        "links": {
          "related": "api/boomerang/properties?filter[owner_id]=7cfd1947-f68e-4fc8-9cdd-87f02a9f8696&filter[owner_type]=products"
        }
      },
      "product_group": {
        "links": {
          "related": "api/boomerang/product_groups/7cfd1947-f68e-4fc8-9cdd-87f02a9f8696"
        }
      },
      "barcode": {
        "links": {
          "related": "api/boomerang/barcodes?filter[owner_id]=aef6b424-89b5-4de5-bdd0-388c538b0e40&filter[owner_type]=products"
        }
      }
    }
  },
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        "type": "products",
        "attributes": {
          "product_group_id": "aa7c4f9b-2f24-4a09-8685-55d99d8a0228",
          "variation_values": [
            "red"
          ]
        }
...
```json
  {
  "data": {
    "id": "a58b0c6a-98c3-48b0-97ed-d40ecfdf2e40",
    "type": "products",
    "attributes": {
      "created_at": "2023-02-13T12:16:32+00:00",
      "updated_at": "2023-02-13T12:16:32+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/products/7960565b-76b8-44a1-884b-acf151253695' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "7960565b-76b8-44a1-884b-acf151253695",
        "type": "products",
        "attributes": {
          "variation_values": [
            "red"
...
```json
  ...
  "data": {
    ...
    "type": "products",
    "attributes": {
      "created_at": "2023-02-13T12:16:33+00:00",
      "updated_at": "2023-02-13T12:16:33+00:00",
      "archived": false,
      "archived_at": null,
      "type": "products",
      "name": "iPad Pro - red",
      ...
      "allow_shortage": false,
      "shortage_limit": 0,
      "product_group_id": "2eec8eeb-8664-4aec-8ae0-44f1b06b7eab"
    },
    "relationships": {
      "photo": {
        "meta": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/products/958b6b2d-2a9a-4643-b6d8-a6439560b3ed' \
    --header 'content-type: application/json' \
    --data '{}'
```
