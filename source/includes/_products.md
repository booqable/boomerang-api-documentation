...
`tax_category_id` | **Uuid** `readonly`<br>Associated Tax category
`price_ruleset_id` | **Uuid** `readonly`<br>Associated Price ruleset
`price_structure_id` | **Uuid** `readonly`<br>Associated Price structure
