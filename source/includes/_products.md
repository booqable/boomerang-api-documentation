...
```json
  ...
  "data": [
    {
      "id": "341feaa7-b134-4a2c-9c6f-4acd093596a6",
      "type": "products",
      "attributes": {
        "created_at": "2023-02-06T08:42:03+00:00",
        "updated_at": "2023-02-06T08:42:03+00:00",
        "archived": false,
        "archived_at": null,
        "type": "products",
        "name": "iPad Pro",
        ...
        "shortage_limit": 0,
        "product_group_id": "f4ae2d5a-83fd-4232-8484-5d5f6e8f760a",
      ...
      "relationships": {
        ...
        "product_group": {
          "links": {
            "related": "api/boomerang/product_groups/f4ae2d5a-83fd-4232-8484-5d5f6e8f760a"
          }
        },
        "tax_category": {
          "links": {
        ...
        "barcode": {
          "links": {
            "related": "api/boomerang/barcodes?filter[owner_id]=341feaa7-b134-4a2c-9c6f-4acd093596a6&filter[owner_type]=products"
          }
        },
        "price_structure": {
          "links": {
        ...
        "inventory_levels": {
          "links": {
            "related": "api/boomerang/inventory_levels?filter[item_id]=341feaa7-b134-4a2c-9c6f-4acd093596a6"
          }
        },
        "price_ruleset": {
          "links": {
        ...
        "properties": {
          "links": {
            "related": "api/boomerang/properties?filter[owner_id]=f4ae2d5a-83fd-4232-8484-5d5f6e8f760a&filter[owner_type]=products"
          }
        }
      }
    },
    {
      "id": "5777bcbd-094b-4824-9bea-5162bb6aa579",
      "type": "products",
      "attributes": {
        "created_at": "2023-02-06T08:42:03+00:00",
        "updated_at": "2023-02-06T08:42:03+00:00",
      ...
      "relationships": {
        ...
        "barcode": {
          "links": {
            "related": "api/boomerang/barcodes?filter[owner_id]=5777bcbd-094b-4824-9bea-5162bb6aa579&filter[owner_type]=products"
          }
        },
        "price_structure": {
          "links": {
        ...
        "inventory_levels": {
          "links": {
            "related": "api/boomerang/inventory_levels?filter[item_id]=5777bcbd-094b-4824-9bea-5162bb6aa579"
          }
        },
        "price_ruleset": {
          "links": {
...
```json
  ...
  "data": [
    {
      "id": "4fa217d1-d21f-401a-8773-e325453ed367"
    },
    {
      "id": "aecd270d-e727-4eb9-95e2-ccb5a7741f48"
    },
    {
      "id": "50d7a2f7-daf1-4c31-8a2c-097bab56eeb3"
    },
    {
      "id": "217b802a-9b42-49a8-b4d7-b41bf30b0be0"
    }
  ]
}
```
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/products/706f31bb-b318-4533-aead-d1bd856f300e' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "706f31bb-b318-4533-aead-d1bd856f300e",
    "type": "products",
    "attributes": {
      "created_at": "2023-02-06T08:42:06+00:00",
      "updated_at": "2023-02-06T08:42:06+00:00",
      "archived": false,
      "archived_at": null,
      "type": "products",
      "name": "iPad Pro",
      ...
      "allow_shortage": false,
      "shortage_limit": 0,
      "product_group_id": "885dd36d-aa54-450f-b8b5-6edc2a83dc1e",
      "tax_category_id": null,
      "price_structure_id": null,
      "price_ruleset_id": null
    },
    "relationships": {
      ...
      "product_group": {
        "links": {
          "related": "api/boomerang/product_groups/885dd36d-aa54-450f-b8b5-6edc2a83dc1e"
        }
      },
      "tax_category": {
        "links": {
      ...
      "barcode": {
        "links": {
          "related": "api/boomerang/barcodes?filter[owner_id]=706f31bb-b318-4533-aead-d1bd856f300e&filter[owner_type]=products"
        }
      },
      "price_structure": {
        "links": {
      ...
      "inventory_levels": {
        "links": {
          "related": "api/boomerang/inventory_levels?filter[item_id]=706f31bb-b318-4533-aead-d1bd856f300e"
        }
      },
      "price_ruleset": {
        "links": {
      ...
      "properties": {
        "links": {
          "related": "api/boomerang/properties?filter[owner_id]=885dd36d-aa54-450f-b8b5-6edc2a83dc1e&filter[owner_type]=products"
        }
      }
    }
  },
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        "type": "products",
        "attributes": {
          "product_group_id": "4c2c7398-e4cc-4a13-9569-df43edbafaec",
          "variation_values": [
            "red"
          ]
        }
...
```json
  {
  "data": {
    "id": "dfee5037-ac7a-4775-ba64-f6766cd92463",
    "type": "products",
    "attributes": {
      "created_at": "2023-02-06T08:42:07+00:00",
      "updated_at": "2023-02-06T08:42:07+00:00",
      "archived": false,
      "archived_at": null,
      "type": "products",
      "name": "iPad Pro - red",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/products/20162b35-771a-4294-be45-9a9a757130df' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "20162b35-771a-4294-be45-9a9a757130df",
        "type": "products",
        "attributes": {
          "variation_values": [
            "red"
...
```json
  ...
  "data": {
    ...
    "attributes": {
      ...
      "allow_shortage": false,
      "shortage_limit": 0,
      "product_group_id": "46aa5173-af51-402a-9e02-6b894a7e2344",
      "tax_category_id": null,
      "price_structure_id": null,
      "price_ruleset_id": null
    },
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/products/a9be9abb-bca8-4d5e-86f5-b186e849068e' \
    --header 'content-type: application/json' \
    --data '{}'
```
