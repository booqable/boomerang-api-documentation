...
```json
  ...
  "data": [
    {
      "id": "766d414b-97d4-41eb-b6ab-e03eaba2815d",
      "type": "products",
      "attributes": {
        "created_at": "2023-02-14T15:30:13+00:00",
        "updated_at": "2023-02-14T15:30:13+00:00",
        "archived": false,
        "archived_at": null,
        "type": "products",
        "name": "iPad Pro",
        ...
        "shortage_limit": 0,
        "product_group_id": "4956ee0c-ec0e-4847-b8cb-fe81c698e0a7"
      },
      "relationships": {
        "photo": {
          "links": {
        ...
        "inventory_levels": {
          "links": {
            "related": "api/boomerang/inventory_levels?filter[item_id]=766d414b-97d4-41eb-b6ab-e03eaba2815d"
          }
        },
        "properties": {
          "links": {
            "related": "api/boomerang/properties?filter[owner_id]=4956ee0c-ec0e-4847-b8cb-fe81c698e0a7&filter[owner_type]=products"
          }
        },
        "product_group": {
          "links": {
            "related": "api/boomerang/product_groups/4956ee0c-ec0e-4847-b8cb-fe81c698e0a7"
          }
        },
        "barcode": {
          "links": {
            "related": "api/boomerang/barcodes?filter[owner_id]=766d414b-97d4-41eb-b6ab-e03eaba2815d&filter[owner_type]=products"
          }
        }
      }
    },
    {
      "id": "0a7334d0-df00-4936-857a-30dc25ee23c7",
      "type": "products",
      "attributes": {
        "created_at": "2023-02-14T15:30:13+00:00",
        "updated_at": "2023-02-14T15:30:13+00:00",
      ...
      "relationships": {
        ...
        "inventory_levels": {
          "links": {
            "related": "api/boomerang/inventory_levels?filter[item_id]=0a7334d0-df00-4936-857a-30dc25ee23c7"
          }
        },
        "properties": {
          "links": {
        ...
        "barcode": {
          "links": {
            "related": "api/boomerang/barcodes?filter[owner_id]=0a7334d0-df00-4936-857a-30dc25ee23c7&filter[owner_type]=products"
          }
        }
      }
    }
...
```json
  ...
  "data": [
    {
      "id": "6000ecc9-8373-41bc-8c93-82eb005db50c"
    },
    {
      "id": "0e8eec90-85a8-4d68-9c91-69dc4fe1aed6"
    },
    {
      "id": "ed06e429-e9ac-42d5-b5c7-1356ab37ac49"
    },
    {
      "id": "e5c1b7b0-5f10-48ac-8429-59b25ab3f498"
    }
  ]
}
```
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/products/30603dfc-7b29-4696-9cb0-983367cf94d6' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "30603dfc-7b29-4696-9cb0-983367cf94d6",
    "type": "products",
    "attributes": {
      "created_at": "2023-02-14T15:30:18+00:00",
      "updated_at": "2023-02-14T15:30:18+00:00",
      "archived": false,
      "archived_at": null,
      "type": "products",
      "name": "iPad Pro",
      ...
      "allow_shortage": false,
      "shortage_limit": 0,
      "product_group_id": "19559359-0280-4cd6-a8ab-b92cfbe1a4a1"
    },
    "relationships": {
      "photo": {
        "links": {
      ...
      "inventory_levels": {
        "links": {
          "related": "api/boomerang/inventory_levels?filter[item_id]=30603dfc-7b29-4696-9cb0-983367cf94d6"
        }
      },
      "properties": {
        "links": {
          "related": "api/boomerang/properties?filter[owner_id]=19559359-0280-4cd6-a8ab-b92cfbe1a4a1&filter[owner_type]=products"
        }
      },
      "product_group": {
        "links": {
          "related": "api/boomerang/product_groups/19559359-0280-4cd6-a8ab-b92cfbe1a4a1"
        }
      },
      "barcode": {
        "links": {
          "related": "api/boomerang/barcodes?filter[owner_id]=30603dfc-7b29-4696-9cb0-983367cf94d6&filter[owner_type]=products"
        }
      }
    }
  },
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        "type": "products",
        "attributes": {
          "product_group_id": "c2d4d79c-6a09-48d5-8a83-14dbeb60511e",
          "variation_values": [
            "red"
          ]
        }
...
```json
  {
  "data": {
    "id": "43c85b89-3718-4239-b0ce-1a6e3fa82d6a",
    "type": "products",
    "attributes": {
      "created_at": "2023-02-14T15:30:19+00:00",
      "updated_at": "2023-02-14T15:30:19+00:00",
      "archived": false,
      "archived_at": null,
      "type": "products",
      "name": "iPad Pro - red",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/products/26f4d182-4051-431f-b977-88f13e0206ff' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "26f4d182-4051-431f-b977-88f13e0206ff",
        "type": "products",
        "attributes": {
          "variation_values": [
            "red"
...
```json
  ...
  "data": {
    ...
    "attributes": {
      ...
      "allow_shortage": false,
      "shortage_limit": 0,
      "product_group_id": "5b98416a-695a-43bb-9fb4-9ea0fd7ec513"
    },
    "relationships": {
      "photo": {
        "meta": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/products/317c6b29-8a2b-47bb-b0e2-61ed7e956573' \
    --header 'content-type: application/json' \
    --data '{}'
```
