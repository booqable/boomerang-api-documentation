...
```json
  {
  "data": {
    "id": "b6eb4aa8-56e7-577a-a97a-42671fa329d4",
    "type": "employee_invitations",
    "attributes": {
      "employee_id": "870a925d-e3a9-433f-8326-c2ec62fe9167"
    },
    "relationships": {
      "employee": {
        "data": {
          "type": "employees",
          "id": "870a925d-e3a9-433f-8326-c2ec62fe9167"
        }
      }
    }
  },
  "included": [
    {
      ...
      "type": "employees",
      "attributes": {
        "created_at": "2022-11-22T16:35:16+00:00",
        "updated_at": "2022-11-22T16:35:16+00:00",
        "name": "John Doe",
        "firstname": "John",
        "lastname": "Doe",
        "locale": null,
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        "type": "employee_invitations",
        "attributes": {
          "id": "7fa5def2-a46d-4403-96d3-054dc2f9b07f",
          "email": "jane@doe.com"
        }
      },
      "include": "employee"
...
```json
  ...
  "data": {
    ...
    "type": "employee_invitations",
    "attributes": {
      "employee_id": "7fa5def2-a46d-4403-96d3-054dc2f9b07f"
    },
    "relationships": {
      "employee": {
        "data": {
