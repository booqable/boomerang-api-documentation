...
```json
  {
  "data": {
    "id": "080fdbc2-3b2a-5446-ad0f-e8dc45df5f22",
    "type": "employee_invitations",
    "attributes": {
      "employee_id": "72bf3fc0-86ea-4ffb-944b-2e3754be5faf"
    },
    "relationships": {
      "employee": {
        "data": {
          "type": "employees",
          "id": "72bf3fc0-86ea-4ffb-944b-2e3754be5faf"
        }
      }
    }
  },
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        "type": "employee_invitations",
        "attributes": {
          "id": "578919d2-a710-4652-8cd5-115f50366381",
          "email": "jane@doe.com"
        }
      },
      "include": "employee"
...
```json
  ...
  "data": {
    ...
    "type": "employee_invitations",
    "attributes": {
      "employee_id": "578919d2-a710-4652-8cd5-115f50366381"
    },
    "relationships": {
      "employee": {
        "data": {
