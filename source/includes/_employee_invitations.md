...
```json
  {
  "data": {
    "id": "408dc97c-3829-5003-b81d-b1806f327828",
    "type": "employee_invitations",
    "attributes": {
      "employee_id": "8b380019-1666-453d-a07a-be6a511f0444"
    },
    "relationships": {
      "employee": {
        "data": {
          "type": "employees",
          "id": "8b380019-1666-453d-a07a-be6a511f0444"
        }
      }
    }
  },
  "included": [
    {
      ...
      "type": "employees",
      "attributes": {
        "created_at": "2022-07-21T10:57:00+00:00",
        "updated_at": "2022-07-21T10:57:00+00:00",
        "name": "John Doe",
        "firstname": "John",
        "lastname": "Doe",
        "email": "john@doe.com",
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        "type": "employee_invitations",
        "attributes": {
          "id": "429c8a31-48e2-43e8-aae9-15e2f4b6a00f",
          "email": "jane@doe.com"
        }
      },
      "include": "employee"
...
```json
  ...
  "data": {
    ...
    "type": "employee_invitations",
    "attributes": {
      "employee_id": "429c8a31-48e2-43e8-aae9-15e2f4b6a00f"
    },
    "relationships": {
      "employee": {
        "data": {
