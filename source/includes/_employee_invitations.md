...
```json
  {
  "data": {
    "id": "9fa536c4-d89b-5438-b35d-93f2f12985f0",
    "type": "employee_invitations",
    "attributes": {
      "employee_id": "36b333a3-1cf5-4b86-aa2f-87345c0c7b2e"
    },
    "relationships": {
      "employee": {
        "data": {
          "type": "employees",
          "id": "36b333a3-1cf5-4b86-aa2f-87345c0c7b2e"
        }
      }
    }
  },
  "included": [
    {
      ...
      "type": "employees",
      "attributes": {
        "created_at": "2023-02-09T14:22:16+00:00",
        "updated_at": "2023-02-09T14:22:16+00:00",
        "name": "John Doe",
        "firstname": "John",
        "lastname": "Doe",
        "locale": null,
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        "type": "employee_invitations",
        "attributes": {
          "id": "8d48ebb2-e873-411e-87de-e5d9a3ca2bcd",
          "email": "jane@doe.com"
        }
      },
      "include": "employee"
...
```json
  ...
  "data": {
    ...
    "type": "employee_invitations",
    "attributes": {
      "employee_id": "8d48ebb2-e873-411e-87de-e5d9a3ca2bcd"
    },
    "relationships": {
      "employee": {
        "data": {
