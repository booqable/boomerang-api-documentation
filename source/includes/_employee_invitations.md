...
```json
  {
  "data": {
    "id": "97a1bb65-e597-559b-9fa0-2e480d4610fe",
    "type": "employee_invitations",
    "attributes": {
      "employee_id": "a665261f-3f76-49a8-a042-15097ab7ca24"
    },
    "relationships": {
      "employee": {
        "data": {
          "type": "employees",
          "id": "a665261f-3f76-49a8-a042-15097ab7ca24"
        }
      }
    }
  },
  "included": [
    {
      ...
      "type": "employees",
      "attributes": {
        "created_at": "2023-03-01T14:48:56+00:00",
        "updated_at": "2023-03-01T14:48:56+00:00",
        "name": "John Doe",
        "firstname": "John",
        "lastname": "Doe",
        "locale": null,
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        "type": "employee_invitations",
        "attributes": {
          "id": "52937819-f464-44db-b653-6e4857157d9f",
          "email": "jane@doe.com"
        }
      },
      "include": "employee"
...
```json
  ...
  "data": {
    ...
    "type": "employee_invitations",
    "attributes": {
      "employee_id": "52937819-f464-44db-b653-6e4857157d9f"
    },
    "relationships": {
      "employee": {
        "data": {
