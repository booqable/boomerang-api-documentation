...
```json
  {
  "data": {
    "id": "dc1e6332-5217-59df-ba08-7b5aa95ec599",
    "type": "employee_invitations",
    "attributes": {
      "employee_id": "f55cf296-e84f-455c-bf40-dcd3f893fcce"
    },
    "relationships": {
      "employee": {
        "data": {
          "type": "employees",
          "id": "f55cf296-e84f-455c-bf40-dcd3f893fcce"
        }
      }
    }
  },
  "included": [
    {
      ...
      "type": "employees",
      "attributes": {
        "created_at": "2022-07-14T12:40:07+00:00",
        "updated_at": "2022-07-14T12:40:07+00:00",
        "name": "John Doe",
        "firstname": "John",
        "lastname": "Doe",
        "email": "john@doe.com",
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        "type": "employee_invitations",
        "attributes": {
          "id": "b701285d-6246-426b-a662-0eae81da3dc9",
          "email": "jane@doe.com"
        }
      },
      "include": "employee"
...
```json
  ...
  "data": {
    ...
    "type": "employee_invitations",
    "attributes": {
      "employee_id": "b701285d-6246-426b-a662-0eae81da3dc9"
    },
    "relationships": {
      "employee": {
        "data": {
