...
```json
  {
  "data": {
    "id": "d5c3f510-3fbb-5acc-9142-af9de392ff2b",
    "type": "employee_invitations",
    "attributes": {
      "employee_id": "eee5e031-bd27-4dcf-b19a-592287424c3d"
    },
    "relationships": {
      "employee": {
        "data": {
          "type": "employees",
          "id": "eee5e031-bd27-4dcf-b19a-592287424c3d"
        }
      }
    }
  },
  "included": [
    {
      ...
      "type": "employees",
      "attributes": {
        "created_at": "2022-04-04T13:22:00+00:00",
        "updated_at": "2022-04-04T13:22:00+00:00",
        "name": "John Doe",
        "firstname": "John",
        "lastname": "Doe",
        "email": "john@doe.com",
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        "type": "employee_invitations",
        "attributes": {
          "id": "bb39b69b-8584-480f-90da-b221de433064",
          "email": "jane@doe.com"
        }
      },
      "include": "employee"
...
```json
  ...
  "data": {
    ...
    "type": "employee_invitations",
    "attributes": {
      "employee_id": "bb39b69b-8584-480f-90da-b221de433064"
    },
    "relationships": {
      "employee": {
        "data": {
