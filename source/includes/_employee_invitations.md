...
```json
  {
  "data": {
    "id": "044e77ca-c1ce-5a65-8a6e-99a2ff84eff3",
    "type": "employee_invitations",
    "attributes": {
      "employee_id": "e2fd13f4-a3a8-4c79-9cc0-e41e57511148"
    },
    "relationships": {
      "employee": {
        "data": {
          "type": "employees",
          "id": "e2fd13f4-a3a8-4c79-9cc0-e41e57511148"
        }
      }
    }
  },
  "included": [
    {
      ...
      "type": "employees",
      "attributes": {
        "created_at": "2023-02-07T09:27:43+00:00",
        "updated_at": "2023-02-07T09:27:43+00:00",
        "name": "John Doe",
        "firstname": "John",
        "lastname": "Doe",
        "locale": null,
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        "type": "employee_invitations",
        "attributes": {
          "id": "af2f28e2-3c2e-4981-96df-7a3a162ab907",
          "email": "jane@doe.com"
        }
      },
      "include": "employee"
...
```json
  ...
  "data": {
    ...
    "type": "employee_invitations",
    "attributes": {
      "employee_id": "af2f28e2-3c2e-4981-96df-7a3a162ab907"
    },
    "relationships": {
      "employee": {
        "data": {
