...
<aside class="warning">
  ...
  This value is still returned by older APIs and v1 webhooks.
</aside>


- `new` Means the order is new, and invisible to anyone except the employee who created it.
- `draft` Does not influence availability.
    ...
    "data": [
      {
        ...
        "attributes": {
          ...
          "starts_at": "1969-04-20T01:34:01.000000+00:00",
          "stops_at": "1969-05-20T01:34:01.000000+00:00",
             ...
             "attributes": [
               {
                 ...
                 "attributes": [
                   {
                     "starts_at": {
                       "gte": "2026-01-22T10:55:15Z",
                       "lte": "2026-01-25T10:55:15Z"
                     }
                   },
                   {
                     "stops_at": {
...
```json
  {
    "data": {
      ...
      "attributes": {
        ...
        "starts_at": "1969-09-15T10:53:01.000000+00:00",
        "stops_at": "1969-10-15T10:53:01.000000+00:00",
        "deposit_type": "percentage",
        "deposit_value": 10.0,
        "entirely_started": false,
        "entirely_stopped": false,
...
```json
  {
    "data": {
      ...
      "attributes": {
        ...
        "starts_at": "2026-09-25T14:30:01.000000+00:00",
        "stops_at": "2026-11-03T14:30:01.000000+00:00",
        "deposit_type": "percentage",
        "deposit_value": 100.0,
        "entirely_started": true,
        "entirely_stopped": false,
...
```json
  {
    "data": {
      ...
      "attributes": {
        ...
        "starts_at": "2018-04-05T18:48:00.000000+00:00",
        "stops_at": "2018-05-14T18:48:00.000000+00:00",
        "deposit_type": "percentage",
        "deposit_value": 100.0,
        "entirely_started": true,
        "entirely_stopped": false,
          ...
          "blocking": [
            {
              ...
              "orders": [
                {
                  "id": "80677aa0-3465-46c7-85a0-c9aa2b4ab20c",
                  "stock_item_ids": [
                    "e58fe3d1-2652-4c3c-8432-caf5b7148a09"
                  ],
                  "conflicts": 1
