...
```json
  {
  "data": {
    "id": "763bf6d9-29a5-55cf-b724-aaedf8da5c61",
    "type": "bulk_upserts",
    "relationships": {
      "results": {
        "data": [
          {
            "type": "operating_rules",
            "id": "88227859-5784-4fda-8693-2bdef3ef124e"
          },
          {
            "type": "operating_rules",
            "id": "878c631a-30a0-4e54-aee7-bf8fe6381a94"
          }
        ]
      }
    }
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          ...
          "data": [
            {
              "default_property_id": "ce394c72-1cb2-4fc6-9ab7-a392593342be"
            },
            {
              "name": "Delivery address",
              "default_property_id": "39c075e9-1f35-494a-a290-45a8f17924b5"
            }
          ]
        },
        "include": "results"
...
```json
  {
  "data": {
    "id": "28934f87-2d4b-5af8-8489-dbf717f32d9a",
    "type": "bulk_upserts",
    "relationships": {
      "results": {
        "meta": {
