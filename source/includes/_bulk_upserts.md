...
```json
  {
  "data": {
    "id": "06e2f82c-0189-5d85-b3d4-97a7e058a706",
    "type": "bulk_upserts",
    "relationships": {
      "results": {
        "data": [
          {
            "type": "operating_rules",
            "id": "ab0bba68-9477-4539-8502-5b695d249283"
          },
          {
            "type": "operating_rules",
            "id": "da3db248-68cb-4cea-aae3-ec4865c77a4d"
          }
        ]
      }
    }
  ...
  "included": [
    {
      ...
      "type": "operating_rules",
      "attributes": {
        "created_at": "2023-02-16T08:11:59+00:00",
        "updated_at": "2023-02-16T08:11:59+00:00",
        "data_type": "hours",
        "data": {
          "mon": {
            "from": "09:00",
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          ...
          "data": [
            {
              "default_property_id": "1bf7a5a1-524f-4aec-a8eb-a9a3b1f12d6f"
            },
            {
              "name": "Delivery address",
              "default_property_id": "6a3a9570-cc5d-4fec-987a-78fa2f1f414b"
            }
          ]
        },
        "include": "results"
