...
```json
  {
  "data": {
    "id": "0c461dcd-534c-5989-a054-a7ec9b501590",
    "type": "bulk_upserts",
    "relationships": {
      "results": {
        "data": [
          {
            "type": "operating_rules",
            "id": "09190efb-f233-42f5-9b1e-2482c502c775"
          },
          {
            "type": "operating_rules",
            "id": "35c6cf90-cea9-45b4-b6b0-c2e5a9a86419"
          }
        ]
      }
    }
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          ...
          "data": [
            {
              "default_property_id": "4b2976ac-9ba3-4583-b03f-922ae592cdf7"
            },
            {
              "name": "Delivery address",
              "default_property_id": "911d41f1-2d47-4574-b481-246384756db4"
            }
          ]
        },
        "include": "results"
...
```json
  {
  "data": {
    "id": "46475202-251b-56a4-b7b1-a9ea11227dab",
    "type": "bulk_upserts",
    "relationships": {
      "results": {
        "meta": {
