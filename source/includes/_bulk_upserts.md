...
```json
  {
  "data": {
    "id": "3f58578e-a6c4-5cd1-9b0e-c7f5b64808b1",
    "type": "bulk_upserts",
    "relationships": {
      "results": {
        "data": [
          {
            "type": "operating_rules",
            "id": "5297137c-75b4-49c2-84b4-3de43e7229df"
          },
          {
            "type": "operating_rules",
            "id": "d0d1541e-f5d2-4541-b091-8f8d5bae5bc3"
          }
        ]
      }
    }
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          ...
          "data": [
            {
              "default_property_id": "998466d9-f16d-4151-b3dc-89022a774ced"
            },
            {
              "name": "Delivery address",
              "default_property_id": "04f7403a-86c9-4e61-b12f-078af1ee8c9c"
            }
          ]
        },
        "include": "results"
...
```json
  {
  "data": {
    "id": "8a60cee4-9b70-57ee-9863-f1a12b253170",
    "type": "bulk_upserts",
    "relationships": {
      "results": {
        "meta": {
