...
```json
  {
  "data": {
    "id": "abe58b65-14a9-5d17-9663-0dabc1c236d2",
    "type": "bulk_upserts",
    "relationships": {
      "results": {
        "data": [
          {
            "type": "operating_rules",
            "id": "703163fb-5ab2-4eab-837e-f1b767f90fe1"
          },
          {
            "type": "operating_rules",
            "id": "e586b60f-0e38-4008-94a0-d9a183eb7a8f"
          }
        ]
      }
    }
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          ...
          "data": [
            {
              "default_property_id": "1dd6fe72-7b78-47ac-b80b-7cb3a967e248"
            },
            {
              "name": "Delivery address",
              "default_property_id": "edf44610-0526-4d79-b743-e1d40ab5215b"
            }
          ]
        },
        "include": "results"
...
```json
  {
  "data": {
    "id": "58e74e43-7015-5f50-b50d-3d8ea7a37174",
    "type": "bulk_upserts",
    "relationships": {
      "results": {
        "meta": {
