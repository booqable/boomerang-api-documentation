...
```json
  {
  "data": {
    "id": "ef6d6e85-964b-5595-b945-83610583861c",
    "type": "bulk_upserts",
    "relationships": {
      "results": {
        "data": [
          {
            "type": "operating_rules",
            "id": "74898f71-edbf-413c-8149-5d38f7c8ac3d"
          },
          {
            "type": "operating_rules",
            "id": "a7ae95df-4b19-4546-8650-5b5eff194867"
          }
        ]
      }
    }
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          ...
          "data": [
            {
              "default_property_id": "b451d097-5361-4c4e-9dde-8c116a5d6fcf"
            },
            {
              "name": "Delivery address",
              "default_property_id": "46ffd9dd-e8b1-404e-a327-28377ecb210a"
            }
          ]
        },
        "include": "results"
...
```json
  {
  "data": {
    "id": "30b51d06-05ac-582f-9fd8-df23908bfc8b",
    "type": "bulk_upserts",
    "relationships": {
      "results": {
        "meta": {
