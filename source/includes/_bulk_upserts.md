...
```json
  {
  "data": {
    "id": "3036d527-e2e1-5866-918a-c1a816d1447b",
    "type": "bulk_upserts",
    "relationships": {
      "results": {
        "data": [
          {
            "type": "operating_rules",
            "id": "d4f06cb7-45c8-40da-b2dd-1667c126397c"
          },
          {
            "type": "operating_rules",
            "id": "fe63ad08-b3d4-4ce0-a352-169ac164711f"
          }
        ]
      }
    }
  ...
  "included": [
    {
      ...
      "type": "operating_rules",
      "attributes": {
        "created_at": "2023-02-09T13:05:31+00:00",
        "updated_at": "2023-02-09T13:05:31+00:00",
        "data_type": "hours",
        "data": {
          "mon": {
            "from": "09:00",
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          ...
          "data": [
            {
              "default_property_id": "3c27ad9c-49f2-4e16-bb85-2aa5401b3875"
            },
            {
              "name": "Delivery address",
              "default_property_id": "adc44129-5c7a-4ba5-8bb1-2be3a5aad612"
            }
          ]
        },
        "include": "results"
...
```json
  {
  "data": {
    "id": "6af30a7f-04f3-5688-aa21-44675be81418",
    "type": "bulk_upserts",
    "relationships": {
      "results": {
        "meta": {
