...
```json
  {
  "data": {
    "id": "7a1021ad-b243-5e4e-a7c5-ba7fe6a27de5",
    "type": "bulk_upserts",
    "relationships": {
      "results": {
        "data": [
          {
            "type": "operating_rules",
            "id": "77cfd467-7264-4084-856b-470ccc0de841"
          },
          {
            "type": "operating_rules",
            "id": "23e5761c-e26a-4820-b68b-147a6218f67b"
          }
        ]
      }
    }
  ...
  "included": [
    {
      ...
      "type": "operating_rules",
      "attributes": {
        "created_at": "2023-02-07T14:59:46+00:00",
        "updated_at": "2023-02-07T14:59:46+00:00",
        "data_type": "hours",
        "data": {
          "mon": {
            "from": "09:00",
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          ...
          "data": [
            {
              "default_property_id": "ba950b92-a23d-4989-a1ff-829f09a3368e"
            },
            {
              "name": "Delivery address",
              "default_property_id": "dfdae906-7236-4df9-8e20-8e434d014368"
            }
          ]
        },
        "include": "results"
