...
```json
  {
  "data": {
    "id": "11559332-67ef-5eb8-a522-a624dae82b3c",
    "type": "bulk_upserts",
    "relationships": {
      "results": {
        "data": [
          {
            "type": "operating_rules",
            "id": "7f41ce3a-bcaa-414f-80e3-24784bff9174"
          },
          {
            "type": "operating_rules",
            "id": "87283135-e63f-43c6-b0ca-b04b58992246"
          }
        ]
      }
    }
  ...
  "included": [
    {
      ...
      "type": "operating_rules",
      "attributes": {
        "created_at": "2023-03-07T11:35:01+00:00",
        "updated_at": "2023-03-07T11:35:01+00:00",
        "data_type": "hours",
        "data": {
          "mon": {
            "from": "09:00",
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          ...
          "data": [
            {
              "default_property_id": "8de68cd6-a6a7-4e8e-a383-6248dc5dfd7b"
            },
            {
              "name": "Delivery address",
              "default_property_id": "592cfb8d-b8b4-4afb-a161-82c4803de61d"
            }
          ]
        },
        "include": "results"
