...
```json
  {
  "data": {
    "id": "557a0c6c-aa47-550b-94f1-0182eaed87cd",
    "type": "bulk_upserts",
    "relationships": {
      "results": {
        "data": [
          {
            "type": "operating_rules",
            "id": "0eac7521-4a52-4790-9713-9bbd225f343a"
          },
          {
            "type": "operating_rules",
            "id": "cd499b21-c621-43dc-b39e-25a574492e02"
          }
        ]
      }
    }
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          ...
          "data": [
            {
              "default_property_id": "48c9b183-c541-4dc8-8400-bef3a51b32d7"
            },
            {
              "name": "Delivery address",
              "default_property_id": "74eb7b36-6bda-457f-8385-4158bb761275"
            }
          ]
        },
        "include": "results"
...
```json
  {
  "data": {
    "id": "b7e9f4c6-3792-5e81-8fe3-68a7c7182efa",
    "type": "bulk_upserts",
    "relationships": {
      "results": {
        "meta": {
...
```json
  {
  "data": {
    "id": "59b112a2-eaba-5bac-ac3a-72e9362d9484",
    "type": "bulk_upserts",
    "relationships": {
      "results": {
        "meta": {
