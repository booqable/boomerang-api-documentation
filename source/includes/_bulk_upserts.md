...
```json
  {
  "data": {
    "id": "bee52613-3b42-50c0-bfc1-c241664f0acc",
    "type": "bulk_upserts",
    "relationships": {
      "results": {
        "data": [
          {
            "type": "operating_rules",
            "id": "d40d05f1-57e2-434e-99b3-9a9e1081f6b9"
          },
          {
            "type": "operating_rules",
            "id": "7a78d9ee-6d78-4cd5-8b6b-429baf865811"
          }
        ]
      }
    }
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          ...
          "data": [
            {
              "default_property_id": "e0952403-4bf9-4d9b-851d-6a96a9445476"
            },
            {
              "name": "Delivery address",
              "default_property_id": "52a8c375-bd3e-4fcd-9725-6a50c685a31e"
            }
          ]
        },
        "include": "results"
...
```json
  {
  "data": {
    "id": "967247ea-db33-53e2-bada-028697eb1d0f",
    "type": "bulk_upserts",
    "relationships": {
      "results": {
        "meta": {
