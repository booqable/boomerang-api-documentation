...
```json
  {
  "data": {
    "id": "ee99d795-332b-5678-a4f2-1ed6d83855da",
    "type": "bulk_upserts",
    "relationships": {
      "results": {
        "data": [
          {
            "type": "operating_rules",
            "id": "e6c6dca5-d6f8-4e1f-99ad-f3c565635bcf"
          },
          {
            "type": "operating_rules",
            "id": "be7de77f-f98e-4201-ba8a-c026e4245911"
          }
        ]
      }
    }
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          ...
          "data": [
            {
              "default_property_id": "24b764ee-aaac-4f5d-95d8-aab3e5cc80ff"
            },
            {
              "name": "Delivery address",
              "default_property_id": "20deb3ea-04e8-46a0-b2e9-7da4764c4111"
            }
          ]
        },
        "include": "results"
...
```json
  {
  "data": {
    "id": "ce9ce6ef-b185-58e3-ab9a-f88aa11d0242",
    "type": "bulk_upserts",
    "relationships": {
      "results": {
        "meta": {
