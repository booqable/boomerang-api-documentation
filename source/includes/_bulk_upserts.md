...
```json
  {
  "data": {
    "id": "85b63b21-d2f3-5e94-8c29-077d95928fc8",
    "type": "bulk_upserts",
    "relationships": {
      "results": {
        "data": [
          {
            "type": "operating_rules",
            "id": "524246f6-3b4e-4dc8-8755-3ac99599b2fa"
          },
          {
            "type": "operating_rules",
            "id": "df7b3305-e5fb-4382-b705-8ffaca6d5151"
          }
        ]
      }
    }
  ...
  "included": [
    {
      ...
      "type": "operating_rules",
      "attributes": {
        "created_at": "2022-06-01T08:55:34+00:00",
        "updated_at": "2022-06-01T08:55:34+00:00",
        "data_type": "hours",
        "data": {
          "mon": {
            "from": "09:00",
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          ...
          "data": [
            {
              "default_property_id": "41738986-f45c-4005-8a26-76c573b78b1f"
            },
            {
              "name": "Delivery address",
              "default_property_id": "310b324a-a0cc-4338-a91f-43591115a0fa"
            }
          ]
        },
        "include": "results"
