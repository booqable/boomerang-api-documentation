...
```json
  {
  "data": {
    "id": "4bc3da55-c906-5e53-b819-14533a5675bf",
    "type": "bulk_upserts",
    "relationships": {
      "results": {
        "data": [
          {
            "type": "operating_rules",
            "id": "1aabb050-15d5-4d31-8827-ba7444fe1126"
          },
          {
            "type": "operating_rules",
            "id": "148f4da4-2a41-473b-a4f9-28568f289bf8"
          }
        ]
      }
    }
  ...
  "included": [
    {
      ...
      "type": "operating_rules",
      "attributes": {
        "created_at": "2023-02-13T12:52:22+00:00",
        "updated_at": "2023-02-13T12:52:22+00:00",
        "data_type": "hours",
        "data": {
          "mon": {
            "from": "09:00",
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          ...
          "data": [
            {
              "default_property_id": "4d1821fb-04f4-4826-8d81-59d19fb022e7"
            },
            {
              "name": "Delivery address",
              "default_property_id": "342a2c7d-2b49-4387-a11e-4e862e84557a"
            }
          ]
        },
        "include": "results"
...
```json
  {
  "data": {
    "id": "eb84a089-22ae-5c81-9a8c-121569d912d5",
    "type": "bulk_upserts",
    "relationships": {
      "results": {
        "meta": {
