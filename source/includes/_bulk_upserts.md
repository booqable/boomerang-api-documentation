...
```json
  {
  "data": {
    "id": "b13ad36e-207d-575e-8d89-d050044298c8",
    "type": "bulk_upserts",
    "relationships": {
      "results": {
        "data": [
          {
            "type": "operating_rules",
            "id": "0abc6383-f586-431b-a98a-48389dd1f2a0"
          },
          {
            "type": "operating_rules",
            "id": "c3e0e196-e0e4-4586-bde4-31e57414c28e"
          }
        ]
      }
    }
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          ...
          "data": [
            {
              "default_property_id": "74aa5baf-119a-4fc3-9d56-fa3b96add270"
            },
            {
              "name": "Delivery address",
              "default_property_id": "168aa2a9-b1fd-4289-a182-0065c9f6f0ce"
            }
          ]
        },
        "include": "results"
...
```json
  {
  "data": {
    "id": "c3ef8d79-1b24-5979-a692-3231461944e7",
    "type": "bulk_upserts",
    "relationships": {
      "results": {
        "meta": {
