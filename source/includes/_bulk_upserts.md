...
```json
  {
  "data": {
    "id": "318fa815-21e1-521b-b2c1-b4a5ce63e0b8",
    "type": "bulk_upserts",
    "relationships": {
      "results": {
        "data": [
          {
            "type": "operating_rules",
            "id": "3474deea-9e88-4f6d-b7a2-29c3441e9e89"
          },
          {
            "type": "operating_rules",
            "id": "75c8784a-9734-420e-b980-1eba4da04647"
          }
        ]
      }
    }
  ...
  "included": [
    {
      ...
      "type": "operating_rules",
      "attributes": {
        "created_at": "2023-02-06T18:56:58+00:00",
        "updated_at": "2023-02-06T18:56:58+00:00",
        "data_type": "hours",
        "data": {
          "mon": {
            "from": "09:00",
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          ...
          "data": [
            {
              "default_property_id": "55443bbd-72cf-4f5b-8028-012152ba6e94"
            },
            {
              "name": "Delivery address",
              "default_property_id": "df354c71-7638-42cb-96a5-424e863d2cc8"
            }
          ]
        },
        "include": "results"
...
```json
  {
  "data": {
    "id": "03a37864-8f33-572a-a5b9-ee3b959bba87",
    "type": "bulk_upserts",
    "relationships": {
      "results": {
        "meta": {
