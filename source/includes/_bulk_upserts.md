...
```json
  {
  "data": {
    "id": "cd930992-b54c-522d-8a8c-d26563b62758",
    "type": "bulk_upserts",
    "relationships": {
      "results": {
        "data": [
          {
            "type": "operating_rules",
            "id": "af349325-8ebc-43cd-bed2-21df36eb3199"
          },
          {
            "type": "operating_rules",
            "id": "5c136b1c-9982-4e77-897f-916e6420b92c"
          }
        ]
      }
    }
  ...
  "included": [
    {
      ...
      "type": "operating_rules",
      "attributes": {
        "created_at": "2023-02-09T15:54:41+00:00",
        "updated_at": "2023-02-09T15:54:41+00:00",
        "data_type": "hours",
        "data": {
          "mon": {
            "from": "09:00",
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          ...
          "data": [
            {
              "default_property_id": "0649db97-bada-45d1-b383-c2ba47d28e9c"
            },
            {
              "name": "Delivery address",
              "default_property_id": "198a460c-4040-490d-b637-eff24cf2e305"
            }
          ]
        },
        "include": "results"
