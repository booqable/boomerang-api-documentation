...
```json
  {
  "data": {
    "id": "b87870fb-ae29-53d9-bc05-bbf75fb1de59",
    "type": "bulk_upserts",
    "relationships": {
      "results": {
        "data": [
          {
            "type": "operating_rules",
            "id": "878a8384-f1f0-4a8a-a582-f0a5eb2f8325"
          },
          {
            "type": "operating_rules",
            "id": "65c2d995-1310-4084-b1a8-b4f2c3dcab71"
          }
        ]
      }
    }
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          ...
          "data": [
            {
              "default_property_id": "29c7443f-5525-43a5-a10a-953930fa6a45"
            },
            {
              "name": "Delivery address",
              "default_property_id": "52e0160c-c799-4019-96ce-8453d99fdc8c"
            }
          ]
        },
        "include": "results"
...
```json
  {
  "data": {
    "id": "7043b11e-d57d-5ba6-92a0-3ff10633af4c",
    "type": "bulk_upserts",
    "relationships": {
      "results": {
        "meta": {
