...
```json
  {
  "data": {
    "id": "270d7e9b-a683-5097-a347-279f362f4a32",
    "type": "bulk_upserts",
    "relationships": {
      "results": {
        "data": [
          {
            "type": "operating_rules",
            "id": "6030197c-800c-4080-a4a9-f01deb416f49"
          },
          {
            "type": "operating_rules",
            "id": "dca7d009-a73b-47dc-8842-bb3a507dfe7a"
          }
        ]
      }
    }
  ...
  "included": [
    {
      ...
      "type": "operating_rules",
      "attributes": {
        "created_at": "2023-02-08T16:17:08+00:00",
        "updated_at": "2023-02-08T16:17:08+00:00",
        "data_type": "hours",
        "data": {
          "mon": {
            "from": "09:00",
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          ...
          "data": [
            {
              "default_property_id": "2b4084f9-6cfd-4377-b3a8-47239fbd5879"
            },
            {
              "name": "Delivery address",
              "default_property_id": "dd634f8a-07be-40d4-88b1-79d94b4a8e97"
            }
          ]
        },
        "include": "results"
...
```json
  {
  "data": {
    "id": "8bcc8163-d92b-5a2e-a608-e82516e4f2cd",
    "type": "bulk_upserts",
    "relationships": {
      "results": {
        "meta": {
...
```json
  {
  "data": {
    "id": "2b6511ef-1921-5788-817a-d7b77792824e",
    "type": "bulk_upserts",
    "relationships": {
      "results": {
        "meta": {
