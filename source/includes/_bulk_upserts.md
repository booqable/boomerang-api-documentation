...
```json
  {
  "data": {
    "id": "fa76d0bd-a620-58e9-995b-39ecab3c0269",
    "type": "bulk_upserts",
    "relationships": {
      "results": {
        "data": [
          {
            "type": "operating_rules",
            "id": "ff246fa0-e357-4a8c-a0e2-b844ed4e88bb"
          },
          {
            "type": "operating_rules",
            "id": "29837159-23f1-457b-963f-067f7ecadd6e"
          }
        ]
      }
    }
  ...
  "included": [
    {
      ...
      "type": "operating_rules",
      "attributes": {
        "created_at": "2023-01-05T13:01:55+00:00",
        "updated_at": "2023-01-05T13:01:55+00:00",
        "data_type": "hours",
        "data": {
          "mon": {
            "from": "09:00",
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          ...
          "data": [
            {
              "default_property_id": "adb00187-8343-42a8-afb0-e134b18c23ab"
            },
            {
              "name": "Delivery address",
              "default_property_id": "2aa56ae2-c5f7-4845-b321-b5b2182d1de2"
            }
          ]
        },
        "include": "results"
...
```json
  {
  "data": {
    "id": "8524add4-4eaf-595e-80c5-71d5fdc30e59",
    "type": "bulk_upserts",
    "relationships": {
      "results": {
        "meta": {
