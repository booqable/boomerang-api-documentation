...
```json
  {
  "data": {
    "id": "fca6ac32-e095-53d2-ac46-19012da6665d",
    "type": "bulk_upserts",
    "relationships": {
      "results": {
        "data": [
          {
            "type": "operating_rules",
            "id": "96b74ed3-840e-4e77-be4d-77dfe948e4de"
          },
          {
            "type": "operating_rules",
            "id": "5b0be126-a841-405f-addc-97e23e45ec04"
          }
        ]
      }
    }
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          ...
          "data": [
            {
              "default_property_id": "3347beee-12cf-4365-a005-53315d4b03e6"
            },
            {
              "name": "Delivery address",
              "default_property_id": "33a68fcc-5ad1-44f2-bd97-a8fb9714c354"
            }
          ]
        },
        "include": "results"
...
```json
  {
  "data": {
    "id": "a2250581-055c-5959-afdd-21979c02ea10",
    "type": "bulk_upserts",
    "relationships": {
      "results": {
        "meta": {
