...
```json
  {
  "data": {
    "id": "a2ef3bfb-56ea-5a49-b80d-6ddd91ba7bc2",
    "type": "bulk_upserts",
    "relationships": {
      "results": {
        "data": [
          {
            "type": "operating_rules",
            "id": "0113cc64-6193-47a5-a455-3ce3949760db"
          },
          {
            "type": "operating_rules",
            "id": "0c3189b9-a614-4c5a-9cf9-49f2e4fd97d7"
          }
        ]
      }
    }
  ...
  "included": [
    {
      ...
      "type": "operating_rules",
      "attributes": {
        "created_at": "2023-02-13T15:59:37+00:00",
        "updated_at": "2023-02-13T15:59:37+00:00",
        "data_type": "hours",
        "data": {
          "mon": {
            "from": "09:00",
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          ...
          "data": [
            {
              "default_property_id": "4364d023-4640-4981-be2a-b05ecc6582f3"
            },
            {
              "name": "Delivery address",
              "default_property_id": "a09ea233-33ff-477d-8930-b1394ef03348"
            }
          ]
        },
        "include": "results"
