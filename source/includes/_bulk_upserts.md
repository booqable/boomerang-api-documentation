...
```json
  {
  "data": {
    "id": "3893113f-15b7-5048-b854-9276e6a912d7",
    "type": "bulk_upserts",
    "relationships": {
      "results": {
        "data": [
          {
            "type": "operating_rules",
            "id": "cc82479b-ee13-48ac-a2da-e536791085fa"
          },
          {
            "type": "operating_rules",
            "id": "75d0c572-7e18-4b87-95e7-6a119ae980ca"
          }
        ]
      }
    }
  ...
  "included": [
    {
      ...
      "type": "operating_rules",
      "attributes": {
        "created_at": "2023-03-07T08:07:49+00:00",
        "updated_at": "2023-03-07T08:07:49+00:00",
        "data_type": "hours",
        "data": {
          "mon": {
            "from": "09:00",
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          ...
          "data": [
            {
              "default_property_id": "c302082d-7179-43d9-9fd5-26e98bb6797f"
            },
            {
              "name": "Delivery address",
              "default_property_id": "db111cc7-19bf-4c52-9fce-57b179123513"
            }
          ]
        },
        "include": "results"
...
```json
  {
  "data": {
    "id": "e5cb28a2-5cb3-5218-bbe4-31bffe82b47d",
    "type": "bulk_upserts",
    "relationships": {
      "results": {
        "meta": {
