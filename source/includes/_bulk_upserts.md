...
```json
  {
  "data": {
    "id": "af654e93-703c-5d17-8e4d-3d53a3e99623",
    "type": "bulk_upserts",
    "relationships": {
      "results": {
        "data": [
          {
            "type": "operating_rules",
            "id": "ab8341ed-e39d-4013-873e-75e826f4ce52"
          },
          {
            "type": "operating_rules",
            "id": "7de40f30-cc9f-45ab-b7a9-7ccbf21de584"
          }
        ]
      }
    }
  ...
  "included": [
    {
      ...
      "type": "operating_rules",
      "attributes": {
        "created_at": "2022-10-25T16:29:54+00:00",
        "updated_at": "2022-10-25T16:29:54+00:00",
        "data_type": "hours",
        "data": {
          "mon": {
            "from": "09:00",
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          ...
          "data": [
            {
              "default_property_id": "7a6914d3-2de4-451b-9026-bf61b4b67f86"
            },
            {
              "name": "Delivery address",
              "default_property_id": "6ea4ce98-580b-4194-b5fd-eee05ba2264e"
            }
          ]
        },
        "include": "results"
