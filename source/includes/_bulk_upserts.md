...
```json
  {
  "data": {
    "id": "fcd2eec1-ab70-50df-afef-fedb292917ef",
    "type": "bulk_upserts",
    "relationships": {
      "results": {
        "data": [
          {
            "type": "operating_rules",
            "id": "55b455a3-5fab-44a5-ba54-1037c55acb5d"
          },
          {
            "type": "operating_rules",
            "id": "8c12e871-198b-4fd7-aaff-35d7047f8e4e"
          }
        ]
      }
    }
  ...
  "included": [
    {
      ...
      "type": "operating_rules",
      "attributes": {
        "created_at": "2023-02-07T10:56:55+00:00",
        "updated_at": "2023-02-07T10:56:55+00:00",
        "data_type": "hours",
        "data": {
          "mon": {
            "from": "09:00",
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          ...
          "data": [
            {
              "default_property_id": "362b6409-d23a-47d7-a2ca-10faaec7556c"
            },
            {
              "name": "Delivery address",
              "default_property_id": "cc139e15-30f6-4461-bcec-c00d2a02f5a9"
            }
          ]
        },
        "include": "results"
...
```json
  {
  "data": {
    "id": "c9bbd289-49a7-516e-9e17-5b579f3da987",
    "type": "bulk_upserts",
    "relationships": {
      "results": {
        "meta": {
