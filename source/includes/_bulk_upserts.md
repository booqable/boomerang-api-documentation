...
```json
  {
  "data": {
    "id": "cc524512-5a50-5dd4-aa3a-f1151f1bdbac",
    "type": "bulk_upserts",
    "relationships": {
      "results": {
        "data": [
          {
            "type": "operating_rules",
            "id": "bf4bc587-fbe6-4d40-b8ff-844fc65b0b1a"
          },
          {
            "type": "operating_rules",
            "id": "09054e20-9331-4569-9bc1-1608fc418643"
          }
        ]
      }
    }
  ...
  "included": [
    {
      ...
      "type": "operating_rules",
      "attributes": {
        "created_at": "2022-01-20T12:33:13+00:00",
        "updated_at": "2022-01-20T12:33:13+00:00",
        "data_type": "hours",
        "data": {
          "mon": {
            "from": "09:00",
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          ...
          "data": [
            {
              "default_property_id": "738c7a65-a665-4edc-9e35-27e046146606"
            },
            {
              "name": "Delivery address",
              "default_property_id": "e29e6bb9-be86-465f-a29e-c8b7d8fc4f99"
            }
          ]
        },
        "include": "results"
