...
```json
  {
  "data": {
    "id": "10e5c53b-01bc-50a1-9bcb-54620bae6fe0",
    "type": "bulk_upserts",
    "relationships": {
      "results": {
        "data": [
          {
            "type": "operating_rules",
            "id": "0507d41b-f011-47d2-b6cd-55e7eb3d6f8f"
          },
          {
            "type": "operating_rules",
            "id": "13092157-2a40-47ee-b12b-8dd120ca3b3a"
          }
        ]
      }
    }
  ...
  "included": [
    {
      ...
      "type": "operating_rules",
      "attributes": {
        "created_at": "2023-02-21T10:48:00+00:00",
        "updated_at": "2023-02-21T10:48:00+00:00",
        "data_type": "hours",
        "data": {
          "mon": {
            "from": "09:00",
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          ...
          "data": [
            {
              "default_property_id": "989e6c5d-d527-446f-9035-9154a1b9cfd4"
            },
            {
              "name": "Delivery address",
              "default_property_id": "b1d87f84-7421-46ed-bda2-5066908908f9"
            }
          ]
        },
        "include": "results"
...
```json
  {
  "data": {
    "id": "e5ad9442-18ad-53e7-b717-23a1b12b1cd4",
    "type": "bulk_upserts",
    "relationships": {
      "results": {
        "meta": {
