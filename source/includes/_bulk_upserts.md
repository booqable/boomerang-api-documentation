...
```json
  {
  "data": {
    "id": "e0e625ae-fade-58db-abfd-731d493a7683",
    "type": "bulk_upserts",
    "relationships": {
      "results": {
        "data": [
          {
            "type": "operating_rules",
            "id": "5f92dc3c-3f59-4578-a71c-a91f53a8d5ad"
          },
          {
            "type": "operating_rules",
            "id": "c01e0c4e-1e48-4e22-a895-a217ef58d6bd"
          }
        ]
      }
    }
  ...
  "included": [
    {
      ...
      "type": "operating_rules",
      "attributes": {
        "created_at": "2022-07-15T09:53:10+00:00",
        "updated_at": "2022-07-15T09:53:10+00:00",
        "data_type": "hours",
        "data": {
          "mon": {
            "from": "09:00",
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          ...
          "data": [
            {
              "default_property_id": "716416da-7344-4a7a-aadc-ae6433e17a53"
            },
            {
              "name": "Delivery address",
              "default_property_id": "26d92a8b-62a6-41cd-b9fe-e25f0fc700cf"
            }
          ]
        },
        "include": "results"
...
```json
  {
  "data": {
    "id": "fdffc1d0-40fe-55fd-b145-c7124422f086",
    "type": "bulk_upserts",
    "relationships": {
      "results": {
        "meta": {
