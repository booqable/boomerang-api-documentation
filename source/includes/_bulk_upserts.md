...
```json
  {
  "data": {
    "id": "11c27943-9c2f-522f-8f57-2463e7eea55d",
    "type": "bulk_upserts",
    "relationships": {
      "results": {
        "data": [
          {
            "type": "operating_rules",
            "id": "4fa457aa-3c57-4351-80a8-408f7eb886fe"
          },
          {
            "type": "operating_rules",
            "id": "668590e3-9d00-4064-8cd9-51887d47083e"
          }
        ]
      }
    }
  ...
  "included": [
    {
      ...
      "type": "operating_rules",
      "attributes": {
        "created_at": "2023-01-18T13:34:49+00:00",
        "updated_at": "2023-01-18T13:34:49+00:00",
        "data_type": "hours",
        "data": {
          "mon": {
            "from": "09:00",
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          ...
          "data": [
            {
              "default_property_id": "ffb9db96-ff9b-40aa-87a1-76f912d9237d"
            },
            {
              "name": "Delivery address",
              "default_property_id": "3fdac639-7094-43d4-bb9c-7063b738623c"
            }
          ]
        },
        "include": "results"
