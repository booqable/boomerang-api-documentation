...
```json
  {
  "data": {
    "id": "ee923c6b-1b94-4206-b293-165ebfa3eb49",
    "type": "companies",
    "attributes": {
      "created_at": "2023-03-07T08:27:20+00:00",
      "updated_at": "2023-03-07T08:27:20+00:00",
      "name": "iRent",
      "slug": "irent",
...
```json
  {
  "data": {
    "id": "9206ece0-0ec1-402d-b690-c4a57cb2f54e",
    "type": "companies",
    "attributes": {
      "subscription": {
        "trial_ends_at": "2023-03-21T08:27:20.479Z",
        "activated": false,
        "suspended": false,
        "canceled": false,
        "canceled_at": null,
...
```shell
  curl --request PUT \
    ...
    --data '{
      "data": {
        "id": "f4343ebb-b765-4553-b701-0198d7be6b70",
        "type": "companies",
        "attributes": {
          "name": "iRent LLC"
        }
