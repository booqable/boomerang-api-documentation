...
```json
  {
  "data": {
    "id": "041502bd-3ab7-4561-bd0d-7b29f9aa8655",
    "type": "companies",
    "attributes": {
      "created_at": "2023-02-02T11:15:26+00:00",
      "updated_at": "2023-02-02T11:15:26+00:00",
      "name": "iRent",
      "slug": "irent",
...
```json
  {
  "data": {
    "id": "2b4c138a-cacd-42d9-9bda-86acc254a1a5",
    "type": "companies",
    "attributes": {
      "subscription": {
        "trial_ends_at": "2023-02-16T11:15:26.327Z",
        "activated": false,
        "suspended": false,
        "canceled": false,
        "canceled_at": null,
...
```shell
  curl --request PUT \
    ...
    --data '{
      "data": {
        "id": "421cb659-b543-4971-8627-7ef04b2e4cd8",
        "type": "companies",
        "attributes": {
          "name": "iRent LLC"
        }
