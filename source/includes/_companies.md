...
```json
  {
  "data": {
    "id": "5172024d-3095-41fe-8593-4a3b5b60dea9",
    "type": "companies",
    "attributes": {
      "created_at": "2023-01-26T12:16:18+00:00",
      "updated_at": "2023-01-26T12:16:18+00:00",
      "name": "iRent",
      "slug": "irent",
...
```json
  {
  "data": {
    "id": "62174874-213e-43d9-ab7d-8050cee58092",
    "type": "companies",
    "attributes": {
      "subscription": {
        "trial_ends_at": "2023-02-09T12:16:18.481Z",
        "activated": false,
        "suspended": false,
        "canceled": false,
        "canceled_at": null,
...
```shell
  curl --request PUT \
    ...
    --data '{
      "data": {
        "id": "c1672b58-08cb-4c35-be4a-cbd7e0ee0758",
        "type": "companies",
        "attributes": {
          "name": "iRent LLC"
        }
