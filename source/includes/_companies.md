...
```json
  {
  "data": {
    "id": "e1f63dbc-e057-4825-b450-cd7c5be96d61",
    "type": "companies",
    "attributes": {
      "created_at": "2023-02-16T09:59:27+00:00",
      "updated_at": "2023-02-16T09:59:27+00:00",
      "name": "iRent",
      "slug": "irent",
...
```json
  {
  "data": {
    "id": "316b4ed9-26f8-439e-ab05-c600ea7e89fe",
    "type": "companies",
    "attributes": {
      "subscription": {
        "trial_ends_at": "2023-03-02T09:59:27.412Z",
        "activated": false,
        "suspended": false,
        "canceled": false,
        "canceled_at": null,
...
```shell
  curl --request PUT \
    ...
    --data '{
      "data": {
        "id": "6086403a-423a-4db5-9c60-e0a8cbee5fb0",
        "type": "companies",
        "attributes": {
          "name": "iRent LLC"
        }
