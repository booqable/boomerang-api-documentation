...
```json
  {
  "data": {
    "id": "24be0a89-e158-469d-9254-6e22918f9ac3",
    "type": "companies",
    "attributes": {
      "created_at": "2022-08-19T07:55:53+00:00",
      "updated_at": "2022-08-19T07:55:53+00:00",
      "name": "iRent",
      "slug": "irent",
...
```json
  {
  "data": {
    "id": "c1b96319-0e02-4612-83f6-8369fbf4e3be",
    "type": "companies",
    "attributes": {
      "subscription": {
        "trial_ends_at": "2022-09-02T07:55:53.553Z",
        "activated": false,
        "suspended": false,
        "canceled": false,
        "canceled_at": null,
...
```shell
  curl --request PUT \
    ...
    --data '{
      "data": {
        "id": "938a57fb-a7e4-46ac-9791-3e5d529455e7",
        "type": "companies",
        "attributes": {
          "name": "iRent LLC"
        }
...
```json
  ...
  "data": {
    ...
    "type": "companies",
    "attributes": {
      "created_at": "2022-08-19T07:55:54+00:00",
      "updated_at": "2022-08-19T07:55:54+00:00",
      "name": "iRent LLC",
      "slug": "irent",
