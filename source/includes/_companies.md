...
```json
  {
  "data": {
    "id": "0336f7eb-a901-4fe6-98a6-017537fb2f6c",
    "type": "companies",
    "attributes": {
      "created_at": "2022-09-16T11:48:34+00:00",
      "updated_at": "2022-09-16T11:48:34+00:00",
      "name": "iRent",
      "slug": "irent",
...
```json
  {
  "data": {
    "id": "162650e1-05cd-49a8-986c-5b0137156439",
    "type": "companies",
    "attributes": {
      "subscription": {
        "trial_ends_at": "2022-09-30T11:48:34.337Z",
        "activated": false,
        "suspended": false,
        "canceled": false,
        "canceled_at": null,
...
```shell
  curl --request PUT \
    ...
    --data '{
      "data": {
        "id": "623db398-b01c-40b6-aae9-a4d282db991e",
        "type": "companies",
        "attributes": {
          "name": "iRent LLC"
        }
