...
```json
  {
  "data": {
    "id": "f606c35f-c8e4-4271-adc7-1838b0ade214",
    "type": "companies",
    "attributes": {
      "created_at": "2023-02-13T12:46:14+00:00",
      "updated_at": "2023-02-13T12:46:14+00:00",
      "name": "iRent",
      "slug": "irent",
...
```json
  {
  "data": {
    "id": "0e3d886e-7088-4e74-9295-6633f4e84aef",
    "type": "companies",
    "attributes": {
      "subscription": {
        "trial_ends_at": "2023-02-27T12:46:14.403Z",
        "activated": false,
        "suspended": false,
        "canceled": false,
        "canceled_at": null,
...
```shell
  curl --request PUT \
    ...
    --data '{
      "data": {
        "id": "9312e356-18bd-4789-a7d6-a7b173ebc6fe",
        "type": "companies",
        "attributes": {
          "name": "iRent LLC"
        }
