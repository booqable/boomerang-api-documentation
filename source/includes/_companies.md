...
```json
  {
  "data": {
    "id": "c08576f5-5869-48b0-9d2d-6e4f47632975",
    "type": "companies",
    "attributes": {
...
```json
  {
  "data": {
    "id": "f3a7d020-ae05-460c-8437-54388828c9e3",
    "type": "companies",
    "attributes": {
      "subscription": {
        "trial_ends_at": "2023-02-28T11:04:12.658Z",
        "activated": false,
        "suspended": false,
        "canceled": false,
        "canceled_at": null,
...
```shell
  curl --request PUT \
    ...
    --data '{
      "data": {
        "id": "e62fad77-276f-4470-a91a-4488b8cfd2be",
        "type": "companies",
        "attributes": {
          "name": "iRent LLC"
        }
...
```json
  ...
  "data": {
    ...
    "attributes": {
      "created_at": "2023-02-14T11:04:12+00:00",
      "updated_at": "2023-02-14T11:04:13+00:00",
      "name": "iRent LLC",
      "slug": "irent",
