...
```json
  {
  "data": {
    "id": "28a1cfb9-9c52-49bf-8aeb-7ce8f0dbd023",
    "type": "companies",
    "attributes": {
      "created_at": "2022-06-08T14:24:36+00:00",
      "updated_at": "2022-06-08T14:24:36+00:00",
      "name": "iRent",
      "slug": "irent",
      "email": "mail55@company.com",
      "billing_email": null,
      "phone": "115.674.8021 x7164",
      "website": "http://schmitt.net/janina.berge",
      "address": "Samatha Extensions\n68720 Weston Harbor\n69687-4732 Estherside\nthe Netherlands",
      "address_line_1": "Samatha Extensions",
      "address_line_2": "68720 Weston Harbor",
      "zipcode": "69687-4732",
      "city": "Estherside",
      "region": null,
      ...
      "currency": "usd",
      "financial_line_1": "198 Satterfield Bypass",
      "financial_line_2": "88165 North Laverne",
      "vat_number": null,
      "custom_domain": null,
      "development": false,
      "shop_theme_id": null
...
```json
  {
  "data": {
    "id": "dc686fe1-2030-4fc2-aa14-220e1366727b",
    "type": "companies",
    "attributes": {
      "subscription": {
        "trial_ends_at": "2022-06-22T14:24:37.140Z",
        "activated": false,
        "suspended": false,
        "canceled": false,
        "canceled_at": null,
...
```shell
  curl --request PUT \
    ...
    --data '{
      "data": {
        "id": "996bd2c8-724e-4ac3-9a1f-56581272cbf2",
        "type": "companies",
        "attributes": {
          "name": "iRent LLC"
        }
...
```json
  ...
  "data": {
    ...
    "attributes": {
      ...
      "billing_email": null,
      "phone": "912.153.1504 x6462",
      "website": "http://schmitt.co/pierre_blick",
      "address": "Shannon Throughway\n8258 Fisher Road\n64881 East Annalee\nthe Netherlands",
      "address_line_1": "Shannon Throughway",
      "address_line_2": "8258 Fisher Road",
      "zipcode": "64881",
      "city": "East Annalee",
      "region": null,
      "country": "the Netherlands",
      ...
      "default_timezone": "UTC",
      "currency": "usd",
      "financial_line_1": "92677 Milford Mall",
      "financial_line_2": "53784-3646 North Gracefurt",
      "vat_number": null,
      "custom_domain": null,
      "development": false,
      "shop_theme_id": null
