...
```json
  {
  "data": {
    "id": "f2ebfc9d-1ef3-4d78-b213-188f85df8cad",
    "type": "companies",
    "attributes": {
      "created_at": "2022-11-22T16:46:05+00:00",
      "updated_at": "2022-11-22T16:46:05+00:00",
      "name": "iRent",
      "slug": "irent",
...
```json
  {
  "data": {
    "id": "310e7663-52e9-4029-bc03-1e63ef5873d6",
    "type": "companies",
    "attributes": {
      "subscription": {
        "trial_ends_at": "2022-12-06T16:46:05.455Z",
        "activated": false,
        "suspended": false,
        "canceled": false,
        "canceled_at": null,
...
```shell
  curl --request PUT \
    ...
    --data '{
      "data": {
        "id": "9faaee39-4903-4062-b279-260adcabff3b",
        "type": "companies",
        "attributes": {
          "name": "iRent LLC"
        }
