...
```json
  {
  "data": {
    "id": "fd79aefc-80db-4a88-8cec-e0584e6de789",
    "type": "companies",
    "attributes": {
...
```json
  {
  "data": {
    "id": "17fe93cb-f0bd-46aa-ab1b-51faef31a906",
    "type": "companies",
    "attributes": {
      "subscription": {
        "trial_ends_at": "2023-02-28T11:03:57.192Z",
        "activated": false,
        "suspended": false,
        "canceled": false,
        "canceled_at": null,
...
```shell
  curl --request PUT \
    ...
    --data '{
      "data": {
        "id": "6a9c555f-b240-4ce3-8fd0-419176b5b9e8",
        "type": "companies",
        "attributes": {
          "name": "iRent LLC"
        }
