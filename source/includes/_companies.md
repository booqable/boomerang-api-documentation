...
```json
  {
  "data": {
    "id": "58674910-947a-4d55-92d4-6e35b6bc83aa",
    "type": "companies",
    "attributes": {
...
```json
  {
  "data": {
    "id": "7c897a75-ab2b-4cdb-8971-1c4f411911bf",
    "type": "companies",
    "attributes": {
      "subscription": {
        "trial_ends_at": "2022-12-06T16:34:50.946Z",
        "activated": false,
        "suspended": false,
        "canceled": false,
        "canceled_at": null,
...
```shell
  curl --request PUT \
    ...
    --data '{
      "data": {
        "id": "e7b9d21f-9bdb-4365-84cf-f65da9d05416",
        "type": "companies",
        "attributes": {
          "name": "iRent LLC"
        }
