...
```json
  {
  "data": {
    "id": "5a6f13a6-b000-48e5-8ebf-28790c210424",
    "type": "companies",
    "attributes": {
...
```json
  {
  "data": {
    "id": "27ba77c8-36e2-4f96-b545-8db811fa17f9",
    "type": "companies",
    "attributes": {
      "subscription": {
        "trial_ends_at": "2023-03-23T08:57:07.455Z",
        "activated": false,
        "suspended": false,
        "canceled": false,
        "canceled_at": null,
...
```shell
  curl --request PUT \
    ...
    --data '{
      "data": {
        "id": "16532974-975e-44ea-abff-c7ebf9fa05fd",
        "type": "companies",
        "attributes": {
          "name": "iRent LLC"
        }
