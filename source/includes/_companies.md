...
```json
  {
  "data": {
    "id": "3d38cde3-0721-415b-8160-9fc48cf016ca",
    "type": "companies",
    "attributes": {
      "created_at": "2023-02-24T14:56:33+00:00",
      "updated_at": "2023-02-24T14:56:33+00:00",
      "name": "iRent",
      "slug": "irent",
...
```json
  {
  "data": {
    "id": "4295f9a7-8295-40cc-8ed9-7301cff5ae88",
    "type": "companies",
    "attributes": {
      "subscription": {
        "trial_ends_at": "2023-03-10T14:56:33.394Z",
        "activated": false,
        "suspended": false,
        "canceled": false,
        "canceled_at": null,
...
```shell
  curl --request PUT \
    ...
    --data '{
      "data": {
        "id": "3b7c1989-e0b7-41c8-a9b5-76edf29f2529",
        "type": "companies",
        "attributes": {
          "name": "iRent LLC"
        }
