...
```json
  {
  "data": {
    "id": "549a5964-e1f2-4df2-856b-760500699ecf",
    "type": "companies",
    "attributes": {
...
```json
  {
  "data": {
    "id": "6d83c694-9360-4b38-b270-d67186af1c08",
    "type": "companies",
    "attributes": {
      "subscription": {
        "trial_ends_at": "2023-03-24T08:37:11.517Z",
        "activated": false,
        "suspended": false,
        "canceled": false,
        "canceled_at": null,
...
```shell
  curl --request PUT \
    ...
    --data '{
      "data": {
        "id": "2c50ab3c-ece7-4e78-9c31-d6371e18a0ec",
        "type": "companies",
        "attributes": {
          "name": "iRent LLC"
        }
