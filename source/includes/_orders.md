...
```json
  ...
  "data": [
    {
      "id": "129cd48e-ce0f-4a5d-9311-bf9008639633",
      "type": "orders",
      "attributes": {
        "number": 1,
        "status": "concept",
        ...
        "starts_at": "2021-11-06T07:45:00+00:00",
        "stops_at": "2021-11-07T07:45:00+00:00",
        ...
        "customer_id": "8bbb6d87-09c8-4fdf-933e-7f353816e822",
        "tax_region_id": null,
        "coupon_id": null,
        "start_location_id": "abd907a3-a346-44d7-9ad5-0a58a3696eaa",
        "stop_location_id": "abd907a3-a346-44d7-9ad5-0a58a3696eaa"
      },
      "relationships": {
        "customer": {
          "links": {
            "related": "api/boomerang/customers/8bbb6d87-09c8-4fdf-933e-7f353816e822"
          }
        },
        "tax_region": {
          "links": {
        ...
        "barcode": {
          "links": {
            "related": "api/boomerang/barcodes?filter[owner_id]=129cd48e-ce0f-4a5d-9311-bf9008639633"
          }
        },
        "start_location": {
          "links": {
            "related": "api/boomerang/locations/abd907a3-a346-44d7-9ad5-0a58a3696eaa"
          }
        },
        "stop_location": {
          "links": {
...
```json
  {
  "data": {
    "id": "156edc32-032c-436b-ae11-3a845a0a20b0",
    "type": "orders",
    "attributes": {
      "number": null,
      "status": "new",
      ...
      "tax_region_id": null,
      "coupon_id": null,
      "start_location_id": "0db08a58-89eb-4175-b94b-d175679aee88",
      "stop_location_id": "0db08a58-89eb-4175-b94b-d175679aee88"
    },
    "relationships": {
      "customer": {
        "links": {
      ...
      "barcode": {
        "links": {
          "related": "api/boomerang/barcodes?filter[owner_id]=156edc32-032c-436b-ae11-3a845a0a20b0"
        }
      },
      "start_location": {
        "links": {
          "related": "api/boomerang/locations/0db08a58-89eb-4175-b94b-d175679aee88"
        }
      },
      "stop_location": {
        "links": {
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/orders/9b431c3e-1488-4249-aa03-609433f7a843' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "9b431c3e-1488-4249-aa03-609433f7a843",
    "type": "orders",
    "attributes": {
      "number": 1,
      "status": "concept",
      ...
      "paid_in_cents": 0,
      "discount_percentage": 10.0,
      "customer_id": "68690f1f-dcfe-498b-a942-5ae6e37faf3b",
      "tax_region_id": null,
      "coupon_id": null,
      "start_location_id": "cae715ef-7e63-4e60-858a-7e51129b6b36",
      "stop_location_id": "cae715ef-7e63-4e60-858a-7e51129b6b36"
    },
    "relationships": {
      "customer": {
        "links": {
          "related": "api/boomerang/customers/68690f1f-dcfe-498b-a942-5ae6e37faf3b"
        }
      },
      "tax_region": {
        "links": {
      ...
      "barcode": {
        "links": {
          "related": "api/boomerang/barcodes?filter[owner_id]=9b431c3e-1488-4249-aa03-609433f7a843"
        }
      },
      "start_location": {
        "links": {
          "related": "api/boomerang/locations/cae715ef-7e63-4e60-858a-7e51129b6b36"
        }
      },
      "stop_location": {
        "links": {
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        "type": "customers",
        "attributes": {
          "starts_at": "2021-11-06T07:56:35.067Z",
          "stops_at": "2021-12-15T07:56:35.067Z"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "69678f70-88ef-4b23-bc71-7c01fc6ec434",
    "type": "orders",
    "attributes": {
      "number": null,
      "status": "new",
      ...
      "status_counts": {},
      "starts_at": "2021-11-06T07:45:00+00:00",
      "stops_at": "2021-12-15T07:45:00+00:00",
      "deposit_type": "percentage",
      "deposit_value": 100,
      "entirely_started": false,
      "entirely_stopped": false,
      ...
      "tax_region_id": null,
      "coupon_id": null,
      "start_location_id": "3cd8b35b-4050-466e-911d-e8be9869bd66",
      "stop_location_id": "3cd8b35b-4050-466e-911d-e8be9869bd66"
    },
    "relationships": {
      "customer": {
        "meta": {
  ...
  "links": {
    "self": "api/boomerang/orders?data%5Battributes%5D%5Bstarts_at%5D=2021-11-06T07%3A56%3A35.067Z&data%5Battributes%5D%5Bstops_at%5D=2021-12-15T07%3A56%3A35.067Z&data%5Btype%5D=customers&page%5Bnumber%5D=1&page%5Bsize%5D=25",
    "first": "api/boomerang/orders?data%5Battributes%5D%5Bstarts_at%5D=2021-11-06T07%3A56%3A35.067Z&data%5Battributes%5D%5Bstops_at%5D=2021-12-15T07%3A56%3A35.067Z&data%5Btype%5D=customers&page%5Bnumber%5D=1&page%5Bsize%5D=25",
    "last": "api/boomerang/orders?data%5Battributes%5D%5Bstarts_at%5D=2021-11-06T07%3A56%3A35.067Z&data%5Battributes%5D%5Bstops_at%5D=2021-12-15T07%3A56%3A35.067Z&data%5Btype%5D=customers&page%5Bnumber%5D=1&page%5Bsize%5D=25"
  },
  "meta": {}
}
```
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/orders/d37f7bda-387d-4670-8bd9-4b9a5887809d' \
    --header 'content-type: application/json' \
    --data '{
      "fields": {
      ...
      "data": {
        "id": "d37f7bda-387d-4670-8bd9-4b9a5887809d",
        "type": "orders",
        "attributes": {
          "customer_id": "da563a22-851c-49ee-859c-a90a9b9c8ef6"
        }
      }
    }'
```
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/orders/38006407-1fe3-4ae6-a29b-30ac9d912f81' \
    --header 'content-type: application/json' \
    --data '{
      "fields": {
      ...
      "data": {
        "id": "38006407-1fe3-4ae6-a29b-30ac9d912f81",
        "type": "orders",
        "attributes": {
          "deposit_type": "percentage"
        }
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/orders/505fef12-17cd-4503-977c-868d0946bcd6' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "505fef12-17cd-4503-977c-868d0946bcd6",
        "type": "orders",
        "attributes": {
          "stops_at": "2021-11-09T07:56:39.835Z"
        }
      }
    }'
```
  ...
  "errors": [
    {
      ...
      "meta": {
        ...
        "blocking": [
          {
            "reason": "shortage",
            "item_id": "e3b2a6f0-ce8b-43b7-bfaf-54d4b75adabf",
            "stock_count": 1,
            "reserved": 1,
            "needed": 1,
            "shortage": 1
