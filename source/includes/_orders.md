...
```json
  ...
  "data": [
    {
      "id": "77cdeef4-e2e8-4cd6-9013-08b5dce554fb",
      "type": "orders",
      "attributes": {
        "number": 1,
        "status": "concept",
        ...
        "starts_at": "2021-11-06T08:30:00+00:00",
        "stops_at": "2021-11-07T08:30:00+00:00",
        ...
        "customer_id": "28e00f6e-57d2-4ab3-9a9d-e9ef4d7f59ef",
        "tax_region_id": null,
        "coupon_id": null,
        "start_location_id": "3d9912fd-4a57-48a7-805a-2536bf25a0d7",
        "stop_location_id": "3d9912fd-4a57-48a7-805a-2536bf25a0d7"
      },
      "relationships": {
        "customer": {
          "links": {
            "related": "api/boomerang/customers/28e00f6e-57d2-4ab3-9a9d-e9ef4d7f59ef"
          }
        },
        "tax_region": {
          "links": {
        ...
        "barcode": {
          "links": {
            "related": "api/boomerang/barcodes?filter[owner_id]=77cdeef4-e2e8-4cd6-9013-08b5dce554fb"
          }
        },
        "start_location": {
          "links": {
            "related": "api/boomerang/locations/3d9912fd-4a57-48a7-805a-2536bf25a0d7"
          }
        },
        "stop_location": {
          "links": {
...
```json
  {
  "data": {
    "id": "a05d8620-2574-4bc4-9bab-c3f741554430",
    "type": "orders",
    "attributes": {
      "number": null,
      "status": "new",
      ...
      "tax_region_id": null,
      "coupon_id": null,
      "start_location_id": "f676e738-9987-4bcd-8a5c-4d04e65ba64f",
      "stop_location_id": "f676e738-9987-4bcd-8a5c-4d04e65ba64f"
    },
    "relationships": {
      "customer": {
        "links": {
      ...
      "barcode": {
        "links": {
          "related": "api/boomerang/barcodes?filter[owner_id]=a05d8620-2574-4bc4-9bab-c3f741554430"
        }
      },
      "start_location": {
        "links": {
          "related": "api/boomerang/locations/f676e738-9987-4bcd-8a5c-4d04e65ba64f"
        }
      },
      "stop_location": {
        "links": {
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/orders/9227500b-faec-4ff5-ae65-eef9853e5c1c' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "9227500b-faec-4ff5-ae65-eef9853e5c1c",
    "type": "orders",
    "attributes": {
      "number": 1,
      "status": "concept",
      ...
      "paid_in_cents": 0,
      "discount_percentage": 10.0,
      "customer_id": "b97721e0-2887-439f-b0a6-0043930b51b4",
      "tax_region_id": null,
      "coupon_id": null,
      "start_location_id": "1e45dc28-c88d-4ab2-bfc4-c91956908d1e",
      "stop_location_id": "1e45dc28-c88d-4ab2-bfc4-c91956908d1e"
    },
    "relationships": {
      "customer": {
        "links": {
          "related": "api/boomerang/customers/b97721e0-2887-439f-b0a6-0043930b51b4"
        }
      },
      "tax_region": {
        "links": {
      ...
      "barcode": {
        "links": {
          "related": "api/boomerang/barcodes?filter[owner_id]=9227500b-faec-4ff5-ae65-eef9853e5c1c"
        }
      },
      "start_location": {
        "links": {
          "related": "api/boomerang/locations/1e45dc28-c88d-4ab2-bfc4-c91956908d1e"
        }
      },
      "stop_location": {
        "links": {
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        "type": "customers",
        "attributes": {
          "starts_at": "2021-11-06T08:36:36.235Z",
          "stops_at": "2021-12-15T08:36:36.235Z"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "c0fdfd9a-16f2-4f86-900a-9c5bc09f2153",
    "type": "orders",
    "attributes": {
      "number": null,
      "status": "new",
      ...
      "status_counts": {},
      "starts_at": "2021-11-06T08:30:00+00:00",
      "stops_at": "2021-12-15T08:30:00+00:00",
      "deposit_type": "percentage",
      "deposit_value": 100,
      "entirely_started": false,
      "entirely_stopped": false,
      ...
      "tax_region_id": null,
      "coupon_id": null,
      "start_location_id": "88582fc4-92c9-46c7-b20d-591b8a7116f8",
      "stop_location_id": "88582fc4-92c9-46c7-b20d-591b8a7116f8"
    },
    "relationships": {
      "customer": {
        "meta": {
  ...
  "links": {
    "self": "api/boomerang/orders?data%5Battributes%5D%5Bstarts_at%5D=2021-11-06T08%3A36%3A36.235Z&data%5Battributes%5D%5Bstops_at%5D=2021-12-15T08%3A36%3A36.235Z&data%5Btype%5D=customers&page%5Bnumber%5D=1&page%5Bsize%5D=25",
    "first": "api/boomerang/orders?data%5Battributes%5D%5Bstarts_at%5D=2021-11-06T08%3A36%3A36.235Z&data%5Battributes%5D%5Bstops_at%5D=2021-12-15T08%3A36%3A36.235Z&data%5Btype%5D=customers&page%5Bnumber%5D=1&page%5Bsize%5D=25",
    "last": "api/boomerang/orders?data%5Battributes%5D%5Bstarts_at%5D=2021-11-06T08%3A36%3A36.235Z&data%5Battributes%5D%5Bstops_at%5D=2021-12-15T08%3A36%3A36.235Z&data%5Btype%5D=customers&page%5Bnumber%5D=1&page%5Bsize%5D=25"
  },
  "meta": {}
}
```
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/orders/b981e32b-3751-4145-b3a0-9334bda0f875' \
    --header 'content-type: application/json' \
    --data '{
      "fields": {
      ...
      "data": {
        "id": "b981e32b-3751-4145-b3a0-9334bda0f875",
        "type": "orders",
        "attributes": {
          "customer_id": "2f562382-9309-4904-a286-c54671fb9a4c"
        }
      }
    }'
```
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/orders/bbd75d6d-8e80-4e91-b915-90f8a470df70' \
    --header 'content-type: application/json' \
    --data '{
      "fields": {
      ...
      "data": {
        "id": "bbd75d6d-8e80-4e91-b915-90f8a470df70",
        "type": "orders",
        "attributes": {
          "deposit_type": "percentage"
        }
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/orders/b650b5d8-6069-4b40-b566-9dc0bf68ed0b' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "b650b5d8-6069-4b40-b566-9dc0bf68ed0b",
        "type": "orders",
        "attributes": {
          "stops_at": "2021-11-09T08:36:42.652Z"
        }
      }
    }'
```
  ...
  "errors": [
    {
      ...
      "meta": {
        ...
        "blocking": [
          {
            "reason": "shortage",
            "item_id": "cda0da84-4ec1-4a66-a92b-805f242b26c9",
            "stock_count": 1,
            "reserved": 1,
            "needed": 1,
            "shortage": 1
