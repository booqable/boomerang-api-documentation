...
```json
  ...
  "data": [
    {
      "id": "8efc9706-c9fa-47e8-9009-9c04710c3ef0",
      "type": "orders",
      "attributes": {
        "created_at": "2023-02-08T15:01:06+00:00",
        "updated_at": "2023-02-08T15:01:07+00:00",
        "number": 1,
        "status": "reserved",
        "statuses": [
          "reserved"
        ...
        "customer_id": "ea34e16b-0cc8-4e85-85a8-8d8d77fa1e93",
        "tax_region_id": null,
        "coupon_id": null,
        "start_location_id": "22b647a5-42ea-461d-93cd-8930cc065c27",
        "stop_location_id": "22b647a5-42ea-461d-93cd-8930cc065c27"
      },
      "relationships": {
        "customer": {
          "links": {
            "related": "api/boomerang/customers/ea34e16b-0cc8-4e85-85a8-8d8d77fa1e93"
          }
        },
        "tax_region": {
          "links": {
        ...
        "barcode": {
          "links": {
            "related": "api/boomerang/barcodes?filter[owner_id]=8efc9706-c9fa-47e8-9009-9c04710c3ef0&filter[owner_type]=orders"
          }
        },
        "properties": {
          "links": {
            "related": "api/boomerang/properties?filter[owner_id]=8efc9706-c9fa-47e8-9009-9c04710c3ef0&filter[owner_type]=orders"
          }
        },
        "start_location": {
          "links": {
            "related": "api/boomerang/locations/22b647a5-42ea-461d-93cd-8930cc065c27"
          }
        },
        "stop_location": {
          "links": {
        ...
        "tax_values": {
          "links": {
            "related": "api/boomerang/tax_values?filter[owner_id]=8efc9706-c9fa-47e8-9009-9c04710c3ef0"
          }
        },
        "lines": {
          "links": {
            "related": "api/boomerang/lines?filter[owner_id]=8efc9706-c9fa-47e8-9009-9c04710c3ef0&filter[owner_type]=orders"
          }
        },
        "stock_item_plannings": {
          "links": {
            "related": "api/boomerang/stock_item_plannings?filter[order_id]=8efc9706-c9fa-47e8-9009-9c04710c3ef0"
          }
        }
      }
    }
          ...
          "attributes": [
            {
              ...
              "attributes": [
                {
                  "starts_at": {
                    "gte": "2023-02-09T15:01:10Z",
                    "lte": "2023-02-12T15:01:10Z"
                  }
                },
                {
                  "stops_at": {
...
```json
  ...
  "data": [
    {
      "id": "f979ac3a-312e-46f3-b8ec-ef386855fb4f"
    },
    {
      "id": "1232a113-770d-4059-b908-a3330d7b7d35"
    }
  ]
}
```
...
```json
  {
  "data": {
    "id": "a6810296-bd6e-4848-b742-d18155fc113b",
    "type": "orders",
    "attributes": {
      "created_at": "2023-02-08T15:01:13+00:00",
      "updated_at": "2023-02-08T15:01:13+00:00",
      "number": null,
      "status": "new",
      "statuses": [
        "new"
      ...
      "tax_region_id": null,
      "coupon_id": null,
      "start_location_id": "b0b3e1f6-c13c-44af-9a51-2bb48a299501",
      "stop_location_id": "b0b3e1f6-c13c-44af-9a51-2bb48a299501"
    },
    "relationships": {
      "customer": {
        "links": {
      ...
      "barcode": {
        "links": {
          "related": "api/boomerang/barcodes?filter[owner_id]=a6810296-bd6e-4848-b742-d18155fc113b&filter[owner_type]=orders"
        }
      },
      "properties": {
        "links": {
          "related": "api/boomerang/properties?filter[owner_id]=a6810296-bd6e-4848-b742-d18155fc113b&filter[owner_type]=orders"
        }
      },
      "start_location": {
        "links": {
          "related": "api/boomerang/locations/b0b3e1f6-c13c-44af-9a51-2bb48a299501"
        }
      },
      "stop_location": {
        "links": {
      ...
      "tax_values": {
        "links": {
          "related": "api/boomerang/tax_values?filter[owner_id]=a6810296-bd6e-4848-b742-d18155fc113b"
        }
      },
      "lines": {
        "links": {
          "related": "api/boomerang/lines?filter[owner_id]=a6810296-bd6e-4848-b742-d18155fc113b&filter[owner_type]=orders"
        }
      },
      "stock_item_plannings": {
        "links": {
          "related": "api/boomerang/stock_item_plannings?filter[order_id]=a6810296-bd6e-4848-b742-d18155fc113b"
        }
      }
    }
  },
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/orders/73f9100c-ad1b-4b83-8275-28a3271e0c4d' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "73f9100c-ad1b-4b83-8275-28a3271e0c4d",
    "type": "orders",
    "attributes": {
      "created_at": "2023-02-08T15:01:13+00:00",
      "updated_at": "2023-02-08T15:01:14+00:00",
      "number": 1,
      "status": "reserved",
      "statuses": [
        "reserved"
      ...
      "paid_in_cents": 0,
      "discount_percentage": 10.0,
      "customer_id": "526f35d5-4a8c-47ae-9c70-b0c3c955db6d",
      "tax_region_id": null,
      "coupon_id": null,
      "start_location_id": "cabeb5be-1c63-4c42-9d44-250f18afe710",
      "stop_location_id": "cabeb5be-1c63-4c42-9d44-250f18afe710"
    },
    "relationships": {
      "customer": {
        "links": {
          "related": "api/boomerang/customers/526f35d5-4a8c-47ae-9c70-b0c3c955db6d"
        }
      },
      "tax_region": {
        "links": {
      ...
      "barcode": {
        "links": {
          "related": "api/boomerang/barcodes?filter[owner_id]=73f9100c-ad1b-4b83-8275-28a3271e0c4d&filter[owner_type]=orders"
        }
      },
      "properties": {
        "links": {
          "related": "api/boomerang/properties?filter[owner_id]=73f9100c-ad1b-4b83-8275-28a3271e0c4d&filter[owner_type]=orders"
        }
      },
      "start_location": {
        "links": {
          "related": "api/boomerang/locations/cabeb5be-1c63-4c42-9d44-250f18afe710"
        }
      },
      "stop_location": {
        "links": {
      ...
      "tax_values": {
        "links": {
          "related": "api/boomerang/tax_values?filter[owner_id]=73f9100c-ad1b-4b83-8275-28a3271e0c4d"
        }
      },
      "lines": {
        "links": {
          "related": "api/boomerang/lines?filter[owner_id]=73f9100c-ad1b-4b83-8275-28a3271e0c4d&filter[owner_type]=orders"
        }
      },
      "stock_item_plannings": {
        "links": {
          "related": "api/boomerang/stock_item_plannings?filter[order_id]=73f9100c-ad1b-4b83-8275-28a3271e0c4d"
        }
      }
    }
  },
  ...
  curl --request POST \
    ...
    --data '{
      "data": {
        "type": "customers",
        "attributes": {
          "starts_at": "2023-02-11T15:01:18.244Z",
          "stops_at": "2023-03-22T15:01:18.244Z"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "a5fbbbe0-947c-4e9d-849f-2295cfa31481",
    "type": "orders",
    "attributes": {
      "created_at": "2023-02-08T15:01:18+00:00",
      "updated_at": "2023-02-08T15:01:18+00:00",
      "number": null,
      "status": "new",
      "statuses": [
        "new"
      ...
      "status_counts": {},
      "starts_at": "2023-02-11T15:00:00+00:00",
      "stops_at": "2023-03-22T15:00:00+00:00",
      "deposit_type": "percentage",
      "deposit_value": 100,
      "entirely_started": false,
      "entirely_stopped": false,
      ...
      "tax_region_id": null,
      "coupon_id": null,
      "start_location_id": "d3c172cc-b9dc-4fc1-9dd9-7727fc15ebce",
      "stop_location_id": "d3c172cc-b9dc-4fc1-9dd9-7727fc15ebce"
    },
    "relationships": {
      "customer": {
        "meta": {
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/orders/6e6033ca-58bc-4eb8-acc7-0330f0187c16' \
    --header 'content-type: application/json' \
    --data '{
      "fields": {
      ...
      "data": {
        "id": "6e6033ca-58bc-4eb8-acc7-0330f0187c16",
        "type": "orders",
        "attributes": {
          "customer_id": "d967a0f0-3e7f-4330-9574-6401d74da7ca"
        }
      }
    }'
```
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/orders/97d957e2-9aae-46d1-a748-d0e6c7e3e6cb' \
    --header 'content-type: application/json' \
    --data '{
      "fields": {
      ...
      "data": {
        "id": "97d957e2-9aae-46d1-a748-d0e6c7e3e6cb",
        "type": "orders",
        "attributes": {
          "deposit_type": "percentage"
        }
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/orders/51c25027-da0d-40b8-9c4d-1b8541773720' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "51c25027-da0d-40b8-9c4d-1b8541773720",
        "type": "orders",
        "attributes": {
        ...
        "blocking": [
          {
            ...
            "item_id": "007930ed-0181-4a1d-82f9-cbea69b2f38e",
            "unavailable": [
              "d627e14d-8828-46e3-bfd7-dde22a02566a"
            ],
            "available": [
              "2a4067b3-50be-480b-a307-0d3854d4d867"
            ]
          }
        ]
      }
