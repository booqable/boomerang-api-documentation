...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/report_rentals?filter%5Bfrom%5D=2022-07-16+00%3A00%3A00+UTC&filter%5Btill%5D=2022-07-21+23%3A59%3A59+UTC' \
...
```json
  ...
  "data": [
    {
      "id": "virtual-64c47383-3dc9-5b80-8e60-7c8195374e9e",
      "type": "report_rentals",
      "attributes": {
        "created_at": "2022-07-21T10:59:57+00:00",
        "name": "Product 21",
        ...
        "quantity": 10,
        "product_id": "d919a23f-f538-4267-a453-eff349d45f3c"
      },
      "relationships": {
        "product": {
          "links": {
            "related": "api/boomerang/products/d919a23f-f538-4267-a453-eff349d45f3c"
          }
        }
      }
    }
