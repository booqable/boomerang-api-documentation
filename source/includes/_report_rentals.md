...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/report_rentals?filter%5Bfrom%5D=2023-01-13+00%3A00%3A00+UTC&filter%5Btill%5D=2023-01-18+23%3A59%3A59+UTC' \
...
```json
  ...
  "data": [
    {
      "id": "virtual-e62ac5de-36e0-5b98-9a53-63c3ce4f03ee",
      "type": "report_rentals",
      "attributes": {
        "created_at": "2023-01-18T13:38:13+00:00",
        "name": "Product 53",
        ...
        "turnover_in_cents": 0,
        "quantity": 10,
        "product_id": "8019305c-e23a-4888-876a-72edb5d64c90"
      },
      "relationships": {
        "product": {
          "links": {
            "related": "api/boomerang/products/8019305c-e23a-4888-876a-72edb5d64c90"
          }
        }
      }
    }
