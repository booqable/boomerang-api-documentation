...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/report_rentals?filter%5Bfrom%5D=2023-03-04+00%3A00%3A00+UTC&filter%5Btill%5D=2023-03-09+23%3A59%3A59+UTC' \
...
```json
  ...
  "data": [
    {
      "id": "virtual-832bfce3-e70d-528f-a9ee-c9c0193e340f",
      "type": "report_rentals",
      "attributes": {
        ...
        "turnover_in_cents": 0,
        "quantity": 10,
        "product_id": "43c333bf-4fa6-4a0e-8b61-e1a33bdc4267"
      },
      "relationships": {
        "product": {
          "links": {
            "related": "api/boomerang/products/43c333bf-4fa6-4a0e-8b61-e1a33bdc4267"
          }
        }
      }
    }
