...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/report_rentals?filter%5Bfrom%5D=2022-09-30+00%3A00%3A00+UTC&filter%5Btill%5D=2022-10-05+23%3A59%3A59+UTC' \
...
```json
  ...
  "data": [
    {
      "id": "virtual-11153232-4935-5cc1-8350-b9547c387005",
      "type": "report_rentals",
      "attributes": {
        "created_at": "2022-10-05T11:38:05+00:00",
        "name": "Product 40",
        ...
        "quantity": 10,
        "product_id": "bfa5e724-71a6-4f47-ab29-3e0a2fa6b37e"
      },
      "relationships": {
        "product": {
          "links": {
            "related": "api/boomerang/products/bfa5e724-71a6-4f47-ab29-3e0a2fa6b37e"
          }
        }
      }
    }
