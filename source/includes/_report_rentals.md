...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/report_rentals?filter%5Bfrom%5D=2022-09-16+00%3A00%3A00+UTC&filter%5Btill%5D=2022-09-21+23%3A59%3A59+UTC' \
...
```json
  ...
  "data": [
    {
      "id": "virtual-250d31d4-af6b-55b0-b077-580ad463afd9",
      "type": "report_rentals",
      "attributes": {
        "created_at": "2022-09-21T09:10:00+00:00",
        "name": "Product 40",
        ...
        "quantity": 10,
        "product_id": "28a73011-b944-498e-95ba-59e0a1ae36e5"
      },
      "relationships": {
        "product": {
          "links": {
            "related": "api/boomerang/products/28a73011-b944-498e-95ba-59e0a1ae36e5"
          }
        }
      }
    }
