...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/report_rentals?filter%5Bfrom%5D=2022-07-14+00%3A00%3A00+UTC&filter%5Btill%5D=2022-07-19+23%3A59%3A59+UTC' \
...
```json
  ...
  "data": [
    {
      "id": "virtual-00ce6264-0033-545e-80cd-cabe5a0edabf",
      "type": "report_rentals",
      "attributes": {
        "created_at": "2022-07-19T12:38:27+00:00",
        "name": "Product 21",
        ...
        "quantity": 10,
        "product_id": "bda880d8-1478-4be1-98aa-267732cae757"
      },
      "relationships": {
        "product": {
          "links": {
            "related": "api/boomerang/products/bda880d8-1478-4be1-98aa-267732cae757"
          }
        }
      }
    }
