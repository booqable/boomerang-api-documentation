...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/report_rentals?filter%5Bfrom%5D=2022-11-17+00%3A00%3A00+UTC&filter%5Btill%5D=2022-11-22+23%3A59%3A59+UTC' \
...
```json
  ...
  "data": [
    {
      "id": "virtual-6259f922-2a8d-59db-a007-8e68989ca584",
      "type": "report_rentals",
      "attributes": {
        "created_at": "2022-11-22T15:35:42+00:00",
        "name": "Product 48",
        ...
        "quantity": 10,
        "product_id": "e57aaa25-ea29-4769-9e9b-ccc4583f8700"
      },
      "relationships": {
        "product": {
          "links": {
            "related": "api/boomerang/products/e57aaa25-ea29-4769-9e9b-ccc4583f8700"
          }
        }
      }
    }
