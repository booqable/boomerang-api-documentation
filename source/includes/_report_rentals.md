...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/report_rentals?filter%5Bfrom%5D=2023-02-22+00%3A00%3A00+UTC&filter%5Btill%5D=2023-02-27+23%3A59%3A59+UTC' \
...
```json
  ...
  "data": [
    {
      "id": "virtual-965c9bd2-e7ea-57df-96c4-ea89b9fa50bb",
      "type": "report_rentals",
      "attributes": {
        "created_at": "2023-02-27T10:49:45+00:00",
        "name": "Product 60",
        ...
        "turnover_in_cents": 0,
        "quantity": 10,
        "product_id": "96f72c27-13d4-47bf-9104-22e7732550ff"
      },
      "relationships": {
        "product": {
          "links": {
            "related": "api/boomerang/products/96f72c27-13d4-47bf-9104-22e7732550ff"
          }
        }
      }
    }
