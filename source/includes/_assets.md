...
```json
  ...
  "data": [
    {
      "id": "159386bb-8255-4c06-9b7b-848bedf6c4b7",
      "type": "assets",
      "attributes": {
        "created_at": "2023-02-10T11:14:52+00:00",
        "updated_at": "2023-02-10T11:14:52+00:00",
        "key": "templates/index.json",
        "custom": false,
        "checksum": "74b5b91c79f3099a43573f152554e8d82d55efe4039fe9c2d67246950750f61e",
        "content_type": "application/json",
        "value": "{ \"name\": \"index\" }",
        "published_at": "2023-02-03T11:14:52+00:00",
        "theme_id": "86bec78a-878e-490f-95df-6f439ffbafe3",
        "file": {
          "url": null
        }
      },
      "relationships": {
        "theme": {
          "links": {
            "related": "api/boomerang/themes/86bec78a-878e-490f-95df-6f439ffbafe3"
          }
        }
      }
    }
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "key": "templates/index.json",
          "value": "{ \"name\": \"index\" }",
          "theme_id": "4c5ba8f3-9dd0-41cd-a954-8244de82a0bf"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "93e9d6e1-3300-40ff-89ca-dcaa7efe194b",
    "type": "assets",
    "attributes": {
      "created_at": "2023-02-10T11:14:52+00:00",
      "updated_at": "2023-02-10T11:14:52+00:00",
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          ...
          "theme_id": "d2a4fa7a-a647-4ff5-bdc0-1db315fb2351",
...
```json
  {
  "data": {
    "id": "d468c83e-57f5-4fb5-a860-c5e8b8951e55",
    "type": "assets",
    "attributes": {
      "created_at": "2023-02-10T11:14:53+00:00",
      "updated_at": "2023-02-10T11:14:53+00:00",
      "key": "assets/image.png",
      "custom": false,
      ...
      "theme_id": "d2a4fa7a-a647-4ff5-bdc0-1db315fb2351",
      "file": {
        "url": "/assets/d2a4fa7a-a647-4ff5-bdc0-1db315fb2351/image-d6c8d6c485714758ae033483d6773831e27bd7393c141bb73e8e96c14f35e1ad.png"
      }
    },
    "relationships": {
      "theme": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/assets/89cb485f-49fa-4ea9-bc00-393bf3c21c1d' \
    --header 'content-type: application/json' \
```
