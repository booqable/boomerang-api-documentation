    ...
    --data '{
      "data": {
        ...
        "attributes": {
          ...
          "value": "{ \"name\": \"index\" }",
          "theme_id": "9a668009-7a57-4d0b-9e2c-db4d32a58f83"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "74e1c254-0f35-4421-8bfa-201a3fc41988",
    "type": "assets",
    "attributes": {
      "created_at": "2024-04-09T07:40:23+00:00",
      "updated_at": "2024-04-09T07:40:23+00:00",
      "key": "templates/index.json",
      "custom": false,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/assets/9771c05b-bee5-4d04-9b4e-89453d202634' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "9771c05b-bee5-4d04-9b4e-89453d202634",
    "type": "assets",
    "attributes": {
      "created_at": "2024-04-09T07:40:24+00:00",
      "updated_at": "2024-04-09T07:40:24+00:00",
      "key": "templates/index.json",
      "custom": false,
      "checksum": "74b5b91c79f3099a43573f152554e8d82d55efe4039fe9c2d67246950750f61e",
      "content_type": "application/json",
      "value": "{ \"name\": \"index\" }",
      "published_at": "2024-04-02T07:40:24+00:00",
      "theme_id": "b589a635-6767-4b45-91e5-5a9335ed1dfc",
      "file": {
        "url": null
      }
    }
...
```json
  ...
  "data": [
    {
      "id": "32655dbc-496e-4ec0-bbd8-673b19869b1a",
      "type": "assets",
      "attributes": {
        "created_at": "2024-04-09T07:40:24+00:00",
        "updated_at": "2024-04-09T07:40:24+00:00",
        ...
        "value": "{ \"name\": \"index\" }",
        "published_at": "2024-04-02T07:40:24+00:00",
        "theme_id": "f000607b-4371-4222-b65c-4ef0e22975a8",
        "file": {
          "url": null
        }
      }
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          ...
          "theme_id": "41455897-5f1a-4ee8-b23b-1ecf01ca1c7c",
...
```json
  {
  "data": {
    "id": "cc6f8e25-6e94-4cd5-a47a-bef587f28c64",
    "type": "assets",
    "attributes": {
      ...
      "theme_id": "41455897-5f1a-4ee8-b23b-1ecf01ca1c7c",
      "file": {
        "url": "/assets/41455897-5f1a-4ee8-b23b-1ecf01ca1c7c/image-d6c8d6c485714758ae033483d6773831e27bd7393c141bb73e8e96c14f35e1ad(2).png"
      }
    }
  },
  "meta": {}
