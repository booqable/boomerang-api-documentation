...
```json
  ...
  "data": [
    {
      "id": "25b749c8-5980-44ec-9547-88217f4cf538",
      "type": "assets",
      "attributes": {
        ...
        "value": "{ \"name\": \"index\" }",
        "published_at": "2023-03-03T08:36:33+00:00",
        "theme_id": "1a535a40-41a7-4cfb-a366-6dd161e43028",
        "file": {
          "url": null
        }
      },
      "relationships": {
        "theme": {
          "links": {
            "related": "api/boomerang/themes/1a535a40-41a7-4cfb-a366-6dd161e43028"
          }
        }
      }
    }
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "key": "templates/index.json",
          "value": "{ \"name\": \"index\" }",
          "theme_id": "8eb9258c-54c1-4ae5-8c51-074afe81ab8e"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "93e0e51f-586c-4ccb-a36c-11442b45e4d4",
    "type": "assets",
    "attributes": {
      "created_at": "2023-03-10T08:36:34+00:00",
      "updated_at": "2023-03-10T08:36:34+00:00",
      "key": "templates/index.json",
      "custom": false,
      "checksum": "74b5b91c79f3099a43573f152554e8d82d55efe4039fe9c2d67246950750f61e",
      "content_type": "application/json",
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          ...
          "theme_id": "b6ce7424-926c-49b6-8556-54a6dadde7d1",
...
```json
  {
  "data": {
    "id": "cb671aaf-4b87-4ae1-8230-fe1dd79f0514",
    "type": "assets",
    "attributes": {
      "created_at": "2023-03-10T08:36:34+00:00",
      "updated_at": "2023-03-10T08:36:34+00:00",
      ...
      "theme_id": "b6ce7424-926c-49b6-8556-54a6dadde7d1",
      "file": {
        "url": "/assets/b6ce7424-926c-49b6-8556-54a6dadde7d1/image-d6c8d6c485714758ae033483d6773831e27bd7393c141bb73e8e96c14f35e1ad.png"
      }
    },
    "relationships": {
      "theme": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/assets/ced8f222-a664-401f-ae11-d7636b695e42' \
    --header 'content-type: application/json' \
```
