...
```json
  ...
  "data": [
    {
      "id": "18b5785b-2cb3-48e9-91c3-c233f55faade",
      "type": "assets",
      "attributes": {
        "created_at": "2022-07-07T12:16:03+00:00",
        "updated_at": "2022-07-07T12:16:03+00:00",
        "key": "templates/index.json",
        "checksum": "74b5b91c79f3099a43573f152554e8d82d55efe4039fe9c2d67246950750f61e",
        "content_type": "application/json",
        "value": "{ \"name\": \"index\" }",
        "published_at": "2022-06-30T12:16:03+00:00",
        "theme_id": "7474d744-3ea0-4f0d-9271-c9dec942e80b",
        "file": {
          "url": null
        }
      },
      "relationships": {
        "theme": {
          "links": {
            "related": "api/boomerang/themes/7474d744-3ea0-4f0d-9271-c9dec942e80b"
          }
        }
      }
    }
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "key": "templates/index.json",
          "value": "{ \"name\": \"index\" }",
          "theme_id": "047b20a8-9133-4aef-b6e6-24441ff404ee"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "0eadcb62-c545-4125-bdd8-a61a6f5aa660",
    "type": "assets",
    "attributes": {
      "created_at": "2022-07-07T12:16:05+00:00",
      "updated_at": "2022-07-07T12:16:05+00:00",
      "key": "templates/index.json",
      "checksum": "74b5b91c79f3099a43573f152554e8d82d55efe4039fe9c2d67246950750f61e",
      "content_type": "application/json",
      "value": "{ \"name\": \"index\" }",
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          ...
          "theme_id": "2abcebaf-92db-47db-88c9-8cf2b085c6e2",
...
```json
  {
  "data": {
    "id": "22f4a0a4-a842-42c2-807c-972216df1a23",
    "type": "assets",
    "attributes": {
      "created_at": "2022-07-07T12:16:05+00:00",
      "updated_at": "2022-07-07T12:16:05+00:00",
      ...
      "theme_id": "2abcebaf-92db-47db-88c9-8cf2b085c6e2",
      "file": {
        "url": "/assets/2abcebaf-92db-47db-88c9-8cf2b085c6e2/image-d6c8d6c485714758ae033483d6773831e27bd7393c141bb73e8e96c14f35e1ad.png"
      }
    },
    "relationships": {
      "theme": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/assets/5e8b6808-dffc-4d03-87c1-85d25a835837' \
    --header 'content-type: application/json' \
```
