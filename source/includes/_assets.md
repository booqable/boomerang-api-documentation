    ...
    --data '{
      "data": {
        ...
        "attributes": {
          ...
          "theme_id": "96bad373-86bc-4b69-8714-8b82366726af",
...
```json
  {
  "data": {
    "id": "bd301318-e277-43d6-96ce-a3752c874662",
    "type": "assets",
    "attributes": {
      "created_at": "2023-12-18T09:16:44+00:00",
      "updated_at": "2023-12-18T09:16:44+00:00",
      "key": "assets/image.png",
      "custom": true,
      ...
      "theme_id": "96bad373-86bc-4b69-8714-8b82366726af",
      "file": {
        "url": "/assets/96bad373-86bc-4b69-8714-8b82366726af/image-d6c8d6c485714758ae033483d6773831e27bd7393c141bb73e8e96c14f35e1ad(2).png"
      }
    }
  },
  "meta": {}
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          ...
          "value": "{ \"name\": \"index\" }",
          "theme_id": "f160cf68-ddf1-4eb6-9b6b-cf18f7a04ca2"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "8b01fc5a-f045-451d-9b23-a2e285936bae",
    "type": "assets",
    "attributes": {
      "created_at": "2023-12-18T09:16:45+00:00",
      "updated_at": "2023-12-18T09:16:45+00:00",
      "key": "templates/index.json",
      "custom": false,
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/assets/656d32cb-09c8-4ebb-8711-a2906506e9b7' \
    --header 'content-type: application/json' \
```
...
```json
  ...
  "data": [
    {
      "id": "3aba5d5c-4afc-4f8f-8561-f29f4885e68b",
      "type": "assets",
      "attributes": {
        "created_at": "2023-12-18T09:16:46+00:00",
        "updated_at": "2023-12-18T09:16:46+00:00",
        "key": "templates/index.json",
        "custom": false,
        "checksum": "74b5b91c79f3099a43573f152554e8d82d55efe4039fe9c2d67246950750f61e",
        "content_type": "application/json",
        "value": "{ \"name\": \"index\" }",
        "published_at": "2023-12-11T09:16:46+00:00",
        "theme_id": "0eeea7c4-15a6-4d64-93b8-15408be299e4",
        "file": {
          "url": null
        }
      }
