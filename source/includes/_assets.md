...
```json
  ...
  "data": [
    {
      "id": "233556a7-bc21-4b6b-8924-15229db501c8",
      "type": "assets",
      "attributes": {
        "created_at": "2022-10-05T11:34:50+00:00",
        "updated_at": "2022-10-05T11:34:50+00:00",
        "key": "templates/index.json",
        "custom": false,
        "checksum": "74b5b91c79f3099a43573f152554e8d82d55efe4039fe9c2d67246950750f61e",
        "content_type": "application/json",
        "value": "{ \"name\": \"index\" }",
        "published_at": "2022-09-28T11:34:50+00:00",
        "theme_id": "c60e0aa4-a16b-49b8-abd0-f6f1d1330435",
        "file": {
          "url": null
        }
      },
      "relationships": {
        "theme": {
          "links": {
            "related": "api/boomerang/themes/c60e0aa4-a16b-49b8-abd0-f6f1d1330435"
          }
        }
      }
    }
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "key": "templates/index.json",
          "value": "{ \"name\": \"index\" }",
          "theme_id": "ed001f87-cc54-444c-97f5-9f9e67fa954a"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "5428180e-d0dc-4bd8-8024-ae89e051681b",
    "type": "assets",
    "attributes": {
      "created_at": "2022-10-05T11:34:51+00:00",
      "updated_at": "2022-10-05T11:34:51+00:00",
      "key": "templates/index.json",
      "custom": false,
      "checksum": "74b5b91c79f3099a43573f152554e8d82d55efe4039fe9c2d67246950750f61e",
      "content_type": "application/json",
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          ...
          "theme_id": "888f3599-1627-4d50-88d6-d9badb240d40",
...
```json
  {
  "data": {
    "id": "10fe08ca-5c62-4dfc-ab00-a517ac95884a",
    "type": "assets",
    "attributes": {
      "created_at": "2022-10-05T11:34:51+00:00",
      "updated_at": "2022-10-05T11:34:51+00:00",
      ...
      "theme_id": "888f3599-1627-4d50-88d6-d9badb240d40",
      "file": {
        "url": "/assets/888f3599-1627-4d50-88d6-d9badb240d40/image-d6c8d6c485714758ae033483d6773831e27bd7393c141bb73e8e96c14f35e1ad.png"
      }
    },
    "relationships": {
      "theme": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/assets/072cd6cf-3043-4a3d-8547-255bc8a391fe' \
    --header 'content-type: application/json' \
```
