...
```json
  ...
  "data": [
    {
      "id": "660eb1a1-134c-4f34-8c2a-2ebc1ebc76bb",
      "type": "assets",
      "attributes": {
        "created_at": "2023-01-26T10:19:03+00:00",
        "updated_at": "2023-01-26T10:19:03+00:00",
        "key": "templates/index.json",
        "custom": false,
        "checksum": "74b5b91c79f3099a43573f152554e8d82d55efe4039fe9c2d67246950750f61e",
        "content_type": "application/json",
        "value": "{ \"name\": \"index\" }",
        "published_at": "2023-01-19T10:19:03+00:00",
        "theme_id": "c935b63c-ad87-4bd9-a42a-fca49e42a1af",
        "file": {
          "url": null
        }
      },
      "relationships": {
        "theme": {
          "links": {
            "related": "api/boomerang/themes/c935b63c-ad87-4bd9-a42a-fca49e42a1af"
          }
        }
      }
    }
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "key": "templates/index.json",
          "value": "{ \"name\": \"index\" }",
          "theme_id": "307cb53f-6443-4dff-94ff-6a5669a6b06d"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "20c57725-4f20-4468-9548-c80037382729",
    "type": "assets",
    "attributes": {
      "created_at": "2023-01-26T10:19:03+00:00",
      "updated_at": "2023-01-26T10:19:03+00:00",
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          ...
          "theme_id": "012efdf9-b98d-4b26-b847-3eea902ab54c",
...
```json
  {
  "data": {
    "id": "e077efae-c109-41f7-87a3-d4310f56a908",
    "type": "assets",
    "attributes": {
      "created_at": "2023-01-26T10:19:04+00:00",
      "updated_at": "2023-01-26T10:19:04+00:00",
      "key": "assets/image.png",
      "custom": false,
      ...
      "theme_id": "012efdf9-b98d-4b26-b847-3eea902ab54c",
      "file": {
        "url": "/assets/012efdf9-b98d-4b26-b847-3eea902ab54c/image-d6c8d6c485714758ae033483d6773831e27bd7393c141bb73e8e96c14f35e1ad.png"
      }
    },
    "relationships": {
      "theme": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/assets/12423abe-8f27-4c6e-86cb-9def76b36e5c' \
    --header 'content-type: application/json' \
```
