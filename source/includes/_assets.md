...
```json
  ...
  "data": [
    {
      "id": "144f0c95-88cb-4ea4-9ff3-05338f932b9d",
      "type": "assets",
      "attributes": {
        "created_at": "2023-03-09T08:56:33+00:00",
        "updated_at": "2023-03-09T08:56:33+00:00",
        "key": "templates/index.json",
        "custom": false,
        "checksum": "74b5b91c79f3099a43573f152554e8d82d55efe4039fe9c2d67246950750f61e",
        "content_type": "application/json",
        "value": "{ \"name\": \"index\" }",
        "published_at": "2023-03-02T08:56:33+00:00",
        "theme_id": "bd0eef65-57bb-4543-833d-17a50bed4c8d",
        "file": {
          "url": null
        }
      },
      "relationships": {
        "theme": {
          "links": {
            "related": "api/boomerang/themes/bd0eef65-57bb-4543-833d-17a50bed4c8d"
          }
        }
      }
    }
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "key": "templates/index.json",
          "value": "{ \"name\": \"index\" }",
          "theme_id": "b350b8fa-01bd-4b88-acd9-22c25ce0ae62"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "7a7a0546-8a98-4d61-bbbc-892a62b9fb11",
    "type": "assets",
    "attributes": {
      "created_at": "2023-03-09T08:56:33+00:00",
      "updated_at": "2023-03-09T08:56:33+00:00",
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          ...
          "theme_id": "910d9e4f-6e9e-4a52-8adf-5bae760889df",
...
```json
  {
  "data": {
    "id": "abfb5def-0abe-426b-aa11-30d392316b12",
    "type": "assets",
    "attributes": {
      "created_at": "2023-03-09T08:56:34+00:00",
      "updated_at": "2023-03-09T08:56:34+00:00",
      "key": "assets/image.png",
      "custom": true,
      ...
      "theme_id": "910d9e4f-6e9e-4a52-8adf-5bae760889df",
      "file": {
        "url": "/assets/910d9e4f-6e9e-4a52-8adf-5bae760889df/image-d6c8d6c485714758ae033483d6773831e27bd7393c141bb73e8e96c14f35e1ad.png"
      }
    },
    "relationships": {
      "theme": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/assets/7ded5587-f4a9-4ae0-933d-e9110dfb4a36' \
    --header 'content-type: application/json' \
```
