...
```json
  ...
  "data": [
    {
      "id": "5fb00a86-9b1e-4e6b-9142-e3a81d3ce0b6",
      "type": "assets",
      "attributes": {
        "created_at": "2023-02-27T10:45:22+00:00",
        "updated_at": "2023-02-27T10:45:22+00:00",
        "key": "templates/index.json",
        "custom": false,
        "checksum": "74b5b91c79f3099a43573f152554e8d82d55efe4039fe9c2d67246950750f61e",
        "content_type": "application/json",
        "value": "{ \"name\": \"index\" }",
        "published_at": "2023-02-20T10:45:22+00:00",
        "theme_id": "3d7452b2-a767-44b3-b967-505c5212cced",
        "file": {
          "url": null
        }
      },
      "relationships": {
        "theme": {
          "links": {
            "related": "api/boomerang/themes/3d7452b2-a767-44b3-b967-505c5212cced"
          }
        }
      }
    }
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "key": "templates/index.json",
          "value": "{ \"name\": \"index\" }",
          "theme_id": "9e8736e8-f61f-4f94-b7d5-f526e80f0841"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "67540d87-b6c9-4acd-8879-248a656ba485",
    "type": "assets",
    "attributes": {
      "created_at": "2023-02-27T10:45:22+00:00",
      "updated_at": "2023-02-27T10:45:22+00:00",
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          ...
          "theme_id": "4452e4c4-920c-43dc-a41d-6948becd7de5",
...
```json
  {
  "data": {
    "id": "4f6bb778-af74-4953-865d-44b2c6e5ee9d",
    "type": "assets",
    "attributes": {
      "created_at": "2023-02-27T10:45:23+00:00",
      "updated_at": "2023-02-27T10:45:23+00:00",
      "key": "assets/image.png",
      "custom": false,
      ...
      "theme_id": "4452e4c4-920c-43dc-a41d-6948becd7de5",
      "file": {
        "url": "/assets/4452e4c4-920c-43dc-a41d-6948becd7de5/image-d6c8d6c485714758ae033483d6773831e27bd7393c141bb73e8e96c14f35e1ad.png"
      }
    },
    "relationships": {
      "theme": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/assets/a360591b-abf7-499d-bbcb-5d3d7c834917' \
    --header 'content-type: application/json' \
```
