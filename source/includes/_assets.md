    ...
    --data '{
      "data": {
        ...
        "attributes": {
          ...
          "value": "{ \"name\": \"index\" }",
          "theme_id": "59ab443e-3320-4f0c-9e49-46f3c2ec6ad6"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "80b9dcfc-ff56-4532-98ac-d97e8063afc0",
    "type": "assets",
    "attributes": {
...
```json
  ...
  "data": [
    {
      "id": "646c2426-5f13-4a51-859b-1894684b5e1d",
      "type": "assets",
      "attributes": {
        "created_at": "2024-01-08T09:20:14+00:00",
        "updated_at": "2024-01-08T09:20:14+00:00",
        "key": "templates/index.json",
        "custom": false,
        "checksum": "74b5b91c79f3099a43573f152554e8d82d55efe4039fe9c2d67246950750f61e",
        "content_type": "application/json",
        "value": "{ \"name\": \"index\" }",
        "published_at": "2024-01-01T09:20:14+00:00",
        "theme_id": "93694aec-c4c8-4402-a9a7-a8487348e35f",
        "file": {
          "url": null
        }
      }
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          ...
          "theme_id": "f42c23e8-4edc-4b55-a149-32abe680aef9",
...
```json
  {
  "data": {
    "id": "bbd5194b-7b06-4ae8-be5e-c8f7a5ded1b4",
    "type": "assets",
    "attributes": {
      "created_at": "2024-01-08T09:20:15+00:00",
      "updated_at": "2024-01-08T09:20:15+00:00",
      "key": "assets/image.png",
      "custom": true,
      ...
      "theme_id": "f42c23e8-4edc-4b55-a149-32abe680aef9",
      "file": {
        "url": "/assets/f42c23e8-4edc-4b55-a149-32abe680aef9/image-d6c8d6c485714758ae033483d6773831e27bd7393c141bb73e8e96c14f35e1ad(2).png"
      }
    }
  },
  "meta": {}
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/assets/777cab08-2caa-4f81-85a0-0aacd7d1ef69' \
    --header 'content-type: application/json' \
```
