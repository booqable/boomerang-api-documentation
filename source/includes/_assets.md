...
```json
  ...
  "data": [
    {
      "id": "53591c34-33c2-4f7c-9872-f79cff1746a3",
      "type": "assets",
      "attributes": {
        "created_at": "2023-03-08T09:17:41+00:00",
        "updated_at": "2023-03-08T09:17:41+00:00",
        "key": "templates/index.json",
        "custom": false,
        "checksum": "74b5b91c79f3099a43573f152554e8d82d55efe4039fe9c2d67246950750f61e",
        "content_type": "application/json",
        "value": "{ \"name\": \"index\" }",
        "published_at": "2023-03-01T09:17:41+00:00",
        "theme_id": "ad973f5f-1ac8-4e5f-8d71-fc940b9c33ce",
        "file": {
          "url": null
        }
      },
      "relationships": {
        "theme": {
          "links": {
            "related": "api/boomerang/themes/ad973f5f-1ac8-4e5f-8d71-fc940b9c33ce"
          }
        }
      }
    }
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "key": "templates/index.json",
          "value": "{ \"name\": \"index\" }",
          "theme_id": "90f47308-5170-49cf-86f7-47f96d05d415"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "b48f3793-0276-452e-9e27-349622120ad2",
    "type": "assets",
    "attributes": {
      "created_at": "2023-03-08T09:17:41+00:00",
      "updated_at": "2023-03-08T09:17:41+00:00",
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          ...
          "theme_id": "d1e7efab-7a0c-430b-b6d5-b4f4c9da64fe",
...
```json
  {
  "data": {
    "id": "21da8701-6d01-4f7a-a486-452cb3580c26",
    "type": "assets",
    "attributes": {
      "created_at": "2023-03-08T09:17:41+00:00",
      "updated_at": "2023-03-08T09:17:41+00:00",
      ...
      "theme_id": "d1e7efab-7a0c-430b-b6d5-b4f4c9da64fe",
      "file": {
        "url": "/assets/d1e7efab-7a0c-430b-b6d5-b4f4c9da64fe/image-d6c8d6c485714758ae033483d6773831e27bd7393c141bb73e8e96c14f35e1ad.png"
      }
    },
    "relationships": {
      "theme": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/assets/5eb0e353-4209-407f-8d00-4d8cf919026e' \
    --header 'content-type: application/json' \
```
