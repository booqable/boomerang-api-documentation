...
```json
  ...
  "data": [
    {
      "id": "6e35e23e-cc4c-47e6-b45f-b21ba9ecc8b4",
      "type": "assets",
      "attributes": {
        ...
        "value": "{ \"name\": \"index\" }",
        "published_at": "2023-02-07T11:03:41+00:00",
        "theme_id": "b40585b7-dfb3-4711-9fa5-6a24308cfdba",
        "file": {
          "url": null
        }
      },
      "relationships": {
        "theme": {
          "links": {
            "related": "api/boomerang/themes/b40585b7-dfb3-4711-9fa5-6a24308cfdba"
          }
        }
      }
    }
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "key": "templates/index.json",
          "value": "{ \"name\": \"index\" }",
          "theme_id": "abb2e42d-aa54-4cbf-9614-4bd1fe0673d0"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "240fc4d5-635c-4c85-8ea0-32b55c33027e",
    "type": "assets",
    "attributes": {
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          ...
          "theme_id": "b322c688-56ed-4331-b5b8-c3fd08e61195",
...
```json
  {
  "data": {
    "id": "ae5eba86-074a-4c62-b31f-9d026ea62312",
    "type": "assets",
    "attributes": {
      "created_at": "2023-02-14T11:03:42+00:00",
      "updated_at": "2023-02-14T11:03:42+00:00",
      ...
      "theme_id": "b322c688-56ed-4331-b5b8-c3fd08e61195",
      "file": {
        "url": "/assets/b322c688-56ed-4331-b5b8-c3fd08e61195/image-d6c8d6c485714758ae033483d6773831e27bd7393c141bb73e8e96c14f35e1ad.png"
      }
    },
    "relationships": {
      "theme": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/assets/61ae0642-a547-45f3-97ce-8de3b8987442' \
    --header 'content-type: application/json' \
```
