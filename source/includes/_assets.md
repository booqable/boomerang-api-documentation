...
```json
  ...
  "data": [
    {
      "id": "0689b40e-f660-45e5-aad8-cafd8aed3617",
      "type": "assets",
      "attributes": {
        "created_at": "2023-02-02T16:57:59+00:00",
        "updated_at": "2023-02-02T16:57:59+00:00",
        "key": "templates/index.json",
        "custom": false,
        "checksum": "74b5b91c79f3099a43573f152554e8d82d55efe4039fe9c2d67246950750f61e",
        "content_type": "application/json",
        "value": "{ \"name\": \"index\" }",
        "published_at": "2023-01-26T16:57:59+00:00",
        "theme_id": "44c650aa-fb17-4447-9177-34bd218b96cd",
        "file": {
          "url": null
        }
      },
      "relationships": {
        "theme": {
          "links": {
            "related": "api/boomerang/themes/44c650aa-fb17-4447-9177-34bd218b96cd"
          }
        }
      }
    }
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "key": "templates/index.json",
          "value": "{ \"name\": \"index\" }",
          "theme_id": "2bfa645e-e3b9-48e2-864d-88d26c7b6898"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "77a90209-be35-40e2-8731-2e0699eb02f3",
    "type": "assets",
    "attributes": {
      "created_at": "2023-02-02T16:57:59+00:00",
      "updated_at": "2023-02-02T16:57:59+00:00",
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          ...
          "theme_id": "62d70103-9455-45bd-9d48-1444df8c2567",
...
```json
  {
  "data": {
    "id": "d87fa3ea-6595-4d15-8d0d-7a123e755c0e",
    "type": "assets",
    "attributes": {
      "created_at": "2023-02-02T16:57:59+00:00",
      "updated_at": "2023-02-02T16:57:59+00:00",
      ...
      "theme_id": "62d70103-9455-45bd-9d48-1444df8c2567",
      "file": {
        "url": "/assets/62d70103-9455-45bd-9d48-1444df8c2567/image-d6c8d6c485714758ae033483d6773831e27bd7393c141bb73e8e96c14f35e1ad.png"
      }
    },
    "relationships": {
      "theme": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/assets/79564453-e02d-4630-b2b1-fa5f297e95fe' \
    --header 'content-type: application/json' \
```
