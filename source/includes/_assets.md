...
```json
  ...
  "data": [
    {
      "id": "109d26a5-c7d9-458d-9db7-36b241f3574b",
      "type": "assets",
      "attributes": {
        "created_at": "2023-03-02T09:22:55+00:00",
        "updated_at": "2023-03-02T09:22:55+00:00",
        "key": "templates/index.json",
        "custom": false,
        "checksum": "74b5b91c79f3099a43573f152554e8d82d55efe4039fe9c2d67246950750f61e",
        "content_type": "application/json",
        "value": "{ \"name\": \"index\" }",
        "published_at": "2023-02-23T09:22:55+00:00",
        "theme_id": "fe2f3a9e-2ac4-4d9c-9636-5a814faf7a6c",
        "file": {
          "url": null
        }
      },
      "relationships": {
        "theme": {
          "links": {
            "related": "api/boomerang/themes/fe2f3a9e-2ac4-4d9c-9636-5a814faf7a6c"
          }
        }
      }
    }
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "key": "templates/index.json",
          "value": "{ \"name\": \"index\" }",
          "theme_id": "399d077a-027d-4aef-ad32-f8e207e7b4a4"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "2a55f579-497f-416e-991a-901c2cca0dc9",
    "type": "assets",
    "attributes": {
      "created_at": "2023-03-02T09:22:57+00:00",
      "updated_at": "2023-03-02T09:22:57+00:00",
      "key": "templates/index.json",
      "custom": false,
      "checksum": "74b5b91c79f3099a43573f152554e8d82d55efe4039fe9c2d67246950750f61e",
      "content_type": "application/json",
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          ...
          "theme_id": "43a5b0f9-68e4-4ffb-b364-ccbe94f7aafa",
...
```json
  {
  "data": {
    "id": "be548d07-cbe1-432c-af2f-6e60faea12ba",
    "type": "assets",
    "attributes": {
      "created_at": "2023-03-02T09:22:58+00:00",
      "updated_at": "2023-03-02T09:22:58+00:00",
      "key": "assets/image.png",
      "custom": true,
      ...
      "theme_id": "43a5b0f9-68e4-4ffb-b364-ccbe94f7aafa",
      "file": {
        "url": "/assets/43a5b0f9-68e4-4ffb-b364-ccbe94f7aafa/image-d6c8d6c485714758ae033483d6773831e27bd7393c141bb73e8e96c14f35e1ad.png"
      }
    },
    "relationships": {
      "theme": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/assets/c0328ce3-ecc3-448e-beb5-6cd3b94c8914' \
    --header 'content-type: application/json' \
```
