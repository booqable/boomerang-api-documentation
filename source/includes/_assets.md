...
```json
  ...
  "data": [
    {
      "id": "83a72a8c-8ace-435e-8e8e-201686e88c8c",
      "type": "assets",
      "attributes": {
        "created_at": "2022-11-03T11:05:20+00:00",
        "updated_at": "2022-11-03T11:05:20+00:00",
        "key": "templates/index.json",
        "custom": false,
        "checksum": "74b5b91c79f3099a43573f152554e8d82d55efe4039fe9c2d67246950750f61e",
        "content_type": "application/json",
        "value": "{ \"name\": \"index\" }",
        "published_at": "2022-10-27T11:05:20+00:00",
        "theme_id": "359de718-0ca0-46bc-bd83-f869f4665250",
        "file": {
          "url": null
        }
      },
      "relationships": {
        "theme": {
          "links": {
            "related": "api/boomerang/themes/359de718-0ca0-46bc-bd83-f869f4665250"
          }
        }
      }
    }
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "key": "templates/index.json",
          "value": "{ \"name\": \"index\" }",
          "theme_id": "0c6f6957-9f01-418f-b92d-54f18c7b01fa"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "63109f34-287d-4e16-9434-d513155b2e37",
    "type": "assets",
    "attributes": {
      "created_at": "2022-11-03T11:05:22+00:00",
      "updated_at": "2022-11-03T11:05:22+00:00",
      "key": "templates/index.json",
      "custom": false,
      "checksum": "74b5b91c79f3099a43573f152554e8d82d55efe4039fe9c2d67246950750f61e",
      "content_type": "application/json",
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          ...
          "theme_id": "c9c2157f-432d-4821-ba3a-736ed593f4a9",
...
```json
  {
  "data": {
    "id": "bef749ca-0a20-4cff-bb32-78521ce7c4d9",
    "type": "assets",
    "attributes": {
      "created_at": "2022-11-03T11:05:22+00:00",
      "updated_at": "2022-11-03T11:05:22+00:00",
      ...
      "theme_id": "c9c2157f-432d-4821-ba3a-736ed593f4a9",
      "file": {
        "url": "/assets/c9c2157f-432d-4821-ba3a-736ed593f4a9/image-d6c8d6c485714758ae033483d6773831e27bd7393c141bb73e8e96c14f35e1ad.png"
      }
    },
    "relationships": {
      "theme": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/assets/a2f8df67-783d-4a47-bbce-5a6b7027ef9d' \
    --header 'content-type: application/json' \
```
