...
```json
  ...
  "data": [
    {
      "id": "41d296f0-1fe0-4db3-a19c-ff81f78e449a",
      "type": "assets",
      "attributes": {
        "created_at": "2023-02-27T10:14:43+00:00",
        "updated_at": "2023-02-27T10:14:43+00:00",
        "key": "templates/index.json",
        "custom": false,
        "checksum": "74b5b91c79f3099a43573f152554e8d82d55efe4039fe9c2d67246950750f61e",
        "content_type": "application/json",
        "value": "{ \"name\": \"index\" }",
        "published_at": "2023-02-20T10:14:43+00:00",
        "theme_id": "7e4175df-6ffa-4a05-ad2c-9f1472b029c8",
        "file": {
          "url": null
        }
      },
      "relationships": {
        "theme": {
          "links": {
            "related": "api/boomerang/themes/7e4175df-6ffa-4a05-ad2c-9f1472b029c8"
          }
        }
      }
    }
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "key": "templates/index.json",
          "value": "{ \"name\": \"index\" }",
          "theme_id": "6699d209-c923-4a51-a74a-01a70d483903"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "db312ca8-c2cd-4fe9-a27b-0539835ed7de",
    "type": "assets",
    "attributes": {
      "created_at": "2023-02-27T10:14:44+00:00",
      "updated_at": "2023-02-27T10:14:44+00:00",
      "key": "templates/index.json",
      "custom": false,
      "checksum": "74b5b91c79f3099a43573f152554e8d82d55efe4039fe9c2d67246950750f61e",
      "content_type": "application/json",
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          ...
          "theme_id": "5ede08b3-8c74-4efd-a1a7-87c0bacc06cd",
...
```json
  {
  "data": {
    "id": "2ef44ef1-e8d2-40f8-a709-8299f540fc24",
    "type": "assets",
    "attributes": {
      "created_at": "2023-02-27T10:14:44+00:00",
      "updated_at": "2023-02-27T10:14:44+00:00",
      ...
      "theme_id": "5ede08b3-8c74-4efd-a1a7-87c0bacc06cd",
      "file": {
        "url": "/assets/5ede08b3-8c74-4efd-a1a7-87c0bacc06cd/image-d6c8d6c485714758ae033483d6773831e27bd7393c141bb73e8e96c14f35e1ad.png"
      }
    },
    "relationships": {
      "theme": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/assets/a8366619-d87d-4446-b6d3-2e5ef3464f8d' \
    --header 'content-type: application/json' \
```
