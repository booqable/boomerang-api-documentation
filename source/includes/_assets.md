...
```json
  ...
  "data": [
    {
      "id": "c6dfb7a3-ba21-42ae-9636-fd66bb82dcfe",
      "type": "assets",
      "attributes": {
        "created_at": "2023-02-14T11:05:28+00:00",
        "updated_at": "2023-02-14T11:05:28+00:00",
        "key": "templates/index.json",
        "custom": false,
        "checksum": "74b5b91c79f3099a43573f152554e8d82d55efe4039fe9c2d67246950750f61e",
        "content_type": "application/json",
        "value": "{ \"name\": \"index\" }",
        "published_at": "2023-02-07T11:05:28+00:00",
        "theme_id": "2d6077fc-dd5b-4e03-a813-b48db6073bd2",
        "file": {
          "url": null
        }
      },
      "relationships": {
        "theme": {
          "links": {
            "related": "api/boomerang/themes/2d6077fc-dd5b-4e03-a813-b48db6073bd2"
          }
        }
      }
    }
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "key": "templates/index.json",
          "value": "{ \"name\": \"index\" }",
          "theme_id": "5b0b707f-6935-4ec2-909e-0dd1eee1d534"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "e1cf34ac-6e07-49f2-81a6-5612c5ad65b1",
    "type": "assets",
    "attributes": {
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          ...
          "theme_id": "8df04655-263f-4815-8d88-4e75be4fcb03",
...
```json
  {
  "data": {
    "id": "b41c46dc-f27e-4474-b72f-50a4e5300c79",
    "type": "assets",
    "attributes": {
      "created_at": "2023-02-14T11:05:30+00:00",
      "updated_at": "2023-02-14T11:05:30+00:00",
      ...
      "theme_id": "8df04655-263f-4815-8d88-4e75be4fcb03",
      "file": {
        "url": "/assets/8df04655-263f-4815-8d88-4e75be4fcb03/image-d6c8d6c485714758ae033483d6773831e27bd7393c141bb73e8e96c14f35e1ad.png"
      }
    },
    "relationships": {
      "theme": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/assets/4336f853-e47a-423c-b00f-9d7d4c6c1d33' \
    --header 'content-type: application/json' \
```
