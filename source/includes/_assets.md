...
```json
  ...
  "data": [
    {
      "id": "98345a20-3ac7-438b-9670-52c88e552d89",
      "type": "assets",
      "attributes": {
        ...
        "value": "{ \"name\": \"index\" }",
        "published_at": "2023-02-01T08:34:30+00:00",
        "theme_id": "a81b9d85-aa08-4040-be6e-28cfd14e856f",
        "file": {
          "url": null
        }
      },
      "relationships": {
        "theme": {
          "links": {
            "related": "api/boomerang/themes/a81b9d85-aa08-4040-be6e-28cfd14e856f"
          }
        }
      }
    }
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "key": "templates/index.json",
          "value": "{ \"name\": \"index\" }",
          "theme_id": "7789577b-1cce-4205-920a-53063def1561"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "cac30cd9-d053-42e5-922d-3bfbbf51c67f",
    "type": "assets",
    "attributes": {
      "created_at": "2023-02-08T08:34:30+00:00",
      "updated_at": "2023-02-08T08:34:30+00:00",
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          ...
          "theme_id": "e65cc5e3-bd84-44db-8506-6f99e33cc0f7",
...
```json
  {
  "data": {
    "id": "e9f5f39d-e84c-42f0-b581-f46e2c5e253a",
    "type": "assets",
    "attributes": {
      ...
      "theme_id": "e65cc5e3-bd84-44db-8506-6f99e33cc0f7",
      "file": {
        "url": "/assets/e65cc5e3-bd84-44db-8506-6f99e33cc0f7/image-d6c8d6c485714758ae033483d6773831e27bd7393c141bb73e8e96c14f35e1ad.png"
      }
    },
    "relationships": {
      "theme": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/assets/e2a25045-a8f3-48a5-9e80-ab856f780fc6' \
    --header 'content-type: application/json' \
```
