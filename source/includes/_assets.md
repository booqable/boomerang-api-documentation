...
```json
  ...
  "data": [
    {
      "id": "6f7b1e33-be7f-4aec-bcc8-9fb4f102d92a",
      "type": "assets",
      "attributes": {
        "created_at": "2023-03-01T10:30:20+00:00",
        "updated_at": "2023-03-01T10:30:20+00:00",
        "key": "templates/index.json",
        "custom": false,
        "checksum": "74b5b91c79f3099a43573f152554e8d82d55efe4039fe9c2d67246950750f61e",
        "content_type": "application/json",
        "value": "{ \"name\": \"index\" }",
        "published_at": "2023-02-22T10:30:20+00:00",
        "theme_id": "c69c9b9d-4999-4de0-9c4a-59361d1954ca",
        "file": {
          "url": null
        }
      },
      "relationships": {
        "theme": {
          "links": {
            "related": "api/boomerang/themes/c69c9b9d-4999-4de0-9c4a-59361d1954ca"
          }
        }
      }
    }
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "key": "templates/index.json",
          "value": "{ \"name\": \"index\" }",
          "theme_id": "3eac5070-77b1-48f5-98d2-f5be0f5c048b"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "796a3a3a-a44c-4e89-9fea-210cf38b4c2d",
    "type": "assets",
    "attributes": {
      "created_at": "2023-03-01T10:30:21+00:00",
      "updated_at": "2023-03-01T10:30:21+00:00",
      "key": "templates/index.json",
      "custom": false,
      "checksum": "74b5b91c79f3099a43573f152554e8d82d55efe4039fe9c2d67246950750f61e",
      "content_type": "application/json",
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          ...
          "theme_id": "c6702693-7bf4-4095-a829-f39d9cffb63e",
...
```json
  {
  "data": {
    "id": "27205718-8280-42bb-8cbe-b087612d8913",
    "type": "assets",
    "attributes": {
      "created_at": "2023-03-01T10:30:21+00:00",
      "updated_at": "2023-03-01T10:30:21+00:00",
      ...
      "theme_id": "c6702693-7bf4-4095-a829-f39d9cffb63e",
      "file": {
        "url": "/assets/c6702693-7bf4-4095-a829-f39d9cffb63e/image-d6c8d6c485714758ae033483d6773831e27bd7393c141bb73e8e96c14f35e1ad.png"
      }
    },
    "relationships": {
      "theme": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/assets/99dd74dc-2fe7-4fcf-b208-1d5cce0d555c' \
    --header 'content-type: application/json' \
```
