...
```json
  ...
  "data": [
    {
      "id": "2ab3a4b7-834d-40a7-a452-b4a8208a6923",
      "type": "assets",
      "attributes": {
        "created_at": "2023-02-02T14:25:03+00:00",
        "updated_at": "2023-02-02T14:25:03+00:00",
        "key": "templates/index.json",
        "custom": false,
        "checksum": "74b5b91c79f3099a43573f152554e8d82d55efe4039fe9c2d67246950750f61e",
        "content_type": "application/json",
        "value": "{ \"name\": \"index\" }",
        "published_at": "2023-01-26T14:25:03+00:00",
        "theme_id": "6be92210-a3aa-4183-a803-cf2ac37481f1",
        "file": {
          "url": null
        }
      },
      "relationships": {
        "theme": {
          "links": {
            "related": "api/boomerang/themes/6be92210-a3aa-4183-a803-cf2ac37481f1"
          }
        }
      }
    }
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "key": "templates/index.json",
          "value": "{ \"name\": \"index\" }",
          "theme_id": "90bec194-5373-4878-8128-662df6088eb2"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "223f3c85-fa67-4c00-9f3a-809871fe56e4",
    "type": "assets",
    "attributes": {
      "created_at": "2023-02-02T14:25:04+00:00",
      "updated_at": "2023-02-02T14:25:04+00:00",
      "key": "templates/index.json",
      "custom": false,
      "checksum": "74b5b91c79f3099a43573f152554e8d82d55efe4039fe9c2d67246950750f61e",
      "content_type": "application/json",
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          ...
          "theme_id": "463bb0b0-d1e5-4af0-b989-1e6b94c13bf8",
...
```json
  {
  "data": {
    "id": "0ce10c15-4d30-4a60-82ef-f85a0ffbb43f",
    "type": "assets",
    "attributes": {
      "created_at": "2023-02-02T14:25:04+00:00",
      "updated_at": "2023-02-02T14:25:04+00:00",
      ...
      "theme_id": "463bb0b0-d1e5-4af0-b989-1e6b94c13bf8",
      "file": {
        "url": "/assets/463bb0b0-d1e5-4af0-b989-1e6b94c13bf8/image-d6c8d6c485714758ae033483d6773831e27bd7393c141bb73e8e96c14f35e1ad.png"
      }
    },
    "relationships": {
      "theme": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/assets/153e7429-a892-4229-aade-470b1c1764ff' \
    --header 'content-type: application/json' \
```
