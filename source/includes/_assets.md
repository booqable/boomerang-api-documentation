...
```json
  ...
  "data": [
    {
      "id": "2d6057d2-ab18-4b18-a76b-11ff22c0be05",
      "type": "assets",
      "attributes": {
        "created_at": "2023-02-21T08:18:50+00:00",
        "updated_at": "2023-02-21T08:18:50+00:00",
        "key": "templates/index.json",
        "custom": false,
        "checksum": "74b5b91c79f3099a43573f152554e8d82d55efe4039fe9c2d67246950750f61e",
        "content_type": "application/json",
        "value": "{ \"name\": \"index\" }",
        "published_at": "2023-02-14T08:18:50+00:00",
        "theme_id": "2a5723a5-8db3-4c7a-9769-3899f91d5a43",
        "file": {
          "url": null
        }
      },
      "relationships": {
        "theme": {
          "links": {
            "related": "api/boomerang/themes/2a5723a5-8db3-4c7a-9769-3899f91d5a43"
          }
        }
      }
    }
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "key": "templates/index.json",
          "value": "{ \"name\": \"index\" }",
          "theme_id": "dbad93d0-fc49-476a-a039-e9111d0f8d55"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "d18b8673-b8c4-4f00-89cd-67411cbaa6d2",
    "type": "assets",
    "attributes": {
      "created_at": "2023-02-21T08:18:50+00:00",
      "updated_at": "2023-02-21T08:18:50+00:00",
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          ...
          "theme_id": "f50bff63-da07-4108-a09b-ca4f8b68964d",
...
```json
  {
  "data": {
    "id": "1d4fb4b2-9eb5-4a9a-9218-9e290e6c24a1",
    "type": "assets",
    "attributes": {
      "created_at": "2023-02-21T08:18:50+00:00",
      "updated_at": "2023-02-21T08:18:50+00:00",
      ...
      "theme_id": "f50bff63-da07-4108-a09b-ca4f8b68964d",
      "file": {
        "url": "/assets/f50bff63-da07-4108-a09b-ca4f8b68964d/image-d6c8d6c485714758ae033483d6773831e27bd7393c141bb73e8e96c14f35e1ad.png"
      }
    },
    "relationships": {
      "theme": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/assets/73511f56-a051-4b41-9b61-c1275d0257b8' \
    --header 'content-type: application/json' \
```
