...
```json
  ...
  "data": [
    {
      "id": "bd267f1c-71ce-4875-9caa-92dbfbe580d2",
      "type": "assets",
      "attributes": {
        "created_at": "2023-02-24T14:55:58+00:00",
        "updated_at": "2023-02-24T14:55:58+00:00",
        "key": "templates/index.json",
        "custom": false,
        "checksum": "74b5b91c79f3099a43573f152554e8d82d55efe4039fe9c2d67246950750f61e",
        "content_type": "application/json",
        "value": "{ \"name\": \"index\" }",
        "published_at": "2023-02-17T14:55:58+00:00",
        "theme_id": "20e25fd3-9ec2-49f5-8b95-0e0c932fe56b",
        "file": {
          "url": null
        }
      },
      "relationships": {
        "theme": {
          "links": {
            "related": "api/boomerang/themes/20e25fd3-9ec2-49f5-8b95-0e0c932fe56b"
          }
        }
      }
    }
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "key": "templates/index.json",
          "value": "{ \"name\": \"index\" }",
          "theme_id": "b1212c39-4a5c-45eb-a7bb-65e4c67638fa"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "ce42ed6e-1a9f-465f-9019-301f8646c463",
    "type": "assets",
    "attributes": {
      "created_at": "2023-02-24T14:55:59+00:00",
      "updated_at": "2023-02-24T14:55:59+00:00",
      "key": "templates/index.json",
      "custom": false,
      "checksum": "74b5b91c79f3099a43573f152554e8d82d55efe4039fe9c2d67246950750f61e",
      "content_type": "application/json",
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          ...
          "theme_id": "45c044ab-9dac-49c3-9e66-bfbde5414330",
...
```json
  {
  "data": {
    "id": "8cc9b2e7-101e-4101-baa7-7ae29ef83f80",
    "type": "assets",
    "attributes": {
      "created_at": "2023-02-24T14:55:59+00:00",
      "updated_at": "2023-02-24T14:55:59+00:00",
      ...
      "theme_id": "45c044ab-9dac-49c3-9e66-bfbde5414330",
      "file": {
        "url": "/assets/45c044ab-9dac-49c3-9e66-bfbde5414330/image-d6c8d6c485714758ae033483d6773831e27bd7393c141bb73e8e96c14f35e1ad.png"
      }
    },
    "relationships": {
      "theme": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/assets/cdf92179-b1e2-4c92-bb3d-b61060c96e77' \
    --header 'content-type: application/json' \
```
