...
```json
  ...
  "data": [
    {
      "id": "5dca3d7f-aee4-4e47-9bbe-c213805ca585",
      "type": "assets",
      "attributes": {
        "created_at": "2023-02-08T09:17:32+00:00",
        "updated_at": "2023-02-08T09:17:32+00:00",
        "key": "templates/index.json",
        "custom": false,
        "checksum": "74b5b91c79f3099a43573f152554e8d82d55efe4039fe9c2d67246950750f61e",
        "content_type": "application/json",
        "value": "{ \"name\": \"index\" }",
        "published_at": "2023-02-01T09:17:32+00:00",
        "theme_id": "00922ef2-46e2-4ca6-b8ee-c51bec169b73",
        "file": {
          "url": null
        }
      },
      "relationships": {
        "theme": {
          "links": {
            "related": "api/boomerang/themes/00922ef2-46e2-4ca6-b8ee-c51bec169b73"
          }
        }
      }
    }
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "key": "templates/index.json",
          "value": "{ \"name\": \"index\" }",
          "theme_id": "3cafdf5f-9197-4053-adad-30507cceb367"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "cbbf345c-ceb3-48ff-bb80-9ad9cf0515cb",
    "type": "assets",
    "attributes": {
      "created_at": "2023-02-08T09:17:33+00:00",
      "updated_at": "2023-02-08T09:17:33+00:00",
      "key": "templates/index.json",
      "custom": false,
      "checksum": "74b5b91c79f3099a43573f152554e8d82d55efe4039fe9c2d67246950750f61e",
      "content_type": "application/json",
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          ...
          "theme_id": "eacb7874-eff4-4fc2-8c25-d6841a4cf5ea",
...
```json
  {
  "data": {
    "id": "36814d35-a4f3-458b-adf9-25afa4c2c01d",
    "type": "assets",
    "attributes": {
      "created_at": "2023-02-08T09:17:33+00:00",
      "updated_at": "2023-02-08T09:17:33+00:00",
      ...
      "theme_id": "eacb7874-eff4-4fc2-8c25-d6841a4cf5ea",
      "file": {
        "url": "/assets/eacb7874-eff4-4fc2-8c25-d6841a4cf5ea/image-d6c8d6c485714758ae033483d6773831e27bd7393c141bb73e8e96c14f35e1ad.png"
      }
    },
    "relationships": {
      "theme": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/assets/bf70fb52-db02-4c54-b313-4a85fac05fba' \
    --header 'content-type: application/json' \
```
