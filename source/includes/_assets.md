...
```json
  ...
  "data": [
    {
      "id": "26c08c9c-694e-4193-91a6-ca629b7ea866",
      "type": "assets",
      "attributes": {
        "created_at": "2022-11-08T13:51:50+00:00",
        "updated_at": "2022-11-08T13:51:50+00:00",
        "key": "templates/index.json",
        "custom": false,
        "checksum": "74b5b91c79f3099a43573f152554e8d82d55efe4039fe9c2d67246950750f61e",
        "content_type": "application/json",
        "value": "{ \"name\": \"index\" }",
        "published_at": "2022-11-01T13:51:50+00:00",
        "theme_id": "bf0f3b45-7aa9-4dc7-a4fc-1fa22980072e",
        "file": {
          "url": null
        }
      },
      "relationships": {
        "theme": {
          "links": {
            "related": "api/boomerang/themes/bf0f3b45-7aa9-4dc7-a4fc-1fa22980072e"
          }
        }
      }
    }
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "key": "templates/index.json",
          "value": "{ \"name\": \"index\" }",
          "theme_id": "41b7e35e-52bd-4502-a058-97490571fbc0"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "a5f6b35d-1c54-4078-83fa-20b14ebf82a5",
    "type": "assets",
    "attributes": {
      "created_at": "2022-11-08T13:51:52+00:00",
      "updated_at": "2022-11-08T13:51:52+00:00",
      "key": "templates/index.json",
      "custom": false,
      "checksum": "74b5b91c79f3099a43573f152554e8d82d55efe4039fe9c2d67246950750f61e",
      "content_type": "application/json",
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          ...
          "theme_id": "4a278327-5150-4e96-80d7-236aa143d16a",
...
```json
  {
  "data": {
    "id": "f5d3074f-69a0-4b52-ab41-61633b20a38f",
    "type": "assets",
    "attributes": {
      "created_at": "2022-11-08T13:51:52+00:00",
      "updated_at": "2022-11-08T13:51:52+00:00",
      ...
      "theme_id": "4a278327-5150-4e96-80d7-236aa143d16a",
      "file": {
        "url": "/assets/4a278327-5150-4e96-80d7-236aa143d16a/image-d6c8d6c485714758ae033483d6773831e27bd7393c141bb73e8e96c14f35e1ad.png"
      }
    },
    "relationships": {
      "theme": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/assets/f274afd5-10cb-4ef0-b0af-11f1d5e6edc4' \
    --header 'content-type: application/json' \
```
