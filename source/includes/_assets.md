...
```json
  ...
  "data": [
    {
      "id": "02262b77-3178-4b7b-b1cb-cce6821813b3",
      "type": "assets",
      "attributes": {
        "created_at": "2023-02-09T09:38:42+00:00",
        "updated_at": "2023-02-09T09:38:42+00:00",
        "key": "templates/index.json",
        "custom": false,
        "checksum": "74b5b91c79f3099a43573f152554e8d82d55efe4039fe9c2d67246950750f61e",
        "content_type": "application/json",
        "value": "{ \"name\": \"index\" }",
        "published_at": "2023-02-02T09:38:42+00:00",
        "theme_id": "b988136d-0d3f-427a-94d7-a7159084ff6e",
        "file": {
          "url": null
        }
      },
      "relationships": {
        "theme": {
          "links": {
            "related": "api/boomerang/themes/b988136d-0d3f-427a-94d7-a7159084ff6e"
          }
        }
      }
    }
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "key": "templates/index.json",
          "value": "{ \"name\": \"index\" }",
          "theme_id": "5beb8512-ef26-4a5d-8f89-b9d7dc5031e7"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "d121b67a-e34e-4f74-9149-468f6a4fa48a",
    "type": "assets",
    "attributes": {
      "created_at": "2023-02-09T09:38:44+00:00",
      "updated_at": "2023-02-09T09:38:44+00:00",
      "key": "templates/index.json",
      "custom": false,
      "checksum": "74b5b91c79f3099a43573f152554e8d82d55efe4039fe9c2d67246950750f61e",
      "content_type": "application/json",
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          ...
          "theme_id": "f088bf0e-53c1-4a66-b816-64076b585cba",
...
```json
  {
  "data": {
    "id": "f9ea4f5a-59ae-4533-8cc9-b1f9a0af938b",
    "type": "assets",
    "attributes": {
      "created_at": "2023-02-09T09:38:45+00:00",
      "updated_at": "2023-02-09T09:38:45+00:00",
      "key": "assets/image.png",
      "custom": false,
      ...
      "theme_id": "f088bf0e-53c1-4a66-b816-64076b585cba",
      "file": {
        "url": "/assets/f088bf0e-53c1-4a66-b816-64076b585cba/image-d6c8d6c485714758ae033483d6773831e27bd7393c141bb73e8e96c14f35e1ad.png"
      }
    },
    "relationships": {
      "theme": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/assets/983ad61f-49d8-4336-aa4a-e3b049ae8cab' \
    --header 'content-type: application/json' \
```
