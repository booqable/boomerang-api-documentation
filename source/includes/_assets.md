...
```json
  ...
  "data": [
    {
      "id": "fd628a08-1703-460d-996f-8f769956af10",
      "type": "assets",
      "attributes": {
        "created_at": "2023-02-22T08:39:36+00:00",
        "updated_at": "2023-02-22T08:39:36+00:00",
        "key": "templates/index.json",
        "custom": false,
        "checksum": "74b5b91c79f3099a43573f152554e8d82d55efe4039fe9c2d67246950750f61e",
        "content_type": "application/json",
        "value": "{ \"name\": \"index\" }",
        "published_at": "2023-02-15T08:39:36+00:00",
        "theme_id": "0b9c94ba-637d-4b09-91ca-7cc243f2edb4",
        "file": {
          "url": null
        }
      },
      "relationships": {
        "theme": {
          "links": {
            "related": "api/boomerang/themes/0b9c94ba-637d-4b09-91ca-7cc243f2edb4"
          }
        }
      }
    }
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "key": "templates/index.json",
          "value": "{ \"name\": \"index\" }",
          "theme_id": "0da3ec34-b02d-4ae0-9dd1-9663162d3e4b"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "50647d01-0e80-4daa-8944-db83867934b5",
    "type": "assets",
    "attributes": {
      "created_at": "2023-02-22T08:39:36+00:00",
      "updated_at": "2023-02-22T08:39:36+00:00",
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          ...
          "theme_id": "111431f2-9aaf-49a9-82b0-f4c02fed01bc",
...
```json
  {
  "data": {
    "id": "41e8be16-beee-4648-a106-165822070e6f",
    "type": "assets",
    "attributes": {
      "created_at": "2023-02-22T08:39:38+00:00",
      "updated_at": "2023-02-22T08:39:38+00:00",
      "key": "assets/image.png",
      "custom": false,
      ...
      "theme_id": "111431f2-9aaf-49a9-82b0-f4c02fed01bc",
      "file": {
        "url": "/assets/111431f2-9aaf-49a9-82b0-f4c02fed01bc/image-d6c8d6c485714758ae033483d6773831e27bd7393c141bb73e8e96c14f35e1ad.png"
      }
    },
    "relationships": {
      "theme": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/assets/e328ce17-0647-489d-ae29-d5fc5cf873eb' \
    --header 'content-type: application/json' \
```
