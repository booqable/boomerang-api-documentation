...
```json
  ...
  "data": [
    {
      "id": "bb3b73a6-d62a-43cf-9f76-28a4b6f25f6f",
      "type": "assets",
      "attributes": {
        "created_at": "2023-02-16T15:34:25+00:00",
        "updated_at": "2023-02-16T15:34:25+00:00",
        "key": "templates/index.json",
        "custom": false,
        "checksum": "74b5b91c79f3099a43573f152554e8d82d55efe4039fe9c2d67246950750f61e",
        "content_type": "application/json",
        "value": "{ \"name\": \"index\" }",
        "published_at": "2023-02-09T15:34:25+00:00",
        "theme_id": "7becc2b3-bff5-4f18-b2ae-17feb87c46a7",
        "file": {
          "url": null
        }
      },
      "relationships": {
        "theme": {
          "links": {
            "related": "api/boomerang/themes/7becc2b3-bff5-4f18-b2ae-17feb87c46a7"
          }
        }
      }
    }
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "key": "templates/index.json",
          "value": "{ \"name\": \"index\" }",
          "theme_id": "49705d07-435b-45d7-8406-8a9098ff412b"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "b2f4fb18-c88c-4d33-9805-1d68b3240364",
    "type": "assets",
    "attributes": {
      "created_at": "2023-02-16T15:34:25+00:00",
      "updated_at": "2023-02-16T15:34:25+00:00",
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          ...
          "theme_id": "67920cdf-9a0c-4bec-9e32-5eb0762005f5",
...
```json
  {
  "data": {
    "id": "2c120a15-5786-4351-b394-dd3310cf5ee5",
    "type": "assets",
    "attributes": {
      "created_at": "2023-02-16T15:34:26+00:00",
      "updated_at": "2023-02-16T15:34:26+00:00",
      "key": "assets/image.png",
      "custom": false,
      ...
      "theme_id": "67920cdf-9a0c-4bec-9e32-5eb0762005f5",
      "file": {
        "url": "/assets/67920cdf-9a0c-4bec-9e32-5eb0762005f5/image-d6c8d6c485714758ae033483d6773831e27bd7393c141bb73e8e96c14f35e1ad.png"
      }
    },
    "relationships": {
      "theme": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/assets/4364a311-e2c9-4f21-aa60-c30e1824edfb' \
    --header 'content-type: application/json' \
```
