...
```json
  ...
  "data": [
    {
      "id": "9c88758c-f8f2-4efc-af1d-ac85a034fd16",
      "type": "assets",
      "attributes": {
        "created_at": "2022-10-13T15:42:02+00:00",
        "updated_at": "2022-10-13T15:42:02+00:00",
        "key": "templates/index.json",
        "custom": false,
        "checksum": "74b5b91c79f3099a43573f152554e8d82d55efe4039fe9c2d67246950750f61e",
        "content_type": "application/json",
        "value": "{ \"name\": \"index\" }",
        "published_at": "2022-10-06T15:42:02+00:00",
        "theme_id": "0b77f267-6370-462b-bc01-c77dfe78e29d",
        "file": {
          "url": null
        }
      },
      "relationships": {
        "theme": {
          "links": {
            "related": "api/boomerang/themes/0b77f267-6370-462b-bc01-c77dfe78e29d"
          }
        }
      }
    }
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "key": "templates/index.json",
          "value": "{ \"name\": \"index\" }",
          "theme_id": "068223d4-3aab-4065-867b-b115885fd232"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "fdd2954c-034f-4609-a446-6e7661d67891",
    "type": "assets",
    "attributes": {
      "created_at": "2022-10-13T15:42:03+00:00",
      "updated_at": "2022-10-13T15:42:03+00:00",
      "key": "templates/index.json",
      "custom": false,
      "checksum": "74b5b91c79f3099a43573f152554e8d82d55efe4039fe9c2d67246950750f61e",
      "content_type": "application/json",
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          ...
          "theme_id": "d40b2980-ecc1-4c84-be5c-c17241163432",
...
```json
  {
  "data": {
    "id": "65997348-4fd9-4a11-b983-24b3495743f4",
    "type": "assets",
    "attributes": {
      "created_at": "2022-10-13T15:42:03+00:00",
      "updated_at": "2022-10-13T15:42:03+00:00",
      ...
      "theme_id": "d40b2980-ecc1-4c84-be5c-c17241163432",
      "file": {
        "url": "/assets/d40b2980-ecc1-4c84-be5c-c17241163432/image-d6c8d6c485714758ae033483d6773831e27bd7393c141bb73e8e96c14f35e1ad.png"
      }
    },
    "relationships": {
      "theme": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/assets/78a74d54-d811-4322-8dce-42dad7953f8f' \
    --header 'content-type: application/json' \
```
