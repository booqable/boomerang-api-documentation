...
```json
  ...
  "data": [
    {
      "id": "8df9884e-ee3f-4928-bb0c-a02a26842d87",
      "type": "assets",
      "attributes": {
        "created_at": "2023-02-07T09:26:40+00:00",
        "updated_at": "2023-02-07T09:26:40+00:00",
        "key": "templates/index.json",
        "custom": false,
        "checksum": "74b5b91c79f3099a43573f152554e8d82d55efe4039fe9c2d67246950750f61e",
        "content_type": "application/json",
        "value": "{ \"name\": \"index\" }",
        "published_at": "2023-01-31T09:26:40+00:00",
        "theme_id": "e5d0fb6f-0d04-4571-b0a4-050856cde478",
        "file": {
          "url": null
        }
      },
      "relationships": {
        "theme": {
          "links": {
            "related": "api/boomerang/themes/e5d0fb6f-0d04-4571-b0a4-050856cde478"
          }
        }
      }
    }
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "key": "templates/index.json",
          "value": "{ \"name\": \"index\" }",
          "theme_id": "69533b3a-2f41-4007-a002-e7e21f751d3a"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "3954f7f5-395c-478a-b0e4-644524663218",
    "type": "assets",
    "attributes": {
      "created_at": "2023-02-07T09:26:40+00:00",
      "updated_at": "2023-02-07T09:26:40+00:00",
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          ...
          "theme_id": "f22e5c45-e03f-4660-9a87-f1b5558ace12",
...
```json
  {
  "data": {
    "id": "0857d3d7-d54d-47da-9efa-0bc51df5a812",
    "type": "assets",
    "attributes": {
      "created_at": "2023-02-07T09:26:40+00:00",
      "updated_at": "2023-02-07T09:26:40+00:00",
      ...
      "theme_id": "f22e5c45-e03f-4660-9a87-f1b5558ace12",
      "file": {
        "url": "/assets/f22e5c45-e03f-4660-9a87-f1b5558ace12/image-d6c8d6c485714758ae033483d6773831e27bd7393c141bb73e8e96c14f35e1ad.png"
      }
    },
    "relationships": {
      "theme": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/assets/5ff74bb5-0b7c-419b-8684-2d9e51ceada9' \
    --header 'content-type: application/json' \
```
