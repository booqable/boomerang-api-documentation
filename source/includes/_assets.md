...
```json
  ...
  "data": [
    {
      "id": "c17cef0e-c9f0-4d4c-9c7d-5a50ed4253b4",
      "type": "assets",
      "attributes": {
        "created_at": "2022-06-04T09:50:04+00:00",
        "updated_at": "2022-06-04T09:50:04+00:00",
        "key": "templates/index.json",
        "checksum": "74b5b91c79f3099a43573f152554e8d82d55efe4039fe9c2d67246950750f61e",
        "content_type": "application/json",
        "value": "{ \"name\": \"index\" }",
        "published_at": "2022-05-28T09:50:04+00:00",
        "theme_id": "9a48feed-2f8a-424e-8821-3eb83f5a9d6e",
        "file": {
          "url": null
        }
      },
      "relationships": {
        "theme": {
          "links": {
            "related": "api/boomerang/themes/9a48feed-2f8a-424e-8821-3eb83f5a9d6e"
          }
        }
      }
    }
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "key": "templates/index.json",
          "value": "{ \"name\": \"index\" }",
          "theme_id": "947bef83-6ade-40e7-a54b-2f3365381e8d"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "c013aaf5-476a-4cd5-b7e5-5ce0ec994561",
    "type": "assets",
    "attributes": {
      "created_at": "2022-06-04T09:50:04+00:00",
      "updated_at": "2022-06-04T09:50:04+00:00",
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          ...
          "theme_id": "333bf2a2-f53e-4ce1-bfd3-5e6c82b7b7bd",
...
```json
  {
  "data": {
    "id": "61c8bae0-16c7-41fd-8048-20293103972c",
    "type": "assets",
    "attributes": {
      "created_at": "2022-06-04T09:50:05+00:00",
      "updated_at": "2022-06-04T09:50:05+00:00",
      "key": "assets/image.png",
      ...
      "theme_id": "333bf2a2-f53e-4ce1-bfd3-5e6c82b7b7bd",
      "file": {
        "url": "/assets/333bf2a2-f53e-4ce1-bfd3-5e6c82b7b7bd/image-d6c8d6c485714758ae033483d6773831e27bd7393c141bb73e8e96c14f35e1ad.png"
      }
    },
    "relationships": {
      "theme": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/assets/3e1a7cf5-594d-4a59-8677-a40b2bae0065' \
    --header 'content-type: application/json' \
```
