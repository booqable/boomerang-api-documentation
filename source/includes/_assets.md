...
```json
  ...
  "data": [
    {
      "id": "aa072ba8-51f4-4f75-8943-d97ed33d2dfc",
      "type": "assets",
      "attributes": {
        "created_at": "2022-06-08T14:24:00+00:00",
        "updated_at": "2022-06-08T14:24:00+00:00",
        "key": "templates/index.json",
        "checksum": "74b5b91c79f3099a43573f152554e8d82d55efe4039fe9c2d67246950750f61e",
        "content_type": "application/json",
        "value": "{ \"name\": \"index\" }",
        "published_at": "2022-06-01T14:24:00+00:00",
        "theme_id": "d8b97621-1a4b-4e12-b082-03bc2632f053",
        "file": {
          "url": null
        }
      },
      "relationships": {
        "theme": {
          "links": {
            "related": "api/boomerang/themes/d8b97621-1a4b-4e12-b082-03bc2632f053"
          }
        }
      }
    }
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "key": "templates/index.json",
          "value": "{ \"name\": \"index\" }",
          "theme_id": "061a55c9-dae4-4463-b5ed-c39b78f03288"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "2ee34eb7-0599-46b8-9a8f-2948a66cb74e",
    "type": "assets",
    "attributes": {
      "created_at": "2022-06-08T14:24:01+00:00",
      "updated_at": "2022-06-08T14:24:01+00:00",
      "key": "templates/index.json",
      "checksum": "74b5b91c79f3099a43573f152554e8d82d55efe4039fe9c2d67246950750f61e",
      "content_type": "application/json",
      "value": "{ \"name\": \"index\" }",
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          ...
          "theme_id": "779579ce-d092-4b30-9522-c2e3523bd4b8",
...
```json
  {
  "data": {
    "id": "68a02d49-2b3a-4060-8c73-c71cf44ef726",
    "type": "assets",
    "attributes": {
      "created_at": "2022-06-08T14:24:01+00:00",
      "updated_at": "2022-06-08T14:24:01+00:00",
      ...
      "theme_id": "779579ce-d092-4b30-9522-c2e3523bd4b8",
      "file": {
        "url": "/assets/779579ce-d092-4b30-9522-c2e3523bd4b8/image-d6c8d6c485714758ae033483d6773831e27bd7393c141bb73e8e96c14f35e1ad.png"
      }
    },
    "relationships": {
      "theme": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/assets/20e7af10-6cf4-4e28-a2af-d062b02d6e62' \
    --header 'content-type: application/json' \
```
