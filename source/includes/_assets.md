...
```json
  ...
  "data": [
    {
      "id": "b58d4bb0-c8c2-44a4-94bd-48b47ba8a611",
      "type": "assets",
      "attributes": {
        "created_at": "2022-12-19T08:45:44+00:00",
        "updated_at": "2022-12-19T08:45:44+00:00",
        "key": "templates/index.json",
        "custom": false,
        "checksum": "74b5b91c79f3099a43573f152554e8d82d55efe4039fe9c2d67246950750f61e",
        "content_type": "application/json",
        "value": "{ \"name\": \"index\" }",
        "published_at": "2022-12-12T08:45:44+00:00",
        "theme_id": "c2290781-5711-46c0-b091-525223884798",
        "file": {
          "url": null
        }
      },
      "relationships": {
        "theme": {
          "links": {
            "related": "api/boomerang/themes/c2290781-5711-46c0-b091-525223884798"
          }
        }
      }
    }
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "key": "templates/index.json",
          "value": "{ \"name\": \"index\" }",
          "theme_id": "793879af-a53e-4bf7-8c37-c581b4b28475"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "f434707d-2b8f-4315-acfb-455f7c76a113",
    "type": "assets",
    "attributes": {
      "created_at": "2022-12-19T08:45:45+00:00",
      "updated_at": "2022-12-19T08:45:45+00:00",
      "key": "templates/index.json",
      "custom": false,
      "checksum": "74b5b91c79f3099a43573f152554e8d82d55efe4039fe9c2d67246950750f61e",
      "content_type": "application/json",
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          ...
          "theme_id": "509cf773-f086-4b3b-a281-8029fd5a8824",
...
```json
  {
  "data": {
    "id": "94cf27aa-94ed-4fee-b791-66d4e2b1054c",
    "type": "assets",
    "attributes": {
      "created_at": "2022-12-19T08:45:45+00:00",
      "updated_at": "2022-12-19T08:45:45+00:00",
      ...
      "theme_id": "509cf773-f086-4b3b-a281-8029fd5a8824",
      "file": {
        "url": "/assets/509cf773-f086-4b3b-a281-8029fd5a8824/image-d6c8d6c485714758ae033483d6773831e27bd7393c141bb73e8e96c14f35e1ad.png"
      }
    },
    "relationships": {
      "theme": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/assets/db78aaaf-48f1-48e2-9d1c-4fbccdfbf1ee' \
    --header 'content-type: application/json' \
```
