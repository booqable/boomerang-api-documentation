...
```json
  ...
  "data": [
    {
      "id": "02bdc2a5-e41b-4a48-8ec6-ce4788a198a8",
      "type": "assets",
      "attributes": {
        "created_at": "2023-01-05T16:26:16+00:00",
        "updated_at": "2023-01-05T16:26:16+00:00",
        "key": "templates/index.json",
        "custom": false,
        "checksum": "74b5b91c79f3099a43573f152554e8d82d55efe4039fe9c2d67246950750f61e",
        "content_type": "application/json",
        "value": "{ \"name\": \"index\" }",
        "published_at": "2022-12-29T16:26:16+00:00",
        "theme_id": "3f823215-6b3e-4942-8d1d-0b9d0ec7dee0",
        "file": {
          "url": null
        }
      },
      "relationships": {
        "theme": {
          "links": {
            "related": "api/boomerang/themes/3f823215-6b3e-4942-8d1d-0b9d0ec7dee0"
          }
        }
      }
    }
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "key": "templates/index.json",
          "value": "{ \"name\": \"index\" }",
          "theme_id": "f0ad68d4-d070-4aca-a43a-6e64c9b14ec6"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "1634dab3-d79e-4bd1-92b7-855e263fd501",
    "type": "assets",
    "attributes": {
      "created_at": "2023-01-05T16:26:17+00:00",
      "updated_at": "2023-01-05T16:26:17+00:00",
      "key": "templates/index.json",
      "custom": false,
      "checksum": "74b5b91c79f3099a43573f152554e8d82d55efe4039fe9c2d67246950750f61e",
      "content_type": "application/json",
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          ...
          "theme_id": "0012c33f-2d94-4919-b882-c4027ae15f78",
...
```json
  {
  "data": {
    "id": "779efd38-4017-489e-b5ed-f287058846af",
    "type": "assets",
    "attributes": {
      "created_at": "2023-01-05T16:26:17+00:00",
      "updated_at": "2023-01-05T16:26:17+00:00",
      ...
      "theme_id": "0012c33f-2d94-4919-b882-c4027ae15f78",
      "file": {
        "url": "/assets/0012c33f-2d94-4919-b882-c4027ae15f78/image-d6c8d6c485714758ae033483d6773831e27bd7393c141bb73e8e96c14f35e1ad.png"
      }
    },
    "relationships": {
      "theme": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/assets/6610cb34-c1cc-45aa-a14a-475612b7b12f' \
    --header 'content-type: application/json' \
```
