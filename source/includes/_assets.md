...
```json
  ...
  "data": [
    {
      "id": "0cbc5fe3-d606-48d2-a6cf-c1a07deddc90",
      "type": "assets",
      "attributes": {
        "created_at": "2023-02-14T12:45:28+00:00",
        "updated_at": "2023-02-14T12:45:28+00:00",
        "key": "templates/index.json",
        "custom": false,
        "checksum": "74b5b91c79f3099a43573f152554e8d82d55efe4039fe9c2d67246950750f61e",
        "content_type": "application/json",
        "value": "{ \"name\": \"index\" }",
        "published_at": "2023-02-07T12:45:28+00:00",
        "theme_id": "556a5b04-983d-4003-8477-0ce4f71dcc55",
        "file": {
          "url": null
        }
      },
      "relationships": {
        "theme": {
          "links": {
            "related": "api/boomerang/themes/556a5b04-983d-4003-8477-0ce4f71dcc55"
          }
        }
      }
    }
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "key": "templates/index.json",
          "value": "{ \"name\": \"index\" }",
          "theme_id": "c6db0e0f-7dae-455c-8457-9ae0805503b7"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "ae6c58b4-76d5-4143-87d0-8308f275d353",
    "type": "assets",
    "attributes": {
      "created_at": "2023-02-14T12:45:29+00:00",
      "updated_at": "2023-02-14T12:45:29+00:00",
      "key": "templates/index.json",
      "custom": false,
      "checksum": "74b5b91c79f3099a43573f152554e8d82d55efe4039fe9c2d67246950750f61e",
      "content_type": "application/json",
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          ...
          "theme_id": "45dc51a0-889a-4bc3-a34a-2c3b31b0b477",
...
```json
  {
  "data": {
    "id": "fd4b6a9a-4cc2-4b55-b29d-ec14850d1e62",
    "type": "assets",
    "attributes": {
      "created_at": "2023-02-14T12:45:29+00:00",
      "updated_at": "2023-02-14T12:45:29+00:00",
      ...
      "theme_id": "45dc51a0-889a-4bc3-a34a-2c3b31b0b477",
      "file": {
        "url": "/assets/45dc51a0-889a-4bc3-a34a-2c3b31b0b477/image-d6c8d6c485714758ae033483d6773831e27bd7393c141bb73e8e96c14f35e1ad.png"
      }
    },
    "relationships": {
      "theme": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/assets/ca4cac97-ea30-4d00-a22d-33378a6902ac' \
    --header 'content-type: application/json' \
```
