...
```json
  ...
  "data": [
    {
      "id": "158dd073-1554-4c45-bd31-bf3862e016b8",
      "type": "assets",
      "attributes": {
        "created_at": "2023-02-08T16:16:45+00:00",
        "updated_at": "2023-02-08T16:16:45+00:00",
        "key": "templates/index.json",
        "custom": false,
        "checksum": "74b5b91c79f3099a43573f152554e8d82d55efe4039fe9c2d67246950750f61e",
        "content_type": "application/json",
        "value": "{ \"name\": \"index\" }",
        "published_at": "2023-02-01T16:16:45+00:00",
        "theme_id": "017bdbd7-e5ac-4054-a695-1d1e55fcddaa",
        "file": {
          "url": null
        }
      },
      "relationships": {
        "theme": {
          "links": {
            "related": "api/boomerang/themes/017bdbd7-e5ac-4054-a695-1d1e55fcddaa"
          }
        }
      }
    }
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "key": "templates/index.json",
          "value": "{ \"name\": \"index\" }",
          "theme_id": "3fbac72c-e995-4896-abb0-7e5c403c454e"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "0cf8ae6f-639d-44af-8b1b-63160edcdef9",
    "type": "assets",
    "attributes": {
      "created_at": "2023-02-08T16:16:45+00:00",
      "updated_at": "2023-02-08T16:16:45+00:00",
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          ...
          "theme_id": "892992ee-a13a-49cb-a73d-22dcfeeeb1fe",
...
```json
  {
  "data": {
    "id": "fdb2fd8a-cd1e-4cba-9741-aad78c0f6726",
    "type": "assets",
    "attributes": {
      "created_at": "2023-02-08T16:16:46+00:00",
      "updated_at": "2023-02-08T16:16:46+00:00",
      "key": "assets/image.png",
      "custom": false,
      ...
      "theme_id": "892992ee-a13a-49cb-a73d-22dcfeeeb1fe",
      "file": {
        "url": "/assets/892992ee-a13a-49cb-a73d-22dcfeeeb1fe/image-d6c8d6c485714758ae033483d6773831e27bd7393c141bb73e8e96c14f35e1ad.png"
      }
    },
    "relationships": {
      "theme": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/assets/7f16a05d-2d0d-484e-85a8-7f8f0784594c' \
    --header 'content-type: application/json' \
```
