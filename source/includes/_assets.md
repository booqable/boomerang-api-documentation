...
```json
  ...
  "data": [
    {
      "id": "376c4649-cdf8-4719-86fd-ac76c9b110e1",
      "type": "assets",
      "attributes": {
        "created_at": "2022-06-30T09:43:56+00:00",
        "updated_at": "2022-06-30T09:43:56+00:00",
        "key": "templates/index.json",
        "checksum": "74b5b91c79f3099a43573f152554e8d82d55efe4039fe9c2d67246950750f61e",
        "content_type": "application/json",
        "value": "{ \"name\": \"index\" }",
        "published_at": "2022-06-23T09:43:56+00:00",
        "theme_id": "d2a2eddb-1f1a-46ea-bd3b-d7fd6f588938",
        "file": {
          "url": null
        }
      },
      "relationships": {
        "theme": {
          "links": {
            "related": "api/boomerang/themes/d2a2eddb-1f1a-46ea-bd3b-d7fd6f588938"
          }
        }
      }
    }
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "key": "templates/index.json",
          "value": "{ \"name\": \"index\" }",
          "theme_id": "b81d1a11-bcff-4ad4-aa43-983f7edf7318"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "6d9ce756-c747-4d0a-add4-faffffc5e2b1",
    "type": "assets",
    "attributes": {
      "created_at": "2022-06-30T09:43:58+00:00",
      "updated_at": "2022-06-30T09:43:58+00:00",
      "key": "templates/index.json",
      "checksum": "74b5b91c79f3099a43573f152554e8d82d55efe4039fe9c2d67246950750f61e",
      "content_type": "application/json",
      "value": "{ \"name\": \"index\" }",
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          ...
          "theme_id": "698f2161-d474-43a3-90fd-ddb963c222d4",
...
```json
  {
  "data": {
    "id": "828ffb1d-8b19-4de0-a871-3c9ce78a9e0b",
    "type": "assets",
    "attributes": {
      "created_at": "2022-06-30T09:43:58+00:00",
      "updated_at": "2022-06-30T09:43:58+00:00",
      ...
      "theme_id": "698f2161-d474-43a3-90fd-ddb963c222d4",
      "file": {
        "url": "/assets/698f2161-d474-43a3-90fd-ddb963c222d4/image-d6c8d6c485714758ae033483d6773831e27bd7393c141bb73e8e96c14f35e1ad.png"
      }
    },
    "relationships": {
      "theme": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/assets/20925320-3b8b-4324-a2b6-112874159cc1' \
    --header 'content-type: application/json' \
```
