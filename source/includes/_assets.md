...
```json
  ...
  "data": [
    {
      "id": "9fed5f20-08da-4c11-a62c-15e3955efb4e",
      "type": "assets",
      "attributes": {
        "created_at": "2022-06-30T08:45:25+00:00",
        "updated_at": "2022-06-30T08:45:25+00:00",
        "key": "templates/index.json",
        "checksum": "74b5b91c79f3099a43573f152554e8d82d55efe4039fe9c2d67246950750f61e",
        "content_type": "application/json",
        "value": "{ \"name\": \"index\" }",
        "published_at": "2022-06-23T08:45:25+00:00",
        "theme_id": "526ac63a-81ef-4399-ad8f-a972cd2b55ca",
        "file": {
          "url": null
        }
      },
      "relationships": {
        "theme": {
          "links": {
            "related": "api/boomerang/themes/526ac63a-81ef-4399-ad8f-a972cd2b55ca"
          }
        }
      }
    }
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "key": "templates/index.json",
          "value": "{ \"name\": \"index\" }",
          "theme_id": "05bc1790-943f-4d0d-b825-03c2a3e7417e"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "3f2a25d1-3028-4f96-aee6-ced5e2d9f338",
    "type": "assets",
    "attributes": {
      "created_at": "2022-06-30T08:45:26+00:00",
      "updated_at": "2022-06-30T08:45:26+00:00",
      "key": "templates/index.json",
      "checksum": "74b5b91c79f3099a43573f152554e8d82d55efe4039fe9c2d67246950750f61e",
      "content_type": "application/json",
      "value": "{ \"name\": \"index\" }",
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          ...
          "theme_id": "53e0ffb1-9517-49da-a71c-7a1c96b5fbc9",
...
```json
  {
  "data": {
    "id": "2b993b1d-6de8-4a80-95bb-f04d5cc716a3",
    "type": "assets",
    "attributes": {
      "created_at": "2022-06-30T08:45:26+00:00",
      "updated_at": "2022-06-30T08:45:26+00:00",
      ...
      "theme_id": "53e0ffb1-9517-49da-a71c-7a1c96b5fbc9",
      "file": {
        "url": "/assets/53e0ffb1-9517-49da-a71c-7a1c96b5fbc9/image-d6c8d6c485714758ae033483d6773831e27bd7393c141bb73e8e96c14f35e1ad.png"
      }
    },
    "relationships": {
      "theme": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/assets/158e8f92-f40b-4385-b1b0-4d7c853c6131' \
    --header 'content-type: application/json' \
```
