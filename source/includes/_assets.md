    ...
    --data '{
      "data": {
        ...
        "attributes": {
          ...
          "theme_id": "06efc908-783e-400f-bd41-be8bb6ebf433",
...
```json
  {
  "data": {
    "id": "25c3244d-6525-43bd-8159-34c946b4657b",
    "type": "assets",
    "attributes": {
      "created_at": "2024-02-12T09:18:00+00:00",
      "updated_at": "2024-02-12T09:18:00+00:00",
      "key": "assets/image.png",
      "custom": true,
      ...
      "theme_id": "06efc908-783e-400f-bd41-be8bb6ebf433",
      "file": {
        "url": "/assets/06efc908-783e-400f-bd41-be8bb6ebf433/image-d6c8d6c485714758ae033483d6773831e27bd7393c141bb73e8e96c14f35e1ad(2).png"
      }
    }
  },
  "meta": {}
...
```json
  ...
  "data": [
    {
      "id": "e72baefc-4cd1-4c49-87f0-ac3c08723ee9",
      "type": "assets",
      "attributes": {
        "created_at": "2024-02-12T09:18:00+00:00",
        "updated_at": "2024-02-12T09:18:00+00:00",
        ...
        "value": "{ \"name\": \"index\" }",
        "published_at": "2024-02-05T09:18:00+00:00",
        "theme_id": "f380a637-a4cc-404f-9c6b-a3211cab47fc",
        "file": {
          "url": null
        }
      }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/assets/00f919bf-7501-40fd-a283-dbd8b3e50787' \
    --header 'content-type: application/json' \
```
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "key": "templates/index.json",
          "value": "{ \"name\": \"index\" }",
          "theme_id": "fdfd4b55-2271-49b3-80f3-e3b60ae30f36"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "a27f7cda-9712-4bea-897d-cff3df8f23e0",
    "type": "assets",
    "attributes": {
      "created_at": "2024-02-12T09:18:01+00:00",
      "updated_at": "2024-02-12T09:18:01+00:00",
      "key": "templates/index.json",
      "custom": false,
      "checksum": "74b5b91c79f3099a43573f152554e8d82d55efe4039fe9c2d67246950750f61e",
      "content_type": "application/json",
