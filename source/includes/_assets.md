...
```json
  ...
  "data": [
    {
      "id": "c2059961-966c-408c-bc24-7d0bf9f603ab",
      "type": "assets",
      "attributes": {
        "created_at": "2022-09-16T11:48:06+00:00",
        "updated_at": "2022-09-16T11:48:06+00:00",
        "key": "templates/index.json",
        "custom": false,
        "checksum": "74b5b91c79f3099a43573f152554e8d82d55efe4039fe9c2d67246950750f61e",
        "content_type": "application/json",
        "value": "{ \"name\": \"index\" }",
        "published_at": "2022-09-09T11:48:06+00:00",
        "theme_id": "fc46a327-55db-4a43-ac36-797a09b7c8c4",
        "file": {
          "url": null
        }
      },
      "relationships": {
        "theme": {
          "links": {
            "related": "api/boomerang/themes/fc46a327-55db-4a43-ac36-797a09b7c8c4"
          }
        }
      }
    }
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "key": "templates/index.json",
          "value": "{ \"name\": \"index\" }",
          "theme_id": "d224360c-f16d-4996-b3a4-0adce74f9efa"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "bbcf99d6-2318-4ef1-bc59-e52834ba4d55",
    "type": "assets",
    "attributes": {
      "created_at": "2022-09-16T11:48:07+00:00",
      "updated_at": "2022-09-16T11:48:07+00:00",
      "key": "templates/index.json",
      "custom": false,
      "checksum": "74b5b91c79f3099a43573f152554e8d82d55efe4039fe9c2d67246950750f61e",
      "content_type": "application/json",
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          ...
          "theme_id": "505d625c-7ffe-4979-8217-4def2e2e4f34",
...
```json
  {
  "data": {
    "id": "245172dc-bf55-439d-a1a1-2e5191780201",
    "type": "assets",
    "attributes": {
      "created_at": "2022-09-16T11:48:08+00:00",
      "updated_at": "2022-09-16T11:48:08+00:00",
      "key": "assets/image.png",
      "custom": false,
      ...
      "theme_id": "505d625c-7ffe-4979-8217-4def2e2e4f34",
      "file": {
        "url": "/assets/505d625c-7ffe-4979-8217-4def2e2e4f34/image-d6c8d6c485714758ae033483d6773831e27bd7393c141bb73e8e96c14f35e1ad.png"
      }
    },
    "relationships": {
      "theme": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/assets/65acbcfe-4108-49a2-99d5-4b73555f8237' \
    --header 'content-type: application/json' \
```
