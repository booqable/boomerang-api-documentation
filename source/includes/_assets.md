...
```json
  ...
  "data": [
    {
      "id": "dee3e650-a187-4aad-9078-a4ff60eb76d2",
      "type": "assets",
      "attributes": {
        "created_at": "2023-03-06T08:22:27+00:00",
        "updated_at": "2023-03-06T08:22:27+00:00",
        "key": "templates/index.json",
        "custom": false,
        "checksum": "74b5b91c79f3099a43573f152554e8d82d55efe4039fe9c2d67246950750f61e",
        "content_type": "application/json",
        "value": "{ \"name\": \"index\" }",
        "published_at": "2023-02-27T08:22:27+00:00",
        "theme_id": "00889ff4-b6e1-4952-a4de-153d549e282c",
        "file": {
          "url": null
        }
      },
      "relationships": {
        "theme": {
          "links": {
            "related": "api/boomerang/themes/00889ff4-b6e1-4952-a4de-153d549e282c"
          }
        }
      }
    }
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "key": "templates/index.json",
          "value": "{ \"name\": \"index\" }",
          "theme_id": "69e9ad43-40bc-41c3-9d5f-2549c99d282a"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "71b34f9c-2525-4ab2-9187-3b333971e9df",
    "type": "assets",
    "attributes": {
      "created_at": "2023-03-06T08:22:27+00:00",
      "updated_at": "2023-03-06T08:22:27+00:00",
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          ...
          "theme_id": "950d2026-14e8-437f-98f2-65788efe9391",
...
```json
  {
  "data": {
    "id": "beed0419-02c5-4ed1-8333-30bb05747f68",
    "type": "assets",
    "attributes": {
      "created_at": "2023-03-06T08:22:27+00:00",
      "updated_at": "2023-03-06T08:22:27+00:00",
      ...
      "theme_id": "950d2026-14e8-437f-98f2-65788efe9391",
      "file": {
        "url": "/assets/950d2026-14e8-437f-98f2-65788efe9391/image-d6c8d6c485714758ae033483d6773831e27bd7393c141bb73e8e96c14f35e1ad.png"
      }
    },
    "relationships": {
      "theme": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/assets/73681b2c-e65f-440a-b79f-f6ff38e90a13' \
    --header 'content-type: application/json' \
```
