...
```json
  ...
  "data": [
    {
      "id": "2bc87c2b-4d08-4c09-8a45-9c8eaa8bd657",
      "type": "assets",
      "attributes": {
        "created_at": "2022-07-13T08:17:10+00:00",
        "updated_at": "2022-07-13T08:17:10+00:00",
        "key": "templates/index.json",
        "checksum": "74b5b91c79f3099a43573f152554e8d82d55efe4039fe9c2d67246950750f61e",
        "content_type": "application/json",
        "value": "{ \"name\": \"index\" }",
        "published_at": "2022-07-06T08:17:10+00:00",
        "theme_id": "0584ca8d-b1b5-41b0-8619-944563dde9dc",
        "file": {
          "url": null
        }
      },
      "relationships": {
        "theme": {
          "links": {
            "related": "api/boomerang/themes/0584ca8d-b1b5-41b0-8619-944563dde9dc"
          }
        }
      }
    }
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "key": "templates/index.json",
          "value": "{ \"name\": \"index\" }",
          "theme_id": "b5286723-a6fb-4103-8564-c78d20cad0c3"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "3fac558a-078d-4504-abca-f4b2ce907f42",
    "type": "assets",
    "attributes": {
      "created_at": "2022-07-13T08:17:11+00:00",
      "updated_at": "2022-07-13T08:17:11+00:00",
      "key": "templates/index.json",
      "checksum": "74b5b91c79f3099a43573f152554e8d82d55efe4039fe9c2d67246950750f61e",
      "content_type": "application/json",
      "value": "{ \"name\": \"index\" }",
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          ...
          "theme_id": "86079d5c-76f1-4f9b-8c8f-3c479ab0fdd3",
...
```json
  {
  "data": {
    "id": "024a57f8-a149-4cdd-95cb-b25fb38a4c52",
    "type": "assets",
    "attributes": {
      "created_at": "2022-07-13T08:17:12+00:00",
      "updated_at": "2022-07-13T08:17:12+00:00",
      "key": "assets/image.png",
      ...
      "theme_id": "86079d5c-76f1-4f9b-8c8f-3c479ab0fdd3",
      "file": {
        "url": "/assets/86079d5c-76f1-4f9b-8c8f-3c479ab0fdd3/image-d6c8d6c485714758ae033483d6773831e27bd7393c141bb73e8e96c14f35e1ad.png"
      }
    },
    "relationships": {
      "theme": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/assets/2d2f2b0b-b671-4901-a4a9-3f7f07f6fbf6' \
    --header 'content-type: application/json' \
```
