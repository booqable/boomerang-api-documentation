...
```json
  ...
  "data": [
    {
      "id": "335abc7a-7c1a-40ac-94c0-71c630e64f55",
      "type": "assets",
      "attributes": {
        "created_at": "2022-05-12T06:33:29+00:00",
        "updated_at": "2022-05-12T06:33:29+00:00",
        "key": "templates/index.json",
        "checksum": "74b5b91c79f3099a43573f152554e8d82d55efe4039fe9c2d67246950750f61e",
        "content_type": "application/json",
        "value": "{ \"name\": \"index\" }",
        "published_at": "2022-05-05T06:33:29+00:00",
        "theme_id": "fbe7ebdd-7ebe-4d13-9608-fe2da53c651c",
        "file": {
          "url": null
        }
      },
      "relationships": {
        "theme": {
          "links": {
            "related": "api/boomerang/themes/fbe7ebdd-7ebe-4d13-9608-fe2da53c651c"
          }
        }
      }
    }
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "key": "templates/index.json",
          "value": "{ \"name\": \"index\" }",
          "theme_id": "b200da9e-0cd4-4ca4-b0c2-93e6b80bcabf"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "a4828145-86af-4a9e-9a3b-c42ede6fae6d",
    "type": "assets",
    "attributes": {
      "created_at": "2022-05-12T06:33:30+00:00",
      "updated_at": "2022-05-12T06:33:30+00:00",
      "key": "templates/index.json",
      "checksum": "74b5b91c79f3099a43573f152554e8d82d55efe4039fe9c2d67246950750f61e",
      "content_type": "application/json",
      "value": "{ \"name\": \"index\" }",
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          ...
          "theme_id": "eead6b32-f4b5-404c-ae07-d67316ceaa5a",
...
```json
  {
  "data": {
    "id": "1aa9e5b5-56e7-46ab-87bb-2aa8a9999e59",
    "type": "assets",
    "attributes": {
      "created_at": "2022-05-12T06:33:30+00:00",
      "updated_at": "2022-05-12T06:33:30+00:00",
      ...
      "theme_id": "eead6b32-f4b5-404c-ae07-d67316ceaa5a",
      "file": {
        "url": "/assets/eead6b32-f4b5-404c-ae07-d67316ceaa5a/image-d6c8d6c485714758ae033483d6773831e27bd7393c141bb73e8e96c14f35e1ad.png"
      }
    },
    "relationships": {
      "theme": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/assets/d7c8b281-747e-4c5d-abf4-04e58b2e3c36' \
    --header 'content-type: application/json' \
```
