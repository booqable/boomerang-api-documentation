...
```json
  ...
  "data": [
    {
      "id": "ed128cf2-6bd1-4180-82e6-5677a25ecf9d",
      "type": "assets",
      "attributes": {
        ...
        "value": "{ \"name\": \"index\" }",
        "published_at": "2023-02-02T11:05:58+00:00",
        "theme_id": "e1dcc1b2-d179-46e5-9f5e-d531a5fed329",
        "file": {
          "url": null
        }
      },
      "relationships": {
        "theme": {
          "links": {
            "related": "api/boomerang/themes/e1dcc1b2-d179-46e5-9f5e-d531a5fed329"
          }
        }
      }
    }
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "key": "templates/index.json",
          "value": "{ \"name\": \"index\" }",
          "theme_id": "fe2b4510-0193-4359-b150-15e591dc68ce"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "1ff4ab70-f187-44e3-b1f2-9de6bef9b62c",
    "type": "assets",
    "attributes": {
      "created_at": "2023-02-09T11:05:58+00:00",
      "updated_at": "2023-02-09T11:05:58+00:00",
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          ...
          "theme_id": "e91d6d15-71c8-4ecb-8663-d3735f19d454",
...
```json
  {
  "data": {
    "id": "f8f5af68-838b-4546-8e27-8431c4aa8ed7",
    "type": "assets",
    "attributes": {
      ...
      "theme_id": "e91d6d15-71c8-4ecb-8663-d3735f19d454",
      "file": {
        "url": "/assets/e91d6d15-71c8-4ecb-8663-d3735f19d454/image-d6c8d6c485714758ae033483d6773831e27bd7393c141bb73e8e96c14f35e1ad.png"
      }
    },
    "relationships": {
      "theme": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/assets/f8e8097f-39f7-466a-a83b-5768375b7611' \
    --header 'content-type: application/json' \
```
