...
```json
  ...
  "data": [
    {
      "id": "24e657bd-8f7b-438d-8337-e41a8ca002d5",
      "type": "assets",
      "attributes": {
        "created_at": "2022-10-25T17:51:01+00:00",
        "updated_at": "2022-10-25T17:51:01+00:00",
        "key": "templates/index.json",
        "custom": false,
        "checksum": "74b5b91c79f3099a43573f152554e8d82d55efe4039fe9c2d67246950750f61e",
        "content_type": "application/json",
        "value": "{ \"name\": \"index\" }",
        "published_at": "2022-10-18T17:51:01+00:00",
        "theme_id": "97e0d4a8-4221-49aa-b25b-5d7c1975743f",
        "file": {
          "url": null
        }
      },
      "relationships": {
        "theme": {
          "links": {
            "related": "api/boomerang/themes/97e0d4a8-4221-49aa-b25b-5d7c1975743f"
          }
        }
      }
    }
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "key": "templates/index.json",
          "value": "{ \"name\": \"index\" }",
          "theme_id": "90ee598f-14f8-4f6e-b359-7866f73c8414"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "f22ce687-ef0c-4a36-8335-edf3f1f337bf",
    "type": "assets",
    "attributes": {
      "created_at": "2022-10-25T17:51:02+00:00",
      "updated_at": "2022-10-25T17:51:02+00:00",
      "key": "templates/index.json",
      "custom": false,
      "checksum": "74b5b91c79f3099a43573f152554e8d82d55efe4039fe9c2d67246950750f61e",
      "content_type": "application/json",
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          ...
          "theme_id": "9057a16d-94aa-4562-9ceb-859d0be88dbd",
...
```json
  {
  "data": {
    "id": "b360895d-236a-4fa3-be3d-1bef1478b247",
    "type": "assets",
    "attributes": {
      "created_at": "2022-10-25T17:51:03+00:00",
      "updated_at": "2022-10-25T17:51:03+00:00",
      "key": "assets/image.png",
      "custom": false,
      ...
      "theme_id": "9057a16d-94aa-4562-9ceb-859d0be88dbd",
      "file": {
        "url": "/assets/9057a16d-94aa-4562-9ceb-859d0be88dbd/image-d6c8d6c485714758ae033483d6773831e27bd7393c141bb73e8e96c14f35e1ad.png"
      }
    },
    "relationships": {
      "theme": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/assets/2a928a38-e278-4a08-bd00-12b71f3f5ec1' \
    --header 'content-type: application/json' \
```
