...
```json
  ...
  "data": [
    {
      "id": "726950a6-8f1a-4554-91c8-7ebc09383c69",
      "type": "assets",
      "attributes": {
        "created_at": "2023-03-09T10:26:21+00:00",
        "updated_at": "2023-03-09T10:26:21+00:00",
        "key": "templates/index.json",
        "custom": false,
        "checksum": "74b5b91c79f3099a43573f152554e8d82d55efe4039fe9c2d67246950750f61e",
        "content_type": "application/json",
        "value": "{ \"name\": \"index\" }",
        "published_at": "2023-03-02T10:26:21+00:00",
        "theme_id": "c1997078-6720-4f2c-9248-df4ec510ec23",
        "file": {
          "url": null
        }
      },
      "relationships": {
        "theme": {
          "links": {
            "related": "api/boomerang/themes/c1997078-6720-4f2c-9248-df4ec510ec23"
          }
        }
      }
    }
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "key": "templates/index.json",
          "value": "{ \"name\": \"index\" }",
          "theme_id": "71d89df4-ae38-4633-88b1-397b6936bb6d"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "3d56d7a6-59e7-4db9-8627-8221c286a2e0",
    "type": "assets",
    "attributes": {
      "created_at": "2023-03-09T10:26:22+00:00",
      "updated_at": "2023-03-09T10:26:22+00:00",
      "key": "templates/index.json",
      "custom": false,
      "checksum": "74b5b91c79f3099a43573f152554e8d82d55efe4039fe9c2d67246950750f61e",
      "content_type": "application/json",
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          ...
          "theme_id": "4394305e-a5e4-411b-b2fc-df84ae19bad4",
...
```json
  {
  "data": {
    "id": "c09c407c-bacf-470e-8500-6b26a926d3b6",
    "type": "assets",
    "attributes": {
      "created_at": "2023-03-09T10:26:22+00:00",
      "updated_at": "2023-03-09T10:26:22+00:00",
      ...
      "theme_id": "4394305e-a5e4-411b-b2fc-df84ae19bad4",
      "file": {
        "url": "/assets/4394305e-a5e4-411b-b2fc-df84ae19bad4/image-d6c8d6c485714758ae033483d6773831e27bd7393c141bb73e8e96c14f35e1ad.png"
      }
    },
    "relationships": {
      "theme": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/assets/1a44f669-a99a-4957-9ce3-ebcd35c25548' \
    --header 'content-type: application/json' \
```
