...
```json
  ...
  "data": [
    {
      "id": "d6c6aebf-d776-4e4c-bf6d-f68be19af042",
      "type": "assets",
      "attributes": {
        "created_at": "2022-06-30T12:40:28+00:00",
        "updated_at": "2022-06-30T12:40:28+00:00",
        "key": "templates/index.json",
        "checksum": "74b5b91c79f3099a43573f152554e8d82d55efe4039fe9c2d67246950750f61e",
        "content_type": "application/json",
        "value": "{ \"name\": \"index\" }",
        "published_at": "2022-06-23T12:40:28+00:00",
        "theme_id": "2058a3b0-9361-4c99-8f67-6b1cfb6d6c6f",
        "file": {
          "url": null
        }
      },
      "relationships": {
        "theme": {
          "links": {
            "related": "api/boomerang/themes/2058a3b0-9361-4c99-8f67-6b1cfb6d6c6f"
          }
        }
      }
    }
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "key": "templates/index.json",
          "value": "{ \"name\": \"index\" }",
          "theme_id": "a2fb3551-bca9-4fca-ae0f-a64b9aca2b95"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "bb56a3d4-5fb1-4f32-9368-74f10d4c11d4",
    "type": "assets",
    "attributes": {
      "created_at": "2022-06-30T12:40:29+00:00",
      "updated_at": "2022-06-30T12:40:29+00:00",
      "key": "templates/index.json",
      "checksum": "74b5b91c79f3099a43573f152554e8d82d55efe4039fe9c2d67246950750f61e",
      "content_type": "application/json",
      "value": "{ \"name\": \"index\" }",
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          ...
          "theme_id": "594369c9-01bc-4923-bd20-82cda02e3bed",
...
```json
  {
  "data": {
    "id": "8f9bccf7-80b4-44d8-91ff-68079e897e77",
    "type": "assets",
    "attributes": {
      "created_at": "2022-06-30T12:40:30+00:00",
      "updated_at": "2022-06-30T12:40:30+00:00",
      "key": "assets/image.png",
      ...
      "theme_id": "594369c9-01bc-4923-bd20-82cda02e3bed",
      "file": {
        "url": "/assets/594369c9-01bc-4923-bd20-82cda02e3bed/image-d6c8d6c485714758ae033483d6773831e27bd7393c141bb73e8e96c14f35e1ad.png"
      }
    },
    "relationships": {
      "theme": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/assets/a7e3ab8e-b888-4889-9764-01053db48c0b' \
    --header 'content-type: application/json' \
```
