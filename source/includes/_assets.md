...
```json
  ...
  "data": [
    {
      "id": "403e76b5-efd5-4d1d-aa62-062d05a6dcae",
      "type": "assets",
      "attributes": {
        "created_at": "2023-03-07T08:26:52+00:00",
        "updated_at": "2023-03-07T08:26:52+00:00",
        "key": "templates/index.json",
        "custom": false,
        "checksum": "74b5b91c79f3099a43573f152554e8d82d55efe4039fe9c2d67246950750f61e",
        "content_type": "application/json",
        "value": "{ \"name\": \"index\" }",
        "published_at": "2023-02-28T08:26:52+00:00",
        "theme_id": "b58d97b7-c202-4667-825a-ae2c5ad7e3a4",
        "file": {
          "url": null
        }
      },
      "relationships": {
        "theme": {
          "links": {
            "related": "api/boomerang/themes/b58d97b7-c202-4667-825a-ae2c5ad7e3a4"
          }
        }
      }
    }
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "key": "templates/index.json",
          "value": "{ \"name\": \"index\" }",
          "theme_id": "94b36ebe-8c64-4e11-9c46-b7835594ea10"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "eb830b51-7bb7-479b-bfca-8823e7b940b1",
    "type": "assets",
    "attributes": {
      "created_at": "2023-03-07T08:26:52+00:00",
      "updated_at": "2023-03-07T08:26:52+00:00",
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          ...
          "theme_id": "a638bb47-9c3b-4073-a27c-715a497247bf",
...
```json
  {
  "data": {
    "id": "13586e54-ea72-430e-b156-e28e295295cd",
    "type": "assets",
    "attributes": {
      "created_at": "2023-03-07T08:26:53+00:00",
      "updated_at": "2023-03-07T08:26:53+00:00",
      "key": "assets/image.png",
      "custom": true,
      ...
      "theme_id": "a638bb47-9c3b-4073-a27c-715a497247bf",
      "file": {
        "url": "/assets/a638bb47-9c3b-4073-a27c-715a497247bf/image-d6c8d6c485714758ae033483d6773831e27bd7393c141bb73e8e96c14f35e1ad.png"
      }
    },
    "relationships": {
      "theme": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/assets/38fd8314-0bd1-4efa-9766-e7b25da97ec4' \
    --header 'content-type: application/json' \
```
