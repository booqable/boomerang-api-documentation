...
```json
  ...
  "data": [
    {
      "id": "d13a7336-4b04-44b1-98eb-c15b7ba52205",
      "type": "assets",
      "attributes": {
        "created_at": "2023-02-07T10:56:38+00:00",
        "updated_at": "2023-02-07T10:56:38+00:00",
        "key": "templates/index.json",
        "custom": false,
        "checksum": "74b5b91c79f3099a43573f152554e8d82d55efe4039fe9c2d67246950750f61e",
        "content_type": "application/json",
        "value": "{ \"name\": \"index\" }",
        "published_at": "2023-01-31T10:56:38+00:00",
        "theme_id": "8fa37dc1-eaef-4e02-8694-9e2b974c3cec",
        "file": {
          "url": null
        }
      },
      "relationships": {
        "theme": {
          "links": {
            "related": "api/boomerang/themes/8fa37dc1-eaef-4e02-8694-9e2b974c3cec"
          }
        }
      }
    }
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "key": "templates/index.json",
          "value": "{ \"name\": \"index\" }",
          "theme_id": "118a6ebb-b3a3-40dc-ae9d-0b3608cb3a95"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "def02148-73e8-4f67-bbf6-bbdb5b8a1c1e",
    "type": "assets",
    "attributes": {
      "created_at": "2023-02-07T10:56:39+00:00",
      "updated_at": "2023-02-07T10:56:39+00:00",
      "key": "templates/index.json",
      "custom": false,
      "checksum": "74b5b91c79f3099a43573f152554e8d82d55efe4039fe9c2d67246950750f61e",
      "content_type": "application/json",
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          ...
          "theme_id": "e95d074e-50ff-49da-a9f0-ff497f895db1",
...
```json
  {
  "data": {
    "id": "0652015a-a7b6-4e7f-8bd8-8e3493a50c88",
    "type": "assets",
    "attributes": {
      "created_at": "2023-02-07T10:56:40+00:00",
      "updated_at": "2023-02-07T10:56:40+00:00",
      "key": "assets/image.png",
      "custom": false,
      ...
      "theme_id": "e95d074e-50ff-49da-a9f0-ff497f895db1",
      "file": {
        "url": "/assets/e95d074e-50ff-49da-a9f0-ff497f895db1/image-d6c8d6c485714758ae033483d6773831e27bd7393c141bb73e8e96c14f35e1ad.png"
      }
    },
    "relationships": {
      "theme": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/assets/25f9a26f-c33d-43a1-bf1b-642dac1c063b' \
    --header 'content-type: application/json' \
```
