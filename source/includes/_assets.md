...
```json
  ...
  "data": [
    {
      "id": "9ce3d0cd-b706-4f7d-8f69-bf5840f3d418",
      "type": "assets",
      "attributes": {
        "created_at": "2022-11-15T08:04:25+00:00",
        "updated_at": "2022-11-15T08:04:25+00:00",
        "key": "templates/index.json",
        "custom": false,
        "checksum": "74b5b91c79f3099a43573f152554e8d82d55efe4039fe9c2d67246950750f61e",
        "content_type": "application/json",
        "value": "{ \"name\": \"index\" }",
        "published_at": "2022-11-08T08:04:25+00:00",
        "theme_id": "a760479b-32dc-4856-b224-9b970c2f06fe",
        "file": {
          "url": null
        }
      },
      "relationships": {
        "theme": {
          "links": {
            "related": "api/boomerang/themes/a760479b-32dc-4856-b224-9b970c2f06fe"
          }
        }
      }
    }
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "key": "templates/index.json",
          "value": "{ \"name\": \"index\" }",
          "theme_id": "a0b008fe-e870-4615-b38c-80b3fb50e9c3"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "a8692049-b1e3-40a0-ab9c-6295d60c1ce3",
    "type": "assets",
    "attributes": {
      "created_at": "2022-11-15T08:04:25+00:00",
      "updated_at": "2022-11-15T08:04:25+00:00",
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          ...
          "theme_id": "db61c6e6-e1d8-4bd6-9e69-1db03afb5bd2",
...
```json
  {
  "data": {
    "id": "29054d72-c617-4355-a408-043899237c44",
    "type": "assets",
    "attributes": {
      "created_at": "2022-11-15T08:04:26+00:00",
      "updated_at": "2022-11-15T08:04:26+00:00",
      "key": "assets/image.png",
      "custom": false,
      ...
      "theme_id": "db61c6e6-e1d8-4bd6-9e69-1db03afb5bd2",
      "file": {
        "url": "/assets/db61c6e6-e1d8-4bd6-9e69-1db03afb5bd2/image-d6c8d6c485714758ae033483d6773831e27bd7393c141bb73e8e96c14f35e1ad.png"
      }
    },
    "relationships": {
      "theme": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/assets/b55b1c9f-3b60-4821-966c-123cd2eb0dc7' \
    --header 'content-type: application/json' \
```
