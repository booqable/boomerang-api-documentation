...
```json
  ...
  "data": [
    {
      "id": "5ff61b29-5739-4640-97f0-cd3603d0ea87",
      "type": "assets",
      "attributes": {
        "created_at": "2022-06-16T19:29:34+00:00",
        "updated_at": "2022-06-16T19:29:34+00:00",
        "key": "templates/index.json",
        "checksum": "74b5b91c79f3099a43573f152554e8d82d55efe4039fe9c2d67246950750f61e",
        "content_type": "application/json",
        "value": "{ \"name\": \"index\" }",
        "published_at": "2022-06-09T19:29:34+00:00",
        "theme_id": "cac1f254-7eff-4d9d-8f57-65b6238b5820",
        "file": {
          "url": null
        }
      },
      "relationships": {
        "theme": {
          "links": {
            "related": "api/boomerang/themes/cac1f254-7eff-4d9d-8f57-65b6238b5820"
          }
        }
      }
    }
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "key": "templates/index.json",
          "value": "{ \"name\": \"index\" }",
          "theme_id": "a79bb449-263b-44f5-9cf9-bddec4b5bb6a"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "ad0753c3-c65b-485b-8263-e2db75ab90ef",
    "type": "assets",
    "attributes": {
      "created_at": "2022-06-16T19:29:35+00:00",
      "updated_at": "2022-06-16T19:29:35+00:00",
      "key": "templates/index.json",
      "checksum": "74b5b91c79f3099a43573f152554e8d82d55efe4039fe9c2d67246950750f61e",
      "content_type": "application/json",
      "value": "{ \"name\": \"index\" }",
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          ...
          "theme_id": "2f3a1119-4af6-465a-aa3c-7884a3da0f40",
...
```json
  {
  "data": {
    "id": "0946c812-591a-4978-8928-39e4f3c328b7",
    "type": "assets",
    "attributes": {
      "created_at": "2022-06-16T19:29:35+00:00",
      "updated_at": "2022-06-16T19:29:35+00:00",
      ...
      "theme_id": "2f3a1119-4af6-465a-aa3c-7884a3da0f40",
      "file": {
        "url": "/assets/2f3a1119-4af6-465a-aa3c-7884a3da0f40/image-d6c8d6c485714758ae033483d6773831e27bd7393c141bb73e8e96c14f35e1ad.png"
      }
    },
    "relationships": {
      "theme": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/assets/bce2ab51-093f-4233-9e63-0ee841e9e71a' \
    --header 'content-type: application/json' \
```
