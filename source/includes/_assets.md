...
`content_type` | **String** `readonly`<br>The MIME representation of the content, consisting of the type and subtype of the asset. One of `image/jpeg`, `image/gif`, `image/png`, `text/css`, `text/plain`, `application/javascript`, `application/liquid`, `application/json`
...
```json
  ...
  "data": [
    {
      "id": "fcb88853-6264-474e-abef-f358a7dc2217",
      "type": "assets",
      "attributes": {
        "created_at": "2022-05-31T06:54:21+00:00",
        "updated_at": "2022-05-31T06:54:21+00:00",
        "key": "templates/index.json",
        "checksum": "74b5b91c79f3099a43573f152554e8d82d55efe4039fe9c2d67246950750f61e",
        "content_type": "application/json",
        "value": "{ \"name\": \"index\" }",
        "published_at": "2022-05-24T06:54:21+00:00",
        "theme_id": "7dc94985-a1f1-4cde-9d51-85b3bf9b73e0",
        "file": {
          "url": null
        }
      },
      "relationships": {
        "theme": {
          "links": {
            "related": "api/boomerang/themes/7dc94985-a1f1-4cde-9d51-85b3bf9b73e0"
          }
        }
      }
    }
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "key": "templates/index.json",
          "value": "{ \"name\": \"index\" }",
          "theme_id": "52035df2-3f32-4f91-acf5-bc838c12d345"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "8bd9196c-5be2-4ad8-9f7b-e580a3024f00",
    "type": "assets",
    "attributes": {
      "created_at": "2022-05-31T06:54:22+00:00",
      "updated_at": "2022-05-31T06:54:22+00:00",
      "key": "templates/index.json",
      "checksum": "74b5b91c79f3099a43573f152554e8d82d55efe4039fe9c2d67246950750f61e",
      "content_type": "application/json",
      "value": "{ \"name\": \"index\" }",
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          ...
          "theme_id": "4a829b16-7ffa-4c30-8b3e-6fdc907295f3",
...
```json
  {
  "data": {
    "id": "180e4c04-e1db-4327-a1ad-b8f8492bb48d",
    "type": "assets",
    "attributes": {
      "created_at": "2022-05-31T06:54:23+00:00",
      "updated_at": "2022-05-31T06:54:23+00:00",
      "key": "assets/image.png",
      ...
      "theme_id": "4a829b16-7ffa-4c30-8b3e-6fdc907295f3",
      "file": {
        "url": "/assets/4a829b16-7ffa-4c30-8b3e-6fdc907295f3/image-d6c8d6c485714758ae033483d6773831e27bd7393c141bb73e8e96c14f35e1ad.png"
      }
    },
    "relationships": {
      "theme": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/assets/71f8ead1-bfd3-4b47-9f2b-a5d57261c3fa' \
    --header 'content-type: application/json' \
```
