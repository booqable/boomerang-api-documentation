...
`content_type` | **String** `readonly`<br>The MIME representation of the content, consisting of the type and subtype of the asset. One of `image/jpeg`, `image/gif`, `image/png`, `image/svg+xml`, `text/css`, `text/plain`, `application/javascript`, `application/liquid`, `application/json`
...
```json
  ...
  "data": [
    {
      "id": "3126dab8-25d1-4e66-be69-da4a4cb957ed",
      "type": "assets",
      "attributes": {
        "created_at": "2022-07-18T07:34:01+00:00",
        "updated_at": "2022-07-18T07:34:01+00:00",
        "key": "templates/index.json",
        "checksum": "74b5b91c79f3099a43573f152554e8d82d55efe4039fe9c2d67246950750f61e",
        "content_type": "application/json",
        "value": "{ \"name\": \"index\" }",
        "published_at": "2022-07-11T07:34:01+00:00",
        "theme_id": "9b572e95-1dad-4c2c-9eff-f99383bc6454",
        "file": {
          "url": null
        }
      },
      "relationships": {
        "theme": {
          "links": {
            "related": "api/boomerang/themes/9b572e95-1dad-4c2c-9eff-f99383bc6454"
          }
        }
      }
    }
...
`filter` | **Hash**<br>The filters to apply `?filter[created_at][gte]=2022-07-18T07:33:56Z`
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "key": "templates/index.json",
          "value": "{ \"name\": \"index\" }",
          "theme_id": "4de0a8d7-6209-46b1-855b-d99a9ca07f39"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "9feff009-847b-4212-8afd-cd4a9182ddd6",
    "type": "assets",
    "attributes": {
      "created_at": "2022-07-18T07:34:03+00:00",
      "updated_at": "2022-07-18T07:34:03+00:00",
      "key": "templates/index.json",
      "checksum": "74b5b91c79f3099a43573f152554e8d82d55efe4039fe9c2d67246950750f61e",
      "content_type": "application/json",
      "value": "{ \"name\": \"index\" }",
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          ...
          "theme_id": "445291e7-4fc3-4211-a13e-5ba4b6fdd3c5",
...
```json
  {
  "data": {
    "id": "4a5a6a75-eb83-435e-bb84-b751a17e661f",
    "type": "assets",
    "attributes": {
      "created_at": "2022-07-18T07:34:05+00:00",
      "updated_at": "2022-07-18T07:34:05+00:00",
      "key": "assets/image.png",
      ...
      "theme_id": "445291e7-4fc3-4211-a13e-5ba4b6fdd3c5",
      "file": {
        "url": "/assets/445291e7-4fc3-4211-a13e-5ba4b6fdd3c5/image-d6c8d6c485714758ae033483d6773831e27bd7393c141bb73e8e96c14f35e1ad.png"
      }
    },
    "relationships": {
      "theme": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/assets/c2165978-48b5-456b-b5ab-d759dcdbba1d' \
    --header 'content-type: application/json' \
```
