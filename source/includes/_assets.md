...
```json
  ...
  "data": [
    {
      "id": "7cf73029-6df4-439e-965f-fdd8bdd4008f",
      "type": "assets",
      "attributes": {
        "created_at": "2023-02-16T09:14:08+00:00",
        "updated_at": "2023-02-16T09:14:08+00:00",
        "key": "templates/index.json",
        "custom": false,
        "checksum": "74b5b91c79f3099a43573f152554e8d82d55efe4039fe9c2d67246950750f61e",
        "content_type": "application/json",
        "value": "{ \"name\": \"index\" }",
        "published_at": "2023-02-09T09:14:08+00:00",
        "theme_id": "7aae35c3-9874-4718-9327-5457855d4bc2",
        "file": {
          "url": null
        }
      },
      "relationships": {
        "theme": {
          "links": {
            "related": "api/boomerang/themes/7aae35c3-9874-4718-9327-5457855d4bc2"
          }
        }
      }
    }
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "key": "templates/index.json",
          "value": "{ \"name\": \"index\" }",
          "theme_id": "bb43987a-c451-49ae-8aea-9aa5dbd89297"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "29ee2ffe-a881-4369-8d06-b7a01d59cf16",
    "type": "assets",
    "attributes": {
      "created_at": "2023-02-16T09:14:09+00:00",
      "updated_at": "2023-02-16T09:14:09+00:00",
      "key": "templates/index.json",
      "custom": false,
      "checksum": "74b5b91c79f3099a43573f152554e8d82d55efe4039fe9c2d67246950750f61e",
      "content_type": "application/json",
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          ...
          "theme_id": "ba34bdc6-e1d7-43fe-a693-f4566b9b7f09",
...
```json
  {
  "data": {
    "id": "d2310562-b3d3-4f88-9dbf-fe1072e27f02",
    "type": "assets",
    "attributes": {
      "created_at": "2023-02-16T09:14:09+00:00",
      "updated_at": "2023-02-16T09:14:09+00:00",
      ...
      "theme_id": "ba34bdc6-e1d7-43fe-a693-f4566b9b7f09",
      "file": {
        "url": "/assets/ba34bdc6-e1d7-43fe-a693-f4566b9b7f09/image-d6c8d6c485714758ae033483d6773831e27bd7393c141bb73e8e96c14f35e1ad.png"
      }
    },
    "relationships": {
      "theme": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/assets/95c0d28f-74a5-49e6-be27-13d9b1bf0a82' \
    --header 'content-type: application/json' \
```
