...
```json
  ...
  "data": [
    {
      "id": "5fb3f909-324d-4a1e-93a1-38c682023c96",
      "type": "assets",
      "attributes": {
        "created_at": "2024-01-01T09:19:49+00:00",
        "updated_at": "2024-01-01T09:19:49+00:00",
        "key": "templates/index.json",
        "custom": false,
        "checksum": "74b5b91c79f3099a43573f152554e8d82d55efe4039fe9c2d67246950750f61e",
        "content_type": "application/json",
        "value": "{ \"name\": \"index\" }",
        "published_at": "2023-12-25T09:19:49+00:00",
        "theme_id": "434f664b-7354-4da6-9e14-e519c3ae29c0",
        "file": {
          "url": null
        }
      }
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "key": "templates/index.json",
          "value": "{ \"name\": \"index\" }",
          "theme_id": "fd3afaf5-a29a-4714-a487-67fb2dbd7f4b"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "10fde78a-3ce4-4160-8a29-c8857d0dd2ae",
    "type": "assets",
    "attributes": {
      "created_at": "2024-01-01T09:19:51+00:00",
      "updated_at": "2024-01-01T09:19:51+00:00",
      "key": "templates/index.json",
      "custom": false,
      "checksum": "74b5b91c79f3099a43573f152554e8d82d55efe4039fe9c2d67246950750f61e",
      "content_type": "application/json",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/assets/2443f693-397d-40f5-9bc4-ac7c1a8fa453' \
    --header 'content-type: application/json' \
```
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          ...
          "theme_id": "a5acb64b-af8a-4882-8bc1-5a72e7d4c23b",
...
```json
  {
  "data": {
    "id": "110a9ad3-e3ad-4b02-a963-a8e96ccaf7dc",
    "type": "assets",
    "attributes": {
      "created_at": "2024-01-01T09:19:53+00:00",
      "updated_at": "2024-01-01T09:19:53+00:00",
      "key": "assets/image.png",
      "custom": true,
      ...
      "theme_id": "a5acb64b-af8a-4882-8bc1-5a72e7d4c23b",
      "file": {
        "url": "/assets/a5acb64b-af8a-4882-8bc1-5a72e7d4c23b/image-d6c8d6c485714758ae033483d6773831e27bd7393c141bb73e8e96c14f35e1ad(2).png"
      }
    }
  },
  "meta": {}
