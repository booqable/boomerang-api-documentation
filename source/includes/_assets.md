...
```json
  ...
  "data": [
    {
      "id": "a974b1e8-ab5f-4461-917d-fb423264e7ae",
      "type": "assets",
      "attributes": {
        "created_at": "2023-03-01T09:59:37+00:00",
        "updated_at": "2023-03-01T09:59:37+00:00",
        "key": "templates/index.json",
        "custom": false,
        "checksum": "74b5b91c79f3099a43573f152554e8d82d55efe4039fe9c2d67246950750f61e",
        "content_type": "application/json",
        "value": "{ \"name\": \"index\" }",
        "published_at": "2023-02-22T09:59:37+00:00",
        "theme_id": "4b1a4780-d3cb-415a-9f15-03b434ed7ea1",
        "file": {
          "url": null
        }
      },
      "relationships": {
        "theme": {
          "links": {
            "related": "api/boomerang/themes/4b1a4780-d3cb-415a-9f15-03b434ed7ea1"
          }
        }
      }
    }
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "key": "templates/index.json",
          "value": "{ \"name\": \"index\" }",
          "theme_id": "9b2dc32c-2538-45bf-aef6-aa3c7a919948"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "0a3907a9-9c13-45e8-93a1-3acc9a7ae754",
    "type": "assets",
    "attributes": {
      "created_at": "2023-03-01T09:59:38+00:00",
      "updated_at": "2023-03-01T09:59:38+00:00",
      "key": "templates/index.json",
      "custom": false,
      "checksum": "74b5b91c79f3099a43573f152554e8d82d55efe4039fe9c2d67246950750f61e",
      "content_type": "application/json",
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          ...
          "theme_id": "74c594a2-7c37-408e-a543-6a1fbb45d8ab",
...
```json
  {
  "data": {
    "id": "7462a757-f1bd-4017-b8a6-747e52c0e5ce",
    "type": "assets",
    "attributes": {
      "created_at": "2023-03-01T09:59:39+00:00",
      "updated_at": "2023-03-01T09:59:39+00:00",
      "key": "assets/image.png",
      "custom": true,
      ...
      "theme_id": "74c594a2-7c37-408e-a543-6a1fbb45d8ab",
      "file": {
        "url": "/assets/74c594a2-7c37-408e-a543-6a1fbb45d8ab/image-d6c8d6c485714758ae033483d6773831e27bd7393c141bb73e8e96c14f35e1ad.png"
      }
    },
    "relationships": {
      "theme": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/assets/d2847931-4622-4e96-a27d-2d8e3bbc57e4' \
    --header 'content-type: application/json' \
```
