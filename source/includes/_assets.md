...
```json
  ...
  "data": [
    {
      "id": "9eaa0dfb-ebe6-4577-84d3-ddac069d21fd",
      "type": "assets",
      "attributes": {
        "created_at": "2023-02-28T08:10:29+00:00",
        "updated_at": "2023-02-28T08:10:29+00:00",
        "key": "templates/index.json",
        "custom": false,
        "checksum": "74b5b91c79f3099a43573f152554e8d82d55efe4039fe9c2d67246950750f61e",
        "content_type": "application/json",
        "value": "{ \"name\": \"index\" }",
        "published_at": "2023-02-21T08:10:29+00:00",
        "theme_id": "d2f4d55a-7bde-41a6-b529-3126d047e2f2",
        "file": {
          "url": null
        }
      },
      "relationships": {
        "theme": {
          "links": {
            "related": "api/boomerang/themes/d2f4d55a-7bde-41a6-b529-3126d047e2f2"
          }
        }
      }
    }
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "key": "templates/index.json",
          "value": "{ \"name\": \"index\" }",
          "theme_id": "e03c36ea-dfde-4844-ba11-4c9df28fbd8a"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "4bf51c48-c1a0-41a0-925c-a64cebce0e42",
    "type": "assets",
    "attributes": {
      "created_at": "2023-02-28T08:10:30+00:00",
      "updated_at": "2023-02-28T08:10:30+00:00",
      "key": "templates/index.json",
      "custom": false,
      "checksum": "74b5b91c79f3099a43573f152554e8d82d55efe4039fe9c2d67246950750f61e",
      "content_type": "application/json",
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          ...
          "theme_id": "5c919e50-ca65-48aa-a43e-0d3ec7fc5500",
...
```json
  {
  "data": {
    "id": "87ba27d9-4006-4f17-a2cd-365f5132fbf2",
    "type": "assets",
    "attributes": {
      "created_at": "2023-02-28T08:10:30+00:00",
      "updated_at": "2023-02-28T08:10:30+00:00",
      ...
      "theme_id": "5c919e50-ca65-48aa-a43e-0d3ec7fc5500",
      "file": {
        "url": "/assets/5c919e50-ca65-48aa-a43e-0d3ec7fc5500/image-d6c8d6c485714758ae033483d6773831e27bd7393c141bb73e8e96c14f35e1ad.png"
      }
    },
    "relationships": {
      "theme": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/assets/7bf6a2ab-8ab9-4dec-b6df-5ecad1e7555d' \
    --header 'content-type: application/json' \
```
