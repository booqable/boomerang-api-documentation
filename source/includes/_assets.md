...
```json
  ...
  "data": [
    {
      "id": "86de814b-4045-4107-8dd9-dfacb75fd433",
      "type": "assets",
      "attributes": {
        "created_at": "2022-05-24T07:45:00+00:00",
        "updated_at": "2022-05-24T07:45:00+00:00",
        "key": "templates/index.json",
        "checksum": "74b5b91c79f3099a43573f152554e8d82d55efe4039fe9c2d67246950750f61e",
        "content_type": "application/json",
        "value": "{ \"name\": \"index\" }",
        "published_at": "2022-05-17T07:45:00+00:00",
        "theme_id": "d76111b4-38f8-4764-b61f-e74c6a010124",
        "file": {
          "url": null
        }
      },
      "relationships": {
        "theme": {
          "links": {
            "related": "api/boomerang/themes/d76111b4-38f8-4764-b61f-e74c6a010124"
          }
        }
      }
    }
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "key": "templates/index.json",
          "value": "{ \"name\": \"index\" }",
          "theme_id": "eb675673-a73c-473a-8438-da2b4a01e42e"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "7a9ed40a-e591-4bd3-bd0e-639ef094ee94",
    "type": "assets",
    "attributes": {
      "created_at": "2022-05-24T07:45:01+00:00",
      "updated_at": "2022-05-24T07:45:01+00:00",
      "key": "templates/index.json",
      "checksum": "74b5b91c79f3099a43573f152554e8d82d55efe4039fe9c2d67246950750f61e",
      "content_type": "application/json",
      "value": "{ \"name\": \"index\" }",
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          ...
          "theme_id": "80c93e8f-8157-4820-bd4e-49a336fa4fe1",
...
```json
  {
  "data": {
    "id": "c582bd51-e338-41e8-a332-afef724d3e78",
    "type": "assets",
    "attributes": {
      "created_at": "2022-05-24T07:45:01+00:00",
      "updated_at": "2022-05-24T07:45:01+00:00",
      ...
      "theme_id": "80c93e8f-8157-4820-bd4e-49a336fa4fe1",
      "file": {
        "url": "/assets/80c93e8f-8157-4820-bd4e-49a336fa4fe1/image-d6c8d6c485714758ae033483d6773831e27bd7393c141bb73e8e96c14f35e1ad.png"
      }
    },
    "relationships": {
      "theme": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/assets/da5c99f4-2ae3-4873-b368-f059e542c71b' \
    --header 'content-type: application/json' \
```
