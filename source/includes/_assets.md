...
```json
  ...
  "data": [
    {
      "id": "e310c197-0e48-495d-8615-24b5313cce8f",
      "type": "assets",
      "attributes": {
        "created_at": "2023-01-19T10:45:16+00:00",
        "updated_at": "2023-01-19T10:45:16+00:00",
        "key": "templates/index.json",
        "custom": false,
        "checksum": "74b5b91c79f3099a43573f152554e8d82d55efe4039fe9c2d67246950750f61e",
        "content_type": "application/json",
        "value": "{ \"name\": \"index\" }",
        "published_at": "2023-01-12T10:45:16+00:00",
        "theme_id": "bc982964-56dc-4a0e-8cd2-142a3967f3e7",
        "file": {
          "url": null
        }
      },
      "relationships": {
        "theme": {
          "links": {
            "related": "api/boomerang/themes/bc982964-56dc-4a0e-8cd2-142a3967f3e7"
          }
        }
      }
    }
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "key": "templates/index.json",
          "value": "{ \"name\": \"index\" }",
          "theme_id": "f9b1c8a5-b051-49e4-aee3-432c7465d553"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "227d5c6b-635e-4bf6-b632-b55d47a9360d",
    "type": "assets",
    "attributes": {
      "created_at": "2023-01-19T10:45:17+00:00",
      "updated_at": "2023-01-19T10:45:17+00:00",
      "key": "templates/index.json",
      "custom": false,
      "checksum": "74b5b91c79f3099a43573f152554e8d82d55efe4039fe9c2d67246950750f61e",
      "content_type": "application/json",
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          ...
          "theme_id": "9ecb2237-684d-46bb-a5ad-3bcdf53783e2",
...
```json
  {
  "data": {
    "id": "638271fa-37f0-4449-9cd9-628761a90a5e",
    "type": "assets",
    "attributes": {
      "created_at": "2023-01-19T10:45:17+00:00",
      "updated_at": "2023-01-19T10:45:17+00:00",
      ...
      "theme_id": "9ecb2237-684d-46bb-a5ad-3bcdf53783e2",
      "file": {
        "url": "/assets/9ecb2237-684d-46bb-a5ad-3bcdf53783e2/image-d6c8d6c485714758ae033483d6773831e27bd7393c141bb73e8e96c14f35e1ad.png"
      }
    },
    "relationships": {
      "theme": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/assets/b4f8fbb7-90e2-4641-9bd8-62e73f3f51da' \
    --header 'content-type: application/json' \
```
