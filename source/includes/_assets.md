...
`content_type` | **string** `readonly`<br>The MIME representation of the content, consisting of the type and subtype of the asset. 
...
```json
  {
    "data": {
      "id": "02171fc0-e20d-4bbf-8c18-6fc6ee3136c7",
      "type": "assets",
      "attributes": {
        "created_at": "2016-02-10T12:38:01.000000+00:00",
