...
```json
  ...
  "data": [
    {
      "id": "15eb4ab7-de29-479f-90b5-6e820a132767",
      "type": "assets",
      "attributes": {
        "created_at": "2023-02-08T14:58:07+00:00",
        "updated_at": "2023-02-08T14:58:07+00:00",
        "key": "templates/index.json",
        "custom": false,
        "checksum": "74b5b91c79f3099a43573f152554e8d82d55efe4039fe9c2d67246950750f61e",
        "content_type": "application/json",
        "value": "{ \"name\": \"index\" }",
        "published_at": "2023-02-01T14:58:07+00:00",
        "theme_id": "d9088c83-282d-4320-8cd7-797574408d3f",
        "file": {
          "url": null
        }
      },
      "relationships": {
        "theme": {
          "links": {
            "related": "api/boomerang/themes/d9088c83-282d-4320-8cd7-797574408d3f"
          }
        }
      }
    }
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "key": "templates/index.json",
          "value": "{ \"name\": \"index\" }",
          "theme_id": "0a9c112b-5836-45b9-ad15-1fcd4969efc2"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "32ced65c-bb96-434a-9c5a-2037081d847b",
    "type": "assets",
    "attributes": {
      "created_at": "2023-02-08T14:58:07+00:00",
      "updated_at": "2023-02-08T14:58:07+00:00",
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          ...
          "theme_id": "9be3e06e-70ef-42a5-b78a-1fc53b4a3dd1",
...
```json
  {
  "data": {
    "id": "2079e807-50b0-4b0f-ac1c-0b13414bf6e6",
    "type": "assets",
    "attributes": {
      "created_at": "2023-02-08T14:58:08+00:00",
      "updated_at": "2023-02-08T14:58:08+00:00",
      "key": "assets/image.png",
      "custom": false,
      ...
      "theme_id": "9be3e06e-70ef-42a5-b78a-1fc53b4a3dd1",
      "file": {
        "url": "/assets/9be3e06e-70ef-42a5-b78a-1fc53b4a3dd1/image-d6c8d6c485714758ae033483d6773831e27bd7393c141bb73e8e96c14f35e1ad.png"
      }
    },
    "relationships": {
      "theme": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/assets/8ed9d7c1-6ee6-4407-9f55-07e7750ee5a4' \
    --header 'content-type: application/json' \
```
