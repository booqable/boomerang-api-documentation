...
```json
  ...
  "data": [
    {
      "id": "3cea9bf6-35f4-41d0-a1fb-29f05aca1e48",
      "type": "assets",
      "attributes": {
        "created_at": "2022-07-14T10:33:24+00:00",
        "updated_at": "2022-07-14T10:33:24+00:00",
        "key": "templates/index.json",
        "checksum": "74b5b91c79f3099a43573f152554e8d82d55efe4039fe9c2d67246950750f61e",
        "content_type": "application/json",
        "value": "{ \"name\": \"index\" }",
        "published_at": "2022-07-07T10:33:24+00:00",
        "theme_id": "2259a504-770b-4528-bf77-392c15dc739e",
        "file": {
          "url": null
        }
      },
      "relationships": {
        "theme": {
          "links": {
            "related": "api/boomerang/themes/2259a504-770b-4528-bf77-392c15dc739e"
          }
        }
      }
    }
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "key": "templates/index.json",
          "value": "{ \"name\": \"index\" }",
          "theme_id": "b3ff9b0d-8a31-499e-92f0-05ee12536469"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "80e164f2-3e3c-478b-b29c-faa77ae40700",
    "type": "assets",
    "attributes": {
      "created_at": "2022-07-14T10:33:25+00:00",
      "updated_at": "2022-07-14T10:33:25+00:00",
      "key": "templates/index.json",
      "checksum": "74b5b91c79f3099a43573f152554e8d82d55efe4039fe9c2d67246950750f61e",
      "content_type": "application/json",
      "value": "{ \"name\": \"index\" }",
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          ...
          "theme_id": "f4457b73-3116-4d9b-93a1-a4ca1d399aed",
...
```json
  {
  "data": {
    "id": "2e4d2f31-d66b-44e4-bf52-954b99b3d43c",
    "type": "assets",
    "attributes": {
      "created_at": "2022-07-14T10:33:26+00:00",
      "updated_at": "2022-07-14T10:33:26+00:00",
      "key": "assets/image.png",
      ...
      "theme_id": "f4457b73-3116-4d9b-93a1-a4ca1d399aed",
      "file": {
        "url": "/assets/f4457b73-3116-4d9b-93a1-a4ca1d399aed/image-d6c8d6c485714758ae033483d6773831e27bd7393c141bb73e8e96c14f35e1ad.png"
      }
    },
    "relationships": {
      "theme": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/assets/b9a29dca-d1c9-4202-aa99-0488e933ecf4' \
    --header 'content-type: application/json' \
```
