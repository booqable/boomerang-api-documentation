...
```json
  ...
  "data": [
    {
      "id": "ac5efd8b-9cc8-46bf-8335-c9edbb387511",
      "type": "assets",
      "attributes": {
        "created_at": "2022-09-16T09:00:44+00:00",
        "updated_at": "2022-09-16T09:00:44+00:00",
        "key": "templates/index.json",
        "custom": false,
        "checksum": "74b5b91c79f3099a43573f152554e8d82d55efe4039fe9c2d67246950750f61e",
        "content_type": "application/json",
        "value": "{ \"name\": \"index\" }",
        "published_at": "2022-09-09T09:00:44+00:00",
        "theme_id": "96158fec-7eea-4ffe-8133-33b62dafce9b",
        "file": {
          "url": null
        }
      },
      "relationships": {
        "theme": {
          "links": {
            "related": "api/boomerang/themes/96158fec-7eea-4ffe-8133-33b62dafce9b"
          }
        }
      }
    }
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "key": "templates/index.json",
          "value": "{ \"name\": \"index\" }",
          "theme_id": "c9912798-742c-4a4e-a86d-26906552f170"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "df739851-5b0f-4373-9d54-de5c24834d37",
    "type": "assets",
    "attributes": {
      "created_at": "2022-09-16T09:00:46+00:00",
      "updated_at": "2022-09-16T09:00:46+00:00",
      "key": "templates/index.json",
      "custom": false,
      "checksum": "74b5b91c79f3099a43573f152554e8d82d55efe4039fe9c2d67246950750f61e",
      "content_type": "application/json",
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          ...
          "theme_id": "a505fbe6-6a20-438b-b48a-612a2b0709ef",
...
```json
  {
  "data": {
    "id": "ecdeb0bb-79e0-47d1-a52b-5fdeac6d10b7",
    "type": "assets",
    "attributes": {
      "created_at": "2022-09-16T09:00:46+00:00",
      "updated_at": "2022-09-16T09:00:46+00:00",
      ...
      "theme_id": "a505fbe6-6a20-438b-b48a-612a2b0709ef",
      "file": {
        "url": "/assets/a505fbe6-6a20-438b-b48a-612a2b0709ef/image-d6c8d6c485714758ae033483d6773831e27bd7393c141bb73e8e96c14f35e1ad.png"
      }
    },
    "relationships": {
      "theme": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/assets/5a67662e-b4cd-4c23-9b4f-f6e411d25731' \
    --header 'content-type: application/json' \
```
