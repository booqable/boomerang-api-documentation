...
```json
  ...
  "data": [
    {
      "id": "76a7fa8d-3456-4818-96ef-efc06549f8b8",
      "type": "assets",
      "attributes": {
        "created_at": "2023-02-08T09:43:55+00:00",
        "updated_at": "2023-02-08T09:43:55+00:00",
        "key": "templates/index.json",
        "custom": false,
        "checksum": "74b5b91c79f3099a43573f152554e8d82d55efe4039fe9c2d67246950750f61e",
        "content_type": "application/json",
        "value": "{ \"name\": \"index\" }",
        "published_at": "2023-02-01T09:43:55+00:00",
        "theme_id": "91b861fd-ef55-453b-b9b1-ac11ab149de4",
        "file": {
          "url": null
        }
      },
      "relationships": {
        "theme": {
          "links": {
            "related": "api/boomerang/themes/91b861fd-ef55-453b-b9b1-ac11ab149de4"
          }
        }
      }
    }
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          "key": "templates/index.json",
          "value": "{ \"name\": \"index\" }",
          "theme_id": "a5ee1b94-aebf-48e2-84b9-ba3cd5096c3d"
        }
      }
    }'
```
...
```json
  {
  "data": {
    "id": "ee47a70a-a776-404d-b646-5a781b012ea1",
    "type": "assets",
    "attributes": {
      "created_at": "2023-02-08T09:43:56+00:00",
      "updated_at": "2023-02-08T09:43:56+00:00",
      "key": "templates/index.json",
      "custom": false,
      "checksum": "74b5b91c79f3099a43573f152554e8d82d55efe4039fe9c2d67246950750f61e",
      "content_type": "application/json",
    ...
    --data '{
      "data": {
        ...
        "attributes": {
          ...
          "theme_id": "90e96ddd-c809-4b6f-9762-e8e50ffb635b",
...
```json
  {
  "data": {
    "id": "8e262d78-2b51-4b60-b13d-fdeab8ace2bf",
    "type": "assets",
    "attributes": {
      "created_at": "2023-02-08T09:43:56+00:00",
      "updated_at": "2023-02-08T09:43:56+00:00",
      ...
      "theme_id": "90e96ddd-c809-4b6f-9762-e8e50ffb635b",
      "file": {
        "url": "/assets/90e96ddd-c809-4b6f-9762-e8e50ffb635b/image-d6c8d6c485714758ae033483d6773831e27bd7393c141bb73e8e96c14f35e1ad.png"
      }
    },
    "relationships": {
      "theme": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/assets/d3111020-8715-4b9e-9aff-8dd1ce4a4eae' \
    --header 'content-type: application/json' \
```
