...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/report_stock_items?filter%5Bfrom%5D=2023-02-03+00%3A00%3A00+UTC&filter%5Btill%5D=2023-02-08+23%3A59%3A59+UTC' \
...
```json
  ...
  "data": [
    {
      "id": "virtual-20495212-687a-58b3-8318-6cb0a4f75319",
      "type": "report_stock_items",
      "attributes": {
        "created_at": "2023-02-08T15:02:26+00:00",
        ...
        "rented_count": 1,
        "turnover_in_cents": 0,
        "stock_item_id": "2340a128-7642-4257-96c8-3aff546b952b",
        "product_id": "967a50ab-2c4f-4187-b426-41d0a70bf8f6",
        "location_id": null
      },
      "relationships": {
        "stock_item": {
        ...
        "product": {
          "links": {
            "related": "api/boomerang/products/967a50ab-2c4f-4187-b426-41d0a70bf8f6"
          }
        },
        "location": {
          "links": {
    ...
    {
      "id": "virtual-cb910724-b60e-5d73-a7ae-467e6ca979a6",
      "type": "report_stock_items",
      "attributes": {
        "created_at": "2023-02-08T15:02:26+00:00",
        "product_name": "Product 55",
        ...
        "rented_count": 0,
        "turnover_in_cents": 0,
        "stock_item_id": "89f029a0-58ff-4354-980a-dc883686dd0c",
        "product_id": "967a50ab-2c4f-4187-b426-41d0a70bf8f6",
        "location_id": null
      },
      "relationships": {
