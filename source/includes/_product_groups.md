...
```json
  ...
  "data": [
    {
      "id": "fa530b58-9505-4d19-bc43-b04631c451be",
      "type": "product_groups",
      "attributes": {
        "created_at": "2023-02-03T11:12:46+00:00",
        "updated_at": "2023-02-03T11:12:46+00:00",
        "archived": false,
        "archived_at": null,
        "type": "product_groups",
        "name": "iPad Pro",
      ...
      "relationships": {
        ...
        "products": {
          "links": {
            "related": "api/boomerang/products?filter[product_group_id]=fa530b58-9505-4d19-bc43-b04631c451be"
          }
        },
        "tax_category": {
          "links": {
        ...
        "properties": {
          "links": {
            "related": "api/boomerang/properties?filter[owner_id]=fa530b58-9505-4d19-bc43-b04631c451be&filter[owner_type]=product_groups"
          }
        }
      }
    }
...
```json
  ...
  "data": [
    {
      "id": "10aa8888-ff86-46d1-a912-cc12d55c17ea"
    },
    {
      "id": "4800350d-f74a-49ba-94be-04d49ea1f094"
    },
    {
      "id": "a7c4ae2b-080c-4842-9ac0-a4e82bd75cec"
    }
  ]
}
```
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/product_groups/8f4377fc-61ec-426d-b512-4b3dd1a80644' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "8f4377fc-61ec-426d-b512-4b3dd1a80644",
    "type": "product_groups",
    "attributes": {
      "created_at": "2023-02-03T11:12:49+00:00",
      "updated_at": "2023-02-03T11:12:49+00:00",
      "archived": false,
      "archived_at": null,
      "type": "product_groups",
      "name": "iPad Pro",
    ...
    "relationships": {
      ...
      "products": {
        "links": {
          "related": "api/boomerang/products?filter[product_group_id]=8f4377fc-61ec-426d-b512-4b3dd1a80644"
        }
      },
      "tax_category": {
        "links": {
      ...
      "properties": {
        "links": {
          "related": "api/boomerang/properties?filter[owner_id]=8f4377fc-61ec-426d-b512-4b3dd1a80644&filter[owner_type]=product_groups"
        }
      }
    }
  },
...
```json
  {
  "data": {
    "id": "efd45755-c6c0-4de1-81e0-0963cffdafac",
    "type": "product_groups",
    "attributes": {
      "created_at": "2023-02-03T11:12:49+00:00",
      "updated_at": "2023-02-03T11:12:49+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/product_groups/108a63f1-caa9-40f7-8198-640df4f24ac8' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "108a63f1-caa9-40f7-8198-640df4f24ac8",
        "type": "product_groups",
        "attributes": {
          "name": "iPad mini"
        }
...
```json
  ...
  "data": {
    ...
    "type": "product_groups",
    "attributes": {
      "created_at": "2023-02-03T11:12:50+00:00",
      "updated_at": "2023-02-03T11:12:50+00:00",
      "archived": false,
      "archived_at": null,
      "type": "product_groups",
      "name": "iPad mini",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/product_groups/64f8c374-0776-4707-9c51-2dc1d0aa4fbf' \
    --header 'content-type: application/json' \
    --data '{}'
```
