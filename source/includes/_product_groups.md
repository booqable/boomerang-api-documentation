...
```json
  ...
  "data": [
    {
      "id": "e179567b-bc93-452a-869d-ccd899681896",
      "type": "product_groups",
      "attributes": {
        "created_at": "2023-02-08T08:37:14+00:00",
        "updated_at": "2023-02-08T08:37:14+00:00",
        "archived": false,
        "archived_at": null,
        "type": "product_groups",
        "name": "iPad Pro",
      ...
      "relationships": {
        ...
        "products": {
          "links": {
            "related": "api/boomerang/products?filter[product_group_id]=e179567b-bc93-452a-869d-ccd899681896"
          }
        },
        "tax_category": {
          "links": {
        ...
        "properties": {
          "links": {
            "related": "api/boomerang/properties?filter[owner_id]=e179567b-bc93-452a-869d-ccd899681896&filter[owner_type]=product_groups"
          }
        }
      }
    }
...
```json
  ...
  "data": [
    {
      "id": "671faee5-5847-426f-879a-03718ab203ca"
    },
    {
      "id": "065b6cb4-811c-4dad-b97d-422088f6899f"
    },
    {
      "id": "81660e6f-7656-4d5d-8f21-06b1c3f34036"
    }
  ]
}
```
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/product_groups/9949571d-a94f-4798-b627-8a7a74a6d2b6' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "9949571d-a94f-4798-b627-8a7a74a6d2b6",
    "type": "product_groups",
    "attributes": {
      "created_at": "2023-02-08T08:37:17+00:00",
      "updated_at": "2023-02-08T08:37:17+00:00",
      "archived": false,
      "archived_at": null,
      "type": "product_groups",
      "name": "iPad Pro",
    ...
    "relationships": {
      ...
      "products": {
        "links": {
          "related": "api/boomerang/products?filter[product_group_id]=9949571d-a94f-4798-b627-8a7a74a6d2b6"
        }
      },
      "tax_category": {
        "links": {
      ...
      "properties": {
        "links": {
          "related": "api/boomerang/properties?filter[owner_id]=9949571d-a94f-4798-b627-8a7a74a6d2b6&filter[owner_type]=product_groups"
        }
      }
    }
  },
...
```json
  {
  "data": {
    "id": "97d4bb71-de9c-402c-86d3-114b747d493b",
    "type": "product_groups",
    "attributes": {
      "created_at": "2023-02-08T08:37:17+00:00",
      "updated_at": "2023-02-08T08:37:17+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/product_groups/f864acb8-aa7c-49c9-b1c0-6865438d5126' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "f864acb8-aa7c-49c9-b1c0-6865438d5126",
        "type": "product_groups",
        "attributes": {
          "name": "iPad mini"
        }
...
```json
  ...
  "data": {
    ...
    "type": "product_groups",
    "attributes": {
      "created_at": "2023-02-08T08:37:18+00:00",
      "updated_at": "2023-02-08T08:37:18+00:00",
      "archived": false,
      "archived_at": null,
      "type": "product_groups",
      "name": "iPad mini",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/product_groups/1e78193a-bd73-40ce-be60-5349aa078e53' \
    --header 'content-type: application/json' \
    --data '{}'
```
