...
```json
  ...
  "data": [
    {
      "id": "95b89a76-e944-44ac-a0d7-5bfa312eb382",
      "type": "product_groups",
      "attributes": {
        "created_at": "2023-02-07T09:29:51+00:00",
        "updated_at": "2023-02-07T09:29:51+00:00",
        "archived": false,
        "archived_at": null,
        "type": "product_groups",
        "name": "iPad Pro",
      ...
      "relationships": {
        ...
        "products": {
          "links": {
            "related": "api/boomerang/products?filter[product_group_id]=95b89a76-e944-44ac-a0d7-5bfa312eb382"
          }
        },
        "tax_category": {
          "links": {
        ...
        "properties": {
          "links": {
            "related": "api/boomerang/properties?filter[owner_id]=95b89a76-e944-44ac-a0d7-5bfa312eb382&filter[owner_type]=product_groups"
          }
        }
      }
    }
...
```json
  ...
  "data": [
    {
      "id": "63800c19-ef1e-4e7e-84b7-da03ac727a2d"
    },
    {
      "id": "bf8cb8dc-92aa-43c1-987d-2e8097ad48ba"
    },
    {
      "id": "0721e5b2-1473-44ca-9883-6098dd0ad08d"
    }
  ]
}
```
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/product_groups/93d48d58-ae4c-4df6-a0a3-c3aa255e8b04' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "93d48d58-ae4c-4df6-a0a3-c3aa255e8b04",
    "type": "product_groups",
    "attributes": {
      "created_at": "2023-02-07T09:29:54+00:00",
      "updated_at": "2023-02-07T09:29:54+00:00",
      "archived": false,
      "archived_at": null,
      "type": "product_groups",
      "name": "iPad Pro",
    ...
    "relationships": {
      ...
      "products": {
        "links": {
          "related": "api/boomerang/products?filter[product_group_id]=93d48d58-ae4c-4df6-a0a3-c3aa255e8b04"
        }
      },
      "tax_category": {
        "links": {
      ...
      "properties": {
        "links": {
          "related": "api/boomerang/properties?filter[owner_id]=93d48d58-ae4c-4df6-a0a3-c3aa255e8b04&filter[owner_type]=product_groups"
        }
      }
    }
  },
...
```json
  {
  "data": {
    "id": "69ae1be4-2889-45e3-9edc-7e1e9c658da2",
    "type": "product_groups",
    "attributes": {
      "created_at": "2023-02-07T09:29:54+00:00",
      "updated_at": "2023-02-07T09:29:54+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/product_groups/56c316f8-92fa-4876-8d7c-db47f3836dc3' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "56c316f8-92fa-4876-8d7c-db47f3836dc3",
        "type": "product_groups",
        "attributes": {
          "name": "iPad mini"
        }
...
```json
  ...
  "data": {
    ...
    "type": "product_groups",
    "attributes": {
      "created_at": "2023-02-07T09:29:55+00:00",
      "updated_at": "2023-02-07T09:29:55+00:00",
      "archived": false,
      "archived_at": null,
      "type": "product_groups",
      "name": "iPad mini",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/product_groups/982b63a8-6601-4885-b733-31a012919342' \
    --header 'content-type: application/json' \
    --data '{}'
```
