...
```json
  ...
  "data": [
    {
      "id": "43c5f302-ef51-4198-8a0f-b4be3bed0671",
      "type": "product_groups",
      "attributes": {
        "created_at": "2023-02-08T09:21:09+00:00",
        "updated_at": "2023-02-08T09:21:09+00:00",
        "archived": false,
        "archived_at": null,
        "type": "product_groups",
        "name": "iPad Pro",
      ...
      "relationships": {
        ...
        "products": {
          "links": {
            "related": "api/boomerang/products?filter[product_group_id]=43c5f302-ef51-4198-8a0f-b4be3bed0671"
          }
        },
        "tax_category": {
          "links": {
        ...
        "properties": {
          "links": {
            "related": "api/boomerang/properties?filter[owner_id]=43c5f302-ef51-4198-8a0f-b4be3bed0671&filter[owner_type]=product_groups"
          }
        }
      }
    }
...
```json
  ...
  "data": [
    {
      "id": "0b68dc7c-f042-4806-8b30-3a4914056099"
    },
    {
      "id": "a4633238-b6cf-4f0a-a67c-f50433bfab31"
    },
    {
      "id": "68c957ba-1e4f-49c0-a7c9-fca481b477e6"
    }
  ]
}
```
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/product_groups/b8bb220f-0e7e-459c-a327-7da2727ebf25' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "b8bb220f-0e7e-459c-a327-7da2727ebf25",
    "type": "product_groups",
    "attributes": {
      "created_at": "2023-02-08T09:21:11+00:00",
      "updated_at": "2023-02-08T09:21:11+00:00",
      "archived": false,
      "archived_at": null,
      "type": "product_groups",
      "name": "iPad Pro",
    ...
    "relationships": {
      ...
      "products": {
        "links": {
          "related": "api/boomerang/products?filter[product_group_id]=b8bb220f-0e7e-459c-a327-7da2727ebf25"
        }
      },
      "tax_category": {
        "links": {
      ...
      "properties": {
        "links": {
          "related": "api/boomerang/properties?filter[owner_id]=b8bb220f-0e7e-459c-a327-7da2727ebf25&filter[owner_type]=product_groups"
        }
      }
    }
  },
...
```json
  {
  "data": {
    "id": "0f0c6004-2f14-4f8b-b252-49ab2408dbf3",
    "type": "product_groups",
    "attributes": {
      "created_at": "2023-02-08T09:21:12+00:00",
      "updated_at": "2023-02-08T09:21:12+00:00",
      "archived": false,
      "archived_at": null,
      "type": "product_groups",
      "name": "iPad mini",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/product_groups/f9d85b37-9c89-468e-97d4-7e43f5f2be75' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "f9d85b37-9c89-468e-97d4-7e43f5f2be75",
        "type": "product_groups",
        "attributes": {
          "name": "iPad mini"
        }
...
```json
  ...
  "data": {
    ...
    "type": "product_groups",
    "attributes": {
      "created_at": "2023-02-08T09:21:13+00:00",
      "updated_at": "2023-02-08T09:21:13+00:00",
      "archived": false,
      "archived_at": null,
      "type": "product_groups",
      "name": "iPad mini",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/product_groups/95a0c821-82ab-45ed-8a25-f535dfac3941' \
    --header 'content-type: application/json' \
    --data '{}'
```
