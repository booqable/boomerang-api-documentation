...
```json
  ...
  "data": [
    {
      "id": "ca77a8c7-57ec-4607-9dc5-5de46ccae6a0",
      "type": "product_groups",
      "attributes": {
        "created_at": "2023-02-09T10:21:37+00:00",
        "updated_at": "2023-02-09T10:21:37+00:00",
        "archived": false,
        "archived_at": null,
        "type": "product_groups",
        "name": "iPad Pro",
      ...
      "relationships": {
        ...
        "products": {
          "links": {
            "related": "api/boomerang/products?filter[product_group_id]=ca77a8c7-57ec-4607-9dc5-5de46ccae6a0"
          }
        },
        "tax_category": {
          "links": {
        ...
        "properties": {
          "links": {
            "related": "api/boomerang/properties?filter[owner_id]=ca77a8c7-57ec-4607-9dc5-5de46ccae6a0&filter[owner_type]=product_groups"
          }
        }
      }
    }
...
```json
  ...
  "data": [
    {
      "id": "64748eaf-3bb1-4d51-a799-c59f8feff9bb"
    },
    {
      "id": "d35491fa-963f-468c-b1b4-8b9c97d10b8e"
    },
    {
      "id": "a7ea7caa-6cde-4e05-baf8-fefb2e507570"
    }
  ]
}
```
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/product_groups/e2adc701-b68a-40e0-bcc5-d10270c9e876' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "e2adc701-b68a-40e0-bcc5-d10270c9e876",
    "type": "product_groups",
    "attributes": {
      "created_at": "2023-02-09T10:21:40+00:00",
      "updated_at": "2023-02-09T10:21:40+00:00",
      "archived": false,
      "archived_at": null,
      "type": "product_groups",
      "name": "iPad Pro",
    ...
    "relationships": {
      ...
      "products": {
        "links": {
          "related": "api/boomerang/products?filter[product_group_id]=e2adc701-b68a-40e0-bcc5-d10270c9e876"
        }
      },
      "tax_category": {
        "links": {
      ...
      "properties": {
        "links": {
          "related": "api/boomerang/properties?filter[owner_id]=e2adc701-b68a-40e0-bcc5-d10270c9e876&filter[owner_type]=product_groups"
        }
      }
    }
  },
...
```json
  {
  "data": {
    "id": "b6e37bc4-876a-4931-8ad7-3e3100abdd67",
    "type": "product_groups",
    "attributes": {
      "created_at": "2023-02-09T10:21:41+00:00",
      "updated_at": "2023-02-09T10:21:41+00:00",
      "archived": false,
      "archived_at": null,
      "type": "product_groups",
      "name": "iPad mini",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/product_groups/c8c2811b-3359-4ddc-a55a-d027fa916193' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "c8c2811b-3359-4ddc-a55a-d027fa916193",
        "type": "product_groups",
        "attributes": {
          "name": "iPad mini"
        }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/product_groups/03dcbd69-ddbe-4420-8744-423017888aed' \
    --header 'content-type: application/json' \
    --data '{}'
```
