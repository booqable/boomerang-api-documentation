...
```json
  ...
  "data": [
    {
      "id": "4ff5e6dd-d021-4b6e-bba6-3bbd179a2a8e",
      "type": "product_groups",
      "attributes": {
        "created_at": "2022-03-25T08:54:16+00:00",
        "updated_at": "2022-03-25T08:54:16+00:00",
        "archived": false,
        "archived_at": null,
        "type": "product_groups",
        "name": "iPad Pro",
      ...
      "relationships": {
        "categories": {
          "links": {
            "related": "api/boomerang/categories?filter[item_id]=4ff5e6dd-d021-4b6e-bba6-3bbd179a2a8e"
          }
        },
        "photo": {
          "links": {
        ...
        "products": {
          "links": {
            "related": "api/boomerang/products?filter[product_group_id]=4ff5e6dd-d021-4b6e-bba6-3bbd179a2a8e"
          }
        },
        "tax_category": {
          "links": {
        ...
        "properties": {
          "links": {
            "related": "api/boomerang/properties?filter[owner_id]=4ff5e6dd-d021-4b6e-bba6-3bbd179a2a8e&filter[owner_type]=product_groups"
          }
        }
      }
    }
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/product_groups/f9cda552-09d3-412b-b22c-36a5cce2e97a' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "f9cda552-09d3-412b-b22c-36a5cce2e97a",
    "type": "product_groups",
    "attributes": {
      "created_at": "2022-03-25T08:54:16+00:00",
      "updated_at": "2022-03-25T08:54:16+00:00",
    ...
    "relationships": {
      "categories": {
        "links": {
          "related": "api/boomerang/categories?filter[item_id]=f9cda552-09d3-412b-b22c-36a5cce2e97a"
        }
      },
      "photo": {
        "links": {
      ...
      "products": {
        "links": {
          "related": "api/boomerang/products?filter[product_group_id]=f9cda552-09d3-412b-b22c-36a5cce2e97a"
        }
      },
      "tax_category": {
        "links": {
      ...
      "properties": {
        "links": {
          "related": "api/boomerang/properties?filter[owner_id]=f9cda552-09d3-412b-b22c-36a5cce2e97a&filter[owner_type]=product_groups"
        }
      }
    }
  },
...
```json
  {
  "data": {
    "id": "dca6ee93-71da-4a5d-9386-a7632a35ce1c",
    "type": "product_groups",
    "attributes": {
      "created_at": "2022-03-25T08:54:17+00:00",
      "updated_at": "2022-03-25T08:54:17+00:00",
      "archived": false,
      "archived_at": null,
      "type": "product_groups",
      "name": "iPad mini",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/product_groups/3b7dedbe-468e-4bcf-a16f-a7631ec7107b' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "3b7dedbe-468e-4bcf-a16f-a7631ec7107b",
        "type": "product_groups",
        "attributes": {
          "name": "iPad mini"
        }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/product_groups/b2e1d9bd-6b6b-446c-afa5-bdfad4bf1345' \
    --header 'content-type: application/json' \
    --data '{}'
```
