...
```json
  ...
  "data": [
    {
      "id": "a5ccbace-c515-4f7d-bf5d-3895acda6fa0",
      "type": "product_groups",
      "attributes": {
        "created_at": "2023-02-02T14:30:35+00:00",
        "updated_at": "2023-02-02T14:30:35+00:00",
        "archived": false,
        "archived_at": null,
        "type": "product_groups",
        "name": "iPad Pro",
      ...
      "relationships": {
        ...
        "products": {
          "links": {
            "related": "api/boomerang/products?filter[product_group_id]=a5ccbace-c515-4f7d-bf5d-3895acda6fa0"
          }
        },
        "tax_category": {
          "links": {
        ...
        "properties": {
          "links": {
            "related": "api/boomerang/properties?filter[owner_id]=a5ccbace-c515-4f7d-bf5d-3895acda6fa0&filter[owner_type]=product_groups"
          }
        }
      }
    }
...
```json
  ...
  "data": [
    {
      "id": "ecdef195-998a-4863-b0b8-f9c836ddd3d4"
    },
    {
      "id": "4bf18135-f317-41f7-a3ee-89eab7173fce"
    },
    {
      "id": "152f713d-1e7f-40a9-9c14-7ad64e55d043"
    }
  ]
}
```
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/product_groups/76825076-77f9-4217-a0d7-f10ddf369a07' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "76825076-77f9-4217-a0d7-f10ddf369a07",
    "type": "product_groups",
    "attributes": {
      "created_at": "2023-02-02T14:30:39+00:00",
      "updated_at": "2023-02-02T14:30:39+00:00",
      "archived": false,
      "archived_at": null,
      "type": "product_groups",
      "name": "iPad Pro",
    ...
    "relationships": {
      ...
      "products": {
        "links": {
          "related": "api/boomerang/products?filter[product_group_id]=76825076-77f9-4217-a0d7-f10ddf369a07"
        }
      },
      "tax_category": {
        "links": {
      ...
      "properties": {
        "links": {
          "related": "api/boomerang/properties?filter[owner_id]=76825076-77f9-4217-a0d7-f10ddf369a07&filter[owner_type]=product_groups"
        }
      }
    }
  },
...
```json
  {
  "data": {
    "id": "c3e7cfee-3a2f-47fe-88cb-d522418eadf3",
    "type": "product_groups",
    "attributes": {
      "created_at": "2023-02-02T14:30:40+00:00",
      "updated_at": "2023-02-02T14:30:40+00:00",
      "archived": false,
      "archived_at": null,
      "type": "product_groups",
      "name": "iPad mini",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/product_groups/c8a5f527-e3f9-4324-b27e-b1e6b4a4c618' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "c8a5f527-e3f9-4324-b27e-b1e6b4a4c618",
        "type": "product_groups",
        "attributes": {
          "name": "iPad mini"
        }
...
```json
  ...
  "data": {
    ...
    "type": "product_groups",
    "attributes": {
      "created_at": "2023-02-02T14:30:41+00:00",
      "updated_at": "2023-02-02T14:30:41+00:00",
      "archived": false,
      "archived_at": null,
      "type": "product_groups",
      "name": "iPad mini",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/product_groups/76dd0c46-ac98-445a-95a4-5a84e86a7ebd' \
    --header 'content-type: application/json' \
    --data '{}'
```
