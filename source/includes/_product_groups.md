...
```json
  ...
  "data": [
    {
      "id": "3d093b30-2b3e-421f-98e8-b4a3f77ba83d",
      "type": "product_groups",
      "attributes": {
      ...
      "relationships": {
        ...
        "products": {
          "links": {
            "related": "api/boomerang/products?filter[product_group_id]=3d093b30-2b3e-421f-98e8-b4a3f77ba83d"
          }
        },
        "tax_category": {
          "links": {
        ...
        "properties": {
          "links": {
            "related": "api/boomerang/properties?filter[owner_id]=3d093b30-2b3e-421f-98e8-b4a3f77ba83d&filter[owner_type]=product_groups"
          }
        }
      }
    }
...
```json
  ...
  "data": [
    {
      "id": "179d1285-b0c8-48ad-ad62-48a6c12267b8"
    },
    {
      "id": "ed6ec707-437a-4612-bae4-3fe476ba577f"
    },
    {
      "id": "d1bc5939-839f-4ceb-9189-0a6e6a3162eb"
    }
  ]
}
```
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/product_groups/7e0b6a73-bbaf-41c9-8282-44682647b043' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "7e0b6a73-bbaf-41c9-8282-44682647b043",
    "type": "product_groups",
    "attributes": {
    ...
    "relationships": {
      ...
      "products": {
        "links": {
          "related": "api/boomerang/products?filter[product_group_id]=7e0b6a73-bbaf-41c9-8282-44682647b043"
        }
      },
      "tax_category": {
        "links": {
      ...
      "properties": {
        "links": {
          "related": "api/boomerang/properties?filter[owner_id]=7e0b6a73-bbaf-41c9-8282-44682647b043&filter[owner_type]=product_groups"
        }
      }
    }
  },
...
```json
  {
  "data": {
    "id": "544b9fd3-bf44-4e93-b035-fb663b7ea5c3",
    "type": "product_groups",
    "attributes": {
      "created_at": "2023-02-08T15:01:59+00:00",
      "updated_at": "2023-02-08T15:01:59+00:00",
      "archived": false,
      "archived_at": null,
      "type": "product_groups",
      "name": "iPad mini",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/product_groups/cb1f0e6e-72ac-4837-9654-4a6bed959a99' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "cb1f0e6e-72ac-4837-9654-4a6bed959a99",
        "type": "product_groups",
        "attributes": {
          "name": "iPad mini"
        }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/product_groups/d55db030-6776-4ddb-9144-ac1ae9f17d5d' \
    --header 'content-type: application/json' \
    --data '{}'
```
