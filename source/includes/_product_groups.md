...
```json
  ...
  "data": [
    {
      "id": "d99b365b-e78b-40d3-9506-a4d5b7d425d9",
      "type": "product_groups",
      "attributes": {
        "created_at": "2023-02-13T12:16:23+00:00",
        "updated_at": "2023-02-13T12:16:23+00:00",
        "archived": false,
        "archived_at": null,
        "type": "product_groups",
        "name": "iPad Pro",
      ...
      "relationships": {
        ...
        "inventory_levels": {
          "links": {
            "related": "api/boomerang/inventory_levels?filter[item_id]=d99b365b-e78b-40d3-9506-a4d5b7d425d9"
          }
        },
        "properties": {
          "links": {
            "related": "api/boomerang/properties?filter[owner_id]=d99b365b-e78b-40d3-9506-a4d5b7d425d9&filter[owner_type]=product_groups"
          }
        },
        "products": {
          "links": {
            "related": "api/boomerang/products?filter[product_group_id]=d99b365b-e78b-40d3-9506-a4d5b7d425d9"
          }
        }
      }
    }
...
```json
  ...
  "data": [
    {
      "id": "923928c6-956c-4112-87c8-fc5ec271a0df"
    },
    {
      "id": "3d901430-f2d9-4b78-b7c5-6c7d207f5b0d"
    },
    {
      "id": "c8f4501d-4e6d-4ecf-a9d0-a27b1058c91d"
    }
  ]
}
```
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/product_groups/d8abb014-48e9-460a-b369-9a77e0a74d96' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "d8abb014-48e9-460a-b369-9a77e0a74d96",
    "type": "product_groups",
    "attributes": {
      "created_at": "2023-02-13T12:16:25+00:00",
      "updated_at": "2023-02-13T12:16:25+00:00",
      "archived": false,
      "archived_at": null,
      "type": "product_groups",
      "name": "iPad Pro",
    ...
    "relationships": {
      ...
      "inventory_levels": {
        "links": {
          "related": "api/boomerang/inventory_levels?filter[item_id]=d8abb014-48e9-460a-b369-9a77e0a74d96"
        }
      },
      "properties": {
        "links": {
          "related": "api/boomerang/properties?filter[owner_id]=d8abb014-48e9-460a-b369-9a77e0a74d96&filter[owner_type]=product_groups"
        }
      },
      "products": {
        "links": {
          "related": "api/boomerang/products?filter[product_group_id]=d8abb014-48e9-460a-b369-9a77e0a74d96"
        }
      }
    }
  },
...
```json
  {
  "data": {
    "id": "ac251b16-9809-40a8-9f4c-6c0839734a97",
    "type": "product_groups",
    "attributes": {
      "created_at": "2023-02-13T12:16:26+00:00",
      "updated_at": "2023-02-13T12:16:26+00:00",
      "archived": false,
      "archived_at": null,
      "type": "product_groups",
      "name": "iPad mini",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/product_groups/04826505-b7d5-457b-bc0e-4a08d9a1d225' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "04826505-b7d5-457b-bc0e-4a08d9a1d225",
        "type": "product_groups",
        "attributes": {
          "name": "iPad mini"
        }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/product_groups/3c4fd48f-52b6-4000-baed-4f991ddf24e4' \
    --header 'content-type: application/json' \
    --data '{}'
```
