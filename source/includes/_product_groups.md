...
```json
  ...
  "data": [
    {
      "id": "bd64832b-727c-40ff-903c-1b8960612149",
      "type": "product_groups",
      "attributes": {
        "created_at": "2023-02-09T09:30:53+00:00",
        "updated_at": "2023-02-09T09:30:53+00:00",
        "archived": false,
        "archived_at": null,
        "type": "product_groups",
        "name": "iPad Pro",
      ...
      "relationships": {
        ...
        "products": {
          "links": {
            "related": "api/boomerang/products?filter[product_group_id]=bd64832b-727c-40ff-903c-1b8960612149"
          }
        },
        "tax_category": {
          "links": {
        ...
        "properties": {
          "links": {
            "related": "api/boomerang/properties?filter[owner_id]=bd64832b-727c-40ff-903c-1b8960612149&filter[owner_type]=product_groups"
          }
        }
      }
    }
...
```json
  ...
  "data": [
    {
      "id": "5b8f66fd-5f2a-4c2f-b098-23aa523928c2"
    },
    {
      "id": "67d0212e-9d55-4f85-ae40-c0bfb33dc98f"
    },
    {
      "id": "ddb2812b-4cd5-4bd6-9b03-da4ca6357624"
    }
  ]
}
```
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/product_groups/c390e627-83b0-45b7-be8f-11938037d385' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "c390e627-83b0-45b7-be8f-11938037d385",
    "type": "product_groups",
    "attributes": {
      "created_at": "2023-02-09T09:30:56+00:00",
      "updated_at": "2023-02-09T09:30:56+00:00",
      "archived": false,
      "archived_at": null,
      "type": "product_groups",
      "name": "iPad Pro",
    ...
    "relationships": {
      ...
      "products": {
        "links": {
          "related": "api/boomerang/products?filter[product_group_id]=c390e627-83b0-45b7-be8f-11938037d385"
        }
      },
      "tax_category": {
        "links": {
      ...
      "properties": {
        "links": {
          "related": "api/boomerang/properties?filter[owner_id]=c390e627-83b0-45b7-be8f-11938037d385&filter[owner_type]=product_groups"
        }
      }
    }
  },
...
```json
  {
  "data": {
    "id": "b83b2a44-cd9e-46ca-bfb5-bf53f0e6bdcd",
    "type": "product_groups",
    "attributes": {
      "created_at": "2023-02-09T09:30:57+00:00",
      "updated_at": "2023-02-09T09:30:57+00:00",
      "archived": false,
      "archived_at": null,
      "type": "product_groups",
      "name": "iPad mini",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/product_groups/3978bcdc-919a-4fd0-ada5-c51e05bbaae7' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "3978bcdc-919a-4fd0-ada5-c51e05bbaae7",
        "type": "product_groups",
        "attributes": {
          "name": "iPad mini"
        }
...
```json
  ...
  "data": {
    ...
    "type": "product_groups",
    "attributes": {
      "created_at": "2023-02-09T09:30:58+00:00",
      "updated_at": "2023-02-09T09:30:58+00:00",
      "archived": false,
      "archived_at": null,
      "type": "product_groups",
      "name": "iPad mini",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/product_groups/49ecdff3-e9e5-4bd2-a1f7-398e9fa1563f' \
    --header 'content-type: application/json' \
    --data '{}'
```
