...
```json
  ...
  "data": [
    {
      "id": "d55097c1-5ada-4abd-be58-71e7f372b9f8",
      "type": "product_groups",
      "attributes": {
        "created_at": "2022-09-16T09:04:14+00:00",
        "updated_at": "2022-09-16T09:04:14+00:00",
        "archived": false,
        "archived_at": null,
        "type": "product_groups",
        "name": "iPad Pro",
      ...
      "relationships": {
        ...
        "products": {
          "links": {
            "related": "api/boomerang/products?filter[product_group_id]=d55097c1-5ada-4abd-be58-71e7f372b9f8"
          }
        },
        "tax_category": {
          "links": {
        ...
        "properties": {
          "links": {
            "related": "api/boomerang/properties?filter[owner_id]=d55097c1-5ada-4abd-be58-71e7f372b9f8&filter[owner_type]=product_groups"
          }
        }
      }
    }
...
```json
  ...
  "data": [
    {
      "id": "91248e83-95fd-4c7a-882e-83db35fb4a68"
    },
    {
      "id": "cab99eb5-feac-4735-b6b7-38f28217e83b"
    },
    {
      "id": "7c410816-d77d-4647-a9d8-d70fbce66d48"
    }
  ]
}
```
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/product_groups/bc867ade-795a-461e-b3c7-317b2b5ab36b' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "bc867ade-795a-461e-b3c7-317b2b5ab36b",
    "type": "product_groups",
    "attributes": {
      "created_at": "2022-09-16T09:04:17+00:00",
      "updated_at": "2022-09-16T09:04:17+00:00",
      "archived": false,
      "archived_at": null,
      "type": "product_groups",
      "name": "iPad Pro",
    ...
    "relationships": {
      ...
      "products": {
        "links": {
          "related": "api/boomerang/products?filter[product_group_id]=bc867ade-795a-461e-b3c7-317b2b5ab36b"
        }
      },
      "tax_category": {
        "links": {
      ...
      "properties": {
        "links": {
          "related": "api/boomerang/properties?filter[owner_id]=bc867ade-795a-461e-b3c7-317b2b5ab36b&filter[owner_type]=product_groups"
        }
      }
    }
  },
...
```json
  {
  "data": {
    "id": "829a3280-59aa-4faf-8b8a-c0452d790019",
    "type": "product_groups",
    "attributes": {
      "created_at": "2022-09-16T09:04:18+00:00",
      "updated_at": "2022-09-16T09:04:18+00:00",
      "archived": false,
      "archived_at": null,
      "type": "product_groups",
      "name": "iPad mini",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/product_groups/306b7fe3-d3ec-4b14-813b-8d134ed8f842' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "306b7fe3-d3ec-4b14-813b-8d134ed8f842",
        "type": "product_groups",
        "attributes": {
          "name": "iPad mini"
        }
...
```json
  ...
  "data": {
    ...
    "attributes": {
      "created_at": "2022-09-16T09:04:18+00:00",
      "updated_at": "2022-09-16T09:04:19+00:00",
      "archived": false,
      "archived_at": null,
      "type": "product_groups",
      "name": "iPad mini",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/product_groups/5d22a3f3-c2a5-4ea1-8f6d-c5c039f131af' \
    --header 'content-type: application/json' \
    --data '{}'
```
