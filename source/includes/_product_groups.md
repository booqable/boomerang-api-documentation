...
```json
  ...
  "data": [
    {
      "id": "82ede265-42bf-4017-8f4e-881b6df2f499",
      "type": "product_groups",
      "attributes": {
        "created_at": "2022-06-08T08:06:54+00:00",
        "updated_at": "2022-06-08T08:06:54+00:00",
        "archived": false,
        "archived_at": null,
        "type": "product_groups",
        "name": "iPad Pro",
      ...
      "relationships": {
        "categories": {
          "links": {
            "related": "api/boomerang/categories?filter[item_id]=82ede265-42bf-4017-8f4e-881b6df2f499"
          }
        },
        "photo": {
          "links": {
        ...
        "products": {
          "links": {
            "related": "api/boomerang/products?filter[product_group_id]=82ede265-42bf-4017-8f4e-881b6df2f499"
          }
        },
        "tax_category": {
          "links": {
        ...
        "properties": {
          "links": {
            "related": "api/boomerang/properties?filter[owner_id]=82ede265-42bf-4017-8f4e-881b6df2f499&filter[owner_type]=product_groups"
          }
        }
      }
    }
...
```json
  ...
  "data": [
    {
      "id": "41f74b93-2b14-4089-90cc-653a77b76729"
    },
    {
      "id": "83312210-8219-46f8-84da-713345bf230c"
    },
    {
      "id": "7880004d-fbad-4b6b-a999-f1b475613c4c"
    }
  ]
}
```
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/product_groups/042b1ea0-c595-40a7-8f2f-78ab4e6463ba' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "042b1ea0-c595-40a7-8f2f-78ab4e6463ba",
    "type": "product_groups",
    "attributes": {
      "created_at": "2022-06-08T08:06:56+00:00",
      "updated_at": "2022-06-08T08:06:56+00:00",
      "archived": false,
      "archived_at": null,
      "type": "product_groups",
      "name": "iPad Pro",
    ...
    "relationships": {
      "categories": {
        "links": {
          "related": "api/boomerang/categories?filter[item_id]=042b1ea0-c595-40a7-8f2f-78ab4e6463ba"
        }
      },
      "photo": {
        "links": {
      ...
      "products": {
        "links": {
          "related": "api/boomerang/products?filter[product_group_id]=042b1ea0-c595-40a7-8f2f-78ab4e6463ba"
        }
      },
      "tax_category": {
        "links": {
      ...
      "properties": {
        "links": {
          "related": "api/boomerang/properties?filter[owner_id]=042b1ea0-c595-40a7-8f2f-78ab4e6463ba&filter[owner_type]=product_groups"
        }
      }
    }
  },
...
```json
  {
  "data": {
    "id": "3ba063b4-c2ee-4312-944c-79a9ee071728",
    "type": "product_groups",
    "attributes": {
      "created_at": "2022-06-08T08:06:57+00:00",
      "updated_at": "2022-06-08T08:06:57+00:00",
      "archived": false,
      "archived_at": null,
      "type": "product_groups",
      "name": "iPad mini",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/product_groups/82113a8c-a594-4efe-9230-904d0ea6dd62' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "82113a8c-a594-4efe-9230-904d0ea6dd62",
        "type": "product_groups",
        "attributes": {
          "name": "iPad mini"
        }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/product_groups/1822def9-59d0-4e5e-8ee5-4e23050edf48' \
    --header 'content-type: application/json' \
    --data '{}'
```
