...
```json
  ...
  "data": [
    {
      "id": "f94d42f8-3776-4af3-aaff-2a2f159a7d96",
      "type": "product_groups",
      "attributes": {
        "created_at": "2023-02-01T13:02:44+00:00",
        "updated_at": "2023-02-01T13:02:44+00:00",
        "archived": false,
        "archived_at": null,
        "type": "product_groups",
        "name": "iPad Pro",
      ...
      "relationships": {
        ...
        "products": {
          "links": {
            "related": "api/boomerang/products?filter[product_group_id]=f94d42f8-3776-4af3-aaff-2a2f159a7d96"
          }
        },
        "tax_category": {
          "links": {
        ...
        "properties": {
          "links": {
            "related": "api/boomerang/properties?filter[owner_id]=f94d42f8-3776-4af3-aaff-2a2f159a7d96&filter[owner_type]=product_groups"
          }
        }
      }
    }
...
```json
  ...
  "data": [
    {
      "id": "ea628e55-975c-46d3-9b65-4f3a3e800f53"
    },
    {
      "id": "b33a706b-b76b-4b3b-8ab2-5ec014f03923"
    },
    {
      "id": "397998e6-9494-43ec-9779-bd2346ba4e81"
    }
  ]
}
```
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/product_groups/4e0ca411-cb2e-478d-98b9-d1dd768cb71d' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "4e0ca411-cb2e-478d-98b9-d1dd768cb71d",
    "type": "product_groups",
    "attributes": {
      "created_at": "2023-02-01T13:02:46+00:00",
      "updated_at": "2023-02-01T13:02:46+00:00",
      "archived": false,
      "archived_at": null,
      "type": "product_groups",
      "name": "iPad Pro",
    ...
    "relationships": {
      ...
      "products": {
        "links": {
          "related": "api/boomerang/products?filter[product_group_id]=4e0ca411-cb2e-478d-98b9-d1dd768cb71d"
        }
      },
      "tax_category": {
        "links": {
      ...
      "properties": {
        "links": {
          "related": "api/boomerang/properties?filter[owner_id]=4e0ca411-cb2e-478d-98b9-d1dd768cb71d&filter[owner_type]=product_groups"
        }
      }
    }
  },
...
```json
  {
  "data": {
    "id": "7000bfbc-3aa0-4eb7-8d46-361331529810",
    "type": "product_groups",
    "attributes": {
      "created_at": "2023-02-01T13:02:47+00:00",
      "updated_at": "2023-02-01T13:02:47+00:00",
      "archived": false,
      "archived_at": null,
      "type": "product_groups",
      "name": "iPad mini",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/product_groups/884db397-b9f6-4f74-98c5-c3c3beccc3c8' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "884db397-b9f6-4f74-98c5-c3c3beccc3c8",
        "type": "product_groups",
        "attributes": {
          "name": "iPad mini"
        }
...
```json
  ...
  "data": {
    ...
    "type": "product_groups",
    "attributes": {
      "created_at": "2023-02-01T13:02:48+00:00",
      "updated_at": "2023-02-01T13:02:48+00:00",
      "archived": false,
      "archived_at": null,
      "type": "product_groups",
      "name": "iPad mini",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/product_groups/ade632ab-a719-4704-827c-414823b8d744' \
    --header 'content-type: application/json' \
    --data '{}'
```
