...
```json
  ...
  "data": [
    {
      "id": "d3512ff0-75ec-4bd3-9911-f063d0f23b6a",
      "type": "product_groups",
      "attributes": {
        "name": "iPad Pro",
        "slug": "ipad-pro",
      ...
      "relationships": {
        ...
        "products": {
          "links": {
            "related": "api/boomerang/products?filter[item_group_id]=d3512ff0-75ec-4bd3-9911-f063d0f23b6a"
          }
        },
        "tax_category": {
          "links": {
        ...
        "properties": {
          "links": {
            "related": "api/boomerang/properties?filter[owner_id]=d3512ff0-75ec-4bd3-9911-f063d0f23b6a&filter[owner_type]=ProductGroup"
          }
        }
      }
    }
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/product_groups/78687ed2-2ba3-4b45-8cae-2b919971f20d' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "78687ed2-2ba3-4b45-8cae-2b919971f20d",
    "type": "product_groups",
    "attributes": {
      "name": "iPad Pro",
      "slug": "ipad-pro",
    ...
    "relationships": {
      ...
      "products": {
        "links": {
          "related": "api/boomerang/products?filter[item_group_id]=78687ed2-2ba3-4b45-8cae-2b919971f20d"
        }
      },
      "tax_category": {
        "links": {
      ...
      "properties": {
        "links": {
          "related": "api/boomerang/properties?filter[owner_id]=78687ed2-2ba3-4b45-8cae-2b919971f20d&filter[owner_type]=ProductGroup"
        }
      }
    }
  },
...
```json
  {
  "data": {
    "id": "4595571d-2bbd-455b-9ea2-ac1656bf6769",
    "type": "product_groups",
    "attributes": {
      "name": "iPad mini",
      "slug": "ipad-mini",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/product_groups/77ec2565-d97f-4279-962f-444de6cd6c87' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "77ec2565-d97f-4279-962f-444de6cd6c87",
        "type": "product_groups",
        "attributes": {
          "name": "iPad mini"
        }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/product_groups/079dfdec-9b33-4332-b7e0-06aa941d555e' \
    --header 'content-type: application/json' \
    --data '{}'
```
