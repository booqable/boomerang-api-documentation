...
```json
  ...
  "data": [
    {
      "id": "0b138bf7-37dc-4905-97ea-13f0d741cfbb",
      "type": "product_groups",
      "attributes": {
        "created_at": "2023-02-24T08:55:35+00:00",
        "updated_at": "2023-02-24T08:55:35+00:00",
        "archived": false,
        "archived_at": null,
        "type": "product_groups",
        "name": "iPad Pro",
      ...
      "relationships": {
        ...
        "inventory_levels": {
          "links": {
            "related": "api/boomerang/inventory_levels?filter[item_id]=0b138bf7-37dc-4905-97ea-13f0d741cfbb"
          }
        },
        "properties": {
          "links": {
            "related": "api/boomerang/properties?filter[owner_id]=0b138bf7-37dc-4905-97ea-13f0d741cfbb&filter[owner_type]=product_groups"
          }
        },
        "products": {
          "links": {
            "related": "api/boomerang/products?filter[product_group_id]=0b138bf7-37dc-4905-97ea-13f0d741cfbb"
          }
        }
      }
    }
...
```json
  ...
  "data": [
    {
      "id": "2bacd57b-9ad5-42f7-9e15-b4a757830af0"
    },
    {
      "id": "fa96d311-f5e1-42ce-a4a4-f5aad1d5129c"
    },
    {
      "id": "9b08f50c-c01d-41c4-bfd6-06613d7b7612"
    }
  ]
}
```
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/product_groups/f84879fc-6a6b-46b1-b489-ae32ec06d086' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "f84879fc-6a6b-46b1-b489-ae32ec06d086",
    "type": "product_groups",
    "attributes": {
      "created_at": "2023-02-24T08:55:38+00:00",
      "updated_at": "2023-02-24T08:55:38+00:00",
      "archived": false,
      "archived_at": null,
      "type": "product_groups",
      "name": "iPad Pro",
    ...
    "relationships": {
      ...
      "inventory_levels": {
        "links": {
          "related": "api/boomerang/inventory_levels?filter[item_id]=f84879fc-6a6b-46b1-b489-ae32ec06d086"
        }
      },
      "properties": {
        "links": {
          "related": "api/boomerang/properties?filter[owner_id]=f84879fc-6a6b-46b1-b489-ae32ec06d086&filter[owner_type]=product_groups"
        }
      },
      "products": {
        "links": {
          "related": "api/boomerang/products?filter[product_group_id]=f84879fc-6a6b-46b1-b489-ae32ec06d086"
        }
      }
    }
  },
...
```json
  {
  "data": {
    "id": "9e86e804-46fe-4802-bc03-6a2550c5541f",
    "type": "product_groups",
    "attributes": {
      "created_at": "2023-02-24T08:55:38+00:00",
      "updated_at": "2023-02-24T08:55:38+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/product_groups/eef2d2ea-e3ff-4bcd-8abc-5dddd83cb651' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "eef2d2ea-e3ff-4bcd-8abc-5dddd83cb651",
        "type": "product_groups",
        "attributes": {
          "name": "iPad mini"
        }
...
```json
  ...
  "data": {
    ...
    "type": "product_groups",
    "attributes": {
      "created_at": "2023-02-24T08:55:39+00:00",
      "updated_at": "2023-02-24T08:55:39+00:00",
      "archived": false,
      "archived_at": null,
      "type": "product_groups",
      "name": "iPad mini",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/product_groups/8b553a05-e918-418d-8c40-be3970f70fab' \
    --header 'content-type: application/json' \
    --data '{}'
```
