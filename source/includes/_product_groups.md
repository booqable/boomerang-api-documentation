...
```json
  ...
  "data": [
    {
      "id": "8d4eefe9-0684-4b82-9efc-036c799ec8c7",
      "type": "product_groups",
      "attributes": {
        "created_at": "2023-02-14T11:07:16+00:00",
        "updated_at": "2023-02-14T11:07:16+00:00",
        "archived": false,
        "archived_at": null,
        "type": "product_groups",
        "name": "iPad Pro",
      ...
      "relationships": {
        ...
        "inventory_levels": {
          "links": {
            "related": "api/boomerang/inventory_levels?filter[item_id]=8d4eefe9-0684-4b82-9efc-036c799ec8c7"
          }
        },
        "properties": {
          "links": {
            "related": "api/boomerang/properties?filter[owner_id]=8d4eefe9-0684-4b82-9efc-036c799ec8c7&filter[owner_type]=product_groups"
          }
        },
        "products": {
          "links": {
            "related": "api/boomerang/products?filter[product_group_id]=8d4eefe9-0684-4b82-9efc-036c799ec8c7"
          }
        }
      }
    }
...
```json
  ...
  "data": [
    {
      "id": "9a4056a2-91ac-42fe-bbee-584899dd60b4"
    },
    {
      "id": "34f2d781-6038-4270-a837-64f79150a276"
    },
    {
      "id": "8b3e3b87-6beb-4425-b237-f5d2e3e55c92"
    }
  ]
}
```
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/product_groups/2a03530a-96b5-413c-9143-93c4baa165bd' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "2a03530a-96b5-413c-9143-93c4baa165bd",
    "type": "product_groups",
    "attributes": {
    ...
    "relationships": {
      ...
      "inventory_levels": {
        "links": {
          "related": "api/boomerang/inventory_levels?filter[item_id]=2a03530a-96b5-413c-9143-93c4baa165bd"
        }
      },
      "properties": {
        "links": {
          "related": "api/boomerang/properties?filter[owner_id]=2a03530a-96b5-413c-9143-93c4baa165bd&filter[owner_type]=product_groups"
        }
      },
      "products": {
        "links": {
          "related": "api/boomerang/products?filter[product_group_id]=2a03530a-96b5-413c-9143-93c4baa165bd"
        }
      }
    }
  },
...
```json
  {
  "data": {
    "id": "c434dfad-a4e8-4958-9a16-f9bd6a76e7d6",
    "type": "product_groups",
    "attributes": {
      "created_at": "2023-02-14T11:07:19+00:00",
      "updated_at": "2023-02-14T11:07:19+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/product_groups/4e54df5e-d7a9-435e-8e44-61fab172ea37' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "4e54df5e-d7a9-435e-8e44-61fab172ea37",
        "type": "product_groups",
        "attributes": {
          "name": "iPad mini"
        }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/product_groups/f2376f6c-7042-4d51-85e8-0e0d7e5f3cbe' \
    --header 'content-type: application/json' \
    --data '{}'
```
