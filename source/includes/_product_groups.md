...
```json
  ...
  "data": [
    {
      "id": "0d97cdd8-a0e4-4a07-8369-b7f9e044dbd3",
      "type": "product_groups",
      "attributes": {
        "created_at": "2023-02-08T08:38:42+00:00",
        "updated_at": "2023-02-08T08:38:42+00:00",
        "archived": false,
        "archived_at": null,
        "type": "product_groups",
        "name": "iPad Pro",
      ...
      "relationships": {
        ...
        "products": {
          "links": {
            "related": "api/boomerang/products?filter[product_group_id]=0d97cdd8-a0e4-4a07-8369-b7f9e044dbd3"
          }
        },
        "tax_category": {
          "links": {
        ...
        "properties": {
          "links": {
            "related": "api/boomerang/properties?filter[owner_id]=0d97cdd8-a0e4-4a07-8369-b7f9e044dbd3&filter[owner_type]=product_groups"
          }
        }
      }
    }
...
```json
  ...
  "data": [
    {
      "id": "67058682-06bb-4229-80de-ecfc74371df2"
    },
    {
      "id": "276f6e26-1498-4129-b93c-cb9349890f24"
    },
    {
      "id": "5ca745b7-fb53-48d1-b3f2-3d8c99cec0a7"
    }
  ]
}
```
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/product_groups/ed35b8ba-143c-4887-b2f7-5215ff1af8a6' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "ed35b8ba-143c-4887-b2f7-5215ff1af8a6",
    "type": "product_groups",
    "attributes": {
      "created_at": "2023-02-08T08:38:45+00:00",
      "updated_at": "2023-02-08T08:38:45+00:00",
      "archived": false,
      "archived_at": null,
      "type": "product_groups",
      "name": "iPad Pro",
    ...
    "relationships": {
      ...
      "products": {
        "links": {
          "related": "api/boomerang/products?filter[product_group_id]=ed35b8ba-143c-4887-b2f7-5215ff1af8a6"
        }
      },
      "tax_category": {
        "links": {
      ...
      "properties": {
        "links": {
          "related": "api/boomerang/properties?filter[owner_id]=ed35b8ba-143c-4887-b2f7-5215ff1af8a6&filter[owner_type]=product_groups"
        }
      }
    }
  },
...
```json
  {
  "data": {
    "id": "3f1a181a-f0de-40c9-97ee-770214b1c2f4",
    "type": "product_groups",
    "attributes": {
      "created_at": "2023-02-08T08:38:46+00:00",
      "updated_at": "2023-02-08T08:38:46+00:00",
      "archived": false,
      "archived_at": null,
      "type": "product_groups",
      "name": "iPad mini",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/product_groups/4fab5d65-4f0a-4015-b901-238eb15c5e9a' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "4fab5d65-4f0a-4015-b901-238eb15c5e9a",
        "type": "product_groups",
        "attributes": {
          "name": "iPad mini"
        }
...
```json
  ...
  "data": {
    ...
    "attributes": {
      "created_at": "2023-02-08T08:38:46+00:00",
      "updated_at": "2023-02-08T08:38:47+00:00",
      "archived": false,
      "archived_at": null,
      "type": "product_groups",
      "name": "iPad mini",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/product_groups/68cdfa92-cc59-4560-8499-ae4abe7163e7' \
    --header 'content-type: application/json' \
    --data '{}'
```
