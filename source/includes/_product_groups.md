...
```json
  ...
  "data": [
    {
      "id": "f429a43e-7d4e-4100-8361-751e64790698",
      "type": "product_groups",
      "attributes": {
        "created_at": "2023-02-16T10:02:44+00:00",
        "updated_at": "2023-02-16T10:02:44+00:00",
        "archived": false,
        "archived_at": null,
        "type": "product_groups",
        "name": "iPad Pro",
      ...
      "relationships": {
        ...
        "inventory_levels": {
          "links": {
            "related": "api/boomerang/inventory_levels?filter[item_id]=f429a43e-7d4e-4100-8361-751e64790698"
          }
        },
        "properties": {
          "links": {
            "related": "api/boomerang/properties?filter[owner_id]=f429a43e-7d4e-4100-8361-751e64790698&filter[owner_type]=product_groups"
          }
        },
        "products": {
          "links": {
            "related": "api/boomerang/products?filter[product_group_id]=f429a43e-7d4e-4100-8361-751e64790698"
          }
        }
      }
    }
...
```json
  ...
  "data": [
    {
      "id": "b8ebf337-d32c-49ff-9443-aa631fc602ae"
    },
    {
      "id": "d9b3d5eb-d461-4272-b5fc-27d9f17b29be"
    },
    {
      "id": "e17d70cc-f81f-4af4-aed9-b2cb6a73d544"
    }
  ]
}
```
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/product_groups/a883040a-6940-4258-9d65-f34c332ca913' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "a883040a-6940-4258-9d65-f34c332ca913",
    "type": "product_groups",
    "attributes": {
      "created_at": "2023-02-16T10:02:48+00:00",
      "updated_at": "2023-02-16T10:02:48+00:00",
      "archived": false,
      "archived_at": null,
      "type": "product_groups",
      "name": "iPad Pro",
    ...
    "relationships": {
      ...
      "inventory_levels": {
        "links": {
          "related": "api/boomerang/inventory_levels?filter[item_id]=a883040a-6940-4258-9d65-f34c332ca913"
        }
      },
      "properties": {
        "links": {
          "related": "api/boomerang/properties?filter[owner_id]=a883040a-6940-4258-9d65-f34c332ca913&filter[owner_type]=product_groups"
        }
      },
      "products": {
        "links": {
          "related": "api/boomerang/products?filter[product_group_id]=a883040a-6940-4258-9d65-f34c332ca913"
        }
      }
    }
  },
...
```json
  {
  "data": {
    "id": "98fc7525-169a-4bbd-899d-37636274f7ee",
    "type": "product_groups",
    "attributes": {
      "created_at": "2023-02-16T10:02:49+00:00",
      "updated_at": "2023-02-16T10:02:49+00:00",
      "archived": false,
      "archived_at": null,
      "type": "product_groups",
      "name": "iPad mini",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/product_groups/860a5756-9be0-45a5-a94b-a830a2c12c87' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "860a5756-9be0-45a5-a94b-a830a2c12c87",
        "type": "product_groups",
        "attributes": {
          "name": "iPad mini"
        }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/product_groups/cef18161-5ad0-4e9a-b0ef-85868c42aefa' \
    --header 'content-type: application/json' \
    --data '{}'
```
