...
```json
  ...
  "data": [
    {
      "id": "6c599d3b-482e-498b-a7b8-eba31c38df00",
      "type": "product_groups",
      "attributes": {
        "created_at": "2023-02-07T15:20:15+00:00",
        "updated_at": "2023-02-07T15:20:15+00:00",
        "archived": false,
        "archived_at": null,
        "type": "product_groups",
        "name": "iPad Pro",
      ...
      "relationships": {
        ...
        "products": {
          "links": {
            "related": "api/boomerang/products?filter[product_group_id]=6c599d3b-482e-498b-a7b8-eba31c38df00"
          }
        },
        "tax_category": {
          "links": {
        ...
        "properties": {
          "links": {
            "related": "api/boomerang/properties?filter[owner_id]=6c599d3b-482e-498b-a7b8-eba31c38df00&filter[owner_type]=product_groups"
          }
        }
      }
    }
...
```json
  ...
  "data": [
    {
      "id": "734371f5-9d7e-48ab-a9f5-0575b0ea361a"
    },
    {
      "id": "5ccf0799-39e4-4312-b815-a2562c11f641"
    },
    {
      "id": "9e6a52ed-9f22-4792-9c40-ba4ad191b57a"
    }
  ]
}
```
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/product_groups/ef8d44d3-71f1-408c-a00b-c5f1dc71b9c4' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "ef8d44d3-71f1-408c-a00b-c5f1dc71b9c4",
    "type": "product_groups",
    "attributes": {
      "created_at": "2023-02-07T15:20:18+00:00",
      "updated_at": "2023-02-07T15:20:18+00:00",
      "archived": false,
      "archived_at": null,
      "type": "product_groups",
      "name": "iPad Pro",
    ...
    "relationships": {
      ...
      "products": {
        "links": {
          "related": "api/boomerang/products?filter[product_group_id]=ef8d44d3-71f1-408c-a00b-c5f1dc71b9c4"
        }
      },
      "tax_category": {
        "links": {
      ...
      "properties": {
        "links": {
          "related": "api/boomerang/properties?filter[owner_id]=ef8d44d3-71f1-408c-a00b-c5f1dc71b9c4&filter[owner_type]=product_groups"
        }
      }
    }
  },
...
```json
  {
  "data": {
    "id": "01a5ca23-8c51-4077-a4b1-2e316a90c5c9",
    "type": "product_groups",
    "attributes": {
      "created_at": "2023-02-07T15:20:18+00:00",
      "updated_at": "2023-02-07T15:20:18+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/product_groups/7ccbd30d-de97-44e6-a0cf-ab721e0156ec' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "7ccbd30d-de97-44e6-a0cf-ab721e0156ec",
        "type": "product_groups",
        "attributes": {
          "name": "iPad mini"
        }
...
```json
  ...
  "data": {
    ...
    "type": "product_groups",
    "attributes": {
      "created_at": "2023-02-07T15:20:19+00:00",
      "updated_at": "2023-02-07T15:20:19+00:00",
      "archived": false,
      "archived_at": null,
      "type": "product_groups",
      "name": "iPad mini",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/product_groups/d49079ad-2418-4fd7-aaba-8df27bfb77f3' \
    --header 'content-type: application/json' \
    --data '{}'
```
