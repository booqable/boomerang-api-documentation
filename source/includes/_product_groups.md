...
```json
  ...
  "data": [
    {
      "id": "1d30815d-a84d-4ab0-89d4-a026d627de85",
      "type": "product_groups",
      "attributes": {
        "created_at": "2022-07-14T10:18:46+00:00",
        "updated_at": "2022-07-14T10:18:46+00:00",
        "archived": false,
        "archived_at": null,
        "type": "product_groups",
        "name": "iPad Pro",
      ...
      "relationships": {
        "categories": {
          "links": {
            "related": "api/boomerang/categories?filter[item_id]=1d30815d-a84d-4ab0-89d4-a026d627de85"
          }
        },
        "photo": {
          "links": {
        ...
        "products": {
          "links": {
            "related": "api/boomerang/products?filter[product_group_id]=1d30815d-a84d-4ab0-89d4-a026d627de85"
          }
        },
        "tax_category": {
          "links": {
        ...
        "properties": {
          "links": {
            "related": "api/boomerang/properties?filter[owner_id]=1d30815d-a84d-4ab0-89d4-a026d627de85&filter[owner_type]=product_groups"
          }
        }
      }
    }
...
```json
  ...
  "data": [
    {
      "id": "c06cbf4c-8328-4687-bdc4-f813cc2adfb6"
    },
    {
      "id": "1cd6882d-52a1-4a5e-9de9-a768ddb111f3"
    },
    {
      "id": "53168188-5ef5-4992-bcd3-da8c5c76becb"
    }
  ]
}
```
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/product_groups/0e629a3b-68f3-4d5e-91db-6516be8cb32f' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "0e629a3b-68f3-4d5e-91db-6516be8cb32f",
    "type": "product_groups",
    "attributes": {
      "created_at": "2022-07-14T10:18:49+00:00",
      "updated_at": "2022-07-14T10:18:49+00:00",
      "archived": false,
      "archived_at": null,
      "type": "product_groups",
      "name": "iPad Pro",
    ...
    "relationships": {
      "categories": {
        "links": {
          "related": "api/boomerang/categories?filter[item_id]=0e629a3b-68f3-4d5e-91db-6516be8cb32f"
        }
      },
      "photo": {
        "links": {
      ...
      "products": {
        "links": {
          "related": "api/boomerang/products?filter[product_group_id]=0e629a3b-68f3-4d5e-91db-6516be8cb32f"
        }
      },
      "tax_category": {
        "links": {
      ...
      "properties": {
        "links": {
          "related": "api/boomerang/properties?filter[owner_id]=0e629a3b-68f3-4d5e-91db-6516be8cb32f&filter[owner_type]=product_groups"
        }
      }
    }
  },
...
```json
  {
  "data": {
    "id": "84a75a10-50b4-4394-9435-32d00856a624",
    "type": "product_groups",
    "attributes": {
      "created_at": "2022-07-14T10:18:49+00:00",
      "updated_at": "2022-07-14T10:18:49+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/product_groups/056671bb-412a-4d0c-ba0e-e5383dff12d3' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "056671bb-412a-4d0c-ba0e-e5383dff12d3",
        "type": "product_groups",
        "attributes": {
          "name": "iPad mini"
        }
...
```json
  ...
  "data": {
    ...
    "type": "product_groups",
    "attributes": {
      "created_at": "2022-07-14T10:18:50+00:00",
      "updated_at": "2022-07-14T10:18:50+00:00",
      "archived": false,
      "archived_at": null,
      "type": "product_groups",
      "name": "iPad mini",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/product_groups/9fe09afb-f9ed-44bf-9cad-05addcb18027' \
    --header 'content-type: application/json' \
    --data '{}'
```
