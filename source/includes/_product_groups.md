...
```json
  ...
  "data": [
    {
      "id": "f521a992-4475-4aa7-baf0-b6d4ac507848",
      "type": "product_groups",
      "attributes": {
        "created_at": "2023-03-10T08:40:34+00:00",
        "updated_at": "2023-03-10T08:40:34+00:00",
        "archived": false,
        "archived_at": null,
        "type": "product_groups",
        "name": "iPad Pro",
      ...
      "relationships": {
        ...
        "inventory_levels": {
          "links": {
            "related": "api/boomerang/inventory_levels?filter[item_id]=f521a992-4475-4aa7-baf0-b6d4ac507848"
          }
        },
        "properties": {
          "links": {
            "related": "api/boomerang/properties?filter[owner_id]=f521a992-4475-4aa7-baf0-b6d4ac507848&filter[owner_type]=product_groups"
          }
        },
        "products": {
          "links": {
            "related": "api/boomerang/products?filter[product_group_id]=f521a992-4475-4aa7-baf0-b6d4ac507848"
          }
        }
      }
    }
...
```json
  ...
  "data": [
    {
      "id": "d2b05a78-d8ba-4d3d-8ade-0c238c2cbb48"
    },
    {
      "id": "de08e87d-c286-40fe-8fa9-3da18bdc1a7f"
    },
    {
      "id": "042a8c90-a71e-4add-bf74-2c9609e65c3c"
    }
  ]
}
```
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/product_groups/9795fbdd-e6d1-41f2-8859-7ae58c36fa10' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "9795fbdd-e6d1-41f2-8859-7ae58c36fa10",
    "type": "product_groups",
    "attributes": {
    ...
    "relationships": {
      ...
      "inventory_levels": {
        "links": {
          "related": "api/boomerang/inventory_levels?filter[item_id]=9795fbdd-e6d1-41f2-8859-7ae58c36fa10"
        }
      },
      "properties": {
        "links": {
          "related": "api/boomerang/properties?filter[owner_id]=9795fbdd-e6d1-41f2-8859-7ae58c36fa10&filter[owner_type]=product_groups"
        }
      },
      "products": {
        "links": {
          "related": "api/boomerang/products?filter[product_group_id]=9795fbdd-e6d1-41f2-8859-7ae58c36fa10"
        }
      }
    }
  },
...
```json
  {
  "data": {
    "id": "7cbc6977-2feb-4cb9-b890-082ccdaf1725",
    "type": "product_groups",
    "attributes": {
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/product_groups/1a95b327-75c9-4129-8cbc-b0e9a52e833e' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "1a95b327-75c9-4129-8cbc-b0e9a52e833e",
        "type": "product_groups",
        "attributes": {
          "name": "iPad mini"
        }
...
```json
  ...
  "data": {
    ...
    "type": "product_groups",
    "attributes": {
      "created_at": "2023-03-10T08:40:40+00:00",
      "updated_at": "2023-03-10T08:40:40+00:00",
      "archived": false,
      "archived_at": null,
      "type": "product_groups",
      "name": "iPad mini",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/product_groups/469d4dc8-7cf7-4e1b-9ef7-c2b62043c39f' \
    --header 'content-type: application/json' \
    --data '{}'
```
