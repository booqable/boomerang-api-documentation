...
```json
  ...
  "data": [
    {
      "id": "a767d102-d9ec-4ebb-8c6f-14d9d7b56162",
      "type": "product_groups",
      "attributes": {
        "created_at": "2023-02-21T08:21:29+00:00",
        "updated_at": "2023-02-21T08:21:29+00:00",
        "archived": false,
        "archived_at": null,
        "type": "product_groups",
        "name": "iPad Pro",
      ...
      "relationships": {
        ...
        "inventory_levels": {
          "links": {
            "related": "api/boomerang/inventory_levels?filter[item_id]=a767d102-d9ec-4ebb-8c6f-14d9d7b56162"
          }
        },
        "properties": {
          "links": {
            "related": "api/boomerang/properties?filter[owner_id]=a767d102-d9ec-4ebb-8c6f-14d9d7b56162&filter[owner_type]=product_groups"
          }
        },
        "products": {
          "links": {
            "related": "api/boomerang/products?filter[product_group_id]=a767d102-d9ec-4ebb-8c6f-14d9d7b56162"
          }
        }
      }
    }
...
```json
  ...
  "data": [
    {
      "id": "6290b70a-85ae-42fe-b700-f44acee65868"
    },
    {
      "id": "4abe5fcd-f7b3-4543-9c81-210996f92c5b"
    },
    {
      "id": "c774a2fa-1485-4de2-889e-4a803768bb91"
    }
  ]
}
```
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/product_groups/a37826cc-774c-422a-b695-3639a0ad5de2' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "a37826cc-774c-422a-b695-3639a0ad5de2",
    "type": "product_groups",
    "attributes": {
      "created_at": "2023-02-21T08:21:31+00:00",
      "updated_at": "2023-02-21T08:21:31+00:00",
      "archived": false,
      "archived_at": null,
      "type": "product_groups",
      "name": "iPad Pro",
    ...
    "relationships": {
      ...
      "inventory_levels": {
        "links": {
          "related": "api/boomerang/inventory_levels?filter[item_id]=a37826cc-774c-422a-b695-3639a0ad5de2"
        }
      },
      "properties": {
        "links": {
          "related": "api/boomerang/properties?filter[owner_id]=a37826cc-774c-422a-b695-3639a0ad5de2&filter[owner_type]=product_groups"
        }
      },
      "products": {
        "links": {
          "related": "api/boomerang/products?filter[product_group_id]=a37826cc-774c-422a-b695-3639a0ad5de2"
        }
      }
    }
  },
...
```json
  {
  "data": {
    "id": "c933eaef-6ce6-4c45-9644-2ff2c8f9686c",
    "type": "product_groups",
    "attributes": {
      "created_at": "2023-02-21T08:21:32+00:00",
      "updated_at": "2023-02-21T08:21:32+00:00",
      "archived": false,
      "archived_at": null,
      "type": "product_groups",
      "name": "iPad mini",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/product_groups/9a24703b-90fa-453e-9730-8d257ed18fc4' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "9a24703b-90fa-453e-9730-8d257ed18fc4",
        "type": "product_groups",
        "attributes": {
          "name": "iPad mini"
        }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/product_groups/3c779b03-5287-4751-bd37-1d1c0b51ca12' \
    --header 'content-type: application/json' \
    --data '{}'
```
