...
```json
  ...
  "data": [
    {
      "id": "5931a6cf-2d89-4054-b816-c3bc3b64743b",
      "type": "product_groups",
      "attributes": {
        "created_at": "2023-02-08T13:53:08+00:00",
        "updated_at": "2023-02-08T13:53:08+00:00",
        "archived": false,
        "archived_at": null,
        "type": "product_groups",
        "name": "iPad Pro",
      ...
      "relationships": {
        ...
        "products": {
          "links": {
            "related": "api/boomerang/products?filter[product_group_id]=5931a6cf-2d89-4054-b816-c3bc3b64743b"
          }
        },
        "tax_category": {
          "links": {
        ...
        "properties": {
          "links": {
            "related": "api/boomerang/properties?filter[owner_id]=5931a6cf-2d89-4054-b816-c3bc3b64743b&filter[owner_type]=product_groups"
          }
        }
      }
    }
...
```json
  ...
  "data": [
    {
      "id": "a2711577-73e5-4b56-9202-de3a7c3192c5"
    },
    {
      "id": "8a4d5b80-29c6-4abb-9942-5686872d6f83"
    },
    {
      "id": "34dbc882-04e1-4f9e-a465-e46209b818c4"
    }
  ]
}
```
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/product_groups/eed2ea21-1a4b-4e91-95ab-7fd5286dc7e1' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "eed2ea21-1a4b-4e91-95ab-7fd5286dc7e1",
    "type": "product_groups",
    "attributes": {
      "created_at": "2023-02-08T13:53:10+00:00",
      "updated_at": "2023-02-08T13:53:10+00:00",
      "archived": false,
      "archived_at": null,
      "type": "product_groups",
      "name": "iPad Pro",
    ...
    "relationships": {
      ...
      "products": {
        "links": {
          "related": "api/boomerang/products?filter[product_group_id]=eed2ea21-1a4b-4e91-95ab-7fd5286dc7e1"
        }
      },
      "tax_category": {
        "links": {
      ...
      "properties": {
        "links": {
          "related": "api/boomerang/properties?filter[owner_id]=eed2ea21-1a4b-4e91-95ab-7fd5286dc7e1&filter[owner_type]=product_groups"
        }
      }
    }
  },
...
```json
  {
  "data": {
    "id": "e8319a8c-f590-4809-b51b-5e630969cfc4",
    "type": "product_groups",
    "attributes": {
      "created_at": "2023-02-08T13:53:11+00:00",
      "updated_at": "2023-02-08T13:53:11+00:00",
      "archived": false,
      "archived_at": null,
      "type": "product_groups",
      "name": "iPad mini",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/product_groups/735ca03a-088b-447f-ad07-b28d4b422a8c' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "735ca03a-088b-447f-ad07-b28d4b422a8c",
        "type": "product_groups",
        "attributes": {
          "name": "iPad mini"
        }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/product_groups/51787a2b-610e-42d5-acb0-540545125b4f' \
    --header 'content-type: application/json' \
    --data '{}'
```
