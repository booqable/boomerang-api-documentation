...
```json
  ...
  "data": [
    {
      "id": "6995cf9a-6795-4d73-8a82-e1ff93376857",
      "type": "product_groups",
      "attributes": {
        "name": "iPad Pro",
        "slug": "ipad-pro",
      ...
      "relationships": {
        ...
        "products": {
          "links": {
            "related": "api/boomerang/products?filter[item_group_id]=6995cf9a-6795-4d73-8a82-e1ff93376857"
          }
        },
        "tax_category": {
          "links": {
        ...
        "properties": {
          "links": {
            "related": "api/boomerang/properties?filter[owner_id]=6995cf9a-6795-4d73-8a82-e1ff93376857&filter[owner_type]=ProductGroup"
          }
        }
      }
    }
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/product_groups/6f34eac8-8389-420b-a84f-5a0bd87f6f3e' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "6f34eac8-8389-420b-a84f-5a0bd87f6f3e",
    "type": "product_groups",
    "attributes": {
      "name": "iPad Pro",
      "slug": "ipad-pro",
    ...
    "relationships": {
      ...
      "products": {
        "links": {
          "related": "api/boomerang/products?filter[item_group_id]=6f34eac8-8389-420b-a84f-5a0bd87f6f3e"
        }
      },
      "tax_category": {
        "links": {
      ...
      "properties": {
        "links": {
          "related": "api/boomerang/properties?filter[owner_id]=6f34eac8-8389-420b-a84f-5a0bd87f6f3e&filter[owner_type]=ProductGroup"
        }
      }
    }
  },
...
```json
  {
  "data": {
    "id": "66d8068b-3e6c-4285-9f4f-5e6bc4980105",
    "type": "product_groups",
    "attributes": {
      "name": "iPad mini",
      "slug": "ipad-mini",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/product_groups/2bf37fc1-73a4-4baa-8024-b878f9760452' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "2bf37fc1-73a4-4baa-8024-b878f9760452",
        "type": "product_groups",
        "attributes": {
          "name": "iPad mini"
        }
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/product_groups/823fb2bf-68c7-49f0-9e95-fd43905961c5' \
    --header 'content-type: application/json' \
    --data '{}'
```
