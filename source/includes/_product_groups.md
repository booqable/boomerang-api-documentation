...
```json
  ...
  "data": [
    {
      "id": "275e55d8-13f0-47b0-adf8-d6d9869329e4",
      "type": "product_groups",
      "attributes": {
        "created_at": "2023-02-24T14:58:58+00:00",
        "updated_at": "2023-02-24T14:58:58+00:00",
        "archived": false,
        "archived_at": null,
        "type": "product_groups",
        "name": "iPad Pro",
      ...
      "relationships": {
        ...
        "inventory_levels": {
          "links": {
            "related": "api/boomerang/inventory_levels?filter[item_id]=275e55d8-13f0-47b0-adf8-d6d9869329e4"
          }
        },
        "properties": {
          "links": {
            "related": "api/boomerang/properties?filter[owner_id]=275e55d8-13f0-47b0-adf8-d6d9869329e4&filter[owner_type]=product_groups"
          }
        },
        "products": {
          "links": {
            "related": "api/boomerang/products?filter[product_group_id]=275e55d8-13f0-47b0-adf8-d6d9869329e4"
          }
        }
      }
    }
...
```json
  ...
  "data": [
    {
      "id": "575f18a3-632e-4522-9ff5-43cf4847f679"
    },
    {
      "id": "954ed385-fc3c-456a-b5d3-81dcdc50c1b9"
    },
    {
      "id": "870f76f6-9422-460b-9f66-51c2ea17abe0"
    }
  ]
}
```
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/product_groups/90378c12-eadd-412f-a38b-fac5be0e5f5f' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "90378c12-eadd-412f-a38b-fac5be0e5f5f",
    "type": "product_groups",
    "attributes": {
      "created_at": "2023-02-24T14:59:01+00:00",
      "updated_at": "2023-02-24T14:59:01+00:00",
      "archived": false,
      "archived_at": null,
      "type": "product_groups",
      "name": "iPad Pro",
    ...
    "relationships": {
      ...
      "inventory_levels": {
        "links": {
          "related": "api/boomerang/inventory_levels?filter[item_id]=90378c12-eadd-412f-a38b-fac5be0e5f5f"
        }
      },
      "properties": {
        "links": {
          "related": "api/boomerang/properties?filter[owner_id]=90378c12-eadd-412f-a38b-fac5be0e5f5f&filter[owner_type]=product_groups"
        }
      },
      "products": {
        "links": {
          "related": "api/boomerang/products?filter[product_group_id]=90378c12-eadd-412f-a38b-fac5be0e5f5f"
        }
      }
    }
  },
...
```json
  {
  "data": {
    "id": "1aba1d74-6f41-4d75-bbab-4f9408f1352c",
    "type": "product_groups",
    "attributes": {
      "created_at": "2023-02-24T14:59:01+00:00",
      "updated_at": "2023-02-24T14:59:01+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/product_groups/b9e783a8-8082-4734-8793-66e5190f9459' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "b9e783a8-8082-4734-8793-66e5190f9459",
        "type": "product_groups",
        "attributes": {
          "name": "iPad mini"
        }
...
```json
  ...
  "data": {
    ...
    "type": "product_groups",
    "attributes": {
      "created_at": "2023-02-24T14:59:02+00:00",
      "updated_at": "2023-02-24T14:59:02+00:00",
      "archived": false,
      "archived_at": null,
      "type": "product_groups",
      "name": "iPad mini",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/product_groups/18f96edd-ad3b-453e-b62e-7df2619d245c' \
    --header 'content-type: application/json' \
    --data '{}'
```
