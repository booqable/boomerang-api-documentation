...
```json
  ...
  "data": [
    {
      "id": "28487cfa-57c3-4572-9623-8fd5805776e0",
      "type": "product_groups",
      "attributes": {
        "created_at": "2023-01-12T14:29:22+00:00",
        "updated_at": "2023-01-12T14:29:22+00:00",
        "archived": false,
        "archived_at": null,
        "type": "product_groups",
        "name": "iPad Pro",
      ...
      "relationships": {
        ...
        "products": {
          "links": {
            "related": "api/boomerang/products?filter[product_group_id]=28487cfa-57c3-4572-9623-8fd5805776e0"
          }
        },
        "tax_category": {
          "links": {
        ...
        "properties": {
          "links": {
            "related": "api/boomerang/properties?filter[owner_id]=28487cfa-57c3-4572-9623-8fd5805776e0&filter[owner_type]=product_groups"
          }
        }
      }
    }
...
```json
  ...
  "data": [
    {
      "id": "1ca6895f-472c-41e9-beee-c8043483a1ef"
    },
    {
      "id": "40f58217-e72d-4e84-b3e9-e81c0124b13c"
    },
    {
      "id": "c4c47fe8-e62a-4631-bfe3-78a812c32c23"
    }
  ]
}
```
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/product_groups/1c3b937f-c166-4790-acb6-fa13606f3a64' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "1c3b937f-c166-4790-acb6-fa13606f3a64",
    "type": "product_groups",
    "attributes": {
      "created_at": "2023-01-12T14:29:25+00:00",
      "updated_at": "2023-01-12T14:29:25+00:00",
      "archived": false,
      "archived_at": null,
      "type": "product_groups",
      "name": "iPad Pro",
    ...
    "relationships": {
      ...
      "products": {
        "links": {
          "related": "api/boomerang/products?filter[product_group_id]=1c3b937f-c166-4790-acb6-fa13606f3a64"
        }
      },
      "tax_category": {
        "links": {
      ...
      "properties": {
        "links": {
          "related": "api/boomerang/properties?filter[owner_id]=1c3b937f-c166-4790-acb6-fa13606f3a64&filter[owner_type]=product_groups"
        }
      }
    }
  },
...
```json
  {
  "data": {
    "id": "5d8c633d-df1f-43e6-8630-e1c48868676e",
    "type": "product_groups",
    "attributes": {
      "created_at": "2023-01-12T14:29:25+00:00",
      "updated_at": "2023-01-12T14:29:25+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/product_groups/503ba495-0184-4af4-989d-dabba1ba265b' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "503ba495-0184-4af4-989d-dabba1ba265b",
        "type": "product_groups",
        "attributes": {
          "name": "iPad mini"
        }
...
```json
  ...
  "data": {
    ...
    "type": "product_groups",
    "attributes": {
      "created_at": "2023-01-12T14:29:26+00:00",
      "updated_at": "2023-01-12T14:29:26+00:00",
      "archived": false,
      "archived_at": null,
      "type": "product_groups",
      "name": "iPad mini",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/product_groups/00eed992-3632-4d2f-96e5-01a6ad5c8159' \
    --header 'content-type: application/json' \
    --data '{}'
```
