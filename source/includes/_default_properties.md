...
```json
  ...
  "data": [
    {
      "id": "4634e07b-ea50-4840-a735-bcdb328ba7a2",
      "type": "default_properties",
      "attributes": {
        "created_at": "2023-02-07T16:05:02+00:00",
        "updated_at": "2023-02-07T16:05:02+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/0cbc7a7d-af4d-4a54-a9fe-a454020de530?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "0cbc7a7d-af4d-4a54-a9fe-a454020de530",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-07T16:05:03+00:00",
      "updated_at": "2023-02-07T16:05:03+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "phone",
...
```json
  {
  "data": {
    "id": "c60944ca-f22e-46d8-925d-65a7309afc06",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-07T16:05:03+00:00",
      "updated_at": "2023-02-07T16:05:03+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/97834e49-6cb8-4565-93cf-18ab23dc5e4c' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "97834e49-6cb8-4565-93cf-18ab23dc5e4c",
        "type": "default_properties",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/8bbf1b0e-d90e-47a2-b5d0-9074cdb4f73f' \
    --header 'content-type: application/json' \
    --data '{}'
```
