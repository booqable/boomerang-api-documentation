...
```json
  ...
  "data": [
    {
      "id": "caaac260-5836-4bff-9709-37a157fc7e96",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/2c255e0e-4a6a-4244-8f74-e93878e571e5?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "2c255e0e-4a6a-4244-8f74-e93878e571e5",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-03-10T08:36:54+00:00",
      "updated_at": "2023-03-10T08:36:54+00:00",
...
```json
  {
  "data": {
    "id": "e3066c0c-f3f9-4057-b5bd-6f259f6978cc",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-03-10T08:36:54+00:00",
      "updated_at": "2023-03-10T08:36:54+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/e15a3246-705a-486f-8992-4f3693551c5a' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "e15a3246-705a-486f-8992-4f3693551c5a",
        "type": "default_properties",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/92b14ad1-8922-48d4-881b-a53a8b42ca91' \
    --header 'content-type: application/json' \
    --data '{}'
```
