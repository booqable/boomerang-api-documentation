...
```json
  ...
  "data": [
    {
      "id": "59ed0cbe-a6c1-4534-84ad-0bcf8acaf877",
      "type": "default_properties",
      "attributes": {
        "created_at": "2022-05-31T08:25:51+00:00",
        "updated_at": "2022-05-31T08:25:51+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/764e5d83-65ea-4d6f-9d96-e401bb1705b9?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "764e5d83-65ea-4d6f-9d96-e401bb1705b9",
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-05-31T08:25:51+00:00",
      "updated_at": "2022-05-31T08:25:51+00:00",
...
```json
  {
  "data": {
    "id": "ae8aa21c-2180-4a68-b325-ea4ea5741ad0",
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-05-31T08:25:51+00:00",
      "updated_at": "2022-05-31T08:25:51+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/3709f7db-c007-47ce-bdb3-ffa5f851aa1d' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "3709f7db-c007-47ce-bdb3-ffa5f851aa1d",
        "type": "default_properties",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/11ac1fc2-498b-4a2f-9b5d-2d8990f43ec2' \
    --header 'content-type: application/json' \
    --data '{}'
```
