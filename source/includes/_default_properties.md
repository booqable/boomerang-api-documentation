...
```json
  ...
  "data": [
    {
      "id": "090b2ee2-8266-4557-a1bd-d82683e1d65c",
      "type": "default_properties",
      "attributes": {
        "created_at": "2023-02-23T08:54:50+00:00",
        "updated_at": "2023-02-23T08:54:50+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/5f07f1a6-7d42-43b7-9092-636ecebf9735?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "5f07f1a6-7d42-43b7-9092-636ecebf9735",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-23T08:54:50+00:00",
      "updated_at": "2023-02-23T08:54:50+00:00",
...
```json
  {
  "data": {
    "id": "f38e7434-ac29-467e-b038-90ae99c266a3",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-23T08:54:50+00:00",
      "updated_at": "2023-02-23T08:54:50+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/440a3b04-d05b-4fe9-9e0a-d0364542c15c' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "440a3b04-d05b-4fe9-9e0a-d0364542c15c",
        "type": "default_properties",
        "attributes": {
...
```json
  ...
  "data": {
    ...
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-23T08:54:51+00:00",
      "updated_at": "2023-02-23T08:54:51+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "text_field",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/6c632e02-e568-4c8a-91c7-806e85484220' \
    --header 'content-type: application/json' \
    --data '{}'
```
