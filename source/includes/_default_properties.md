...
```json
  ...
  "data": [
    {
      "id": "49f93a9b-fed3-4404-92cf-daee04263c29",
      "type": "default_properties",
      "attributes": {
        "created_at": "2023-02-14T12:46:11+00:00",
        "updated_at": "2023-02-14T12:46:11+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/319da0d2-593e-41c3-8826-0c7efbd10f1b?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "319da0d2-593e-41c3-8826-0c7efbd10f1b",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-14T12:46:11+00:00",
      "updated_at": "2023-02-14T12:46:11+00:00",
...
```json
  {
  "data": {
    "id": "820983f6-f786-47c5-90d9-4bb7527212cd",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-14T12:46:12+00:00",
      "updated_at": "2023-02-14T12:46:12+00:00",
      "name": "Mobile phone",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/6689b6e9-dbda-4e45-aef9-b2b8ab443089' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "6689b6e9-dbda-4e45-aef9-b2b8ab443089",
        "type": "default_properties",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/9f188ccb-ca0e-44c3-a503-901039e24393' \
    --header 'content-type: application/json' \
    --data '{}'
```
