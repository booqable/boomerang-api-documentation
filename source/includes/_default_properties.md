...
```json
  ...
  "data": [
    {
      "id": "ad530660-c9e2-43fc-aa73-974619d61403",
      "type": "default_properties",
      "attributes": {
        "created_at": "2022-07-15T09:23:29+00:00",
        "updated_at": "2022-07-15T09:23:29+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/eb758fd7-f07f-4d3a-8804-ea1b293311dc?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "eb758fd7-f07f-4d3a-8804-ea1b293311dc",
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-07-15T09:23:29+00:00",
      "updated_at": "2022-07-15T09:23:29+00:00",
...
```json
  {
  "data": {
    "id": "ce1e4899-a571-443b-90ad-13846e995dca",
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-07-15T09:23:30+00:00",
      "updated_at": "2022-07-15T09:23:30+00:00",
      "name": "Mobile phone",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/ffeeb59b-3f0f-4445-b66e-8feec1a255bc' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "ffeeb59b-3f0f-4445-b66e-8feec1a255bc",
        "type": "default_properties",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/a4f73fce-f9fc-41eb-a2a4-6ed07e60d8ca' \
    --header 'content-type: application/json' \
    --data '{}'
```
