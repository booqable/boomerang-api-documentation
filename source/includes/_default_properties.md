...
```json
  ...
  "data": [
    {
      "id": "64fb34e1-1e36-4fdb-b364-209d8683354f",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/1d101160-806a-43ea-a764-2f3c4c65f516?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "1d101160-806a-43ea-a764-2f3c4c65f516",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-13T12:13:54+00:00",
      "updated_at": "2023-02-13T12:13:54+00:00",
...
```json
  {
  "data": {
    "id": "00929c32-c631-4491-a53e-f905d5a3f172",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-13T12:13:54+00:00",
      "updated_at": "2023-02-13T12:13:54+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/18d0e061-41a2-45e5-8914-3d8c88363ce1' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "18d0e061-41a2-45e5-8914-3d8c88363ce1",
        "type": "default_properties",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/db41bb62-4d9c-4e6e-bdfe-87578491f9f2' \
    --header 'content-type: application/json' \
    --data '{}'
```
