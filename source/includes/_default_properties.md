...
```json
  ...
  "data": [
    {
      "id": "38d1b1fb-ed8a-45f8-a27b-752064a8545b",
      "type": "default_properties",
      "attributes": {
        "created_at": "2022-11-21T10:28:50+00:00",
        "updated_at": "2022-11-21T10:28:50+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/38095927-260f-41cf-974a-5df4e5d236e2?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "38095927-260f-41cf-974a-5df4e5d236e2",
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-11-21T10:28:50+00:00",
      "updated_at": "2022-11-21T10:28:50+00:00",
...
```json
  {
  "data": {
    "id": "294faf26-4838-4875-bc3d-65b3a106fd3c",
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-11-21T10:28:50+00:00",
      "updated_at": "2022-11-21T10:28:50+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/bfd6d39c-9011-4688-b4e9-092e42fb1651' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "bfd6d39c-9011-4688-b4e9-092e42fb1651",
        "type": "default_properties",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/e049a118-1f34-4e10-b64c-d6c0f4699f06' \
    --header 'content-type: application/json' \
    --data '{}'
```
