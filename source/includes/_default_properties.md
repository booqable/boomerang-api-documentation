...
```json
  ...
  "data": [
    {
      "id": "d37d0a15-ab11-41e1-9053-dfa3ecb1a451",
      "type": "default_properties",
      "attributes": {
        "created_at": "2023-02-01T12:59:41+00:00",
        "updated_at": "2023-02-01T12:59:41+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/6d04362b-a586-4a71-829f-ab47e5fed17b?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "6d04362b-a586-4a71-829f-ab47e5fed17b",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-01T12:59:42+00:00",
      "updated_at": "2023-02-01T12:59:42+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "phone",
...
```json
  {
  "data": {
    "id": "e0bc987f-815a-4f9c-a945-4e4c74dbc2e0",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-01T12:59:42+00:00",
      "updated_at": "2023-02-01T12:59:42+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/012ac150-3320-48fe-b219-13399118f8b4' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "012ac150-3320-48fe-b219-13399118f8b4",
        "type": "default_properties",
        "attributes": {
...
```json
  ...
  "data": {
    ...
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-01T12:59:43+00:00",
      "updated_at": "2023-02-01T12:59:43+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "text_field",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/22fb81f7-dc10-4bbb-bf63-cb617202208f' \
    --header 'content-type: application/json' \
    --data '{}'
```
