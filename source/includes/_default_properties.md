...
```json
  ...
  "data": [
    {
      "id": "2eea0920-7565-4919-af82-f4d2ff21ff21",
      "type": "default_properties",
      "attributes": {
        "created_at": "2023-02-16T09:14:44+00:00",
        "updated_at": "2023-02-16T09:14:44+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/ce5ca916-02fd-4dd5-82db-7506d46909b1?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "ce5ca916-02fd-4dd5-82db-7506d46909b1",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-16T09:14:44+00:00",
      "updated_at": "2023-02-16T09:14:44+00:00",
...
```json
  {
  "data": {
    "id": "b21228f7-9798-4b85-a446-aea40cc7be4d",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-16T09:14:45+00:00",
      "updated_at": "2023-02-16T09:14:45+00:00",
      "name": "Mobile phone",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/3cf0d950-df23-459a-a83a-8a18d25655f1' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "3cf0d950-df23-459a-a83a-8a18d25655f1",
        "type": "default_properties",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/0dede942-c319-49ea-bc7a-a6b20a21827d' \
    --header 'content-type: application/json' \
    --data '{}'
```
