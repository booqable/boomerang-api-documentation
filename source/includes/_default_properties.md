...
```json
  ...
  "data": [
    {
      "id": "b820644e-51e1-4db7-91f5-773af1baab32",
      "type": "default_properties",
      "attributes": {
        "created_at": "2023-02-09T10:18:45+00:00",
        "updated_at": "2023-02-09T10:18:45+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/972ce12e-35bf-4a8d-9280-7cea28cebf57?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "972ce12e-35bf-4a8d-9280-7cea28cebf57",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-09T10:18:45+00:00",
      "updated_at": "2023-02-09T10:18:45+00:00",
...
```json
  {
  "data": {
    "id": "b4c66bb6-71d0-432c-9a72-ae452903b43a",
    "type": "default_properties",
    "attributes": {
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/4a59e2dd-1986-4409-abee-df8ded06c40e' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "4a59e2dd-1986-4409-abee-df8ded06c40e",
        "type": "default_properties",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/75f088eb-9c5f-43d0-8840-1c8c2c7fda00' \
    --header 'content-type: application/json' \
    --data '{}'
```
