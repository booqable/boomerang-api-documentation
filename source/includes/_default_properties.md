...
```json
  ...
  "data": [
    {
      "id": "459ebca2-b773-4832-b4d7-4be133154e8d",
      "type": "default_properties",
      "attributes": {
        "created_at": "2021-12-07T11:01:10+00:00",
        "updated_at": "2021-12-07T11:01:10+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/5e1483f7-10b7-4be8-ae3b-64fae339fc2f?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "5e1483f7-10b7-4be8-ae3b-64fae339fc2f",
    "type": "default_properties",
    "attributes": {
      "created_at": "2021-12-07T11:01:10+00:00",
      "updated_at": "2021-12-07T11:01:10+00:00",
...
```json
  {
  "data": {
    "id": "214d6340-0da1-45fb-9874-a6a98c054014",
    "type": "default_properties",
    "attributes": {
      "created_at": "2021-12-07T11:01:11+00:00",
      "updated_at": "2021-12-07T11:01:11+00:00",
      "name": "Mobile phone",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/45d61e0c-583e-4c72-a3d8-def7f6ac1822' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "45d61e0c-583e-4c72-a3d8-def7f6ac1822",
        "type": "default_properties",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/ca29219e-89f1-4d20-b983-9d80b6bb55d5' \
    --header 'content-type: application/json' \
    --data '{}'
```
