...
```json
  ...
  "data": [
    {
      "id": "f32c63c2-c380-4981-af43-d59fa7c9f46f",
      "type": "default_properties",
      "attributes": {
        "created_at": "2022-07-14T12:00:31+00:00",
        "updated_at": "2022-07-14T12:00:31+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/2fdfee2f-417e-42e2-9d78-19d691767c26?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "2fdfee2f-417e-42e2-9d78-19d691767c26",
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-07-14T12:00:32+00:00",
      "updated_at": "2022-07-14T12:00:32+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "phone",
...
```json
  {
  "data": {
    "id": "b8c21673-61a4-44cd-a725-968e605ea7e3",
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-07-14T12:00:32+00:00",
      "updated_at": "2022-07-14T12:00:32+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/f44bf803-01be-405f-98ef-8ac1fe30ce5d' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "f44bf803-01be-405f-98ef-8ac1fe30ce5d",
        "type": "default_properties",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/7f380607-56c6-4f64-a5aa-821b43fd035f' \
    --header 'content-type: application/json' \
    --data '{}'
```
