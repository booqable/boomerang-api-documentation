...
```json
  ...
  "data": [
    {
      "id": "845d6d30-70c8-4e69-b07c-4ff96d1b8ed2",
      "type": "default_properties",
      "attributes": {
        "created_at": "2022-06-30T09:44:41+00:00",
        "updated_at": "2022-06-30T09:44:41+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/4faa545f-a03b-4e61-ac63-e5e841811158?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "4faa545f-a03b-4e61-ac63-e5e841811158",
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-06-30T09:44:41+00:00",
      "updated_at": "2022-06-30T09:44:41+00:00",
...
```json
  {
  "data": {
    "id": "1c15293c-cce6-4e62-a5a3-cf529530800b",
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-06-30T09:44:42+00:00",
      "updated_at": "2022-06-30T09:44:42+00:00",
      "name": "Mobile phone",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/60037f9e-3714-40f8-8244-c7c8162cb682' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "60037f9e-3714-40f8-8244-c7c8162cb682",
        "type": "default_properties",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/4a504d10-b689-4c46-96ef-9c718dcda69a' \
    --header 'content-type: application/json' \
    --data '{}'
```
