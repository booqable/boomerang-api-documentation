...
```json
  ...
  "data": [
    {
      "id": "3b4e06a3-6d62-4d5b-889a-b220a00d325d",
      "type": "default_properties",
      "attributes": {
        "created_at": "2023-02-03T08:14:21+00:00",
        "updated_at": "2023-02-03T08:14:21+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/31cc0c75-db42-4554-b1aa-906e33163c37?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "31cc0c75-db42-4554-b1aa-906e33163c37",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-03T08:14:22+00:00",
      "updated_at": "2023-02-03T08:14:22+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "phone",
...
```json
  {
  "data": {
    "id": "8e07225a-b1d8-4928-9521-2a7c72744f98",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-03T08:14:22+00:00",
      "updated_at": "2023-02-03T08:14:22+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/bd7ab853-2548-453a-9d54-10858c1800d7' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "bd7ab853-2548-453a-9d54-10858c1800d7",
        "type": "default_properties",
        "attributes": {
...
```json
  ...
  "data": {
    ...
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-03T08:14:23+00:00",
      "updated_at": "2023-02-03T08:14:23+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "text_field",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/8a2657b4-e5ad-4884-9f5d-83893cbd7baf' \
    --header 'content-type: application/json' \
    --data '{}'
```
