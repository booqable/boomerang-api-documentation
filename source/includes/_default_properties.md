...
```json
  ...
  "data": [
    {
      "id": "a2149e8d-09fb-4425-853f-6e399eac9772",
      "type": "default_properties",
      "attributes": {
        "created_at": "2023-02-28T08:11:07+00:00",
        "updated_at": "2023-02-28T08:11:07+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/a65b6326-9316-4151-8c15-a5fdb5d8d343?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "a65b6326-9316-4151-8c15-a5fdb5d8d343",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-28T08:11:07+00:00",
      "updated_at": "2023-02-28T08:11:07+00:00",
...
```json
  {
  "data": {
    "id": "8d74a083-96f5-458e-9bfc-48802812345f",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-28T08:11:08+00:00",
      "updated_at": "2023-02-28T08:11:08+00:00",
      "name": "Mobile phone",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/ac46e9c4-2d5c-46d4-a07b-aec1e2d7cf7c' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "ac46e9c4-2d5c-46d4-a07b-aec1e2d7cf7c",
        "type": "default_properties",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/266d5a3a-3dd0-434c-8c77-cb516e71247c' \
    --header 'content-type: application/json' \
    --data '{}'
```
