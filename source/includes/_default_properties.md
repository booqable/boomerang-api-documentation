...
```json
  ...
  "data": [
    {
      "id": "619dcf56-d847-4658-aae4-5075a962b2b4",
      "type": "default_properties",
      "attributes": {
        "created_at": "2023-02-02T07:55:59+00:00",
        "updated_at": "2023-02-02T07:55:59+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/a501609c-fdca-47cd-9a47-65eba43a34c2?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "a501609c-fdca-47cd-9a47-65eba43a34c2",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-02T07:55:59+00:00",
      "updated_at": "2023-02-02T07:55:59+00:00",
...
```json
  {
  "data": {
    "id": "54ca58b8-6c78-4a65-89c4-0e0ed65a5c81",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-02T07:55:59+00:00",
      "updated_at": "2023-02-02T07:55:59+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/a6cad0d2-7fb6-418f-800e-104a332c6afd' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "a6cad0d2-7fb6-418f-800e-104a332c6afd",
        "type": "default_properties",
        "attributes": {
...
```json
  ...
  "data": {
    ...
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-02T07:56:00+00:00",
      "updated_at": "2023-02-02T07:56:00+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "text_field",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/ee4645f2-c110-4785-b71e-665f2b371717' \
    --header 'content-type: application/json' \
    --data '{}'
```
