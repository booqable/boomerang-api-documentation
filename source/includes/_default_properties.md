...
```json
  ...
  "data": [
    {
      "id": "69830683-974c-458f-bb14-9a529a8a4ece",
      "type": "default_properties",
      "attributes": {
        "created_at": "2023-02-16T09:20:59+00:00",
        "updated_at": "2023-02-16T09:20:59+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/071bbc04-a331-4b7b-8fb5-bc0e596d816c?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "071bbc04-a331-4b7b-8fb5-bc0e596d816c",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-16T09:20:59+00:00",
      "updated_at": "2023-02-16T09:20:59+00:00",
...
```json
  {
  "data": {
    "id": "f8150c23-1541-4609-9113-8ebab15f6f51",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-16T09:21:00+00:00",
      "updated_at": "2023-02-16T09:21:00+00:00",
      "name": "Mobile phone",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/d9f60241-0a70-4ea5-beeb-95a55109047b' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "d9f60241-0a70-4ea5-beeb-95a55109047b",
        "type": "default_properties",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/308673e7-eeb2-4aee-bc68-5bf9f95af65a' \
    --header 'content-type: application/json' \
    --data '{}'
```
