...
```json
  ...
  "data": [
    {
      "id": "ae540dc7-97a5-48d6-afa2-6879293e3cd7",
      "type": "default_properties",
      "attributes": {
        "created_at": "2022-07-14T10:49:08+00:00",
        "updated_at": "2022-07-14T10:49:08+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/7cb23974-f590-4666-be02-f5feac4a4da5?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "7cb23974-f590-4666-be02-f5feac4a4da5",
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-07-14T10:49:08+00:00",
      "updated_at": "2022-07-14T10:49:08+00:00",
...
```json
  {
  "data": {
    "id": "c2e4a4c8-b41d-46ef-9c2a-231eae313b38",
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-07-14T10:49:08+00:00",
      "updated_at": "2022-07-14T10:49:08+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/31c2b266-9478-4eda-ad41-df2770b97826' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "31c2b266-9478-4eda-ad41-df2770b97826",
        "type": "default_properties",
        "attributes": {
...
```json
  ...
  "data": {
    ...
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-07-14T10:49:09+00:00",
      "updated_at": "2022-07-14T10:49:09+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "text_field",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/778a8bed-1775-4995-a8fd-8cff3b3a4069' \
    --header 'content-type: application/json' \
    --data '{}'
```
