...
```json
  ...
  "data": [
    {
      "id": "9507fde1-b88a-472c-8e4e-b68ea4aaa55b",
      "type": "default_properties",
      "attributes": {
        "created_at": "2022-06-30T08:46:02+00:00",
        "updated_at": "2022-06-30T08:46:02+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/9e982e0a-819f-4bd2-b9a1-6db0480ccf7b?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "9e982e0a-819f-4bd2-b9a1-6db0480ccf7b",
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-06-30T08:46:02+00:00",
      "updated_at": "2022-06-30T08:46:02+00:00",
...
```json
  {
  "data": {
    "id": "0672191b-eb29-400b-9284-2593a89dcdc0",
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-06-30T08:46:03+00:00",
      "updated_at": "2022-06-30T08:46:03+00:00",
      "name": "Mobile phone",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/917d5f45-e2ea-4a31-ab68-edccef3ab45d' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "917d5f45-e2ea-4a31-ab68-edccef3ab45d",
        "type": "default_properties",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/af2e0846-4fdb-4f87-90d3-3c29a582ecd1' \
    --header 'content-type: application/json' \
    --data '{}'
```
