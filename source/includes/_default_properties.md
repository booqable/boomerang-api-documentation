...
```json
  ...
  "data": [
    {
      "id": "e9554179-7e70-44b0-a8d3-8cfe8c58c191",
      "type": "default_properties",
      "attributes": {
        "created_at": "2023-02-08T08:35:22+00:00",
        "updated_at": "2023-02-08T08:35:22+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/57775705-14d2-4828-b12e-8e22e3e6a194?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "57775705-14d2-4828-b12e-8e22e3e6a194",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-08T08:35:22+00:00",
      "updated_at": "2023-02-08T08:35:22+00:00",
...
```json
  {
  "data": {
    "id": "c784c799-a3eb-4da4-be48-773c02f96053",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-08T08:35:27+00:00",
      "updated_at": "2023-02-08T08:35:27+00:00",
      "name": "Mobile phone",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/866bad1b-a3df-48c8-91e3-a193cc005059' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "866bad1b-a3df-48c8-91e3-a193cc005059",
        "type": "default_properties",
        "attributes": {
...
```json
  ...
  "data": {
    ...
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-08T08:35:28+00:00",
      "updated_at": "2023-02-08T08:35:28+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "text_field",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/8e2bffd4-0150-4790-82d6-857bde450894' \
    --header 'content-type: application/json' \
    --data '{}'
```
