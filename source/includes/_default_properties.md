...
```json
  ...
  "data": [
    {
      "id": "31f544cc-7d7b-4829-a7fb-e6cf75feaf88",
      "type": "default_properties",
      "attributes": {
        "created_at": "2023-02-07T15:00:07+00:00",
        "updated_at": "2023-02-07T15:00:07+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/0589e58d-df62-4981-8e8f-f020a1a38768?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "0589e58d-df62-4981-8e8f-f020a1a38768",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-07T15:00:07+00:00",
      "updated_at": "2023-02-07T15:00:07+00:00",
...
```json
  {
  "data": {
    "id": "7c079ea7-21e3-4553-89c4-db044a3e81ee",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-07T15:00:08+00:00",
      "updated_at": "2023-02-07T15:00:08+00:00",
      "name": "Mobile phone",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/c93e6090-715e-4a77-b831-fefc9ab3f13c' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "c93e6090-715e-4a77-b831-fefc9ab3f13c",
        "type": "default_properties",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/9ef78498-4a6d-4367-8aa2-e4c1bcf5a859' \
    --header 'content-type: application/json' \
    --data '{}'
```
