...
```json
  ...
  "data": [
    {
      "id": "600358cb-34f2-4e8d-af3a-a307a7c89a5f",
      "type": "default_properties",
      "attributes": {
        "created_at": "2023-01-12T14:26:51+00:00",
        "updated_at": "2023-01-12T14:26:51+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/59c4d76c-71de-439a-b36d-89bbb21e270f?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "59c4d76c-71de-439a-b36d-89bbb21e270f",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-01-12T14:26:52+00:00",
      "updated_at": "2023-01-12T14:26:52+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "phone",
...
```json
  {
  "data": {
    "id": "3a972196-1b1d-48e9-a36b-6181c460e3de",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-01-12T14:26:52+00:00",
      "updated_at": "2023-01-12T14:26:52+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/11f456ec-5395-430e-8afc-a647cbaa7f2f' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "11f456ec-5395-430e-8afc-a647cbaa7f2f",
        "type": "default_properties",
        "attributes": {
...
```json
  ...
  "data": {
    ...
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-01-12T14:26:53+00:00",
      "updated_at": "2023-01-12T14:26:53+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "text_field",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/61636738-6fa4-4f1e-a80e-975a5562dc76' \
    --header 'content-type: application/json' \
    --data '{}'
```
