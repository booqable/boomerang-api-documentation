...
```json
  ...
  "data": [
    {
      "id": "bc4df5df-d095-437c-912a-51bbcc0aa69e",
      "type": "default_properties",
      "attributes": {
        "created_at": "2022-07-14T21:13:41+00:00",
        "updated_at": "2022-07-14T21:13:41+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/641c0350-d73f-422d-8694-5ad449aa9b0c?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "641c0350-d73f-422d-8694-5ad449aa9b0c",
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-07-14T21:13:42+00:00",
      "updated_at": "2022-07-14T21:13:42+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "phone",
...
```json
  {
  "data": {
    "id": "32da2225-1d47-43df-bd1d-78c7d79db974",
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-07-14T21:13:42+00:00",
      "updated_at": "2022-07-14T21:13:42+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/51f07eb8-f9fc-4dcb-9431-d08a8b17c397' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "51f07eb8-f9fc-4dcb-9431-d08a8b17c397",
        "type": "default_properties",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/40628515-d15e-4d89-a8e7-38c6f48a0c6b' \
    --header 'content-type: application/json' \
    --data '{}'
```
