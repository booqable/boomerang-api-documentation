...
```json
  ...
  "data": [
    {
      "id": "049dadaf-dfd1-4bf9-b40c-2d729579299d",
      "type": "default_properties",
      "attributes": {
        "created_at": "2023-03-02T12:19:55+00:00",
        "updated_at": "2023-03-02T12:19:55+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/98f01983-cd3b-4441-8482-402755e0590d?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "98f01983-cd3b-4441-8482-402755e0590d",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-03-02T12:19:56+00:00",
      "updated_at": "2023-03-02T12:19:56+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "phone",
...
```json
  {
  "data": {
    "id": "6e67e313-bc96-4593-b686-cdae08a28815",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-03-02T12:19:56+00:00",
      "updated_at": "2023-03-02T12:19:56+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/c3e855f6-5cb7-407a-aa60-d0805bd09db0' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "c3e855f6-5cb7-407a-aa60-d0805bd09db0",
        "type": "default_properties",
        "attributes": {
...
```json
  ...
  "data": {
    ...
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-03-02T12:19:57+00:00",
      "updated_at": "2023-03-02T12:19:57+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "text_field",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/726156db-b32e-44e2-803b-b56fa3406336' \
    --header 'content-type: application/json' \
    --data '{}'
```
