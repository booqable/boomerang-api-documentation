...
```json
  ...
  "data": [
    {
      "id": "97466bf5-97f6-4370-919b-1626ff2cc06c",
      "type": "default_properties",
      "attributes": {
        "created_at": "2023-02-03T11:09:51+00:00",
        "updated_at": "2023-02-03T11:09:51+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/eeac6890-51dc-454c-aceb-50011a114e47?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "eeac6890-51dc-454c-aceb-50011a114e47",
    "type": "default_properties",
    "attributes": {
...
```json
  {
  "data": {
    "id": "390f9fa0-b8ad-43b3-8fa8-84818b1cddf7",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-03T11:09:52+00:00",
      "updated_at": "2023-02-03T11:09:52+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/2f451f81-b7dd-42b1-8ce3-56ec9eb033ae' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "2f451f81-b7dd-42b1-8ce3-56ec9eb033ae",
        "type": "default_properties",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/2397f9bf-482a-4d3d-ad56-f98686eb6902' \
    --header 'content-type: application/json' \
    --data '{}'
```
