...
```json
  ...
  "data": [
    {
      "id": "89affae2-4dec-4640-8592-ccb1ce5f4536",
      "type": "default_properties",
      "attributes": {
        "created_at": "2023-02-09T09:27:05+00:00",
        "updated_at": "2023-02-09T09:27:05+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/01d61565-2c58-46ea-9526-4cdd36858b8b?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "01d61565-2c58-46ea-9526-4cdd36858b8b",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-09T09:27:05+00:00",
      "updated_at": "2023-02-09T09:27:05+00:00",
...
```json
  {
  "data": {
    "id": "7f7ae448-4f86-4532-bbb2-0e3f63a8d66e",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-09T09:27:06+00:00",
      "updated_at": "2023-02-09T09:27:06+00:00",
      "name": "Mobile phone",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/50ece7e7-84c1-4c86-ae41-0931fe7eaa8f' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "50ece7e7-84c1-4c86-ae41-0931fe7eaa8f",
        "type": "default_properties",
        "attributes": {
...
```json
  ...
  "data": {
    ...
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-09T09:27:07+00:00",
      "updated_at": "2023-02-09T09:27:07+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "text_field",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/71b73af1-cb39-4a58-8eaf-bc7d58d6f056' \
    --header 'content-type: application/json' \
    --data '{}'
```
