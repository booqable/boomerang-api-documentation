...
```json
  ...
  "data": [
    {
      "id": "0ce65586-7d7b-49f8-96bf-1f18e2542576",
      "type": "default_properties",
      "attributes": {
        "created_at": "2023-02-02T15:25:17+00:00",
        "updated_at": "2023-02-02T15:25:17+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/f842ea5e-c84d-4d65-9892-6836f16e1666?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "f842ea5e-c84d-4d65-9892-6836f16e1666",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-02T15:25:18+00:00",
      "updated_at": "2023-02-02T15:25:18+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "phone",
...
```json
  {
  "data": {
    "id": "9bcf1ed9-bbb5-4bdc-8d33-c4f0d508b3f5",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-02T15:25:18+00:00",
      "updated_at": "2023-02-02T15:25:18+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/21348c73-dee6-47a9-956e-ce20200dd9f0' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "21348c73-dee6-47a9-956e-ce20200dd9f0",
        "type": "default_properties",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/328e99e3-a80d-4293-be36-394f0318651c' \
    --header 'content-type: application/json' \
    --data '{}'
```
