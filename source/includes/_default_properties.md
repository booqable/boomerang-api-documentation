...
```json
  ...
  "data": [
    {
      "id": "d706f1b1-62e8-4fab-be18-3d49e763b150",
      "type": "default_properties",
      "attributes": {
        "created_at": "2022-05-04T10:04:37+00:00",
        "updated_at": "2022-05-04T10:04:37+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/06dacadc-ccc1-4522-a59d-6e15334ab7b8?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "06dacadc-ccc1-4522-a59d-6e15334ab7b8",
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-05-04T10:04:37+00:00",
      "updated_at": "2022-05-04T10:04:37+00:00",
...
```json
  {
  "data": {
    "id": "5d67b177-e391-40ca-89c1-a019016f5964",
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-05-04T10:04:37+00:00",
      "updated_at": "2022-05-04T10:04:37+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/f6111faa-e0a8-4150-8e4b-991a0d1b54af' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "f6111faa-e0a8-4150-8e4b-991a0d1b54af",
        "type": "default_properties",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/1dfae244-5e2c-4e30-9e12-58333ed58d00' \
    --header 'content-type: application/json' \
    --data '{}'
```
