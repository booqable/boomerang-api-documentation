...
```json
  ...
  "data": [
    {
      "id": "06eeaeff-f49e-4c22-bc17-8e38b60e34bc",
      "type": "default_properties",
      "attributes": {
        "created_at": "2023-02-09T15:55:23+00:00",
        "updated_at": "2023-02-09T15:55:23+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/771b2666-ae72-4ef9-8d8e-36efea7f47e8?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "771b2666-ae72-4ef9-8d8e-36efea7f47e8",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-09T15:55:24+00:00",
      "updated_at": "2023-02-09T15:55:24+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "phone",
...
```json
  {
  "data": {
    "id": "2222afa3-988c-4728-aca1-4c8d22ad4ad0",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-09T15:55:25+00:00",
      "updated_at": "2023-02-09T15:55:25+00:00",
      "name": "Mobile phone",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/08983e2e-2f98-4ad3-a5a7-b28109623e98' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "08983e2e-2f98-4ad3-a5a7-b28109623e98",
        "type": "default_properties",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/9ba16b56-b89f-4a63-a3b2-cb506d904854' \
    --header 'content-type: application/json' \
    --data '{}'
```
