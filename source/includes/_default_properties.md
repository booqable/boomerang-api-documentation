...
```json
  ...
  "data": [
    {
      "id": "3d36ac91-4d6f-458a-898e-448adf45219f",
      "type": "default_properties",
      "attributes": {
        "created_at": "2023-02-02T14:14:45+00:00",
        "updated_at": "2023-02-02T14:14:45+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/a7b3c1eb-4317-4a13-811f-c35784d88319?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "a7b3c1eb-4317-4a13-811f-c35784d88319",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-02T14:14:45+00:00",
      "updated_at": "2023-02-02T14:14:45+00:00",
...
```json
  {
  "data": {
    "id": "46b03fd7-baa3-4f26-8c7c-9433ac1469b8",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-02T14:14:46+00:00",
      "updated_at": "2023-02-02T14:14:46+00:00",
      "name": "Mobile phone",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/dd7eee25-8bab-4a68-88fa-83a40e8acf3a' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "dd7eee25-8bab-4a68-88fa-83a40e8acf3a",
        "type": "default_properties",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/b7aa97ab-b3a7-495f-9f7a-cd772aed9d0b' \
    --header 'content-type: application/json' \
    --data '{}'
```
