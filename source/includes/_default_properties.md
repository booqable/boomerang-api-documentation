...
```json
  ...
  "data": [
    {
      "id": "ad545f9a-bebc-4894-90da-cb20cda2ca6e",
      "type": "default_properties",
      "attributes": {
        "created_at": "2023-02-01T13:18:45+00:00",
        "updated_at": "2023-02-01T13:18:45+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/e7369805-1b5b-4400-94db-b5ffa7233157?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "e7369805-1b5b-4400-94db-b5ffa7233157",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-01T13:18:45+00:00",
      "updated_at": "2023-02-01T13:18:45+00:00",
...
```json
  {
  "data": {
    "id": "b7fbb007-296a-4ac8-9eb0-9b005734ecd7",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-01T13:18:46+00:00",
      "updated_at": "2023-02-01T13:18:46+00:00",
      "name": "Mobile phone",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/e732a1c2-1d56-42b1-a7bd-a6b9be292721' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "e732a1c2-1d56-42b1-a7bd-a6b9be292721",
        "type": "default_properties",
        "attributes": {
...
```json
  ...
  "data": {
    ...
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-01T13:18:47+00:00",
      "updated_at": "2023-02-01T13:18:47+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "text_field",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/7ce59d18-8e67-4c74-831d-150e941bd9cc' \
    --header 'content-type: application/json' \
    --data '{}'
```
