...
```json
  ...
  "data": [
    {
      "id": "29913683-a457-47c5-aaaf-e7ff4cdad3bb",
      "type": "default_properties",
      "attributes": {
        "created_at": "2022-07-12T08:47:25+00:00",
        "updated_at": "2022-07-12T08:47:25+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/85b616fe-e305-4db9-be19-40b41fd34fc1?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "85b616fe-e305-4db9-be19-40b41fd34fc1",
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-07-12T08:47:25+00:00",
      "updated_at": "2022-07-12T08:47:25+00:00",
...
```json
  {
  "data": {
    "id": "aba86d4c-72fd-4f33-8a49-b3b59b4c1bde",
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-07-12T08:47:26+00:00",
      "updated_at": "2022-07-12T08:47:26+00:00",
      "name": "Mobile phone",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/58631bcd-3e6c-4e00-be2f-8ad29d89fc80' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "58631bcd-3e6c-4e00-be2f-8ad29d89fc80",
        "type": "default_properties",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/4d0f8985-6945-4242-813c-fab31ea20d91' \
    --header 'content-type: application/json' \
    --data '{}'
```
