...
```json
  ...
  "data": [
    {
      "id": "f5fcf48f-6aa9-4a8a-afdb-8908a82ca29b",
      "type": "default_properties",
      "attributes": {
        "created_at": "2023-02-24T14:55:48+00:00",
        "updated_at": "2023-02-24T14:55:48+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/6e34a13c-8e60-4fb8-b9b3-0c2e79501bec?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "6e34a13c-8e60-4fb8-b9b3-0c2e79501bec",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-24T14:55:48+00:00",
      "updated_at": "2023-02-24T14:55:48+00:00",
...
```json
  {
  "data": {
    "id": "c7494a21-99b6-4917-986e-2ed72e36a32b",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-24T14:55:49+00:00",
      "updated_at": "2023-02-24T14:55:49+00:00",
      "name": "Mobile phone",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/d815c1f8-472d-46a0-b5cc-99ecdf5ad7c5' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "d815c1f8-472d-46a0-b5cc-99ecdf5ad7c5",
        "type": "default_properties",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/f8dc63b6-c1d4-47a6-aa4e-b7dd1ea6372d' \
    --header 'content-type: application/json' \
    --data '{}'
```
