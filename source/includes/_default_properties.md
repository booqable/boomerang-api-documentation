...
```json
  ...
  "data": [
    {
      "id": "83674d38-fa3f-4bce-8608-1fe2e10637fc",
      "type": "default_properties",
      "attributes": {
        "created_at": "2022-12-08T11:02:59+00:00",
        "updated_at": "2022-12-08T11:02:59+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/a5e0ae0c-c406-41ef-9acd-c7634cac7484?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "a5e0ae0c-c406-41ef-9acd-c7634cac7484",
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-12-08T11:03:00+00:00",
      "updated_at": "2022-12-08T11:03:00+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "phone",
...
```json
  {
  "data": {
    "id": "a96294ca-cca0-4fa1-af67-b091f3c67dd8",
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-12-08T11:03:01+00:00",
      "updated_at": "2022-12-08T11:03:01+00:00",
      "name": "Mobile phone",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/4d190a70-425d-4617-ac44-47280ac343a8' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "4d190a70-425d-4617-ac44-47280ac343a8",
        "type": "default_properties",
        "attributes": {
...
```json
  ...
  "data": {
    ...
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-12-08T11:03:02+00:00",
      "updated_at": "2022-12-08T11:03:02+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "text_field",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/d9ffc7c4-d81f-46a1-9354-8f87c20fbd57' \
    --header 'content-type: application/json' \
    --data '{}'
```
