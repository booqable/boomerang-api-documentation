...
```json
  ...
  "data": [
    {
      "id": "4f81dfd6-32a8-4d2b-acb5-3b66adc29614",
      "type": "default_properties",
      "attributes": {
        "created_at": "2023-01-25T12:34:35+00:00",
        "updated_at": "2023-01-25T12:34:35+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/fb5d6b1b-c543-4b5a-87a9-9584747d9f78?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "fb5d6b1b-c543-4b5a-87a9-9584747d9f78",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-01-25T12:34:36+00:00",
      "updated_at": "2023-01-25T12:34:36+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "phone",
...
```json
  {
  "data": {
    "id": "3d7096be-555c-49b1-a6a9-299bc38f47bf",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-01-25T12:34:36+00:00",
      "updated_at": "2023-01-25T12:34:36+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/e73d73f1-1790-4b0c-92cd-e1f4729c48c5' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "e73d73f1-1790-4b0c-92cd-e1f4729c48c5",
        "type": "default_properties",
        "attributes": {
...
```json
  ...
  "data": {
    ...
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-01-25T12:34:37+00:00",
      "updated_at": "2023-01-25T12:34:37+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "text_field",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/ceb6b4ca-37e5-4881-a787-3e1259daf710' \
    --header 'content-type: application/json' \
    --data '{}'
```
