...
```json
  ...
  "data": [
    {
      "id": "063f5036-2504-479c-95e7-a5defe56ae7c",
      "type": "default_properties",
      "attributes": {
        "created_at": "2023-02-09T09:39:41+00:00",
        "updated_at": "2023-02-09T09:39:41+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/0e9971a2-39cc-45b8-9428-297d9daed93e?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "0e9971a2-39cc-45b8-9428-297d9daed93e",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-09T09:39:41+00:00",
      "updated_at": "2023-02-09T09:39:41+00:00",
...
```json
  {
  "data": {
    "id": "e3faa9d6-ba65-44fb-a6f2-d443c183f4dc",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-09T09:39:42+00:00",
      "updated_at": "2023-02-09T09:39:42+00:00",
      "name": "Mobile phone",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/78c74234-a996-4b4a-92e3-a4c78d3eff23' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "78c74234-a996-4b4a-92e3-a4c78d3eff23",
        "type": "default_properties",
        "attributes": {
...
```json
  ...
  "data": {
    ...
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-09T09:39:43+00:00",
      "updated_at": "2023-02-09T09:39:43+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "text_field",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/4e6951da-dc7e-4adb-986b-bc73120a920a' \
    --header 'content-type: application/json' \
    --data '{}'
```
