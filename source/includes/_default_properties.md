...
```json
  ...
  "data": [
    {
      "id": "10d82e07-58c8-4347-83cf-95ec789e29eb",
      "type": "default_properties",
      "attributes": {
        "created_at": "2023-03-09T09:33:55+00:00",
        "updated_at": "2023-03-09T09:33:55+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/dd9c9b39-8afb-4913-8356-c68c5cd90bd2?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "dd9c9b39-8afb-4913-8356-c68c5cd90bd2",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-03-09T09:33:55+00:00",
      "updated_at": "2023-03-09T09:33:55+00:00",
...
```json
  {
  "data": {
    "id": "85d43153-7059-4b68-b65c-f9abc6b74da9",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-03-09T09:33:55+00:00",
      "updated_at": "2023-03-09T09:33:55+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/f75198c1-2670-459f-8ba8-ae298faf1bfc' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "f75198c1-2670-459f-8ba8-ae298faf1bfc",
        "type": "default_properties",
        "attributes": {
...
```json
  ...
  "data": {
    ...
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-03-09T09:33:56+00:00",
      "updated_at": "2023-03-09T09:33:56+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "text_field",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/74731d69-0788-4f7e-9119-0288defebb00' \
    --header 'content-type: application/json' \
    --data '{}'
```
