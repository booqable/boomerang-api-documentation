...
```json
  ...
  "data": [
    {
      "id": "7383b04d-02ee-496c-8ffa-8e2ff6a57914",
      "type": "default_properties",
      "attributes": {
        "created_at": "2023-02-09T10:10:39+00:00",
        "updated_at": "2023-02-09T10:10:39+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/53c1960e-5a96-424e-bb4d-c9bfc8e739fc?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "53c1960e-5a96-424e-bb4d-c9bfc8e739fc",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-09T10:10:40+00:00",
      "updated_at": "2023-02-09T10:10:40+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "phone",
...
```json
  {
  "data": {
    "id": "45fc9132-8f1b-4ce3-8afd-2a8821046054",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-09T10:10:40+00:00",
      "updated_at": "2023-02-09T10:10:40+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/63cb0b57-b7b9-4b47-b9f1-3de5bb7ea4bd' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "63cb0b57-b7b9-4b47-b9f1-3de5bb7ea4bd",
        "type": "default_properties",
        "attributes": {
...
```json
  ...
  "data": {
    ...
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-09T10:10:41+00:00",
      "updated_at": "2023-02-09T10:10:41+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "text_field",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/067461ec-6699-4e6d-99eb-8af0fa6a4603' \
    --header 'content-type: application/json' \
    --data '{}'
```
