...
```json
  ...
  "data": [
    {
      "id": "c9907063-82b4-4ad3-8961-d09132c50976",
      "type": "default_properties",
      "attributes": {
        "created_at": "2022-10-13T12:37:27+00:00",
        "updated_at": "2022-10-13T12:37:27+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/5de3b749-631b-4a4a-8048-a3e74a471a09?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "5de3b749-631b-4a4a-8048-a3e74a471a09",
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-10-13T12:37:28+00:00",
      "updated_at": "2022-10-13T12:37:28+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "phone",
...
```json
  {
  "data": {
    "id": "20910db7-6e4d-493d-946e-d825e0956803",
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-10-13T12:37:28+00:00",
      "updated_at": "2022-10-13T12:37:28+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/765216df-3ab3-493c-9ab4-222f949153d2' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "765216df-3ab3-493c-9ab4-222f949153d2",
        "type": "default_properties",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/b2c28eb8-c1fc-4e7c-a3d6-42ad6c38b6f2' \
    --header 'content-type: application/json' \
    --data '{}'
```
