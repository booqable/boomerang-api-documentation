...
```json
  ...
  "data": [
    {
      "id": "26e57453-75ec-4b1f-bfc0-23eb0b1f84e3",
      "type": "default_properties",
      "attributes": {
        "created_at": "2022-04-08T17:51:46+00:00",
        "updated_at": "2022-04-08T17:51:46+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/0d114b3f-5601-4942-8112-4d725618ce2f?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "0d114b3f-5601-4942-8112-4d725618ce2f",
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-04-08T17:51:46+00:00",
      "updated_at": "2022-04-08T17:51:46+00:00",
...
```json
  {
  "data": {
    "id": "925fb083-8b05-41d7-afe0-c61c73fd72e1",
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-04-08T17:51:47+00:00",
      "updated_at": "2022-04-08T17:51:47+00:00",
      "name": "Mobile phone",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/be5e75c7-f112-4452-9f4c-5371b1f8fb6d' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "be5e75c7-f112-4452-9f4c-5371b1f8fb6d",
        "type": "default_properties",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/3516d608-4d8b-47d2-aff0-00f4396fcb59' \
    --header 'content-type: application/json' \
    --data '{}'
```
