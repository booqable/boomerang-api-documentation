...
```json
  ...
  "data": [
    {
      "id": "b20809d3-ce5e-4e0e-bfc4-3a3103a05777",
      "type": "default_properties",
      "attributes": {
        "created_at": "2023-02-08T09:44:45+00:00",
        "updated_at": "2023-02-08T09:44:45+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/9f613ad5-5919-47ad-8136-12bc42ad9187?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "9f613ad5-5919-47ad-8136-12bc42ad9187",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-08T09:44:45+00:00",
      "updated_at": "2023-02-08T09:44:45+00:00",
...
```json
  {
  "data": {
    "id": "4c1e525b-8ddc-4b57-8cb8-bddb8179cef0",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-08T09:44:46+00:00",
      "updated_at": "2023-02-08T09:44:46+00:00",
      "name": "Mobile phone",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/814732ee-3bad-4a4a-b943-81249e068cef' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "814732ee-3bad-4a4a-b943-81249e068cef",
        "type": "default_properties",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/154eca7a-fb28-4a3b-b96f-47c95f840df6' \
    --header 'content-type: application/json' \
    --data '{}'
```
