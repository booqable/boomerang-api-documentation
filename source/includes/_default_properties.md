...
```json
  ...
  "data": [
    {
      "id": "e8e7b7f7-271b-4c0a-b273-4283ac6ed269",
      "type": "default_properties",
      "attributes": {
        "created_at": "2023-02-13T12:12:58+00:00",
        "updated_at": "2023-02-13T12:12:58+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/3d1fe9f6-1f52-49f7-8ba0-091de53a6e6d?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "3d1fe9f6-1f52-49f7-8ba0-091de53a6e6d",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-13T12:12:58+00:00",
      "updated_at": "2023-02-13T12:12:58+00:00",
...
```json
  {
  "data": {
    "id": "2e116a8c-b953-45fc-8527-f3c5fc4690fb",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-13T12:12:59+00:00",
      "updated_at": "2023-02-13T12:12:59+00:00",
      "name": "Mobile phone",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/b4878525-8204-4052-9215-9a4c6989cfd4' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "b4878525-8204-4052-9215-9a4c6989cfd4",
        "type": "default_properties",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/5666a9cb-a6bc-4d06-b0cc-aaf8fcfc9135' \
    --header 'content-type: application/json' \
    --data '{}'
```
