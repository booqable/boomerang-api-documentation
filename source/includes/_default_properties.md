...
```json
  ...
  "data": [
    {
      "id": "46909cf5-c8f1-405d-bf81-946bc5a28d8d",
      "type": "default_properties",
      "attributes": {
        "created_at": "2022-11-22T17:43:05+00:00",
        "updated_at": "2022-11-22T17:43:05+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/6ae4b806-1435-4900-94b5-b6e2c53162f7?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "6ae4b806-1435-4900-94b5-b6e2c53162f7",
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-11-22T17:43:05+00:00",
      "updated_at": "2022-11-22T17:43:05+00:00",
...
```json
  {
  "data": {
    "id": "769fd0b4-c5cc-43f6-8a01-cececf125cf7",
    "type": "default_properties",
    "attributes": {
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/d0be328a-42f3-4ace-a4ea-82c4a8851847' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "d0be328a-42f3-4ace-a4ea-82c4a8851847",
        "type": "default_properties",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/7009f44a-7dfe-4832-b193-36d764c4bf1d' \
    --header 'content-type: application/json' \
    --data '{}'
```
