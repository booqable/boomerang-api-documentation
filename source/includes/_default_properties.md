...
```json
  ...
  "data": [
    {
      "id": "a0b86221-955f-4c90-af9b-801f927b49d2",
      "type": "default_properties",
      "attributes": {
        "created_at": "2023-02-07T15:18:02+00:00",
        "updated_at": "2023-02-07T15:18:02+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/95b62c23-5984-40c8-bb82-58ed6968fbda?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "95b62c23-5984-40c8-bb82-58ed6968fbda",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-07T15:18:02+00:00",
      "updated_at": "2023-02-07T15:18:02+00:00",
...
```json
  {
  "data": {
    "id": "b28439d9-5cad-44cb-9b02-ca34b73af1e8",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-07T15:18:03+00:00",
      "updated_at": "2023-02-07T15:18:03+00:00",
      "name": "Mobile phone",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/981b94a0-c00d-4ddf-984b-3c1e3a41ae39' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "981b94a0-c00d-4ddf-984b-3c1e3a41ae39",
        "type": "default_properties",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/4bd21d7b-29b9-4ec6-a2c3-7e133ff08068' \
    --header 'content-type: application/json' \
    --data '{}'
```
