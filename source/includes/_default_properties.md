...
```json
  ...
  "data": [
    {
      "id": "755f87f1-cef4-4aee-af21-16bade5ccd5d",
      "type": "default_properties",
      "attributes": {
        "created_at": "2023-02-01T15:17:52+00:00",
        "updated_at": "2023-02-01T15:17:52+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/ad9bcd86-ef20-4662-8fb0-dfab1e753caa?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "ad9bcd86-ef20-4662-8fb0-dfab1e753caa",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-01T15:17:52+00:00",
      "updated_at": "2023-02-01T15:17:52+00:00",
...
```json
  {
  "data": {
    "id": "e84dfb87-9561-4d69-98dc-869073ec1c24",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-01T15:17:52+00:00",
      "updated_at": "2023-02-01T15:17:52+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/2744594e-4406-4f4d-87a8-e11735fda175' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "2744594e-4406-4f4d-87a8-e11735fda175",
        "type": "default_properties",
        "attributes": {
...
```json
  ...
  "data": {
    ...
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-01T15:17:53+00:00",
      "updated_at": "2023-02-01T15:17:53+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "text_field",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/0b6e211c-c1b7-4a0d-ad5c-4d96397bc951' \
    --header 'content-type: application/json' \
    --data '{}'
```
