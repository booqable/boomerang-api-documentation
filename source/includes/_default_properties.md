...
```json
  ...
  "data": [
    {
      "id": "946738a7-1e81-4710-aaa5-73fbaa6728b0",
      "type": "default_properties",
      "attributes": {
        "created_at": "2023-02-22T14:13:12+00:00",
        "updated_at": "2023-02-22T14:13:12+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/1655464a-aa16-499f-b4e3-1a6e4c7854e1?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "1655464a-aa16-499f-b4e3-1a6e4c7854e1",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-22T14:13:13+00:00",
      "updated_at": "2023-02-22T14:13:13+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "phone",
...
```json
  {
  "data": {
    "id": "16a6c5c3-09c8-4cc6-8801-b8e10f74d419",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-22T14:13:13+00:00",
      "updated_at": "2023-02-22T14:13:13+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/08daceba-e24b-4f17-a8bf-46fff5a8c504' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "08daceba-e24b-4f17-a8bf-46fff5a8c504",
        "type": "default_properties",
        "attributes": {
...
```json
  ...
  "data": {
    ...
    "attributes": {
      "created_at": "2023-02-22T14:13:13+00:00",
      "updated_at": "2023-02-22T14:13:14+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "text_field",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/f83f8a66-6668-47e2-a69f-e5a77a21c425' \
    --header 'content-type: application/json' \
    --data '{}'
```
