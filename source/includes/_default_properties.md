...
```json
  ...
  "data": [
    {
      "id": "4893d7e0-7af0-4796-ada9-baf4066bc5c7",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/ee1f582a-918a-4671-b037-3b5c0c617182?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "ee1f582a-918a-4671-b037-3b5c0c617182",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-09T12:18:05+00:00",
      "updated_at": "2023-02-09T12:18:05+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "phone",
...
```json
  {
  "data": {
    "id": "7a381045-038d-447b-9645-6f457fd88be9",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-09T12:18:05+00:00",
      "updated_at": "2023-02-09T12:18:05+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/deb6c766-3e13-4091-a0bc-659784f6b945' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "deb6c766-3e13-4091-a0bc-659784f6b945",
        "type": "default_properties",
        "attributes": {
...
```json
  ...
  "data": {
    ...
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-09T12:18:06+00:00",
      "updated_at": "2023-02-09T12:18:06+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "text_field",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/164a1960-af5f-4ef4-b34b-2651b515b02f' \
    --header 'content-type: application/json' \
    --data '{}'
```
