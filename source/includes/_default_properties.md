...
```json
  ...
  "data": [
    {
      "id": "9fe0ee4d-4414-4e4e-8327-084f0600763f",
      "type": "default_properties",
      "attributes": {
        "created_at": "2023-02-09T12:59:58+00:00",
        "updated_at": "2023-02-09T12:59:58+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/f5bf1699-94cb-43cf-a6b8-abf685fe609b?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "f5bf1699-94cb-43cf-a6b8-abf685fe609b",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-09T12:59:58+00:00",
      "updated_at": "2023-02-09T12:59:58+00:00",
...
```json
  {
  "data": {
    "id": "b6c278b7-7e6e-45e5-b2cc-2c5dcc875c4f",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-09T12:59:59+00:00",
      "updated_at": "2023-02-09T12:59:59+00:00",
      "name": "Mobile phone",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/82ee5358-44ba-4269-975f-8e96781282c9' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "82ee5358-44ba-4269-975f-8e96781282c9",
        "type": "default_properties",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/d54b2aa7-85df-40b6-9284-f4aee03dbcc6' \
    --header 'content-type: application/json' \
    --data '{}'
```
