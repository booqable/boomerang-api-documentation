...
```json
  ...
  "data": [
    {
      "id": "c7a9813e-c0d3-4904-898a-21cd8d13c9a9",
      "type": "default_properties",
      "attributes": {
        "created_at": "2023-02-03T08:27:03+00:00",
        "updated_at": "2023-02-03T08:27:03+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/b7ddeea0-fc14-4b1e-a65d-cf02a98e8238?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "b7ddeea0-fc14-4b1e-a65d-cf02a98e8238",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-03T08:27:03+00:00",
      "updated_at": "2023-02-03T08:27:03+00:00",
...
```json
  {
  "data": {
    "id": "9828e1b3-1046-4dc1-84be-2dc32366cf3e",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-03T08:27:04+00:00",
      "updated_at": "2023-02-03T08:27:04+00:00",
      "name": "Mobile phone",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/77209109-a017-4bb0-a43a-92121661635d' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "77209109-a017-4bb0-a43a-92121661635d",
        "type": "default_properties",
        "attributes": {
...
```json
  ...
  "data": {
    ...
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-03T08:27:05+00:00",
      "updated_at": "2023-02-03T08:27:05+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "text_field",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/f03fda75-4cb1-4e13-8669-80fde1c80bba' \
    --header 'content-type: application/json' \
    --data '{}'
```
