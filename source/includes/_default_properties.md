...
```json
  ...
  "data": [
    {
      "id": "ad7be7c5-c4f5-43fd-8857-78e0cc75773f",
      "type": "default_properties",
      "attributes": {
        "created_at": "2022-06-01T08:55:54+00:00",
        "updated_at": "2022-06-01T08:55:54+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/a70a73b0-41b8-4b69-9686-d5ac1e239313?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "a70a73b0-41b8-4b69-9686-d5ac1e239313",
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-06-01T08:55:54+00:00",
      "updated_at": "2022-06-01T08:55:54+00:00",
...
```json
  {
  "data": {
    "id": "3ed3f450-0b3f-4e16-9c37-e8ab62ad6a59",
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-06-01T08:55:54+00:00",
      "updated_at": "2022-06-01T08:55:54+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/c5216271-61f6-46e1-a7a8-2ebef0ef0e0d' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "c5216271-61f6-46e1-a7a8-2ebef0ef0e0d",
        "type": "default_properties",
        "attributes": {
...
```json
  ...
  "data": {
    ...
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-06-01T08:55:55+00:00",
      "updated_at": "2022-06-01T08:55:55+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "text_field",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/142017ae-1743-476d-96f9-e330d1f10f30' \
    --header 'content-type: application/json' \
    --data '{}'
```
