...
```json
  ...
  "data": [
    {
      "id": "6c5135a5-a55e-4358-b66f-b5f723bcbb69",
      "type": "default_properties",
      "attributes": {
        "created_at": "2023-02-07T08:06:26+00:00",
        "updated_at": "2023-02-07T08:06:26+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/a090a382-0b53-4598-9631-e6fe84bd0230?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "a090a382-0b53-4598-9631-e6fe84bd0230",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-07T08:06:26+00:00",
      "updated_at": "2023-02-07T08:06:26+00:00",
...
```json
  {
  "data": {
    "id": "5643bc9b-7971-41ee-89bd-7a1cd2898cf5",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-07T08:06:26+00:00",
      "updated_at": "2023-02-07T08:06:26+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/0b973e98-30a8-4362-b2f2-07538b8e15f9' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "0b973e98-30a8-4362-b2f2-07538b8e15f9",
        "type": "default_properties",
        "attributes": {
...
```json
  ...
  "data": {
    ...
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-07T08:06:27+00:00",
      "updated_at": "2023-02-07T08:06:27+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "text_field",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/04b7c549-8f60-4f1c-a473-38ffe16c9f51' \
    --header 'content-type: application/json' \
    --data '{}'
```
