...
```json
  ...
  "data": [
    {
      "id": "215628f4-1ea6-452f-acf4-82021213d5bb",
      "type": "default_properties",
      "attributes": {
        "created_at": "2023-02-03T13:09:00+00:00",
        "updated_at": "2023-02-03T13:09:00+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/d88ab2e9-a42d-4048-90bc-1a8b56dbbf44?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "d88ab2e9-a42d-4048-90bc-1a8b56dbbf44",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-03T13:09:01+00:00",
      "updated_at": "2023-02-03T13:09:01+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "phone",
...
```json
  {
  "data": {
    "id": "793a61c7-4ef7-4bc2-8eee-6e52c44d147e",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-03T13:09:01+00:00",
      "updated_at": "2023-02-03T13:09:01+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/4c05f89e-b52a-4bc0-ae06-8d9631a553fe' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "4c05f89e-b52a-4bc0-ae06-8d9631a553fe",
        "type": "default_properties",
        "attributes": {
...
```json
  ...
  "data": {
    ...
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-03T13:09:02+00:00",
      "updated_at": "2023-02-03T13:09:02+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "text_field",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/f0ee529e-46c3-4faf-bd11-592bd5964b5c' \
    --header 'content-type: application/json' \
    --data '{}'
```
