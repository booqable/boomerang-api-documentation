...
```json
  ...
  "data": [
    {
      "id": "21c00767-3ced-4e78-822c-60e1c6ae019c",
      "type": "default_properties",
      "attributes": {
        "created_at": "2023-03-08T15:22:44+00:00",
        "updated_at": "2023-03-08T15:22:44+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/edaf34c3-6014-40ce-8f72-943118be7130?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "edaf34c3-6014-40ce-8f72-943118be7130",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-03-08T15:22:45+00:00",
      "updated_at": "2023-03-08T15:22:45+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "phone",
...
```json
  {
  "data": {
    "id": "37114432-aed3-45f3-994f-76341cdf8704",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-03-08T15:22:45+00:00",
      "updated_at": "2023-03-08T15:22:45+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/0fd41221-987b-49f8-aee4-10c2d93eeec1' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "0fd41221-987b-49f8-aee4-10c2d93eeec1",
        "type": "default_properties",
        "attributes": {
...
```json
  ...
  "data": {
    ...
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-03-08T15:22:46+00:00",
      "updated_at": "2023-03-08T15:22:46+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "text_field",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/93687ab1-a430-405b-b264-3434a1f9cb27' \
    --header 'content-type: application/json' \
    --data '{}'
```
