...
```json
  ...
  "data": [
    {
      "id": "a6d84a6f-0a18-413d-a48a-7df948659671",
      "type": "default_properties",
      "attributes": {
        "created_at": "2023-02-02T14:26:08+00:00",
        "updated_at": "2023-02-02T14:26:08+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/15ae6a21-f9b9-4cb6-9e3e-b2f6ab5c723a?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "15ae6a21-f9b9-4cb6-9e3e-b2f6ab5c723a",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-02T14:26:09+00:00",
      "updated_at": "2023-02-02T14:26:09+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "phone",
...
```json
  {
  "data": {
    "id": "ffbc3724-a026-484d-81b1-19b2915d1248",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-02T14:26:09+00:00",
      "updated_at": "2023-02-02T14:26:09+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/29d371da-e99b-4d74-982c-13bdb6cc9268' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "29d371da-e99b-4d74-982c-13bdb6cc9268",
        "type": "default_properties",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/469e7b17-eec9-485a-90b0-3fe05e7a8b81' \
    --header 'content-type: application/json' \
    --data '{}'
```
