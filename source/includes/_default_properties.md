...
```json
  ...
  "data": [
    {
      "id": "13351430-94aa-4253-a670-bbc045f286cd",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/baee4762-aee0-457c-b667-2757bc26829e?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "baee4762-aee0-457c-b667-2757bc26829e",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-01-24T14:00:43+00:00",
      "updated_at": "2023-01-24T14:00:43+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "phone",
...
```json
  {
  "data": {
    "id": "5334a2a1-80c7-434f-b3a8-5513206541ea",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-01-24T14:00:43+00:00",
      "updated_at": "2023-01-24T14:00:43+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/bfb8c13a-8718-4bf1-ae20-2dcb81dfb956' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "bfb8c13a-8718-4bf1-ae20-2dcb81dfb956",
        "type": "default_properties",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/99e4d6c7-c543-467a-9a25-c94cda52f4ba' \
    --header 'content-type: application/json' \
    --data '{}'
```
