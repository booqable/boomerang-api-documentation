...
```json
  ...
  "data": [
    {
      "id": "ab43d1c6-3b4c-4d73-b539-d189e7bc3e51",
      "type": "default_properties",
      "attributes": {
        "created_at": "2023-02-08T09:18:23+00:00",
        "updated_at": "2023-02-08T09:18:23+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/8e282e74-5bc4-470c-89c1-0728bc35353c?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "8e282e74-5bc4-470c-89c1-0728bc35353c",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-08T09:18:23+00:00",
      "updated_at": "2023-02-08T09:18:23+00:00",
...
```json
  {
  "data": {
    "id": "2d16ebc8-95a6-4223-b095-dacb08cd5d74",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-08T09:18:23+00:00",
      "updated_at": "2023-02-08T09:18:23+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/95ffbe57-f69d-42d6-a116-8a81833fa48a' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "95ffbe57-f69d-42d6-a116-8a81833fa48a",
        "type": "default_properties",
        "attributes": {
...
```json
  ...
  "data": {
    ...
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-08T09:18:24+00:00",
      "updated_at": "2023-02-08T09:18:24+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "text_field",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/d0c944af-02d6-4a3f-ab7b-3afe2dc95bce' \
    --header 'content-type: application/json' \
    --data '{}'
```
