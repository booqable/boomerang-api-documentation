...
```json
  ...
  "data": [
    {
      "id": "7c770a8a-5685-4b38-840e-9681faef7ccd",
      "type": "default_properties",
      "attributes": {
        "created_at": "2022-10-05T11:35:27+00:00",
        "updated_at": "2022-10-05T11:35:27+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/57003fbf-7e19-45e3-b4d7-676c9b7add85?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "57003fbf-7e19-45e3-b4d7-676c9b7add85",
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-10-05T11:35:27+00:00",
      "updated_at": "2022-10-05T11:35:27+00:00",
...
```json
  {
  "data": {
    "id": "94633111-040c-4cad-ab1f-e1731a5f8674",
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-10-05T11:35:27+00:00",
      "updated_at": "2022-10-05T11:35:27+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/e4cdc497-f943-4256-a776-c568653b0be3' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "e4cdc497-f943-4256-a776-c568653b0be3",
        "type": "default_properties",
        "attributes": {
...
```json
  ...
  "data": {
    ...
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-10-05T11:35:28+00:00",
      "updated_at": "2022-10-05T11:35:28+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "text_field",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/4b68b0c5-42c2-4874-8b6d-c7a9aaf8045a' \
    --header 'content-type: application/json' \
    --data '{}'
```
