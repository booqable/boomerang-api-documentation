...
```json
  ...
  "data": [
    {
      "id": "de12b1c8-4541-41d1-87c5-cd84916ef672",
      "type": "default_properties",
      "attributes": {
        "created_at": "2023-02-13T16:00:03+00:00",
        "updated_at": "2023-02-13T16:00:03+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/056ba47d-38fe-4020-8733-dfefaf264b5e?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "056ba47d-38fe-4020-8733-dfefaf264b5e",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-13T16:00:03+00:00",
      "updated_at": "2023-02-13T16:00:03+00:00",
...
```json
  {
  "data": {
    "id": "e502d7d6-9aa7-44a3-8271-5f19818ce27d",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-13T16:00:03+00:00",
      "updated_at": "2023-02-13T16:00:03+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/823adfc5-ea1e-41d8-8af7-d6eb7ee50f0b' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "823adfc5-ea1e-41d8-8af7-d6eb7ee50f0b",
        "type": "default_properties",
        "attributes": {
...
```json
  ...
  "data": {
    ...
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-13T16:00:04+00:00",
      "updated_at": "2023-02-13T16:00:04+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "text_field",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/a4cb7703-f3c9-4d0c-a69a-7a5942b8dd18' \
    --header 'content-type: application/json' \
    --data '{}'
```
