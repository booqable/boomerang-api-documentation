...
```json
  ...
  "data": [
    {
      "id": "02c8c81b-bb21-471b-8037-b9bbf3ded7a2",
      "type": "default_properties",
      "attributes": {
        "created_at": "2022-07-18T07:34:47+00:00",
        "updated_at": "2022-07-18T07:34:47+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/0fdf76e7-e7c9-420f-9b64-aa5271127570?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "0fdf76e7-e7c9-420f-9b64-aa5271127570",
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-07-18T07:34:47+00:00",
      "updated_at": "2022-07-18T07:34:47+00:00",
...
```json
  {
  "data": {
    "id": "76da1d4a-b498-42d7-b2f7-4cd6c4ec7e89",
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-07-18T07:34:48+00:00",
      "updated_at": "2022-07-18T07:34:48+00:00",
      "name": "Mobile phone",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/e68e140b-ba27-4eac-9d50-9187d7f7fd3f' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "e68e140b-ba27-4eac-9d50-9187d7f7fd3f",
        "type": "default_properties",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/59403dfe-2c66-4364-b576-1b30b88d9e9e' \
    --header 'content-type: application/json' \
    --data '{}'
```
