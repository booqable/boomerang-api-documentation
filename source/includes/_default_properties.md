...
```json
  ...
  "data": [
    {
      "id": "d013f64d-3af9-4da4-ab31-0656b40b07a8",
      "type": "default_properties",
      "attributes": {
        "created_at": "2023-02-07T14:32:38+00:00",
        "updated_at": "2023-02-07T14:32:38+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/822f475e-b886-40c3-94bd-2784fcc2bb73?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "822f475e-b886-40c3-94bd-2784fcc2bb73",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-07T14:32:39+00:00",
      "updated_at": "2023-02-07T14:32:39+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "phone",
...
```json
  {
  "data": {
    "id": "ede34f70-e6a7-45c0-ad16-594dc4f43346",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-07T14:32:39+00:00",
      "updated_at": "2023-02-07T14:32:39+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/c4faa1a5-555f-4afa-b3fa-8e87d144d4a4' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "c4faa1a5-555f-4afa-b3fa-8e87d144d4a4",
        "type": "default_properties",
        "attributes": {
...
```json
  ...
  "data": {
    ...
    "attributes": {
      "created_at": "2023-02-07T14:32:39+00:00",
      "updated_at": "2023-02-07T14:32:40+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "text_field",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/db42c4c7-9c62-4a0d-b892-f880edc70df4' \
    --header 'content-type: application/json' \
    --data '{}'
```
