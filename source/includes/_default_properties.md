...
```json
  ...
  "data": [
    {
      "id": "c65811ca-f8f8-4cf6-a4f6-676d52947f67",
      "type": "default_properties",
      "attributes": {
        "created_at": "2023-02-06T08:47:48+00:00",
        "updated_at": "2023-02-06T08:47:48+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/17e4734d-49b1-41fd-8f48-3b8c714fed6d?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "17e4734d-49b1-41fd-8f48-3b8c714fed6d",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-06T08:47:48+00:00",
      "updated_at": "2023-02-06T08:47:48+00:00",
...
```json
  {
  "data": {
    "id": "734a1472-ae9f-42e2-8ad6-d3c3e2c4e5c2",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-06T08:47:48+00:00",
      "updated_at": "2023-02-06T08:47:48+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/997e4a3c-c9d1-49f9-9d5b-8b9eddb65fe6' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "997e4a3c-c9d1-49f9-9d5b-8b9eddb65fe6",
        "type": "default_properties",
        "attributes": {
...
```json
  ...
  "data": {
    ...
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-06T08:47:49+00:00",
      "updated_at": "2023-02-06T08:47:49+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "text_field",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/d2f64084-bf4b-4698-be96-8dde96fbaa08' \
    --header 'content-type: application/json' \
    --data '{}'
```
