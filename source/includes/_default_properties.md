...
```json
  ...
  "data": [
    {
      "id": "0d6d924c-76b9-4f80-89b6-be20064b350c",
      "type": "default_properties",
      "attributes": {
        "created_at": "2023-01-18T13:35:13+00:00",
        "updated_at": "2023-01-18T13:35:13+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/76f3aa18-c1d2-4aca-9c1d-67c8208271dd?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "76f3aa18-c1d2-4aca-9c1d-67c8208271dd",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-01-18T13:35:13+00:00",
      "updated_at": "2023-01-18T13:35:13+00:00",
...
```json
  {
  "data": {
    "id": "ddaf780d-0c06-4806-89a3-2275646dd22b",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-01-18T13:35:14+00:00",
      "updated_at": "2023-01-18T13:35:14+00:00",
      "name": "Mobile phone",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/655980d7-0349-4608-85ac-fe5093a197b4' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "655980d7-0349-4608-85ac-fe5093a197b4",
        "type": "default_properties",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/b68cb878-fe03-4135-a105-77a331fecd9e' \
    --header 'content-type: application/json' \
    --data '{}'
```
