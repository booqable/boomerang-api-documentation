...
```json
  ...
  "data": [
    {
      "id": "c6650cf7-2399-4b09-8ed8-7a75aa1803b5",
      "type": "default_properties",
      "attributes": {
        "created_at": "2023-02-17T13:25:56+00:00",
        "updated_at": "2023-02-17T13:25:56+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/3bed7a2f-6a24-485e-9db8-8e7ff3e2191d?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "3bed7a2f-6a24-485e-9db8-8e7ff3e2191d",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-17T13:25:57+00:00",
      "updated_at": "2023-02-17T13:25:57+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "phone",
...
```json
  {
  "data": {
    "id": "e8667f0c-4e26-4ad2-8e63-758d85b78fe2",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-17T13:25:58+00:00",
      "updated_at": "2023-02-17T13:25:58+00:00",
      "name": "Mobile phone",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/4c40103f-04ac-4a2d-b99a-15f2dbacc208' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "4c40103f-04ac-4a2d-b99a-15f2dbacc208",
        "type": "default_properties",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/91b8c5a8-5254-4e23-b87d-3c70974aaad1' \
    --header 'content-type: application/json' \
    --data '{}'
```
