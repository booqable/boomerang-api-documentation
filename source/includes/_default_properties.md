...
```json
  ...
  "data": [
    {
      "id": "b42ad4b5-61f9-4f3b-a61e-6bc382343e32",
      "type": "default_properties",
      "attributes": {
        "created_at": "2022-07-08T11:44:14+00:00",
        "updated_at": "2022-07-08T11:44:14+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/30b532b8-03f5-4cd9-a95e-60e86cd4b3b9?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "30b532b8-03f5-4cd9-a95e-60e86cd4b3b9",
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-07-08T11:44:14+00:00",
      "updated_at": "2022-07-08T11:44:14+00:00",
...
```json
  {
  "data": {
    "id": "fb10c721-72d9-4fa4-96b5-597d22341baf",
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-07-08T11:44:14+00:00",
      "updated_at": "2022-07-08T11:44:14+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/a5d0cc1a-3f69-433b-98e2-59936cdd84b6' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "a5d0cc1a-3f69-433b-98e2-59936cdd84b6",
        "type": "default_properties",
        "attributes": {
...
```json
  ...
  "data": {
    ...
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-07-08T11:44:15+00:00",
      "updated_at": "2022-07-08T11:44:15+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "text_field",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/29e461ee-e304-46ac-9209-214544bcb287' \
    --header 'content-type: application/json' \
    --data '{}'
```
