...
```json
  ...
  "data": [
    {
      "id": "21d3a3ba-6d0c-4d7f-a5f1-43e6e3a2df3c",
      "type": "default_properties",
      "attributes": {
        "created_at": "2022-05-05T12:26:23+00:00",
        "updated_at": "2022-05-05T12:26:23+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/c7fb3210-d9b1-4874-936b-d04f2ec01d0c?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "c7fb3210-d9b1-4874-936b-d04f2ec01d0c",
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-05-05T12:26:23+00:00",
      "updated_at": "2022-05-05T12:26:23+00:00",
...
```json
  {
  "data": {
    "id": "877e4248-ecb6-4f8c-a30d-3b458a3cd8f4",
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-05-05T12:26:24+00:00",
      "updated_at": "2022-05-05T12:26:24+00:00",
      "name": "Mobile phone",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/1415e3a8-85b9-460d-b4de-b88bd92eaea3' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "1415e3a8-85b9-460d-b4de-b88bd92eaea3",
        "type": "default_properties",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/8bcb9a0d-9166-4bf2-83d8-4e5130a515f3' \
    --header 'content-type: application/json' \
    --data '{}'
```
