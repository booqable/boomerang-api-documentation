...
```json
  ...
  "data": [
    {
      "id": "598e9852-d260-4ecc-bce3-f3d2dd194bd5",
      "type": "default_properties",
      "attributes": {
        "created_at": "2023-02-08T13:51:09+00:00",
        "updated_at": "2023-02-08T13:51:09+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/392dd3bd-b4bf-4565-b268-d2c8d078b380?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "392dd3bd-b4bf-4565-b268-d2c8d078b380",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-08T13:51:09+00:00",
      "updated_at": "2023-02-08T13:51:09+00:00",
...
```json
  {
  "data": {
    "id": "8578ad4b-7933-4bff-a4fe-73dbd93265ee",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-08T13:51:09+00:00",
      "updated_at": "2023-02-08T13:51:09+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/b2bc8e07-a534-455f-b7f2-a92a0dd28e82' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "b2bc8e07-a534-455f-b7f2-a92a0dd28e82",
        "type": "default_properties",
        "attributes": {
...
```json
  ...
  "data": {
    ...
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-08T13:51:10+00:00",
      "updated_at": "2023-02-08T13:51:10+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "text_field",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/8df61821-8da9-429f-b635-604f19dad10c' \
    --header 'content-type: application/json' \
    --data '{}'
```
