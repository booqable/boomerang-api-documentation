...
```json
  ...
  "data": [
    {
      "id": "492726e8-6bbe-4bdb-809a-6db0e000aebc",
      "type": "default_properties",
      "attributes": {
        "created_at": "2022-06-09T12:37:45+00:00",
        "updated_at": "2022-06-09T12:37:45+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/00184844-e937-4e0c-8a51-82e20f8a550c?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "00184844-e937-4e0c-8a51-82e20f8a550c",
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-06-09T12:37:45+00:00",
      "updated_at": "2022-06-09T12:37:45+00:00",
...
```json
  {
  "data": {
    "id": "e71b9baa-79f3-4b91-8e69-cbe358774552",
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-06-09T12:37:46+00:00",
      "updated_at": "2022-06-09T12:37:46+00:00",
      "name": "Mobile phone",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/3c4b9f28-4967-4ab9-bfd1-89ef4e617946' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "3c4b9f28-4967-4ab9-bfd1-89ef4e617946",
        "type": "default_properties",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/c72efce4-e4d9-4da0-9c18-9d40971b3bb0' \
    --header 'content-type: application/json' \
    --data '{}'
```
