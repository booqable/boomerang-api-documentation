...
```json
  ...
  "data": [
    {
      "id": "1521fb29-1c80-4011-9e09-1cd740d9bc8f",
      "type": "default_properties",
      "attributes": {
        "created_at": "2023-02-08T16:17:44+00:00",
        "updated_at": "2023-02-08T16:17:44+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/e7f7e146-ef1b-4928-bee3-1532c4a315cd?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "e7f7e146-ef1b-4928-bee3-1532c4a315cd",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-08T16:17:44+00:00",
      "updated_at": "2023-02-08T16:17:44+00:00",
...
```json
  {
  "data": {
    "id": "75aff59c-c3fa-4159-9ba7-7a08caa5385e",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-08T16:17:45+00:00",
      "updated_at": "2023-02-08T16:17:45+00:00",
      "name": "Mobile phone",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/497fb823-8b78-4634-91b6-4e80e7469401' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "497fb823-8b78-4634-91b6-4e80e7469401",
        "type": "default_properties",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/c045ac38-a7a4-483a-a164-87c70415878f' \
    --header 'content-type: application/json' \
    --data '{}'
```
