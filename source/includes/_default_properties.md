...
```json
  ...
  "data": [
    {
      "id": "2382c102-e2da-409e-9355-2b75bd902bc2",
      "type": "default_properties",
      "attributes": {
        "created_at": "2023-02-28T07:29:50+00:00",
        "updated_at": "2023-02-28T07:29:50+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/8843b2b4-006c-4ba8-8fd7-760f5f2a9c1c?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "8843b2b4-006c-4ba8-8fd7-760f5f2a9c1c",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-28T07:29:50+00:00",
      "updated_at": "2023-02-28T07:29:50+00:00",
...
```json
  {
  "data": {
    "id": "fcb29f00-2c06-4dd8-aac7-a1045556b68c",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-28T07:29:50+00:00",
      "updated_at": "2023-02-28T07:29:50+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/f93f2f84-f20f-44a8-96f8-899423afd171' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "f93f2f84-f20f-44a8-96f8-899423afd171",
        "type": "default_properties",
        "attributes": {
...
```json
  ...
  "data": {
    ...
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-28T07:29:51+00:00",
      "updated_at": "2023-02-28T07:29:51+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "text_field",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/ab05edea-0edc-4174-a64a-3254c3168145' \
    --header 'content-type: application/json' \
    --data '{}'
```
