...
```json
  ...
  "data": [
    {
      "id": "1df31a0e-abd5-44fb-a12d-6722d91c0142",
      "type": "default_properties",
      "attributes": {
        "created_at": "2022-03-25T08:52:54+00:00",
        "updated_at": "2022-03-25T08:52:54+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/66859fbf-0803-46d6-9303-324426f755e4?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "66859fbf-0803-46d6-9303-324426f755e4",
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-03-25T08:52:55+00:00",
      "updated_at": "2022-03-25T08:52:55+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "phone",
...
```json
  {
  "data": {
    "id": "e5f80904-6b04-4068-a0c9-096234980537",
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-03-25T08:52:55+00:00",
      "updated_at": "2022-03-25T08:52:55+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/636c8133-57d3-49a9-a653-7c5b3d22d4a7' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "636c8133-57d3-49a9-a653-7c5b3d22d4a7",
        "type": "default_properties",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/d6540cae-750b-4a8c-89a4-419bdd21ac85' \
    --header 'content-type: application/json' \
    --data '{}'
```
