...
```json
  ...
  "data": [
    {
      "id": "dfba08e7-e3ef-4ad2-97b9-8249f4a908bf",
      "type": "default_properties",
      "attributes": {
        "created_at": "2023-01-05T16:27:00+00:00",
        "updated_at": "2023-01-05T16:27:00+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/cf206dc2-9f96-4c4e-a421-06c0038ad700?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "cf206dc2-9f96-4c4e-a421-06c0038ad700",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-01-05T16:27:00+00:00",
      "updated_at": "2023-01-05T16:27:00+00:00",
...
```json
  {
  "data": {
    "id": "ba76c228-9200-45c8-98e1-1a86a173d717",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-01-05T16:27:01+00:00",
      "updated_at": "2023-01-05T16:27:01+00:00",
      "name": "Mobile phone",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/fd7a97f4-e9cf-4dc7-8de9-6f3cc7f107d8' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "fd7a97f4-e9cf-4dc7-8de9-6f3cc7f107d8",
        "type": "default_properties",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/883ffd30-10d5-4341-8632-296385f5b355' \
    --header 'content-type: application/json' \
    --data '{}'
```
