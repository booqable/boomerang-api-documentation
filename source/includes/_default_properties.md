...
```json
  ...
  "data": [
    {
      "id": "9fa1d029-2e02-4ddc-a16e-859793c7ac82",
      "type": "default_properties",
      "attributes": {
        "created_at": "2023-02-16T15:48:27+00:00",
        "updated_at": "2023-02-16T15:48:27+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/9a84eead-9ad4-47c2-ac36-ff5edeaf0144?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "9a84eead-9ad4-47c2-ac36-ff5edeaf0144",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-16T15:48:27+00:00",
      "updated_at": "2023-02-16T15:48:27+00:00",
...
```json
  {
  "data": {
    "id": "13b475dd-fbe1-4cc7-86e9-9d5f68fddad9",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-16T15:48:29+00:00",
      "updated_at": "2023-02-16T15:48:29+00:00",
      "name": "Mobile phone",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/45951061-b46e-4d97-8288-af4c7fced5e1' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "45951061-b46e-4d97-8288-af4c7fced5e1",
        "type": "default_properties",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/153473f8-05e3-4a8d-a961-b9cb77f9c872' \
    --header 'content-type: application/json' \
    --data '{}'
```
