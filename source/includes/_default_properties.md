...
```json
  ...
  "data": [
    {
      "id": "6011b27e-eed2-4705-b2ce-cc051b40da8f",
      "type": "default_properties",
      "attributes": {
        "created_at": "2023-03-01T10:30:57+00:00",
        "updated_at": "2023-03-01T10:30:57+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/78b02c2f-bb40-4fd8-aca0-354e0b09c7cb?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "78b02c2f-bb40-4fd8-aca0-354e0b09c7cb",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-03-01T10:30:57+00:00",
      "updated_at": "2023-03-01T10:30:57+00:00",
...
```json
  {
  "data": {
    "id": "aef35c5e-02ba-4bea-83c4-fea3272fbb44",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-03-01T10:30:58+00:00",
      "updated_at": "2023-03-01T10:30:58+00:00",
      "name": "Mobile phone",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/ef02db00-d455-4f39-8a58-f5aa5ad730c7' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "ef02db00-d455-4f39-8a58-f5aa5ad730c7",
        "type": "default_properties",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/220db0a2-b9b7-450b-8544-a3ed9148e879' \
    --header 'content-type: application/json' \
    --data '{}'
```
