...
```json
  ...
  "data": [
    {
      "id": "465d0308-83af-436b-9aec-f7055a327ad3",
      "type": "default_properties",
      "attributes": {
        "created_at": "2023-02-21T08:19:25+00:00",
        "updated_at": "2023-02-21T08:19:25+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/c4673cee-1640-4551-8606-1a247ce0fcb7?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "c4673cee-1640-4551-8606-1a247ce0fcb7",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-21T08:19:25+00:00",
      "updated_at": "2023-02-21T08:19:25+00:00",
...
```json
  {
  "data": {
    "id": "41391a2d-a614-48bd-b63c-b144d5d5f2c0",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-21T08:19:26+00:00",
      "updated_at": "2023-02-21T08:19:26+00:00",
      "name": "Mobile phone",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/eef9dd69-681c-428d-9046-7c921beb76a2' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "eef9dd69-681c-428d-9046-7c921beb76a2",
        "type": "default_properties",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/7ce646a0-631e-4d12-a0e7-f759d118cb70' \
    --header 'content-type: application/json' \
    --data '{}'
```
