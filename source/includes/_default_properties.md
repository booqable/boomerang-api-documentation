...
```json
  ...
  "data": [
    {
      "id": "0eb6b721-fe40-4ae3-abaa-1c086a8b1abd",
      "type": "default_properties",
      "attributes": {
        "created_at": "2023-02-23T08:19:38+00:00",
        "updated_at": "2023-02-23T08:19:38+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/b7190df9-1c83-4b88-9f4e-40d808123955?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "b7190df9-1c83-4b88-9f4e-40d808123955",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-23T08:19:39+00:00",
      "updated_at": "2023-02-23T08:19:39+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "phone",
...
```json
  {
  "data": {
    "id": "6f9fb86c-b342-4a7c-9031-739dda35c099",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-23T08:19:39+00:00",
      "updated_at": "2023-02-23T08:19:39+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/cd9f8c89-2de0-42ec-baaf-fa0177213a93' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "cd9f8c89-2de0-42ec-baaf-fa0177213a93",
        "type": "default_properties",
        "attributes": {
...
```json
  ...
  "data": {
    ...
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-23T08:19:40+00:00",
      "updated_at": "2023-02-23T08:19:40+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "text_field",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/3b5d7c44-69fd-4145-b94b-415409d0adcb' \
    --header 'content-type: application/json' \
    --data '{}'
```
