...
```json
  ...
  "data": [
    {
      "id": "9a8adc90-1959-4437-b2f4-b2288c352744",
      "type": "default_properties",
      "attributes": {
        "created_at": "2022-06-30T12:41:10+00:00",
        "updated_at": "2022-06-30T12:41:10+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/0ec2ad6f-19a0-442a-bb10-c04029cb9b7c?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "0ec2ad6f-19a0-442a-bb10-c04029cb9b7c",
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-06-30T12:41:11+00:00",
      "updated_at": "2022-06-30T12:41:11+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "phone",
...
```json
  {
  "data": {
    "id": "688ffed6-bd5f-4eac-bb10-d8d31983fbd8",
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-06-30T12:41:12+00:00",
      "updated_at": "2022-06-30T12:41:12+00:00",
      "name": "Mobile phone",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/4cff4022-6dcd-45aa-93d4-f8304ed00deb' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "4cff4022-6dcd-45aa-93d4-f8304ed00deb",
        "type": "default_properties",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/5c04dc81-7182-4536-952f-b73e5bd24b24' \
    --header 'content-type: application/json' \
    --data '{}'
```
