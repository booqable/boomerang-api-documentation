...
```json
  ...
  "data": [
    {
      "id": "a79a5583-1a9f-4356-bebc-85186e237a09",
      "type": "default_properties",
      "attributes": {
        "created_at": "2022-01-20T12:33:32+00:00",
        "updated_at": "2022-01-20T12:33:32+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/c658b77f-6035-4158-a6cd-1fc2a299e847?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "c658b77f-6035-4158-a6cd-1fc2a299e847",
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-01-20T12:33:33+00:00",
      "updated_at": "2022-01-20T12:33:33+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "phone",
...
```json
  {
  "data": {
    "id": "4dc600ff-6ffe-4d7a-a8b3-9bce8ac7b66a",
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-01-20T12:33:33+00:00",
      "updated_at": "2022-01-20T12:33:33+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/a679ff72-13b1-464c-a627-4af967990a76' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "a679ff72-13b1-464c-a627-4af967990a76",
        "type": "default_properties",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/aa2efd43-85e5-4c66-8698-fcf6402f9abc' \
    --header 'content-type: application/json' \
    --data '{}'
```
