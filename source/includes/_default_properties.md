...
```json
  ...
  "data": [
    {
      "id": "0c6d2fc9-5167-48f0-a73d-c6e992217dce",
      "type": "default_properties",
      "attributes": {
        "created_at": "2022-10-13T08:56:25+00:00",
        "updated_at": "2022-10-13T08:56:25+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/f7232d74-f5b0-4724-88d9-e09e370185ec?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "f7232d74-f5b0-4724-88d9-e09e370185ec",
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-10-13T08:56:25+00:00",
      "updated_at": "2022-10-13T08:56:25+00:00",
...
```json
  {
  "data": {
    "id": "0ef6815b-779e-4f1f-b989-045424b81e14",
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-10-13T08:56:26+00:00",
      "updated_at": "2022-10-13T08:56:26+00:00",
      "name": "Mobile phone",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/76bab987-386a-40fd-a839-e576a7dbc3c1' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "76bab987-386a-40fd-a839-e576a7dbc3c1",
        "type": "default_properties",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/7d4c6336-d204-4352-8d04-6eeda53bb977' \
    --header 'content-type: application/json' \
    --data '{}'
```
