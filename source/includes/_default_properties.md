...
```json
  ...
  "data": [
    {
      "id": "b56106d7-ef37-4959-8fdd-dea80d738e33",
      "type": "default_properties",
      "attributes": {
        "created_at": "2022-04-07T07:02:40+00:00",
        "updated_at": "2022-04-07T07:02:40+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/d22b7bed-4ee7-40c8-80ce-88e892123cfd?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "d22b7bed-4ee7-40c8-80ce-88e892123cfd",
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-04-07T07:02:40+00:00",
      "updated_at": "2022-04-07T07:02:40+00:00",
...
```json
  {
  "data": {
    "id": "315ad8a4-ec9e-4121-b51c-6dabfa8b9bbb",
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-04-07T07:02:41+00:00",
      "updated_at": "2022-04-07T07:02:41+00:00",
      "name": "Mobile phone",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/ad1c6926-2b7f-4a69-86b6-39498ea194a9' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "ad1c6926-2b7f-4a69-86b6-39498ea194a9",
        "type": "default_properties",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/36a67d56-ae2d-4de5-bb99-262e7a9c4e28' \
    --header 'content-type: application/json' \
    --data '{}'
```
