...
```json
  ...
  "data": [
    {
      "id": "083a8d73-f1f5-46dc-8709-bf9b24ac87c8",
      "type": "default_properties",
      "attributes": {
        "created_at": "2023-02-02T16:58:33+00:00",
        "updated_at": "2023-02-02T16:58:33+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/4a7a84ef-b9d6-4b7e-b151-7aa03b33e0bf?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "4a7a84ef-b9d6-4b7e-b151-7aa03b33e0bf",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-02T16:58:34+00:00",
      "updated_at": "2023-02-02T16:58:34+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "phone",
...
```json
  {
  "data": {
    "id": "230e511d-7511-4eca-8d38-fbcbd5111789",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-02T16:58:34+00:00",
      "updated_at": "2023-02-02T16:58:34+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/e5a302be-5e50-4a8b-b755-dd007c5b780f' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "e5a302be-5e50-4a8b-b755-dd007c5b780f",
        "type": "default_properties",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/a54b176c-d8e2-4644-bc7a-a93423094bfc' \
    --header 'content-type: application/json' \
    --data '{}'
```
