...
```json
  ...
  "data": [
    {
      "id": "7ea9b9e2-960f-4b2c-9caa-574d2d089585",
      "type": "default_properties",
      "attributes": {
        "created_at": "2023-01-26T12:16:31+00:00",
        "updated_at": "2023-01-26T12:16:31+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/c57b73e5-b3ea-4241-8c7e-b168349a2118?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "c57b73e5-b3ea-4241-8c7e-b168349a2118",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-01-26T12:16:31+00:00",
      "updated_at": "2023-01-26T12:16:31+00:00",
...
```json
  {
  "data": {
    "id": "d2850cb8-eae1-4828-9375-6f6d0a8e219b",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-01-26T12:16:32+00:00",
      "updated_at": "2023-01-26T12:16:32+00:00",
      "name": "Mobile phone",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/8a66aaa2-33fa-4c2c-846a-100e26497ba3' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "8a66aaa2-33fa-4c2c-846a-100e26497ba3",
        "type": "default_properties",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/094d0a1f-e1eb-4df7-9d44-19cb11148eaa' \
    --header 'content-type: application/json' \
    --data '{}'
```
