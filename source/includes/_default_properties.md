...
```json
  ...
  "data": [
    {
      "id": "cda830f5-6882-41cf-9cfd-39d361eab346",
      "type": "default_properties",
      "attributes": {
        "created_at": "2023-02-24T08:53:02+00:00",
        "updated_at": "2023-02-24T08:53:02+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/fb560c29-9341-4de7-b977-217fe4549d9d?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "fb560c29-9341-4de7-b977-217fe4549d9d",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-24T08:53:02+00:00",
      "updated_at": "2023-02-24T08:53:02+00:00",
...
```json
  {
  "data": {
    "id": "2e635704-b8aa-4aa6-b2c3-73fbc3739d55",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-24T08:53:03+00:00",
      "updated_at": "2023-02-24T08:53:03+00:00",
      "name": "Mobile phone",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/01b14fcd-ad66-4c7a-b423-a56b0c63de15' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "01b14fcd-ad66-4c7a-b423-a56b0c63de15",
        "type": "default_properties",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/1179acd8-b93c-4287-bd0f-2ac080f15f23' \
    --header 'content-type: application/json' \
    --data '{}'
```
