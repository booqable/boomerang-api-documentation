...
```json
  ...
  "data": [
    {
      "id": "4cbaddae-cfcc-48ed-9282-3de3cd0b0db1",
      "type": "default_properties",
      "attributes": {
        "created_at": "2023-01-19T10:45:49+00:00",
        "updated_at": "2023-01-19T10:45:49+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/19690797-92f0-40f0-a6b5-57ecf7286b6a?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "19690797-92f0-40f0-a6b5-57ecf7286b6a",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-01-19T10:45:49+00:00",
      "updated_at": "2023-01-19T10:45:49+00:00",
...
```json
  {
  "data": {
    "id": "b7a80681-c067-41a4-8274-3be7b861b29d",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-01-19T10:45:49+00:00",
      "updated_at": "2023-01-19T10:45:49+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/4c6509e8-b78b-4c46-94ca-8ccca9c4207e' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "4c6509e8-b78b-4c46-94ca-8ccca9c4207e",
        "type": "default_properties",
        "attributes": {
...
```json
  ...
  "data": {
    ...
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-01-19T10:45:50+00:00",
      "updated_at": "2023-01-19T10:45:50+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "text_field",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/6f07cf0e-c98d-4026-8973-b90f1f95b211' \
    --header 'content-type: application/json' \
    --data '{}'
```
