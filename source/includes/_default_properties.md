...
```json
  ...
  "data": [
    {
      "id": "c93579db-a4d3-49b6-a509-0edaaca30935",
      "type": "default_properties",
      "attributes": {
        "created_at": "2022-06-23T12:51:01+00:00",
        "updated_at": "2022-06-23T12:51:01+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/5be7e937-e56d-4586-9ee6-c84479f9098b?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "5be7e937-e56d-4586-9ee6-c84479f9098b",
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-06-23T12:51:03+00:00",
      "updated_at": "2022-06-23T12:51:03+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "phone",
...
```json
  {
  "data": {
    "id": "bfab1f06-2aa2-48d9-978c-bc076f485123",
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-06-23T12:51:04+00:00",
      "updated_at": "2022-06-23T12:51:04+00:00",
      "name": "Mobile phone",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/b70bd8a3-fe4d-4902-9599-ac4292d54425' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "b70bd8a3-fe4d-4902-9599-ac4292d54425",
        "type": "default_properties",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/ed49a9bc-a4d0-40ae-aecf-9cec668b8aa1' \
    --header 'content-type: application/json' \
    --data '{}'
```
