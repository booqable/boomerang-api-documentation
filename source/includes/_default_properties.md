...
```json
  ...
  "data": [
    {
      "id": "be38f90a-ff53-4f73-a78f-02a0371ea465",
      "type": "default_properties",
      "attributes": {
        "created_at": "2022-10-12T12:57:03+00:00",
        "updated_at": "2022-10-12T12:57:03+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/698eaca9-c9d2-40bc-918e-5561bac69178?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "698eaca9-c9d2-40bc-918e-5561bac69178",
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-10-12T12:57:03+00:00",
      "updated_at": "2022-10-12T12:57:03+00:00",
...
```json
  {
  "data": {
    "id": "b906f88a-b1e6-4253-b483-a544d0d129a4",
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-10-12T12:57:04+00:00",
      "updated_at": "2022-10-12T12:57:04+00:00",
      "name": "Mobile phone",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/b5c21983-5736-4923-99ef-ee4e2d5b1469' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "b5c21983-5736-4923-99ef-ee4e2d5b1469",
        "type": "default_properties",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/e5c4ba70-3dc3-4625-9d61-7aa33ff096b1' \
    --header 'content-type: application/json' \
    --data '{}'
```
