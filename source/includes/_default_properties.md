...
```json
  ...
  "data": [
    {
      "id": "778e27cf-4164-4fd9-b8dd-c278879a1707",
      "type": "default_properties",
      "attributes": {
        "created_at": "2022-07-14T12:39:44+00:00",
        "updated_at": "2022-07-14T12:39:44+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/e36a22db-4e75-4af6-9024-504360c2e6b6?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "e36a22db-4e75-4af6-9024-504360c2e6b6",
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-07-14T12:39:45+00:00",
      "updated_at": "2022-07-14T12:39:45+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "phone",
...
```json
  {
  "data": {
    "id": "99e8ca0f-b192-4a3f-be5f-dac4475d669a",
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-07-14T12:39:45+00:00",
      "updated_at": "2022-07-14T12:39:45+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/4b7cf98f-73c4-464b-81ef-833553181f75' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "4b7cf98f-73c4-464b-81ef-833553181f75",
        "type": "default_properties",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/73cbce52-8c14-4da1-961d-a3f2e165a0fa' \
    --header 'content-type: application/json' \
    --data '{}'
```
