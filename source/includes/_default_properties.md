...
```json
  ...
  "data": [
    {
      "id": "f2a995e0-d1bd-462c-9564-8a29fc0e2da1",
      "type": "default_properties",
      "attributes": {
        "created_at": "2023-03-01T10:00:25+00:00",
        "updated_at": "2023-03-01T10:00:25+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/be19c84f-8ea5-4823-9f6d-8d77aa8747df?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "be19c84f-8ea5-4823-9f6d-8d77aa8747df",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-03-01T10:00:25+00:00",
      "updated_at": "2023-03-01T10:00:25+00:00",
...
```json
  {
  "data": {
    "id": "3250d81e-db94-4aa3-af79-d216e59d98fe",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-03-01T10:00:26+00:00",
      "updated_at": "2023-03-01T10:00:26+00:00",
      "name": "Mobile phone",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/14d46d9b-ace6-4a5e-bf35-61beeeed5045' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "14d46d9b-ace6-4a5e-bf35-61beeeed5045",
        "type": "default_properties",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/327bad3a-f462-4bbf-a6c0-f6ae9aa8b5ff' \
    --header 'content-type: application/json' \
    --data '{}'
```
