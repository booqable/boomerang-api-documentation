...
```json
  ...
  "data": [
    {
      "id": "662275c6-41bb-4cf2-96f5-2f012faf405f",
      "type": "default_properties",
      "attributes": {
        "created_at": "2023-02-24T09:47:10+00:00",
        "updated_at": "2023-02-24T09:47:10+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/f0ff71d3-18a7-4e94-875f-3bd495b747f4?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "f0ff71d3-18a7-4e94-875f-3bd495b747f4",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-24T09:47:10+00:00",
      "updated_at": "2023-02-24T09:47:10+00:00",
...
```json
  {
  "data": {
    "id": "569c00ef-e7c9-49c0-b834-3f122a4c54d8",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-24T09:47:10+00:00",
      "updated_at": "2023-02-24T09:47:10+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/36846eac-4e87-4505-a02e-952fd978f13f' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "36846eac-4e87-4505-a02e-952fd978f13f",
        "type": "default_properties",
        "attributes": {
...
```json
  ...
  "data": {
    ...
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-24T09:47:11+00:00",
      "updated_at": "2023-02-24T09:47:11+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "text_field",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/98034207-7b93-42de-b410-e650f33d29ac' \
    --header 'content-type: application/json' \
    --data '{}'
```
