...
```json
  ...
  "data": [
    {
      "id": "e231d998-7442-40c2-9985-04741736f078",
      "type": "default_properties",
      "attributes": {
        "created_at": "2023-02-14T11:04:11+00:00",
        "updated_at": "2023-02-14T11:04:11+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/5228bebb-b709-41cd-acb7-96372b6ecfe8?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "5228bebb-b709-41cd-acb7-96372b6ecfe8",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-14T11:04:11+00:00",
      "updated_at": "2023-02-14T11:04:11+00:00",
...
```json
  {
  "data": {
    "id": "ffa891e6-b9bb-47e4-b623-2947796ff35f",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-14T11:04:12+00:00",
      "updated_at": "2023-02-14T11:04:12+00:00",
      "name": "Mobile phone",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/13dafe52-b23e-4639-be17-8d6dca3cf225' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "13dafe52-b23e-4639-be17-8d6dca3cf225",
        "type": "default_properties",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/98c0b618-5439-40c2-acc1-f6f1c4138174' \
    --header 'content-type: application/json' \
    --data '{}'
```
