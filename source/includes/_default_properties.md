...
```json
  ...
  "data": [
    {
      "id": "e25d4bf9-77fc-4208-9e4e-9642b239ad24",
      "type": "default_properties",
      "attributes": {
        "created_at": "2023-02-21T16:14:00+00:00",
        "updated_at": "2023-02-21T16:14:00+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/6c817186-fffd-449e-b421-cea68dc736f1?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "6c817186-fffd-449e-b421-cea68dc736f1",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-21T16:14:01+00:00",
      "updated_at": "2023-02-21T16:14:01+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "phone",
...
```json
  {
  "data": {
    "id": "c4a18507-9142-4726-a6f0-e2803b936251",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-21T16:14:01+00:00",
      "updated_at": "2023-02-21T16:14:01+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/a29db24e-095c-4c80-802e-ab6614fd5449' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "a29db24e-095c-4c80-802e-ab6614fd5449",
        "type": "default_properties",
        "attributes": {
...
```json
  ...
  "data": {
    ...
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-21T16:14:02+00:00",
      "updated_at": "2023-02-21T16:14:02+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "text_field",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/e9efb00a-0293-491f-9b7d-d54a3fcc66f0' \
    --header 'content-type: application/json' \
    --data '{}'
```
