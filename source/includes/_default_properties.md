...
```json
  ...
  "data": [
    {
      "id": "a8232ae2-59a2-428f-98df-8e466cdd1527",
      "type": "default_properties",
      "attributes": {
        "created_at": "2023-02-22T08:40:23+00:00",
        "updated_at": "2023-02-22T08:40:23+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/36a3cd4f-56f5-405e-8589-a29ed4c3772b?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "36a3cd4f-56f5-405e-8589-a29ed4c3772b",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-22T08:40:24+00:00",
      "updated_at": "2023-02-22T08:40:24+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "phone",
...
```json
  {
  "data": {
    "id": "9571f3c7-84db-4dd4-8039-24f1df2f74e0",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-22T08:40:24+00:00",
      "updated_at": "2023-02-22T08:40:24+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/ddf7581a-ca5e-48ae-a44b-019038ff20bf' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "ddf7581a-ca5e-48ae-a44b-019038ff20bf",
        "type": "default_properties",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/a45e8628-4a3e-425e-8250-2c0fd677b36b' \
    --header 'content-type: application/json' \
    --data '{}'
```
