...
```json
  ...
  "data": [
    {
      "id": "28382d44-5883-4434-8bf0-8353993e39e6",
      "type": "default_properties",
      "attributes": {
        "created_at": "2022-07-07T12:17:07+00:00",
        "updated_at": "2022-07-07T12:17:07+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/0fc4b3fd-026f-4c5d-ad9f-d868cf2616a4?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "0fc4b3fd-026f-4c5d-ad9f-d868cf2616a4",
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-07-07T12:17:08+00:00",
      "updated_at": "2022-07-07T12:17:08+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "phone",
...
```json
  {
  "data": {
    "id": "4fae4fc2-37a5-4f96-bc8b-be69554dd1fb",
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-07-07T12:17:08+00:00",
      "updated_at": "2022-07-07T12:17:08+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/de371519-06df-4cb4-b4b6-34641e026dd5' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "de371519-06df-4cb4-b4b6-34641e026dd5",
        "type": "default_properties",
        "attributes": {
...
```json
  ...
  "data": {
    ...
    "attributes": {
      "created_at": "2022-07-07T12:17:08+00:00",
      "updated_at": "2022-07-07T12:17:09+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "text_field",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/fd19be84-08c2-485b-ac85-8b72f177a356' \
    --header 'content-type: application/json' \
    --data '{}'
```
