...
```json
  ...
  "data": [
    {
      "id": "a416206d-6332-42bb-b491-5684abc986ca",
      "type": "default_properties",
      "attributes": {
        "created_at": "2022-01-13T13:09:11+00:00",
        "updated_at": "2022-01-13T13:09:11+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/c157b6a7-528e-4465-9d4f-e2829e66566b?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "c157b6a7-528e-4465-9d4f-e2829e66566b",
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-01-13T13:09:11+00:00",
      "updated_at": "2022-01-13T13:09:11+00:00",
...
```json
  {
  "data": {
    "id": "466bc22d-71d0-4d60-8402-38010406d64d",
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-01-13T13:09:11+00:00",
      "updated_at": "2022-01-13T13:09:11+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/f916a26d-815a-45da-93db-6faea28dc630' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "f916a26d-815a-45da-93db-6faea28dc630",
        "type": "default_properties",
        "attributes": {
...
```json
  ...
  "data": {
    ...
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-01-13T13:09:12+00:00",
      "updated_at": "2022-01-13T13:09:12+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "text_field",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/c04995df-e4ea-456f-81f9-97a1a68a998e' \
    --header 'content-type: application/json' \
    --data '{}'
```
