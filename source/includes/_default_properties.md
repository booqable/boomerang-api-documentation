...
```json
  ...
  "data": [
    {
      "id": "d295aa5f-6279-4263-afca-6bcba499f629",
      "type": "default_properties",
      "attributes": {
        "created_at": "2023-02-16T15:35:10+00:00",
        "updated_at": "2023-02-16T15:35:10+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/7c707b89-9e92-4344-84c9-cafb40c79ed6?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "7c707b89-9e92-4344-84c9-cafb40c79ed6",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-16T15:35:10+00:00",
      "updated_at": "2023-02-16T15:35:10+00:00",
...
```json
  {
  "data": {
    "id": "7842a9fd-043a-4d84-b401-6cb8709a807c",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-16T15:35:11+00:00",
      "updated_at": "2023-02-16T15:35:11+00:00",
      "name": "Mobile phone",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/229e8d5a-86d6-4422-b2a5-b9bb224ff0a5' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "229e8d5a-86d6-4422-b2a5-b9bb224ff0a5",
        "type": "default_properties",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/e723a5da-236e-4fac-bbd2-1940b863fed6' \
    --header 'content-type: application/json' \
    --data '{}'
```
