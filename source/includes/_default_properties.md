...
```json
  ...
  "data": [
    {
      "id": "693966f5-c20f-418e-bd09-357e6c2ad85a",
      "type": "default_properties",
      "attributes": {
        "created_at": "2023-02-23T13:36:34+00:00",
        "updated_at": "2023-02-23T13:36:34+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/8e421db2-e003-4917-9a16-f64645e8477e?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "8e421db2-e003-4917-9a16-f64645e8477e",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-23T13:36:35+00:00",
      "updated_at": "2023-02-23T13:36:35+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "phone",
...
```json
  {
  "data": {
    "id": "2167619c-6ef4-4d64-b3d8-fd442eca6669",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-23T13:36:36+00:00",
      "updated_at": "2023-02-23T13:36:36+00:00",
      "name": "Mobile phone",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/ad839a93-0b56-4926-9cfe-d9049c913598' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "ad839a93-0b56-4926-9cfe-d9049c913598",
        "type": "default_properties",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/6b0cfdb4-bad7-4a60-b5af-771b00ef4286' \
    --header 'content-type: application/json' \
    --data '{}'
```
