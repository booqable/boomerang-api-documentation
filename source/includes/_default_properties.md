...
```json
  ...
  "data": [
    {
      "id": "999281da-2ac4-4166-90f8-ee10f54f49c8",
      "type": "default_properties",
      "attributes": {
        "created_at": "2022-04-07T10:04:39+00:00",
        "updated_at": "2022-04-07T10:04:39+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/0c9ed265-88e0-4a7e-9479-3479e3238753?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "0c9ed265-88e0-4a7e-9479-3479e3238753",
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-04-07T10:04:39+00:00",
      "updated_at": "2022-04-07T10:04:39+00:00",
...
```json
  {
  "data": {
    "id": "449250ef-55fb-4398-87d2-cffd9cb93d46",
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-04-07T10:04:40+00:00",
      "updated_at": "2022-04-07T10:04:40+00:00",
      "name": "Mobile phone",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/fdd0525d-2266-40bc-b2ae-c22151d756a6' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "fdd0525d-2266-40bc-b2ae-c22151d756a6",
        "type": "default_properties",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/979bdb1b-2524-44b7-8b23-e65700aae67f' \
    --header 'content-type: application/json' \
    --data '{}'
```
