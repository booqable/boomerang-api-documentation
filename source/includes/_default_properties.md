...
```json
  ...
  "data": [
    {
      "id": "ff2b7512-33db-47c7-9539-eeba084e58f8",
      "type": "default_properties",
      "attributes": {
        "created_at": "2023-03-01T14:48:37+00:00",
        "updated_at": "2023-03-01T14:48:37+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/8fc1901b-98bf-4a63-a120-6a312d27cc30?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "8fc1901b-98bf-4a63-a120-6a312d27cc30",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-03-01T14:48:38+00:00",
      "updated_at": "2023-03-01T14:48:38+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "phone",
...
```json
  {
  "data": {
    "id": "2e4d0ff3-e919-493a-bf36-6c1bd40aa35a",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-03-01T14:48:38+00:00",
      "updated_at": "2023-03-01T14:48:38+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/d9a22d7e-c74f-414f-b505-aee9bd361dac' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "d9a22d7e-c74f-414f-b505-aee9bd361dac",
        "type": "default_properties",
        "attributes": {
...
```json
  ...
  "data": {
    ...
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-03-01T14:48:39+00:00",
      "updated_at": "2023-03-01T14:48:39+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "text_field",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/7c7379ed-239d-4b19-9b0e-a53639c32cb6' \
    --header 'content-type: application/json' \
    --data '{}'
```
