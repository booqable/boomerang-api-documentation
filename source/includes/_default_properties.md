...
```json
  ...
  "data": [
    {
      "id": "067359d4-c90f-46b9-bceb-0775b3884811",
      "type": "default_properties",
      "attributes": {
        "created_at": "2023-02-16T08:12:22+00:00",
        "updated_at": "2023-02-16T08:12:22+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/7684a9d3-e6ce-43a8-b883-c093d855d1de?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "7684a9d3-e6ce-43a8-b883-c093d855d1de",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-16T08:12:22+00:00",
      "updated_at": "2023-02-16T08:12:22+00:00",
...
```json
  {
  "data": {
    "id": "ca59b9b4-0d90-45a2-9d9a-8c5010aa63f2",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-16T08:12:23+00:00",
      "updated_at": "2023-02-16T08:12:23+00:00",
      "name": "Mobile phone",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/27ea32ea-62a2-4e73-9928-080a34f359dd' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "27ea32ea-62a2-4e73-9928-080a34f359dd",
        "type": "default_properties",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/583dcdf4-2b50-44d8-a61f-8ceaa8638d7b' \
    --header 'content-type: application/json' \
    --data '{}'
```
