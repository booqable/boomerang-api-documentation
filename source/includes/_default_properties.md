...
```json
  ...
  "data": [
    {
      "id": "9b33b74f-4171-42a7-be80-8135bdbd7bfb",
      "type": "default_properties",
      "attributes": {
        "created_at": "2023-02-01T15:14:26+00:00",
        "updated_at": "2023-02-01T15:14:26+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/75c47fac-045f-4382-8fb3-cccb32aaf6b9?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "75c47fac-045f-4382-8fb3-cccb32aaf6b9",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-01T15:14:26+00:00",
      "updated_at": "2023-02-01T15:14:26+00:00",
...
```json
  {
  "data": {
    "id": "b947e619-758d-4c4c-a77f-b9545a3d9bca",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-01T15:14:27+00:00",
      "updated_at": "2023-02-01T15:14:27+00:00",
      "name": "Mobile phone",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/eb5b0589-2967-4ebf-a0e3-d51da1ae7b90' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "eb5b0589-2967-4ebf-a0e3-d51da1ae7b90",
        "type": "default_properties",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/c2d26dcb-1574-42e3-933a-f56f919ad56c' \
    --header 'content-type: application/json' \
    --data '{}'
```
