...
```json
  ...
  "data": [
    {
      "id": "4aea2fcf-0132-4d93-8b9a-f1362592d7f0",
      "type": "default_properties",
      "attributes": {
        "created_at": "2023-02-22T10:35:35+00:00",
        "updated_at": "2023-02-22T10:35:35+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/74b37c7d-7956-4780-b424-90b38f6c9c09?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "74b37c7d-7956-4780-b424-90b38f6c9c09",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-22T10:35:35+00:00",
      "updated_at": "2023-02-22T10:35:35+00:00",
...
```json
  {
  "data": {
    "id": "1b2094c6-f28e-4b4a-8304-c3b3d2f9665b",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-22T10:35:36+00:00",
      "updated_at": "2023-02-22T10:35:36+00:00",
      "name": "Mobile phone",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/1a193d02-bae4-453a-82ef-cd963872eed9' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "1a193d02-bae4-453a-82ef-cd963872eed9",
        "type": "default_properties",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/b53e5d49-a851-4221-af2f-9b9f1bd4e47d' \
    --header 'content-type: application/json' \
    --data '{}'
```
