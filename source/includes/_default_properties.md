...
```json
  ...
  "data": [
    {
      "id": "08c3e80a-9a5a-4197-8bbe-a98240f026a0",
      "type": "default_properties",
      "attributes": {
        "created_at": "2022-11-22T15:50:14+00:00",
        "updated_at": "2022-11-22T15:50:14+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/62aaa6ad-0037-46fd-b521-9f98b9129c80?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "62aaa6ad-0037-46fd-b521-9f98b9129c80",
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-11-22T15:50:15+00:00",
      "updated_at": "2022-11-22T15:50:15+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "phone",
...
```json
  {
  "data": {
    "id": "ddbffb2f-8b80-4c11-8cd4-8e24f482328f",
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-11-22T15:50:15+00:00",
      "updated_at": "2022-11-22T15:50:15+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/f6c8e34a-d8bd-4585-8be6-4bd12e946bc7' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "f6c8e34a-d8bd-4585-8be6-4bd12e946bc7",
        "type": "default_properties",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/e3ef6c89-df2c-4f8f-8ca6-6d76519386f6' \
    --header 'content-type: application/json' \
    --data '{}'
```
