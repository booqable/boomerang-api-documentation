...
```json
  ...
  "data": [
    {
      "id": "c5c9f898-16a3-4452-8c87-fa9b6edb1f32",
      "type": "default_properties",
      "attributes": {
        "created_at": "2023-02-17T10:32:35+00:00",
        "updated_at": "2023-02-17T10:32:35+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/d2e0a1d2-4e14-4ca4-a84e-6ebcae94dcab?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "d2e0a1d2-4e14-4ca4-a84e-6ebcae94dcab",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-17T10:32:35+00:00",
      "updated_at": "2023-02-17T10:32:35+00:00",
...
```json
  {
  "data": {
    "id": "0ca1d623-41ac-4dc6-af01-492c5ca02e6b",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-17T10:32:36+00:00",
      "updated_at": "2023-02-17T10:32:36+00:00",
      "name": "Mobile phone",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/dbc07451-6cc7-4630-8cb7-bd7d2af88253' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "dbc07451-6cc7-4630-8cb7-bd7d2af88253",
        "type": "default_properties",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/82d87a90-ee0a-45ff-955b-d95d32bb5862' \
    --header 'content-type: application/json' \
    --data '{}'
```
