...
```json
  ...
  "data": [
    {
      "id": "e4a264f1-eb41-4387-9a21-794c0cc5ad5e",
      "type": "default_properties",
      "attributes": {
        "created_at": "2022-07-08T13:10:49+00:00",
        "updated_at": "2022-07-08T13:10:49+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/9d6d8a47-a0d7-4e16-81d1-120dc6fe2f80?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "9d6d8a47-a0d7-4e16-81d1-120dc6fe2f80",
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-07-08T13:10:49+00:00",
      "updated_at": "2022-07-08T13:10:49+00:00",
...
```json
  {
  "data": {
    "id": "1b98c416-69e1-46bd-b33b-5680854afcba",
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-07-08T13:10:49+00:00",
      "updated_at": "2022-07-08T13:10:49+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/083edd2d-087c-4d47-9a61-37e6f0806d47' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "083edd2d-087c-4d47-9a61-37e6f0806d47",
        "type": "default_properties",
        "attributes": {
...
```json
  ...
  "data": {
    ...
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-07-08T13:10:50+00:00",
      "updated_at": "2022-07-08T13:10:50+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "text_field",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/855e767b-9d7e-44a0-87e5-381580a1110f' \
    --header 'content-type: application/json' \
    --data '{}'
```
