...
```json
  ...
  "data": [
    {
      "id": "b8e9648a-d03a-4b92-acea-c9e9f2d9949d",
      "type": "default_properties",
      "attributes": {
        "created_at": "2022-11-16T14:22:42+00:00",
        "updated_at": "2022-11-16T14:22:42+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/2ceecc4b-8ce9-466a-b8be-fe72f9859d86?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "2ceecc4b-8ce9-466a-b8be-fe72f9859d86",
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-11-16T14:22:43+00:00",
      "updated_at": "2022-11-16T14:22:43+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "phone",
...
```json
  {
  "data": {
    "id": "8dcad55c-f7f8-473a-aa33-acb63407f624",
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-11-16T14:22:43+00:00",
      "updated_at": "2022-11-16T14:22:43+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/7b5861e8-deb0-4b79-83ff-f6a3ae9b3c0a' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "7b5861e8-deb0-4b79-83ff-f6a3ae9b3c0a",
        "type": "default_properties",
        "attributes": {
...
```json
  ...
  "data": {
    ...
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-11-16T14:22:44+00:00",
      "updated_at": "2022-11-16T14:22:44+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "text_field",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/8e3ae00c-f594-4663-a585-55691e15cef1' \
    --header 'content-type: application/json' \
    --data '{}'
```
