...
```json
  ...
  "data": [
    {
      "id": "e01ca9e0-a088-4175-aaac-838b8434da10",
      "type": "default_properties",
      "attributes": {
        "created_at": "2023-02-09T14:21:45+00:00",
        "updated_at": "2023-02-09T14:21:45+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/f3f6e1dc-90da-45f7-b117-6c8f4d5ad230?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "f3f6e1dc-90da-45f7-b117-6c8f4d5ad230",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-09T14:21:45+00:00",
      "updated_at": "2023-02-09T14:21:45+00:00",
...
```json
  {
  "data": {
    "id": "085e8ca4-469b-4094-8358-1aa723acd74a",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-09T14:21:45+00:00",
      "updated_at": "2023-02-09T14:21:45+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/afa6f52d-e608-4aa5-8d04-fddaa249f135' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "afa6f52d-e608-4aa5-8d04-fddaa249f135",
        "type": "default_properties",
        "attributes": {
...
```json
  ...
  "data": {
    ...
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-09T14:21:46+00:00",
      "updated_at": "2023-02-09T14:21:46+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "text_field",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/c25f849f-045d-407c-9490-a32bae17e390' \
    --header 'content-type: application/json' \
    --data '{}'
```
