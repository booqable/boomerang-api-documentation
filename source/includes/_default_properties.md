...
```json
  ...
  "data": [
    {
      "id": "8e4f0cf2-ee5f-4257-a216-32b9204c538b",
      "type": "default_properties",
      "attributes": {
        "created_at": "2023-02-02T16:37:15+00:00",
        "updated_at": "2023-02-02T16:37:15+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/f983ab1b-2984-49f4-b02d-c800422980d8?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "f983ab1b-2984-49f4-b02d-c800422980d8",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-02T16:37:15+00:00",
      "updated_at": "2023-02-02T16:37:15+00:00",
...
```json
  {
  "data": {
    "id": "002fd9e8-5a59-4e7a-96a8-abef75c65137",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-02T16:37:16+00:00",
      "updated_at": "2023-02-02T16:37:16+00:00",
      "name": "Mobile phone",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/3f3425e6-cd6e-4909-829c-70b569d58f8d' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "3f3425e6-cd6e-4909-829c-70b569d58f8d",
        "type": "default_properties",
        "attributes": {
...
```json
  ...
  "data": {
    ...
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-02T16:37:17+00:00",
      "updated_at": "2023-02-02T16:37:17+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "text_field",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/3135698e-6d3d-4830-abc3-12326453aebb' \
    --header 'content-type: application/json' \
    --data '{}'
```
