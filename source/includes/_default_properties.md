...
```json
  ...
  "data": [
    {
      "id": "31003fb5-d0b3-446d-82bc-f5e59b708700",
      "type": "default_properties",
      "attributes": {
        "created_at": "2022-11-22T15:32:23+00:00",
        "updated_at": "2022-11-22T15:32:23+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/712c1069-c1d7-4586-ad04-abb77534b546?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "712c1069-c1d7-4586-ad04-abb77534b546",
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-11-22T15:32:23+00:00",
      "updated_at": "2022-11-22T15:32:23+00:00",
...
```json
  {
  "data": {
    "id": "fbdf03ff-e9a8-4d57-885b-7906acbc3a42",
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-11-22T15:32:24+00:00",
      "updated_at": "2022-11-22T15:32:24+00:00",
      "name": "Mobile phone",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/f9b45cb9-162e-42bc-85c2-7a529fc63521' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "f9b45cb9-162e-42bc-85c2-7a529fc63521",
        "type": "default_properties",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/ad80dc6e-08d1-432e-a940-949977f2a568' \
    --header 'content-type: application/json' \
    --data '{}'
```
