...
```json
  ...
  "data": [
    {
      "id": "6fa719be-230f-4cb9-8108-60ce74cfb12d",
      "type": "default_properties",
      "attributes": {
        "created_at": "2022-05-31T06:54:58+00:00",
        "updated_at": "2022-05-31T06:54:58+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/4edd5231-7eee-49fe-a4df-9969f3662db3?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "4edd5231-7eee-49fe-a4df-9969f3662db3",
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-05-31T06:54:58+00:00",
      "updated_at": "2022-05-31T06:54:58+00:00",
...
```json
  {
  "data": {
    "id": "0b443002-d98e-4fb0-a8a8-69069f9a9734",
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-05-31T06:54:59+00:00",
      "updated_at": "2022-05-31T06:54:59+00:00",
      "name": "Mobile phone",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/927127a4-fd3a-4edf-8b05-26397f2f6b8f' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "927127a4-fd3a-4edf-8b05-26397f2f6b8f",
        "type": "default_properties",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/e46cf4e2-c358-41e9-9ef8-2592f3f8d59e' \
    --header 'content-type: application/json' \
    --data '{}'
```
