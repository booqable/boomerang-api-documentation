...
```json
  ...
  "data": [
    {
      "id": "f718b383-f446-4da7-a446-b00431382071",
      "type": "default_properties",
      "attributes": {
        "created_at": "2023-02-08T15:43:08+00:00",
        "updated_at": "2023-02-08T15:43:08+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/8a4ec2e6-6918-47bb-b599-8331e4096edc?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "8a4ec2e6-6918-47bb-b599-8331e4096edc",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-08T15:43:08+00:00",
      "updated_at": "2023-02-08T15:43:08+00:00",
...
```json
  {
  "data": {
    "id": "ee6feb45-c218-4ed2-8e49-88dfd20bd842",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-08T15:43:08+00:00",
      "updated_at": "2023-02-08T15:43:08+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/e3f46ffa-5cdb-4887-91bb-3bd0c3b4562f' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "e3f46ffa-5cdb-4887-91bb-3bd0c3b4562f",
        "type": "default_properties",
        "attributes": {
...
```json
  ...
  "data": {
    ...
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-08T15:43:09+00:00",
      "updated_at": "2023-02-08T15:43:09+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "text_field",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/c2d7853e-cace-47e6-9487-de803ba0722e' \
    --header 'content-type: application/json' \
    --data '{}'
```
