...
```json
  ...
  "data": [
    {
      "id": "16efcc31-0e1a-4e19-b02c-02bf7ef9a73f",
      "type": "default_properties",
      "attributes": {
        "created_at": "2022-11-22T14:41:25+00:00",
        "updated_at": "2022-11-22T14:41:25+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/7579935d-63dd-40c8-bdc3-f3882b1cce16?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "7579935d-63dd-40c8-bdc3-f3882b1cce16",
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-11-22T14:41:25+00:00",
      "updated_at": "2022-11-22T14:41:25+00:00",
...
```json
  {
  "data": {
    "id": "e1ffdb53-86d0-488d-b6d5-0308a648d240",
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-11-22T14:41:25+00:00",
      "updated_at": "2022-11-22T14:41:25+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/75893544-0500-40d3-b671-93fd53112a60' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "75893544-0500-40d3-b671-93fd53112a60",
        "type": "default_properties",
        "attributes": {
...
```json
  ...
  "data": {
    ...
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-11-22T14:41:26+00:00",
      "updated_at": "2022-11-22T14:41:26+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "text_field",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/58ae0b10-f773-48b2-b973-ff115a523b94' \
    --header 'content-type: application/json' \
    --data '{}'
```
