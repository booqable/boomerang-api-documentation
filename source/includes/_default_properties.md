...
```json
  ...
  "data": [
    {
      "id": "ae04d9ff-eb9e-4a0c-95e6-945cc7a922ac",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/b45f97c0-8afa-400d-b07c-471df39ae647?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "b45f97c0-8afa-400d-b07c-471df39ae647",
    "type": "default_properties",
    "attributes": {
...
```json
  {
  "data": {
    "id": "04ca3afc-559b-4bf6-a941-fc402039a9ac",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-03T11:09:39+00:00",
      "updated_at": "2023-02-03T11:09:39+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/e1a32b3b-defc-45bb-a82a-749daafc3c54' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "e1a32b3b-defc-45bb-a82a-749daafc3c54",
        "type": "default_properties",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/e1e228db-7355-4868-bc15-e173e419efee' \
    --header 'content-type: application/json' \
    --data '{}'
```
