...
```json
  ...
  "data": [
    {
      "id": "ae5763db-3f46-41f5-95fb-6f756f7e41f5",
      "type": "default_properties",
      "attributes": {
        "created_at": "2023-02-08T08:34:48+00:00",
        "updated_at": "2023-02-08T08:34:48+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/abf1f276-4af9-4633-b31c-aad4d593ca12?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "abf1f276-4af9-4633-b31c-aad4d593ca12",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-08T08:34:48+00:00",
      "updated_at": "2023-02-08T08:34:48+00:00",
...
```json
  {
  "data": {
    "id": "07b54887-2270-42c0-b311-f2062c8d7e11",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-08T08:34:49+00:00",
      "updated_at": "2023-02-08T08:34:49+00:00",
      "name": "Mobile phone",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/f888ca0f-0e9d-41c1-8e60-13c897cae8a9' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "f888ca0f-0e9d-41c1-8e60-13c897cae8a9",
        "type": "default_properties",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/3f5b1d18-db49-43fa-9986-7ae4dd415298' \
    --header 'content-type: application/json' \
    --data '{}'
```
