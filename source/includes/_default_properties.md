...
```json
  ...
  "data": [
    {
      "id": "6ebc9890-5767-4d18-b68a-a799bc020525",
      "type": "default_properties",
      "attributes": {
        "created_at": "2022-04-04T13:21:44+00:00",
        "updated_at": "2022-04-04T13:21:44+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/600945d0-8ae9-4d81-88b1-39b6836aad5a?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "600945d0-8ae9-4d81-88b1-39b6836aad5a",
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-04-04T13:21:45+00:00",
      "updated_at": "2022-04-04T13:21:45+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "phone",
...
```json
  {
  "data": {
    "id": "28ff4c92-2a91-4c05-8515-644361a0f919",
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-04-04T13:21:45+00:00",
      "updated_at": "2022-04-04T13:21:45+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/28b65de8-d785-4382-8d16-a848275f193e' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "28b65de8-d785-4382-8d16-a848275f193e",
        "type": "default_properties",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/8f635436-9a2d-457d-913b-b241b12afc0b' \
    --header 'content-type: application/json' \
    --data '{}'
```
