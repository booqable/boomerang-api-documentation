...
```json
  ...
  "data": [
    {
      "id": "b4ad7dc0-2bea-4853-8b0d-847d2c149f86",
      "type": "default_properties",
      "attributes": {
        "created_at": "2023-02-14T15:26:49+00:00",
        "updated_at": "2023-02-14T15:26:49+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/3f6ae437-792e-4aeb-8dc0-14bd637cf4de?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "3f6ae437-792e-4aeb-8dc0-14bd637cf4de",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-14T15:26:49+00:00",
      "updated_at": "2023-02-14T15:26:49+00:00",
...
```json
  {
  "data": {
    "id": "49fd9687-4609-4cfb-b168-e05ab855243e",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-14T15:26:50+00:00",
      "updated_at": "2023-02-14T15:26:50+00:00",
      "name": "Mobile phone",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/6c9736c4-03c4-40e6-bafe-9d94bcfe57bc' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "6c9736c4-03c4-40e6-bafe-9d94bcfe57bc",
        "type": "default_properties",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/be892788-f29c-4d9e-ab76-dc439c8c04f1' \
    --header 'content-type: application/json' \
    --data '{}'
```
