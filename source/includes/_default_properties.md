...
```json
  ...
  "data": [
    {
      "id": "9974e83d-aad9-4725-a047-a8a1c96177e6",
      "type": "default_properties",
      "attributes": {
        "created_at": "2023-02-02T08:01:28+00:00",
        "updated_at": "2023-02-02T08:01:28+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/73273477-e4e3-4a5a-8d59-1ff82fa43786?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "73273477-e4e3-4a5a-8d59-1ff82fa43786",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-02T08:01:29+00:00",
      "updated_at": "2023-02-02T08:01:29+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "phone",
...
```json
  {
  "data": {
    "id": "8767beb7-8233-43af-a4f3-eb7a0bfeb6c3",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-02T08:01:29+00:00",
      "updated_at": "2023-02-02T08:01:29+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/0b602ae2-ebf2-41d0-a05d-bdad07f14afe' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "0b602ae2-ebf2-41d0-a05d-bdad07f14afe",
        "type": "default_properties",
        "attributes": {
...
```json
  ...
  "data": {
    ...
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-02T08:01:30+00:00",
      "updated_at": "2023-02-02T08:01:30+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "text_field",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/aa9c6a3f-c176-47f0-9227-1a7df624643d' \
    --header 'content-type: application/json' \
    --data '{}'
```
