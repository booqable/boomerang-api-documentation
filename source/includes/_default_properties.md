...
```json
  ...
  "data": [
    {
      "id": "47810b07-fe4a-4303-9070-78f55e311a59",
      "type": "default_properties",
      "attributes": {
        "created_at": "2023-03-10T08:37:25+00:00",
        "updated_at": "2023-03-10T08:37:25+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/62642b58-2cdc-423c-a7fd-a31561998bd2?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "62642b58-2cdc-423c-a7fd-a31561998bd2",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-03-10T08:37:25+00:00",
      "updated_at": "2023-03-10T08:37:25+00:00",
...
```json
  {
  "data": {
    "id": "c22809e9-320a-439a-9f8a-a5deba9ba115",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-03-10T08:37:26+00:00",
      "updated_at": "2023-03-10T08:37:26+00:00",
      "name": "Mobile phone",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/924fd317-d655-4539-883b-cfcc960bdcac' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "924fd317-d655-4539-883b-cfcc960bdcac",
        "type": "default_properties",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/08fac14f-2723-4d8d-97ba-9a35038cb041' \
    --header 'content-type: application/json' \
    --data '{}'
```
