...
```json
  ...
  "data": [
    {
      "id": "86f8e40f-0639-4b37-8f72-03c7ec42dd32",
      "type": "default_properties",
      "attributes": {
        "created_at": "2023-02-09T13:05:55+00:00",
        "updated_at": "2023-02-09T13:05:55+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/831c04be-1fc1-4e4b-b0bb-7a760bf0e6b5?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "831c04be-1fc1-4e4b-b0bb-7a760bf0e6b5",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-09T13:05:56+00:00",
      "updated_at": "2023-02-09T13:05:56+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "phone",
...
```json
  {
  "data": {
    "id": "68543bff-29a3-4342-a9d7-4495df833941",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-09T13:05:56+00:00",
      "updated_at": "2023-02-09T13:05:56+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/d04f62c5-d89b-43ec-b409-9da1eaa2191d' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "d04f62c5-d89b-43ec-b409-9da1eaa2191d",
        "type": "default_properties",
        "attributes": {
...
```json
  ...
  "data": {
    ...
    "attributes": {
      "created_at": "2023-02-09T13:05:56+00:00",
      "updated_at": "2023-02-09T13:05:57+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "text_field",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/548cd151-9c8b-498e-b612-8f9a13d55b49' \
    --header 'content-type: application/json' \
    --data '{}'
```
