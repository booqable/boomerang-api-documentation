...
```json
  ...
  "data": [
    {
      "id": "4c4f806a-d5db-4e4d-80c3-867de5226762",
      "type": "default_properties",
      "attributes": {
        "created_at": "2022-06-15T09:34:37+00:00",
        "updated_at": "2022-06-15T09:34:37+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/9e82f382-fdd2-482b-87ba-10eb9bdbfd78?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "9e82f382-fdd2-482b-87ba-10eb9bdbfd78",
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-06-15T09:34:37+00:00",
      "updated_at": "2022-06-15T09:34:37+00:00",
...
```json
  {
  "data": {
    "id": "01e0b960-c982-4d19-90e2-00e801eb1b70",
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-06-15T09:34:37+00:00",
      "updated_at": "2022-06-15T09:34:37+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/d456f569-7b9e-4d04-9d86-544aac01e5cb' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "d456f569-7b9e-4d04-9d86-544aac01e5cb",
        "type": "default_properties",
        "attributes": {
...
```json
  ...
  "data": {
    ...
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-06-15T09:34:38+00:00",
      "updated_at": "2022-06-15T09:34:38+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "text_field",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/bfc99316-c24b-4a77-8c70-864c6104d9c6' \
    --header 'content-type: application/json' \
    --data '{}'
```
