...
```json
  ...
  "data": [
    {
      "id": "0be384de-e549-42cc-b510-d3afc95962ee",
      "type": "default_properties",
      "attributes": {
        "created_at": "2022-07-14T10:34:01+00:00",
        "updated_at": "2022-07-14T10:34:01+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/df6edbff-af54-4c97-acc1-436192d17862?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "df6edbff-af54-4c97-acc1-436192d17862",
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-07-14T10:34:01+00:00",
      "updated_at": "2022-07-14T10:34:01+00:00",
...
```json
  {
  "data": {
    "id": "8d0ddc1f-ed37-479c-8bbf-e2579c84efb2",
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-07-14T10:34:02+00:00",
      "updated_at": "2022-07-14T10:34:02+00:00",
      "name": "Mobile phone",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/738fe0e7-a589-43fc-979f-e1422301659e' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "738fe0e7-a589-43fc-979f-e1422301659e",
        "type": "default_properties",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/789da573-50c2-4363-8b87-105ff6e489c5' \
    --header 'content-type: application/json' \
    --data '{}'
```
