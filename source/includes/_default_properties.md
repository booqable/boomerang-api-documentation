...
```json
  ...
  "data": [
    {
      "id": "b09754e0-7de9-4f08-aae2-04772b3d1b52",
      "type": "default_properties",
      "attributes": {
        "created_at": "2023-02-21T10:56:15+00:00",
        "updated_at": "2023-02-21T10:56:15+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/c82461c0-2829-4563-92ac-381ef8f15c0b?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "c82461c0-2829-4563-92ac-381ef8f15c0b",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-21T10:56:16+00:00",
      "updated_at": "2023-02-21T10:56:16+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "phone",
...
```json
  {
  "data": {
    "id": "72d17a3e-e412-4f4c-91c1-49c143077086",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-21T10:56:16+00:00",
      "updated_at": "2023-02-21T10:56:16+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/dd64b9de-776f-432e-a9bb-901fd2afe78f' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "dd64b9de-776f-432e-a9bb-901fd2afe78f",
        "type": "default_properties",
        "attributes": {
...
```json
  ...
  "data": {
    ...
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-21T10:56:17+00:00",
      "updated_at": "2023-02-21T10:56:17+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "text_field",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/f8c961f4-7eab-4c62-8fa1-a63237458785' \
    --header 'content-type: application/json' \
    --data '{}'
```
