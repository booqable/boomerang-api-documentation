...
```json
  ...
  "data": [
    {
      "id": "93ef9a08-ad1b-4dfb-ad76-fd81c0ea7fe1",
      "type": "default_properties",
      "attributes": {
        "created_at": "2022-06-24T14:45:28+00:00",
        "updated_at": "2022-06-24T14:45:28+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/df2e46a4-f572-4dc4-bc88-e82cd0e93a90?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "df2e46a4-f572-4dc4-bc88-e82cd0e93a90",
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-06-24T14:45:28+00:00",
      "updated_at": "2022-06-24T14:45:28+00:00",
...
```json
  {
  "data": {
    "id": "f33dd612-7dff-4ecf-896b-733a69093488",
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-06-24T14:45:28+00:00",
      "updated_at": "2022-06-24T14:45:28+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/c522090b-6982-4828-91e0-6c7a6bb293c7' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "c522090b-6982-4828-91e0-6c7a6bb293c7",
        "type": "default_properties",
        "attributes": {
...
```json
  ...
  "data": {
    ...
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-06-24T14:45:29+00:00",
      "updated_at": "2022-06-24T14:45:29+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "text_field",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/f8e6f6b3-c7d0-4191-b0d3-cb89728dde98' \
    --header 'content-type: application/json' \
    --data '{}'
```
