...
```json
  ...
  "data": [
    {
      "id": "d616287a-930e-4107-bfb4-a1b39bee873c",
      "type": "default_properties",
      "attributes": {
        "created_at": "2023-02-08T15:18:32+00:00",
        "updated_at": "2023-02-08T15:18:32+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/bba9d185-5f6c-4e08-a614-95fb43578db0?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "bba9d185-5f6c-4e08-a614-95fb43578db0",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-08T15:18:32+00:00",
      "updated_at": "2023-02-08T15:18:32+00:00",
...
```json
  {
  "data": {
    "id": "f39e5cdf-d48e-41d0-9945-3a923e724f20",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-08T15:18:32+00:00",
      "updated_at": "2023-02-08T15:18:32+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/d6186855-961c-4375-bfd6-74c43e5f7910' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "d6186855-961c-4375-bfd6-74c43e5f7910",
        "type": "default_properties",
        "attributes": {
...
```json
  ...
  "data": {
    ...
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-08T15:18:33+00:00",
      "updated_at": "2023-02-08T15:18:33+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "text_field",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/05c0f646-8809-447e-8f95-a5a8d9591f46' \
    --header 'content-type: application/json' \
    --data '{}'
```
