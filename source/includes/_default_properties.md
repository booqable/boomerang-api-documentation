...
```json
  ...
  "data": [
    {
      "id": "46d1b2ab-c5f1-4707-8541-dadfec91163d",
      "type": "default_properties",
      "attributes": {
        "created_at": "2023-03-09T08:57:33+00:00",
        "updated_at": "2023-03-09T08:57:33+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/4e871efb-2112-4623-a517-4e1b0bba3cb8?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "4e871efb-2112-4623-a517-4e1b0bba3cb8",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-03-09T08:57:33+00:00",
      "updated_at": "2023-03-09T08:57:33+00:00",
...
```json
  {
  "data": {
    "id": "ff258e5c-c3c6-4749-ada4-e69149327f6d",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-03-09T08:57:33+00:00",
      "updated_at": "2023-03-09T08:57:33+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/8787e6d0-787b-4678-ae11-3283c248aa27' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "8787e6d0-787b-4678-ae11-3283c248aa27",
        "type": "default_properties",
        "attributes": {
...
```json
  ...
  "data": {
    ...
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-03-09T08:57:34+00:00",
      "updated_at": "2023-03-09T08:57:34+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "text_field",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/abfac240-2116-40fe-8c06-627056dcf754' \
    --header 'content-type: application/json' \
    --data '{}'
```
