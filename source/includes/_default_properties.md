...
```json
  ...
  "data": [
    {
      "id": "7903f97c-c9b5-489a-8b3b-406da6c24191",
      "type": "default_properties",
      "attributes": {
        "created_at": "2023-02-13T08:14:37+00:00",
        "updated_at": "2023-02-13T08:14:37+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/c90b4fdf-b8b6-4a9e-8df1-a6242eded262?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "c90b4fdf-b8b6-4a9e-8df1-a6242eded262",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-13T08:14:38+00:00",
      "updated_at": "2023-02-13T08:14:38+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "phone",
...
```json
  {
  "data": {
    "id": "6fdf65ac-3957-4eff-b39a-e463c47cd05c",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-13T08:14:38+00:00",
      "updated_at": "2023-02-13T08:14:38+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/5fbc7696-8fd3-43c6-a087-54bcb11faeaf' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "5fbc7696-8fd3-43c6-a087-54bcb11faeaf",
        "type": "default_properties",
        "attributes": {
...
```json
  ...
  "data": {
    ...
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-13T08:14:39+00:00",
      "updated_at": "2023-02-13T08:14:39+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "text_field",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/bfa06ab4-0f25-4a90-a31e-ddfc92c28ec2' \
    --header 'content-type: application/json' \
    --data '{}'
```
