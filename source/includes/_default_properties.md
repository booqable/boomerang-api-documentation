...
```json
  ...
  "data": [
    {
      "id": "dfe25159-4ce9-446f-b48e-4296b1539245",
      "type": "default_properties",
      "attributes": {
        "created_at": "2022-02-21T07:52:27+00:00",
        "updated_at": "2022-02-21T07:52:27+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/7766f835-9773-42cf-add7-e548d1096b32?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "7766f835-9773-42cf-add7-e548d1096b32",
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-02-21T07:52:27+00:00",
      "updated_at": "2022-02-21T07:52:27+00:00",
...
```json
  {
  "data": {
    "id": "dfb905b9-9c03-48b4-a77d-1105a4927e3d",
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-02-21T07:52:27+00:00",
      "updated_at": "2022-02-21T07:52:27+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/61f78715-12df-46cc-9c0a-97292d9c1335' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "61f78715-12df-46cc-9c0a-97292d9c1335",
        "type": "default_properties",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/78984e83-71e6-4fbe-9586-a0896f944abe' \
    --header 'content-type: application/json' \
    --data '{}'
```
