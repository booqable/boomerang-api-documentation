...
```json
  ...
  "data": [
    {
      "id": "490e415a-fd88-4a72-9330-4de3d6f98d7a",
      "type": "default_properties",
      "attributes": {
        "created_at": "2022-08-22T15:50:49+00:00",
        "updated_at": "2022-08-22T15:50:49+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/0c182d88-ca13-4079-8924-0eb8aefd476c?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "0c182d88-ca13-4079-8924-0eb8aefd476c",
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-08-22T15:50:49+00:00",
      "updated_at": "2022-08-22T15:50:49+00:00",
...
```json
  {
  "data": {
    "id": "b3a9a162-4e58-4a81-86a1-4be2a6c7fd7f",
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-08-22T15:50:49+00:00",
      "updated_at": "2022-08-22T15:50:49+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/c2419229-7475-45eb-91e2-a7b21d1dcfcb' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "c2419229-7475-45eb-91e2-a7b21d1dcfcb",
        "type": "default_properties",
        "attributes": {
...
```json
  ...
  "data": {
    ...
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-08-22T15:50:50+00:00",
      "updated_at": "2022-08-22T15:50:50+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "text_field",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/fa4bcd73-98aa-44bc-858c-f97f9fc81a30' \
    --header 'content-type: application/json' \
    --data '{}'
```
