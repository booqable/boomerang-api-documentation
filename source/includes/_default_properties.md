...
```json
  ...
  "data": [
    {
      "id": "225e8397-4af2-4e25-b5ca-44db26f89a0d",
      "type": "default_properties",
      "attributes": {
        "created_at": "2023-02-21T10:48:23+00:00",
        "updated_at": "2023-02-21T10:48:23+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/195ff972-05ef-498c-bba3-b56a3068b731?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "195ff972-05ef-498c-bba3-b56a3068b731",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-21T10:48:24+00:00",
      "updated_at": "2023-02-21T10:48:24+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "phone",
...
```json
  {
  "data": {
    "id": "068def7d-dfc7-46f1-812b-dd5d0f09e1be",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-21T10:48:24+00:00",
      "updated_at": "2023-02-21T10:48:24+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/023dee8a-4d0d-410c-a8b4-1bc04f2e891c' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "023dee8a-4d0d-410c-a8b4-1bc04f2e891c",
        "type": "default_properties",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/9a6942d9-4b2c-44fc-b76c-828d5d9f8906' \
    --header 'content-type: application/json' \
    --data '{}'
```
