...
```json
  ...
  "data": [
    {
      "id": "a1c9dfd8-5318-40c8-8b99-29bf9cba838c",
      "type": "default_properties",
      "attributes": {
        "created_at": "2023-02-24T09:11:14+00:00",
        "updated_at": "2023-02-24T09:11:14+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/465a4eed-a0c6-4b27-9650-2cbe3053c7ba?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "465a4eed-a0c6-4b27-9650-2cbe3053c7ba",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-24T09:11:14+00:00",
      "updated_at": "2023-02-24T09:11:14+00:00",
...
```json
  {
  "data": {
    "id": "14ed2c1e-6b3a-4c78-89a4-24d51f7cfc9b",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-24T09:11:14+00:00",
      "updated_at": "2023-02-24T09:11:14+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/12be3ced-d8ad-4b20-adcd-2e1c64f026e5' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "12be3ced-d8ad-4b20-adcd-2e1c64f026e5",
        "type": "default_properties",
        "attributes": {
...
```json
  ...
  "data": {
    ...
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-24T09:11:15+00:00",
      "updated_at": "2023-02-24T09:11:15+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "text_field",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/c4aabf18-d19f-479f-8523-1377f5532815' \
    --header 'content-type: application/json' \
    --data '{}'
```
