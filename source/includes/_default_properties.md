...
```json
  ...
  "data": [
    {
      "id": "353b031d-41a5-4850-b79b-a72b6fd0550d",
      "type": "default_properties",
      "attributes": {
        "created_at": "2023-02-02T19:25:57+00:00",
        "updated_at": "2023-02-02T19:25:57+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/9d5b73ba-febf-48ef-83df-e84d719cae34?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "9d5b73ba-febf-48ef-83df-e84d719cae34",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-02T19:25:57+00:00",
      "updated_at": "2023-02-02T19:25:57+00:00",
...
```json
  {
  "data": {
    "id": "9fa26eff-a067-424a-874a-dd0ee4619980",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-02T19:25:58+00:00",
      "updated_at": "2023-02-02T19:25:58+00:00",
      "name": "Mobile phone",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/3bccb89b-60de-490e-ba42-126f8914a9b2' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "3bccb89b-60de-490e-ba42-126f8914a9b2",
        "type": "default_properties",
        "attributes": {
...
```json
  ...
  "data": {
    ...
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-02T19:25:59+00:00",
      "updated_at": "2023-02-02T19:25:59+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "text_field",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/3cb6925b-8e8e-449b-a799-0d90c5f748bc' \
    --header 'content-type: application/json' \
    --data '{}'
```
