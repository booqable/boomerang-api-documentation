...
```json
  ...
  "data": [
    {
      "id": "4c6225df-c95f-44f1-91b9-51f78772998a",
      "type": "default_properties",
      "attributes": {
        "created_at": "2022-01-12T14:02:43+00:00",
        "updated_at": "2022-01-12T14:02:43+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/84ad1401-233b-4cfb-a1a3-d223fe63ef1e?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "84ad1401-233b-4cfb-a1a3-d223fe63ef1e",
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-01-12T14:02:43+00:00",
      "updated_at": "2022-01-12T14:02:43+00:00",
...
```json
  {
  "data": {
    "id": "0256d243-9931-451a-ae1c-0343f9fbab53",
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-01-12T14:02:43+00:00",
      "updated_at": "2022-01-12T14:02:43+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/c552b788-177c-42a3-b56a-41bc78dc871d' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "c552b788-177c-42a3-b56a-41bc78dc871d",
        "type": "default_properties",
        "attributes": {
...
```json
  ...
  "data": {
    ...
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-01-12T14:02:44+00:00",
      "updated_at": "2022-01-12T14:02:44+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "text_field",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/56a5021e-0a68-4c4b-836f-0ac138388093' \
    --header 'content-type: application/json' \
    --data '{}'
```
