...
```json
  ...
  "data": [
    {
      "id": "2752c911-4131-4f28-8a40-f939ea7d4f8f",
      "type": "default_properties",
      "attributes": {
        "created_at": "2023-02-23T13:50:24+00:00",
        "updated_at": "2023-02-23T13:50:24+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/cf3161cb-200d-43d3-b617-8ee25df0bc7a?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "cf3161cb-200d-43d3-b617-8ee25df0bc7a",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-23T13:50:26+00:00",
      "updated_at": "2023-02-23T13:50:26+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "phone",
...
```json
  {
  "data": {
    "id": "6ab5fbaf-5090-42fc-aff1-003f0ad494ea",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-23T13:50:28+00:00",
      "updated_at": "2023-02-23T13:50:28+00:00",
      "name": "Mobile phone",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/5b1cb325-c2bc-46a3-92a1-457e5593a0d0' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "5b1cb325-c2bc-46a3-92a1-457e5593a0d0",
        "type": "default_properties",
        "attributes": {
...
```json
  ...
  "data": {
    ...
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-23T13:50:29+00:00",
      "updated_at": "2023-02-23T13:50:29+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "text_field",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/d9687fb4-ccb0-4078-8f04-af66cbda0e57' \
    --header 'content-type: application/json' \
    --data '{}'
```
