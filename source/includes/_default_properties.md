...
```json
  ...
  "data": [
    {
      "id": "73d883c2-ae5c-4b6e-b036-8731647e468e",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/01f8686d-29bc-40db-b373-f5f6de0145cb?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "01f8686d-29bc-40db-b373-f5f6de0145cb",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-14T11:07:05+00:00",
      "updated_at": "2023-02-14T11:07:05+00:00",
...
```json
  {
  "data": {
    "id": "455ea7a3-61a9-4b5f-9980-e87e75259d63",
    "type": "default_properties",
    "attributes": {
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/ec106917-04a0-4f94-b3e5-bdf8f6fb46d5' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "ec106917-04a0-4f94-b3e5-bdf8f6fb46d5",
        "type": "default_properties",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/7d51a10d-634d-4eb6-844a-a66cba1a5d9b' \
    --header 'content-type: application/json' \
    --data '{}'
```
