...
```json
  ...
  "data": [
    {
      "id": "e3d8b0d6-256e-4b57-a4b7-e5c457675f4b",
      "type": "default_properties",
      "attributes": {
        "created_at": "2022-07-15T09:53:45+00:00",
        "updated_at": "2022-07-15T09:53:45+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/a0873515-3e7f-4b72-89f8-0074da128299?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "a0873515-3e7f-4b72-89f8-0074da128299",
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-07-15T09:53:45+00:00",
      "updated_at": "2022-07-15T09:53:45+00:00",
...
```json
  {
  "data": {
    "id": "3578aff4-a64e-483d-843b-7bd9e4a9e8b8",
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-07-15T09:53:45+00:00",
      "updated_at": "2022-07-15T09:53:45+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/4854ced3-2eca-44cb-b5ab-c65b5e04631c' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "4854ced3-2eca-44cb-b5ab-c65b5e04631c",
        "type": "default_properties",
        "attributes": {
...
```json
  ...
  "data": {
    ...
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-07-15T09:53:46+00:00",
      "updated_at": "2022-07-15T09:53:46+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "text_field",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/b899b870-9645-4ff1-a2d2-53d35d086806' \
    --header 'content-type: application/json' \
    --data '{}'
```
