...
```json
  ...
  "data": [
    {
      "id": "4cbe6d9f-125e-4564-920e-fac6c2ad98a3",
      "type": "default_properties",
      "attributes": {
        "created_at": "2023-01-05T11:03:07+00:00",
        "updated_at": "2023-01-05T11:03:07+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/850a5266-f6de-453e-9117-1f6918296d34?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "850a5266-f6de-453e-9117-1f6918296d34",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-01-05T11:03:07+00:00",
      "updated_at": "2023-01-05T11:03:07+00:00",
...
```json
  {
  "data": {
    "id": "f2203885-a77c-429e-a2e5-197b20fba237",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-01-05T11:03:08+00:00",
      "updated_at": "2023-01-05T11:03:08+00:00",
      "name": "Mobile phone",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/94e453c0-c43b-4254-80fb-cbb8c4a61f5d' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "94e453c0-c43b-4254-80fb-cbb8c4a61f5d",
        "type": "default_properties",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/a4a5fb1c-71e3-4241-87f2-6d42ad83cab6' \
    --header 'content-type: application/json' \
    --data '{}'
```
