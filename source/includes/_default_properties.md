...
```json
  ...
  "data": [
    {
      "id": "e2ee922b-4bb6-4842-a4a9-c7fabe48a241",
      "type": "default_properties",
      "attributes": {
        "created_at": "2023-02-24T14:56:44+00:00",
        "updated_at": "2023-02-24T14:56:44+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/6a91bae6-b031-401f-8175-5b54b67fb614?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "6a91bae6-b031-401f-8175-5b54b67fb614",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-24T14:56:44+00:00",
      "updated_at": "2023-02-24T14:56:44+00:00",
...
```json
  {
  "data": {
    "id": "5d28dc54-8228-4624-80b6-e79e606e4843",
    "type": "default_properties",
    "attributes": {
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/2b7bbbbe-f73a-47bb-bb01-577ad78ec432' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "2b7bbbbe-f73a-47bb-bb01-577ad78ec432",
        "type": "default_properties",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/b71ada8a-00e3-4de1-ac3d-bfc5bdfc3dd0' \
    --header 'content-type: application/json' \
    --data '{}'
```
