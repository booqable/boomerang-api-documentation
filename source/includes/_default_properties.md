...
```json
  ...
  "data": [
    {
      "id": "b4c622c2-7fc1-48c2-b5ac-35a7779d8623",
      "type": "default_properties",
      "attributes": {
        "created_at": "2022-05-03T10:18:24+00:00",
        "updated_at": "2022-05-03T10:18:24+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/77b1d22a-4a1c-4e54-ad93-2232a4f569a3?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "77b1d22a-4a1c-4e54-ad93-2232a4f569a3",
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-05-03T10:18:25+00:00",
      "updated_at": "2022-05-03T10:18:25+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "phone",
...
```json
  {
  "data": {
    "id": "836d9677-dc71-4a2f-823a-35aaeead280d",
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-05-03T10:18:25+00:00",
      "updated_at": "2022-05-03T10:18:25+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/5890a80f-4a48-4e76-927a-e30de99dfcde' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "5890a80f-4a48-4e76-927a-e30de99dfcde",
        "type": "default_properties",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/c2abefba-c0fa-4763-8aff-78f0b06ad916' \
    --header 'content-type: application/json' \
    --data '{}'
```
