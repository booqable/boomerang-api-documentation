...
```json
  ...
  "data": [
    {
      "id": "699e28fa-8967-4135-ab7e-3d1e1cb484cd",
      "type": "default_properties",
      "attributes": {
        "created_at": "2023-03-07T07:56:14+00:00",
        "updated_at": "2023-03-07T07:56:14+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/9008a4d2-aed1-4446-b9ae-49571f0d68bd?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "9008a4d2-aed1-4446-b9ae-49571f0d68bd",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-03-07T07:56:15+00:00",
      "updated_at": "2023-03-07T07:56:15+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "phone",
...
```json
  {
  "data": {
    "id": "b9776cd8-c81d-4a34-bdfa-d9b54e14cfaf",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-03-07T07:56:15+00:00",
      "updated_at": "2023-03-07T07:56:15+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/46ee60a5-5bc9-4cad-bb60-fb83ce5d5d57' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "46ee60a5-5bc9-4cad-bb60-fb83ce5d5d57",
        "type": "default_properties",
        "attributes": {
...
```json
  ...
  "data": {
    ...
    "attributes": {
      "created_at": "2023-03-07T07:56:15+00:00",
      "updated_at": "2023-03-07T07:56:16+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "text_field",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/e24a6134-e6c4-4092-837f-c3c4660cae4d' \
    --header 'content-type: application/json' \
    --data '{}'
```
