...
```json
  ...
  "data": [
    {
      "id": "6082beac-616a-4374-944b-8eec450be502",
      "type": "default_properties",
      "attributes": {
        "created_at": "2023-02-06T19:28:56+00:00",
        "updated_at": "2023-02-06T19:28:56+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/cd0e4b16-98bd-429d-b874-5d5e66be70c3?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "cd0e4b16-98bd-429d-b874-5d5e66be70c3",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-06T19:28:56+00:00",
      "updated_at": "2023-02-06T19:28:56+00:00",
...
```json
  {
  "data": {
    "id": "ef31a443-9319-44cc-82d3-5eb5510f323c",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-06T19:28:57+00:00",
      "updated_at": "2023-02-06T19:28:57+00:00",
      "name": "Mobile phone",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/55b941fc-9e66-4dfc-aab5-ed13827aabcf' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "55b941fc-9e66-4dfc-aab5-ed13827aabcf",
        "type": "default_properties",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/b750537f-4f7b-4ecd-b9e3-ffdcd5447622' \
    --header 'content-type: application/json' \
    --data '{}'
```
