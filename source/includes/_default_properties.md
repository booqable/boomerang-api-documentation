...
```json
  ...
  "data": [
    {
      "id": "e1d59c1c-36df-438d-b651-dfa4eb0b95a1",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/57d88d8c-b177-4ce8-88af-c40c9629b080?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "57d88d8c-b177-4ce8-88af-c40c9629b080",
    "type": "default_properties",
    "attributes": {
...
```json
  {
  "data": {
    "id": "97d4909a-7db1-481b-a054-27d3828bcb24",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-03-09T08:57:23+00:00",
      "updated_at": "2023-03-09T08:57:23+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/2399b515-e4fb-44fe-b785-4a8a7f1aaa90' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "2399b515-e4fb-44fe-b785-4a8a7f1aaa90",
        "type": "default_properties",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/3a80dfc2-2e8e-498f-b01f-1a5bf9dcb76d' \
    --header 'content-type: application/json' \
    --data '{}'
```
