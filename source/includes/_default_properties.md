...
```json
  ...
  "data": [
    {
      "id": "816523bf-4d18-4ad1-be23-994a2e856503",
      "type": "default_properties",
      "attributes": {
        "created_at": "2023-02-09T10:18:15+00:00",
        "updated_at": "2023-02-09T10:18:15+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/afc39d94-98a7-4ee4-8676-b19da04cdf99?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "afc39d94-98a7-4ee4-8676-b19da04cdf99",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-09T10:18:16+00:00",
      "updated_at": "2023-02-09T10:18:16+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "phone",
...
```json
  {
  "data": {
    "id": "52733fec-54ac-4ed6-8417-2b476be751f0",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-09T10:18:17+00:00",
      "updated_at": "2023-02-09T10:18:17+00:00",
      "name": "Mobile phone",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/1fdfb356-d59a-4469-93f2-4a179fc259b0' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "1fdfb356-d59a-4469-93f2-4a179fc259b0",
        "type": "default_properties",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/07afe642-2c66-403c-a8e6-f799da5f3f66' \
    --header 'content-type: application/json' \
    --data '{}'
```
