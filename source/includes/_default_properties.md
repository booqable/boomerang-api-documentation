...
```json
  ...
  "data": [
    {
      "id": "4525846f-a44e-426e-b27a-6b6d113656dd",
      "type": "default_properties",
      "attributes": {
        "created_at": "2021-12-13T08:13:59+00:00",
        "updated_at": "2021-12-13T08:13:59+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/42aa1504-68b8-4db9-83ea-dbc06df50cac?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "42aa1504-68b8-4db9-83ea-dbc06df50cac",
    "type": "default_properties",
    "attributes": {
      "created_at": "2021-12-13T08:13:59+00:00",
      "updated_at": "2021-12-13T08:13:59+00:00",
...
```json
  {
  "data": {
    "id": "6d85d01b-18cd-4f0c-942e-07b2ee70d192",
    "type": "default_properties",
    "attributes": {
      "created_at": "2021-12-13T08:14:00+00:00",
      "updated_at": "2021-12-13T08:14:00+00:00",
      "name": "Mobile phone",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/c312dc7f-cdaf-4dc3-a2b7-692ac7ca24d3' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "c312dc7f-cdaf-4dc3-a2b7-692ac7ca24d3",
        "type": "default_properties",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/09dcf4f0-5d25-42d7-bb1c-0ef7de8d3acc' \
    --header 'content-type: application/json' \
    --data '{}'
```
