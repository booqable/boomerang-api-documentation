...
```json
  ...
  "data": [
    {
      "id": "04027e31-3f9b-4362-938c-4c0f74e589b3",
      "type": "default_properties",
      "attributes": {
        "created_at": "2023-03-07T11:35:23+00:00",
        "updated_at": "2023-03-07T11:35:23+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/e5296a78-94cc-46de-801c-7a796346e6c7?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "e5296a78-94cc-46de-801c-7a796346e6c7",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-03-07T11:35:24+00:00",
      "updated_at": "2023-03-07T11:35:24+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "phone",
...
```json
  {
  "data": {
    "id": "2d6e2a63-2975-4d90-ad1f-b48d1622edd1",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-03-07T11:35:25+00:00",
      "updated_at": "2023-03-07T11:35:25+00:00",
      "name": "Mobile phone",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/ddf8aa8c-b6ea-424e-a079-bdafe334a19d' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "ddf8aa8c-b6ea-424e-a079-bdafe334a19d",
        "type": "default_properties",
        "attributes": {
...
```json
  ...
  "data": {
    ...
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-03-07T11:35:26+00:00",
      "updated_at": "2023-03-07T11:35:26+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "text_field",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/4042bb28-47e7-4da0-9d8d-a16fbeeb4636' \
    --header 'content-type: application/json' \
    --data '{}'
```
