...
```json
  ...
  "data": [
    {
      "id": "464142b8-bf12-4ddd-b47d-4a51e510b3fc",
      "type": "default_properties",
      "attributes": {
        "created_at": "2022-06-08T14:24:45+00:00",
        "updated_at": "2022-06-08T14:24:45+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/839aecc9-f3fa-4b6c-a655-7041c00daeba?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "839aecc9-f3fa-4b6c-a655-7041c00daeba",
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-06-08T14:24:45+00:00",
      "updated_at": "2022-06-08T14:24:45+00:00",
...
```json
  {
  "data": {
    "id": "5105d9b7-759d-4c95-b1e9-b8502671138e",
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-06-08T14:24:46+00:00",
      "updated_at": "2022-06-08T14:24:46+00:00",
      "name": "Mobile phone",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/879add37-159d-472e-a0b9-f7927d79a413' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "879add37-159d-472e-a0b9-f7927d79a413",
        "type": "default_properties",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/a1a889ae-aa5f-426a-9502-256dcac39dd1' \
    --header 'content-type: application/json' \
    --data '{}'
```
