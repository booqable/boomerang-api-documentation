...
```json
  ...
  "data": [
    {
      "id": "2dcc15bd-21d6-4fed-a660-7e4140721ae6",
      "type": "default_properties",
      "attributes": {
        "created_at": "2022-05-05T09:12:49+00:00",
        "updated_at": "2022-05-05T09:12:49+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/52c1a12e-3a50-4a51-9781-15e25bbea392?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "52c1a12e-3a50-4a51-9781-15e25bbea392",
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-05-05T09:12:49+00:00",
      "updated_at": "2022-05-05T09:12:49+00:00",
...
```json
  {
  "data": {
    "id": "e1bf6189-e3d9-40e1-9ccb-86805aeb33ae",
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-05-05T09:12:49+00:00",
      "updated_at": "2022-05-05T09:12:49+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/df6987fc-0756-4b42-93dc-18d5884f5817' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "df6987fc-0756-4b42-93dc-18d5884f5817",
        "type": "default_properties",
        "attributes": {
...
```json
  ...
  "data": {
    ...
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-05-05T09:12:50+00:00",
      "updated_at": "2022-05-05T09:12:50+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "text_field",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/8c44e527-82da-4fcb-81f2-f956fdb571b7' \
    --header 'content-type: application/json' \
    --data '{}'
```
