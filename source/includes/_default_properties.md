...
```json
  ...
  "data": [
    {
      "id": "048cf6b4-73bd-485c-b491-309cc768028e",
      "type": "default_properties",
      "attributes": {
        "created_at": "2023-02-07T10:57:28+00:00",
        "updated_at": "2023-02-07T10:57:28+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/637e7245-2aba-4525-893c-baf7e1cef9c3?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "637e7245-2aba-4525-893c-baf7e1cef9c3",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-07T10:57:29+00:00",
      "updated_at": "2023-02-07T10:57:29+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "phone",
...
```json
  {
  "data": {
    "id": "b91197bd-8c3a-46e1-9239-276682f8371c",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-07T10:57:30+00:00",
      "updated_at": "2023-02-07T10:57:30+00:00",
      "name": "Mobile phone",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/b6b6372f-1eed-4dc0-9e4c-e9feaed2b8ab' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "b6b6372f-1eed-4dc0-9e4c-e9feaed2b8ab",
        "type": "default_properties",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/2acb8e0f-e73a-4c3c-b638-484120823b45' \
    --header 'content-type: application/json' \
    --data '{}'
```
