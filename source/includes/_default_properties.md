...
```json
  ...
  "data": [
    {
      "id": "99b780d5-43f8-4f26-9925-a55147c1f4b0",
      "type": "default_properties",
      "attributes": {
        "created_at": "2022-01-14T18:53:25+00:00",
        "updated_at": "2022-01-14T18:53:25+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/07fd4d17-441a-4b1c-84c9-23496034a4b7?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "07fd4d17-441a-4b1c-84c9-23496034a4b7",
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-01-14T18:53:25+00:00",
      "updated_at": "2022-01-14T18:53:25+00:00",
...
```json
  {
  "data": {
    "id": "bf72bd79-b389-480a-81e3-c867ca210bee",
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-01-14T18:53:26+00:00",
      "updated_at": "2022-01-14T18:53:26+00:00",
      "name": "Mobile phone",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/2f581c56-6772-4eaa-b482-96d588a4aebd' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "2f581c56-6772-4eaa-b482-96d588a4aebd",
        "type": "default_properties",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/7c2fd43a-b980-48b3-9a1b-c210ebc17619' \
    --header 'content-type: application/json' \
    --data '{}'
```
