...
```json
  ...
  "data": [
    {
      "id": "30bd5000-cad4-4849-a547-9c6704f623a4",
      "type": "default_properties",
      "attributes": {
        "created_at": "2023-02-14T11:04:24+00:00",
        "updated_at": "2023-02-14T11:04:24+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/d4420887-fbc5-4757-8505-dc0ee554c2fd?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "d4420887-fbc5-4757-8505-dc0ee554c2fd",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-14T11:04:24+00:00",
      "updated_at": "2023-02-14T11:04:24+00:00",
...
```json
  {
  "data": {
    "id": "fb6c7157-bb4d-4b7a-90ad-03b52beeea63",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-14T11:04:24+00:00",
      "updated_at": "2023-02-14T11:04:24+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/10d37a29-fa0e-4003-8363-a15f93b61742' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "10d37a29-fa0e-4003-8363-a15f93b61742",
        "type": "default_properties",
        "attributes": {
...
```json
  ...
  "data": {
    ...
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-14T11:04:25+00:00",
      "updated_at": "2023-02-14T11:04:25+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "text_field",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/9025e5df-e0c1-4a2a-ae57-2e1a01f7dfad' \
    --header 'content-type: application/json' \
    --data '{}'
```
