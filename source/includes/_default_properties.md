...
```json
  ...
  "data": [
    {
      "id": "ce7a61c3-f1b2-4a1d-860c-803d8489aac3",
      "type": "default_properties",
      "attributes": {
        "created_at": "2022-04-12T18:24:59+00:00",
        "updated_at": "2022-04-12T18:24:59+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/a711466a-bb3c-48d3-800e-d06bc26ba77b?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "a711466a-bb3c-48d3-800e-d06bc26ba77b",
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-04-12T18:24:59+00:00",
      "updated_at": "2022-04-12T18:24:59+00:00",
...
```json
  {
  "data": {
    "id": "ec3ffc52-0751-4873-890c-be082e2955ea",
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-04-12T18:25:00+00:00",
      "updated_at": "2022-04-12T18:25:00+00:00",
      "name": "Mobile phone",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/e139f9d5-7fb4-4af0-abbf-add2f2bd052b' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "e139f9d5-7fb4-4af0-abbf-add2f2bd052b",
        "type": "default_properties",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/1d650a84-9718-411e-8917-e0cc7c99e3c8' \
    --header 'content-type: application/json' \
    --data '{}'
```
