...
```json
  ...
  "data": [
    {
      "id": "bf4f75c4-bd07-46f9-b27d-41964be1cb9e",
      "type": "default_properties",
      "attributes": {
        "created_at": "2023-01-26T08:08:53+00:00",
        "updated_at": "2023-01-26T08:08:53+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/a6c2cb3b-6cc1-40ea-9f2f-622a418e62fc?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "a6c2cb3b-6cc1-40ea-9f2f-622a418e62fc",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-01-26T08:08:54+00:00",
      "updated_at": "2023-01-26T08:08:54+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "phone",
...
```json
  {
  "data": {
    "id": "175a4392-9f5c-46f1-8dce-7b3afc6459f0",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-01-26T08:08:54+00:00",
      "updated_at": "2023-01-26T08:08:54+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/59ee1be7-5b5b-4b6b-8277-3617aa77acf0' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "59ee1be7-5b5b-4b6b-8277-3617aa77acf0",
        "type": "default_properties",
        "attributes": {
...
```json
  ...
  "data": {
    ...
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-01-26T08:08:55+00:00",
      "updated_at": "2023-01-26T08:08:55+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "text_field",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/5b9b1335-d08e-4dac-aa48-81973b45e83e' \
    --header 'content-type: application/json' \
    --data '{}'
```
