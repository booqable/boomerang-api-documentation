...
```json
  ...
  "data": [
    {
      "id": "c4dfdfeb-679e-485d-bec5-1eef7b4d9e15",
      "type": "default_properties",
      "attributes": {
        "created_at": "2023-02-16T11:20:07+00:00",
        "updated_at": "2023-02-16T11:20:07+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/97129294-8077-4b39-a749-ba7b7b1e450e?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "97129294-8077-4b39-a749-ba7b7b1e450e",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-16T11:20:07+00:00",
      "updated_at": "2023-02-16T11:20:07+00:00",
...
```json
  {
  "data": {
    "id": "fc5a8c3f-93a9-4a21-8815-9019ca96ec3b",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-16T11:20:08+00:00",
      "updated_at": "2023-02-16T11:20:08+00:00",
      "name": "Mobile phone",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/c80d2f17-804a-429f-9ab0-8eaca2b9423e' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "c80d2f17-804a-429f-9ab0-8eaca2b9423e",
        "type": "default_properties",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/cf72448a-8b21-4719-8ade-a2de17d0ad5d' \
    --header 'content-type: application/json' \
    --data '{}'
```
