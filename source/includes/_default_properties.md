...
```json
  ...
  "data": [
    {
      "id": "e70627cc-a77a-4988-ad99-d79fcb26728d",
      "type": "default_properties",
      "attributes": {
        "created_at": "2022-11-16T14:30:55+00:00",
        "updated_at": "2022-11-16T14:30:55+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/76f21f30-f067-4529-afd5-c784a22071ea?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "76f21f30-f067-4529-afd5-c784a22071ea",
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-11-16T14:30:56+00:00",
      "updated_at": "2022-11-16T14:30:56+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "phone",
...
```json
  {
  "data": {
    "id": "8fb5f63e-3853-49a2-b479-a6adaf7db4af",
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-11-16T14:30:56+00:00",
      "updated_at": "2022-11-16T14:30:56+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/182b3d15-115a-4565-b3d1-065bf40c9735' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "182b3d15-115a-4565-b3d1-065bf40c9735",
        "type": "default_properties",
        "attributes": {
...
```json
  ...
  "data": {
    ...
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-11-16T14:30:57+00:00",
      "updated_at": "2022-11-16T14:30:57+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "text_field",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/fe4a5ee3-3ce6-4581-bd6f-2d1380d05e6b' \
    --header 'content-type: application/json' \
    --data '{}'
```
