...
```json
  ...
  "data": [
    {
      "id": "153741e6-d8aa-4bc6-8239-89613a4deab0",
      "type": "default_properties",
      "attributes": {
        "created_at": "2023-02-14T11:06:13+00:00",
        "updated_at": "2023-02-14T11:06:13+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/d35bfac4-ec8c-4a7d-9e84-70d9a7aa8f0f?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "d35bfac4-ec8c-4a7d-9e84-70d9a7aa8f0f",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-14T11:06:13+00:00",
      "updated_at": "2023-02-14T11:06:13+00:00",
...
```json
  {
  "data": {
    "id": "e5d18997-08cc-455c-ba43-a991bb412cbb",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-14T11:06:14+00:00",
      "updated_at": "2023-02-14T11:06:14+00:00",
      "name": "Mobile phone",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/6ee11d0f-8718-427e-a8c1-91bb1954b416' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "6ee11d0f-8718-427e-a8c1-91bb1954b416",
        "type": "default_properties",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/1577c1cd-fe36-4904-9c43-8a9c369196e5' \
    --header 'content-type: application/json' \
    --data '{}'
```
