...
```json
  ...
  "data": [
    {
      "id": "2a790409-f677-4406-bf58-df23c5448846",
      "type": "default_properties",
      "attributes": {
        "created_at": "2023-02-16T09:59:39+00:00",
        "updated_at": "2023-02-16T09:59:39+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/ca07fa95-349b-4943-8dde-0767f5d0a882?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "ca07fa95-349b-4943-8dde-0767f5d0a882",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-16T09:59:39+00:00",
      "updated_at": "2023-02-16T09:59:39+00:00",
...
```json
  {
  "data": {
    "id": "8a59f38e-867f-4591-9c31-24d970bb0423",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-16T09:59:40+00:00",
      "updated_at": "2023-02-16T09:59:40+00:00",
      "name": "Mobile phone",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/b3a12cdd-334d-440b-87dc-6ad32df7c0fb' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "b3a12cdd-334d-440b-87dc-6ad32df7c0fb",
        "type": "default_properties",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/e3efd804-deb2-467d-9879-08e36880b384' \
    --header 'content-type: application/json' \
    --data '{}'
```
