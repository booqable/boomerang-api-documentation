...
```json
  ...
  "data": [
    {
      "id": "e35260b3-c7d0-4817-92db-f4287d860422",
      "type": "default_properties",
      "attributes": {
        "created_at": "2023-03-02T09:23:52+00:00",
        "updated_at": "2023-03-02T09:23:52+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/1f5883c0-455c-4a33-816e-4d698fb6050c?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "1f5883c0-455c-4a33-816e-4d698fb6050c",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-03-02T09:23:53+00:00",
      "updated_at": "2023-03-02T09:23:53+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "phone",
...
```json
  {
  "data": {
    "id": "9c11997d-9b1a-43e5-893e-baa7526342c3",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-03-02T09:23:53+00:00",
      "updated_at": "2023-03-02T09:23:53+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/b570a0d2-d34a-40fd-8051-f44b5b36bbc3' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "b570a0d2-d34a-40fd-8051-f44b5b36bbc3",
        "type": "default_properties",
        "attributes": {
...
```json
  ...
  "data": {
    ...
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-03-02T09:23:54+00:00",
      "updated_at": "2023-03-02T09:23:54+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "text_field",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/34bc266a-19fd-4a39-a431-9c0bafd57b29' \
    --header 'content-type: application/json' \
    --data '{}'
```
