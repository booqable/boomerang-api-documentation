...
```json
  ...
  "data": [
    {
      "id": "45cc3b85-a485-491b-92a7-5109ac7cdd8d",
      "type": "default_properties",
      "attributes": {
        "created_at": "2023-02-28T08:44:43+00:00",
        "updated_at": "2023-02-28T08:44:43+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/3d22afa4-0639-427d-a7b3-3ade17aadc7b?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "3d22afa4-0639-427d-a7b3-3ade17aadc7b",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-28T08:44:43+00:00",
      "updated_at": "2023-02-28T08:44:43+00:00",
...
```json
  {
  "data": {
    "id": "c41507bc-6c14-425c-a79d-bac5d9b9a603",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-28T08:44:43+00:00",
      "updated_at": "2023-02-28T08:44:43+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/c5f99635-c70f-42b7-b37b-a7fd43584d30' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "c5f99635-c70f-42b7-b37b-a7fd43584d30",
        "type": "default_properties",
        "attributes": {
...
```json
  ...
  "data": {
    ...
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-28T08:44:44+00:00",
      "updated_at": "2023-02-28T08:44:44+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "text_field",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/095b893a-0387-4310-a0e7-ba0538dd7469' \
    --header 'content-type: application/json' \
    --data '{}'
```
