...
```json
  ...
  "data": [
    {
      "id": "1d72c886-ff22-444d-a197-ab5bfde7a302",
      "type": "default_properties",
      "attributes": {
        "created_at": "2022-11-22T17:41:45+00:00",
        "updated_at": "2022-11-22T17:41:45+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/8dcd78a1-d5c8-45a0-a9f0-a865149ecec1?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "8dcd78a1-d5c8-45a0-a9f0-a865149ecec1",
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-11-22T17:41:45+00:00",
      "updated_at": "2022-11-22T17:41:45+00:00",
...
```json
  {
  "data": {
    "id": "40031b07-c7e7-4baa-a94f-b9e591392e7f",
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-11-22T17:41:45+00:00",
      "updated_at": "2022-11-22T17:41:45+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/bfdb64db-bd61-4a6d-ac47-14ea085fb82f' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "bfdb64db-bd61-4a6d-ac47-14ea085fb82f",
        "type": "default_properties",
        "attributes": {
...
```json
  ...
  "data": {
    ...
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-11-22T17:41:46+00:00",
      "updated_at": "2022-11-22T17:41:46+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "text_field",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/fb25d189-488c-4aaa-aec9-3f0e290c6f75' \
    --header 'content-type: application/json' \
    --data '{}'
```
