...
```json
  ...
  "data": [
    {
      "id": "66152c5a-a218-46d9-97f9-6dc7b1687685",
      "type": "default_properties",
      "attributes": {
        "created_at": "2023-02-08T13:00:38+00:00",
        "updated_at": "2023-02-08T13:00:38+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/5b2f0be0-ff03-40fe-a75d-e170cc554c48?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "5b2f0be0-ff03-40fe-a75d-e170cc554c48",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-08T13:00:39+00:00",
      "updated_at": "2023-02-08T13:00:39+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "phone",
...
```json
  {
  "data": {
    "id": "8c3f243a-1d46-4ba6-bf51-45cbe108927b",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-02-08T13:00:39+00:00",
      "updated_at": "2023-02-08T13:00:39+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/78cf5a4b-1e70-4c08-bab1-2e72b207a8ea' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "78cf5a4b-1e70-4c08-bab1-2e72b207a8ea",
        "type": "default_properties",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/5729a53b-080d-48bf-a5a6-e8983bc0f018' \
    --header 'content-type: application/json' \
    --data '{}'
```
