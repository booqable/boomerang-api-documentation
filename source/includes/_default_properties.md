...
```json
  ...
  "data": [
    {
      "id": "0e1d2e91-00b7-4209-a5a2-64a672db8399",
      "type": "default_properties",
      "attributes": {
        "created_at": "2023-01-24T14:00:41+00:00",
        "updated_at": "2023-01-24T14:00:41+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/4e258ead-f823-40d7-b827-82ec6365a9c6?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "4e258ead-f823-40d7-b827-82ec6365a9c6",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-01-24T14:00:41+00:00",
      "updated_at": "2023-01-24T14:00:41+00:00",
...
```json
  {
  "data": {
    "id": "613cc896-4d99-440b-aec3-cdd60ec3d1a2",
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-01-24T14:00:41+00:00",
      "updated_at": "2023-01-24T14:00:41+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/10ed9b90-0b77-487d-83d8-8be03f1f93d3' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "10ed9b90-0b77-487d-83d8-8be03f1f93d3",
        "type": "default_properties",
        "attributes": {
...
```json
  ...
  "data": {
    ...
    "type": "default_properties",
    "attributes": {
      "created_at": "2023-01-24T14:00:42+00:00",
      "updated_at": "2023-01-24T14:00:42+00:00",
      "name": "Phone",
      "identifier": "phone",
      "position": 1,
      "property_type": "text_field",
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/b3f84044-5319-4bb5-bb2c-975fbb024492' \
    --header 'content-type: application/json' \
    --data '{}'
```
