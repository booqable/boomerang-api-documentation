...
```json
  ...
  "data": [
    {
      "id": "6255081d-8dd0-4bd2-8ad5-becbff084df3",
      "type": "default_properties",
      "attributes": {
        "created_at": "2022-05-24T07:19:25+00:00",
        "updated_at": "2022-05-24T07:19:25+00:00",
        "name": "Phone",
        "identifier": "phone",
        "position": 1,
        "property_type": "phone",
...
```shell
  curl --request GET \
    --url 'https://example.booqable.com/api/boomerang/default_properties/08e0b97d-6fc5-4da2-803f-2e6a3931b1b6?include=owner' \
    --header 'content-type: application/json' \
```
...
```json
  {
  "data": {
    "id": "08e0b97d-6fc5-4da2-803f-2e6a3931b1b6",
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-05-24T07:19:25+00:00",
      "updated_at": "2022-05-24T07:19:25+00:00",
...
```json
  {
  "data": {
    "id": "50c4a796-a13a-4693-afeb-2cdb0d31de4c",
    "type": "default_properties",
    "attributes": {
      "created_at": "2022-05-24T07:19:25+00:00",
      "updated_at": "2022-05-24T07:19:25+00:00",
...
```shell
  curl --request PUT \
    --url 'https://example.booqable.com/api/boomerang/default_properties/69ccbcc4-d7eb-4d7f-aa9b-1ddc4563cb74' \
    --header 'content-type: application/json' \
    --data '{
      "data": {
        "id": "69ccbcc4-d7eb-4d7f-aa9b-1ddc4563cb74",
        "type": "default_properties",
        "attributes": {
...
```shell
  curl --request DELETE \
    --url 'https://example.booqable.com/api/boomerang/default_properties/c72f32b8-fabb-4488-83a5-928063eddabc' \
    --header 'content-type: application/json' \
    --data '{}'
```
