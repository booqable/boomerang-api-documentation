...
```json
{
  ...
  "allowed_sections": [ /* ... */ ],
  "settings_iframe_url": "https://example.com/settings",
  "settings": { /* ... */ }
}
```
...
| `settings_iframe_url` | string | false | URL of the theme block's configuration page to embed in the Booqable theme editor sidebar. |
...
| Name | Type | Required | Description |
|------|------|----------|-------------|
| `type` | one of: `text`, `textarea`, `number`, `select`, `header` | true | Type of the setting field. |
